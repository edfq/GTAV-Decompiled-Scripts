...
void func_277(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	func_278(uParam0, sParam3, iParam4, iParam5, uParam6);
	uParam0->f_9 = { Param1 };
	uParam0->f_12 = { Param2 };
	uParam0->f_7 = iParam7;
}
