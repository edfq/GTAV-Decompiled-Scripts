...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { unk_0xD6E677FAD7521410(uLocal_68, 0) };
		fVar2 = vdist2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0x0509CE092AC81B7C(uLocal_68, uLocal_70, uLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (unk_0xBFCE58B2B3249999(uLocal_70, 0))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xEEC203A73BC92E7E(Global_96700))
		{
			...
			if (!func_5(Global_99091, uLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0xB1D85A6C23F2F945(Global_99091, uLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0xA2C015B68CE01357(uLocal_68, 0);
				iLocal_172 = 1;
			}
			unk_0x5501AD171E63CFEB(uLocal_68, uLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_99091, uLocal_70, 2))
			...
			unk_0x90ED32458AC2D129(uLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0x5C679902079A7E80(&uVar2);
				unk_0x5501AD171E63CFEB(0, uLocal_70, 24, 50);
				unk_0xC85977CD781454AC(0, 2000);
				unk_0xE946751408DFA71B(0, uLocal_70, Local_170 + Local_173, uLocal_171, 0, uLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x1BBD0A5729AB1226(uVar2);
				unk_0x8A1AC8EBC73850C8(iLocal_68, uVar2);
...
void func_22()
{
	...
	unk_0x16C6E55F8C91ED24(iLocal_69, 1);
	uLocal_70 = unk_0x278BD89624D37226(Local_173 + Local_169, 15f, uLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0x419E13582192CFEA(Global_99091) || !unk_0x419E13582192CFEA(uLocal_70)) || (!unk_0xA9C0BBFB9CBB66F1(iLocal_69) && iVar0 < 400))
	{
		if (!unk_0x419E13582192CFEA(iLocal_70))
		{
			iLocal_70 = unk_0x278BD89624D37226(Local_173 + Local_169, 15f, uLocal_71, 2);
		}
		iVar0++;
		wait(0);
	}
	...
	{
		unk_0x89E171705EA920DA(iLocal_70, 1, 1, 0);
		unk_0x5C052A30B9FCA449(iLocal_70, 2);
		unk_0x47D0DDD8833C5E5F(iLocal_70, 1084227584);
		iLocal_68 = unk_0x42F3C85A00B4FC7B(iLocal_70, 4, iLocal_69, -1, 1, 1);
		unk_0xD30B1DC5605A4D93(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_50()
{
	if (!unk_0xE50EB54E0F21BED0(iLocal_68, 0) && unk_0x9984C023D4E57C2E(iLocal_68, 1))
	{
		unk_0x0F3BD19FF11738D3(&iLocal_68);
	}
	if (!unk_0xE50EB54E0F21BED0(iLocal_70, 0) && unk_0x9984C023D4E57C2E(iLocal_70, 1))
	{
		unk_0x795957CD3A0042C8(&iLocal_70);
	}
	unk_0x16C6E55F8C91ED24(iLocal_69, 0);
	unk_0x824F744352C8BC82(iLocal_69);
