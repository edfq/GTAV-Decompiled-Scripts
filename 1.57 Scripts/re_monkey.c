...
void func_40(int iParam0)
{
	...
	while (iVar1 < Global_112293.f_7686.f_198)
	{
		...
		{
			func_41(Global_112293.f_7686.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_58[iVar1] = unk_0x795434E153F90E41(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
				unk_0xDB8D6815E13996A9(uLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0xBDDCDEC7B6205897(uLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				uLocal_58[iVar1] = unk_0x795434E153F90E41(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
				unk_0xDB8D6815E13996A9(uLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0xBDDCDEC7B6205897(uLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				uLocal_58[iVar1] = unk_0x795434E153F90E41(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
				unk_0xDB8D6815E13996A9(uLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0xBDDCDEC7B6205897(uLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0xC6D04E4B28753F77(iLocal_48, 1))
			{
				func_150();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (unk_0x7B679A34CBECDEE2(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0xDFB7BFA6482FEE1E() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0xDFB7BFA6482FEE1E())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_48 = unk_0x0FDCFECB2EF2BC1C(26, joaat("u_m_m_streetart_01"), Local_49, fLocal_50, 1, 1);
			unk_0x824F744352C8BC82(joaat("u_m_m_streetart_01"));
			uLocal_58[0] = unk_0x795434E153F90E41(joaat("prop_cs_spray_can"), Local_59, 1, 1, 0);
			unk_0x0F1058706D5A58B4(uLocal_58[0], iLocal_48, unk_0xA79DFB802C09F5F5(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1);
			unk_0x504B26425DFF773C(iLocal_48, 1);
			unk_0x7B28A83A0D3DD0F9(iLocal_48, 42, 1);
			uLocal_53 = func_68(iLocal_48, 0, 145);
			func_58(1);
			unk_0x2271ED1E65FB75EE(iLocal_48, 1862763509);
			unk_0x63EC3B3BCF4B0D48(iLocal_48, 2.5f);
		}
	}
	return 0;
}
...
{
	func_72();
	if (!unk_0xCC7E6EA219FD8BAC() && iLocal_51 < 3)
	{
		func_150();
	}
}
...
void func_72()
{
	...
	if (func_50(iLocal_48))
	{
		...
		Var2 = { unk_0xD6E677FAD7521410(iLocal_48, 0) };
		fVar4 = 7.5f;
		Var5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			Var3 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0) };
			bVar6 = unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0);
			bVar7 = unk_0xD1A2328AC17D6F4C(unk_0x7D2B9E6A64637269());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x3E72EB0926A107F9(Var2, fVar4, 0) || unk_0xD7196DD041C06559(Var2 - Var5, Var2 + Var5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x068BDE31F7D112BB(sLocal_62);
				if (unk_0x0EC2B29D4172D225(sLocal_62))
				{
					unk_0xBE91B077ADADE97F(iLocal_48, 1);
					unk_0x4261814A9A26E86F(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_82(unk_0x7D2B9E6A64637269(), iLocal_48, 35f))
				{
					unk_0x5C679902079A7E80(&uLocal_68);
					unk_0x4261814A9A26E86F(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x1BBD0A5729AB1226(uLocal_68);
					unk_0x8A1AC8EBC73850C8(iLocal_48, uLocal_68);
					unk_0x8D5B447F21217223(&uLocal_68);
					unk_0xF9135F131C423364(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(unk_0x7D2B9E6A64637269(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0x82D2BB48A39F1E88(iLocal_48, 8, 1);
				unk_0x82D2BB48A39F1E88(iLocal_48, 32, 1);
				unk_0x5C679902079A7E80(&uLocal_68);
			...
			case 5:
				...
				if (!unk_0xB4E725A8915BDF60(iLocal_48) && vdist2(Var2, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0)) > 2500f)
				{
					uLocal_67 = unk_0x3F7B472B49D4D2AC(Var3, Var2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0xA2B3B271E2AE7A08(uLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0x419E13582192CFEA(iLocal_48))
	{
...
int func_73()
{
	...
	{
		case 0:
			if (unk_0x698F51FB33ADAF7B(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				Local_57 = { Var0 };
			...
			else if (unk_0x698F51FB33ADAF7B(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0x4598B7969D5B0A28(iLocal_48, sLocal_62, sLocal_64);
				fLocal_54 = func_77(fLocal_54, 0.2f, 0.349f);
				if (fLocal_54 != 0.2f)
				{
					fVar2 = ((1f / (0.349f - 0.161f)) * to_float(900));
					iLocal_55 = round(((fLocal_54 - 0.161f) * fVar2));
					Local_57 = { unk_0xD6E677FAD7521410(iLocal_48, 0) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x4261814A9A26E86F(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0xDFB7BFA6482FEE1E();
			func_76(&uLocal_53);
			func_75();
			if (unk_0x419E13582192CFEA(uLocal_58[0]))
			{
				unk_0x3211C35423263392(uLocal_58[0], 1, 1);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0x698F51FB33ADAF7B(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0xDFB7BFA6482FEE1E() - iLocal_69);
				fVar4 = (to_float(iVar3) / to_float(iLocal_55));
				fVar5 = (fLocal_54 - ((fLocal_54 - 0.161f) * fVar4));
				fVar5 = func_77(fVar5, 0.161f, fLocal_54);
				unk_0x3778FB1E5EA800F9(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_77(fVar6, 0f, 0.8f);
				Var7 = { func_74(Local_57, Var1, fVar6) };
				unk_0x78CDDD1E6367978D(iLocal_48, Var7, 0, 1, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0xA2C015B68CE01357(iLocal_48, 0);
					return 1;
...
void func_75()
{
	if (iLocal_60 != 0)
	{
		unk_0x39448B5909AEB658(iLocal_60, 0);
		iLocal_60 = 0;
	}
}
...
void func_78()
{
	...
	if (unk_0x698F51FB33ADAF7B(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0x4598B7969D5B0A28(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_75();
		}
	...
	else if (unk_0x698F51FB33ADAF7B(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0x4598B7969D5B0A28(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_75();
		}
...
void func_79()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0x48558536A19BA88A(sLocal_61, uLocal_58[0], Local_66, Local_66, 1065353216, 0, 0, 0);
		unk_0xE41AAE444A244039(iLocal_60, 1f, 1f, 1f, 0);
		unk_0xEE7AA8559A163993(iLocal_60, 0.2f);
	}
}
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0x419E13582192CFEA(uParam0) && unk_0x419E13582192CFEA(uParam1))
	{
		...
		return vdist2(unk_0xD6E677FAD7521410(iParam0, 0), unk_0xD6E677FAD7521410(iParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_83(int iParam0)
{
	...
	{
		func_76(&uLocal_53);
		unk_0x1DC2BF231DE6A016(iLocal_48, unk_0x7D2B9E6A64637269(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			...
			if (vmag2(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_149())
			{
				return 0;
			}
		}
		...
		if (!func_133(Global_112293.f_24993.f_43[iParam1]))
		{
			return 0;
		}
