...
void __EntryFunction__()
{
	...
	iLocal_373 = unk_0xBD366067DA5DC0DE(iLocal_368);
	iLocal_374 = unk_0xBD366067DA5DC0DE(iLocal_369);
	...
	while (true)
	{
		...
		func_470();
		if (unk_0x419E13582192CFEA(Local_48.f_2))
		{
...
void func_1()
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (unk_0xDA654EB115F9FF7D(sVar0, sLocal_381))
			{
				func_509(1);
			}
			else
...
void func_2(bool bParam0)
{
	if (Local_45.f_4 == 1)
	{
		...
		{
			if (unk_0x419E13582192CFEA(Local_45))
			{
				if (func_469(Local_45))
				{
					unk_0xBE91B077ADADE97F(Local_45, 0);
					unk_0x1B0723EFE914C031(Local_45, 0);
				}
...
void func_10(bool bParam0)
{
	...
	{
		unk_0x46EDFC827DC67D89(Local_48.f_2, 0, 1);
	}
	if (bParam0)
	{
		func_7(&(Local_48.f_2));
	...
	unk_0x791B4C3811D53DFA(Local_48.f_6);
	unk_0x791B4C3811D53DFA(Local_48.f_7);
	Local_48 = 0;
}
...
void func_17()
{
	switch (Local_43.f_1)
	{
		case 0:
			if (func_469(Local_48.f_2))
			{
				...
				if (func_221(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", 8, 0, 0, 0))
				{
					...
					iLocal_189 = unk_0xDFB7BFA6482FEE1E() + 5000;
					Local_43.f_1 = 1;
				}
			}
			else
		...
		case 1:
			if ((unk_0xDFB7BFA6482FEE1E() > iLocal_189 && !func_18()) || !func_469(Local_48.f_2))
			{
				func_19();
			}
			break;
...
void func_24()
{
	...
	{
		func_26(13, floor(Global_112293.f_10192.f_3853));
	}
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77059[1 /*14*/] = { func_100(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0x234B68AC2E35ED5A(Global_77059[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77059[1 /*14*/] = { func_100(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77059[1 /*14*/] = { func_100(iVar10, 14, uVar15[iVar1], -1) };
			func_68(iParam0, Global_77059[1 /*14*/].f_12, Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4);
			func_83(14);
			if (Global_77057 == 1)
			{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_92(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_102(int iParam0)
{
	...
	func_103(&(Global_77059[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_103(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x01758128AAB0BA8F(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			Global_2621445 = Var9;
			func_103(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x01758128AAB0BA8F(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_92(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_178(&uVar1, Var0.f_3, Global_99407, iParam1, iParam2);
	}
}
...
void func_239()
{
	...
	if (Local_43.f_3 == 1)
	{
		...
		while (!unk_0x419E13582192CFEA(Local_48.f_2))
		{
			func_370();
			wait(0);
		}
		...
		unk_0x16E516CA9C88FF48(iLocal_377);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_359(1, 1093140480, 0))
		{
			if (bLocal_180)
			{
				...
				wait(3000);
				if (unk_0x419E13582192CFEA(Local_48.f_2) && unk_0xECEC7528A52B4EE8(Local_48.f_2))
				{
					unk_0x69FBFDE24E0127D9(Local_48.f_2);
				}
				if (func_469(Local_48.f_2))
				{
					unk_0xC595907BB71C921D(Local_48.f_2, 110, 0);
					unk_0xF2CEEA627AD5A24B(Local_48.f_2, "Orleans", 0, 0, 0);
				}
				unk_0x90E0430E6CB448D5(Local_49, 0);
				wait(0);
				unk_0xE9F487B66E055135("SF_TheLastOne", 0);
			...
			else
			{
				...
				if (func_469(Local_48.f_2))
				{
					unk_0xC595907BB71C921D(Local_48.f_2, 110, 0);
					unk_0xF2CEEA627AD5A24B(Local_48.f_2, "Orleans", 0, 0, 0);
					unk_0x145AB994058F1720(Local_48.f_2, 0, 1, 1);
					unk_0x145AB994058F1720(Local_48.f_2, 1, 1, 0);
					unk_0x145AB994058F1720(Local_48.f_2, 8, 1, 0);
					unk_0x145AB994058F1720(Local_48.f_2, 7, 1, 0);
				}
			...
			func_8(0);
			func_2(1);
			iLocal_411 = unk_0xDFB7BFA6482FEE1E() + 500;
			iLocal_412 = 1;
			iVar0 = unk_0x0BF0F8F3AD0993F6();
			unk_0x6AF7EE4DD9F8B944(Local_386, 200f, 1, 0, 0, 0);
			iLocal_197 = (unk_0x76EC599745C1F9BD() - 300);
			iLocal_198 = 1;
			if (func_335(iVar0))
			{
				unk_0x78CDDD1E6367978D(iVar0, Local_386, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(iVar0, fLocal_387);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			uLocal_385 = unk_0x0BF0F8F3AD0993F6();
			if (!func_335(uLocal_385) && unk_0xA9C0BBFB9CBB66F1(iLocal_377))
			{
				uLocal_385 = unk_0x170478CC84C8AE2F(iLocal_377, Local_386, fLocal_387, 1, 1, 0);
				if (func_335(uLocal_385))
				{
					unk_0x473DA067A7AE5435(uLocal_385, 1);
				}
			}
		}
		if (func_334())
		{
			if (iLocal_198)
			{
				if (unk_0x5505579F3F8D58CB() > iLocal_197)
				{
		...
		if (func_469(Local_48.f_2))
		{
			if (unk_0x30700B4AA35835FD("Orleans", 0))
			{
				...
				unk_0x7B28A83A0D3DD0F9(Local_48.f_2, 185, 1);
				unk_0x1EB6C2E7D90CD82E(Local_48.f_2, 0);
				unk_0x5C679902079A7E80(&uVar1);
				unk_0x4261814A9A26E86F(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				unk_0x4261814A9A26E86F(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				unk_0x1BBD0A5729AB1226(uVar1);
				unk_0x8A1AC8EBC73850C8(Local_48.f_2, uVar1);
				unk_0x8D5B447F21217223(&uVar1);
				unk_0xE37EB80DFB0D31FB(Local_48.f_2, 1, 0);
				unk_0xEC7D41CF790FC6FB(Local_48.f_2, 0);
				unk_0x1EADA8BA12D47EAB(Local_48.f_2, 1, 0.81f, 0.733f, 1);
				unk_0x1EADA8BA12D47EAB(Local_48.f_2, 0, 0.94f, 0.59f, 1);
				if (func_469(unk_0x7D2B9E6A64637269()) && unk_0x30700B4AA35835FD("FRANKLIN", 0))
				{
					unk_0x8ADA462BC5F42FD8(unk_0x7D2B9E6A64637269(), Local_48.f_2, -1, 2050, 4);
					unk_0x8ADA462BC5F42FD8(Local_48.f_2, unk_0x7D2B9E6A64637269(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
				if (unk_0xDFB7BFA6482FEE1E() > iLocal_411)
				{
					unk_0x4170FE884DF7426D(Local_48.f_2, 0, 1, 1, 0);
					unk_0x4170FE884DF7426D(Local_48.f_2, 1, 1, 0, 0);
					unk_0x4170FE884DF7426D(Local_48.f_2, 8, 1, 0, 0);
					unk_0x4170FE884DF7426D(Local_48.f_2, 7, 1, 0, 0);
					iLocal_412 = 0;
				}
			}
		}
...
void func_252()
{
	...
	unk_0xDD205B87CDFD0C1B(Local_48.f_3, 1f);
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_219(unk_0x471C98FD94C0A5FD(), 1);
			if (iVar4 != -1)
			{
...
void func_279(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_281(Var7.f_1)) && iVar9 < 51)
			{
...
int func_330(int iParam0, struct<3> Param1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (func_242(iParam0))
	{
		...
		unk_0xCD37A28258D70638(iParam0, iParam2);
		if (bParam3)
		{
			return bVar0;
		}
...
int func_367()
{
	...
	{
		unk_0x16E516CA9C88FF48(iLocal_376);
		if (unk_0xA9C0BBFB9CBB66F1(iLocal_376))
		{
			Local_46 = unk_0x0358AFF5157FE26F(iLocal_376, Local_388, 1, 1, 0);
			if (unk_0x419E13582192CFEA(Local_46))
			{
				unk_0xBDDCDEC7B6205897(Local_46, Local_389, 2, 1);
				unk_0x824F744352C8BC82(iLocal_376);
				unk_0xA2C015B68CE01357(Local_46, true);
			}
			else
			{
				return 0;
...
int func_370()
{
	if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
	{
		Local_48.f_2 = unk_0x0FDCFECB2EF2BC1C(25, iLocal_370, Local_47.f_1[1 /*14*/].f_1, 0f, 1, 1);
	}
	else
	{
		Local_48.f_2 = unk_0x0FDCFECB2EF2BC1C(25, iLocal_370, Local_47.f_1[0 /*14*/].f_1, 0f, 1, 1);
	}
	if (func_469(Local_48.f_2))
	{
		iLocal_188 = func_371(unk_0x7D2B9E6A64637269(), Local_48.f_2, 0f);
		unk_0x46EDFC827DC67D89(Local_48.f_2, 1, 1);
		unk_0xC22CF0F8AABFA658(Local_48.f_2, 0);
		unk_0x1D7A4E9E23D306D6(Local_48.f_2, 0);
		unk_0xBE91B077ADADE97F(Local_48.f_2, 1);
		unk_0xD82D50E4AC0D46B9(Local_48.f_2, joaat("weapon_unarmed"), -1, 1, 1);
		unk_0xEC7D41CF790FC6FB(Local_48.f_2, 0);
		unk_0x4170FE884DF7426D(Local_48.f_2, 0, 1, 0, 0);
		unk_0x4170FE884DF7426D(Local_48.f_2, 1, 0, 0, 0);
		unk_0x4170FE884DF7426D(Local_48.f_2, 8, 0, 0, 0);
		unk_0x7B28A83A0D3DD0F9(Local_48.f_2, 185, 1);
		unk_0xA415F00D0E0DFBCE(Local_48.f_2, 46, 1);
		unk_0x05D0B763CEEA9ABD(Local_48.f_2, 1);
		unk_0xDBF5BCD703020A83(Local_48.f_2, 1);
		unk_0x2BDB866C1791F9D7(Local_48.f_2, 1);
		func_238(&uLocal_199, 3, Local_48.f_2, "ORLEANS", 0, 1);
		func_369(Local_48.f_2, 0);
		Local_48 = 0;
		Local_48.f_1 = 2;
		Local_48.f_4 = 0;
		Local_48.f_5 = unk_0x5AD02BBC63E31E46();
		Local_48.f_6 = unk_0x5AD02BBC63E31E46();
		Local_48.f_7 = unk_0x5AD02BBC63E31E46();
		Local_48.f_11 = 0;
		return 1;
	}
	return 0;
...
int func_373()
{
	if ((unk_0xA9C0BBFB9CBB66F1(iLocal_370) && unk_0x0EC2B29D4172D225(sLocal_379)) && unk_0x0EC2B29D4172D225(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_377()
{
	if (Local_43.f_3 == 1)
	{
		...
		{
			unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), Local_402, 1, 0, 0, 1);
			unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), fLocal_403);
		}
		while (!func_368())
		{
			wait(0);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			if (unk_0x16B4C536089C3CAD(-1, unk_0xD6E677FAD7521410(Local_48.f_2, 1), 4f) || iLocal_171)
			{
			...
			else
			{
				func_251(4);
				func_403();
				iLocal_364 = unk_0xDFB7BFA6482FEE1E() + 3000;
				Local_43.f_1 = 3;
				func_11(&(Local_48.f_3));
			}
		}
		else if (unk_0x16B4C536089C3CAD(-1, unk_0xD6E677FAD7521410(Local_48.f_2, 1), 4f))
		{
			if (unk_0xDFB7BFA6482FEE1E() > iLocal_186)
			{
				iLocal_185++;
				iLocal_186 = unk_0xDFB7BFA6482FEE1E() + 1000;
				func_402(807, 1, 0);
			}
			if ((iLocal_179 && iLocal_185 > 0) || (!iLocal_179 && iLocal_185 > 1))
			{
				if (func_469(Local_48.f_2))
				{
					unk_0xC595907BB71C921D(Local_48.f_2, 99, 0);
				}
		...
		else
		{
			...
			{
				Local_47 = 0;
				if (Local_47.f_352 == 0 && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
				{
					Local_47.f_352 = 2;
				}
				else
			...
			if (func_385(unk_0x7D2B9E6A64637269(), Local_47.f_1[10 /*14*/].f_5, 100f))
			{
				unk_0xA566E488BA0A0A4C("sas_2_rcm_t7", 8);
			}
			if (iLocal_170 == 0)
			{
				...
				iLocal_170 = 1;
				iLocal_184 = unk_0xDFB7BFA6482FEE1E() + 1000;
			}
			else if (iLocal_183 == 0)
			{
				if (iLocal_184 < unk_0xDFB7BFA6482FEE1E())
				{
					func_383("SAS1_H0", -1);
					iLocal_183 = 1;
				}
			...
			else if (iLocal_178 == 0)
			{
				if (Local_47.f_352 < 5)
				{
					...
					{
						func_238(&uLocal_199, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
			...
			else if (iLocal_179 == 0)
			{
				...
				{
					if (!func_18() && unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_392, 35f, 35f, 35f, 0, 1, 0))
					{
						func_380();
						func_238(&uLocal_199, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
						if (func_221(&uLocal_199, "SAS1AUD", "SAS1_CHASE3", 7, 0, 0, 0))
						{
							unk_0xFEF60EAEB2A1B906(Local_48.f_2, -1536.6f, 4543.7f, 45.5f, -1538.2f, 4536.2f, 48.6f, 5f, 0, 0);
							iLocal_179 = 1;
						}
					}
				}
			...
			if (iLocal_168 == 0)
			{
				if (!func_379(&uLocal_63, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)))
				{
					func_384("SAS1_C2", 7500, 0);
					iLocal_168 = 1;
					iLocal_172 = unk_0xDFB7BFA6482FEE1E() + 30000;
				}
			}
			else if (unk_0xDFB7BFA6482FEE1E() > iLocal_172)
			{
				if (func_379(&uLocal_63, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)))
				{
					iLocal_168 = 0;
...
void func_378()
{
	unk_0x1036762BD3781C84();
	func_11(&(Local_48.f_3));
	if (func_379(&uLocal_115, unk_0xD6E677FAD7521410(Local_48.f_2, 0)))
	{
		bLocal_180 = false;
	}
	else
...
void func_380()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			unk_0x1DC2BF231DE6A016(Local_59[iVar0 /*16*/], unk_0x7D2B9E6A64637269(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
bool func_382(int iParam0, int iParam1)
{
	...
	return (unk_0xDFB7BFA6482FEE1E() - Local_42[iParam0 /*13*/].f_4) < iParam1;
}
...
void func_386()
{
	if (unk_0xA3EE9E61D762C09A(unk_0xD6E677FAD7521410(Local_48.f_2, 1), 1.5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			func_387();
	...
	else if (unk_0xA3EE9E61D762C09A(unk_0xD6E677FAD7521410(Local_48.f_2, 1), 5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			if (!func_18())
...
void func_387()
{
	...
	{
		unk_0x791B4C3811D53DFA(Local_48.f_6);
		unk_0xE2D24A37AFCF27BF(Local_48.f_6, "WOUNDED", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
		Local_48.f_10 = 1;
	}
}
	...
	switch (Local_48)
	{
		case 1:
			if (func_469(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0x78CDDD1E6367978D(Local_48.f_2, uParam0->f_1, 1, 0, 0, 1);
					if (*uParam0 == 1)
					{
						func_400(Local_48.f_2, uParam0->f_5);
					}
					Local_48.f_4 = (unk_0xDFB7BFA6482FEE1E() + iVar1);
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					else if (unk_0xDFB7BFA6482FEE1E() > Local_48.f_4)
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_469(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					Local_48.f_12 = (unk_0xDFB7BFA6482FEE1E() + 60000);
					Local_48.f_4 = 0;
					Local_48.f_1 = 1;
				}
				else if (fVar0 == -1f || func_392(Local_48.f_2, unk_0x7D2B9E6A64637269(), fVar0, 1))
				{
				...
				else if (unk_0x575B7C28D81C0B4D(Local_48.f_3))
				{
					iVar2 = (unk_0x5D8B0ADD9EFBD7B9(Local_48.f_3) - 5);
					if (iVar2 > 0)
					{
						unk_0x97A41BF3F05FC07D(Local_48.f_3, iVar2);
					}
					else
					{
						func_11(&(Local_48.f_3));
				...
				else if (unk_0xDFB7BFA6482FEE1E() > Local_48.f_12)
				{
					Local_48.f_11 = 1;
				}
				else if (unk_0xDFB7BFA6482FEE1E() > Local_48.f_4)
				{
					if ((unk_0x964C4D363AF812CB(Local_48.f_6) && unk_0x964C4D363AF812CB(Local_48.f_6)) && unk_0x964C4D363AF812CB(Local_48.f_7))
					{
						unk_0xE2D24A37AFCF27BF(Local_48.f_5, "ALERT", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						unk_0xD8575EED8AA4AA31(unk_0xD6E677FAD7521410(Local_48.f_2, 1), 30f, 6);
					}
					Local_48.f_4 = unk_0xDFB7BFA6482FEE1E() + 7500;
				}
		...
		case 3:
			if (func_469(Local_48.f_2))
			{
				...
				{
					func_369(Local_48.f_2, 1);
					unk_0x28A5BAF912B4E14D(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 1056964608);
					if ((unk_0x964C4D363AF812CB(Local_48.f_6) && unk_0x964C4D363AF812CB(Local_48.f_6)) && unk_0x964C4D363AF812CB(Local_48.f_7))
					{
						unk_0xE2D24A37AFCF27BF(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					}
					Local_48.f_10 = 0;
					if (!unk_0x575B7C28D81C0B4D(Local_48.f_3))
					{
						Local_48.f_3 = func_329(Local_48.f_2, 1, 0, 5);
						unk_0xDD205B87CDFD0C1B(Local_48.f_3, 1f);
					}
					...
					{
						unk_0x97A41BF3F05FC07D(Local_48.f_3, 255);
					}
					if (Local_47.f_352 == (Local_47.f_353 - 1))
					{
						unk_0xC22CF0F8AABFA658(Local_48.f_2, 1);
						unk_0x1D7A4E9E23D306D6(Local_48.f_2, 1);
						unk_0xC595907BB71C921D(Local_48.f_2, 110, 0);
					}
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					{
						unk_0x4261814A9A26E86F(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
					...
					else if ((unk_0x964C4D363AF812CB(Local_48.f_6) && unk_0x964C4D363AF812CB(Local_48.f_6)) && unk_0x964C4D363AF812CB(Local_48.f_7))
					{
						if (Local_48.f_10 == 0)
						{
							unk_0xE2D24A37AFCF27BF(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					...
					if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
					{
						...
						if (func_335(iVar3) && unk_0x83B12E293561B796(iVar3, Local_48.f_2))
						{
							Local_48 = 6;
							Local_48.f_1 = 0;
						}
				...
				{
					unk_0xCA089CD1A17D76DF(Local_48.f_2);
					if (Local_47.f_352 < (Local_47.f_353 - 1))
					{
						if ((unk_0x964C4D363AF812CB(Local_48.f_6) && unk_0x964C4D363AF812CB(Local_48.f_6)) && unk_0x964C4D363AF812CB(Local_48.f_7))
						{
							unk_0xE2D24A37AFCF27BF(Local_48.f_7, "COUGH", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						}
						Local_48 = 4;
						Local_48.f_1 = 0;
					}
		...
		case 4:
			...
			if (func_469(Local_48.f_2))
			{
				if (unk_0x575B7C28D81C0B4D(Local_48.f_3))
				{
					...
					iVar4 = (unk_0x5D8B0ADD9EFBD7B9(Local_48.f_3) - iVar5);
					if (iVar4 > 0)
					{
						unk_0x97A41BF3F05FC07D(Local_48.f_3, iVar4);
					}
					else
					{
						func_11(&(Local_48.f_3));
		...
		case 5:
			if (func_469(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0x8A1AC8EBC73850C8(Local_48.f_2, uVar6);
					func_380();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					if (Local_48.f_9 == 0)
					{
						if (func_392(unk_0x7D2B9E6A64637269(), Local_48.f_2, 20f, 1))
						{
							unk_0xC595907BB71C921D(Local_48.f_2, 110, 0);
							unk_0x2271ED1E65FB75EE(Local_48.f_2, -2065892691);
							unk_0x7B28A83A0D3DD0F9(Local_48.f_2, 185, 1);
							func_380();
							iLocal_366 = 0;
					...
					{
						if (unk_0xDFB7BFA6482FEE1E() > iLocal_367)
						{
							if (func_396(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", sLocal_365[iLocal_366], 7, 0, 0))
							{
								iLocal_367 = (unk_0xDFB7BFA6482FEE1E() + unk_0xB36B8558948EA7A8(3000, 5000));
								iLocal_366 = unk_0xB36B8558948EA7A8(0, 4);
							}
						}
					}
					func_395();
		...
		case 6:
			if (func_469(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					unk_0xC22CF0F8AABFA658(Local_48.f_2, 1);
					unk_0x1D7A4E9E23D306D6(Local_48.f_2, 1);
					unk_0xC595907BB71C921D(Local_48.f_2, 120, 0);
					func_369(Local_48.f_2, 1);
					if (!unk_0x575B7C28D81C0B4D(Local_48.f_3))
					{
						Local_48.f_3 = func_329(Local_48.f_2, 1, 0, 5);
					...
					iLocal_171 = 1;
					unk_0x9DA29013F33252A6(Local_48.f_2, unk_0x7D2B9E6A64637269(), 0, 16);
					func_380();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
void func_395()
{
	if (unk_0xA6E8FBD68548675F(Local_48.f_2, unk_0x7D2B9E6A64637269(), 1))
	{
		unk_0xC595907BB71C921D(Local_48.f_2, 99, 0);
	}
}
...
void func_397()
{
	if (iLocal_191 < 0)
	{
		iLocal_191 = unk_0xDFB7BFA6482FEE1E() + 7000;
		iLocal_192 = -1;
	}
	else if (unk_0xDFB7BFA6482FEE1E() > iLocal_191)
	{
...
void func_398()
{
	if (iLocal_192 < 0)
	{
		iLocal_192 = unk_0xDFB7BFA6482FEE1E() + 7000;
		iLocal_191 = -1;
	}
	else if (unk_0xDFB7BFA6482FEE1E() > iLocal_192)
	{
		if ((!func_18() && !unk_0x123480158F10FA67()) && !unk_0xE6046EB2291D084D(unk_0x7D2B9E6A64637269()))
		{
...
int func_399(var uParam0)
{
	...
	if ((Var0.x * Var1.x) + (Var0.f_1 * Var1.f_1)) < cos(to_float(uParam0->f_11))
	{
		...
		return !unk_0xC18B7B2430ACA41E(Var2, Var3, 0, 1, 0, 0, 0, 0, 0);
	}
	return 0;
}
...
void func_406()
{
	unk_0x824F744352C8BC82(iLocal_378);
}
...
void func_408()
{
	...
	while (iVar0 < iLocal_60)
	{
		Local_59[iVar0 /*16*/] = unk_0x0FDCFECB2EF2BC1C(25, iLocal_378, Local_59[iVar0 /*16*/].f_11, Local_59[iVar0 /*16*/].f_14, 1, 1);
		if (func_469(Local_59[iVar0 /*16*/]))
		{
			unk_0xBE91B077ADADE97F(Local_59[iVar0 /*16*/], 1);
			unk_0x2BDB866C1791F9D7(Local_59[iVar0 /*16*/], 1);
			unk_0x731992816BA6C01E(Local_59[iVar0 /*16*/], Local_59[iVar0 /*16*/].f_11, 15f, 1077936128, 1086324736);
			unk_0xA415F00D0E0DFBCE(Local_59[iVar0 /*16*/], 46, 1);
			unk_0xFA13CA7EC498AD09(Local_59[iVar0 /*16*/], joaat("weapon_cougar"), -1, 1);
...
bool func_409()
{
	return unk_0xA9C0BBFB9CBB66F1(iLocal_378);
}

void func_410()
{
	unk_0x16E516CA9C88FF48(iLocal_378);
}
...
void func_411()
{
	...
	if (unk_0xDFB7BFA6482FEE1E() > iLocal_187 && iLocal_187 > 0)
	{
		if (func_242(unk_0x7D2B9E6A64637269()))
		{
			unk_0xF99B8860747709DD(unk_0x1146A9AE09CE2B14(), true, 0);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_448())
		{
			...
			if (func_469(Local_45))
			{
				unk_0x7B28A83A0D3DD0F9(Local_45, 185, 1);
				unk_0x1EB6C2E7D90CD82E(Local_45, 0);
			}
			uLocal_61 = unk_0x6DCCE0FDB3CB1D7F(Local_390, 75f);
			unk_0xFA3E6ADC3E5D386E(uLocal_61, 5);
			unk_0x97A41BF3F05FC07D(uLocal_61, 128);
			unk_0xB5E587F8B911573B(uLocal_61, 0);
			unk_0x6AF7EE4DD9F8B944(Local_404, 100f, 1, 0, 0, 0);
			unk_0x6AF7EE4DD9F8B944(Local_405, 100f, 1, 0, 0, 0);
			unk_0x6AF7EE4DD9F8B944(Local_406, 100f, 1, 0, 0, 0);
			unk_0x6AF7EE4DD9F8B944(Local_407, 100f, 1, 0, 0, 0);
			iLocal_167 = 0;
			iLocal_168 = 0;
			iLocal_169 = 0;
			iLocal_174 = 0;
			...
			iLocal_181 = 1;
			iLocal_182 = 1;
			iLocal_196 = (unk_0xDFB7BFA6482FEE1E() + 40000);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_432(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_385(Local_45, Local_397, 1.5f)) || unk_0x6B9E71121F5B8154(Local_45))
		{
			unk_0x2271ED1E65FB75EE(Local_45, -2065892691);
			unk_0x9DA29013F33252A6(Local_45, unk_0x7D2B9E6A64637269(), 0, 16);
			func_403();
			func_251(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
		...
		{
			bVar0 = func_379(&uLocal_63, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1));
			if (iLocal_182 && func_385(unk_0x7D2B9E6A64637269(), Local_388, 250f))
			{
				func_374();
				func_410();
				iLocal_182 = 0;
			...
			else if (iLocal_175 == 0)
			{
				...
				{
					func_238(&uLocal_199, 4, Local_45, "HUNTER", 0, 1);
					if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), Local_45, 25f, 25f, 25f, 0, 1, 0))
					{
			...
			else if (iLocal_167 == 0)
			{
				...
				if (func_18())
				{
					if (func_413(unk_0x7D2B9E6A64637269(), Local_45) > 25f)
					{
						func_403();
					}
				}
			...
			else
			{
				if (iLocal_169 == 0)
				{
					if (func_385(unk_0x7D2B9E6A64637269(), Local_388, 5f))
					{
						func_238(&uLocal_199, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
				...
				if (iLocal_176 == 0)
				{
					if (func_385(unk_0x7D2B9E6A64637269(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_370())
						{
							func_11(&uLocal_61);
							Local_48.f_3 = func_329(Local_48.f_2, 1, 0, 5);
							unk_0xDD205B87CDFD0C1B(Local_48.f_3, 1f);
							unk_0x4569EA65F1B056ED(Local_48.f_5, "ALERT", -1541.965f, 4692.725f, 44.0651f, "SASQUATCH_01_SOUNDSET", 0, 0, 0);
							unk_0xD8575EED8AA4AA31(unk_0xD6E677FAD7521410(Local_48.f_2, 1), 30f, 6);
							unk_0xDDFB0D5F3D3B74AA(unk_0x7D2B9E6A64637269(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_412();
						}
				...
				else if (iLocal_177 == 0)
				{
					if (!func_18())
					{
						if (iLocal_190 < 0)
						{
							iLocal_190 = unk_0xDFB7BFA6482FEE1E() + 2000;
						}
						else if (unk_0xDFB7BFA6482FEE1E() > iLocal_190)
						{
							func_238(&uLocal_199, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
...
void func_412()
{
	...
	unk_0x6AF7EE4DD9F8B944(Local_404, 50f, 1, 0, 0, 0);
	unk_0x6AF7EE4DD9F8B944(Local_405, 50f, 1, 0, 0, 0);
	unk_0x6AF7EE4DD9F8B944(Local_406, 50f, 1, 0, 0, 0);
	unk_0x6AF7EE4DD9F8B944(Local_407, 20f, 1, 0, 0, 0);
	iVar0 = unk_0x0BF0F8F3AD0993F6();
	if (unk_0x419E13582192CFEA(iVar0) && !unk_0xE50EB54E0F21BED0(iVar0, 0))
	{
		...
		{
			unk_0x78CDDD1E6367978D(iVar0, Local_383, 1, 0, 0, 1);
			unk_0xCD37A28258D70638(iVar0, fLocal_384);
			unk_0x47D0DDD8833C5E5F(iVar0, 1084227584);
		}
	}
}
...
void func_415()
{
	if (iLocal_173)
	{
		if (!func_335(Local_44.f_35[0]) && func_413(unk_0x7D2B9E6A64637269(), Local_45) < 25f)
		{
			func_403();
...
void func_419()
{
	if (func_469(Local_45) && func_469(unk_0x7D2B9E6A64637269()))
	{
		if (func_392(unk_0x7D2B9E6A64637269(), Local_45, 50f, 1))
		{
			...
			if (unk_0x83B12E293561B796(unk_0x7D2B9E6A64637269(), Local_45))
			{
...
int func_427(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_341(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_439()
{
	...
	{
		if (unk_0x698F51FB33ADAF7B(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (unk_0x4598B7969D5B0A28(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (unk_0x0EC2B29D4172D225(sLocal_379))
				{
					unk_0x5C679902079A7E80(&uVar0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0x4261814A9A26E86F(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xCC2EDAABFCD738A4(uVar0, 1);
					unk_0x1BBD0A5729AB1226(uVar0);
					unk_0x8A1AC8EBC73850C8(Local_45, uVar0);
...
void func_440()
{
	...
	while (iVar0 < Local_42)
	{
		if (!(Local_42[iVar0 /*13*/].f_11 == 3 && unk_0xDFB7BFA6482FEE1E() < Local_42[iVar0 /*13*/].f_10))
		{
...
int func_441(var uParam0)
{
	...
	if (!func_242(uParam0->f_1) || !func_242(uParam0->f_2))
	{
		if (uParam0->f_5 != 0)
		{
			iVar5 = unk_0xA2B3B271E2AE7A08(uParam0->f_5, &iVar1, &Var2, &uVar3, &uVar4);
			uParam0->f_5 = 0;
		}
	...
	Var7 = { unk_0xD6E677FAD7521410(uParam0->f_1, 1) };
	Var8 = { unk_0xD6E677FAD7521410(uParam0->f_2, 1) };
	if (uParam0->f_3 > 0f)
	{
		Var9 = { func_341(Var8 - Var7) };
		fVar10 = func_428(unk_0x557C9CA8FCC667DF(uParam0->f_1), Var9);
		if (fVar10 <= cos(fVar6))
		{
			if (uParam0->f_5 != 0)
			{
	...
	if (uParam0->f_5 == 0)
	{
		Var7 = { unk_0x885F3A431ECE75E3(uParam0->f_1, 31086, 0f, 0.6f, 0f) };
		uParam0->f_7 = { Var8 + unk_0x9F2928DF31D785C7(uParam0->f_2) * FtoV(unk_0x7FF6ACE380ED166C()) };
		Var0 = { uParam0->f_7 - Var7 * Vector(1.25f, 1.25f, 1.25f) + Var7 };
		uParam0->f_5 = unk_0x3F7B472B49D4D2AC(Var7, Var0, 511, 0, 7);
		return 2;
	}
	bVar12 = false;
	iVar5 = unk_0xA2B3B271E2AE7A08(uParam0->f_5, &iVar1, &Var2, &uVar3, &uVar4);
	...
	{
		fVar13 = unk_0x0BCA9ADE67DF9DD8((unk_0x4DDAC4C80BACF92C(uParam0->f_1) * unk_0x7FF6ACE380ED166C()));
		fVar13 = 0f;
		fVar11 = unk_0x0BABEFEA577FCFA4(uParam0->f_7, Var2, 0);
		...
		if (bVar12 && unk_0x0BCA9ADE67DF9DD8((uParam0->f_7.f_2 - Var2.f_2)) > 1f)
		{
			bVar12 = false;
		}
		uParam0->f_6 = bVar12;
...
void func_444()
{
	...
	unk_0x824F744352C8BC82(iLocal_373);
	unk_0x824F744352C8BC82(iLocal_374);
	unk_0x824F744352C8BC82(iLocal_375);
}
...
void func_445(bool bParam0)
{
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			if (func_469(unk_0x7D2B9E6A64637269()) && !func_358())
			{
				unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), Local_393, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), uLocal_394);
				unk_0xDF23DCD7A3E1B7A5(0f);
				unk_0x3A13FD2813C8251F(0f, 1065353216);
			}
			if (func_469(Local_44.f_28[0]))
			{
				...
				unk_0x78CDDD1E6367978D(Local_45, Local_395, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(Local_45, fLocal_396);
			}
			else
			{
				Local_45 = unk_0x0FDCFECB2EF2BC1C(26, iLocal_371, Local_395, fLocal_396, 1, 1);
			...
			if (func_447(Local_45, 1862763509, iLocal_368))
			{
				if (func_469(unk_0x7D2B9E6A64637269()))
				{
					unk_0x8ADA462BC5F42FD8(Local_45, unk_0x7D2B9E6A64637269(), -1, 1024, 2);
				}
			}
		}
		func_446();
...
void func_446()
{
	...
	if (!unk_0xC2EBFA0B77E6B2D4(Local_45.f_2))
	{
		Local_45.f_2 = unk_0x902811AB4D3F0E4F(joaat("pickup_weapon_sniperrifle"), Local_398, Local_399, iVar0, 100, 0, 1, 0);
	}
	if (!unk_0xC2EBFA0B77E6B2D4(Local_45.f_3))
	{
		if (Local_400.f_2 != 0f)
		{
			Local_45.f_3 = unk_0x902811AB4D3F0E4F(joaat("pickup_weapon_pumpshotgun"), Local_400, Local_401, iVar0, 48, 0, 1, 0);
		}
	}
}
...
int func_448()
{
	if (((((((unk_0xA9C0BBFB9CBB66F1(iLocal_371) && unk_0xA9C0BBFB9CBB66F1(iLocal_372)) && unk_0xA9C0BBFB9CBB66F1(iLocal_373)) && unk_0xA9C0BBFB9CBB66F1(iLocal_374)) && unk_0xA9C0BBFB9CBB66F1(iLocal_375)) && unk_0x0F4C16D9EAAF22F9(iLocal_372)) && unk_0x0EC2B29D4172D225(sLocal_379)) && unk_0x0EC2B29D4172D225(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_449()
{
	...
	unk_0x16E516CA9C88FF48(iLocal_374);
	unk_0x16E516CA9C88FF48(iLocal_375);
	unk_0x4DF8E7F8D8FB143A(iLocal_372, 3);
	unk_0x068BDE31F7D112BB(sLocal_379);
	unk_0x068BDE31F7D112BB(sLocal_380);
}
...
void func_458()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_359(1, 1093140480, 0))
		{
			...
			if (func_469(Local_44.f_28[0]))
			{
				unk_0xF2CEEA627AD5A24B(Local_44.f_28[0], "Hunter", 0, 0, 0);
				iLocal_62 = func_460(Local_44.f_28[0], 1, 0, 0, 0, 0);
				if (unk_0x419E13582192CFEA(iLocal_62))
				{
					unk_0xF2CEEA627AD5A24B(iLocal_62, "SAS_SniperRifle", 0, 0, 0);
				}
			}
			func_356(500, 0);
			unk_0x9469E3DA4B5A7A39(Local_408, Local_409, 0, 0);
		...
		if (func_469(Local_44.f_28[0]))
		{
			if (unk_0x30700B4AA35835FD("Hunter", 0))
			{
				...
				if (func_447(Local_45, 1862763509, iLocal_368))
				{
					if (unk_0x0EC2B29D4172D225(sLocal_379))
					{
						unk_0x4261814A9A26E86F(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
	...
	if (Local_43.f_1 == 3)
	{
		if (unk_0xAB946B7DDFEE8833())
		{
			...
			func_500(&Local_44, 0, 1);
			func_5(&iLocal_62);
			iLocal_187 = unk_0xDFB7BFA6482FEE1E() + 500;
			func_251(2);
			func_240();
		}
	}
...
int func_461(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_282(iVar2, iVar6) != 0)
	{
		if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
		{
			if (unk_0x2B8CB30532811E62(iParam0, iVar2, func_282(iVar2, iVar6)))
			{
				if (func_464(func_282(iVar2, iVar6)))
				{
					uVar7 = unk_0x0F2D318764C61F56(func_282(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_282(iVar2, iVar8) != 0)
	{
		if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
		{
			...
			{
				unk_0x3C11038EDEC5E20E(uVar1, func_282(iVar2, iVar8));
...
void func_466()
{
	...
	if ((((unk_0x952AB441FA24BF16("SCRIPT\SAS_BANK_01", 0, -1) && unk_0x952AB441FA24BF16("SCRIPT\SAS_BANK_02", 0, -1)) && unk_0x952AB441FA24BF16("SAS_BANK_03", 0, -1)) && func_368()) && func_367())
	{
		...
		unk_0xE58535D63CA64820(iLocal_378, 1);
		if (func_469(unk_0x7D2B9E6A64637269()))
		{
			func_238(&uLocal_199, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
		}
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x8B6A925F148E0E94())
			{
				...
				Var4 = { func_473(Global_77503, Global_77505, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_501(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0x0FDCFECB2EF2BC1C(25, iLocal_38, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
void func_506()
{
	...
	unk_0xE58535D63CA64820(iLocal_378, 0);
	func_10(0);
	func_8(0);
	func_2(0);
	func_455(&uLocal_385);
	unk_0x7B57ACCEBD44824A(Local_408, Local_409, 0);
...
int func_511(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_514())
	{
		...
		{
			iVar2 = func_323(unk_0x471C98FD94C0A5FD());
			if (iVar2 > -1)
			{
