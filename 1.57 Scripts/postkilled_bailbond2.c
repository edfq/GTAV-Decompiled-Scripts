...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((unk_0xDFB7BFA6482FEE1E() - iVar4) > 100)
		{
			if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
			{
				...
				{
					if (vdist2(Var0, unk_0xD6E677FAD7521410(iLocal_79[iVar1], 0)) >= IntToFloat((iVar3 * iVar3)) && unk_0x98E18969B1D0C4AB(iLocal_79[iVar1]))
					{
				...
				else if (unk_0x419E13582192CFEA(iLocal_79[iVar1]))
				{
					func_6(&(iLocal_79[iVar1]), 1, 0, 1);
				}
				if (func_3(iLocal_79.f_5[iVar2]))
				{
					...
					{
						if (unk_0x98E18969B1D0C4AB(iLocal_79.f_5[iVar2]) || unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_79.f_5[iVar2], 0))
						{
							func_2(&(iLocal_79.f_5[iVar2]));
						}
					}
				}
				else if (unk_0x419E13582192CFEA(iLocal_79.f_5[iVar2]))
				{
					func_2(&(iLocal_79.f_5[iVar2]));
				}
				iVar1++;
...
void func_19()
{
	...
	unk_0xF479CA7199C54C8F("ENEMIES", &iLocal_90);
	unk_0x78B2DF314748056B(5, 1862763509, iLocal_90);
	unk_0x78B2DF314748056B(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
	...
	while (iVar0 <= (iLocal_79 - 1))
	{
		if (func_8(iLocal_79[iVar0]))
		{
			...
			unk_0x2271ED1E65FB75EE(iLocal_79[iVar0], iLocal_90);
...
void func_20()
{
	...
	unk_0xC14EEEFD0DE24816(5, 1862763509, iLocal_90);
	unk_0xC14EEEFD0DE24816(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
