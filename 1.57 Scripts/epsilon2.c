...
void func_1()
{
	...
	unk_0x3D8A7DEC4408D591(iLocal_87, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_86)
	{
		case 0:
			iLocal_91 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_91 && (unk_0xDFB7BFA6482FEE1E() - iLocal_88) > 15000)
				{
				...
				if (!iLocal_93 && !unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
				{
					if (!unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
					{
						...
						if (unk_0x0BCA9ADE67DF9DD8(fVar1) <= 0.05f && !iLocal_93)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_92 = 1;
...
{
	return (shift_right(iParam0, 26) & 31 * func_26(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_41(&iVar2);
		iVar3 = func_40(Var1, Global_112293.f_7686.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_38(Global_112293.f_7686.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_36(Global_112293.f_7686.f_765[iVar2 /*10*/]))
				{
					Global_112293.f_7686.f_765[iVar2 /*10*/] = { Var1 };
					func_37(&Var1);
					return 1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_72(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_72(iParam0));
			if (iVar11 > iVar10)
			{
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x8B6A925F148E0E94())
			{
				...
				Var4 = { func_222(Global_77503, Global_77505, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_259()
{
	...
	{
		func_320(13, floor(Global_112293.f_10192.f_3853));
	}
...
int func_281(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77059[1 /*14*/] = { func_112(iVar0, iParam1, uVar6[iParam1], -1) };
...
void func_286(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_287(&uVar1, Var0.f_3, Global_99407, iParam1, iParam2);
	}
}
...
int func_331(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_337())
	{
		...
		{
			iVar2 = func_332(unk_0x471C98FD94C0A5FD());
			if (iVar2 > -1)
			{
