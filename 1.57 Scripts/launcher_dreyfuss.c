...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x7D2B9E6A64637269()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_171(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		...
		case 2:
			...
			if (!unk_0x419E13582192CFEA(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					...
					unk_0x16C6E55F8C91ED24(iLocal_53, 1);
				}
			}
			if (bVar2)
			{
...
void func_269(int iParam0, bool bParam1)
{
	...
	func_270(sVar0);
	unk_0x16C6E55F8C91ED24(iLocal_53, 0);
