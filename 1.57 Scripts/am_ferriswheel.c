...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/] = 3;
		}
		func_160();
		if (unk_0x234B68AC2E35ED5A(uLocal_369, 3))
		{
			if (!Global_99422.f_1441)
			{
				unk_0xC664C0067EEAB8D1(&uLocal_369, 3);
			}
		}
		switch (func_159(unk_0xDD0E57E73E5C4BF6()))
		{
			case 0:
				if (func_158() > 0)
				{
					Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/] = 1;
				}
				break;
			...
			case 1:
				if (func_158() > 1)
				{
					if (func_153())
					{
						Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/] = 2;
					}
				}
				break;
			...
			case 3:
				...
				if (((func_20(&uLocal_1082, 3000, 0) || func_19()) || func_18()) || func_14(unk_0x1146A9AE09CE2B14()))
				{
					func_191();
				}
				break;
...
void func_1()
{
	...
	if (unk_0xF46EDF82CA845956(unk_0x6750311806FF130A(iLocal_354)))
	{
		uVar1 = unk_0x539ED6DF32477DE0(unk_0x6750311806FF130A(iLocal_354));
		switch (Local_1084)
		{
			case 0:
				if (unk_0x234B68AC2E35ED5A(Local_1086[iLocal_354 /*5*/].f_2, 4) && !unk_0x234B68AC2E35ED5A(Local_1084.f_3[iLocal_354], 1))
				{
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 0);
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_3[iLocal_354]), 0);
					unk_0x191DDA30577F440A(&(Local_1084.f_2), 2);
					iLocal_372 = 30000;
					Local_1084 = 1;
					func_5(&uLocal_370);
					unk_0x191DDA30577F440A(&(Local_1084.f_3[iLocal_354]), 1);
				}
				if (unk_0x234B68AC2E35ED5A(Local_1086[iLocal_354 /*5*/].f_2, 3) && !unk_0x234B68AC2E35ED5A(Local_1084.f_3[iLocal_354], 0))
				{
					...
					else
					{
						...
						unk_0x191DDA30577F440A(&(Local_1084.f_2), 0);
						unk_0x191DDA30577F440A(&(Local_1084.f_3[iLocal_354]), 0);
					}
				}
				break;
			
			case 1:
				if (unk_0x234B68AC2E35ED5A(Local_1084.f_3[iLocal_354], 1))
				{
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_3[iLocal_354]), 1);
				}
				break;
		}
	}
	...
	iLocal_354++;
	if (iLocal_354 == unk_0x5E72DF7B8C03AA05())
	{
		iLocal_354 = 0;
	}
}
...
int func_3()
{
	...
	while (iVar0 < 16)
	{
		...
		if (Local_1084.f_36[iVar0 /*10*/].f_6 >= Global_2551618)
		{
			return iVar0;
		}
		iVar0++;
	}
	if (Local_1084.f_36[0 /*10*/].f_6 >= Global_2551618)
	{
		return 0;
	}
	else
...
int func_4(int iParam0)
{
	...
	while (iVar1 < 2)
	{
		if (unk_0x234B68AC2E35ED5A(Local_1086[iParam0 /*5*/].f_2, 0))
		{
	...
	switch (Local_1084)
	{
		...
		case 1:
				...
				if (func_9())
				{
					if (Local_1084.f_262 != -1)
					{
						...
						while (iVar0 < 32)
						{
							...
							{
								unk_0xC664C0067EEAB8D1(&(Local_1084.f_3[iVar0]), 0);
								unk_0xC664C0067EEAB8D1(&(Local_1084.f_3[iVar0]), 1);
					...
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 3);
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 4);
					Local_1084 = 0;
				}
				else
				{
			...
			else
			{
				...
				{
					unk_0x191DDA30577F440A(&(Local_1084.f_2), 4);
				}
				if ((30000 - func_7(&uLocal_370, 0, 0)) < 3000)
				{
					unk_0x191DDA30577F440A(&(Local_1084.f_2), 3);
				}
				if (((Local_1084.f_262 != -1 && !unk_0x234B68AC2E35ED5A(Local_1086[Local_1084.f_262 /*5*/].f_2, 6)) && unk_0x591190E69BE43117(unk_0xD56332194D622ECE(Local_1084.f_197[Local_1084.f_262 /*2*/].f_1), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, 0, 1, 0)) && unk_0x234B68AC2E35ED5A(Local_1084.f_2, 2))
				{
					if (!unk_0x234B68AC2E35ED5A(Local_1084.f_2, 1))
					{
						unk_0x191DDA30577F440A(&(Local_1084.f_2), 1);
					}
				}
				else if (unk_0x234B68AC2E35ED5A(Local_1084.f_2, 1))
				{
					unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 1);
				}
			}
			break;
	}
...
int func_9()
{
	...
	while (iVar0 >= 0)
	{
		...
		{
			if (unk_0x234B68AC2E35ED5A(Local_1086[iVar0 /*5*/].f_2, 9) || unk_0x234B68AC2E35ED5A(Local_1086[iVar0 /*5*/].f_2, 10))
			{
				return 0;
			}
		}
...
void func_31()
{
	switch (Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_1)
	{
		case 0:
			if (Local_1084 == 1)
			{
				unk_0x66AE54CE92457FEE(1);
				unk_0xC664C0067EEAB8D1(&uLocal_369, 1);
				unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 4);
				iLocal_355 = 0;
				Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_1 = 1;
			}
			else
			{
				if (unk_0x234B68AC2E35ED5A(Local_1084.f_2, 0))
				{
					if (Local_1084.f_262 != -1)
					{
						if (Global_2551618 != Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_6)
						{
							func_149();
						}
					}
				...
				if (unk_0x234B68AC2E35ED5A(Local_1084.f_3[unk_0xDD0E57E73E5C4BF6()], 0))
				{
					Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 = Local_1084.f_197[unk_0xDD0E57E73E5C4BF6() /*2*/];
					if (Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 != -1)
					{
						if (Global_2551618 != Local_1084.f_36[Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 /*10*/].f_6)
						{
							if (unk_0x234B68AC2E35ED5A(uLocal_369, 0))
							{
								unk_0x66AE54CE92457FEE(1);
								unk_0xC664C0067EEAB8D1(&uLocal_369, 0);
							}
							if (!unk_0x234B68AC2E35ED5A(uLocal_369, 1))
							{
								if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
								{
								...
								unk_0x191DDA30577F440A(&uLocal_369, 1);
							}
						}
						else if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 4))
						{
							unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 4);
							unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 3);
							iLocal_379 = 1;
						}
					}
					else
				...
				else if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 8))
				{
						...
						if (!func_137())
						{
							if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
							{
								if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, 0, 1, 0))
								{
									...
									unk_0x191DDA30577F440A(&uLocal_369, 0);
									if (unk_0x86AF801D34E482FF(2, 51))
									{
										func_117();
										unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 3);
									}
								}
								else if (unk_0x234B68AC2E35ED5A(uLocal_369, 0))
								{
									unk_0x66AE54CE92457FEE(1);
									unk_0xC664C0067EEAB8D1(&uLocal_369, 0);
								}
		...
		case 1:
			if (Local_1084 == 0)
			{
				if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 5) || unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 7))
				{
					func_83();
					func_81(25);
				}
				if (!unk_0x234B68AC2E35ED5A(Local_1084.f_3[unk_0xDD0E57E73E5C4BF6()], 0))
				{
					unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 8);
				}
				unk_0x66AE54CE92457FEE(1);
				unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 7);
				unk_0xC664C0067EEAB8D1(&uLocal_369, 2);
				unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 11);
				unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 6);
				Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_1 = 0;
				if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
				{
					func_91();
				}
			...
			else
			{
				if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
				{
					if ((Local_1084.f_262 != -1 && Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 != -1) && Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 == Local_1084.f_197[Local_1084.f_262 /*2*/])
					{
						if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 7))
						{
							if (!unk_0x234B68AC2E35ED5A(Local_1084.f_2, 4))
							{
							...
							unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 7);
						}
						if (!unk_0x234B68AC2E35ED5A(Local_1084.f_2, 3))
						{
				...
				else if (((((((!func_147(0) && !func_143(unk_0x1146A9AE09CE2B14())) && !func_142(unk_0x1146A9AE09CE2B14(), 21)) && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 1)) && !unk_0xA12BCF836724905A(unk_0x1146A9AE09CE2B14(), 0)) && unk_0x7A0F33AA19956CEB(-1661.95f, -1127.011f, 12.6973f, 1f, 0, 6) == 0) && !func_76()) && !Global_1312436.f_6)
				{
					if (!func_137())
					{
						if (unk_0x234B68AC2E35ED5A(Local_1084.f_2, 1))
						{
							if (Local_1084.f_197[Local_1084.f_262 /*2*/].f_1 == unk_0x1146A9AE09CE2B14())
							{
								if (!unk_0x234B68AC2E35ED5A(Local_1084.f_2, 3))
								{
									if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 11))
									{
										func_77(func_78(1));
										unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 11);
									}
								}
							}
						}
						...
						{
							if ((!unk_0x234B68AC2E35ED5A(Local_1084.f_2, 3) && !unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 9)) && Local_1084.f_262 != -1)
							{
								if (!Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_3 >= 2)
								{
									if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 8))
									{
								...
								else if (!unk_0x234B68AC2E35ED5A(uLocal_369, 2))
								{
									func_148("AMFW_CAR_FULL", -1);
									unk_0x191DDA30577F440A(&uLocal_369, 2);
								}
							}
						}
					}
				...
				if (Local_1084.f_262 != -1)
				{
					if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 9))
					{
						func_67();
					}
					if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 10))
					{
						func_39();
					}
				}
...
void func_32()
{
	...
	{
		if (!unk_0x234B68AC2E35ED5A(uLocal_369, 5))
		{
			...
			{
				func_5(&uLocal_373);
				unk_0x191DDA30577F440A(&uLocal_369, 5);
			}
		}
		else if (func_20(&uLocal_373, 2000, 0))
		{
			if (((unk_0xD03B80D5775B63DF(unk_0x7D2B9E6A64637269()) || unk_0xD9045D352687BE18(unk_0x7D2B9E6A64637269())) || unk_0xB800560AF60FDD2E(unk_0x7D2B9E6A64637269())) || unk_0x970CD43622925924(unk_0x7D2B9E6A64637269()))
			{
				...
				unk_0xC664C0067EEAB8D1(&uLocal_369, 5);
			}
		}
	}
}
...
void func_39()
{
	...
	if (Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4 == 0)
	{
	...
	uLocal_377 = unk_0x88A92D91AB021F3F(Local_295, 0f, 0f, 0f, 2, 0, 0, 1065353216, 0, 1065353216);
	unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_377, sLocal_356, &cLocal_365, 8f, -8f, 131072, 0, 1148846080, 0);
	unk_0x20F6F12F2945E30E(uLocal_377);
	unk_0x66AE54CE92457FEE(1);
	...
	func_41();
	unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 6);
	unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 7);
	unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 0);
	unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 5);
	unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 10);
	unk_0xC664C0067EEAB8D1(&(Global_1590908[unk_0x1146A9AE09CE2B14() /*874*/].f_873), 14);
	func_40(func_78(1), Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4, 0);
	Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4 = -1;
...
void func_41()
{
	if (unk_0x234B68AC2E35ED5A(uLocal_369, 8))
	{
		func_42(&iLocal_297);
		func_42(&iLocal_299);
		func_42(&iLocal_300);
		...
		unk_0xC664C0067EEAB8D1(&uLocal_369, 8);
	}
	unk_0xC664C0067EEAB8D1(&uLocal_369, 7);
}
...
void func_45(bool bParam0)
{
	if (bParam0)
	{
		if (!unk_0x234B68AC2E35ED5A(uLocal_369, 6))
		{
			func_52(0, 0);
			unk_0x191DDA30577F440A(&uLocal_369, 6);
		}
	}
	else if (unk_0x234B68AC2E35ED5A(uLocal_369, 6))
	{
		func_46();
		unk_0xC664C0067EEAB8D1(&uLocal_369, 6);
	}
}
...
void func_67()
{
	...
	if (!unk_0x234B68AC2E35ED5A(uLocal_369, 7))
	{
		if (!unk_0x952AB441FA24BF16("SCRIPT\FERRIS_WHALE_01", 0, -1) || !unk_0x952AB441FA24BF16("SCRIPT\FERRIS_WHALE_02", 0, -1))
		{
			...
			{
				unk_0x191DDA30577F440A(&uLocal_369, 7);
			}
			return;
		}
		else
		{
			unk_0x191DDA30577F440A(&uLocal_369, 8);
			unk_0x191DDA30577F440A(&uLocal_369, 7);
		}
	}
	switch (iLocal_378)
	{
		case 0:
			...
			{
				Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3 = Local_1084.f_197[Local_1084.f_262 /*2*/];
				Local_295 = { unk_0x9E695CE384C77EF0(iLocal_290[Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3], 0f, 0f, 0f) };
				if (!Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/][0])
				{
					Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4 = 0;
				}
			...
			{
				unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 9);
				func_40(func_78(1), Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4, 1);
			}
			break;
		...
		case 1:
			...
			{
				uLocal_376 = unk_0x88A92D91AB021F3F(Local_295, 0f, 0f, 0f, 2, 1, 0, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_376, sLocal_356, &cLocal_357, 8f, -8f, 131072, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_376);
				iLocal_378 = 2;
			}
			break;
		
		case 2:
			uVar2 = unk_0x51FB94D5F3D17E35(uLocal_376);
			if (unk_0x0BC8768247440B3A(uVar2) > 0.99f)
			{
				uLocal_376 = unk_0x88A92D91AB021F3F(Local_295, 0f, 0f, 0f, 2, 0, 1, 1065353216, 0, 1065353216);
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uLocal_376, sLocal_356, &cLocal_361, 8f, -8f, 131072, 0, 1148846080, 0);
				unk_0x20F6F12F2945E30E(uLocal_376);
				iLocal_378 = 3;
			}
			break;
		...
		case 3:
			...
			Var1 = { unk_0x8EB57098C563AB39(iLocal_290[Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3], unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) };
			unk_0x0F1058706D5A58B4(unk_0x7D2B9E6A64637269(), iLocal_290[Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3], 0, Var1, 0f, 0f, unk_0xA8D713A937F31250(unk_0x7D2B9E6A64637269()), 0, 0, 0, 0, 2, 1);
			unk_0xB10D331AF5A4D8F3(unk_0x7D2B9E6A64637269(), 1);
			func_68(func_78(0), Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3, Var1, unk_0xA8D713A937F31250(unk_0x7D2B9E6A64637269()));
			unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 5);
			unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 0);
			unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 9);
			iLocal_378 = 0;
			func_40(func_78(1), Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_4, 1);
			break;
...
void func_83()
{
	...
	if (unk_0x234B68AC2E35ED5A(uLocal_369, 8))
	{
		iLocal_297 = unk_0x5AD02BBC63E31E46();
		unk_0xE2D24A37AFCF27BF(iLocal_297, "GENERATOR", uLocal_291, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
		iLocal_299 = unk_0x5AD02BBC63E31E46();
		unk_0xE2D24A37AFCF27BF(iLocal_299, "SLOW_SQUEAK", uLocal_291, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
		iLocal_300 = unk_0x5AD02BBC63E31E46();
		unk_0xE2D24A37AFCF27BF(iLocal_300, "SLOW_SQUEAK", iLocal_290[1], "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
		iLocal_298 = unk_0x5AD02BBC63E31E46();
		unk_0xE2D24A37AFCF27BF(iLocal_298, "CARRIAGE", iLocal_290[1], "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	}
	func_84();
	unk_0xC664C0067EEAB8D1(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 5);
}
...
void func_87(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	*uParam1 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", Var0, uParam0->f_8[0 /*3*/], uParam0->f_15[0], 1, 2);
	...
	if ((!bParam3 && uParam0->f_20 > 0) && !func_88(uParam0->f_1[1 /*3*/]))
	{
		...
		unk_0xFD866EC0672D68D5(*uParam1, Var0, uParam0->f_8[1 /*3*/], fVar1, uParam0->f_20, iParam4, iParam5, 2);
	}
...
void func_91()
{
	if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
	{
		...
		if (!unk_0xA300BD5F71A8C704())
		{
			...
			if ((!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 4) && !unk_0x234B68AC2E35ED5A(Local_1084.f_3[unk_0xDD0E57E73E5C4BF6()], 0)) && !unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 3))
			{
				if (unk_0x86AF801D34E482FF(2, 51))
				{
					unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 3);
		...
		if (iLocal_353 == 1)
		{
			...
			else
			{
				...
				unk_0xBD833AA6EB59C81B(Local_303, unk_0x4BB6BF4A85268A22(unk_0x7D2B9E6A64637269(), 2) + Local_303.f_14, 2);
...
void func_92()
{
	if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
	{
		if (unk_0x234B68AC2E35ED5A(uLocal_369, 4))
		{
			if (unk_0xDAE4BC89A198A6AF(uLocal_380))
			{
				if (iLocal_379)
				{
					Local_1081 = { func_105() };
					func_103(&uLocal_381);
					func_102(unk_0x908D1ACF42DAF9B8(2, 236, 1), "AMFW_BTNCV", &uLocal_381, 0);
					if (!unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 3))
					{
						func_102(unk_0x908D1ACF42DAF9B8(2, 51, 1), "AMFW_BTNEX", &uLocal_381, 0);
					}
					iLocal_379 = 0;
				}
		...
		{
			uLocal_380 = unk_0x42AA2CCF0B61DCD8("instructional_buttons");
			unk_0x191DDA30577F440A(&uLocal_369, 4);
		}
	}
	else
	{
		unk_0x3D9BC07C93913E04(&uLocal_380);
		unk_0xC664C0067EEAB8D1(&uLocal_369, 4);
		iLocal_379 = 1;
	}
}
...
void func_110(var uParam0)
{
	...
	if (*uParam0 == 1)
	{
		...
		{
			uParam0->f_12 = (uParam0->f_12 - ((unk_0xBDAD193FD6CC54F5(2, 220) * 60f) * timestep()));
			if (uParam0->f_15)
			{
		...
		{
			fVar2 = ((unk_0xBDAD193FD6CC54F5(2, 221) * 60f) * timestep());
			if (unk_0x3840DB3ECC7D0818())
			{
				fVar2 = (fVar2 * -1f);
			}
		...
		{
			fVar2 = ((unk_0xBDAD193FD6CC54F5(2, 219) * (60f / 2f)) * timestep());
...
void func_113()
{
	...
	if (func_44(unk_0x7D2B9E6A64637269()))
	{
		...
		if (bLocal_301)
		{
			...
			func_116(&Local_303, Var0, unk_0x4BB6BF4A85268A22(unk_0x7D2B9E6A64637269(), 2), 50f, Local_303.f_20, Local_303.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
			unk_0xF64CCD2B361895E2(Local_303, unk_0x7D2B9E6A64637269(), 31086, 0f, -0.25f, 0f, 1);
		}
		else
		{
...
void func_117()
{
	...
	if (func_135(1) >= Global_262145.f_7960 || unk_0x9C0D256830690A70(Global_262145.f_7960, 0, 0, 1, -1, 0))
	{
		...
		unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 8);
	}
	else if (!unk_0x234B68AC2E35ED5A(uLocal_369, 3))
	{
		func_118(0, 31, 5);
		unk_0x191DDA30577F440A(&uLocal_369, 3);
	}
}
...
void func_149()
{
	...
	if (iLocal_355 != 0)
	{
		fVar2 = (IntToFloat(unk_0x2D57EADCBEDDB2AA(unk_0xCB3024ED32EBF9EC(), iLocal_355)) / 1000f);
	}
	iLocal_355 = unk_0xCB3024ED32EBF9EC();
	if (((Local_1084.f_262 != -1 && unk_0x234B68AC2E35ED5A(Local_1084.f_2, 0)) && Global_2551618 < Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_6) && (Global_2551618 + (fLocal_292 * fVar2)) > Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_6)
	{
		Global_2551618 = Local_1084.f_36[Local_1084.f_197[Local_1084.f_262 /*2*/] /*10*/].f_6;
	}
	else
	{
		Global_2551618 = (Global_2551618 + (fLocal_292 * fVar2));
	}
	...
	{
		unk_0x78CDDD1E6367978D(uLocal_291, Local_293, 1, 0, 0, 1);
		unk_0xBDDCDEC7B6205897(uLocal_291, (-Global_2551618 - (360f / 16f)), 0f, 0f, 2, 1);
		unk_0xA2C015B68CE01357(uLocal_291, true);
	}
	if (unk_0xB30CD10E2CD1B67D("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		if (func_44(unk_0x7D2B9E6A64637269()))
		...
		unk_0x12F409221DAE2366("FAIRGROUND_RIDES_FERRIS_WHALE", "HEIGHT", (Var1.f_2 - fLocal_296));
	}
	iVar0 = 0;
	while (iVar0 < 16)
	{
...
Vector3 func_152(int iParam0)
{
	...
	return unk_0x9E695CE384C77EF0(uLocal_291, 0f, (15.3f * sin(fVar0)), (-15.3f * cos(fVar0)));
}

int func_153()
{
	unk_0x068BDE31F7D112BB(sLocal_356);
	unk_0x068BDE31F7D112BB(sLocal_289);
	unk_0x16E516CA9C88FF48(iLocal_287);
	unk_0x16E516CA9C88FF48(iLocal_288);
	if (!unk_0x0EC2B29D4172D225(sLocal_356))
	{
		return 0;
	}
...
void func_156()
{
	...
	iVar0 = 0;
	Global_2551618 = 0f;
	uLocal_291 = unk_0x795434E153F90E41(iLocal_287, 0f, 1f, 2f, 0, 0, 0);
	unk_0x78CDDD1E6367978D(uLocal_291, Local_293, 1, 0, 0, 1);
	unk_0xBDDCDEC7B6205897(uLocal_291, Global_2551618, 0f, 0f, 2, 1);
	unk_0xA2C015B68CE01357(uLocal_291, true);
	unk_0x83E421E5A4A2A512(uLocal_291, 1000);
	unk_0x8F160110753EB17B(uLocal_291, 1);
	unk_0x337507F493AD865C(uLocal_291, 0);
	if (!unk_0xB30CD10E2CD1B67D("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		unk_0xB84B43B766630B5C("FAIRGROUND_RIDES_FERRIS_WHALE");
	}
...
void func_162(int iParam0)
{
	...
	if (unk_0x443E2CA72E118E64())
	{
		...
		{
			unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 3);
			unk_0xC664C0067EEAB8D1(&(Local_1084.f_2), 2);
...
void func_163(int iParam0)
{
	...
	if (unk_0x53858F1E03A88AE1(1, iParam0, &Var0, 3))
	{
		if (!Var0.f_2)
		{
			if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
			{
				unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 10);
			}
			else
			{
				unk_0x191DDA30577F440A(&(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2), 9);
			}
		}
	}
}
...
void func_164(int iParam0)
{
	...
	if (unk_0x443E2CA72E118E64())
	{
		...
		{
			bVar1 = unk_0x234B68AC2E35ED5A(Local_1084.f_2, 3);
...
void func_170(int iParam0)
{
	...
	if (unk_0x53858F1E03A88AE1(1, iParam0, &Var0, 7))
	{
		if (Var0.f_2 != -1)
		{
			...
			{
				unk_0xB10D331AF5A4D8F3(uVar1, 1);
				unk_0x0F1058706D5A58B4(uVar1, iLocal_290[Var0.f_2], 0, Var0.f_3, 0f, 0f, Var0.f_6, 0, 0, 0, 0, 2, 1);
			}
		}
	}
}
...
void func_171(int iParam0)
{
	...
	if (unk_0x53858F1E03A88AE1(1, iParam0, &Var0, 2))
	{
		if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0))
		{
			unk_0xB10D331AF5A4D8F3(unk_0x7D2B9E6A64637269(), 1);
			Var1 = { unk_0x8EB57098C563AB39(iLocal_290[Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3], unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) };
			func_68(func_133(Var0.f_1), Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_3, Var1, unk_0xA8D713A937F31250(unk_0x7D2B9E6A64637269()));
		}
	}
}
...
void func_191()
{
	...
	if (unk_0x02BFF15CAA701972())
	{
		if (unk_0x234B68AC2E35ED5A(Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/].f_2, 0) || func_179())
		{
			if (unk_0x5976053523EA16C8(unk_0x7D2B9E6A64637269()))
			{
				unk_0x3211C35423263392(unk_0x7D2B9E6A64637269(), 1, 1);
...
int func_200(struct<21> Param0)
{
	...
	func_202(0, -1, 0);
	unk_0xF784CE07ED70869A(&Local_1084, 264);
	unk_0xC84352B5E80ABF68(&Local_1086, 161);
	unk_0x87F1904AB605184A(0);
	Local_1086[unk_0xDD0E57E73E5C4BF6() /*5*/] = 0;
	func_201(func_78(1));
	return 1;
}
