...
int func_2()
{
	...
	if (vdist(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0x4E8DA737B686529A(iParam0, -1146898486) != 1)
				{
					...
					unk_0x504B26425DFF773C(iLocal_68[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xAB6A270F84A8781E(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (vdist2(unk_0xD6E677FAD7521410(iParam0, 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0xAB6A270F84A8781E(&(Local_71[iVar0 /*4*/])))
			{
				unk_0xA7988ABD4140D469(&(Local_71[iVar0 /*4*/]));
				if (!unk_0x79CDCC8ABB331B8C(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x0FDCFECB2EF2BC1C(4, iLocal_69[iVar0], Local_72 + Local_74[iVar0 /*3*/], 0, 1, 1);
			unk_0xCD37A28258D70638(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0xF5143FB7B9EC876D(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			Local_74[3 /*3*/] = { Vector(45.5004f, unk_0x644B8DBA4F69BB73(-205.8167f, -210.4254f), unk_0x644B8DBA4F69BB73(-1416.54f, -1428.501f)) - Local_72 };
