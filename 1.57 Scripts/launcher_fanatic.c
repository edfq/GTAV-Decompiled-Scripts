...
void func_187(int iParam0)
{
	...
	if ((unk_0xDFB7BFA6482FEE1E() - iLocal_57) >= 900)
	{
		if (func_198(iParam0->f_28[0]))
		{
			if (!func_145())
...
int func_190(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_198(unk_0x7D2B9E6A64637269()) && func_198(iParam0->f_28[0])) && !func_145()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_194(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(unk_0x7D2B9E6A64637269()) && func_198(iParam0->f_28[0])) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_194(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_191(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_227(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
