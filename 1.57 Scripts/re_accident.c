	...
	while (true)
	{
		...
		if (unk_0xCC7E6EA219FD8BAC())
		{
			...
			switch (iLocal_70)
			{
				...
				case 2:
					if (((unk_0x419E13582192CFEA(iLocal_78) && unk_0xC6D04E4B28753F77(iLocal_78, 1)) && iLocal_98 < 5) && !bLocal_95)
					{
						func_12();
					}
					func_1();
...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		while (iLocal_97 < 11)
		{
			if (unk_0x419E13582192CFEA(uLocal_88[iLocal_97]))
			{
				unk_0xA2C015B68CE01357(uLocal_88[iLocal_97], 0);
			}
			iLocal_97++;
		}
		if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
		{
			unk_0xEBF08082D648C482(iLocal_80, 0f);
			unk_0xA2C015B68CE01357(iLocal_80, 0);
		}
		if (unk_0x419E13582192CFEA(iLocal_89))
		{
			unk_0xA2C015B68CE01357(iLocal_89, 0);
		}
		...
		if (unk_0x0E8572B08CEB6A11(uLocal_275))
		{
			unk_0xFE1DEC9C5734D0C0(uLocal_275, 0);
			unk_0x09F9466B03D29D2D(0, 0, 3000, 1, 0, 0);
		...
		if (unk_0x575B7C28D81C0B4D(uLocal_86))
		{
			unk_0x1AD5BCFEC31BB8D9(&uLocal_86);
		}
	...
	if (unk_0x419E13582192CFEA(uLocal_88[0]) || unk_0x419E13582192CFEA(uLocal_88[1]))
	{
		if (!unk_0x3D6C3476988DE6E1(Local_75 + Vector(20f, 0f, 0f), 30f) && !unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_75, 80f, 80f, 80f, 0, 1, 0))
		{
			func_180();
		}
	}
...
void func_12()
{
	if (iLocal_102 == -1)
	{
		iLocal_102 = unk_0xDFB7BFA6482FEE1E() + 5000;
	}
	if (unk_0xDFB7BFA6482FEE1E() > iLocal_102)
	{
		if (unk_0x419E13582192CFEA(iLocal_80))
		{
			unk_0xA2C015B68CE01357(iLocal_80, 0);
			unk_0xBC5268D1B5C5B73B(iLocal_80, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
			if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
			{
				unk_0xF4C21F6414CF1653(iLocal_80, 1, 0);
			}
		}
	}
}
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (unk_0x0064F2026E85AA12(&Var1, Local_68[0 /*5*/]))
		{
			fVar2 = 0f;
			fVar5 = 999999f;
			iVar0 = 0;
			while (iVar0 < Local_68)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + unk_0x0BABEFEA577FCFA4(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], 1));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (unk_0x0064F2026E85AA12(&Var1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = unk_0x0BABEFEA577FCFA4(Local_68[iVar0 /*5*/], Var1, 1);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_61 == 1)
	{
		...
		fVar7 = (to_float((unk_0xDFB7BFA6482FEE1E() - iLocal_63)) / fLocal_69);
		...
		{
			if ((unk_0xDFB7BFA6482FEE1E() - Local_60[iVar0 /*5*/].f_4) > 1000)
			{
				unk_0xB7E1FA65AEDC9FE5(Local_60[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((unk_0xDFB7BFA6482FEE1E() - Local_60[iVar0 /*5*/].f_4) > 6000)
			{
				unk_0x8F05701ADA031BAD(Local_60[iVar0 /*5*/]);
			}
			iVar0++;
		}
	}
...
void func_16(struct<3> Param0, int iParam1)
{
	...
	unk_0x8F05701ADA031BAD(Local_60[iLocal_65 /*5*/]);
	if (Local_60[iLocal_65 /*5*/].f_4 != 0)
	{
		unk_0xB7E1FA65AEDC9FE5(Local_60[iLocal_65 /*5*/].f_1, 0.4f, 1f);
	}
	Local_60[iLocal_65 /*5*/].f_4 = unk_0xDFB7BFA6482FEE1E();
	Local_60[iLocal_65 /*5*/].f_1 = { Param0 };
	Local_60[iLocal_65 /*5*/] = unk_0x0B072CF0711C653F(Param0, uLocal_53, iParam1);
	iLocal_65++;
	if (iLocal_65 >= 31)
	{
		iLocal_65 = 0;
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (unk_0x5C6675393464A814(0, 24) && unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269()))
			{
				if (iLocal_54 == 0)
				{
					...
					iLocal_54 = unk_0xDFB7BFA6482FEE1E() + 250;
				}
				if (unk_0xDFB7BFA6482FEE1E() > iLocal_54)
				{
					if (!bLocal_44)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_68)
						{
							if (unk_0x575B7C28D81C0B4D(Local_68[iVar0 /*5*/].f_3))
							{
								fVar2 = unk_0x0BABEFEA577FCFA4(Local_57, unk_0xB5BBED356C99E704(Local_68[iVar0 /*5*/].f_3), 1);
								fVar3 = unk_0x0BABEFEA577FCFA4(Local_68[iVar0 /*5*/], unk_0xB5BBED356C99E704(Local_68[iVar0 /*5*/].f_3), 1);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_50 != -1)
							{
								if (unk_0x909F156FC4077611((iLocal_51 - iVar5)) > 1)
								{
									iLocal_51 = -1;
								}
								if (iLocal_51 == -1)
								...
								if (unk_0x909F156FC4077611((iLocal_51 - iVar5)) < 3 && unk_0x909F156FC4077611((iLocal_51 - iVar5)) > 0)
								{
									if (iLocal_51 < iVar5)
									{
										iVar6 = iLocal_51;
										while (iVar6 <= (iVar5 - 1))
										{
											if (unk_0x575B7C28D81C0B4D(Local_68[iVar6 /*5*/].f_3))
											{
												if (unk_0x5D8B0ADD9EFBD7B9(Local_68[iVar6 /*5*/].f_3) > 0)
												{
													unk_0x97A41BF3F05FC07D(Local_68[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (unk_0x575B7C28D81C0B4D(Local_68[iVar5 /*5*/].f_3))
									{
										if (unk_0x5D8B0ADD9EFBD7B9(Local_68[iVar5 /*5*/].f_3) > 0)
										{
											unk_0x97A41BF3F05FC07D(Local_68[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	switch (iLocal_71)
	{
		case 0:
			...
			if (Local_283.f_32 <= 0)
			{
				Local_283.f_32 = unk_0x2053F6ACFD4ED4BC();
			}
			...
			func_108(&Local_283);
			if ((unk_0x952AB441FA24BF16("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0x0EC2B29D4172D225("re@construction")) && func_104(&Local_283))
			{
				if (unk_0xBFCE58B2B3249999(iLocal_80, 0))
				{
					iLocal_78 = unk_0x42F3C85A00B4FC7B(iLocal_80, 26, joaat("s_m_m_dockwork_01"), -1, 1, 1);
					unk_0x4170FE884DF7426D(iLocal_78, 0, 1, 0, 0);
					unk_0x4170FE884DF7426D(iLocal_78, 3, 1, 1, 0);
					unk_0x4170FE884DF7426D(iLocal_78, 4, 0, 1, 0);
					unk_0x4170FE884DF7426D(iLocal_78, 8, 0, 0, 0);
					unk_0x4261814A9A26E86F(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
					iLocal_90 = unk_0x795434E153F90E41(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, 1, 1, 0);
					unk_0x824F744352C8BC82(joaat("p_amb_phone_01"));
					unk_0x0F1058706D5A58B4(iLocal_90, iLocal_78, unk_0xA79DFB802C09F5F5(iLocal_78, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0xA415F00D0E0DFBCE(iLocal_78, 17, 1);
					unk_0x2828751D3E482BF8(iLocal_78, 1);
					unk_0xBE91B077ADADE97F(iLocal_78, 1);
					unk_0x1D7A4E9E23D306D6(iLocal_78, 0);
					func_103(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					unk_0x90517F1BF9113FB8(iLocal_78, "S_M_Y_GENERICWORKER_01_WHITE_01");
					uLocal_79 = unk_0x0FDCFECB2EF2BC1C(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, 1, 1);
					unk_0xBE91B077ADADE97F(uLocal_79, 1);
					unk_0x46EDFC827DC67D89(iLocal_79, 1, 1);
					unk_0xA2C015B68CE01357(iLocal_79, 1);
					unk_0x9EBC1183D6EE08A2(iLocal_78, -1143637011);
					...
					iLocal_89 = unk_0x795434E153F90E41(joaat("prop_generator_01a"), Local_274.x, (Local_274.f_1 + 0.5f), (Local_274.f_2 - 0.25f), 1, 1, 0);
					unk_0xCD37A28258D70638(iLocal_89, 75f);
					unk_0x3A653D4F5FA4B665(iLocal_89, 0, 1, 1, 0, 0, 0, 0, 0);
					uLocal_279 = unk_0x48558536A19BA88A("scr_sparking_generator", iLocal_89, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					unk_0xA2C015B68CE01357(iLocal_89, 1);
			...
			if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
			{
				if (!iLocal_92)
				{
					if (!unk_0xECEC7528A52B4EE8(iLocal_78))
					{
						...
						if (unk_0xA6E8FBD68548675F(iLocal_78, unk_0x7D2B9E6A64637269(), 1) || unk_0xA6E8FBD68548675F(iLocal_80, unk_0x7D2B9E6A64637269(), 1))
						{
							unk_0xA2C015B68CE01357(iLocal_80, 0);
							unk_0xCA089CD1A17D76DF(iLocal_78);
							...
							unk_0x8A1AC8EBC73850C8(iLocal_78, uLocal_107);
						...
						if ((((unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, 0, 1, 0) && !unk_0xD1A2328AC17D6F4C(unk_0x7D2B9E6A64637269())) && !unk_0x8599CD37AE5778BB(unk_0x7D2B9E6A64637269())) && func_94(1, 0, 1)) && unk_0xA9C0BBFB9CBB66F1(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_134())
							{
								...
								{
									iLocal_83 = unk_0x0BF0F8F3AD0993F6();
								}
								func_84(1);
							}
							iLocal_91 = 1;
				...
				else
				{
					if (!unk_0xECEC7528A52B4EE8(iLocal_78))
					{
						if (unk_0xC49311A2A500FF09(iLocal_78, 0))
						{
							if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0) && !unk_0x575B7C28D81C0B4D(uLocal_85))
							{
								uLocal_85 = func_96(iLocal_80, 0, 0);
							}
						}
					...
					if (!unk_0xECEC7528A52B4EE8(iLocal_78))
					{
						if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_78, Local_76, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_48();
					...
					else
					{
						...
						if (unk_0xECEC7528A52B4EE8(iLocal_78) || unk_0xE50EB54E0F21BED0(iLocal_80, 0))
						{
							func_95();
						}
					}
					if (!unk_0xBFCE58B2B3249999(iLocal_81, 0))
					{
						if (unk_0x575B7C28D81C0B4D(uLocal_86))
						{
							unk_0x1AD5BCFEC31BB8D9(&uLocal_86);
					...
					if (iLocal_103 >= 3)
					{
						if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) && unk_0x16D329E799CE6084(unk_0x7D2B9E6A64637269(), joaat("bulldozer")))
						{
							if (unk_0x575B7C28D81C0B4D(uLocal_86))
							{
								...
								if (!unk_0xECEC7528A52B4EE8(iLocal_78) && !unk_0xE50EB54E0F21BED0(iLocal_80, 0))
								{
									if (unk_0xC49311A2A500FF09(iLocal_78, 0) && !unk_0x575B7C28D81C0B4D(uLocal_85))
									{
										uLocal_85 = func_96(iLocal_80, 0, 0);
									}
								}
						...
						else if (!unk_0xECEC7528A52B4EE8(iLocal_78) && !unk_0xE50EB54E0F21BED0(iLocal_80, 0))
						{
							if (unk_0xC49311A2A500FF09(iLocal_78, 0) && unk_0x575B7C28D81C0B4D(uLocal_85))
							{
								unk_0x1AD5BCFEC31BB8D9(&uLocal_85);
				...
				if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
				{
					if (unk_0x2AB8EC6521549BAD(iLocal_80))
					{
						iLocal_97 = 0;
						while (iLocal_97 < 11)
						{
						...
						if (!unk_0xECEC7528A52B4EE8(iLocal_78))
						{
							...
							{
								unk_0xBE91B077ADADE97F(iLocal_78, 1);
								unk_0x7B28A83A0D3DD0F9(iLocal_78, 116, 0);
								unk_0x7B28A83A0D3DD0F9(iLocal_78, 29, 0);
								if (!bLocal_95)
								{
									func_46();
									wait(0);
								...
								if (!unk_0xECEC7528A52B4EE8(iLocal_78))
								{
									unk_0xC595907BB71C921D(iLocal_78, 99, 0);
								}
								if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
								{
									unk_0xA2C015B68CE01357(iLocal_80, 0);
...
void func_48()
{
	switch (iLocal_103)
	{
		case 0:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 3000)
				{
		...
		case 2:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 5000 && !func_23())
				{
					if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
					{
						iLocal_106 = unk_0x6471F4759775FCA4(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0));
					}
					if (unk_0xC49311A2A500FF09(iLocal_78, 0))
					{
						if (unk_0xBFCE58B2B3249999(iLocal_81, 0))
						{
							...
							else if (!unk_0x575B7C28D81C0B4D(uLocal_86))
							{
								uLocal_86 = func_96(iLocal_81, 0, 0);
								if (unk_0x575B7C28D81C0B4D(uLocal_85))
								{
		...
		case 3:
			if (unk_0xDFB7BFA6482FEE1E() - iLocal_101) > unk_0xB36B8558948EA7A8(5000, 8000)
			{
				if (!func_23())
				{
...
void func_49()
{
	...
	{
		case 0:
			unk_0x0860A43DF88D64B1(Local_274 + Vector(0f, 1f, 0f), 1f, 1f, 1f);
			wait(0);
			unk_0x55005C717C7A23F7(1f);
			unk_0x9FC2ACC68E7C1E10(Local_273, 1f);
			wait(0);
			unk_0x9FC2ACC68E7C1E10(Local_273 - Vector(0f, 4f, 0f), 1f);
			wait(0);
			unk_0x9FC2ACC68E7C1E10(Local_273 - Vector(0f, 8f, 0f), 1f);
			wait(0);
			unk_0x9FC2ACC68E7C1E10(Local_274, 1f);
		...
		case 2:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_105) > iLocal_73 || func_51())
			{
				...
				if (!bLocal_95)
				{
					if (!unk_0xECEC7528A52B4EE8(iLocal_78) && !unk_0xE50EB54E0F21BED0(iLocal_80, 0))
					{
						if (!unk_0x5F1B1AFB0CA1586A(iLocal_78, iLocal_80, -1, 0, 0) && !unk_0x5F1B1AFB0CA1586A(iLocal_78, iLocal_80, 0, 0, 0))
						{
							func_46();
							wait(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
				...
				unk_0x966FF0999887A469(3, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_278, 0, 0);
				settimera(0);
				iLocal_99 = 3;
			}
			break;
...
void func_52()
{
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!unk_0xECEC7528A52B4EE8(iLocal_78) && !unk_0xE50EB54E0F21BED0(iLocal_80, 0))
				{
					...
					unk_0x04F4D55F2C0C756D(&iLocal_90);
					if (unk_0x5F1B1AFB0CA1586A(iLocal_78, iLocal_80, -1, 0, 0) || unk_0x5F1B1AFB0CA1586A(iLocal_78, iLocal_80, 0, 0, 0))
					{
						if (unk_0x5F1B1AFB0CA1586A(iLocal_78, iLocal_80, -1, 0, 0))
						{
							bLocal_94 = true;
							Local_77 = { unk_0xD6E677FAD7521410(iLocal_80, 0) + Vector(0f, -1f, -3f) };
						}
						else
						{
							Local_77 = { unk_0xD6E677FAD7521410(iLocal_80, 0) + Vector(0f, 1.5f, -3f) };
						}
						if (unk_0x591190E69BE43117(unk_0x0BF0F8F3AD0993F6(), Local_77, 4.2f, 4f, 5f, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_46();
		...
		case 1:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78) && !unk_0xE50EB54E0F21BED0(iLocal_80, 0))
			{
				if (!unk_0xE50EB54E0F21BED0(iLocal_81, 0))
				{
					unk_0x3A653D4F5FA4B665(iLocal_81, 0, 1, 1, 0, 0, 0, 0, 0);
				}
				unk_0x3A653D4F5FA4B665(iLocal_78, 0, 1, 0, 0, 0, 0, 0, 0);
				unk_0xA2C015B68CE01357(iLocal_80, 0);
				unk_0x5C679902079A7E80(&uLocal_107);
				if (bLocal_94)
				{
				...
				unk_0x8A1AC8EBC73850C8(iLocal_78, uLocal_107);
				unk_0x8D5B447F21217223(&uLocal_107);
				unk_0x504B26425DFF773C(iLocal_78, 1);
				iLocal_101 = unk_0xDFB7BFA6482FEE1E();
				iLocal_98++;
			}
			break;
		...
		case 2:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 500 && !unk_0xC49311A2A500FF09(iLocal_78, 0))
				{
					iLocal_73 = 0;
					if (unk_0xBFCE58B2B3249999(iLocal_80, 0))
					{
		...
		case 3:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if (unk_0x591190E69BE43117(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, 0, 1, 0) || (unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if (unk_0x591190E69BE43117(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, 0, 1, 0) || (unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 10000)
				{
					if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
					{
						unk_0xA2C015B68CE01357(iLocal_80, 0);
		...
		case 5:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 3000)
			{
				...
				if (!unk_0xECEC7528A52B4EE8(iLocal_78))
				{
					...
					if (!unk_0xE50EB54E0F21BED0(iLocal_81, 0))
					{
						unk_0x3A653D4F5FA4B665(iLocal_81, 0, 0, 0, 0, 0, 0, 0, 0);
					}
					unk_0x3A653D4F5FA4B665(iLocal_78, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0xF5143FB7B9EC876D(iLocal_78, 1);
					unk_0x1D7A4E9E23D306D6(iLocal_78, 1);
					unk_0x2828751D3E482BF8(iLocal_78, 0);
					unk_0xBE91B077ADADE97F(iLocal_78, 0);
					unk_0x9EBC1183D6EE08A2(iLocal_78, joaat("DEFAULT"));
					unk_0xCA089CD1A17D76DF(unk_0x7D2B9E6A64637269());
					unk_0x5C679902079A7E80(&uLocal_107);
					unk_0x4261814A9A26E86F(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0f, 0, 0, 0);
					unk_0xCC2EDAABFCD738A4(uLocal_107, 1);
					unk_0x1BBD0A5729AB1226(uLocal_107);
					unk_0x8A1AC8EBC73850C8(iLocal_78, uLocal_107);
					unk_0x8D5B447F21217223(&uLocal_107);
				}
		...
		case 6:
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_101) > 6400)
				{
					...
					{
						if (unk_0x591190E69BE43117(iLocal_83, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					{
						if (unk_0x591190E69BE43117(iLocal_81, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
...
void func_60()
{
	...
	{
		func_62(13, floor(Global_112293.f_10192.f_3853));
	}
...
void func_97()
{
	if (func_100(1000))
	{
		...
		if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
		{
			unk_0x21DC133439C50AA5(iLocal_80, 0f, 1f, 1f, 200f, 800f, 1);
		}
		bLocal_282 = true;
		iLocal_72 = 8;
	}
	switch (iLocal_72)
	{
		case 0:
			...
			unk_0x91F94D2287684BDB(Local_75, 50f, 0);
			unk_0xB7D390F8F682127B(Local_75, 30f, 0, 0, 0, 0, 0, 0);
			unk_0xAA464864BA733E26(Local_75, 100f, 0);
			if (!unk_0xE50EB54E0F21BED0(unk_0x0BF0F8F3AD0993F6(), 0))
			{
				if (unk_0x591190E69BE43117(unk_0x0BF0F8F3AD0993F6(), Local_75, 8f, 8f, 8f, 0, 1, 0))
				{
					uLocal_82 = unk_0x0BF0F8F3AD0993F6();
					unk_0x4985CD0720AFD468(uLocal_82, 1, 0);
					unk_0x5420D0D520CF44D0(&iLocal_82);
				}
			}
			...
			uLocal_276 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, 1, 2);
			uLocal_277 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, 1, 2);
			unk_0x9C9EC7CC88D050FA(uLocal_276, "HAND_SHAKE", 0.3f);
			unk_0x9C9EC7CC88D050FA(uLocal_277, "HAND_SHAKE", 0.3f);
			func_99();
			unk_0x6FA8221C9D2ECB46(uLocal_276, 1);
			unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
			wait(500);
			unk_0x32279DAB93C9A9FA(uLocal_277, uLocal_276, 3500, 1, 1);
		...
		case 1:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 3500)
			{
				unk_0x9B0169E27978C1A2(-1, "WEAKEN", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				unk_0x9B0169E27978C1A2(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				unk_0x3B3F13C4C5844979(uLocal_88[0], 1);
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, 1, 2);
				uLocal_277 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, 1, 2);
				unk_0x9C9EC7CC88D050FA(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x9C9EC7CC88D050FA(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0x32279DAB93C9A9FA(uLocal_277, uLocal_276, 4000, 1, 0);
				if (!unk_0xECEC7528A52B4EE8(iLocal_78))
				{
					unk_0xCA089CD1A17D76DF(iLocal_78);
					unk_0xDDFB0D5F3D3B74AA(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
				if (unk_0x419E13582192CFEA(iLocal_90))
				{
					unk_0x3211C35423263392(iLocal_90, 1, 1);
					unk_0x04F4D55F2C0C756D(&iLocal_90);
				}
				iLocal_104 = unk_0xDFB7BFA6482FEE1E();
				iLocal_72 = 2;
		...
		case 2:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 1500)
			{
		...
		case 3:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 500)
			{
				if (unk_0x419E13582192CFEA(uLocal_88[0]))
				{
					unk_0xA2C015B68CE01357(uLocal_88[0], 0);
					unk_0xBC5268D1B5C5B73B(uLocal_88[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, 1, 1, 1, 0, 1);
					unk_0x29686D628C8C6B94(uLocal_88[0], 11, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 18, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 19, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 23, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 9, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 12, 0);
					unk_0x29686D628C8C6B94(uLocal_88[0], 17, 0);
					unk_0x4A95E0F654DD603E("scr_reconstruct_pipefall_debris", uLocal_88[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
				}
				iLocal_104 = unk_0xDFB7BFA6482FEE1E();
				iLocal_72 = 4;
			}
		...
		case 4:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 2000)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, 1, 2);
				uLocal_277 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, 1, 2);
				unk_0x9C9EC7CC88D050FA(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x9C9EC7CC88D050FA(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0x32279DAB93C9A9FA(uLocal_277, uLocal_276, 1000, 3, 3);
		...
		case 5:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 500)
			{
				if (!unk_0xE50EB54E0F21BED0(iLocal_80, 0))
				{
					...
					if (!unk_0xECEC7528A52B4EE8(iLocal_78))
					{
						unk_0x880C7B361C9651EE(iLocal_78);
					}
					unk_0x4261814A9A26E86F(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0f, 0, 0, 0);
					unk_0x4A95E0F654DD603E("scr_reconstruct_pipe_impact", iLocal_80, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					func_24(&uLocal_108, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
					if (unk_0x0E8572B08CEB6A11(uLocal_276) && unk_0x0E8572B08CEB6A11(uLocal_277))
					{
						unk_0x9C9EC7CC88D050FA(uLocal_276, "HAND_SHAKE", 1.5f);
						unk_0x9C9EC7CC88D050FA(uLocal_277, "HAND_SHAKE", 1.5f);
					}
					iLocal_104 = unk_0xDFB7BFA6482FEE1E();
					iLocal_72 = 6;
				}
		...
		case 6:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 500)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, 1, 2);
				uLocal_277 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, 1, 2);
				unk_0x9C9EC7CC88D050FA(uLocal_276, "HAND_SHAKE", 0.5f);
				unk_0x9C9EC7CC88D050FA(uLocal_277, "HAND_SHAKE", 0.5f);
				unk_0x32279DAB93C9A9FA(uLocal_277, uLocal_276, 2500, 3, 3);
				if (!unk_0xECEC7528A52B4EE8(iLocal_78))
				{
					unk_0xDDFB0D5F3D3B74AA(iLocal_78, unk_0xD6E677FAD7521410(iLocal_78, 1) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = unk_0xDFB7BFA6482FEE1E();
				iLocal_72 = 7;
			}
		...
		case 7:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 2200 && !iLocal_96)
			{
			...
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_104) > 2500)
			{
				if (unk_0xBFCE58B2B3249999(iLocal_80, 0))
				{
		...
		case 8:
			...
			if (unk_0x419E13582192CFEA(uLocal_88[0]))
			{
				unk_0x04F4D55F2C0C756D(&(uLocal_88[0]));
			}
			if (unk_0xBFCE58B2B3249999(iLocal_80, 0))
			{
				unk_0xEBF08082D648C482(iLocal_80, 250f);
				unk_0x78CDDD1E6367978D(iLocal_80, Local_75, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(iLocal_80, 80f);
				unk_0xBA7E979B202649F9(Local_75, 50f, 0);
			}
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				unk_0xCA089CD1A17D76DF(iLocal_78);
				unk_0x880C7B361C9651EE(iLocal_78);
				unk_0x4261814A9A26E86F(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			}
			unk_0x6FA8221C9D2ECB46(uLocal_276, 0);
			unk_0x09F9466B03D29D2D(0, 0, 3000, 1, 0, 0);
			unk_0xFE1DEC9C5734D0C0(uLocal_276, 0);
			unk_0xFE1DEC9C5734D0C0(uLocal_277, 0);
			unk_0xF99B8860747709DD(unk_0x1146A9AE09CE2B14(), 1, 0);
			unk_0xDF23DCD7A3E1B7A5(0f);
			unk_0xDD7C2F9844E745B1(1);
			unk_0x4200138CBB376D4D(1);
			...
			uLocal_88[1] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[1], -0.1939f, 105.0058f, 77.3964f, 2, 1);
			uLocal_88[2] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[2], 24.3941f, 32.5423f, 80.6862f, 2, 1);
			uLocal_88[3] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[3], 24.1841f, 110.287f, 78.4357f, 2, 1);
			uLocal_88[4] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[4], -0.0264f, 29.5754f, 79.1811f, 2, 1);
			uLocal_88[5] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[5], -0.6337f, 108.4339f, 77.9539f, 2, 1);
			uLocal_88[6] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[6], 0.0929f, 74.2657f, 79.3839f, 2, 1);
			uLocal_88[7] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[7], -0.0264f, 29.5754f, 80.9061f, 2, 1);
			uLocal_88[8] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[8], -0.1087f, 109.7339f, 80.9789f, 2, 1);
			uLocal_88[9] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[9], -0.3321f, 74.1907f, 81.6089f, 2, 1);
			uLocal_88[10] = unk_0x0358AFF5157FE26F(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(uLocal_88[10], 5.7811f, 104.6058f, 104.6964f, 2, 1);
			iLocal_97 = 0;
			while (iLocal_97 < 11)
			{
				if (unk_0x419E13582192CFEA(uLocal_88[iLocal_97]))
				{
					unk_0x0B87A8220B73252D(uLocal_88[iLocal_97], 1);
					unk_0xA2C015B68CE01357(uLocal_88[iLocal_97], 1);
				}
				iLocal_97++;
			}
			if (bLocal_282)
...
void func_115()
{
	...
	if (func_104(&Local_283))
	{
		...
		unk_0x0823FA7465392E20(Local_74 + Vector(50f, 50f, 50f), Local_74 - Vector(50f, 50f, 50f), 0, 1, 1, 1);
		Local_75 = { -455.6561f, -985.8071f, 22.4868f };
		iLocal_80 = unk_0x170478CC84C8AE2F(joaat("utillitruck2"), Local_75, 80f, 1, 1, 0);
		unk_0x89E171705EA920DA(iLocal_80, 0, 1, 0);
		unk_0x5C052A30B9FCA449(iLocal_80, 3);
		unk_0xB021D5C8EC8634FA(iLocal_80, 1, 1);
		unk_0xB021D5C8EC8634FA(iLocal_80, 2, 1);
		unk_0xB021D5C8EC8634FA(iLocal_80, 3, 0);
		unk_0xB021D5C8EC8634FA(iLocal_80, 4, 1);
		unk_0xB021D5C8EC8634FA(iLocal_80, 5, 1);
		unk_0xB021D5C8EC8634FA(iLocal_80, 6, 0);
		unk_0xB021D5C8EC8634FA(iLocal_80, 7, 1);
		unk_0xA2C015B68CE01357(iLocal_80, 1);
		unk_0x3A653D4F5FA4B665(iLocal_80, 0, 0, 0, 1, 0, 0, 0, 0);
		unk_0x83E421E5A4A2A512(iLocal_80, 10000);
		unk_0xD39FDEA586C82548(iLocal_80, 5f);
		iLocal_81 = unk_0x170478CC84C8AE2F(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, 1, 1, 0);
		unk_0x6AF7EE4DD9F8B944(Local_75, 10f, 1, 0, 0, 0);
		uLocal_88[0] = unk_0x0358AFF5157FE26F(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, 1, 1, 0);
		unk_0xCD37A28258D70638(uLocal_88[0], 90f);
		unk_0xA2C015B68CE01357(uLocal_88[0], 1);
		unk_0x3A653D4F5FA4B665(uLocal_88[0], 1, 1, 1, 1, 0, 0, 0, 0);
		unk_0x83E421E5A4A2A512(uLocal_88[0], 10000000);
...
int func_121()
{
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		...
		if (vmag2(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_132())
		{
			return 0;
		}
	}
...
int func_138(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_174(Global_112293.f_24993.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_152(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_180()
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!unk_0xECEC7528A52B4EE8(iLocal_78))
			{
				unk_0x7B28A83A0D3DD0F9(iLocal_78, 317, 1);
			}
			if (!unk_0xE50EB54E0F21BED0(iLocal_83, 0))
			{
				if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_83, 0) && !unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_83, 50f, 50f, 50f, 0, 1, 0))
				{
