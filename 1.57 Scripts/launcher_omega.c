...
void func_184(int iParam0)
{
	...
	if ((unk_0xDFB7BFA6482FEE1E() - iLocal_58) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0xB4E725A8915BDF60(iParam0->f_28[0]))
		{
			if (func_127(unk_0x7D2B9E6A64637269()) && !func_185(unk_0x7D2B9E6A64637269(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar4 != 0f)
				{
					fVar2 = unk_0xF0AE30F012D1FD8C(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0xCD37A28258D70638(iParam0->f_28[0], fVar2);
			}
		}
...
void func_186()
{
	...
	unk_0x704F8697BB515627(uLocal_56, "SET_COLOUR");
	...
	unk_0x704F8697BB515627(uLocal_56, "SET_DISTANCE");
	unk_0x82D42F43BE26EB72(10f);
	unk_0x392841D58D2EED1D();
	unk_0x27DA7E2B98AB7899(uLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x43D93129BD1AD792(uLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0xDFB7BFA6482FEE1E() - iLocal_58) > 1250)
	{
		unk_0x4569EA65F1B056ED(uLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0xDFB7BFA6482FEE1E();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_175(2))
		{
			...
			if (func_194(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_223(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_242()
{
	uLocal_56 = unk_0x42AA2CCF0B61DCD8("digiscanner");
	while (!unk_0xDAE4BC89A198A6AF(uLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0x041B9511CD0AC7F4("digiscanner"))
	{
		uLocal_57 = unk_0xC7D18C6E194A37FF("digiscanner");
	}
	uLocal_59 = unk_0x5AD02BBC63E31E46();
	iLocal_58 = unk_0xDFB7BFA6482FEE1E();
}
