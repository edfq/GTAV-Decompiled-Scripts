...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (unk_0x419E13582192CFEA(uLocal_91))
		{
			if (unk_0xE50EB54E0F21BED0(uLocal_91, 0) && !iLocal_95 == 7)
			{
		...
		switch (iLocal_95)
		{
			case 0:
				if ((unk_0xCC7E6EA219FD8BAC() && !func_34()) && !func_12())
				{
					if (func_11())
					{
						uLocal_91 = unk_0x0FDCFECB2EF2BC1C(26, iLocal_88, Local_89, uLocal_90, 1, 1);
						unk_0xBE91B077ADADE97F(uLocal_91, 1);
						uLocal_92 = unk_0x795434E153F90E41(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, 1, 1, 0);
						unk_0xCD37A28258D70638(uLocal_92, (233.8288f + 180f));
						unk_0xC8749D706BBF16E1(uLocal_91, 0, 0, 0, 0);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = unk_0xD955F1CC0BCABC78(Local_89 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_90, 2);
				unk_0xAD844C8843FC405C(uLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0x254CD34043BCDA6F("MNT_DNC", uLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0xD8C5970C104EE9F9(iLocal_97, "MNT_DNC") == 1)
				{
					unk_0x8EBD542C90FF0C85(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				Var0 = { unk_0xD6E677FAD7521410(uLocal_91, 1) };
				unk_0x63EC3B3BCF4B0D48(uLocal_91, 3f);
				if (func_10(unk_0x7D2B9E6A64637269(), uLocal_91) < 10f)
				{
					unk_0x28DDC3A09E7F918B(unk_0x7D2B9E6A64637269(), 1, uLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x28DDC3A09E7F918B(uLocal_91, 1, unk_0x7D2B9E6A64637269(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(uLocal_91, unk_0x7D2B9E6A64637269(), 1) < 25f)
				{
					if (!unk_0x575B7C28D81C0B4D(uLocal_96))
					{
						func_5(&uLocal_96, &uLocal_91, 0);
						unk_0xFA3E6ADC3E5D386E(uLocal_96, 3);
					}
				}
				...
				if (unk_0x0BC8768247440B3A(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x6B9E71121F5B8154(uLocal_91))
				{
					unk_0x6BED7510491CAF98(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0xECEC7528A52B4EE8(uLocal_91) || unk_0x3E72EB0926A107F9(Var0, 50f, 1)) || unk_0x3E72EB0926A107F9(Var0, 50f, 0)) || unk_0xD7196DD041C06559(Var0, 20f, 20f, 20f, 0)) || unk_0x16B4C536089C3CAD(-1, Var0, 50f)) || (((unk_0x4140085B99B17F97(unk_0x1146A9AE09CE2B14(), uLocal_91) || unk_0x87BE50F80F3FCEAB(unk_0x1146A9AE09CE2B14(), uLocal_91)) && unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Var0, 1) < 25f) && func_1(uLocal_91, unk_0x7D2B9E6A64637269(), 1126825984, 0)))
				{
					unk_0x6BED7510491CAF98(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x6B9E71121F5B8154(uLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x45B1B4E55BF15523(uLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x45B1B4E55BF15523(uLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0x504B26425DFF773C(uLocal_91, 1);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0x4E8DA737B686529A(uLocal_91, 713668775) != 1 && unk_0x4E8DA737B686529A(uLocal_91, 713668775) != 0)
				{
					unk_0xBE91B077ADADE97F(uLocal_91, 0);
					if (iLocal_93 == 1)
					{
						unk_0x1DC2BF231DE6A016(uLocal_91, unk_0x7D2B9E6A64637269(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0x4B770B4D8C1A469B(uLocal_91, 1193033728, 0);
					}
					unk_0x504B26425DFF773C(uLocal_91, 1);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0x98E18969B1D0C4AB(uLocal_91) && unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(uLocal_91, 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), 1) > 50f) && !unk_0xCC7E6EA219FD8BAC())
				{
					func_37(1);
				}
				break;
...
int func_1(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_3(unk_0x885F3A431ECE75E3(uParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_11()
{
	...
	unk_0x068BDE31F7D112BB(sLocal_94);
	if (unk_0xA9C0BBFB9CBB66F1(iLocal_88) && unk_0x0EC2B29D4172D225(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (vmag2(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_27())
		{
			return 0;
		}
	}
...
{
	if (unk_0x419E13582192CFEA(uLocal_92))
	{
		unk_0x04F4D55F2C0C756D(&uLocal_92);
	}
	if (unk_0x575B7C28D81C0B4D(uLocal_96))
	{
		func_4(&uLocal_96);
	...
	if (unk_0x419E13582192CFEA(uLocal_91))
	{
		if (bParam0)
		{
			unk_0xC606AE2A3209945E(&uLocal_91);
		}
		else
		{
			unk_0x0F3BD19FF11738D3(&uLocal_91);
		}
	}
