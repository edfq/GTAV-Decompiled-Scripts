...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0xD991F7672CE8EAD3(iLocal_296, 124, 1);
		}
		func_532();
		switch (iLocal_292)
		{
...
void func_1()
{
	...
	if (unk_0x419E13582192CFEA(iLocal_296) && unk_0xECEC7528A52B4EE8(iLocal_296))
	{
		func_2(2);
	}
	else if (func_533(iLocal_296) && func_533(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xA6E8FBD68548675F(iLocal_296, unk_0x7D2B9E6A64637269(), 1))
		{
			if (unk_0x16DE9112AAAB5C8C(iLocal_296, 0, 2) || unk_0xC51EC1626E7099CA(iLocal_296))
			{
				func_2(1);
			}
		}
...
void func_3()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			{
				if (unk_0xECEC7528A52B4EE8(iLocal_296))
				{
					iLocal_294 = 2;
				}
				else if (unk_0xA6E8FBD68548675F(iLocal_296, unk_0x7D2B9E6A64637269(), 1))
				{
					iLocal_294 = 1;
				}
			}
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_533(iLocal_296) && unk_0x284BE2EA89FED4E1(iLocal_296))
		{
			unk_0xC1A7CF4B179CD225(iLocal_296);
		}
		if (bParam1)
		{
			func_17(&iLocal_296, 1, 0, 1);
		}
		else if (func_533(iLocal_296) && unk_0x591190E69BE43117(iLocal_296, Local_282, 50f, 50f, 50f, 0, 1, 0))
		{
			func_11(iLocal_296);
		}
		else
	...
	if (unk_0x419E13582192CFEA(iLocal_302))
	{
		func_6(&uLocal_55, 6);
		iVar0 = 1;
		if (!unk_0xECEC7528A52B4EE8(iLocal_302))
		{
			if (unk_0x3D28F4F0775C6C2A(iLocal_302, 0) && !func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0xCA089CD1A17D76DF(iLocal_302);
				unk_0x4B770B4D8C1A469B(iLocal_302, 1193033728, 0);
			}
		}
		if (bParam0)
		{
	...
	unk_0xA48693249537873E(Local_279, Local_280, 0);
	unk_0x9469E3DA4B5A7A39(Local_279, Local_280, 1, 0);
...
void func_24(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_26(Global_112293.f_18531[iVar0], &Var2, &fVar3))
			{
...
void func_36()
{
	...
	if (func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296))
	{
		unk_0xD991F7672CE8EAD3(iLocal_296, 60, 1);
		...
		switch (iLocal_293)
		{
			case 0:
				...
				uLocal_247 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -1392.254f, 367.9411f, 75.0046f, -44.2648f, 0f, -119.873f, 48.4f, 0, 2);
				unk_0x6FA8221C9D2ECB46(uLocal_247, 1);
				...
				{
					unk_0xB0C1A43193C25F7A(unk_0x7D2B9E6A64637269(), iLocal_296, 0);
					...
					unk_0x45B1B4E55BF15523(0, Local_239, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0x1BBD0A5729AB1226(uVar2);
					unk_0x8A1AC8EBC73850C8(iLocal_296, uVar2);
			...
			case 3:
				...
				if (unk_0xC49311A2A500FF09(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_296, -828834893))
					{
						if (unk_0x8879B2803A5F8682(iVar0))
						{
							...
							unk_0x8A1AC8EBC73850C8(iLocal_296, uVar3);
				...
				else if (func_51(iLocal_296, Local_239, 1.5f) || func_53(&iLocal_334, 10000))
				{
					...
					unk_0xFE1DEC9C5734D0C0(uLocal_247, 0);
					func_37();
				}
				break;
			}
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0x234B68AC2E35ED5A(Global_77059[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77059[1 /*14*/] = { func_126(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77059[1 /*14*/] = { func_126(iVar10, 14, uVar15[iVar1], -1) };
			func_96(iParam0, Global_77059[1 /*14*/].f_12, Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4);
			func_118(14);
			if (Global_77057 == 1)
			{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_86(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_128(int iParam0)
{
	...
	func_129(&(Global_77059[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_129(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x01758128AAB0BA8F(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			Global_2621445 = Var9;
			func_129(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x01758128AAB0BA8F(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_86(iParam0));
			if (iVar11 > iVar10)
			{
	...
	if (func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296))
	{
		...
		switch (iLocal_293)
		{
			case 0:
				...
				iLocal_334 = -1;
				func_73(0f, 0f, 0f, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0);
				uLocal_247 = unk_0x4EE8324979A597B2("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				unk_0x6FA8221C9D2ECB46(uLocal_247, 1);
				unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
				if (func_8(iVar0))
				{
					...
					{
						unk_0x7B28A83A0D3DD0F9(iLocal_296, 179, 1);
					}
					func_71(iVar0, 1093140480, 1, 1056964608, 0, 1, 0);
				...
				else
				{
					...
					unk_0x16D66F11FE644901(iLocal_296);
					func_198(iLocal_296, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) + Vector(0f, 2f, 2f));
					unk_0xCD37A28258D70638(iLocal_296, -155.84f);
					unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), -43.04f);
					unk_0xB0C1A43193C25F7A(unk_0x7D2B9E6A64637269(), iLocal_296, 0);
					unk_0x5C679902079A7E80(&uVar3);
					unk_0xB0C1A43193C25F7A(0, unk_0x7D2B9E6A64637269(), 3000);
					unk_0x45B1B4E55BF15523(0, Local_238, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0x1BBD0A5729AB1226(uVar3);
					unk_0x8A1AC8EBC73850C8(iLocal_296, uVar3);
					unk_0x8D5B447F21217223(&uVar3);
					unk_0x8BE64A4794BF87FA(Local_341, 2.5f);
					unk_0xF22CC2CA28E44D4F(Local_341, 2.5f);
					iLocal_293 = 2;
				}
				break;
				...
				if (unk_0xC49311A2A500FF09(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_296, 242628503))
					{
						if (unk_0x8879B2803A5F8682(iVar0))
						{
							...
							unk_0x8A1AC8EBC73850C8(iLocal_296, uVar4);
...
void func_210()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_533(iLocal_296))
			{
				if (unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
				{
			...
			iLocal_258 = unk_0xDFB7BFA6482FEE1E() + 1000;
			iLocal_293 = 1;
			break;
		...
		case 1:
			if (func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296))
			{
				...
				if (unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
				{
					if (func_218(unk_0x7D2B9E6A64637269(), iLocal_296) < 5f)
					{
						func_217();
					}
				}
				else if (((func_8(iLocal_298) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0)) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0)) || (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0) && !unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0)))
				{
					func_217();
				}
				func_215();
				if (func_218(unk_0x7D2B9E6A64637269(), iLocal_296) > 200f)
				{
					func_2(4);
				}
			}
...
void func_211()
{
	...
	if (unk_0xDFB7BFA6482FEE1E() > iLocal_273)
	{
		if ((((func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296)) && unk_0xC49311A2A500FF09(iLocal_296, 0)) && !func_214()) && func_218(unk_0x7D2B9E6A64637269(), iLocal_296) < 10f)
		{
			iVar0 = unk_0x75B58B38E45C6F9A(iLocal_296, 0);
			if (func_8(iVar0) && !unk_0x2C10A11A684CFE96(unk_0x7D2B9E6A64637269(), iVar0))
			{
				if (unk_0xA6E8FBD68548675F(iVar0, unk_0x7D2B9E6A64637269(), 1))
				{
					...
					iLocal_273 = unk_0xDFB7BFA6482FEE1E() + 5000;
					unk_0xA5030CC1B9A0FDA6(iLocal_298);
				}
			}
...
void func_215()
{
	if (((func_9(iLocal_298) && func_533(iLocal_296)) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0)) && func_218(unk_0x7D2B9E6A64637269(), iLocal_296) < 10f)
	{
		if (unk_0xDFB7BFA6482FEE1E() > iLocal_258)
		{
			if (!func_214())
			{
				func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if ((func_216("MEA1_03", 0, 0) || func_216("MEA1_05", 0, 0)) || func_216("MEA1_06", 0, 0))
				{
					...
					{
						iLocal_258 = unk_0xDFB7BFA6482FEE1E() + 9000;
					}
				}
...
void func_221()
{
	unk_0x4B75B1FF20EA3A22(iLocal_296, func_226());
	unk_0x95C1F609605A12FF(iLocal_296, 0);
	unk_0xA571B9D2035E6945(iLocal_296, 1);
	unk_0x1D7A4E9E23D306D6(iLocal_296, 0);
	unk_0x472BD05C38FE7A6B(iLocal_296, 0);
	unk_0x4D63B727F53E09E9(iLocal_296, 0);
...
void func_233()
{
	...
	if (func_533(iLocal_296))
	{
		unk_0xA70AB8E887871101(iLocal_296, 1);
	}
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_257())
			{
				if (unk_0x0EC2B29D4172D225(sLocal_278))
				{
					unk_0xC63C967EC1D348E4(iLocal_296, sLocal_278, 1048576000);
				}
				iLocal_270 = unk_0xDFB7BFA6482FEE1E() + 20000;
		...
		case 1:
			if (iLocal_317)
			{
				if (unk_0xDFB7BFA6482FEE1E() > iLocal_246)
				{
					if (!func_214())
					{
						if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0))
						{
			...
			{
				iLocal_311 = unk_0xDFB7BFA6482FEE1E() + 1000;
				unk_0x13520157939D4329(unk_0x1146A9AE09CE2B14());
				iLocal_293 = 2;
			}
			break;
		...
		case 2:
			if (func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296))
			{
				...
				if (!unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
				{
					if (func_8(iLocal_298))
					{
						if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0))
						{
							func_257();
						}
					}
				...
				if (func_218(unk_0x7D2B9E6A64637269(), iLocal_296) > 15f)
				{
					func_237();
					iLocal_293 = 0;
					iLocal_292 = 5;
...
void func_234()
{
	if (func_533(iLocal_306) && func_218(unk_0x7D2B9E6A64637269(), iLocal_306) > 100f)
	{
		func_17(&iLocal_306, 0, 0, 1);
	}
	if (func_533(iLocal_302) && func_218(unk_0x7D2B9E6A64637269(), iLocal_302) > 100f)
	{
...
void func_235()
{
	...
	if (((iLocal_337 && !unk_0x123480158F10FA67()) && func_533(unk_0x7D2B9E6A64637269())) && func_533(iLocal_296))
	{
		if (unk_0x530FB711AE9CF518(unk_0x7D2B9E6A64637269()))
		{
			iVar0 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
			if ((func_8(iVar0) && !unk_0xF41EB7643E61A928(iLocal_296, iVar0, 1)) && !func_236(iVar0))
			{
...
void func_240()
{
	...
	{
		if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_310, 0) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_310, 0))
		{
			if (((unk_0x0D628BB90DA6214A(iLocal_310, 2, 5000) || unk_0x0D628BB90DA6214A(iLocal_310, 3, 5000)) || unk_0x0D628BB90DA6214A(iLocal_310, 0, 5000)) || unk_0x0D628BB90DA6214A(iLocal_310, 1, 5000))
			{
				if (iLocal_313 == iLocal_312)
				{
					iLocal_312++;
					iLocal_315 = unk_0xDFB7BFA6482FEE1E() + 5000;
				}
				else if (unk_0xDFB7BFA6482FEE1E() > iLocal_315 && !func_214())
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_243()
{
	...
	if (func_533(unk_0x7D2B9E6A64637269()) && unk_0xDFB7BFA6482FEE1E() > iLocal_311)
	{
		if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			iVar0 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
			if (iVar0 != iLocal_310)
			{
				...
				else
				{
					if (func_8(iLocal_310))
					{
						unk_0x795957CD3A0042C8(&iLocal_310);
					}
					iLocal_310 = iVar0;
				}
			}
...
void func_244()
{
	if ((((iLocal_272 < 3 && !func_214()) && func_242()) && func_245()) && unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
	{
		if (unk_0xDFB7BFA6482FEE1E() > iLocal_270)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_245()
{
	...
	{
		iVar0 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
		if (func_8(iVar0) && unk_0xF41EB7643E61A928(iLocal_296, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_246()
{
	...
	if ((((iLocal_261 < 3 && unk_0xDFB7BFA6482FEE1E() > iLocal_259) && func_242()) && unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0)) && func_245())
	{
		iVar0 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
		if (func_8(iVar0) && func_70(unk_0x6471F4759775FCA4(iVar0)))
		{
			bLocal_262 = unk_0xA47A27C1733E0E64(iVar0);
			if (bLocal_262)
			{
				if (!func_214() && bLocal_263 == 0)
				{
					...
					if (func_241(&uLocal_55, "MEA1AUD", "MEA1_SIREN", sLocal_260[iLocal_261], 7, 0, 0))
					{
						...
						iLocal_259 = unk_0xDFB7BFA6482FEE1E() + 9000;
					}
				}
			}
			else
	...
	else if (bLocal_263 && unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
	{
		iVar1 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
		if (func_8(iVar1) && func_70(unk_0x6471F4759775FCA4(iVar1)))
		{
			bLocal_263 = unk_0xA47A27C1733E0E64(iVar1);
		}
	}
}
...
void func_247()
{
	if (((iLocal_257 < 3 && unk_0xDFB7BFA6482FEE1E() > iLocal_254) && func_242()) && func_245())
	{
			...
			if (iLocal_255 > 180)
			{
				if (!func_214() && !func_216("MEA1_04", 0, 0))
				{
					...
					else if (func_241(&uLocal_55, "MEA1AUD", "MEA1_STILL", sLocal_256[iLocal_257], 7, 0, 0))
					{
						iLocal_257++;
						iLocal_255 = 0;
						iLocal_254 = unk_0xDFB7BFA6482FEE1E() + 9000;
					}
				}
			}
		}
...
void func_248()
{
	...
	if (((iLocal_253 < 4 && unk_0xDFB7BFA6482FEE1E() > iLocal_251) && func_242()) && func_245())
	{
		if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) && !unk_0xE6046EB2291D084D(unk_0x7D2B9E6A64637269()))
		{
			...
			if (func_8(iVar0))
			{
				if (unk_0x7919C1F1872DDE8E(iVar0))
				{
					if (!func_214())
					{
						if (((((iLocal_253 == 0 && func_8(iLocal_298)) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0)) && func_249(iLocal_296, 0) == 2) || (((iLocal_253 == 1 || iLocal_253 == 2) && unk_0xC49311A2A500FF09(iLocal_296, 0)) && (func_249(iLocal_296, 0) == 2 || func_249(iLocal_296, 0) == 1))) || (iLocal_253 == 3 && unk_0xEEA5947010767C07(unk_0x7D2B9E6A64637269())))
						{
							func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
							if (func_241(&uLocal_55, "MEA1AUD", "MEA1_CRASH", sLocal_252[iLocal_253], 7, 0, 0))
							{
								iLocal_253++;
								iLocal_251 = unk_0xDFB7BFA6482FEE1E() + 9000;
							}
						}
						else
						{
...
void func_250()
{
	if ((((iLocal_241 < 4 && !func_214()) && func_242()) && (func_245() || func_251())) && unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
	{
		if (iLocal_242 == iLocal_241)
		{
			iLocal_241++;
			iLocal_246 = unk_0xDFB7BFA6482FEE1E() + 2000;
		}
		else if (unk_0xDFB7BFA6482FEE1E() > iLocal_246)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_251()
{
	if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) || unk_0xC49311A2A500FF09(iLocal_296, 0))
	{
		return 0;
	}
	return 1;
...
void func_252()
{
	if (iLocal_324)
	{
		if (func_214())
		{
			if (unk_0xDFB7BFA6482FEE1E() > iLocal_327)
			{
				unk_0xE2D24A37AFCF27BF(uLocal_326, "MICHAEL_EVENT_AMANDA_REMOVE_HANDCUFFS_MASTER", iLocal_296, 0, 0, 0);
				iLocal_324 = 0;
			}
		}
	}
		...
		else if (!func_214())
		{
			...
			if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0) && unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0))
			{
				if (func_258(&uLocal_55, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_53(&iLocal_332, 5000))
				{
					...
					unk_0xDDFB0D5F3D3B74AA(0, unk_0x9E695CE384C77EF0(iLocal_298, 2f, 2f, 0f), 2000, 2050, 4);
					...
					unk_0x8A1AC8EBC73850C8(iLocal_296, uVar0);
					unk_0x8D5B447F21217223(&uVar0);
					iLocal_327 = unk_0xDFB7BFA6482FEE1E() + 9000;
					iLocal_324 = 1;
					return 1;
				}
			}
...
void func_262()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_223(&uLocal_343);
			iLocal_293 = 1;
			iLocal_291 = unk_0xDFB7BFA6482FEE1E() + 10000;
			iLocal_332 = -1;
			break;
		...
		case 1:
			...
			if (iLocal_325)
			{
				...
				{
					uLocal_326 = unk_0x5AD02BBC63E31E46();
					iLocal_325 = 0;
				}
			}
			func_268();
			if (func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296))
			{
				...
				if (unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
				{
					if (func_218(unk_0x7D2B9E6A64637269(), iLocal_296) > (15f * 2f))
					{
						func_237();
						iLocal_293 = 0;
						iLocal_292 = 5;
				...
				else if (((func_8(iLocal_298) && unk_0x2C10A11A684CFE96(iLocal_296, iLocal_298)) && !unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0)) && !func_261(iLocal_298))
				{
					func_237();
					iLocal_293 = 0;
					iLocal_292 = 5;
	...
	func_235();
	func_211();
	if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0) || unk_0x591190E69BE43117(iLocal_296, -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0))
	{
...
void func_263()
{
	if (func_533(iLocal_296) && !unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
	{
		if (func_8(iLocal_298))
		{
			if (((unk_0x0D628BB90DA6214A(iLocal_298, 2, 30000) || unk_0x0D628BB90DA6214A(iLocal_298, 3, 30000)) || unk_0x0D628BB90DA6214A(iLocal_298, 0, 7000)) || unk_0x0D628BB90DA6214A(iLocal_298, 1, 40000))
			{
				func_2(5);
			}
		}
...
void func_264()
{
	if (((((func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_302)) && !unk_0x2AB8EC6521549BAD(iLocal_302)) && !unk_0x674642CC58396437(iLocal_302)) && !unk_0x28E91B800C85243D(iLocal_302)) && !unk_0x6B9E71121F5B8154(iLocal_302))
	{
		if (unk_0xDFB7BFA6482FEE1E() > iLocal_291)
		{
			if (!func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0x83B972AB639B4420(iLocal_302, 1);
				unk_0xD82D50E4AC0D46B9(iLocal_302, joaat("weapon_pistol"), -1, 0, 1);
			}
			if (!unk_0x3D28F4F0775C6C2A(iLocal_302, 0))
			{
				unk_0xCA089CD1A17D76DF(iLocal_302);
				unk_0xC74074470B4DB0EF(iLocal_302, unk_0x7D2B9E6A64637269());
...
void func_265()
{
	if (((((iLocal_266 < 9 && !func_214()) && func_242()) && func_245()) && unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0) && !func_267(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xDFB7BFA6482FEE1E() > iLocal_264)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			iLocal_268 = unk_0xB36B8558948EA7A8(0, 4);
			...
			{
				iLocal_264 = unk_0xDFB7BFA6482FEE1E() + 9000;
				iLocal_266++;
...
void func_268()
{
	...
	{
		if ((func_270(iLocal_306, 1090519040, 1097859072) || unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269())) || (func_533(iLocal_302) && unk_0x7F716EA884E75E49(iLocal_302)))
		{
			if (unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_233, 2))
			{
				unk_0x90ED32458AC2D129(iLocal_306, -8f, 1);
			}
			unk_0x1DC2BF231DE6A016(iLocal_306, unk_0x7D2B9E6A64637269(), 500f, -1, 0, 0);
			func_269(1);
		}
	}
}
...
{
	if (((((func_533(iLocal_302) && func_533(unk_0x7D2B9E6A64637269())) && !unk_0x2AB8EC6521549BAD(iLocal_302)) && !unk_0x674642CC58396437(iLocal_302)) && !unk_0x28E91B800C85243D(iLocal_302)) && !unk_0x6B9E71121F5B8154(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			unk_0x83B972AB639B4420(iLocal_302, 1);
	...
	if ((func_533(iLocal_306) && !unk_0x11DBA82F76F3C4C2(iLocal_306)) && !unk_0x3D28F4F0775C6C2A(iLocal_306, 0))
	{
		if (unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_233, 2))
		{
			unk_0x90ED32458AC2D129(iLocal_306, -8f, 1);
...
int func_273(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_207(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_275()
{
	if ((iLocal_320 && unk_0xDFB7BFA6482FEE1E() > iLocal_316) && func_245())
	{
		func_6(&uLocal_55, 4);
...
void func_276()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_365();
			iLocal_248 = unk_0xDFB7BFA6482FEE1E() + 7000;
			iVar0 = unk_0x0BF0F8F3AD0993F6();
			if (func_8(iVar0) && unk_0x6471F4759775FCA4(iVar0) != iLocal_299)
			{
		...
		case 1:
			...
			func_302();
			func_298();
			if (((func_533(unk_0x7D2B9E6A64637269()) && func_8(iLocal_298)) && unk_0xA6E8FBD68548675F(iLocal_298, unk_0x7D2B9E6A64637269(), 1)) && !unk_0x6B9E71121F5B8154(unk_0x7D2B9E6A64637269()))
			{
				unk_0xA2C015B68CE01357(iLocal_298, 0);
				func_269(1);
			}
			func_306();
			break;
		...
		case 2:
			if (func_8(iLocal_298))
			{
				if (func_533(iLocal_302))
				{
					...
					{
						func_297();
						iLocal_316 = unk_0xDFB7BFA6482FEE1E() + 1000;
						iLocal_221 = 4;
						iLocal_234 = 5;
					}
				}
...
void func_277()
{
	...
	if (func_280(unk_0x7D2B9E6A64637269(), Local_222, 100f))
	{
		if (iLocal_323)
		{
			func_279(0);
	...
	else if (func_214())
	{
		if (!iLocal_323)
		{
			Var0 = { func_231() };
			sVar1 = func_278(&Var0);
			if (unk_0xDA654EB115F9FF7D(sVar1, "MEA1_SCENE"))
			{
				func_279(1);
				iLocal_323 = 1;
			}
...
void func_281()
{
	...
	iVar0 = unk_0x0BF0F8F3AD0993F6();
	if (((((unk_0xECEC7528A52B4EE8(iLocal_302) || unk_0xECEC7528A52B4EE8(iLocal_306)) || func_283(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_283(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(iVar0) && func_8(iLocal_298)) && unk_0x83B12E293561B796(iVar0, iLocal_298))) || (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0 && unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_281, 1) < 30f))
	{
		if (!unk_0xF41EB7643E61A928(iLocal_296, iLocal_298, 0))
		{
			if (!unk_0xAB3E7E62A69D0DB3(iLocal_296, func_226()))
			{
				func_237();
				iLocal_221 = 5;
				iLocal_234 = 5;
				if (unk_0xEEC203A73BC92E7E(uLocal_220))
				{
					fVar1 = unk_0x0BC8768247440B3A(uLocal_220);
					unk_0x90ED32458AC2D129(iLocal_296, -1000f, 1);
					unk_0x90ED32458AC2D129(iLocal_298, -1000f, 1);
					if (fVar1 > 0.75f)
					{
						unk_0x90ED32458AC2D129(iLocal_296, -1000f, 0);
						func_282(iLocal_296, iLocal_298, 2, 0);
					}
					else
					{
						unk_0x90ED32458AC2D129(iLocal_296, -1000f, 1);
						unk_0x3CBE9F07524C242D(iLocal_296, 1, 0);
					}
					if (func_533(iLocal_302))
					{
						unk_0x90ED32458AC2D129(iLocal_302, -1000f, 1);
					}
					if (func_533(iLocal_306))
					{
						unk_0x90ED32458AC2D129(iLocal_306, -1000f, 1);
					}
				}
				unk_0xA2C015B68CE01357(iLocal_296, 0);
				unk_0xA2C015B68CE01357(iLocal_298, 0);
				if ((func_8(iVar0) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iVar0, 0)) && unk_0x9B73EB6255D4AE81(iVar0, 0, 0))
				{
					...
					{
						unk_0x95CA4545D0C61309(iLocal_296, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_218(iLocal_296, unk_0x7D2B9E6A64637269()) > 10f)
				{
					if (!func_52(iLocal_296, 1227113341))
					{
						unk_0xF0ED372419FE0E70(iLocal_296, unk_0x7D2B9E6A64637269(), 20000, 7f, 1073741824, 1073741824, 0);
					}
				}
				else
				{
					unk_0xCA089CD1A17D76DF(iLocal_296);
				}
				func_221();
				func_35(&iLocal_295);
				iLocal_322 = 1;
...
void func_297()
{
	...
	if (func_533(unk_0x7D2B9E6A64637269()))
	{
		...
		else
		{
			...
			if (func_533(iLocal_296))
			{
				unk_0x880C7B361C9651EE(iLocal_296);
			}
			unk_0x58D4F7C6214FFC91(Local_329, Local_330, fLocal_331, 1);
			iLocal_325 = 1;
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_533(iLocal_302) && !unk_0x2AB8EC6521549BAD(iLocal_302)) && !unk_0x674642CC58396437(iLocal_302)) && !unk_0x28E91B800C85243D(iLocal_302)) && !unk_0x6B9E71121F5B8154(iLocal_302))
			{
				if (!func_52(iLocal_302, 1392476864))
				{
					if (unk_0x698F51FB33ADAF7B(iLocal_302, sLocal_277, sLocal_228, 2) || unk_0x698F51FB33ADAF7B(iLocal_302, sLocal_277, sLocal_232, 2))
					{
						unk_0x90ED32458AC2D129(iLocal_302, -8f, 1);
					}
					unk_0x5C679902079A7E80(&uVar0);
					unk_0xB0C1A43193C25F7A(0, unk_0x7D2B9E6A64637269(), 1500);
					unk_0xC74074470B4DB0EF(0, unk_0x7D2B9E6A64637269());
					unk_0x1BBD0A5729AB1226(uVar0);
					unk_0x8A1AC8EBC73850C8(iLocal_302, uVar0);
					unk_0x8D5B447F21217223(&uVar0);
				}
			}
			if (func_533(iLocal_306) && !unk_0x11DBA82F76F3C4C2(iLocal_306))
			{
				if (unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0x698F51FB33ADAF7B(iLocal_306, sLocal_277, sLocal_233, 2))
				{
					unk_0x90ED32458AC2D129(iLocal_306, -8f, 1);
...
void func_298()
{
	...
	if (((func_8(iLocal_298) && func_533(unk_0x7D2B9E6A64637269())) && func_533(iLocal_302)) && func_533(iLocal_306))
	{
		switch (iLocal_250)
		{
			case 0:
				if (func_214())
				{
					...
					{
						Local_249 = { func_301() };
						if ((((((((func_300(unk_0x7D2B9E6A64637269(), iLocal_298, 5f, 1) || func_300(unk_0x7D2B9E6A64637269(), iLocal_302, 5f, 1)) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_1")) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_2")) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_3")) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_4")) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_5")) && !unk_0xDA654EB115F9FF7D(&Local_249, "MEA1_SCENE_6")) && func_285(iLocal_302, 1126825984))
						{
			...
			case 1:
				fVar2 = func_219(unk_0x7D2B9E6A64637269(), iLocal_302, 1);
				fVar3 = func_219(unk_0x7D2B9E6A64637269(), iLocal_298, 1);
				bVar4 = false;
				func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if (fVar2 < fVar3)
				{
				...
				if (bVar4)
				{
					unk_0x8ADA462BC5F42FD8(iLocal_302, unk_0x7D2B9E6A64637269(), 2000, 2048, 4);
					iLocal_250 = 2;
				}
				break;
			...
			case 2:
				if (!func_214())
				{
					if (!unk_0xDA654EB115F9FF7D(&Local_249, "") && !unk_0xDA654EB115F9FF7D(&Local_249, "NULL"))
					{
						func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_302()
{
	...
	if (func_533(unk_0x7D2B9E6A64637269()) && iLocal_221 != 5)
	{
		bVar0 = false;
		if ((func_533(iLocal_302) && unk_0x83B12E293561B796(unk_0x7D2B9E6A64637269(), iLocal_302)) || (((func_533(iLocal_306) && unk_0x83B12E293561B796(unk_0x7D2B9E6A64637269(), iLocal_306)) && !((func_283(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_283(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269()))) && unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) == 0))
		{
			if (unk_0x6B9E71121F5B8154(iLocal_302) || unk_0x6B9E71121F5B8154(iLocal_306))
			{
				bVar0 = true;
			}
			else if (iLocal_335)
		...
		if (((((((((((unk_0x419E13582192CFEA(iLocal_302) && unk_0xA6E8FBD68548675F(iLocal_302, unk_0x7D2B9E6A64637269(), 1)) || (unk_0x419E13582192CFEA(iLocal_302) && unk_0xECEC7528A52B4EE8(iLocal_302))) || func_295(iLocal_302, 1, 0, 0, 0)) || func_284(iLocal_302, 1126825984)) || func_284(iLocal_306, 1126825984)) || (unk_0x419E13582192CFEA(iLocal_306) && unk_0xA6E8FBD68548675F(iLocal_306, unk_0x7D2B9E6A64637269(), 1))) || (unk_0x419E13582192CFEA(iLocal_306) && unk_0xECEC7528A52B4EE8(iLocal_306))) || unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269())) || bVar0) || func_270(iLocal_306, 1090519040, 1097859072)) || unk_0x7F716EA884E75E49(unk_0x7D2B9E6A64637269()))
		{
			unk_0xA48693249537873E(Local_279, Local_280, 0);
			unk_0x9469E3DA4B5A7A39(Local_279, Local_280, 1, 0);
			if (bVar0)
			...
			if ((((func_533(iLocal_302) && !unk_0x2AB8EC6521549BAD(iLocal_302)) && !unk_0x674642CC58396437(iLocal_302)) && !unk_0x28E91B800C85243D(iLocal_302)) && !unk_0x6B9E71121F5B8154(iLocal_302))
			{
				...
				if (!unk_0x3D28F4F0775C6C2A(iLocal_302, 0) && !func_52(iLocal_302, 1392476864))
				{
					func_237();
					unk_0x83B972AB639B4420(iLocal_302, 1);
					unk_0xD82D50E4AC0D46B9(iLocal_302, joaat("weapon_pistol"), -1, 0, 1);
...
void func_303()
{
	if ((func_533(unk_0x7D2B9E6A64637269()) && func_8(iLocal_298)) && func_533(iLocal_296))
	{
		if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 0) || func_261(iLocal_298))
		{
			func_237();
			func_35(&iLocal_295);
			unk_0xA2C015B68CE01357(iLocal_298, 0);
		...
		else if (func_300(unk_0x7D2B9E6A64637269(), iLocal_298, 6.5f, 1))
		{
			if (iLocal_321)
			{
				unk_0xA2C015B68CE01357(iLocal_298, 0);
		...
		{
			unk_0xA2C015B68CE01357(iLocal_298, 1);
			iLocal_321 = 1;
		}
	}
}
...
void func_304()
{
	if ((((func_533(iLocal_302) && func_533(iLocal_306)) && func_533(iLocal_296)) && func_8(iLocal_298)) && unk_0x0EC2B29D4172D225(sLocal_277))
	{
		switch (iLocal_221)
		{
			case 0:
				func_305();
				uLocal_220 = unk_0xD955F1CC0BCABC78(Local_222, Local_223, 2);
				unk_0xB9314D20143CEED3(uLocal_220, 1);
				unk_0x1C6FA6A93BF99EA4(uLocal_220, 0);
				iLocal_328 = 1;
				unk_0xAD844C8843FC405C(iLocal_302, uLocal_220, sLocal_277, sLocal_224, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xAD844C8843FC405C(iLocal_306, uLocal_220, sLocal_277, sLocal_225, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xAD844C8843FC405C(iLocal_296, uLocal_220, sLocal_277, sLocal_226, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xED3365BAA5895E01(iLocal_298, uLocal_220, sLocal_227, sLocal_277, 1000f, -8f, 1, 1148846080);
				iLocal_333 = -1;
				iLocal_234 = 1;
				iLocal_221 = 2;
				break;
			...
			case 1:
				func_305();
				uLocal_220 = unk_0xD955F1CC0BCABC78(Local_222, Local_223, 2);
				unk_0xB9314D20143CEED3(uLocal_220, 0);
				unk_0x1C6FA6A93BF99EA4(uLocal_220, 0);
				unk_0xAD844C8843FC405C(iLocal_302, uLocal_220, sLocal_277, sLocal_228, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0xAD844C8843FC405C(iLocal_306, uLocal_220, sLocal_277, sLocal_229, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xAD844C8843FC405C(iLocal_296, uLocal_220, sLocal_277, sLocal_230, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0xED3365BAA5895E01(iLocal_298, uLocal_220, sLocal_231, sLocal_277, 1000f, -8f, 1, 1148846080);
				unk_0xE9F198943372703F(uLocal_220, 0.622f);
				iLocal_221 = 3;
				break;
			...
			case 3:
				...
				if (!unk_0xEEC203A73BC92E7E(uLocal_220))
				{
					uLocal_220 = unk_0xD955F1CC0BCABC78(Local_222, Local_223, 2);
					unk_0xB9314D20143CEED3(uLocal_220, 1);
					unk_0xAD844C8843FC405C(iLocal_302, uLocal_220, sLocal_277, sLocal_232, 1000f, -4f, 1, 16, 1148846080, 0);
					unk_0xAD844C8843FC405C(iLocal_306, uLocal_220, sLocal_277, sLocal_233, 1000f, -4f, 1, 16, 1148846080, 0);
					if (unk_0x9B73EB6255D4AE81(iLocal_298, 2, 0))
					{
						unk_0xB1D85A6C23F2F945(iLocal_296, iLocal_298, 2);
						unk_0x616B09EEEFED8FAF(iLocal_298, 3, 1);
						unk_0x764D10CFB2EDD065(iLocal_298, 1);
						unk_0x8ADA462BC5F42FD8(iLocal_296, unk_0x7D2B9E6A64637269(), -1, 2050, 4);
					}
					if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_298, 1))
					{
				...
				else if (unk_0x0BC8768247440B3A(uLocal_220) >= 0.9f)
				{
					if (unk_0x698F51FB33ADAF7B(iLocal_296, sLocal_277, sLocal_230, 2))
					{
						unk_0x90ED32458AC2D129(iLocal_296, -1000f, 0);
						if (unk_0x9B73EB6255D4AE81(iLocal_298, 2, 0))
						{
				...
				else if (unk_0x0BC8768247440B3A(uLocal_220) >= 0.85f)
				{
					if (unk_0x698F51FB33ADAF7B(iLocal_298, sLocal_277, sLocal_231, 2))
					{
						unk_0x3CBE9F07524C242D(iLocal_296, 0, 0);
						unk_0x90ED32458AC2D129(iLocal_298, -4f, 1);
						unk_0x616B09EEEFED8FAF(iLocal_298, 3, 1);
					}
				}
				break;
			...
			case 4:
				...
				if (func_533(iLocal_302))
				{
					unk_0xB0C1A43193C25F7A(iLocal_302, unk_0x7D2B9E6A64637269(), -1);
				}
				iLocal_221 = 5;
				break;
			}
	...
	switch (iLocal_234)
	{
		...
		case 1:
			if (!func_214())
			{
				...
				{
					if (func_280(unk_0x7D2B9E6A64637269(), Local_222, 90f))
					{
						func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				...
				else if (func_280(unk_0x7D2B9E6A64637269(), Local_222, (90f * 2f)))
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 2:
			if (!func_214())
			{
				if ((func_280(unk_0x7D2B9E6A64637269(), Local_222, 90f) && !func_216("MEA1_02", 0, 0)) && !func_216("MEA1_03", 0, 0))
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 3:
			if (func_214())
			{
				...
				{
					Local_235 = { func_230() };
					if (unk_0xDA654EB115F9FF7D(&Local_235, "") || unk_0xDA654EB115F9FF7D(&Local_235, "NULL"))
					{
						iLocal_234 = 5;
					}
					else
		...
		case 4:
			if (func_214())
			{
				if (!func_280(unk_0x7D2B9E6A64637269(), Local_222, 91f))
				{
					Local_235 = { func_230() };
					if (unk_0xDA654EB115F9FF7D(&Local_235, "") || unk_0xDA654EB115F9FF7D(&Local_235, "NULL"))
					{
...
void func_310()
{
	...
	{
		if (unk_0xF41EB7643E61A928(iLocal_302, iLocal_298, 0))
		{
			unk_0xA2C015B68CE01357(iLocal_298, 0);
			if (func_52(iLocal_302, -258271821))
			{
				if (unk_0xDFB7BFA6482FEE1E() > iLocal_286)
				{
					func_2(3);
				}
			}
			...
			{
				unk_0x0509CE092AC81B7C(iLocal_302, iLocal_298, 30f, 786469);
				iLocal_286 = unk_0xDFB7BFA6482FEE1E() + 2000;
			}
		}
	}
}
...
void func_311()
{
	...
	if (iLocal_319)
	{
		unk_0xA48693249537873E(Local_279, Local_280, 0);
		unk_0x9469E3DA4B5A7A39(Local_279, Local_280, 1, 0);
		if ((func_533(iLocal_302) && func_8(iLocal_298)) && unk_0x9B73EB6255D4AE81(iLocal_298, -1, 0))
		{
			func_237();
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			...
			{
				unk_0x5C679902079A7E80(&uVar0);
				unk_0x95CA4545D0C61309(0, iLocal_298, 20000, -1, 1f, 1, 0);
				unk_0x0509CE092AC81B7C(0, iLocal_298, 50f, 786597);
				unk_0x1BBD0A5729AB1226(uVar0);
				unk_0x8A1AC8EBC73850C8(iLocal_302, uVar0);
				unk_0x8D5B447F21217223(&uVar0);
				unk_0xA2C015B68CE01357(iLocal_298, 0);
	...
	if (unk_0x419E13582192CFEA(unk_0x0BF0F8F3AD0993F6()))
	{
		if (unk_0xBFCE58B2B3249999(unk_0x0BF0F8F3AD0993F6(), 0))
		{
			if (func_364(24) != unk_0x0BF0F8F3AD0993F6())
			{
				if (iParam2 == 1)
				{
					if (func_361(unk_0xD6E677FAD7521410(unk_0x0BF0F8F3AD0993F6(), 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_315(unk_0x0BF0F8F3AD0993F6(), Param0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_339(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_366(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_418(unk_0x471C98FD94C0A5FD(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_416(&(Global_99370.f_3));
				if (iVar6 > -1)
				{
...
void func_383(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_385(Var7.f_1)) && iVar9 < 51)
			{
...
void func_428()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			unk_0xDD944E3FD2028A48(iLocal_295, "MEA1_AMA");
			unk_0xFA3E6ADC3E5D386E(iLocal_295, 3);
			unk_0x13CC211F9F7ACE7F(iLocal_295, 1);
			func_435(&iLocal_295, -838.47f, -177.11f, 36.92f, 31.44f);
			func_433();
			iLocal_246 = unk_0xDFB7BFA6482FEE1E() + 10000;
			iLocal_244 = -1;
			iLocal_245 = -1;
			iLocal_322 = 0;
			iLocal_323 = 0;
		...
		case 1:
			if (func_533(unk_0x7D2B9E6A64637269()))
			{
				if (unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_281, 1) < 200f)
				{
					iLocal_293 = 2;
				}
			}
		...
		case 2:
			func_430();
			if ((((func_533(unk_0x7D2B9E6A64637269()) && func_533(iLocal_296)) && unk_0x419E13582192CFEA(iLocal_306)) && unk_0x419E13582192CFEA(iLocal_302)) && func_8(iLocal_298))
			{
				if (unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_281, 1) < 30f)
				{
					iLocal_332 = -1;
					iLocal_293 = 0;
					iLocal_292 = 2;
...
void func_429()
{
	if ((((iLocal_244 < 1 && func_533(unk_0x7D2B9E6A64637269())) && !func_214()) && !func_216("MEA1_01", 0, 0)) && unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_281, 1) > (30f * 3f))
	{
...
void func_430()
{
	if (!unk_0x419E13582192CFEA(iLocal_298))
	{
		if (unk_0xA9C0BBFB9CBB66F1(iLocal_299))
		{
			iLocal_298 = unk_0x170478CC84C8AE2F(iLocal_299, Local_300, fLocal_301, 1, 1, 0);
			unk_0x89E171705EA920DA(iLocal_298, 1, 1, 0);
			unk_0xA2C015B68CE01357(iLocal_298, 1);
			unk_0x9F6498B97F642B82(iLocal_298, 0);
			unk_0x764D10CFB2EDD065(iLocal_298, 0);
			unk_0xB021D5C8EC8634FA(iLocal_298, 2, true);
			iLocal_321 = 1;
			unk_0x824F744352C8BC82(iLocal_299);
			unk_0x6FF312B4049B4865(Local_329, Local_330, fLocal_331, 0, 0, 1);
		}
	}
	if (!unk_0x419E13582192CFEA(iLocal_296))
	{
		if (func_8(iLocal_298) && unk_0xA9C0BBFB9CBB66F1(func_16(17)))
		{
			func_431(&iLocal_296, 17, iLocal_298, 2, 1);
			unk_0x145AB994058F1720(iLocal_296, 2, 4, 0);
			unk_0x145AB994058F1720(iLocal_296, 3, 5, 0);
			unk_0x145AB994058F1720(iLocal_296, 4, 5, 0);
			unk_0x145AB994058F1720(iLocal_296, 8, 1, 0);
			unk_0x145AB994058F1720(iLocal_296, 1, 0, 0);
			unk_0x145AB994058F1720(iLocal_296, 10, 1, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 2, 4, 0, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 3, 5, 0, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 4, 5, 0, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 8, 1, 0, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 1, 0, 0, 0);
			unk_0x4170FE884DF7426D(iLocal_296, 10, 1, 0, 0);
			unk_0xC8749D706BBF16E1(iLocal_296, 1, 0, 0, false);
			unk_0x1D7A4E9E23D306D6(iLocal_296, 0);
			unk_0x7B28A83A0D3DD0F9(iLocal_296, 29, 0);
			unk_0x7B28A83A0D3DD0F9(iLocal_296, 116, 0);
			unk_0x7B28A83A0D3DD0F9(iLocal_296, 104, 1);
			unk_0xBE91B077ADADE97F(iLocal_296, 1);
			unk_0x2271ED1E65FB75EE(unk_0x7D2B9E6A64637269(), uLocal_297);
			unk_0x2271ED1E65FB75EE(iLocal_296, uLocal_297);
			unk_0x472BD05C38FE7A6B(iLocal_296, 1);
			unk_0x4D63B727F53E09E9(iLocal_296, 1);
			unk_0xA70AB8E887871101(iLocal_296, 1);
			iLocal_221 = 0;
		}
	}
	if (!unk_0x419E13582192CFEA(iLocal_302))
	{
		...
		{
			iLocal_302 = unk_0x0FDCFECB2EF2BC1C(6, iLocal_303, Local_304, fLocal_305, 1, 1);
			func_69(&uLocal_55, 6, iLocal_302, "MEAmandaCop", 1, 1);
			unk_0x83B972AB639B4420(iLocal_302, 0);
			unk_0xC8749D706BBF16E1(iLocal_302, 1, 0, 0, false);
			unk_0xF8207455457B967E(iLocal_302, 25);
			unk_0xDB8D6815E13996A9(iLocal_302, Local_304, 0, 0, 1);
			unk_0xC595907BB71C921D(iLocal_302, 110, 0);
			unk_0x824F744352C8BC82(iLocal_303);
		}
	}
	if (!unk_0x419E13582192CFEA(iLocal_306))
	{
		...
		{
			iLocal_306 = unk_0x0FDCFECB2EF2BC1C(4, iLocal_307, Local_308, fLocal_309, 1, 1);
			unk_0xBE91B077ADADE97F(iLocal_306, 1);
			unk_0xDB8D6815E13996A9(iLocal_306, Local_308, 0, 0, 1);
			func_69(&uLocal_55, 5, iLocal_306, "MEAmandaShop", 1, 1);
			unk_0x824F744352C8BC82(iLocal_307);
			unk_0x91F94D2287684BDB(Local_304, 50f, 0);
			unk_0xA48693249537873E(Local_279, Local_280, 1);
			unk_0x9469E3DA4B5A7A39(Local_279, Local_280, 0, 0);
			unk_0x494E8A58F41F5F54(Local_279, Local_280);
			unk_0x0823FA7465392E20(Local_279, Local_280, 0, 1, 1, 1);
		}
	}
}
...
void func_433()
{
	...
	unk_0x16E516CA9C88FF48(iLocal_303);
	func_434(func_16(17));
	unk_0x16E516CA9C88FF48(iLocal_307);
	unk_0x068BDE31F7D112BB(sLocal_277);
	unk_0x068BDE31F7D112BB(sLocal_278);
}
...
void func_436()
{
	...
	if (unk_0x080D38ACEC5DC1A2(0))
	{
		if (func_533(unk_0x7D2B9E6A64637269()))
		{
			func_69(&uLocal_55, 0, unk_0x7D2B9E6A64637269(), "MICHAEL", 1, 1);
			unk_0xA70AB8E887871101(unk_0x7D2B9E6A64637269(), 1);
		}
		func_69(&uLocal_55, 4, 0, "AMANDA", 0, 1);
		if (func_533(unk_0x7D2B9E6A64637269()))
		{
			uLocal_297 = unk_0x5FB5CBC5FDADA3C9(unk_0x7D2B9E6A64637269());
		}
...
{
	return func_511(&(Global_105842.f_2890), Param0, fParam1, 0);
}
...
int func_513(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_514(iParam0, uVar1[iVar3], 1) && func_458(unk_0xD6E677FAD7521410(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_354(Param1, 0f, 0f, 0f, 0)) || unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(iParam0, 1), unk_0xD6E677FAD7521410(uVar1[iVar3], 1), 1) < 10f)
					{
						unk_0x5420D0D520CF44D0(&iParam0);
						return 1;
					}
...
void func_530()
{
	...
	fVar0 = func_531(unk_0x7D2B9E6A64637269(), Local_281, 1);
...
void func_532()
{
	if (func_533(iLocal_296))
	{
		if (iLocal_328)
		{
			if (unk_0xC49311A2A500FF09(iLocal_296, 0))
			{
				unk_0x4170FE884DF7426D(iLocal_296, 8, 0, 0, 0);
				iLocal_328 = 0;
			}
		}
		else if (!unk_0xC49311A2A500FF09(iLocal_296, 1))
		{
			unk_0x4170FE884DF7426D(iLocal_296, 8, 1, 0, 0);
			iLocal_328 = 1;
		}
