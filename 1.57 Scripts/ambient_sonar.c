...
void func_1()
{
	...
	if (func_109(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
		{
			...
			{
				uLocal_49 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
				func_125(1);
				func_13(0);
				if (func_109(unk_0x7D2B9E6A64637269()))
				{
					if (func_11(&Local_42, &Local_48, unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), &iLocal_54))
					{
						func_8();
					}
				}
			...
			{
				if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(uLocal_49, 1)) > 62500f)
				{
					func_5();
				}
				else if (!unk_0x575B7C28D81C0B4D(uLocal_50))
				{
					...
					unk_0x252BE56DB93DF816(uLocal_50, 308);
				}
			}
			else
			{
...
{
	func_7();
	if (unk_0x419E13582192CFEA(uLocal_49))
	{
		unk_0x795957CD3A0042C8(&uLocal_49);
	}
}
...
void func_90(int iParam0, bool bParam1)
{
	...
	if (iLocal_58[iParam0] == -1)
	{
		...
		{
			if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_48[iParam0 /*11*/].f_3) < (100f * 100f))
			{
				if (func_91(&iVar0))
				{
					unk_0x0EA07962994F9247(iVar0, Local_48[iParam0 /*11*/].f_3, 8f);
	...
	{
		if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_48[iParam0 /*11*/].f_3) > (105f * 105f))
		{
			if (iLocal_58[iParam0] >= 0 && iLocal_58[iParam0] < 8)
			{
				unk_0xEC59B73A84DB7C06(iLocal_58[iParam0]);
				iLocal_58[iParam0] = -1;
			}
		}
	}
...
int func_93(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((vdist2(Param2, unk_0xCA4950AD4AC0DAD8((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_17(13)) || func_17(14))
		{
...
void func_127()
{
	...
	while (iVar0 < Local_48)
	{
		...
		{
			unk_0xEC59B73A84DB7C06(iLocal_58[iVar0]);
		}
		iVar0++;
	}
