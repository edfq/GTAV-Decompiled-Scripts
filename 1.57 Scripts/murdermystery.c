...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_76(iLocal_71))
			{
				if (((func_73() && !func_72()) && func_71()) && !func_70(0))
				{
					if (iLocal_73 != 0)
					{
						if (unk_0xB0307F369363B547(iLocal_73))
						{
		...
		case 4:
			...
			{
				unk_0x7979149EE8FE954D(uLocal_66, 0.75f);
			}
			if (!func_76(4))
			{
		...
		case 6:
			...
			if (!func_34(2))
			{
				...
				{
					unk_0xD2FBB949CDCF79AB(Local_58, 200f, joaat("prop_mineshaft_door"), 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		unk_0x191DDA30577F440A(&uLocal_78, iParam0);
	}
	else
	{
		unk_0xC664C0067EEAB8D1(&uLocal_78, iParam0);
	}
}

bool func_34(int iParam0)
{
	return unk_0x234B68AC2E35ED5A(uLocal_78, iParam0);
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_51, Local_57, 1, 1, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_52, Local_57, 1, 1, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(unk_0x7D2B9E6A64637269(), Local_55, fLocal_56);
				...
				unk_0x22C43B6780E8FE5B(Local_55, 20f, 0);
				func_39(24, &iLocal_59);
				unk_0x0EFDA7B3FFAA82B3(iLocal_59);
				iLocal_72 = (unk_0xDFB7BFA6482FEE1E() + 40000);
				while ((!unk_0xABE4F4FD4329B037() || !unk_0xC4EACCE45DBAA313(iLocal_59)) && iLocal_72 > unk_0xDFB7BFA6482FEE1E())
				{
					wait(0);
				}
				unk_0xED93DAC36CA89AF2();
				if (iLocal_72 <= unk_0xDFB7BFA6482FEE1E())
				{
					unk_0x8BAFB6B897BD2A31(iLocal_59);
					func_44(unk_0x7D2B9E6A64637269(), Local_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_49()
{
	...
	{
		case 0:
			if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Var0, Var1, fVar2, 0, 1, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
		...
		case 2:
			...
			if (unk_0x86AF801D34E482FF(2, 51))
			{
				...
				{
					iLocal_72 = unk_0xDFB7BFA6482FEE1E() + 300;
...
int func_63()
{
	...
	if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		...
		if (!bParam2)
		{
			unk_0x9B0169E27978C1A2(uLocal_69, sLocal_67, sLocal_68, 0);
		}
		func_69();
	}
	else
...
void func_82()
{
	if (func_67(unk_0x7D2B9E6A64637269()))
	{
		Local_70 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			...
			func_85(sLocal_74);
			uLocal_66 = unk_0x0FDCFECB2EF2BC1C(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, 1);
			unk_0x824F744352C8BC82(joaat("u_f_m_drowned_01"));
			unk_0x4261814A9A26E86F(uLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			unk_0xBE91B077ADADE97F(uLocal_66, 1);
			unk_0x504B26425DFF773C(uLocal_66, 1);
			unk_0xA2C015B68CE01357(uLocal_66, 1);
			unk_0x05D0B763CEEA9ABD(uLocal_66, 1);
			unk_0xDBF5BCD703020A83(uLocal_66, 1);
			unk_0x7B28A83A0D3DD0F9(uLocal_66, 118, 0);
			unk_0x7B28A83A0D3DD0F9(uLocal_66, 208, 1);
			unk_0x8F160110753EB17B(uLocal_66, 1);
			unk_0x2271ED1E65FB75EE(uLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			unk_0x94F284E4B5633B45(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
			unk_0x1EA8B94F4F446F35(iLocal_63, 1, 1, 0);
			uLocal_62 = unk_0x1CA878DB277C6DF0(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(joaat("u_m_o_filmnoir"));
			uLocal_64 = unk_0x0FDCFECB2EF2BC1C(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, 1);
			unk_0xC8749D706BBF16E1(uLocal_64, 0, 0, 0, 0);
			unk_0x824F744352C8BC82(joaat("u_m_o_filmnoir"));
			unk_0x05D0B763CEEA9ABD(uLocal_64, 1);
			unk_0xDBF5BCD703020A83(uLocal_64, 1);
			unk_0x8BE0C51D3486F755(uLocal_64, joaat("weapon_sniperrifle"));
			unk_0x2271ED1E65FB75EE(uLocal_64, 1862763509);
			uLocal_65 = unk_0x0358AFF5157FE26F(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, 1, 1, 0);
			break;
	}
}
...
void func_87(int iParam0, struct<3> Param1, float fParam2)
{
	*iParam0 = unk_0x200BB4DD7C4DB741();
	...
	{
		unk_0x60C60FC4CCF9DF77(*iParam0, Param1, fParam2);
	}
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			unk_0xAEBEF7AEA5E74A38(iLocal_73);
			iLocal_73 = 0;
			break;
		
		case 4:
			if (unk_0x419E13582192CFEA(uLocal_66))
			{
				unk_0x0F3BD19FF11738D3(&iLocal_66);
			}
			unk_0xF9135F131C423364(sLocal_74);
			break;
		
		case 5:
			if (unk_0x4336DC3297C47528(iLocal_63))
			{
				unk_0x23AD9DB85DF0B50D(iLocal_63);
			}
			if (unk_0x0E8572B08CEB6A11(uLocal_62))
			{
		...
		case 6:
			...
			{
				unk_0x0F3BD19FF11738D3(&iLocal_64);
			}
			if (unk_0x419E13582192CFEA(uLocal_65))
			{
				unk_0x39E572BDDBA714A2(&iLocal_65);
			}
			if (func_34(2))
			{
				unk_0xC5CAF559D14B1D18(Local_58, 200f, joaat("prop_mineshaft_door"), 0);
			}
			break;
	}
}
