...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_221(&uLocal_83, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x8B6A925F148E0E94())
			{
				...
				Var4 = { func_233(Global_77503, Global_77505, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	return func_325(&(Global_105842.f_2890), Param0, fParam1, 0);
}
...
int func_327(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_329(iParam0, uVar1[iVar3], 1) && func_328(unk_0xD6E677FAD7521410(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_323(Param1, 0f, 0f, 0f, 0)) || unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(iParam0, 1), unk_0xD6E677FAD7521410(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_371(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_377())
	{
		...
		{
			iVar2 = func_372(unk_0x471C98FD94C0A5FD());
			if (iVar2 > -1)
			{
