...
void func_1()
{
	...
	if (iLocal_21 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (unk_0x419E13582192CFEA(Local_23[iVar0 /*13*/]) && !unk_0xE50EB54E0F21BED0(Local_23[iVar0 /*13*/], 0))
			{
				unk_0x1A59F2280C3BC4C3(Local_23[iVar0 /*13*/]);
				iLocal_21++;
			}
		}
	}
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		...
		{
			if (!unk_0x419E13582192CFEA(Local_23[iVar0 /*13*/]))
			{
				func_11(&(Local_23[iVar0 /*13*/]));
			}
			else if (unk_0xE50EB54E0F21BED0(Local_23[iVar0 /*13*/], 0))
			{
