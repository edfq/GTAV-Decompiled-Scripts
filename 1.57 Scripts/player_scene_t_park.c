...
int func_2()
{
	...
	if (!unk_0xAB6A270F84A8781E(&cLocal_80))
	{
		if (!unk_0x176066ACB1B41C48(uLocal_77))
		{
			Var0 = { Vector(32.856f, 3819.65f, 1971.62f) - Local_75 };
			uLocal_77 = unk_0x2614BD180D42D9AF(&cLocal_80, Local_75 + Var0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0x698F51FB33ADAF7B(unk_0x7D2B9E6A64637269(), &sLocal_110, &cLocal_126, 2))
		{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						if (!unk_0x419E13582192CFEA(iLocal_68) || iLocal_79 != -1)
						{
							if (unk_0x2286C0F02D4FC21C(&cLocal_89, unk_0x7D2B9E6A64637269(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
								if (unk_0xDA654EB115F9FF7D(&cLocal_89, "scr_meth_pipe_smoke"))
								{
									func_17(unk_0x7D2B9E6A64637269(), 0, 1);
								}
								uLocal_169 = unk_0x5AD02BBC63E31E46();
								unk_0xE2D24A37AFCF27BF(uLocal_169, &cLocal_160, unk_0x7D2B9E6A64637269(), &cLocal_151, 0, 0);
								iLocal_170++;
							}
						}
						else if (unk_0x4A95E0F654DD603E(&cLocal_89, iLocal_68, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (unk_0xDA654EB115F9FF7D(&cLocal_89, "scr_meth_pipe_smoke"))
							{
								func_17(unk_0x7D2B9E6A64637269(), 0, 1);
				...
				case 2:
					if (!unk_0xAB6A270F84A8781E(&cLocal_98))
					{
						if (unk_0xE832E9D52B06C404(&cLocal_98, Local_75 + Local_107, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_170++;
						}
					}
			...
			{
				if (unk_0x5976053523EA16C8(iLocal_68))
				{
					if (iLocal_74 != -1)
					{
						if (fVar1 > fLocal_73)
		...
		else
		{
			if (iLocal_78 != 0)
			{
				unk_0x39448B5909AEB658(iLocal_78, 0);
				iLocal_78 = 0;
				unk_0x791B4C3811D53DFA(uLocal_169);
				unk_0xBAB6F7501A822416(uLocal_169);
			}
			if (unk_0x419E13582192CFEA(iLocal_68))
			{
				if (unk_0x5976053523EA16C8(iLocal_68))
	...
	switch (iParam1)
	{
		case 0:
			...
			if (unk_0x6471F4759775FCA4(*iParam0) == joaat("prop_iron_01"))
			{
				...
				Var2 = { unk_0x4BB6BF4A85268A22(*iParam0, 2) };
				unk_0x78CDDD1E6367978D(*iParam0, Var1 + Vector(0.1f, 0f, 0f), 1, 0, 0, 1);
				unk_0xBDDCDEC7B6205897(*iParam0, Var2.x, Var2.f_1, Var2.f_2, 2, 1);
			}
		...
		case 4:
			...
			switch (unk_0x6471F4759775FCA4(*iParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					Var7 = { 0f, 0f, 53.6f };
					unk_0x78CDDD1E6367978D(*iParam0, Var6, 1, 0, 0, 1);
					unk_0xBDDCDEC7B6205897(*iParam0, Var7, 2, 1);
			...
			while (!unk_0xA9C0BBFB9CBB66F1(iVar5))
			{
			...
			unk_0x04F4D55F2C0C756D(iParam0);
			*iParam0 = unk_0x795434E153F90E41(iVar5, Var3, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(*iParam0, Var4, 2, 1);
		...
		case 8:
			Var8 = { unk_0xD6E677FAD7521410(*iParam0, 1) };
			Var9 = { unk_0x4BB6BF4A85268A22(*iParam0, 2) };
			sVar10 = "";
			switch (unk_0x6471F4759775FCA4(*iParam0))
			{
			...
			unk_0xE832E9D52B06C404(sVar10, Var8, Var9, 1065353216, 0, 0, 0);
			unk_0x04F4D55F2C0C756D(iParam0);
			return 1;
			break;
		
		case 9:
			Var11 = { unk_0xD6E677FAD7521410(*iParam0, 1) };
			Var12 = { unk_0x4BB6BF4A85268A22(*iParam0, 2) };
			sVar13 = "";
			switch (unk_0x6471F4759775FCA4(*iParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			unk_0x16E516CA9C88FF48(iVar14);
			while (!unk_0xA9C0BBFB9CBB66F1(iVar14))
			{
				unk_0xAF98B1BA240CE3DB();
				unk_0xEFD424FDD55A6EC7(18);
				unk_0x601B0DFD9B0102A6();
			...
			unk_0xE832E9D52B06C404(sVar13, Var11, Var12, 1065353216, 0, 0, 0);
			unk_0x04F4D55F2C0C756D(iParam0);
			*iParam0 = unk_0x795434E153F90E41(iVar14, Var11, 1, 1, 0);
			unk_0xBDDCDEC7B6205897(*iParam0, Var12, 2, 1);
			if (func_6(iVar0, &sVar15, &cVar16, &uVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					if (!unk_0x698F51FB33ADAF7B(*iParam0, &sVar18, &sVar15, 2))
					{
						unk_0xED3365BAA5895E01(*iParam0, Global_96700, &sVar15, &sVar18, 1000f, -8f, uVar17, 1148846080);
					}
				}
			}
			unk_0x824F744352C8BC82(iVar14);
			return 1;
			break;
	}
	return 0;
...
int func_36()
{
	if (!iLocal_69 == 0)
	{
		if (!unk_0x419E13582192CFEA(iLocal_68))
		{
			...
			{
				iLocal_68 = unk_0x795434E153F90E41(iLocal_69, Local_75, 1, 1, 0);
				unk_0x0F1058706D5A58B4(iLocal_68, unk_0x7D2B9E6A64637269(), unk_0xA79DFB802C09F5F5(unk_0x7D2B9E6A64637269(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				iLocal_68 = unk_0x795434E153F90E41(iLocal_69, Local_75 + Local_70, 1, 1, 0);
				unk_0x78CDDD1E6367978D(iLocal_68, Local_75 + Local_70, 1, 0, 0, 1);
				unk_0xBDDCDEC7B6205897(iLocal_68, Vector(uLocal_76, 0f, 0f) + Local_71, 2, 1);
				unk_0xA2C015B68CE01357(iLocal_68, 1);
			}
		}
	}
	if (!func_37())
	{
		if (unk_0x419E13582192CFEA(iLocal_68))
		{
			if (iLocal_72 != -1)
			{
				if (!unk_0xDA872572A987B2AD(iLocal_68, unk_0x7D2B9E6A64637269()))
				{
					unk_0x0F1058706D5A58B4(iLocal_68, unk_0x7D2B9E6A64637269(), unk_0xA79DFB802C09F5F5(unk_0x7D2B9E6A64637269(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1);
				}
			}
...
void func_52()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (!unk_0xAB6A270F84A8781E(&cLocal_142))
		{
			if (!unk_0x936616EE3F524830(&cLocal_142, 0, -1))
			{
				bVar1 = false;
			}
		}
...
int func_54(struct<109> Param0, var uParam1)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam1 = { Global_97481[0 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_56(uParam1);
			uParam1->f_118 = Global_99069[0];
			return 1;
			break;
		
		case 3:
			*uParam1 = { Global_97481[1 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_56(uParam1);
			uParam1->f_118 = Global_99069[1];
			return 1;
			break;
		
		case 4:
			*uParam1 = { Global_97481[2 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_56(uParam1);
			uParam1->f_118 = Global_99069[2];
			return 1;
			break;
		...
		case 5:
			*uParam1 = { Param0 };
			...
			uParam1->f_110 = -982327190;
			func_56(uParam1);
			uParam1->f_118 = Global_99069[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 17, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 144, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_55(uParam1, 43, 1785177548, 1785177548, unk_0x644B8DBA4F69BB73(-5f, 5f), unk_0x644B8DBA4F69BB73(-5f, 5f), 0f, unk_0x644B8DBA4F69BB73(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
