...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_46)
			{
				if (!iLocal_47)
				{
					...
					iLocal_50 = unk_0x4D9115464D37FCEB(0);
					unk_0x19D76D7797ADA482(iLocal_50, "tot_pc", Global_112293.f_10192.f_3853);
					uLocal_51 = unk_0x68515D5331A425C7(iLocal_50, "Sect");
					uLocal_52 = unk_0x56D29DCCD9789CC8(uLocal_51, "mgc");
					uLocal_53 = unk_0x56D29DCCD9789CC8(uLocal_51, "msnc");
					uLocal_54 = unk_0x56D29DCCD9789CC8(uLocal_51, "ojc");
					uLocal_55 = unk_0x56D29DCCD9789CC8(uLocal_51, "rcc");
					uLocal_56 = unk_0x56D29DCCD9789CC8(uLocal_51, "revc");
					uLocal_57 = unk_0x56D29DCCD9789CC8(uLocal_51, "misc");
					iLocal_58 = 0;
					while (iLocal_58 < 321)
					{
						if (!Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 0)
						{
							if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 1 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 2)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_28[iLocal_34] = unk_0x00A21BC78E06E96C(uLocal_53);
									unk_0x8D5B2CAB16E07F01(uLocal_28[iLocal_34], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_28[iLocal_34], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 1)
									{
										unk_0x52EDECAF527E73AA(uLocal_28[iLocal_34], "100", 1);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_28[iLocal_34], "100", 0);
									}
									Local_40 = { func_125(iLocal_58) };
									unk_0x85D9696FF3E31D8A(uLocal_28[iLocal_34], "x", round(Local_40.x));
									unk_0x85D9696FF3E31D8A(uLocal_28[iLocal_34], "y", round(Local_40.f_1));
									iLocal_34++;
								}
							}
							if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 3 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 4)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_29[iLocal_35] = unk_0x00A21BC78E06E96C(uLocal_52);
									unk_0x8D5B2CAB16E07F01(uLocal_29[iLocal_35], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_29[iLocal_35], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 3)
									{
										unk_0x52EDECAF527E73AA(uLocal_29[iLocal_35], "100", 1);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_29[iLocal_35], "100", 0);
									}
									Local_40 = { func_125(iLocal_58) };
									unk_0x85D9696FF3E31D8A(uLocal_29[iLocal_35], "x", round(Local_40.x));
									unk_0x85D9696FF3E31D8A(uLocal_29[iLocal_35], "y", round(Local_40.f_1));
									iLocal_35++;
								}
							}
							if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 5 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 6)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_30[iLocal_36] = unk_0x00A21BC78E06E96C(uLocal_54);
									unk_0x8D5B2CAB16E07F01(uLocal_30[iLocal_36], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_30[iLocal_36], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 5)
									{
										unk_0x52EDECAF527E73AA(uLocal_30[iLocal_36], "100", 1);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_30[iLocal_36], "100", 0);
									}
									Local_40 = { func_125(iLocal_58) };
									unk_0x85D9696FF3E31D8A(uLocal_30[iLocal_36], "x", round(Local_40.x));
									unk_0x85D9696FF3E31D8A(uLocal_30[iLocal_36], "y", round(Local_40.f_1));
									iLocal_36++;
								}
							}
							if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 7 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 8)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_32[iLocal_37] = unk_0x00A21BC78E06E96C(uLocal_55);
									unk_0x8D5B2CAB16E07F01(uLocal_32[iLocal_37], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_32[iLocal_37], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 7)
									{
										unk_0x52EDECAF527E73AA(uLocal_32[iLocal_37], "100", 1);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_32[iLocal_37], "100", 0);
									}
									Local_40 = { func_125(iLocal_58) };
									unk_0x85D9696FF3E31D8A(uLocal_32[iLocal_37], "x", round(Local_40.x));
									unk_0x85D9696FF3E31D8A(uLocal_32[iLocal_37], "y", round(Local_40.f_1));
									iLocal_37++;
								}
							}
							if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 9 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 10)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_31[iLocal_38] = unk_0x00A21BC78E06E96C(uLocal_56);
									unk_0x8D5B2CAB16E07F01(uLocal_31[iLocal_38], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_31[iLocal_38], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 9)
									{
										unk_0x52EDECAF527E73AA(uLocal_31[iLocal_38], "100", 0);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_31[iLocal_38], "100", 0);
									}
									unk_0x85D9696FF3E31D8A(uLocal_31[iLocal_38], "x", round(Global_112293.f_10192[iLocal_58 /*12*/].f_10));
									unk_0x85D9696FF3E31D8A(uLocal_31[iLocal_38], "y", round(Global_112293.f_10192[iLocal_58 /*12*/].f_11));
									iLocal_38++;
								}
							}
							if (((Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 11 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 13) || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 12) || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 14)
							{
								if (Global_112293.f_10192[iLocal_58 /*12*/].f_5 || Global_112028 == 1)
								{
									uLocal_33[iLocal_39] = unk_0x00A21BC78E06E96C(uLocal_57);
									unk_0x8D5B2CAB16E07F01(uLocal_33[iLocal_39], "nm", &(Global_112293.f_10192[iLocal_58 /*12*/]));
									unk_0x52EDECAF527E73AA(uLocal_33[iLocal_39], "cmp", Global_112293.f_10192[iLocal_58 /*12*/].f_5);
									if (Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 11 || Global_112293.f_10192[iLocal_58 /*12*/].f_6 == 13)
									{
										unk_0x52EDECAF527E73AA(uLocal_33[iLocal_39], "100", 1);
									}
									else
									{
										unk_0x52EDECAF527E73AA(uLocal_33[iLocal_39], "100", 0);
									}
									Local_40 = { func_125(iLocal_58) };
									unk_0x85D9696FF3E31D8A(uLocal_33[iLocal_39], "x", round(Local_40.x));
									unk_0x85D9696FF3E31D8A(uLocal_33[iLocal_39], "y", round(Local_40.f_1));
									iLocal_39++;
								}
							}
						}
		...
		if (iLocal_46)
		{
			...
			else if (!unk_0x3601BCA33ECA8B49(&bLocal_48))
			{
				if (bLocal_48)
				{
				}
...
void func_49(int iParam0)
{
	...
	func_50(&(Global_77059[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_50(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x01758128AAB0BA8F(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			Global_2621445 = Var9;
			func_50(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x01758128AAB0BA8F(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_38(iParam0));
			if (iVar11 > iVar10)
			{
...
{
	return shift_right(Global_112293.f_10192[iParam0 /*12*/].f_8, 7) & 127;
}
...
void func_141()
{
	...
	iLocal_41 = unk_0xDFB7BFA6482FEE1E();
...
void func_151()
{
	...
	{
		func_154(13, floor(Global_112293.f_10192.f_3853));
	}
