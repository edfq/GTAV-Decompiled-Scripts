...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_112293.f_18531[iVar0], &Var2, &fVar3))
			{
...
void func_90(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	while (iVar4 < 47)
	{
		if (unk_0xAB6A270F84A8781E(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0xAB6A270F84A8781E(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0xAB6A270F84A8781E(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_95(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_96(&(Global_112293.f_19959), iVar1, 1);
	}
...
struct<4> func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	else
	{
		...
		{
			unk_0x191DDA30577F440A(&iVar2, 2);
			iVar3++;
		}
		...
		{
			unk_0x191DDA30577F440A(&iVar2, 5);
			iVar3++;
		}
		if (!func_111(&(Global_112293.f_19959), 6) && func_109(0) > 0)
		{
			unk_0x191DDA30577F440A(&iVar2, 6);
			iVar3++;
		}
		if (!func_111(&(Global_112293.f_19959), 7))
		{
			unk_0x191DDA30577F440A(&iVar2, 7);
			iVar3++;
		}
		...
		else
		{
			...
			while (iVar4 > 0)
			{
				if (unk_0x234B68AC2E35ED5A(iVar2, iVar5))
				{
					iVar4 = (iVar4 - 1);
					if (iVar4 == 0)
					{
	...
	if (bParam2)
	{
		func_107(&(Global_112293.f_19959), iVar1, 1);
	}
