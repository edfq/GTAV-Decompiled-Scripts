...
void __EntryFunction__()
{
	...
	uLocal_80 = unk_0xBD366067DA5DC0DE(joaat("weapon_sniperrifle"));
	uLocal_81 = unk_0x0F2D318764C61F56(joaat("component_at_scope_large"));
	uLocal_82 = unk_0x0F2D318764C61F56(joaat("component_at_ar_supp_02"));
	...
	func_515(25);
	func_514();
	func_513(&uLocal_89, 2, unk_0x7D2B9E6A64637269(), "TREVOR", 0, 1);
...
void func_1()
{
	switch (iLocal_257)
	{
		case 0:
			...
			func_7();
			if (unk_0xAB6A270F84A8781E(sLocal_352))
			{
				func_541(1);
			}
			else
...
void func_14()
{
	...
	{
		func_16(13, floor(Global_112293.f_10192.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77059[1 /*14*/] = { func_90(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0x234B68AC2E35ED5A(Global_77059[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77059[1 /*14*/] = { func_90(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77059[1 /*14*/] = { func_90(iVar10, 14, uVar15[iVar1], -1) };
			func_58(iParam0, Global_77059[1 /*14*/].f_12, Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4);
			func_73(14);
			if (Global_77057 == 1)
			{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_82(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_77059[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_93(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x01758128AAB0BA8F(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			Global_2621445 = Var9;
			func_93(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x01758128AAB0BA8F(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_82(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&uVar1, Var0.f_3, Global_99407, iParam1, iParam2);
	}
}
...
void func_224()
{
	if (iLocal_274)
	{
		...
		unk_0x8C74DB57A6F523C6(unk_0x7D2B9E6A64637269(), joaat("AMMO_SNIPER"), uLocal_337);
	}
	else
	{
		...
		case 1:
			if (unk_0x8B6A925F148E0E94())
			{
				...
				if (func_308(unk_0x7D2B9E6A64637269()))
				{
					...
					if (!func_212())
					{
						func_229(unk_0x7D2B9E6A64637269(), Local_415, fLocal_416, 0, 1);
					}
					if (func_308(iLocal_348))
					{
						unk_0x8ADA462BC5F42FD8(unk_0x7D2B9E6A64637269(), iLocal_348, -1, 0, 2);
					}
					func_228(1);
					func_226(0);
				}
...
void func_226(bool bParam0)
{
	if (func_308(iLocal_348))
	{
		if (bParam0)
		{
			...
			{
				if (!unk_0xAB3E7E62A69D0DB3(iLocal_348, func_227()))
				{
					unk_0xCA089CD1A17D76DF(iLocal_348);
					unk_0x4B75B1FF20EA3A22(iLocal_348, func_227());
					unk_0xA571B9D2035E6945(iLocal_348, 1);
					unk_0xA2C015B68CE01357(iLocal_348, 0);
				}
			}
		}
		else if (unk_0xAB3E7E62A69D0DB3(iLocal_348, func_227()))
		{
			unk_0xCA089CD1A17D76DF(iLocal_348);
			unk_0xC1A7CF4B179CD225(iLocal_348);
		}
	}
}
...
void func_231(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_209(unk_0x471C98FD94C0A5FD(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_302(&(Global_99370.f_3));
				if (iVar6 > -1)
				{
...
void func_257(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_259(Var7.f_1)) && iVar9 < 51)
			{
...
{
	return (shift_right(iParam0, 26) & 31 * func_297(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_310()
{
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_365, Local_366, 20f, 0, 1, 0))
			{
				func_321();
				if (iLocal_301[17])
				{
...
void func_311()
{
	...
	while (iVar3 < 4)
	{
		if (unk_0x5E74E07533CA2FE9(iVar2[iVar3], Var0[iVar3 /*3*/], 1))
		{
			uLocal_425[iVar3] = unk_0x170478CC84C8AE2F(iVar2[iVar3], Var0[iVar3 /*3*/], fVar1[iVar3], 1, 1, 0);
		}
		iVar3++;
	}
...
void func_312()
{
	unk_0x824F744352C8BC82(iLocal_343);
	unk_0x824F744352C8BC82(iLocal_344);
}
...
{
	if (!unk_0x575B7C28D81C0B4D(iLocal_263))
	{
	...
	if (unk_0x575B7C28D81C0B4D(iLocal_263))
	{
		if (!bParam0)
		{
			unk_0xDD205B87CDFD0C1B(iLocal_263, 0.75f);
		}
		unk_0x89936830A493350F(iLocal_263, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_308(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						Local_421[iVar0 /*3*/] = { unk_0xD6E677FAD7521410(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_303[iVar0] = 1;
						Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_260[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!unk_0xE50EB54E0F21BED0(Local_260[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_260[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_329 = 1;
							}
							else if (!unk_0xE50EB54E0F21BED0(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (unk_0x3E72EB0926A107F9(unk_0xD6E677FAD7521410(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
					...
					while (iLocal_330 < 3)
					{
						...
						{
							Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14 = { unk_0xD6E677FAD7521410(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 1) };
							Local_260[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_260[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_330 < 3)
					{
						if ((unk_0x419E13582192CFEA(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0)) && !unk_0xECEC7528A52B4EE8(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						...
						{
							if (unk_0x419E13582192CFEA(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0))
							{
								unk_0x3C3DD4D53CF82FCD(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, Local_421[iVar0 /*3*/], unk_0x644B8DBA4F69BB73(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			unk_0x7F11626F2B7E7356(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (unk_0xDFB7BFA6482FEE1E() + unk_0xB36B8558948EA7A8(3000, 8000));
		...
		case 4:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xDFB7BFA6482FEE1E() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 = unk_0xB36B8558948EA7A8(0, 8);
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						unk_0x45B1B4E55BF15523(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, unk_0x644B8DBA4F69BB73(0f, 359.9f));
					}
					else if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
					{
						unk_0x573C7DCF0ED57602(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && unk_0x591190E69BE43117(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							unk_0xCA089CD1A17D76DF(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
							unk_0x731992816BA6C01E(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					unk_0xE668BF9946D414D8(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					unk_0xE668BF9946D414D8(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				unk_0x504B26425DFF773C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
		...
		case 12:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					...
					{
						unk_0x3C3DD4D53CF82FCD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], unk_0x644B8DBA4F69BB73(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
				{
					unk_0x573C7DCF0ED57602(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
				...
				unk_0xA5030CC1B9A0FDA6(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
{
	if ((((unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_365, Local_366, 20f, 0, 1, 0) && unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3)
	{
		if (!unk_0x575B7C28D81C0B4D(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/] = func_315(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (unk_0x575B7C28D81C0B4D(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
			{
				unk_0xDD205B87CDFD0C1B(Local_260[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!unk_0xE50EB54E0F21BED0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				unk_0xC22CF0F8AABFA658(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			}
		}
	}
	else
...
void func_346(int iParam0, int iParam1)
{
	...
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x0FDCFECB2EF2BC1C(26, iLocal_341, Var0, unk_0x644B8DBA4F69BB73(0f, 359.9f), 1, 1);
		if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			unk_0xC595907BB71C921D(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			unk_0xBE91B077ADADE97F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5 = unk_0x644B8DBA4F69BB73(0f, 359.9f);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0x0FDCFECB2EF2BC1C(26, iLocal_341, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (unk_0x419E13582192CFEA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				unk_0xC595907BB71C921D(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				unk_0xBE91B077ADADE97F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
void func_348(int iParam0, int iParam1)
{
	if (func_349())
	{
		unk_0xE2D24A37AFCF27BF(-1, "COYOTE_BARK_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		unk_0xE2D24A37AFCF27BF(-1, "COYOTE_CRY_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x8B6A925F148E0E94())
			{
				...
				if (!func_212())
				{
					func_229(unk_0x7D2B9E6A64637269(), Local_377, fLocal_378, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x575B7C28D81C0B4D(Local_258[iVar0 /*10*/].f_9))
		{
			unk_0x1AD5BCFEC31BB8D9(&(Local_258[iVar0 /*10*/].f_9));
		}
	...
	if (iLocal_271)
	{
		unk_0x824F744352C8BC82(iLocal_340);
	}
}
...
void func_359()
{
	unk_0x16E516CA9C88FF48(iLocal_343);
	unk_0x16E516CA9C88FF48(iLocal_344);
	while (!unk_0xA9C0BBFB9CBB66F1(iLocal_343) || !unk_0xA9C0BBFB9CBB66F1(iLocal_344))
	{
		wait(0);
	}
}
...
int func_361()
{
	if (unk_0x419E13582192CFEA(iLocal_348) && !unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
	{
		if (!unk_0xD406352E21A7E1D0(iLocal_348, unk_0x7D2B9E6A64637269(), Local_367, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_363()
{
	...
	func_364();
	if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_413, Local_414, 3.5f, 0, 1, 0) || iLocal_301[16])
	{
		func_358();
		func_351();
		iLocal_254 = 15;
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_378(iVar0);
			if (unk_0x419E13582192CFEA(Local_259[iVar0 /*29*/].f_28))
			{
				if (!unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_363, Local_364, 10f, 0, 1, 0))
				{
					if (!bLocal_289)
					{
						if (unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
						{
							bLocal_289 = true;
							func_318(6);
						}
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_259[iVar0 /*29*/].f_7 = unk_0xB36B8558948EA7A8(0, 5);
				if ((!unk_0x4B1BAFAB7E8F4DA7(Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_319 < 3) && unk_0x5E74E07533CA2FE9(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, 1))
				{
					Local_259[iVar0 /*29*/].f_28 = unk_0x170478CC84C8AE2F(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, Local_259[iVar0 /*29*/].f_4, 1, 1, 0);
					if (unk_0x419E13582192CFEA(Local_259[iVar0 /*29*/].f_28) && !unk_0xE50EB54E0F21BED0(Local_259[iVar0 /*29*/].f_28, 0))
					{
						unk_0x1B0723EFE914C031(Local_259[iVar0 /*29*/].f_28, 1);
						unk_0xED4E91A1FC7ABBF6(Local_259[iVar0 /*29*/].f_28, 1);
						Local_259[iVar0 /*29*/].f_7 = unk_0xB36B8558948EA7A8(0, 5);
						Local_259[iVar0 /*29*/].f_12 = unk_0x42F3C85A00B4FC7B(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
						if (unk_0x419E13582192CFEA(Local_259[iVar0 /*29*/].f_12))
						{
							Local_259[iVar0 /*29*/].f_11 = unk_0x795434E153F90E41(iLocal_345, Local_259[iVar0 /*29*/].f_16, 1, 1, 0);
							if (unk_0x419E13582192CFEA(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x0F1058706D5A58B4(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, unk_0xA79DFB802C09F5F5(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								unk_0x4603196EEEA2355C(Local_259[iVar0 /*29*/].f_11, 0, 0);
								unk_0x46EDFC827DC67D89(Local_259[iVar0 /*29*/].f_12, 1, 1);
								unk_0x1B0723EFE914C031(Local_259[iVar0 /*29*/].f_12, 1);
								Local_259[iVar0 /*29*/].f_2 = 0;
								Local_259[iVar0 /*29*/].f_1 = 0;
								Local_259[iVar0 /*29*/].f_3 = 0;
								unk_0xBE91B077ADADE97F(Local_259[iVar0 /*29*/].f_12, 1);
								unk_0xE946751408DFA71B(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_319++;
			...
			case 4:
				...
				{
					if (!unk_0x591190E69BE43117(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
							...
							if (func_324(Local_259[iVar0 /*29*/].f_28))
							{
								if (func_375(iVar0))
								{
									if (!Local_259[iVar0 /*29*/].f_1)
									{
										...
										func_374(iVar0);
										unk_0xA5030CC1B9A0FDA6(Local_259[iVar0 /*29*/].f_28);
						...
						{
							if (unk_0x3E72EB0926A107F9(unk_0xD6E677FAD7521410(Local_259[iVar0 /*29*/].f_28, 1), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
					...
					{
						unk_0xCA089CD1A17D76DF(Local_259[iVar0 /*29*/].f_12);
						unk_0xED4E91A1FC7ABBF6(Local_259[iVar0 /*29*/].f_28, 0);
						unk_0x0509CE092AC81B7C(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
						unk_0x504B26425DFF773C(Local_259[iVar0 /*29*/].f_12, 1);
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					...
					{
						unk_0xE7FD307AF3D07EF7(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Var1, unk_0xA8D713A937F31250(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						unk_0x5501AD171E63CFEB(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						unk_0x5501AD171E63CFEB(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_259[iVar0 /*29*/].f_28) && func_308(Local_259[iVar0 /*29*/].f_12)) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					if (unk_0x8879B2803A5F8682(Local_259[iVar0 /*29*/].f_28))
					{
						unk_0xCA089CD1A17D76DF(Local_259[iVar0 /*29*/].f_12);
						unk_0xBE91B077ADADE97F(Local_259[iVar0 /*29*/].f_12, 1);
						if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
							unk_0xEDC0317C5B604BB1(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 7:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					if (!unk_0xC49311A2A500FF09(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
					...
					else if (unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1)) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					Var2 = { unk_0xD6E677FAD7521410(Local_259[iVar0 /*29*/].f_12, 1) };
					if (!unk_0xC49311A2A500FF09(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) && !unk_0x3E72EB0926A107F9(Var2, 3f, 1))
						{
							Local_259[iVar0 /*29*/].f_25 = { unk_0x9E695CE384C77EF0(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_22) };
							Local_259[iVar0 /*29*/].f_6 = (unk_0xA8D713A937F31250(Local_259[iVar0 /*29*/].f_28) + Local_259[iVar0 /*29*/].f_5);
							unk_0xCA089CD1A17D76DF(Local_259[iVar0 /*29*/].f_12);
							unk_0xBE91B077ADADE97F(Local_259[iVar0 /*29*/].f_12, 1);
							unk_0x45B1B4E55BF15523(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_259[iVar0 /*29*/].f_6);
			...
			case 9:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					...
					if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) && !unk_0x3E72EB0926A107F9(Var2, 3f, 1))
					{
						if (unk_0x591190E69BE43117(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							unk_0xCA089CD1A17D76DF(Local_259[iVar0 /*29*/].f_12);
							unk_0xBE91B077ADADE97F(Local_259[iVar0 /*29*/].f_12, 1);
							unk_0xB0C1A43193C25F7A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					...
					if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) && !unk_0x3E72EB0926A107F9(Var2, 3f, 1))
					{
						Local_259[iVar0 /*29*/].f_15 = unk_0x4E8DA737B686529A(Local_259[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					...
					if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) && !unk_0x3E72EB0926A107F9(Var2, 3f, 1))
					{
						unk_0x5C679902079A7E80(&(Local_259[iVar0 /*29*/].f_14));
						...
						unk_0x1BBD0A5729AB1226(Local_259[iVar0 /*29*/].f_14);
						unk_0x8A1AC8EBC73850C8(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_14);
						unk_0x8D5B447F21217223(&(Local_259[iVar0 /*29*/].f_14));
						Local_259[iVar0 /*29*/].f_8 = unk_0xDFB7BFA6482FEE1E() + 20000;
			...
			case 12:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					...
					if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1) && !unk_0x3E72EB0926A107F9(Var2, 3f, 1))
					{
						if (unk_0xDFB7BFA6482FEE1E() > Local_259[iVar0 /*29*/].f_8)
						{
							if (unk_0x1F9D47D45E125FA6(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x4603196EEEA2355C(Local_259[iVar0 /*29*/].f_11, 0, 0);
							}
							else
						...
						else if (unk_0x698F51FB33ADAF7B(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !unk_0x1F9D47D45E125FA6(Local_259[iVar0 /*29*/].f_11))
						{
							unk_0x4603196EEEA2355C(Local_259[iVar0 /*29*/].f_11, 1, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!unk_0xA6E8FBD68548675F(Local_259[iVar0 /*29*/].f_28, unk_0x7D2B9E6A64637269(), 1))
				{
					if (unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(Local_259[iVar0 /*29*/].f_28, 0), unk_0xD6E677FAD7521410(Local_259[iVar0 /*29*/].f_12, 1), 0) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (unk_0x419E13582192CFEA(Local_259[iVar0 /*29*/].f_12))
				{
					if (!unk_0xE50EB54E0F21BED0(Local_259[iVar0 /*29*/].f_12, 0))
					{
						unk_0x504B26425DFF773C(Local_259[iVar0 /*29*/].f_12, 1);
					}
		...
		{
			if (unk_0x0BABEFEA577FCFA4(Local_376, unk_0xD6E677FAD7521410(Local_259[iVar0 /*29*/].f_28, 1), 1) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			...
			unk_0x5C679902079A7E80(&(Local_259[iParam0 /*29*/].f_14));
			unk_0x95CA4545D0C61309(0, Local_259[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			unk_0x0509CE092AC81B7C(0, Local_259[iParam0 /*29*/].f_28, 60f, 786468);
			unk_0x1BBD0A5729AB1226(Local_259[iParam0 /*29*/].f_14);
			unk_0x8A1AC8EBC73850C8(iVar0, Local_259[iParam0 /*29*/].f_14);
			unk_0x504B26425DFF773C(iVar0, 1);
			unk_0x8D5B447F21217223(&(Local_259[iParam0 /*29*/].f_14));
		}
...
Vector3 func_368(int iParam0)
{
	...
	if (func_377(iParam0))
	{
		...
		if (unk_0xC2B18235ABE89FC1(Var0, &Var1, 1, 1077936128, 0))
		{
			if (unk_0x62E0823A71208EF9(Var1, 0, &Var1))
			{
				if (!unk_0x4B1BAFAB7E8F4DA7(Var1, 2f) && !unk_0x091D6114DC63264E(Var1, 2f, 0))
				{
					return Var1;
				}
			}
...
void func_369(int iParam0)
{
	...
	{
		unk_0xCA089CD1A17D76DF(Local_259[iParam0 /*29*/].f_12);
		unk_0xBE91B077ADADE97F(Local_259[iParam0 /*29*/].f_12, 1);
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			if (unk_0xF41EB7643E61A928(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, 0))
			{
				unk_0xE946751408DFA71B(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, Local_259[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_259[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				unk_0xE668BF9946D414D8(Local_259[iParam0 /*29*/].f_12, Local_358, 10000f, -1, 0, 0);
				Local_259[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_259[iParam0 /*29*/].f_2 = 1;
		unk_0x504B26425DFF773C(Local_259[iParam0 /*29*/].f_12, 1);
	}
	else
	{
...
void func_370()
{
	if (!iLocal_278)
	{
		if (func_349())
		{
			iLocal_318 = unk_0xDFB7BFA6482FEE1E() + 1000;
			iLocal_278 = 1;
		}
	}
	else if (unk_0xDFB7BFA6482FEE1E() > iLocal_318)
	{
...
int func_372()
{
	...
	if (func_308(unk_0x7D2B9E6A64637269()))
	{
		...
		if (func_308(iLocal_348))
		{
			Var1 = { unk_0xD6E677FAD7521410(iLocal_348, 1) };
			if (func_373(unk_0x7D2B9E6A64637269(), iLocal_348, 0) <= 10f && unk_0x0BCA9ADE67DF9DD8((Var0.f_2 - Var1.f_2)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!unk_0xE50EB54E0F21BED0(Local_259[iParam0 /*29*/].f_28, 0))
	{
		unk_0xC22CF0F8AABFA658(Local_259[iParam0 /*29*/].f_28, 0);
	}
...
{
	if (unk_0x419E13582192CFEA(Local_259[iParam0 /*29*/].f_28) && !unk_0xE50EB54E0F21BED0(Local_259[iParam0 /*29*/].f_28, 0))
	{
		if (unk_0x3095B0C5EB2CFFEC(Local_259[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0x3095B0C5EB2CFFEC(Local_259[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0x3095B0C5EB2CFFEC(Local_259[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (unk_0x3095B0C5EB2CFFEC(Local_259[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (unk_0x419E13582192CFEA(Local_259[iParam0 /*29*/].f_12))
	{
		if (unk_0xE50EB54E0F21BED0(Local_259[iParam0 /*29*/].f_12, 0) || !unk_0xE50EB54E0F21BED0(Local_259[iParam0 /*29*/].f_12, 0))
		{
			if (unk_0xA6E8FBD68548675F(Local_259[iParam0 /*29*/].f_12, unk_0x7D2B9E6A64637269(), 1))
			{
				func_369(iParam0);
			}
		}
...
void func_381()
{
	if (bLocal_292)
	{
		unk_0x824F744352C8BC82(Local_259[0 /*29*/].f_9);
		unk_0x824F744352C8BC82(Local_259[1 /*29*/].f_9);
		unk_0x824F744352C8BC82(Local_259[2 /*29*/].f_9);
		unk_0x824F744352C8BC82(Local_259[3 /*29*/].f_9);
		unk_0x824F744352C8BC82(Local_259[4 /*29*/].f_9);
		unk_0x824F744352C8BC82(Local_259[0 /*29*/].f_10);
		unk_0x824F744352C8BC82(Local_259[1 /*29*/].f_10);
		unk_0x824F744352C8BC82(Local_259[2 /*29*/].f_10);
		unk_0x824F744352C8BC82(Local_259[3 /*29*/].f_10);
		unk_0x824F744352C8BC82(Local_259[4 /*29*/].f_10);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x8B6A925F148E0E94())
			{
				...
				iLocal_255 = 13;
				unk_0xB7D390F8F682127B(Local_376, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xB7D390F8F682127B(Local_374, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xB7D390F8F682127B(Local_375, 50f, 0, 0, 0, 0, 0, 0);
				unk_0x16D66F11FE644901(unk_0x7D2B9E6A64637269());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(unk_0x7D2B9E6A64637269(), Local_358, fLocal_305, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
{
	func_387();
	unk_0x16E516CA9C88FF48(Local_259[0 /*29*/].f_9);
	unk_0x16E516CA9C88FF48(Local_259[1 /*29*/].f_9);
	unk_0x16E516CA9C88FF48(Local_259[2 /*29*/].f_9);
	unk_0x16E516CA9C88FF48(Local_259[3 /*29*/].f_9);
	unk_0x16E516CA9C88FF48(Local_259[4 /*29*/].f_9);
	unk_0x16E516CA9C88FF48(Local_259[0 /*29*/].f_10);
	unk_0x16E516CA9C88FF48(Local_259[1 /*29*/].f_10);
	unk_0x16E516CA9C88FF48(Local_259[2 /*29*/].f_10);
	unk_0x16E516CA9C88FF48(Local_259[3 /*29*/].f_10);
	unk_0x16E516CA9C88FF48(Local_259[4 /*29*/].f_10);
	unk_0x16E516CA9C88FF48(iLocal_345);
	while ((((((((((!unk_0xA9C0BBFB9CBB66F1(Local_259[0 /*29*/].f_9) || !unk_0xA9C0BBFB9CBB66F1(Local_259[1 /*29*/].f_9)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[2 /*29*/].f_9)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[3 /*29*/].f_9)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[4 /*29*/].f_9)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[0 /*29*/].f_10)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[1 /*29*/].f_10)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[2 /*29*/].f_10)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[3 /*29*/].f_10)) || !unk_0xA9C0BBFB9CBB66F1(Local_259[4 /*29*/].f_10)) || !unk_0xA9C0BBFB9CBB66F1(iLocal_345))
	{
		wait(0);
	}
	bLocal_292 = true;
...
void func_389()
{
	...
	unk_0x72B26E0E77583A99(Local_359, fLocal_315);
	unk_0x72B26E0E77583A99(Local_360, fLocal_315);
	unk_0xCAFB54B99BF4F907(0f);
	unk_0xE9B24CFD75198D4C(0f, 0f);
	if (unk_0xC7E4E71866B09979() == 4)
	{
...
void func_390()
{
	if (!unk_0xECEC7528A52B4EE8(iLocal_348) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (!bLocal_283)
		{
			if (!unk_0xD406352E21A7E1D0(iLocal_348, unk_0x7D2B9E6A64637269(), Local_384, 0, 1, 0) || unk_0xB71084333B418824(unk_0x7D2B9E6A64637269()) != 0)
			{
				if (!unk_0x480609C7D10E7F3E(iLocal_348))
				{
					bLocal_283 = true;
				}
			}
		}
		else if (unk_0xD406352E21A7E1D0(iLocal_348, unk_0x7D2B9E6A64637269(), Local_385, 0, 1, 0) && unk_0xB71084333B418824(unk_0x7D2B9E6A64637269()) == 0)
		{
...
void func_393()
{
	...
	if (!iLocal_293)
	{
		if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_357, 50f, 50f, 50f, 0, 1, 0))
		{
			func_395();
			iLocal_293 = 1;
		}
	...
	if (!bLocal_283)
	{
		if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_357, 5f, 5f, 5f, 0, 1, 0) && func_394(1077936128, 1))
		{
			unk_0x86DA8A407ED8A381(Local_374, Local_375, 0, 1);
			func_8(&iLocal_262);
			func_385();
			func_2();
			func_351();
...
void func_395()
{
	unk_0x0823FA7465392E20(Local_401, Local_402, 0, 1, 1, 1);
	unk_0x494E8A58F41F5F54(Local_401, Local_402);
	unk_0x91F94D2287684BDB(Local_412, 5f, 0);
}
...
void func_396()
{
	...
	if (iLocal_301[3])
	{
		...
		{
			func_231(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
			if (unk_0x419E13582192CFEA(iLocal_426))
			{
				unk_0x5C052A30B9FCA449(iLocal_426, 1);
			}
			if (iLocal_336 <= 3)
			{
				func_382(769, 3, 1);
...
void func_397()
{
	...
	unk_0x72B26E0E77583A99(Local_359, fLocal_315);
	unk_0x72B26E0E77583A99(Local_360, fLocal_315);
	if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_361, Local_362, 7f, 1, 1, 0))
	{
		if (iLocal_301[1])
		{
			iLocal_290 = 0;
...
void func_399()
{
	...
	unk_0x72B26E0E77583A99(Local_359, fLocal_315);
	unk_0x72B26E0E77583A99(Local_360, fLocal_315);
	if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_361, Local_362, 7f, 0, 1, 0))
	{
		func_321();
		func_404();
		func_383();
		...
		if (!unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) && (unk_0x591190E69BE43117(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0) || iLocal_338 >= 3))
		{
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					if (!unk_0x591190E69BE43117(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0))
					{
						func_226(1);
					}
					iLocal_254 = 8;
		...
		if (!unk_0x575B7C28D81C0B4D(Local_258[iVar0 /*10*/].f_9))
		{
			if (func_230(Local_258[iVar0 /*10*/]))
			{
				if (!Local_258[iVar0 /*10*/].f_7)
				{
					...
					unk_0xFA3E6ADC3E5D386E(Local_258[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (Local_258[iVar0 /*10*/].f_7 == 1)
		{
			if (!Local_258[iVar0 /*10*/].f_8)
			{
				...
				{
					unk_0xA5030CC1B9A0FDA6(Local_258[iVar0 /*10*/]);
					iLocal_338++;
				}
				else
				{
...
{
	if (unk_0x419E13582192CFEA(Local_258[iParam0 /*10*/]) && !Local_258[iParam0 /*10*/].f_7)
	{
		Local_258[iParam0 /*10*/].f_5 = unk_0x5E7C0A485B91DB87(Local_258[iParam0 /*10*/]);
		if (Local_258[iParam0 /*10*/].f_5 < 100)
		{
			...
			unk_0x29686D628C8C6B94(Local_258[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0x8B6A925F148E0E94())
			{
				...
				if (!func_212())
				{
					func_229(unk_0x7D2B9E6A64637269(), Local_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_228(1);
...
void func_407()
{
	unk_0x91F94D2287684BDB(Local_403, 3f, 0);
	unk_0x494E8A58F41F5F54(Local_404, Local_405);
	unk_0x91F94D2287684BDB(Local_406, 3f, 0);
	unk_0x494E8A58F41F5F54(Local_407, Local_408);
	unk_0x91F94D2287684BDB(Local_409, 3f, 0);
	unk_0x494E8A58F41F5F54(Local_410, Local_411);
}
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			unk_0xBA7E979B202649F9(Local_258[iVar0 /*10*/].f_1, 2f, 0);
			Local_258[iVar0 /*10*/] = unk_0x795434E153F90E41(iLocal_340, Local_258[iVar0 /*10*/].f_1, 1, 1, 0);
			if (unk_0x419E13582192CFEA(Local_258[iVar0 /*10*/]))
			{
				unk_0xCD37A28258D70638(Local_258[iVar0 /*10*/], Local_258[iVar0 /*10*/].f_4);
				unk_0xE34405F82AAC89BC(Local_258[iVar0 /*10*/], 0);
				unk_0xC595907BB71C921D(Local_258[iVar0 /*10*/], 100, 0);
				unk_0x0B87A8220B73252D(Local_258[iVar0 /*10*/], 1);
				Local_258[iVar0 /*10*/].f_7 = 0;
				Local_258[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((unk_0x419E13582192CFEA(Local_258[0 /*10*/]) && unk_0x419E13582192CFEA(Local_258[1 /*10*/])) && unk_0x419E13582192CFEA(Local_258[2 /*10*/])) && func_409())
		{
			unk_0x824F744352C8BC82(iLocal_340);
			iLocal_271 = 0;
			return 1;
...
int func_409()
{
	iLocal_335 = unk_0xB36B8558948EA7A8(0, 3);
	if (unk_0x419E13582192CFEA(Local_258[iLocal_335 /*10*/]))
	{
...
void func_410()
{
	unk_0x16E516CA9C88FF48(iLocal_340);
	while (!unk_0xA9C0BBFB9CBB66F1(iLocal_340))
	{
		wait(0);
	}
	iLocal_271 = 1;
...
void func_411()
{
	...
	else
	{
		...
		if (unk_0x575B7C28D81C0B4D(iLocal_263))
		{
			if (!unk_0xF8D4180996FA0FA7(iLocal_263))
			{
				if (!unk_0xD406352E21A7E1D0(iLocal_348, unk_0x7D2B9E6A64637269(), Local_384, 0, 1, 0))
				{
					func_2();
					func_314(1, 0);
					func_319("HT_BKHTER");
			...
			else
			{
				...
				if (unk_0xD406352E21A7E1D0(iLocal_348, unk_0x7D2B9E6A64637269(), Local_385, 0, 1, 0))
				{
					func_314(1, 0);
					if (func_398("HT_BKHTER", 0, 0))
					{
		...
		case 1:
			if (unk_0x8B6A925F148E0E94())
			{
				if (unk_0x2CA4B93E310C1860())
				{
					...
					if (unk_0x419E13582192CFEA(iLocal_347))
					{
						unk_0x04F4D55F2C0C756D(&iLocal_347);
					}
				}
				...
				if (!func_212())
				{
					func_229(unk_0x7D2B9E6A64637269(), Local_380, fLocal_381, 0, 1);
					func_352();
				}
				func_228(1);
				unk_0xB7D390F8F682127B(Local_379, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
			...
			switch (iLocal_320)
			{
				case 0:
					if (func_440(1, 1093140480, 0))
					{
						...
						{
							unk_0xF2CEEA627AD5A24B(unk_0x7D2B9E6A64637269(), sLocal_354, 0, 0, 0);
						}
						if (func_230(iLocal_348))
						{
							unk_0xF2CEEA627AD5A24B(iLocal_348, sLocal_355, 0, 0, 0);
							unk_0xF81CBD28BD382566(sLocal_355, unk_0x7D2B9E6A64637269(), 0);
							iLocal_347 = func_436(iLocal_348, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (unk_0x419E13582192CFEA(iLocal_347))
						{
							unk_0xF2CEEA627AD5A24B(iLocal_347, "Daves_Rifle", 0, 0, 0);
						}
						func_435();
						...
						{
							unk_0x78CDDD1E6367978D(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
							unk_0xCD37A28258D70638(iLocal_426, 76.1155f);
						}
				...
				case 1:
					if (unk_0x30700B4AA35835FD(sLocal_355, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_276)
						{
					...
					{
						unk_0x96C7681CE7E3763A(iLocal_347, unk_0x7D2B9E6A64637269());
					}
					if (unk_0x30700B4AA35835FD(sLocal_354, 0))
					{
			...
			if (unk_0x8B6A925F148E0E94())
			{
				if (func_408())
				{
					if (func_308(iLocal_348))
					{
						...
						{
							func_229(iLocal_348, Local_373, fLocal_312, 0, 1);
							unk_0x04BC2951833EF44D(iLocal_348, joaat("weapon_sniperrifle"));
							unk_0xCA089CD1A17D76DF(iLocal_348);
							iLocal_255 = 2;
						}
					}
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
		{
			if (unk_0x2B8CB30532811E62(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				if (func_439(func_260(iVar2, iVar6)))
				{
					uVar7 = unk_0x0F2D318764C61F56(func_260(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_260(iVar2, iVar8) != 0)
	{
		if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
		{
			...
			{
				unk_0x3C11038EDEC5E20E(uVar1, func_260(iVar2, iVar8));
...
void func_446()
{
	if (!unk_0x79CC60D128756F16() && func_373(unk_0x7D2B9E6A64637269(), iLocal_348, 1) > 3f)
	{
		iLocal_325 = unk_0xDFB7BFA6482FEE1E() + 2000;
		if (func_308(iLocal_348))
		{
			if (func_308(unk_0x7D2B9E6A64637269()))
			{
			}
			unk_0x48A41E0B6D206A79(iLocal_348, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			unk_0x75AE23FD9355C8A0(fLocal_306);
			unk_0x811451B8BA61B007(fLocal_307);
			unk_0x5CB56864CBD74649(fLocal_308);
			unk_0xC1A425C6F3193A36(fLocal_309);
			unk_0xFD11888B7E4927D4(fLocal_310);
			unk_0xFAF9E5F77F1A8F7D(1);
		}
	}
	else if (func_308(iLocal_348) && func_308(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xDFB7BFA6482FEE1E() > iLocal_325 || func_373(unk_0x7D2B9E6A64637269(), iLocal_348, 1) <= 3f)
		{
			if (func_373(unk_0x7D2B9E6A64637269(), iLocal_348, 1) <= 3f)
			{
			}
			iLocal_320 = 0;
			iLocal_257 = 0;
...
void func_447()
{
	...
	if (func_308(iLocal_348))
	{
		unk_0x83E421E5A4A2A512(iLocal_348, 200);
		unk_0xBC4B0376D5E2BD1A(iLocal_348, 0);
		unk_0x95C1F609605A12FF(iLocal_348, 0);
		unk_0x7B28A83A0D3DD0F9(iLocal_348, 169, 1);
		unk_0x7B28A83A0D3DD0F9(iLocal_348, 206, 1);
		unk_0x7B28A83A0D3DD0F9(iLocal_348, 32, 0);
		unk_0x472BD05C38FE7A6B(iLocal_348, 0);
		unk_0xB5BF3BBD2E785884(iLocal_348);
		unk_0x2828751D3E482BF8(iLocal_348, 1);
		unk_0x13812A3531901D7E(iLocal_348, 0);
		unk_0x1B0723EFE914C031(iLocal_348, 1);
		unk_0x1EB6C2E7D90CD82E(iLocal_348, 0);
		unk_0x354924FCEF0851C8(iLocal_348, 1);
		unk_0x2EB33FFA32BC9E49(iLocal_348, 1);
	}
	iLocal_257 = 0;
	if (func_528())
	{
...
void func_450()
{
	...
	{
		iLocal_274 = 1;
		uLocal_337 = unk_0xC9F09853CEEF29AE(unk_0x7D2B9E6A64637269(), joaat("AMMO_SNIPER"));
	}
}
...
void func_452()
{
	unk_0x16E516CA9C88FF48(iLocal_341);
	unk_0x211A0F273B705428("SCRIPT\HUNTING_1_COYOTE_VOCALS", 0, -1);
	while (!unk_0xA9C0BBFB9CBB66F1(iLocal_341))
	{
		wait(0);
	}
}
...
void func_456()
{
	if (unk_0xC7E4E71866B09979() != 4)
	{
		if ((unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_397, Local_398, 16f, 0, 1, 0) || unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_399, Local_400, 19f, 0, 1, 0)) || unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_401, Local_402, 19f, 0, 1, 0))
		{
...
void func_457()
{
	...
	if (func_308(unk_0x7D2B9E6A64637269()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 3:
				func_314(1, 0);
				iLocal_334 = unk_0xDFB7BFA6482FEE1E() + 2000;
				unk_0x78CDDD1E6367978D(iLocal_348, Local_373, 1, 0, 0, 1);
				unk_0xCD37A28258D70638(iLocal_348, fLocal_312);
				iLocal_255 = 2;
				break;
			...
			case 2:
				if (func_308(iLocal_348))
				{
					...
					{
						bLocal_276 = true;
						iLocal_334 = unk_0xDFB7BFA6482FEE1E() + 5000;
						unk_0x04BC2951833EF44D(iLocal_348, joaat("weapon_sniperrifle"));
						unk_0x45B1B4E55BF15523(iLocal_348, Local_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						unk_0x1EB6C2E7D90CD82E(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				if (unk_0x4E8DA737B686529A(iLocal_348, 713668775) == 7)
				{
					if (unk_0x591190E69BE43117(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0))
					{
						unk_0xCA089CD1A17D76DF(iLocal_348);
						unk_0x8ADA462BC5F42FD8(iLocal_348, unk_0x7D2B9E6A64637269(), -1, 1024, 2);
						unk_0x1EB6C2E7D90CD82E(iLocal_348, 1);
						unk_0xBE91B077ADADE97F(iLocal_348, 1);
						iLocal_255 = 6;
					}
				}
				else if (!iLocal_301[0])
				{
					if (unk_0xDFB7BFA6482FEE1E() > iLocal_334)
					{
			...
			case 5:
				if (!unk_0xECEC7528A52B4EE8(iLocal_348))
				{
					if (unk_0x6CEA35622FBD9702(iLocal_348, joaat("weapon_sniperrifle"), 0))
					{
						unk_0x04BC2951833EF44D(iLocal_348, joaat("weapon_sniperrifle"));
					}
					if (func_488())
					{
						if (unk_0x1F9D47D45E125FA6(iLocal_346))
						{
							unk_0x4603196EEEA2355C(iLocal_346, 0, 0);
						}
						func_354();
						func_353();
						func_8(&iLocal_263);
						unk_0x16D66F11FE644901(iLocal_348);
						unk_0x78CDDD1E6367978D(iLocal_348, Local_368, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(iLocal_348, fLocal_304);
						iLocal_288 = 0;
						iLocal_255 = 6;
					}
				}
			...
			case 6:
				...
				else if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_361, Local_362, 7f, 0, 1, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 12:
				if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_333 == -1)
					{
						iLocal_333 = unk_0xD5504E3827DE12F9(Local_395, Local_396, 0f, 0, 7);
					}
					func_380();
					iLocal_301[9] = 1;
					func_226(0);
					...
					iLocal_328 = 0;
					unk_0x8ADA462BC5F42FD8(iLocal_348, unk_0x7D2B9E6A64637269(), -1, 1024, 2);
					unk_0x45B1B4E55BF15523(iLocal_348, Local_369, 1f, 60000, 0.25f, 512, fLocal_305);
					unk_0x1EB6C2E7D90CD82E(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
			...
			case 13:
				if (!unk_0xECEC7528A52B4EE8(iLocal_348))
				{
					if (func_488())
					{
						...
						unk_0x16D66F11FE644901(iLocal_348);
						unk_0x78CDDD1E6367978D(iLocal_348, Local_369, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(iLocal_348, fLocal_305);
						func_380();
						func_353();
						func_354();
						func_8(&iLocal_263);
			...
			case 14:
				if (unk_0x4E8DA737B686529A(iLocal_348, 713668775) == 7)
				{
					if (unk_0x591190E69BE43117(iLocal_348, Local_369, 1.25f, 1.25f, 2.5f, 0, 1, 0) && unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_363, Local_364, 10f, 0, 1, 0))
					{
						if (func_485())
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_328 == 1)
							{
								...
								if (iLocal_333 != -1)
								{
									unk_0xF5A3E4A97D6F6DD4(iLocal_333);
									iLocal_333 = -1;
								}
								func_353();
								iLocal_301[11] = 1;
			...
			case 16:
				if (func_477())
				{
					iLocal_331 = 0;
					func_458();
					unk_0x45B1B4E55BF15523(iLocal_348, Local_420[0 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
					unk_0x1EB6C2E7D90CD82E(iLocal_348, 1);
					func_314(0, 0);
					iLocal_255 = 17;
				}
			...
			case 17:
				unk_0x297D19A25D01587C(iLocal_348, 1.4f);
				if (!iLocal_301[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0), Local_358, 1) > 10f)
							{
				...
				switch (iLocal_331)
				{
					case 0:
						...
						{
							unk_0x45B1B4E55BF15523(iLocal_348, Local_420[1 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 1:
						...
						{
							unk_0x45B1B4E55BF15523(iLocal_348, Local_420[2 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 2:
						...
						{
							unk_0x45B1B4E55BF15523(iLocal_348, Local_420[3 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 3:
						...
						{
							unk_0x45B1B4E55BF15523(iLocal_348, Local_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (unk_0x4E8DA737B686529A(iLocal_348, 713668775) == 7 || (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_413, Local_414, 3.5f, 0, 1, 0) && unk_0x8954E9D0A9F6F8CF(iLocal_348, Local_413, Local_414, 3.5f, 0, 1, 0)))
						{
							unk_0x1EB6C2E7D90CD82E(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 20:
				if (!unk_0xECEC7528A52B4EE8(iLocal_348))
				{
					if (func_488())
					{
						...
						unk_0x16D66F11FE644901(iLocal_348);
						unk_0x78CDDD1E6367978D(iLocal_348, Local_370, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(iLocal_348, fLocal_371);
						func_353();
						func_354();
						func_314(1, 0);
						iLocal_255 = 18;
			...
			case 18:
				...
				{
					Var0 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) };
					if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_413, Local_414, 3.5f, 0, 1, 0) || Var0.f_2 > 41f)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT_ROOF", 7, 0, 0, 0))
						{
							unk_0xCA089CD1A17D76DF(iLocal_348);
							unk_0x45B1B4E55BF15523(iLocal_348, Local_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							unk_0x1EB6C2E7D90CD82E(iLocal_348, 0);
							iLocal_255 = 21;
						}
					}
					else if (unk_0x4E8DA737B686529A(iLocal_348, -875674219) != 1)
					{
						unk_0xB0C1A43193C25F7A(iLocal_348, unk_0x7D2B9E6A64637269(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_365, Local_366, 20f, 0, 1, 0))
				{
					...
					{
						func_316();
						iLocal_322 = unk_0xDFB7BFA6482FEE1E() + 2000;
						bLocal_279 = true;
					}
					if (func_485())
					{
				...
				if (bLocal_279)
				{
					if (unk_0xDFB7BFA6482FEE1E() > iLocal_322)
					{
						func_316();
			...
			case 24:
				...
				{
					unk_0x16D66F11FE644901(iLocal_348);
					unk_0x78CDDD1E6367978D(iLocal_348, Local_417, 1, 0, 0, 1);
					unk_0xCD37A28258D70638(iLocal_348, fLocal_418);
					unk_0x8ADA462BC5F42FD8(iLocal_348, unk_0x7D2B9E6A64637269(), -1, 0, 2);
					if (unk_0x419E13582192CFEA(iLocal_346))
					{
						unk_0x4603196EEEA2355C(iLocal_346, 0, 0);
					}
				}
				...
				if (!func_223())
				{
					...
					else if (!func_223())
					{
						if (func_308(iLocal_348))
						{
							unk_0xCA089CD1A17D76DF(iLocal_348);
							unk_0xBC4B0376D5E2BD1A(iLocal_348, 0);
							unk_0x5C679902079A7E80(&uLocal_351);
							unk_0x45B1B4E55BF15523(0, Local_422, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x45B1B4E55BF15523(0, Local_423, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x45B1B4E55BF15523(0, Local_424, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x4B770B4D8C1A469B(0, 1193033728, 0);
							unk_0x1BBD0A5729AB1226(uLocal_351);
							unk_0x8A1AC8EBC73850C8(iLocal_348, uLocal_351);
							unk_0x8D5B447F21217223(&uLocal_351);
							unk_0x504B26425DFF773C(iLocal_348, 1);
						}
						iLocal_255 = 0;
					}
				}
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				...
				{
					if (unk_0x6B9E71121F5B8154(iLocal_348))
					{
						func_2();
						iLocal_324 = unk_0xDFB7BFA6482FEE1E() + 2400;
						iLocal_280 = 1;
					}
				}
				if (((unk_0xE50EB54E0F21BED0(iLocal_348, 0) || unk_0xA6E8FBD68548675F(iLocal_348, unk_0x7D2B9E6A64637269(), 1)) || unk_0x16DE9112AAAB5C8C(iLocal_348, 0, 2)) || unk_0x16B4C536089C3CAD(-1, unk_0xD6E677FAD7521410(iLocal_348, 0), 10f))
				{
					func_2();
					iLocal_324 = unk_0xDFB7BFA6482FEE1E() + 2400;
					iLocal_280 = 1;
			...
			else if (unk_0xDFB7BFA6482FEE1E() > iLocal_324)
			{
				if (unk_0x419E13582192CFEA(iLocal_348))
				{
					if (!unk_0xE50EB54E0F21BED0(iLocal_348, 0))
					{
						unk_0xCA089CD1A17D76DF(iLocal_348);
						unk_0x1DC2BF231DE6A016(iLocal_348, unk_0x7D2B9E6A64637269(), 100f, -1, 0, 0);
						unk_0x504B26425DFF773C(iLocal_348, 1);
						func_318(2);
					}
					else
	...
	if (func_462())
	{
		...
		while (iVar1 < func_461())
		{
			if (unk_0x419E13582192CFEA(func_460(iVar1)))
			{
				...
				{
					if (unk_0x20799DE10C73159E(iVar0, iLocal_341))
					{
...
void func_463()
{
	if (!unk_0xC49311A2A500FF09(iLocal_348, 0) && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
	{
		if (!iLocal_433)
		{
			iLocal_434 = unk_0xDFB7BFA6482FEE1E() + 3000;
			iLocal_433 = 1;
		}
		else if (unk_0xDFB7BFA6482FEE1E() > iLocal_434)
		{
			if (func_372())
			{
...
void func_464()
{
	if (!unk_0xC6D04E4B28753F77(iLocal_348, 1) && !unk_0xC6D04E4B28753F77(unk_0x7D2B9E6A64637269(), 1))
	{
		if (unk_0xC49311A2A500FF09(iLocal_348, 0) && unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			if (!iLocal_291)
			{
				iLocal_317 = unk_0xDFB7BFA6482FEE1E() + 3000;
				iLocal_291 = 1;
			}
			else if (unk_0xDFB7BFA6482FEE1E() > iLocal_317)
			{
				if (!func_223())
				{
					if (!iLocal_301[8])
					{
						...
						{
							if (!unk_0xAB6A270F84A8781E(&Local_428))
							{
								Local_428 = { func_465() };
							}
							else
...
void func_467()
{
	...
	if (func_308(unk_0x7D2B9E6A64637269()) && func_308(iLocal_348))
	{
		if (unk_0xC49311A2A500FF09(iLocal_348, 0) && unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			if (func_230(iLocal_426))
			{
				if (unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0) == iLocal_426 && unk_0x75B58B38E45C6F9A(iLocal_348, 0) == iLocal_426)
				{
					if (!iLocal_431)
					{
						iLocal_432 = unk_0x5E7C0A485B91DB87(iLocal_426);
						iLocal_431 = 1;
					}
					else
					{
						iVar0 = unk_0x5E7C0A485B91DB87(iLocal_426);
						if (iVar0 < iLocal_432)
						{
							func_468();
	...
	if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
	{
		if (!iLocal_301[7])
		{
			if (!func_223())
			{
				if (func_372())
				{
					if (unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0) == iLocal_426)
					{
...
void func_471()
{
	if (!unk_0xC6D04E4B28753F77(iLocal_348, 1) && !unk_0xC6D04E4B28753F77(unk_0x7D2B9E6A64637269(), 1))
	{
		if (!unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_361, Local_362, 7f, 0, 1, 0))
		{
			if (!unk_0xC49311A2A500FF09(iLocal_348, 0) && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 1))
			{
				if (!iLocal_297)
				{
					if (!func_398("HT_NXTLOC", 0, 0) && iLocal_301[4])
					{
						iLocal_332 = unk_0xDFB7BFA6482FEE1E() + 20000;
						iLocal_297 = 1;
					}
				}
				else if (unk_0xDFB7BFA6482FEE1E() > iLocal_332)
				{
...
void func_474()
{
	if (!unk_0xC6D04E4B28753F77(iLocal_348, 1) && !unk_0xC6D04E4B28753F77(unk_0x7D2B9E6A64637269(), 1))
	{
		if (!iLocal_429)
		{
			...
			{
				iLocal_430 = unk_0xDFB7BFA6482FEE1E() + 3000;
				iLocal_429 = 1;
			}
		}
		else if (unk_0xDFB7BFA6482FEE1E() > iLocal_430)
		{
			if (!func_223() && func_372())
			{
				if (!iLocal_301[4])
...
void func_475()
{
	if (unk_0x8954E9D0A9F6F8CF(unk_0x7D2B9E6A64637269(), Local_361, Local_362, 16f, 0, 1, 0))
	{
		if ((iLocal_302[1] && !func_398("HT_NXTLOC", 0, 0)) && !func_223())
		{
			if (!iLocal_296)
			{
				iLocal_316 = unk_0xDFB7BFA6482FEE1E() + 15000;
				iLocal_296 = 1;
			}
			else if (unk_0xDFB7BFA6482FEE1E() > iLocal_316)
			{
...
void func_476()
{
	if (unk_0x530FB711AE9CF518(unk_0x7D2B9E6A64637269()))
	{
		if (!iLocal_273)
		{
			uLocal_435 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
			if (!unk_0xC49311A2A500FF09(iLocal_348, 1))
			{
				if (!unk_0x7D9E9A30FEC1F2A4(uLocal_435))
				{
					if (func_372())
					{
						if (!func_223())
...
int func_477()
{
	if (!unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!unk_0x419E13582192CFEA(iLocal_346))
		{
			unk_0xCA089CD1A17D76DF(iLocal_348);
		...
		{
			unk_0x04F4D55F2C0C756D(&iLocal_346);
		}
	}
	else if (!unk_0x419E13582192CFEA(iLocal_346))
	{
		unk_0xCA089CD1A17D76DF(iLocal_348);
		return 1;
	}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x3E72EB0926A107F9(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_223())
			{
...
void func_480(int iParam0)
{
	...
	if (((iLocal_338 < 3 && !func_398("HT_SHDISH", 0, 0)) && !func_398("HT_SHTYRE", 0, 0)) && !func_398("HT_SHCOY", 0, 0))
	{
		if (iLocal_277)
		{
			if (unk_0xDFB7BFA6482FEE1E() > iLocal_326)
			{
		...
		{
			iLocal_327 = unk_0xB36B8558948EA7A8(10000, 15000);
			iLocal_326 = (unk_0xDFB7BFA6482FEE1E() + iLocal_327);
			iLocal_277 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							if (!unk_0x591190E69BE43117(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !unk_0x3E09537707C40210(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f))
							{
								if (unk_0x4E8DA737B686529A(iLocal_348, 713668775) != 1 || unk_0x4E8DA737B686529A(iLocal_348, 713668775) != 7)
								{
									iLocal_328 = 1;
								}
							}
					...
					case 1:
						if (!unk_0x591190E69BE43117(iLocal_348, Local_369, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!unk_0x591190E69BE43117(iLocal_348, Local_372, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_269)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_348))
			{
				...
				if (bParam1)
				{
					unk_0xFBF1F1BE9D437D22(0, Local_258[iLocal_335 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				unk_0x8A1AC8EBC73850C8(iLocal_348, uVar0);
...
int func_488()
{
	if (unk_0x419E13582192CFEA(iLocal_346) && unk_0xDA872572A987B2AD(iLocal_346, iLocal_348))
	{
		return 1;
	}
	if (!iLocal_265)
...
void func_489()
{
	unk_0x16E516CA9C88FF48(iLocal_342);
	while (!unk_0xA9C0BBFB9CBB66F1(iLocal_342))
	{
		wait(0);
	}
	iLocal_265 = 1;
...
void func_490(bool bParam0)
{
	...
	if (func_308(iLocal_348))
	{
		if (unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			unk_0xBE91B077ADADE97F(iLocal_348, 1);
			unk_0x880C7B361C9651EE(iLocal_348);
			unk_0x5C679902079A7E80(&uVar0);
...
void func_491(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_308(iLocal_348) && func_308(unk_0x7D2B9E6A64637269()))
	{
		if (func_462())
		{
			iVar1 = 0;
			while (iVar1 < func_461())
			{
				...
				{
					iVar0 = unk_0xFAA5505029C4B5A6(func_460(iVar1));
					if (iVar0 != unk_0x7D2B9E6A64637269() && iVar0 != iLocal_348)
					{
			...
			while (iVar1 < 5)
			{
				if (unk_0x419E13582192CFEA(Local_259[iVar1 /*29*/].f_12))
				{
					if (unk_0xA6E8FBD68548675F(Local_259[iVar1 /*29*/].f_12, unk_0x7D2B9E6A64637269(), 1))
					{
						unk_0xA5030CC1B9A0FDA6(Local_259[iVar1 /*29*/].f_12);
						iLocal_321++;
					}
				}
				iVar1++;
...
void func_492()
{
	if (!unk_0xECEC7528A52B4EE8(iLocal_348))
	{
		if (((unk_0x93B9F446C9E48692(unk_0xD6E677FAD7521410(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0xD6E677FAD7521410(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || unk_0x93B9F446C9E48692(unk_0xD6E677FAD7521410(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0xD6E677FAD7521410(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || unk_0x93B9F446C9E48692(unk_0xD6E677FAD7521410(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0xD6E677FAD7521410(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || unk_0x16B4C536089C3CAD(-1, unk_0xD6E677FAD7521410(iLocal_348, 0), 10f))
		{
			unk_0xC14EEEFD0DE24816(1, iLocal_261, 1862763509);
		}
		if (!iLocal_272)
		{
			if (func_494() || unk_0x4140085B99B17F97(unk_0x1146A9AE09CE2B14(), iLocal_348))
			{
				if (func_223())
				{
					func_316();
		...
		if (!bLocal_298)
		{
			if (unk_0x480609C7D10E7F3E(iLocal_348))
			{
				unk_0x1B0723EFE914C031(iLocal_348, 0);
				bLocal_298 = true;
			}
		}
		else if (unk_0x674642CC58396437(iLocal_348))
		{
			unk_0x1B0723EFE914C031(iLocal_348, 1);
			bLocal_298 = false;
		}
...
int func_494()
{
	if (func_308(iLocal_348))
	{
		if (iLocal_255 != 25)
		{
			if ((!unk_0x24A466C655E8588A(unk_0x7D2B9E6A64637269(), 6) && unk_0x97AEEA04505AFDC3(unk_0x7D2B9E6A64637269())) && func_373(iLocal_348, unk_0x7D2B9E6A64637269(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!unk_0x24A466C655E8588A(unk_0x7D2B9E6A64637269(), 6) && unk_0x97AEEA04505AFDC3(unk_0x7D2B9E6A64637269())) && unk_0x836F48E8C4A773BF(unk_0x7D2B9E6A64637269(), iLocal_348, 30f)) && func_373(iLocal_348, unk_0x7D2B9E6A64637269(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_495()
{
	if (!unk_0xECEC7528A52B4EE8(iLocal_348))
	{
		if ((unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && unk_0x4598B7969D5B0A28(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_328 == 1)
		{
			if (unk_0x419E13582192CFEA(iLocal_346))
			{
				unk_0x04F4D55F2C0C756D(&iLocal_346);
		...
		if (!unk_0x419E13582192CFEA(iLocal_346))
		{
			if (unk_0x698F51FB33ADAF7B(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro", 3) && unk_0x4598B7969D5B0A28(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_346 = unk_0x795434E153F90E41(iLocal_342, unk_0xD6E677FAD7521410(iLocal_348, 1), 0, 0, 0);
			}
		}
		else if (!unk_0xDA872572A987B2AD(iLocal_346, iLocal_348))
		{
			unk_0x0F1058706D5A58B4(iLocal_346, iLocal_348, unk_0xA79DFB802C09F5F5(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x8B6A925F148E0E94())
			{
				...
				Var4 = { func_498(Global_77503, Global_77505, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_514()
{
	if (!iLocal_284)
	{
		unk_0xF479CA7199C54C8F("FRIENDLIES", &iLocal_261);
		unk_0x2271ED1E65FB75EE(iLocal_348, iLocal_261);
		unk_0x78B2DF314748056B(1, iLocal_261, 1862763509);
		unk_0x78B2DF314748056B(1, 1862763509, iLocal_261);
		unk_0x78B2DF314748056B(2, iLocal_261, -2065892691);
...
void func_529()
{
	...
	if (iLocal_265)
	{
		unk_0x824F744352C8BC82(iLocal_342);
	}
	if (bLocal_264)
	{
	...
	if (iLocal_293)
	{
		unk_0xE6B53A6E51AAA49F(uLocal_350, 0);
	}
...
void func_540()
{
	unk_0x824F744352C8BC82(iLocal_341);
}
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_546())
	{
		...
		{
			iVar2 = func_302(unk_0x471C98FD94C0A5FD());
			if (iVar2 > -1)
			{
