...
void __EntryFunction__()
{
	...
	{
		unk_0x5C052A30B9FCA449(Local_81.f_35[0], 1);
	}
...
void func_1()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (unk_0xDA654EB115F9FF7D(sLocal_89, "DEFAULT"))
			{
				func_349(1);
			}
			else
...
int func_7(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_13(&iVar2);
		iVar3 = func_12(Var1, Global_112293.f_7686.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_10(Global_112293.f_7686.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_8(Global_112293.f_7686.f_765[iVar2 /*10*/]))
				{
					Global_112293.f_7686.f_765[iVar2 /*10*/] = { Var1 };
					func_9(&Var1);
					return 1;
...
void func_20()
{
	...
	{
		func_6(13, floor(Global_112293.f_10192.f_3853));
	}
...
int func_44(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77059[1 /*14*/] = { func_95(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_87(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_87(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_172(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_173(&uVar1, Var0.f_3, Global_99407, iParam1, iParam2);
	}
}
...
void func_215()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			func_242(unk_0x7D2B9E6A64637269(), Local_256, 201.2074f, 0, 1);
			if (!unk_0xCE84F8AB9BD41C13())
			{
				unk_0x22C43B6780E8FE5B(Local_256, 100f, 1);
			}
			if (!unk_0x419E13582192CFEA(iLocal_88))
			{
				iLocal_88 = unk_0x170478CC84C8AE2F(iLocal_87, 1970.362f, 2859.594f, 49.2307f, 151.6095f, 1, 1, 0);
			}
			if (func_214(iLocal_85))
			{
				unk_0x1D7A4E9E23D306D6(iLocal_85, 0);
				unk_0x2271ED1E65FB75EE(iLocal_85, 1862763509);
				unk_0x504B26425DFF773C(iLocal_85, 1);
				if (func_214(iLocal_88))
				{
					unk_0xC612552622E74D36(iLocal_88, 0, 0);
					unk_0xA2FEFE3BBCD9FB23(iLocal_88, 0, 0);
					unk_0x47D0DDD8833C5E5F(iLocal_88, 1084227584);
					unk_0xCF882B151A34557C(iLocal_88, 0);
					unk_0x5A64713E8D99EAA4(iLocal_85, iLocal_88, -1);
					unk_0x5C052A30B9FCA449(iLocal_88, 3);
					unk_0x89E171705EA920DA(iLocal_88, 1, 1, 0);
				}
			}
			if (func_214(unk_0x7D2B9E6A64637269()))
			{
				unk_0x4261814A9A26E86F(unk_0x7D2B9E6A64637269(), sLocal_90, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 1:
			if (unk_0xCE84F8AB9BD41C13())
			{
				if (unk_0xABE4F4FD4329B037())
				{
					...
					uLocal_264 = unk_0x1CA878DB277C6DF0(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
					unk_0x6FA8221C9D2ECB46(uLocal_264, 1);
					uLocal_265 = unk_0x1CA878DB277C6DF0(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
				...
				if (func_214(iLocal_88))
				{
					if (func_240(iLocal_85, iLocal_88, -1))
					{
						if (iLocal_263)
						{
							...
							{
								unk_0x0509CE092AC81B7C(iLocal_85, iLocal_88, fLocal_258, 786599);
								func_218(unk_0x7D2B9E6A64637269(), 30000, 0);
								unk_0xE5AC37B329B31F82(0, 0, 3, 0);
								unk_0x6FA8221C9D2ECB46(uLocal_265, 0);
								func_244(0);
								iLocal_83 = 2;
							}
							else if (timera() > 10000)
							{
								if (!unk_0x2671671BBCC6AD9F(uLocal_265))
								{
									unk_0x6FA8221C9D2ECB46(uLocal_265, 1);
									unk_0x6FA8221C9D2ECB46(uLocal_264, 0);
									unk_0xFD866EC0672D68D5(uLocal_265, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
								}
							}
						}
						else if (func_214(unk_0x7D2B9E6A64637269()))
						{
							if (unk_0x4E8DA737B686529A(unk_0x7D2B9E6A64637269(), -2017877118) == 1)
							{
								...
								settimera(0);
								func_217(2000, 0);
								unk_0xFD866EC0672D68D5(uLocal_264, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
							}
						}
					}
					else
...
void func_243()
{
	if (!unk_0x419E13582192CFEA(iLocal_85))
	{
		iLocal_85 = unk_0x0FDCFECB2EF2BC1C(26, iLocal_86, Local_257, 0, 1, 1);
	}
	if (func_214(iLocal_85))
	{
		unk_0x1B0723EFE914C031(iLocal_85, 1);
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				{
					unk_0xF2CEEA627AD5A24B(Local_81.f_35[0], sLocal_84, 0, joaat("bison"), 0);
				}
				func_280();
...
void func_292()
{
	...
	unk_0x068BDE31F7D112BB(sLocal_90);
	while (((!unk_0x0EC2B29D4172D225(sLocal_90) || !unk_0x080D38ACEC5DC1A2(0)) || !unk_0xA9C0BBFB9CBB66F1(iLocal_87)) || !unk_0xA9C0BBFB9CBB66F1(iLocal_86))
	{
		wait(0);
	}
	unk_0x5E84945E26CAEF1F(0.1f);
	unk_0xF7865792085F5D28(128, 0);
	func_241(&uLocal_91, 0, unk_0x7D2B9E6A64637269(), "MICHAEL", 0, 1);
	if (func_214(unk_0x7D2B9E6A64637269()))
	{
...
void func_294(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_296(Var7.f_1)) && iVar9 < 51)
			{
	...
	if (Global_77502 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x8B6A925F148E0E94())
			{
				...
				Var4 = { func_302(Global_77503, Global_77505, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_323()
{
	...
	unk_0x5E84945E26CAEF1F(1f);
	func_347(&iLocal_85, 1, 0, 1);
	unk_0xF9135F131C423364(sLocal_90);
...
int func_351(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_357())
	{
		...
		{
			iVar2 = func_352(unk_0x471C98FD94C0A5FD());
			if (iVar2 > -1)
			{
