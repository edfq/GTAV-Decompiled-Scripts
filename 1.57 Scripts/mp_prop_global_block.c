...
void func_26(struct<4> Param0, var uParam1, var uParam2, struct<6> Param3, struct<4> Param4, var uParam5, var uParam6, var uParam7)
{
	...
	*uParam7 = { unk_0x26C2ACB261895E70(Param4, 0f, Var0) };
...
int func_34(int iParam0)
{
	...
	if (unk_0x02BFF15CAA701972() && func_43())
	{
		...
		uVar3 = unk_0x15173FB88ABC94F9(&sVar2);
		if (unk_0x92F2FDB7CAFB0FD0(uVar3))
		{
			uVar4 = unk_0xB4D939A0198820EF(uVar3, 426439576, 1);
