...
int func_24(int iParam0, int iParam1)
{
	...
	if (unk_0x02BFF15CAA701972() && func_70())
	{
		...
		func_63(&sVar10, Var11, unk_0x6471F4759775FCA4(unk_0x7D2B9E6A64637269()), 3, 1, func_66(iParam0), func_65(iParam0), -1, 0, 0);
...
void func_91(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(uParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_92(Var7.f_1)) && iVar9 < 51)
			{
...
int func_122(bool bParam0)
{
	...
	unk_0xD885BEFA31A18D47(joaat("num_discipline_gold_earned"), &iVar3, -1);
	if (iVar1 > iVar3 && iVar1 > 0)
	{
		unk_0xAC4FD27671081628(joaat("num_discipline_gold_earned"), iVar1, 1);
		func_136(17, iVar1);
	}
	if (bParam0)
	{
