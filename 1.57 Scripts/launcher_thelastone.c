...
int func_184(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(unk_0x7D2B9E6A64637269()) && func_127(uParam0->f_28[0])) && (unk_0xDFB7BFA6482FEE1E() - uParam0->f_60) > iParam6) && func_190(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f)
			{
				uVar0 = 16;
	...
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		if (!unk_0xAB6A270F84A8781E(uParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_190(unk_0x7D2B9E6A64637269(), Param4, 1);
					fVar1 = func_190(unk_0x7D2B9E6A64637269(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0x0FDCFECB2EF2BC1C(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
