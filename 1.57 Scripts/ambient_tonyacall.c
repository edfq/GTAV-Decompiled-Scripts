...
int func_1()
{
	...
	if ((vdist2(Var0, Var1) > 10000f || unk_0xE50EB54E0F21BED0(uLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0x419E13582192CFEA(uLocal_38) && !unk_0xE50EB54E0F21BED0(uLocal_38, 0))
			{
				if (unk_0x591190E69BE43117(uLocal_38, Local_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x8A1AC8EBC73850C8(uLocal_38, uVar2);
					unk_0x8D5B447F21217223(&uVar2);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0x419E13582192CFEA(uLocal_38) && !unk_0xE50EB54E0F21BED0(uLocal_38, 0))
			{
				if (unk_0x507B30DD5CDF782F(uLocal_38) == 1)
				{
					if (!unk_0x419E13582192CFEA(uLocal_39))
					{
						...
						{
							fVar3 = unk_0x4598B7969D5B0A28(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar3 >= 0.157f)
							{
				...
				{
					iVar4 = (unk_0xB36B8558948EA7A8(0, 65535) % 2);
					if (iVar4 == 0)
					{
