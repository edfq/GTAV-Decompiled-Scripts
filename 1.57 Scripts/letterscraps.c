	...
	switch (iLocal_43)
	{
				...
				if (unk_0xE0A6F16F546C8274())
				{
					if (!func_20())
					{
						if (((!unk_0x8820F6FCD373F9F7() && !func_14()) && !func_13()) && !func_12())
						{
							...
							uLocal_55 = unk_0x42AA2CCF0B61DCD8("LETTER_SCRAPS");
							while (!unk_0xDAE4BC89A198A6AF(uLocal_55))
							{
								wait(0);
							}
							unk_0x704F8697BB515627(uLocal_55, "SET_LETTER_TEXT");
							func_11(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0x44EF5678D6916481(uLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0x7E8029344EE9DC34((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
...
int func_40(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((vdist2(Param2, unk_0xCA4950AD4AC0DAD8((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
...
void func_75()
{
	...
	unk_0x3D9BC07C93913E04(&uLocal_55);
