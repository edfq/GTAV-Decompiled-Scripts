...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0xBD366067DA5DC0DE(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0x0F2D318764C61F56(joaat("component_at_scope_large"));
	iLocal_56 = unk_0x0F2D318764C61F56(joaat("component_at_ar_supp_02"));
	...
	unk_0x6AF7EE4DD9F8B944(Var1, 3f, 1, 0, 0, 0);
	while (true)
	{
		wait(0);
		if (!func_197(&Var0, 1))
		...
		if (func_169(&Var0, 0) && unk_0x0BCA9ADE67DF9DD8((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x7D2B9E6A64637269()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_188(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_217(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x419E13582192CFEA(uLocal_58))
			{
				iLocal_58 = unk_0xB04D76ED3835CFA3(joaat("weapon_sniperrifle"), 0, Local_57, 0, 1065353216, 0, 0, 1);
				unk_0x3C11038EDEC5E20E(iLocal_58, joaat("component_at_scope_large"));
				unk_0x3C11038EDEC5E20E(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (unk_0xCC09B877A009E41F(Local_57, 1f, iLocal_54, 0))
			{
				unk_0xBDDCDEC7B6205897(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
