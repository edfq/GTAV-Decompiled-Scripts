...
void func_192()
{
	...
	{
		case 0:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0x7D2B9E6A64637269()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_217(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_237(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				uLocal_54 = unk_0xD955F1CC0BCABC78(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xB9314D20143CEED3(uLocal_54, 1);
				unk_0xAD844C8843FC405C(uParam0->f_28[0], uLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_289(int iParam0, bool bParam1)
{
	...
	{
		unk_0x1AD5BCFEC31BB8D9(&uLocal_224);
	}
