...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0xCC7E6EA219FD8BAC() && !unk_0xA12BCF836724905A(unk_0x1146A9AE09CE2B14(), 0)) || iLocal_243)
		{
			if (!func_236())
			{
				if (func_235())
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					if (!unk_0xE50EB54E0F21BED0(iLocal_234, 0))
					{
						if (unk_0xC49311A2A500FF09(iLocal_234, 0))
						{
							func_219();
						}
					}
					if (!unk_0xE50EB54E0F21BED0(iLocal_235, 0))
					{
						if (unk_0xC49311A2A500FF09(iLocal_235, 0))
						{
							func_219();
						}
					}
					...
					if (!iLocal_243)
					{
						...
						{
							if (func_204(unk_0x7D2B9E6A64637269(), unk_0xD6E677FAD7521410(iLocal_236, 1), 1) < IntToFloat(iLocal_256) && !unk_0x98E18969B1D0C4AB(iLocal_236))
							{
								if (!iLocal_250)
								{
									func_202();
									...
									if (unk_0x575B7C28D81C0B4D(uLocal_233))
									{
										unk_0xB5E587F8B911573B(uLocal_233, 1);
									}
									iLocal_250 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_245)
						{
							if (!unk_0xE50EB54E0F21BED0(iLocal_236, 0))
							{
								...
								{
									if (!unk_0xECEC7528A52B4EE8(iLocal_234))
									{
										unk_0x5C679902079A7E80(&uLocal_253);
										unk_0x95CA4545D0C61309(0, iLocal_236, -1, -1, 2f, 524296, 0);
										unk_0x9DA29013F33252A6(0, unk_0x7D2B9E6A64637269(), 0, 16);
										unk_0x1BBD0A5729AB1226(uLocal_253);
										unk_0x8A1AC8EBC73850C8(iLocal_234, uLocal_253);
										unk_0x8D5B447F21217223(&uLocal_253);
										unk_0x504B26425DFF773C(iLocal_234, 1);
									}
									iLocal_245 = 1;
								}
							}
...
void func_2()
{
	if (!unk_0xE50EB54E0F21BED0(iLocal_234, 0))
	{
		if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 10f, 10f, 10f, 0, 1, 0) && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			if ((timerb() > 3000 && iLocal_254 == 0) && !func_3())
			{
				func_186(&uLocal_66, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				unk_0x8ADA462BC5F42FD8(iLocal_234, unk_0x7D2B9E6A64637269(), 4000, 0, 2);
				unk_0x78B2DF314748056B(5, iLocal_63, 1862763509);
				settimerb(0);
				iLocal_254++;
			}
	...
	if (!iLocal_249)
	{
		if (!unk_0xECEC7528A52B4EE8(iLocal_234))
		{
			...
			else if (timera() > 4000)
			{
				if (!unk_0xECEC7528A52B4EE8(iLocal_234))
				{
					unk_0x9DA29013F33252A6(iLocal_234, unk_0x7D2B9E6A64637269(), 0, 16);
					unk_0x504B26425DFF773C(iLocal_234, 1);
				}
			...
			if (!unk_0xECEC7528A52B4EE8(iLocal_234))
			{
				if ((iLocal_257 >= 1 && unk_0xEDE161DE4F39475B(unk_0x7D2B9E6A64637269(), 0)) && iLocal_246)
				{
					unk_0x4261814A9A26E86F(iLocal_234, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0xFB8A6909539A30B1(sLocal_259);
	...
	else
	{
		...
		switch (iLocal_260)
		{
			...
			case 1:
				...
				{
					func_167();
					uLocal_64 = unk_0xD1F051AA4563F197(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_159(1);
					unk_0x8BA9BCDD56AA7115(500);
					wait(2000);
					if (unk_0x419E13582192CFEA(iLocal_234))
					{
						unk_0x0F3BD19FF11738D3(&iLocal_234);
					}
					iLocal_260++;
				}
				else
			...
			case 2:
				...
				iLocal_237 = unk_0x12CE1CDBAD8161A5(0, 1063.595f, 3227.571f, 39.3899f, 1, 0, 0);
				uVar0 = unk_0x42F3C85A00B4FC7B(iLocal_237, 26, iLocal_240, -1, 1, 1);
				uVar0 = uVar0;
				if (!iLocal_248)
				{
					if (unk_0x952AB441FA24BF16("Train_Horn", 0, -1))
					{
						unk_0xE2D24A37AFCF27BF(-1, "Warning_Once", iLocal_237, "TRAIN_HORN", 0, 0);
					}
				}
			...
			case 3:
				unk_0xDF27EE31B849DF76(uLocal_64);
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0x234B68AC2E35ED5A(Global_77059[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77059[1 /*14*/] = { func_95(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77059[1 /*14*/] = { func_95(iVar10, 14, uVar15[iVar1], -1) };
			func_65(iParam0, Global_77059[1 /*14*/].f_12, Global_77059[1 /*14*/].f_3, Global_77059[1 /*14*/].f_4);
			func_87(14);
			if (Global_77057 == 1)
			{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0x44C4C2E7417F5E29(iParam3, 8, -1, 0, -1, func_55(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_97(int iParam0)
{
	...
	func_98(&(Global_77059[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2621445 = Var5;
				func_98(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x01758128AAB0BA8F(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77229)
		{
			...
			Global_2621445 = Var9;
			func_98(&(Global_77059[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x01758128AAB0BA8F(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0x44C4C2E7417F5E29(iVar1, 8, -1, 0, -1, func_55(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_169()
{
	if ((unk_0xECEC7528A52B4EE8(iLocal_234) && unk_0xECEC7528A52B4EE8(iLocal_235)) && !iLocal_249)
	{
		func_15();
	}
	if (iLocal_50 == 1)
	{
		if (!iLocal_249)
		{
			if (!unk_0xECEC7528A52B4EE8(iLocal_234))
			{
				if (!unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 50f, 50f, 50f, 0, 1, 0))
				{
					func_15();
				}
			}
	...
	{
		if (!unk_0xECEC7528A52B4EE8(iLocal_234) && !unk_0xECEC7528A52B4EE8(iLocal_235))
		{
			if (!unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 200f, 200f, 200f, 0, 1, 0) && !unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 200f, 200f, 200f, 0, 1, 0))
			{
				func_15();
			}
		}
...
void func_170()
{
	if (!unk_0xECEC7528A52B4EE8(iLocal_234))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0xEDE161DE4F39475B(unk_0x7D2B9E6A64637269(), 0))
			{
				if (!unk_0xD406352E21A7E1D0(iLocal_234, unk_0x7D2B9E6A64637269(), 8f, 8f, 8f, 0, 1, 0) || !unk_0x591190E69BE43117(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
				{
					if ((unk_0x4140085B99B17F97(unk_0x1146A9AE09CE2B14(), iLocal_234) || unk_0x87BE50F80F3FCEAB(unk_0x1146A9AE09CE2B14(), iLocal_234)) || !unk_0x591190E69BE43117(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
					{
						if (unk_0x24A466C655E8588A(unk_0x7D2B9E6A64637269(), 6) || !unk_0x591190E69BE43117(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
						{
							unk_0x1DC2BF231DE6A016(iLocal_234, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
							unk_0x504B26425DFF773C(iLocal_234, 1);
							func_202();
							wait(0);
...
void func_171()
{
	if (iLocal_50 == 1)
	{
		if (!unk_0xECEC7528A52B4EE8(iLocal_234))
		{
			if (!unk_0xE196738BFC6C83A6(iLocal_234))
			{
				if (iLocal_260 < 3)
				{
					if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 20f, 20f, 10f, 0, 1, 0))
					{
						if (func_176())
						{
							func_175(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!unk_0xE50EB54E0F21BED0(iLocal_234, 0))
		{
			if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_176())
				{
					func_175(0);
		...
		else if (!unk_0xE50EB54E0F21BED0(iLocal_235, 0))
		{
			if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_235, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_176())
				{
					func_175(0);
		...
		if (!func_3())
		{
			if (!iLocal_252)
			{
				if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 30f, 30f, 10f, 0, 1, 0))
				{
					if (func_201() == 0)
					{
			...
			if (iLocal_258 < unk_0xDFB7BFA6482FEE1E())
			{
				if (func_174())
				{
					if (!unk_0xECEC7528A52B4EE8(iLocal_234))
					{
						if (!unk_0xE196738BFC6C83A6(iLocal_234))
						{
							...
							iLocal_258 = (unk_0xDFB7BFA6482FEE1E() + unk_0xB36B8558948EA7A8(4500, 5000));
						}
					}
				}
				else if (!unk_0xECEC7528A52B4EE8(iLocal_235))
				{
					if (!unk_0xE196738BFC6C83A6(iLocal_235))
					{
	...
	if (!unk_0xECEC7528A52B4EE8(iLocal_234))
	{
		if (!unk_0xE196738BFC6C83A6(iLocal_234))
		{
			if ((unk_0x6B9E71121F5B8154(iLocal_234) || unk_0xEDE161DE4F39475B(iLocal_234, joaat("weapon_stungun"))) || unk_0xA6E8FBD68548675F(iLocal_234, unk_0x7D2B9E6A64637269(), 1))
			{
				func_202();
				unk_0xA5030CC1B9A0FDA6(iLocal_234);
			}
			if (!unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, Local_62, 0, 1, 0) || !unk_0x591190E69BE43117(iLocal_234, Local_59, 290f, 290f, 290f, 0, 1, 0))
			{
...
void func_177()
{
	...
	if (unk_0x575B7C28D81C0B4D(uLocal_232))
	{
		if (unk_0xECEC7528A52B4EE8(iLocal_235))
		{
			unk_0x1AD5BCFEC31BB8D9(&uLocal_232);
		}
	}
}
...
void func_178()
{
	if (!unk_0xECEC7528A52B4EE8(iLocal_234))
	{
		if (unk_0xC49311A2A500FF09(iLocal_234, 0))
		{
			if (unk_0xBFCE58B2B3249999(unk_0x75B58B38E45C6F9A(iLocal_234, 0), 0))
			{
				if (unk_0x698F51FB33ADAF7B(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && unk_0x4598B7969D5B0A28(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						unk_0xBC5268D1B5C5B73B(unk_0x75B58B38E45C6F9A(iLocal_234, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						unk_0xE2D24A37AFCF27BF(-1, "SUSPENSION_SCRIPT_FORCE", unk_0x75B58B38E45C6F9A(iLocal_234, 0), 0, 0, 0);
					}
				}
		...
		if (!unk_0xECEC7528A52B4EE8(iLocal_235))
		{
			if (unk_0xA6E8FBD68548675F(iLocal_235, unk_0x7D2B9E6A64637269(), 1))
			{
				unk_0x4261814A9A26E86F(iLocal_235, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
			}
		}
	}
}
...
void func_179()
{
	if (!unk_0xE50EB54E0F21BED0(iLocal_236, 0))
	{
		if ((!unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) || unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_236, 0)) || iLocal_50 == 2)
		{
			if (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_236, Local_61, 0, 1, 0) || iLocal_242)
			{
				if (iLocal_50 == 1)
				{
					Local_55 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) - Vector(-1f, 8.8f, 0f) };
					unk_0x88B0C92B04E14561(Local_55, 0, &Local_55, 0);
					Local_56 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) + Vector(-1f, 0f, 8.8f) };
					unk_0x88B0C92B04E14561(Local_56, 0, &Local_56, 0);
					Local_57 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) + Vector(-1f, 8.8f, 0f) };
					unk_0x88B0C92B04E14561(Local_57, 0, &Local_57, 0);
					Local_58 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) - Vector(-1f, 0f, 8.8f) };
					unk_0x88B0C92B04E14561(Local_58, 0, &Local_58, 0);
					if (!unk_0x3D6C3476988DE6E1(Local_55, 2f))
					{
						iLocal_234 = unk_0x0FDCFECB2EF2BC1C(19, iLocal_240, Local_55 - Vector(1f, 0f, 0f), func_184(Local_55, func_185(unk_0x1146A9AE09CE2B14())), 1, 1);
					}
					else if (!unk_0x3D6C3476988DE6E1(Local_56, 2f))
					{
						iLocal_234 = unk_0x0FDCFECB2EF2BC1C(19, iLocal_240, Local_56 - Vector(1f, 0f, 0f), func_184(Local_56, func_185(unk_0x1146A9AE09CE2B14())), 1, 1);
					}
					else if (!unk_0x3D6C3476988DE6E1(Local_57, 2f))
					{
						iLocal_234 = unk_0x0FDCFECB2EF2BC1C(19, iLocal_240, Local_57 - Vector(1f, 0f, 0f), func_184(Local_57, func_185(unk_0x1146A9AE09CE2B14())), 1, 1);
					}
					else if (!unk_0x3D6C3476988DE6E1(Local_58, 2f))
					{
						iLocal_234 = unk_0x0FDCFECB2EF2BC1C(19, iLocal_240, Local_58 - Vector(1f, 0f, 0f), func_184(Local_58, func_185(unk_0x1146A9AE09CE2B14())), 1, 1);
					}
					if (!unk_0xECEC7528A52B4EE8(iLocal_234))
					{
						unk_0x90517F1BF9113FB8(iLocal_234, "A_M_M_HillBilly_01_WHITE_MINI_02");
						unk_0xD82D50E4AC0D46B9(iLocal_234, joaat("weapon_stungun"), -1, 1, 1);
						unk_0xA1217FA3D209873F(iLocal_234, 100);
						unk_0x7B28A83A0D3DD0F9(iLocal_234, 137, 1);
						unk_0x7B28A83A0D3DD0F9(iLocal_234, 188, 1);
						unk_0x7B28A83A0D3DD0F9(iLocal_234, 286, 1);
						unk_0x718B410D2D92C542(unk_0x7D2B9E6A64637269(), 10000);
						unk_0xA415F00D0E0DFBCE(iLocal_234, 0, 0);
						unk_0xA415F00D0E0DFBCE(iLocal_234, 27, 1);
						unk_0xA415F00D0E0DFBCE(iLocal_234, 13, 1);
						unk_0xA415F00D0E0DFBCE(iLocal_234, 50, 1);
						unk_0xEA480A62F5D29812(iLocal_234, 2);
						unk_0x095503B9F1CAC814(iLocal_234, 2);
						unk_0x52261CF13B75FFA8(iLocal_234, 0);
						unk_0x817234E2BB671752(iLocal_234, 2, 11f);
						unk_0x817234E2BB671752(iLocal_234, 13, 1f);
						unk_0x05D0B763CEEA9ABD(iLocal_234, 1);
						unk_0x2271ED1E65FB75EE(iLocal_234, iLocal_63);
						func_183(&uLocal_66, 4, iLocal_234, "RAPIST", 0, 1);
						unk_0x34C71C0D521039D0(unk_0x7D2B9E6A64637269(), -8f);
						unk_0xBE91B077ADADE97F(iLocal_234, 1);
						if (!unk_0x575B7C28D81C0B4D(uLocal_231))
						{
							uLocal_231 = func_180(iLocal_234, 1, 145);
						}
						unk_0x1AD5BCFEC31BB8D9(&uLocal_233);
						unk_0x5C679902079A7E80(&uLocal_253);
						...
						unk_0x8D5B447F21217223(&uLocal_253);
						unk_0x504B26425DFF773C(iLocal_234, 1);
						unk_0xE37EB80DFB0D31FB(iLocal_234, 0, 0);
						iLocal_243 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!unk_0xECEC7528A52B4EE8(iLocal_235))
					{
						...
						unk_0xC595907BB71C921D(iLocal_235, 200, 0);
						unk_0x5C679902079A7E80(&uLocal_253);
						...
						unk_0x9DA29013F33252A6(0, unk_0x7D2B9E6A64637269(), 0, 16);
						unk_0x1BBD0A5729AB1226(uLocal_253);
						unk_0x8A1AC8EBC73850C8(iLocal_235, uLocal_253);
						unk_0x8D5B447F21217223(&uLocal_253);
						unk_0x504B26425DFF773C(iLocal_235, 1);
					}
					func_202();
					wait(0);
					if (!unk_0xECEC7528A52B4EE8(iLocal_234) && !unk_0xECEC7528A52B4EE8(iLocal_235))
...
void func_205()
{
	if (unk_0xBFCE58B2B3249999(iLocal_236, 0))
	{
		if (!func_236())
		{
			if (func_204(unk_0x7D2B9E6A64637269(), unk_0xD6E677FAD7521410(iLocal_236, 1), 1) < IntToFloat(iLocal_255))
			{
				if (unk_0x575B7C28D81C0B4D(uLocal_233))
				{
					unk_0x1AD5BCFEC31BB8D9(&uLocal_233);
				...
				unk_0xB5E587F8B911573B(uLocal_233, 0);
				if (!unk_0xE50EB54E0F21BED0(unk_0x0BF0F8F3AD0993F6(), 0))
				{
					iLocal_238 = unk_0x0BF0F8F3AD0993F6();
				}
				func_207(1);
				func_206(1);
			}
	...
	if (iLocal_50 == 1)
	{
		if (!unk_0xE50EB54E0F21BED0(iLocal_234, 0))
		{
			if ((((unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_234, 13f, 13f, 13f, 0, 1, 0) && !unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0)) || unk_0xA6E8FBD68548675F(unk_0x7D2B9E6A64637269(), iLocal_234, 1)) || unk_0xA6E8FBD68548675F(iLocal_234, unk_0x7D2B9E6A64637269(), 1)) || unk_0x3D6C3476988DE6E1(unk_0xD6E677FAD7521410(iLocal_234, 1), 2f))
			{
				iLocal_242 = 1;
				settimerb(0);
				if (!unk_0xE50EB54E0F21BED0(iLocal_234, 0))
				{
					...
					if (!unk_0xECEC7528A52B4EE8(iLocal_234))
					{
						unk_0x8ADA462BC5F42FD8(iLocal_234, unk_0x7D2B9E6A64637269(), 30000, 0, 2);
					}
				}
			}
		}
...
void func_218()
{
	if (!unk_0xE50EB54E0F21BED0(iLocal_236, 0))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x591190E69BE43117(iLocal_236, Local_59, 15f, 15f, 15f, 0, 1, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((unk_0xA6E8FBD68548675F(iLocal_236, unk_0x7D2B9E6A64637269(), 1) || unk_0xAE6D88ADF91EE5A4(unk_0x7D2B9E6A64637269(), Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f), 0, 1)) || unk_0x3DBB16B468DC3E18(2, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x3DBB16B468DC3E18(4, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x3DBB16B468DC3E18(0, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x3DBB16B468DC3E18(1, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0xD4C5E892E2E71D05(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0xDDC360B77B1C1AE6(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || (unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_236, 50f, 50f, 50f, 0, 1, 2) && unk_0xD8CCA4EAA59D74BF(unk_0x1146A9AE09CE2B14())))
			{
				if (!unk_0xE50EB54E0F21BED0(unk_0x0BF0F8F3AD0993F6(), 0))
				{
					iLocal_238 = unk_0x0BF0F8F3AD0993F6();
...
void func_221()
{
	...
	if (iLocal_50 == 1)
	{
		unk_0x0823FA7465392E20(Local_59 - Vector(20f, 50f, 50f), Local_59 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x0823FA7465392E20(Local_59 - Vector(50f, 100f, 100f), Local_59 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
	}
	unk_0xB7D390F8F682127B(Local_54, 50f, 0, 0, 0, 0, 0, 0);
	...
	unk_0x8A54885A635DC8D1(sLocal_259);
	unk_0x9783B77820E7F699(0);
	unk_0xB84B43B766630B5C("RE_ABANDONED_VEHICLE_SCENE");
	while (((((!unk_0xA9C0BBFB9CBB66F1(iLocal_240) || !unk_0xA9C0BBFB9CBB66F1(iLocal_241)) || !unk_0x0EC2B29D4172D225("random@train_tracks")) || !unk_0x0EC2B29D4172D225("amb@world_human_guard_patrol@male@idle_b")) || !unk_0x8A54885A635DC8D1(sLocal_259)) || !unk_0xB30CD10E2CD1B67D("RE_ABANDONED_VEHICLE_SCENE"))
	{
		wait(0);
	}
	if (func_201() == 0)
	{
		func_183(&uLocal_66, 0, unk_0x7D2B9E6A64637269(), "MICHAEL", 0, 1);
	}
	else if (func_201() == 1)
	{
		func_183(&uLocal_66, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
	}
	else if (func_201() == 2)
	{
		func_183(&uLocal_66, 2, unk_0x7D2B9E6A64637269(), "TREVOR", 0, 1);
	}
	unk_0xE63D792F88BFF242(3, 0);
	unk_0xE63D792F88BFF242(5, 0);
	iLocal_236 = unk_0x170478CC84C8AE2F(iLocal_241, Local_59, fLocal_60, 1, 1, 0);
	unk_0x83E421E5A4A2A512(iLocal_236, 10000);
	unk_0x74891A80460EA768(iLocal_236);
	unk_0xD39FDEA586C82548(iLocal_236, 5f);
	unk_0x824F744352C8BC82(iLocal_241);
	unk_0x01BF36BDFE0F82AC(iLocal_236, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
	unk_0x76E23297A6BC5595(iLocal_236, 3);
	unk_0xF479CA7199C54C8F("Redneck", &iLocal_63);
	unk_0x78B2DF314748056B(5, iLocal_63, 1862763509);
	unk_0x78B2DF314748056B(5, joaat("COP"), iLocal_63);
	unk_0x78B2DF314748056B(5, iLocal_63, joaat("COP"));
	if (iLocal_50 == 1)
	{
		unk_0x94F15E506D091111(iLocal_236, 0, 1, 0);
		unk_0x94F15E506D091111(iLocal_236, 1, 1, 0);
		unk_0x21DC133439C50AA5(iLocal_236, Local_59, 0f, 1700f, 1);
		unk_0x89E171705EA920DA(iLocal_236, 0, 1, 0);
		unk_0xC55DA02D18D77322(iLocal_236, 2);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x89E171705EA920DA(iLocal_236, 0, 1, 0);
		unk_0xC55DA02D18D77322(iLocal_236, 1);
		iLocal_234 = unk_0x42F3C85A00B4FC7B(iLocal_236, 26, iLocal_240, -1, 1, 1);
		unk_0x4170FE884DF7426D(iLocal_234, 0, 0, 2, 0);
		unk_0x4170FE884DF7426D(iLocal_234, 2, 1, 2, 0);
		unk_0x4170FE884DF7426D(iLocal_234, 3, 1, 0, 0);
		unk_0x4170FE884DF7426D(iLocal_234, 4, 0, 0, 0);
		unk_0x4170FE884DF7426D(iLocal_234, 8, 0, 0, 0);
		unk_0xBE91B077ADADE97F(iLocal_234, 1);
		unk_0x2271ED1E65FB75EE(iLocal_234, iLocal_63);
		unk_0xD82D50E4AC0D46B9(iLocal_234, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
		unk_0xA415F00D0E0DFBCE(iLocal_234, 1, 0);
		unk_0xF8207455457B967E(iLocal_234, 25);
		unk_0x05D0B763CEEA9ABD(iLocal_234, 1);
		unk_0x90517F1BF9113FB8(iLocal_234, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_183(&uLocal_66, 4, iLocal_234, "INCESTBRO1", 0, 1);
		iLocal_235 = unk_0x42F3C85A00B4FC7B(iLocal_236, 26, iLocal_240, 0, 1, 1);
		unk_0x4170FE884DF7426D(iLocal_235, 0, 0, 0, 0);
		unk_0x4170FE884DF7426D(iLocal_235, 2, 0, 0, 0);
		unk_0x4170FE884DF7426D(iLocal_235, 3, 0, 2, 0);
		unk_0x4170FE884DF7426D(iLocal_235, 4, 1, 0, 0);
		unk_0x4170FE884DF7426D(iLocal_235, 8, 0, 0, 0);
		unk_0xC595907BB71C921D(iLocal_235, 100000000, 0);
		unk_0xBE91B077ADADE97F(iLocal_235, 1);
		unk_0x2271ED1E65FB75EE(iLocal_235, iLocal_63);
		unk_0xD82D50E4AC0D46B9(iLocal_235, joaat("weapon_pistol"), -1, 0, 1);
		unk_0xA415F00D0E0DFBCE(iLocal_235, 1, 0);
		unk_0xF8207455457B967E(iLocal_235, 25);
		unk_0x05D0B763CEEA9ABD(iLocal_235, 1);
		unk_0x90517F1BF9113FB8(iLocal_235, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_183(&uLocal_66, 5, iLocal_235, "INCESTBRO2", 0, 1);
		unk_0x4261814A9A26E86F(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x4261814A9A26E86F(iLocal_235, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x824F744352C8BC82(iLocal_240);
	}
	iLocal_51 = 1;
}
...
int func_223()
{
	...
	{
		if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_48) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_234())
		{
			return 0;
		}
	}
...
void func_237()
{
	if (iLocal_52)
	{
		...
		unk_0x08918C6897982748(sLocal_259);
		...
		if (!unk_0xE50EB54E0F21BED0(iLocal_238, 0))
		{
			if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_238, 0) && !unk_0xD406352E21A7E1D0(unk_0x7D2B9E6A64637269(), iLocal_238, 50f, 50f, 50f, 0, 1, 0))
			{
				func_265(iLocal_238, 0, 145);
			}
		}
		if (!unk_0xECEC7528A52B4EE8(iLocal_234) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			unk_0x533E323CD73D0001(iLocal_234);
			unk_0x1DC2BF231DE6A016(iLocal_234, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
			unk_0x504B26425DFF773C(iLocal_234, 1);
		}
		if (!unk_0xECEC7528A52B4EE8(iLocal_235) && !unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			unk_0x533E323CD73D0001(iLocal_235);
			unk_0x1DC2BF231DE6A016(iLocal_235, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
			unk_0x504B26425DFF773C(iLocal_235, 1);
		}
	}
	func_238(-1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_247(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
int func_292(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_313(Global_112293.f_24993.f_43[iParam1]))
		{
			return 0;
		}
...
Vector3 func_318()
{
	...
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		fVar0 = unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_261, 1);
		iLocal_263 = 1;
		if (unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_262, 1) < fVar0)
		{
			fVar0 = unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_262, 1);
			iLocal_263 = 2;
		}
		if (iLocal_263 == 1)
		{
