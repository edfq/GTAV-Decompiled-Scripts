...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_974)
		{
			if (!unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_971, 200f, 200f, 200f, 0, 1, 0) && !unk_0x3D6C3476988DE6E1(Local_971, 50f))
			{
				unk_0x6AF7EE4DD9F8B944(Local_971, 50f, 1, 0, 0, 0);
				iLocal_974 = 1;
			}
		}
		else if (!unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_971, 200f, 200f, 200f, 0, 1, 0))
		{
			iLocal_974 = 0;
		}
		if (!iLocal_979)
		...
		while (iVar0 <= 7)
		{
			if ((unk_0x419E13582192CFEA(iLocal_802[iVar0]) && !unk_0xECEC7528A52B4EE8(iLocal_802[iVar0])) && unk_0x419E13582192CFEA(iLocal_800))
			{
				if (vdist2(unk_0xD6E677FAD7521410(iLocal_802[iVar0], 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) > 2500f)
				{
					unk_0x504B26425DFF773C(iLocal_802[iVar0], 1);
					unk_0x1DC2BF231DE6A016(iLocal_802[iVar0], unk_0x7D2B9E6A64637269(), 300f, 20000, 1, 0);
					unk_0x0F3BD19FF11738D3(&(iLocal_802[iVar0]));
				}
			}
			iVar0++;
		}
		...
		switch (iLocal_969)
		{
			case -1:
				...
				{
					if (unk_0x419E13582192CFEA(iLocal_802[iVar1]))
					{
						if (unk_0x419E13582192CFEA(unk_0xC96B0C85BE0E0287(unk_0x7D2B9E6A64637269())))
						{
							...
							if ((unk_0xBFCE58B2B3249999(iVar2, 0) && vdist(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iVar2, 1)) < 30f) && unk_0xEACFC87E44438F24(iVar2, joaat("firetruk")))
							{
								unk_0x78B2DF314748056B(5, 1862763509, iLocal_803);
								unk_0x78B2DF314748056B(5, iLocal_803, 1862763509);
			...
			case 0:
				if (!unk_0x419E13582192CFEA(iLocal_800))
				{
					func_94();
					...
					{
						iLocal_800 = unk_0x0BF0F8F3AD0993F6();
						unk_0x4985CD0720AFD468(iLocal_800, 1, 1);
					}
				}
				else
				{
					func_45();
					if (!iLocal_975 && unk_0xBFCE58B2B3249999(iLocal_800, 0))
					{
					...
					if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_971) < pow(100f, 2f))
					{
					...
					if (bLocal_980)
					{
						if (unk_0xBFCE58B2B3249999(iLocal_800, 0) && unk_0xBFCE58B2B3249999(iLocal_801, 0))
						{
							func_36(iLocal_801);
							if (unk_0x2C10A11A684CFE96(unk_0x7D2B9E6A64637269(), iLocal_801) && unk_0x591190E69BE43117(iLocal_800, Local_971, Global_19, 1, 1, 0))
							{
								if (unk_0x575B7C28D81C0B4D(uLocal_798))
								{
									unk_0x1AD5BCFEC31BB8D9(&uLocal_798);
								}
					...
					else if (unk_0xBFCE58B2B3249999(iLocal_800, 0))
					{
						func_36(iLocal_800);
						if (unk_0x2C10A11A684CFE96(unk_0x7D2B9E6A64637269(), iLocal_800) && unk_0x591190E69BE43117(iLocal_800, Local_971, Global_19, 1, 1, 0))
						{
							if (unk_0x575B7C28D81C0B4D(uLocal_798))
							{
								unk_0x1AD5BCFEC31BB8D9(&uLocal_798);
				...
				{
					if ((vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iLocal_800, 1)) > 22500f && unk_0x98E18969B1D0C4AB(iLocal_800)) || vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iLocal_800, 1)) > 90000f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
			...
			case 1:
				if (unk_0xBFCE58B2B3249999(iLocal_800, 0))
				{
			...
			case 2:
				if (unk_0xBFCE58B2B3249999(iLocal_800, 0))
				{
					if (!unk_0x591190E69BE43117(iLocal_800, Local_971, Global_19 + Vector(2f, 2f, 2f), 1, 1, 0))
					{
						iLocal_969 = 0;
					}
					else if (bLocal_980)
					{
						if (unk_0x419E13582192CFEA(iLocal_801))
						{
							if (!unk_0xDA872572A987B2AD(iLocal_801, iLocal_800))
							{
								unk_0x410F7E904016F85F(iLocal_800, 0, 0);
								if (unk_0xA47A27C1733E0E64(iLocal_800))
								{
									unk_0xE3F32DF0088B1EA4(iLocal_800, 0);
								}
								unk_0x5C052A30B9FCA449(iLocal_800, 2);
							...
							{
								unk_0xEDAF90EB98D31F52(iLocal_801, iLocal_800);
							}
						}
					}
					else if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_800, 0))
					{
						if (unk_0xA47A27C1733E0E64(iLocal_800))
						{
							unk_0xE3F32DF0088B1EA4(iLocal_800, 0);
			...
			case 101:
				...
				if (!iLocal_981)
				{
					if ((unk_0xBFCE58B2B3249999(iLocal_800, 0) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_800, 0)) || (unk_0xBFCE58B2B3249999(iLocal_801, 0) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_801, 0)))
					{
				...
				else if (unk_0xBFCE58B2B3249999(iLocal_800, 0))
				{
					...
					else if (unk_0x2C10A11A684CFE96(unk_0x7D2B9E6A64637269(), iLocal_800))
					{
						if (!iLocal_977)
						{
							func_11("AHP_LOSECOPS", 7500, 1);
							iLocal_977 = 1;
							iLocal_970 = unk_0xDFB7BFA6482FEE1E();
						}
					}
					else if ((iLocal_977 && (unk_0xDFB7BFA6482FEE1E() - iLocal_970) < 7500) && unk_0x123480158F10FA67())
					{
						unk_0x1036762BD3781C84();
					}
					if (vdist2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iLocal_800, 1)) > 22500f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
...
void func_14(char* sParam0)
{
	...
	if (unk_0x419E13582192CFEA(iLocal_800))
	{
		if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_800, 0))
		{
			unk_0x5420D0D520CF44D0(&iLocal_800);
		}
	}
	iVar0 = 0;
	while (iVar0 < iLocal_802)
	{
		if (unk_0x419E13582192CFEA(iLocal_802[iVar0]))
		{
			unk_0xC606AE2A3209945E(&(iLocal_802[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_23(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_25(Global_112293.f_18531[iVar0], &Var2, &fVar3))
			{
	...
	if (unk_0xBFCE58B2B3249999(iParam0, 0))
	{
		if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0)
		{
			if (unk_0xBFCE58B2B3249999(iParam0, 0))
			{
				...
				{
					if (unk_0x575B7C28D81C0B4D(uLocal_799))
					{
						unk_0x1AD5BCFEC31BB8D9(&uLocal_799);
					}
				}
				else if (!unk_0x575B7C28D81C0B4D(uLocal_799))
				{
	...
	if (!unk_0xF471787D45ADC2C1())
	{
		switch (iLocal_982)
		{
			...
			case 1:
				...
				{
					if ((((unk_0xECEC7528A52B4EE8(func_92(iLocal_983)) || unk_0x27FC1B0077581B37(iVar0, -1, 0) != func_92(iLocal_983)) || !unk_0xF41EB7643E61A928(func_92(iLocal_983), iVar0, 0)) || !func_91(func_92(iLocal_983))) || !unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iVar0, 0))
					{
					...
					else
					{
						switch (iLocal_1003)
						{
							...
							case 1:
								if (unk_0xA1CB00B61C47B900(Local_986, Local_986.f_1, Local_988, Local_988.f_1))
								{
									iLocal_1003++;
								}
								break;
							...
							case 2:
								unk_0xE946751408DFA71B(func_92(iLocal_983), iVar0, Local_971, 15f, 0, joaat("firetruk"), 786484, 5f, 5f);
								if (vdist(unk_0xD6E677FAD7521410(iVar0, 1), Local_971) > 250f)
								{
									unk_0x8FE37689D07B40FF(iVar0, vdist(unk_0xD6E677FAD7521410(iLocal_800, 1), Local_971));
								}
								iLocal_1003++;
								break;
							...
							case 3:
								...
								{
									if (vdist(unk_0xD6E677FAD7521410(iVar0, 1), Local_984) < vdist(unk_0xD6E677FAD7521410(iVar0, 1), Local_985))
									{
										if (bLocal_980)
										{
											unk_0xE946751408DFA71B(func_92(iLocal_983), iVar0, Local_985, 5f, 0, unk_0x6471F4759775FCA4(iVar0), 262144, 2f, 2f);
										}
										else
										{
											unk_0xE7FD307AF3D07EF7(func_92(iLocal_983), iVar0, Local_971, 180f, 1, 15f, 0);
										}
									}
									else if (bLocal_980)
									{
										unk_0xE946751408DFA71B(func_92(iLocal_983), iVar0, Local_984, 5f, 0, unk_0x6471F4759775FCA4(iVar0), 262144, 2f, 2f);
									}
									else
									{
										unk_0xE7FD307AF3D07EF7(func_92(iLocal_983), iVar0, Local_971, 0f, 1, 15f, 0);
									}
									iLocal_1003++;
								}
								break;
...
void func_46()
{
	...
	bVar0 = false;
	if (!unk_0xECEC7528A52B4EE8(func_92(iLocal_983)) && unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) == 0)
	{
		if ((((unk_0x419E13582192CFEA(iLocal_800) && unk_0xBFCE58B2B3249999(iLocal_800, 0)) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_800, 0)) && unk_0xF41EB7643E61A928(func_92(iLocal_983), iLocal_800, 0)) || (((unk_0x419E13582192CFEA(iLocal_801) && unk_0xBFCE58B2B3249999(iLocal_801, 0)) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_801, 0)) && unk_0xF41EB7643E61A928(func_92(iLocal_983), iLocal_801, 0)))
		{
			bVar0 = true;
		}
	}
	switch (iLocal_990)
	{
		case 0:
			...
			if (func_71(0, 1, 145, 0, iVar1, &cLocal_991, &cLocal_995, 1))
			{
				...
				if (func_28() == 1)
				{
					...
					func_69(&uLocal_804, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
				}
				else
				{
					func_69(&uLocal_804, 1, func_92(1), "FRANKLIN", 0, 1);
					func_69(&uLocal_804, 0, unk_0x7D2B9E6A64637269(), "MICHAEL", 0, 1);
				}
				if (!iLocal_1000)
				{
					iLocal_1002 = unk_0xDFB7BFA6482FEE1E();
				}
				iLocal_990 = 1;
			}
			break;
		...
		case 1:
			if (bVar0)
			{
				if ((unk_0xDFB7BFA6482FEE1E() - iLocal_1002) > 5000 || iLocal_1000)
				{
		...
		case 2:
			...
			if (unk_0xF471787D45ADC2C1() || (!bLocal_999 && !func_49()))
			{
				func_47();
				iLocal_990 = 3;
				iLocal_1002 = unk_0xDFB7BFA6482FEE1E();
		...
		case 3:
			if ((unk_0xDFB7BFA6482FEE1E() - iLocal_1002) > 10000)
			{
				iLocal_990 = 0;
			}
			break;
...
int func_94()
{
	if (((unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0) && unk_0xBFCE58B2B3249999(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0), 0)) && unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0) != iLocal_800) && unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0) != iLocal_801)
	{
		if (unk_0xEACFC87E44438F24(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0), joaat("firetruk")))
		{
			iLocal_800 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
			unk_0x4985CD0720AFD468(iLocal_800, 1, 1);
			iLocal_975 = 0;
			return 1;
		}
		if (unk_0xEACFC87E44438F24(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0), joaat("towtruck")) || unk_0xEACFC87E44438F24(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0), joaat("towtruck2")))
		{
			if (unk_0x419E13582192CFEA(unk_0x05029439A5245679(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0))))
			{
				...
				{
					iLocal_801 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
					unk_0x4985CD0720AFD468(iLocal_801, 1, 1);
					if (unk_0x611CD1312FD3CA66(unk_0x05029439A5245679(iLocal_801)) != iLocal_800)
					{
						iLocal_800 = unk_0x611CD1312FD3CA66(unk_0x05029439A5245679(unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0)));
						iLocal_975 = 0;
						unk_0x4985CD0720AFD468(iLocal_800, 1, 1);
					}
					return 1;
...
void func_95()
{
	...
	if (iLocal_1004 < 8)
	{
		if (iLocal_1004 < 4)
		{
			if (unk_0x419E13582192CFEA(Global_95867.f_9[iLocal_1004]))
			{
				if (!unk_0xECEC7528A52B4EE8(Global_95867.f_9[iLocal_1004]))
				{
					if (vdist2(unk_0xD6E677FAD7521410(Global_95867.f_9[iLocal_1004], 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) < 900f)
					{
						unk_0x4985CD0720AFD468(Global_95867.f_9[iLocal_1004], 1, 1);
						iLocal_802[iLocal_1004] = Global_95867.f_9[iLocal_1004];
						bVar0 = true;
						Global_95867.f_9[iLocal_1004] = 0;
					}
					else if (vdist2(unk_0xD6E677FAD7521410(Global_95867.f_9[iLocal_1004], 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1)) > 2500f && unk_0x98E18969B1D0C4AB(Global_95867.f_9[iLocal_1004]))
					{
						unk_0x4985CD0720AFD468(Global_95867.f_9[iLocal_1004], 1, 1);
						unk_0xC606AE2A3209945E(&(Global_95867.f_9[iLocal_1004]));
					}
				}
			}
		}
		if (!bVar0)
		{
			...
			{
				if ((unk_0x419E13582192CFEA(iVar1) && !unk_0xECEC7528A52B4EE8(iVar1)) && !func_96(iVar1, &iLocal_802))
				{
		...
		if (bVar0)
		{
			if (!unk_0xECEC7528A52B4EE8(iLocal_802[iLocal_1004]))
			{
				unk_0x2271ED1E65FB75EE(iLocal_802[iLocal_1004], iLocal_803);
				unk_0x272ACC75FC69F0B5(unk_0x1146A9AE09CE2B14(), 1, 0);
				unk_0xA415F00D0E0DFBCE(iLocal_802[iLocal_1004], 17, 0);
				unk_0x7C0C012482836EE9(unk_0x1146A9AE09CE2B14(), 0f);
			}
			iLocal_1004++;
		}
...
void func_97()
{
	if (bLocal_980)
	{
		if (((!unk_0xBFCE58B2B3249999(iLocal_801, 0) || (unk_0xBFCE58B2B3249999(iLocal_801, 0) && !unk_0xDA872572A987B2AD(iLocal_800, iLocal_801))) || (unk_0xBFCE58B2B3249999(iLocal_800, 0) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_800, 0))) || (unk_0x419E13582192CFEA(iLocal_801) && vdist(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), unk_0xD6E677FAD7521410(iLocal_801, 1)) > 250f))
		{
			bLocal_980 = false;
		}
	}
	else if ((unk_0xBFCE58B2B3249999(iLocal_801, 0) && unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_801, 0)) && unk_0xDA872572A987B2AD(iLocal_800, iLocal_801))
	{
		bLocal_980 = true;
	}
}
...
void func_99()
{
	...
	unk_0xF479CA7199C54C8F("FireMen", &iLocal_803);
	unk_0x78B2DF314748056B(5, 1862763509, iLocal_803);
	unk_0x78B2DF314748056B(5, iLocal_803, 1862763509);
	if (func_10(0))
	{
		...
		uLocal_1005 = unk_0x0823FA7465392E20(Var0 - Vector(10f, 30f, 30f), Var0 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
		unk_0x6AF7EE4DD9F8B944(Var0, 20f, 1, 0, 0, 0);
		iLocal_802[0] = unk_0x0FDCFECB2EF2BC1C(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, 1, 1);
		iLocal_802[1] = unk_0x0FDCFECB2EF2BC1C(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, 1, 1);
		iLocal_802[2] = unk_0x0FDCFECB2EF2BC1C(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, 1, 1);
		iVar1 = 0;
		while (iVar1 <= (iLocal_802 - 1))
		{
			if (!unk_0xECEC7528A52B4EE8(iLocal_802[iVar1]))
			{
				unk_0x8B515AB1F9C6E8CE(iLocal_802[iVar1], "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
				unk_0xA415F00D0E0DFBCE(iLocal_802[iVar1], 17, 0);
				unk_0x2271ED1E65FB75EE(iLocal_802[iVar1], iLocal_803);
			}
			iVar1++;
		}
		unk_0x78B2DF314748056B(255, 1862763509, iLocal_803);
		unk_0x78B2DF314748056B(255, iLocal_803, 1862763509);
		iLocal_969 = -1;
		if (func_106())
		{
...
void func_107()
{
	...
	if (unk_0x419E13582192CFEA(iLocal_800))
	{
		unk_0x795957CD3A0042C8(&iLocal_800);
	}
	unk_0xE6B53A6E51AAA49F(uLocal_1005, 0);
