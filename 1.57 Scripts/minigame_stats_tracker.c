...
void __EntryFunction__()
{
	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				unk_0x4EA6290996DE4EDC(uLocal_46, "SET_MISSION_TITLE", ScriptParam_50, ScriptParam_50.f_1, 0, 0, 0);
				unk_0x587426517A26C00B(uLocal_46, "SET_MISSION_TITLE_COLOUR", ScriptParam_50.f_2, ScriptParam_50.f_2, ScriptParam_50.f_2, -1082130432, -1082130432);
				if (ScriptParam_50.f_5.f_1 != -1f && !unk_0x4030103C8B148AFC(ScriptParam_50.f_5.f_2))
				{
					unk_0x25B325CC908EE6A5(uLocal_46, "SET_TOTAL", to_float(ScriptParam_50.f_5), ScriptParam_50.f_5.f_1, -1f, -1f, -1f, ScriptParam_50.f_5.f_2, 0, 0, 0, 0);
				}
				unk_0x587426517A26C00B(uLocal_46, "SET_MEDAL", to_float(ScriptParam_50.f_5), -1082130432, -1082130432, -1082130432, -1082130432);
				...
				while (iVar0 < ScriptParam_50.f_66 + 1)
				{
					...
					unk_0x9E3D03981E2E9AD9(ScriptParam_50.f_9[iVar0 /*7*/]);
					unk_0x9E3D03981E2E9AD9(ScriptParam_50.f_9[iVar0 /*7*/].f_1);
					if (ScriptParam_50.f_9[iVar0 /*7*/].f_2 == 4)
					{
						...
						unk_0x4E2EF4B6B665F3F4(floor((ScriptParam_50.f_9[iVar0 /*7*/].f_3 * 1000f)), 6);
						unk_0xD4B2C39F7AD5A6A6();
						if (!unk_0x4030103C8B148AFC(ScriptParam_50.f_9[iVar0 /*7*/].f_5))
						{
					...
					{
						if (!unk_0x4030103C8B148AFC(ScriptParam_50.f_9[iVar0 /*7*/].f_5) && !unk_0x4030103C8B148AFC(ScriptParam_50.f_9[iVar0 /*7*/].f_6))
						{
							unk_0x35CA0C119E6A2A27(ScriptParam_50.f_9[iVar0 /*7*/].f_6);
							unk_0xA91D83F2CC1345A6(ScriptParam_50.f_9[iVar0 /*7*/].f_5);
							unk_0xD4B2C39F7AD5A6A6();
						}
					}
					else
					{
						unk_0x9E3D03981E2E9AD9(ScriptParam_50.f_9[iVar0 /*7*/].f_2);
						if ((ScriptParam_50.f_9[iVar0 /*7*/].f_3 % 1f) == 0f)
						{
							unk_0x82D42F43BE26EB72(ScriptParam_50.f_9[iVar0 /*7*/].f_3);
						}
						else
						{
							unk_0x35CA0C119E6A2A27("NUMBER");
							unk_0x21300A5159EC89B1(ScriptParam_50.f_9[iVar0 /*7*/].f_3, 2);
							unk_0xD4B2C39F7AD5A6A6();
						}
						if ((ScriptParam_50.f_9[iVar0 /*7*/].f_4 % 1f) == 0f)
						{
							unk_0x82D42F43BE26EB72(ScriptParam_50.f_9[iVar0 /*7*/].f_4);
						}
						else
						{
							unk_0x35CA0C119E6A2A27("NUMBER");
							unk_0x21300A5159EC89B1(ScriptParam_50.f_9[iVar0 /*7*/].f_4, 2);
							unk_0xD4B2C39F7AD5A6A6();
						}
						if (!unk_0x4030103C8B148AFC(ScriptParam_50.f_9[iVar0 /*7*/].f_5))
						{
						...
						if (!unk_0x4030103C8B148AFC(ScriptParam_50.f_9[iVar0 /*7*/].f_6))
						{
				...
				if (ScriptParam_50.f_5 != 0 && !unk_0x4030103C8B148AFC(ScriptParam_50.f_5.f_2))
				{
					unk_0x704F8697BB515627(uLocal_46, "SET_TOTAL");
					unk_0x9E3D03981E2E9AD9(ScriptParam_50.f_5);
					if (!unk_0x4030103C8B148AFC(ScriptParam_50.f_5.f_3))
					{
						func_18(ScriptParam_50.f_5.f_3);
					}
					else
					{
						unk_0x82D42F43BE26EB72(ScriptParam_50.f_5.f_1);
					}
			...
			case 3:
				if (((func_2(&uLocal_47) > ScriptParam_50.f_67 && ScriptParam_50.f_67 != -1f) || unk_0x8B6A925F148E0E94()) || Global_31490)
				{
					func_19();
				}
				else
