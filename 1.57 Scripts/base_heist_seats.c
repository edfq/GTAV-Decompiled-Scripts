...
void func_11()
{
	...
	if (Global_1590751 == unk_0x1146A9AE09CE2B14() && !unk_0x234B68AC2E35ED5A(Global_1627455[unk_0x61BE49A80917237B() /*105*/].f_38.f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_64 == 0 && !unk_0x234B68AC2E35ED5A(Global_1627455[unk_0x61BE49A80917237B() /*105*/].f_38.f_27, 3)) && !func_16()) && !unk_0xA300BD5F71A8C704()) && !func_15(0)) && !func_14()) && unk_0x96DF114B59E81B9C(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	{
		unk_0x191DDA30577F440A(&iLocal_64, 2);
	}
	if (func_14())
	{
		unk_0x191DDA30577F440A(&iLocal_64, 4);
	}
	if (func_15(0))
	{
		unk_0x191DDA30577F440A(&iLocal_64, 3);
	}
}
...
void func_19(int iParam0)
{
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				Var3 = { unk_0xBF480D363C51CDF8(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) };
				Var4 = { unk_0x04F690ADA8C71424(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) };
				uVar5 = Var4.f_2;
				unk_0x28A5BAF912B4E14D(unk_0x7D2B9E6A64637269(), Var3, 1f, 500, uVar5, 0.15f);
			}
			func_58(iParam0, 5);
			break;
		...
		case 5:
			...
			if (Var2 == 3)
			{
				iVar6 = unk_0x4E8DA737B686529A(unk_0x7D2B9E6A64637269(), 1920390111);
			}
			else
			{
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), iParam0->f_421.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_33(iParam0);
			func_26(iParam0);
			uVar7 = unk_0x51FB94D5F3D17E35(iParam0->f_421.f_1);
			if (unk_0xEEC203A73BC92E7E(uVar7))
			{
				if (unk_0x0BC8768247440B3A(uVar7) >= 1f)
				{
					func_20(iParam0, 0);
					func_47(iParam0, &sVar0);
					func_46(iParam0, &sVar1);
					iParam0->f_421.f_1 = unk_0x88A92D91AB021F3F(func_45(iParam0), func_44(iParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), iParam0->f_421.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x20F6F12F2945E30E(iParam0->f_421.f_1);
					func_13(&(iParam0->f_421), 8);
		...
		case 8:
			uVar8 = unk_0x51FB94D5F3D17E35(iParam0->f_421.f_1);
			if (unk_0xEEC203A73BC92E7E(uVar8))
			{
				if ((unk_0x0BC8768247440B3A(uVar8) >= 1f || unk_0x0E497F28E1A4E3F6(unk_0x7D2B9E6A64637269(), 364629851)) || unk_0x0E497F28E1A4E3F6(unk_0x7D2B9E6A64637269(), 2116425869))
				{
					unk_0x3DF4E172AD7D16AF(iParam0->f_421.f_1);
					func_4(iParam0, 1);
					func_58(iParam0, 0);
...
void func_31(var uParam0)
{
	...
	if (((func_21(uParam0) != uParam0->f_421.f_8.f_1 && uParam0->f_421.f_8.f_2 < 6) && uParam0->f_421.f_8.f_2 != 3) && uParam0->f_421.f_8.f_2 != 4)
	{
		...
		unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uParam0->f_421.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
...
bool func_81(var uParam0, int iParam1)
{
	...
	if (func_84(unk_0x1146A9AE09CE2B14()) || unk_0x234B68AC2E35ED5A(iLocal_64, 0))
	{
		return 0;
	}
	Var0 = { uParam0->f_1 };
