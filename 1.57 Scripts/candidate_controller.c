		...
		if (Global_41970 > 0)
		{
			...
			if (Global_41970 == iVar0)
			{
				...
				if (Global_41970 > 1)
				{
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < Global_41970)
					{
						if (func_15(Global_41976[iVar4 /*4*/].f_2))
						{
							iVar2[iVar4] = 0;
						}
						else
					...
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < (Global_41970 - 1))
					{
						if (!iVar2[iVar4 + 1])
						{
							if (Global_41976[iVar4 + 1 /*4*/].f_1 < Global_41976[iVar5 /*4*/].f_1)
							{
								iVar5 = iVar4 + 1;
							}
						}
					...
					iVar3 = iVar5;
					if (Global_41976[iVar3 /*4*/].f_2 == 15)
					{
						iVar3 = -1;
					}
					if (iVar3 != -1)
					{
						if (!func_15(Global_41976[iVar3 /*4*/].f_2))
						{
							iVar3 = -1;
						}
					}
				...
				if (iVar3 > -1)
				{
					Global_41971 = Global_41976[iVar3 /*4*/];
					Global_41972 = Global_41976[iVar3 /*4*/].f_3;
					Global_42009 = Global_41976[iVar3 /*4*/].f_2;
					Global_41970 = 0;
					Global_41975 = 0;
				}
				else
...
{
	return (shift_right(iParam0, 26) & 31 * func_7(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
