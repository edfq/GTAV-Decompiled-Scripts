...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		...
		unk_0x6AF7EE4DD9F8B944(Var1, 40f, 1, 0, 0, 0);
	}
	else if (Var0 == 34)
	{
		uLocal_57 = func_245();
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x7D2B9E6A64637269()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0xDFB7BFA6482FEE1E() - iParam0->f_60) > iParam6) && func_191(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_178(2))
		{
			...
			else if (((func_194(sParam3) && !*uParam8 == 1) && func_127(unk_0x7D2B9E6A64637269())) && func_191(unk_0x7D2B9E6A64637269(), Param1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam8 = 1;
			}
			if (func_191(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_228(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
