...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &uVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x3A63BEB7A1E25FB1(iVar1, Var2, iVar4, uVar5, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					...
					{
						uLocal_3[iVar0] = unk_0x3A63BEB7A1E25FB1(iVar1, Var2, iVar4, iVar5, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							uLocal_3[iVar0] = unk_0x3A63BEB7A1E25FB1(iVar1, Var2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x902811AB4D3F0E4F(iVar1, Var2, Var3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						uLocal_3[iVar0] = unk_0x902811AB4D3F0E4F(iVar1, Var2, Var3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
