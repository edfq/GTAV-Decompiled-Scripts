...
void func_1()
{
	...
	{
		iVar2 = (1000 / round((unk_0x7FF6ACE380ED166C() * 1000f)));
...
void func_17(int iParam0)
{
	...
	if (iVar1 || unk_0x53858F1E03A88AE1(1, iParam0, &Var0, 7))
	{
		Var4.f_66 = 2147483647;
		iVar3 = func_35(Var0, &Var4);
		if (iVar3 != -1)
		{
			Global_4265506[iVar3 /*85*/].f_66.f_8 = 0;
			if (Global_4265506[iVar3 /*85*/].f_66.f_18 == 0)
			{
				Global_4265506[iVar3 /*85*/].f_66.f_18 = unk_0x2053F6ACFD4ED4BC();
			}
		}
		bVar5 = true;
		if (iVar3 != -1)
		{
			Global_4265506[iVar3 /*85*/].f_66.f_17 = Var0.f_2;
		}
		else
		{
		...
		switch (Var0.f_2)
		{
			case 0:
				if (iVar3 != -1)
				{
					Global_4270941[iVar3 /*12*/] = Global_4265506[iVar3 /*85*/].f_66.f_3;
					Global_4270941[iVar3 /*12*/].f_1 = Global_4265506[iVar3 /*85*/].f_66.f_7;
					Global_4270941[iVar3 /*12*/].f_2 = Global_4265506[iVar3 /*85*/].f_66.f_4;
					Global_4270941[iVar3 /*12*/].f_3 = Global_4265506[iVar3 /*85*/].f_66.f_1;
					Global_4270941[iVar3 /*12*/].f_5 = Var0.f_1;
					Global_4270941[iVar3 /*12*/].f_6 = Var0.f_3;
					Global_4270941[iVar3 /*12*/].f_7 = Var0.f_4;
					Global_4270941[iVar3 /*12*/].f_8 = Var0.f_5;
					Global_4270941[iVar3 /*12*/].f_9 = Var0.f_6;
					Global_4270941[iVar3 /*12*/].f_11 = 1;
					Global_4265506[iVar3 /*85*/].f_66.f_2 = 2;
					if (Global_4265506[iVar3 /*85*/].f_66.f_11 & 4 != 0)
					{
						func_32(iVar3, bVar5);
					}
					else if (func_13())
					{
						if (bVar5)
						{
							unk_0xC01E6A01232A4FF6(Global_4265506[iVar3 /*85*/].f_66, &uVar6);
						}
					}
				}
				break;
			...
			default:
				if (iVar3 != -1)
				{
					Global_4265506[iVar3 /*85*/].f_66.f_2 = 3;
					if ((Global_4265506[iVar3 /*85*/].f_66.f_11 & 1 != 0 && Global_4265506[iVar3 /*85*/].f_66.f_9 < 2) && func_31(Var0.f_2))
					{
						if (func_10(iVar3))
						{
							if (func_24())
							{
								Global_4265506[iVar3 /*85*/].f_66.f_2 = 1;
								Global_4265506[iVar3 /*85*/].f_66.f_9++;
							}
							else if (Global_4265506[iVar3 /*85*/].f_66.f_11 & 2 != 0)
							{
								Global_4267010 = Global_4265506[iVar3 /*85*/].f_66.f_4;
								Global_4267012 = Global_4265506[iVar3 /*85*/].f_66.f_6;
								Global_4267013 = Var0.f_2;
								Global_4267011 = Global_4265506[iVar3 /*85*/].f_66.f_1;
								if (func_23(Global_4267010) && func_13())
								{
									if (!func_22(Global_4265506[iVar3 /*85*/].f_66))
									{
										iVar7 = func_21();
										Global_4266867[iVar7 /*7*/] = Global_4265506[iVar3 /*85*/].f_66;
										Global_4266867[iVar7 /*7*/].f_2 = Global_4267010;
										Global_4266867[iVar7 /*7*/].f_3 = Global_4267012;
										Global_4266867[iVar7 /*7*/].f_1 = Global_4267011;
										Global_4266867[iVar7 /*7*/].f_4 = unk_0x551F46B3C7DFB654();
									}
								}
								else
								{
						...
						else if (Global_4265506[iVar3 /*85*/].f_66.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4267010) && func_13())
							{
								...
								{
									iVar8 = func_21();
									Global_4266867[iVar8 /*7*/] = Global_4265506[iVar3 /*85*/].f_66;
									Global_4266867[iVar8 /*7*/].f_2 = Global_4267010;
									Global_4266867[iVar8 /*7*/].f_3 = Global_4267012;
									Global_4266867[iVar8 /*7*/].f_1 = Global_4267011;
									Global_4266867[iVar8 /*7*/].f_4 = unk_0x551F46B3C7DFB654();
								}
							}
							else
							{
					...
					else if (Global_4265506[iVar3 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if ((func_23(Global_4267010) && func_13()) && func_31(Var0.f_2))
						{
							...
							{
								iVar9 = func_21();
								Global_4266867[iVar9 /*7*/] = Global_4265506[iVar3 /*85*/].f_66;
								Global_4266867[iVar9 /*7*/].f_2 = Global_4267010;
								Global_4266867[iVar9 /*7*/].f_3 = Global_4267012;
								Global_4266867[iVar9 /*7*/].f_1 = Global_4267011;
								Global_4266867[iVar9 /*7*/].f_4 = unk_0x551F46B3C7DFB654();
							}
						}
						else
						{
					...
					if (Global_4265506[iVar3 /*85*/].f_66.f_2 == 3)
					{
						if (bVar2)
						{
							func_19(1, Global_4265506[iVar3 /*85*/].f_66.f_4);
							Global_4267007 = 0;
						}
						if (Global_4265506[iVar3 /*85*/].f_66.f_11 & 4 != 0)
						{
							func_18(iVar3, Global_4265506[iVar3 /*85*/].f_66.f_4, Global_4265506[iVar3 /*85*/].f_66.f_10, Global_4265506[iVar3 /*85*/].f_66.f_1, Var0.f_2);
						}
					}
				}
				break;
...
void func_32(int iParam0, bool bParam1)
{
	...
	switch (Global_4265506[iParam0 /*85*/].f_66.f_4)
	{
		...
		case -1896606724:
			Var3 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case -1291433573:
			Var3.f_1 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case 538631715:
			Var3.f_2 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case 133782822:
			Var3.f_3 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case 2081885153:
			Var3.f_4 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case -1314365345:
			Var3.f_5 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case 1322977732:
			Var3.f_6 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
		
		case 396623013:
			Var3.f_7 = Global_4265506[iParam0 /*85*/].f_66.f_1;
			unk_0x6817ACF18A10E06F(Global_4265506[iParam0 /*85*/].f_66.f_1, 0, 1, &Var3);
			break;
	...
	if (func_13())
	{
		if (bParam1)
		{
			unk_0xC01E6A01232A4FF6(Global_4265506[iParam0 /*85*/].f_66, &uVar4);
		}
	}
	func_7(iParam0);
}
...
{
	if (Global_4265506[iParam2 /*85*/].f_66.f_1 != Param0.f_1)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_3 != Param0.f_3)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_4 != Param0.f_4)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_5 != Param0.f_5)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_6 != Param0.f_6)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_7 != Param0.f_7)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_14 != Param0.f_14)
	{
		return 0;
	}
	if (Global_4265506[iParam2 /*85*/].f_66.f_17 != Param0.f_17)
	{
		return 0;
	}
	return 1;
