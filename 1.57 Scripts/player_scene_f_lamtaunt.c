	...
	while (iLocal_257 && func_138(2, 0))
	{
		...
		switch (iLocal_66)
		{
			...
			case 2:
				if (func_134())
				{
					func_133(&uLocal_68, 0, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
					func_133(&uLocal_68, 2, Global_99091, "LAMAR", 0, 1);
					iLocal_66 = 3;
				}
				break;
...
int func_2()
{
	...
	func_126(&Global_99091, iLocal_258);
	func_3(Global_99091);
	return 0;
}
...
void func_3(var uParam0)
{
	...
	{
		if (!iLocal_337 && unk_0xA6E8FBD68548675F(uParam0, unk_0x7D2B9E6A64637269(), 1))
		{
	...
	fVar4 = vdist2(unk_0xD6E677FAD7521410(uParam0, 1), unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1));
	if (fVar4 > (8f * 8f))
	{
		iLocal_335 = -1;
	}
	...
	else
	{
		...
		if (iLocal_335 > 0)
		{
			if (iLocal_336 == 0)
			{
				if (iLocal_335 + 15000 < unk_0xDFB7BFA6482FEE1E())
				{
			...
			else if (iLocal_335 + 10000 < unk_0xDFB7BFA6482FEE1E())
			{
...
int func_6(var uParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6)
{
	...
	{
		if (unk_0x0BCA9ADE67DF9DD8((Var1.f_2 - Var0.f_2)) > 2f)
		{
			return 0;
		}
	}
	...
	if (!bVar5)
	{
		iVar6 = unk_0x10AA1D668D6C5CF4(uParam0);
		if (Global_99422.f_362 != iVar6)
		{
			return 0;
		}
	}
	...
	if (unk_0x49875FC4498CDA9A(&cVar7))
	{
		iVar8 = 1;
	}
	else
...
int func_31(var uParam0, char* sParam1, var uParam2)
{
	...
	if (func_29(uParam0, 7))
	{
		...
		while (iVar6 < *uParam2)
		{
			if (!unk_0xAB6A270F84A8781E(uParam2[iVar6 /*4*/]))
			{
				iVar7 = 0;
				while (iVar7 < Var3)
				{
					if (!unk_0xAB6A270F84A8781E(&(Var3[iVar7 /*4*/])))
					{
						if (unk_0xDA654EB115F9FF7D(uParam2[iVar6 /*4*/], &(Var3[iVar7 /*4*/])))
						{
							iVar8 = iVar7;
							while (iVar8 <= (Var3 - 1))
							{
		...
		iVar9 = unk_0xB36B8558948EA7A8(0, iVar5 + 1);
...
int func_86(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19985)
	{
		if (Global_19798.f_1 == 6)
		{
			...
			func_88(1);
			func_91(Global_19779, "DISPLAY_VIEW", 1f, to_float(Global_19778), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7675[iVar1 /*15*/].f_4)
					{
						if (Global_8237[iVar0] == 0)
						{
							...
							if (Global_2463492)
							{
								if (iVar1 == 14)
								{
									func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(Global_22188), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8237[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7675[iVar1 /*15*/].f_4)
					{
						if (Global_8237[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(Global_22193), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_77248)
								{
									...
									func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19798)
									...
									func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7675[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_89(Global_19779, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7675[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7675[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8237[iVar0] = 1;
						}
					}
...
void func_109(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Global_42010[iParam0 /*5*/].f_3 = fParam2;
	Global_42010[iParam0 /*5*/].f_4 = iParam3;
}
...
int func_126(var uParam0, int iParam1)
{
	...
	if (unk_0x419E13582192CFEA(*uParam0))
	{
		...
		{
			case 0:
				if (unk_0x698F51FB33ADAF7B(*uParam0, &cLocal_317, &(Local_327[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_334;
					fVar2 = -1f;
					fVar3 = -1f;
					if (unk_0x723B88C26632AA38(&cLocal_317, &(Local_327[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (unk_0x0BC8768247440B3A(Global_96700) > fVar1)
					{
						...
						if (unk_0xECEC7528A52B4EE8(*uParam0))
						{
							...
							unk_0x28A5BAF912B4E14D(*uParam0, Local_263 + Local_266[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
			...
			case 1:
				...
				{
					unk_0x45B1B4E55BF15523(*uParam0, Local_263 + Local_266[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_260[iParam1] = 2;
					return 1;
				}
				fVar5 = vmag(Local_266[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (vdist2(unk_0xD6E677FAD7521410(*uParam0, 1), Local_263) >= fVar5)
				{
			...
			case 2:
				...
				if (unk_0x4E8DA737B686529A(*uParam0, 713668775) != 1)
				{
					...
					unk_0x731992816BA6C01E(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (unk_0xFEC8B0A512DAD49D(sLocal_333))
				{
					unk_0x911ACE3851C77474(sLocal_333, 0);
				}
				if (vdist2(unk_0xD6E677FAD7521410(*uParam0, 1), Local_263 + Local_266[iParam1 /*3*/]) < (fLocal_268[iParam1] * fLocal_268[iParam1]))
				{
					if (unk_0x7B44CC985AF750BD(Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1))
					{
						unk_0x5F2B3E2AFA7B81C5(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					else if (unk_0x88B0C92B04E14561(Var6, 0, &Var7, 14))
					{
						if (vdist2(unk_0xD6E677FAD7521410(*uParam0, 1), Var7) > 100f)
						{
							unk_0x45B1B4E55BF15523(*uParam0, Var7, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_260[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				unk_0x78B2DF314748056B(5, iLocal_261, 1862763509);
				unk_0x78B2DF314748056B(5, 1862763509, iLocal_261);
				unk_0x78B2DF314748056B(5, iLocal_261, Global_94374);
				unk_0x78B2DF314748056B(5, Global_94374, iLocal_261);
...
Vector3 func_127(struct<3> Param0, float fParam1, float fParam2)
{
	...
	while (iVar3 < 10)
	{
		Var0 = { unk_0x644B8DBA4F69BB73(-fParam1, fParam1), unk_0x644B8DBA4F69BB73(-fParam1, fParam1), 0f };
		if (((Var0.x * Var0.x) + (Var0.f_1 * Var0.f_1)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			Var0.f_2 = unk_0x644B8DBA4F69BB73(-fVar2, fVar2);
			return Param0 + Var0;
		}
		iVar3++;
	}
...
Vector3 func_128(struct<3> Param0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_129(Var0, unk_0x644B8DBA4F69BB73(0f, fParam1)) };
...
int func_136()
{
	...
	if (!func_135())
	{
		if (unk_0xEEC203A73BC92E7E(Global_96700))
		{
			...
			while (iVar0 < iLocal_258)
			{
				if (!unk_0xECEC7528A52B4EE8(iLocal_258[iVar0]))
				{
					unk_0xAD844C8843FC405C(iLocal_258[iVar0], Global_96700, &cLocal_317, &(Local_327[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_260[iVar0] = 0;
				}
				else
				{
...
int func_137()
{
	...
	if (unk_0xEEC203A73BC92E7E(Global_96699))
	{
		...
		while (iVar0 < iLocal_258)
		{
			if (!unk_0xECEC7528A52B4EE8(iLocal_258[iVar0]))
			{
				unk_0xAD844C8843FC405C(iLocal_258[iVar0], Global_96699, &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			func_133(&uLocal_68, 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
		}
		if (!unk_0xECEC7528A52B4EE8(Global_99091))
		{
			func_133(&uLocal_68, 4, Global_99091, "LAMAR", 0, 1);
		}
		if (!unk_0xECEC7528A52B4EE8(iLocal_258[0]))
		{
			func_133(&uLocal_68, 5, iLocal_258[0], "GangMember1", 0, 1);
		}
		if (!unk_0xECEC7528A52B4EE8(iLocal_258[1]))
		{
...
void func_146()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_258)
		{
			...
			{
				unk_0x16E516CA9C88FF48(iLocal_259[iVar0]);
				if (!unk_0xA9C0BBFB9CBB66F1(iLocal_259[iVar0]))
				{
					bVar2 = false;
					unk_0x16E516CA9C88FF48(iLocal_259[iVar0]);
				}
		...
		if (!unk_0xAB6A270F84A8781E(&cLocal_317))
		{
			unk_0x068BDE31F7D112BB(&cLocal_317);
			if (!unk_0x0EC2B29D4172D225(&cLocal_317))
			{
				bVar2 = false;
				unk_0x068BDE31F7D112BB(&cLocal_317);
			}
	...
	unk_0xF479CA7199C54C8F("TAUNTERS", &iLocal_261);
	iVar0 = 0;
	while (iVar0 < iLocal_258)
	{
		if (iLocal_259[iVar0] != 0)
		{
			iLocal_258[iVar0] = unk_0x0FDCFECB2EF2BC1C(iLocal_262, iLocal_259[iVar0], Local_263 + Local_265[iVar0 /*3*/], 0, 1, 1);
			unk_0xCD37A28258D70638(iLocal_258[iVar0], (fLocal_264 + fLocal_267[iVar0]));
			unk_0xD30B1DC5605A4D93(iLocal_258[iVar0], 0);
			unk_0x2271ED1E65FB75EE(iLocal_258[iVar0], iLocal_261);
			unk_0x4261814A9A26E86F(iLocal_258[iVar0], &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0x7B28A83A0D3DD0F9(iLocal_258[iVar0], 317, 1);
			if (iLocal_262 == 6)
			{
				unk_0xD82D50E4AC0D46B9(iLocal_258[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_148()
{
	...
	iLocal_67 = Global_98773;
	func_152(iLocal_67, &Local_263, &fLocal_264, &cVar0);
	func_150(iLocal_67, &sLocal_269, &cLocal_285, &cLocal_301, &uVar1, &uVar2);
	switch (iLocal_67)
	{
		case 218:
			Local_265[0 /*3*/] = { unk_0x644B8DBA4F69BB73(-10f, 10f), unk_0x644B8DBA4F69BB73(-10f, 10f), 0f };
			Local_265[1 /*3*/] = { unk_0x644B8DBA4F69BB73(-10f, 10f), unk_0x644B8DBA4F69BB73(-10f, 10f), 0f };
			Local_266[0 /*3*/] = { -77.3f, -4.1f, 1f };
			Local_266[1 /*3*/] = { Local_266[0 /*3*/] };
			Local_266[iLocal_258 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_267[0] = unk_0x644B8DBA4F69BB73(-180f, 180f);
			fLocal_267[1] = unk_0x644B8DBA4F69BB73(-180f, 180f);
			fLocal_268[0] = 30f;
...
void func_159()
{
	...
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			unk_0x0F3BD19FF11738D3(&(iLocal_258[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			unk_0x824F744352C8BC82(iLocal_259[iVar0]);
		}
		iVar0++;
	}
	unk_0x45881466B05A8703(iLocal_261);
	if (!unk_0xFEC8B0A512DAD49D(sLocal_333))
	{
		unk_0x911ACE3851C77474(sLocal_333, 1);
	}
