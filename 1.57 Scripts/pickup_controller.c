...
void func_3(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_29[iParam0] = unk_0x902811AB4D3F0E4F(iParam1, func_4(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_27[iParam0] = unk_0x902811AB4D3F0E4F(iParam1, func_8(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_24[iParam0] = unk_0x902811AB4D3F0E4F(iParam1, func_12(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_24[iParam0], 600000);
}
	...
	switch (Global_31589)
	{
		...
		case 1:
			switch (Global_31590)
			{
				...
				case 1:
					if (unk_0xC2EBFA0B77E6B2D4(uLocal_22[Global_31591]) && unk_0xFC3D64AC1D955520(uLocal_22[Global_31591]))
					{
						Global_31592 = 0;
					}
					else
				...
				case 2:
					if (unk_0xC2EBFA0B77E6B2D4(uLocal_23[Global_31591]) && unk_0xFC3D64AC1D955520(uLocal_23[Global_31591]))
					{
						Global_31592 = 0;
					}
					else
...
void func_16()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_29[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_27[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_24[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()
{
	...
	while (iVar0 < 102)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_23[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_23[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()
{
	...
	while (iVar0 < 76)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_22[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_22[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 19)
	{
		if (unk_0xC2EBFA0B77E6B2D4(uLocal_21[iVar0]))
		{
			unk_0xDB5C5980B9AE89B9(uLocal_21[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	uLocal_23[iParam0] = unk_0x902811AB4D3F0E4F(iParam1, func_28(iParam0, 0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0x7E8029344EE9DC34(uLocal_23[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, struct<3> Param1, bool bParam2, bool bParam3)
{
	...
	uLocal_22[iParam0] = unk_0x902811AB4D3F0E4F(joaat("pickup_health_standard"), func_32(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0x7E8029344EE9DC34(uLocal_22[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	uLocal_21[iParam0] = unk_0x902811AB4D3F0E4F(joaat("pickup_weapon_petrolcan"), func_35(iParam0), Param1, iVar0, -1, 2, 1, 0);
	unk_0x88E684C517DDFD83(uLocal_21[iParam0], 600000);
}
