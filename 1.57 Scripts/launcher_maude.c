...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_213(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_52 = unk_0x0823FA7465392E20(Var0, Var1, 0, 1, 1, 1);
