...
void __EntryFunction__()
{
	...
	uLocal_54 = unk_0x0823FA7465392E20(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
...
int func_183(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x7D2B9E6A64637269()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0xDFB7BFA6482FEE1E() - uParam0->f_60) > iParam6) && func_187(unk_0x7D2B9E6A64637269(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_219(unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 5f, 0f) - unk_0x885F3A431ECE75E3(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_237(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_244(&iVar0) || !unk_0x0EC2B29D4172D225(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			...
			{
				uVar5 = unk_0xED5AD56E2C551D1E(uParam0->f_35[0], "chassis_dummy");
				Var6 = { unk_0xE8E46B75F88C4ACC(uParam0->f_35[0], uVar5) };
				uVar2 = unk_0xD955F1CC0BCABC78(Var6, unk_0x4BB6BF4A85268A22(uParam0->f_35[0], 2), 2);
				unk_0xB9314D20143CEED3(uVar2, 1);
				unk_0x1C6FA6A93BF99EA4(uVar2, 0);
				unk_0xAD844C8843FC405C(uParam0->f_28[0], uVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
