...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				Var3 = { unk_0xBF480D363C51CDF8(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				Var4 = { unk_0x04F690ADA8C71424(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				uVar5 = Var4.f_2;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uParam0->f_57.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar7 = unk_0x51FB94D5F3D17E35(uParam0->f_57.f_1);
			if (unk_0xEEC203A73BC92E7E(uVar7))
			{
				if (unk_0x0BC8768247440B3A(uVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_57.f_1 = unk_0x88A92D91AB021F3F(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0x5DDC0EBEF6A48288(unk_0x7D2B9E6A64637269(), uParam0->f_57.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x20F6F12F2945E30E(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 8:
			uVar8 = unk_0x51FB94D5F3D17E35(uParam0->f_57.f_1);
