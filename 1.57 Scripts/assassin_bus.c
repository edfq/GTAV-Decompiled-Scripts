...
void __EntryFunction__()
{
	...
	iLocal_143 = 100;
	iLocal_144 = 3;
	uLocal_734 = unk_0xB967AFE724ADAEB1();
	uLocal_735 = unk_0x7EA43B6762051EA2();
	iLocal_980 = 1;
	iLocal_1327 = -1;
	fLocal_1329 = 1f;
	...
	iLocal_1391 = 1;
	iLocal_1413 = -1;
	iLocal_1416 = unk_0xB36B8558948EA7A8(5, 15);
	iLocal_1421 = unk_0xB36B8558948EA7A8(5, 10);
	iLocal_1426 = 1000;
	fLocal_1434 = 0.5f;
	fLocal_1438 = 15f;
	...
	if (unk_0x4210287E2833D44B(3))
	{
		...
		func_542();
		func_540();
		if (unk_0x419E13582192CFEA(iLocal_1348))
		{
			unk_0x4603196EEEA2355C(iLocal_1348, 1, 0);
			unk_0x3CBE9F07524C242D(iLocal_1348, 1, 0);
			unk_0xC22CF0F8AABFA658(iLocal_1348, 1);
		}
		func_539();
	...
	while (true)
	{
		...
		if (func_487(&uScriptParam_1911))
		{
			if (func_486())
			{
				...
				func_483();
				unk_0xE6B53A6E51AAA49F(uLocal_1466[0], 0);
				unk_0xE6B53A6E51AAA49F(uLocal_1466[1], 0);
				unk_0xE6B53A6E51AAA49F(uLocal_1466[2], 0);
				unk_0xE6B53A6E51AAA49F(uLocal_1466[3], 0);
				unk_0xE6B53A6E51AAA49F(uLocal_1466[4], 0);
				unk_0xE6B53A6E51AAA49F(uLocal_1466[5], 0);
		...
		else if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			...
			{
				Global_112293.f_19961.f_8 = func_165(&uLocal_976);
				fLocal_132 = Global_112293.f_19961.f_8;
				func_164();
				func_114();
...
void func_1(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_982)
	{
		...
		case 1:
			...
			if (func_102(&uLocal_148, 1, 0) && unk_0x6F75D3BB2E4578CE())
			{
...
void func_69(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_87();
		unk_0x80B2E30CC8B794C0(0.5f, (fVar1 - (func_90((2f - 0.5f)) - 0.001388889f)), fVar6, func_82(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_68((fVar11 / (0.6f * func_90(25f))), 0f, 1f);
					func_87();
					unk_0x80B2E30CC8B794C0(0.5f, (fVar1 + func_90((2f * 0.5f))), fVar6, func_82(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_90((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_90((25f * 0.2f)));
...
var func_75(int iParam0, bool bParam1)
{
	...
	if (!unk_0xAB6A270F84A8781E(&(Global_22670.f_7286[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_77(unk_0x1146A9AE09CE2B14()) };
...
void func_106()
{
	...
	if (!iLocal_137)
	{
		func_112(&uLocal_148, &Local_725, &Global_62113, 0);
		...
		else
		{
			...
			if (!unk_0xAB6A270F84A8781E(&(Local_725.f_18)))
			{
				if (bLocal_135)
				{
...
void func_114()
{
	if (unk_0x419E13582192CFEA(iLocal_1463) && unk_0xBFCE58B2B3249999(iLocal_1463, 0))
	{
...
{
	return (shift_right(iParam0, 26) & 31 * func_142(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_164()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!unk_0xECEC7528A52B4EE8(Local_1898[iVar0 /*30*/].f_14[iVar1]) && unk_0xC49311A2A500FF09(Local_1898[iVar0 /*30*/].f_14[iVar1], 0))
			{
				unk_0xA415F00D0E0DFBCE(Local_1898[iVar0 /*30*/].f_14[iVar1], 3, 0);
				unk_0x82D2BB48A39F1E88(Local_1898[iVar0 /*30*/].f_14[iVar1], 2, 0);
				unk_0x504B26425DFF773C(Local_1898[iVar0 /*30*/].f_14[iVar1], 1);
			}
			iVar1++;
		}
		iVar0++;
	...
	switch (iLocal_980)
	{
		...
		case 4:
			...
			if (bLocal_1389)
			{
				...
				{
					func_455(&uLocal_976, Global_112293.f_19961.f_8);
				}
				if (iLocal_1432 == 0)
				{
		...
		case 7:
			...
			{
				func_372();
				if (func_370(uParam0->f_6, fLocal_1438) && unk_0x0711D6B5B61B3EBC(unk_0x1146A9AE09CE2B14()))
				{
					if (unk_0x575B7C28D81C0B4D(uParam1->f_2))
					{
						unk_0x1AD5BCFEC31BB8D9(&(uParam1->f_2));
			...
			func_365(uParam1);
			func_364();
			if ((((unk_0xA12BCF836724905A(unk_0x1146A9AE09CE2B14(), 0) && func_363(uParam1->f_1, 1) < fLocal_1438) || !func_362(uParam1->f_1)) || unk_0x16B4C536089C3CAD(-1, uParam0->f_9, 25f)) || unk_0xA6E8FBD68548675F(uParam1->f_1, unk_0x7D2B9E6A64637269(), 1))
			{
	...
	switch (iLocal_1433)
	{
		...
		case 1:
			if (!unk_0xE50EB54E0F21BED0(uParam0->f_1, 0) && !unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
			{
				if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), uParam0->f_1, 0))
				{
					Var1 = { unk_0xD6E677FAD7521410(uParam0->f_1, 0) };
...
void func_204(int iParam0, bool bParam1)
{
	...
	if (func_165(&uLocal_1489) > fLocal_1439)
	{
		...
		fLocal_1439 = unk_0x644B8DBA4F69BB73(0f, 3f);
		func_183(&uLocal_1489);
	}
}
...
void func_205()
{
	if (unk_0x0E8572B08CEB6A11(uLocal_140))
	{
		if (unk_0x2671671BBCC6AD9F(uLocal_140))
		{
			unk_0x6FA8221C9D2ECB46(uLocal_140, 0);
			unk_0x09F9466B03D29D2D(0, 0, 3000, 1, 0, 0);
			unk_0x4200138CBB376D4D(1);
			unk_0xFE1DEC9C5734D0C0(uLocal_140, 0);
		}
	}
}
...
void func_214(var uParam0)
{
	...
	switch (iLocal_1427)
	{
		case 0:
			...
			{
				iLocal_1426 = unk_0x5E7C0A485B91DB87(uParam0->f_1);
				iLocal_1427++;
			}
			break;
		...
		case 1:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 50) || unk_0x7919C1F1872DDE8E(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1453))
					{
						func_201(&(uParam0->f_16), 4, iLocal_1453, "BusPed1", 0, 1);
		...
		case 2:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 150) || unk_0x7919C1F1872DDE8E(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1454))
					{
						func_201(&(uParam0->f_16), 5, iLocal_1454, "BusPed2", 0, 1);
		...
		case 3:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 200) || unk_0x7919C1F1872DDE8E(uParam0->f_1))
				{
...
{
	iLocal_1421 = unk_0xB36B8558948EA7A8(iParam0, iParam1);
	func_183(&uLocal_1477);
	func_183(&uLocal_1483);
	iLocal_1417++;
}
...
{
	iLocal_1416 = unk_0xB36B8558948EA7A8(iParam0, iParam1);
	func_183(&uLocal_1474);
	func_183(&uLocal_1483);
	iLocal_1415++;
}
...
void func_222(var uParam0, var uParam1)
{
	if (iLocal_1345 < 4)
	{
		...
		if (!bLocal_1378)
		{
			...
			{
				Local_1447 = { unk_0xD6E677FAD7521410(uParam1->f_1, 1) };
			}
			if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
			{
				Local_1448 = { unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1) };
			}
...
void func_224()
{
	unk_0x1AD5BCFEC31BB8D9(&(Local_1898[0 /*30*/].f_9));
	unk_0x1AD5BCFEC31BB8D9(&(Local_1898[1 /*30*/].f_9));
	unk_0x1AD5BCFEC31BB8D9(&(Local_1898[2 /*30*/].f_9));
	unk_0x1AD5BCFEC31BB8D9(&(Local_1898[3 /*30*/].f_9));
}
...
void func_226(var uParam0, var uParam1)
{
	if (!iLocal_1377 == 1)
	{
		if (iLocal_1345 < 4)
		{
			if (((((func_235(*uParam1, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_233(&uLocal_1414)) || iLocal_1424 >= 2) || unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0) || !unk_0xBFCE58B2B3249999(uParam1->f_1, 0)) || func_232(*uParam1, uParam1->f_8, 1097859072))
			{
				if (unk_0x6C9038EC46DA62DE(unk_0x1146A9AE09CE2B14()) > 0)
				{
				}
...
void func_229(int iParam0, var uParam1)
{
	...
	unk_0x86C9FC78CFA91BFF("OJASbs_102", &iLocal_1430);
	unk_0x46EDFC827DC67D89(iParam0, 1, 1);
	fLocal_1435 = unk_0xACBF3CDEE04E0AEC(uParam1);
	unk_0x9982130A0A4E9E8E(uParam1, (fLocal_1434 * 100f));
...
int func_230(var uParam0)
{
	if (!unk_0xE50EB54E0F21BED0(uParam0->f_1, 0) && !unk_0xE50EB54E0F21BED0(uParam0->f_8, 0))
	{
		if (unk_0xBFCE58B2B3249999(uParam0->f_1, 0))
		{
			if (unk_0xBFCE58B2B3249999(uParam0->f_8, 0))
			{
				if (func_231(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_5, 1) > 5f || unk_0x83B12E293561B796(uParam0->f_1, uParam0->f_8))
				{
					return 0;
				}
			}
...
int func_236(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		...
		iLocal_118 = unk_0x5E7C0A485B91DB87(iParam0);
...
int func_239(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x24A466C655E8588A(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x8A92595B8AA1D4E9(iParam0) || func_240(iVar1))
			{
				if (unk_0x591190E69BE43117(iParam1, unk_0xD6E677FAD7521410(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x836F48E8C4A773BF(unk_0xFAA5505029C4B5A6(iParam1), iParam0, 120f) && unk_0x895779B17E5AA5FE(iParam1, iParam0, 17))
	...
	if (!unk_0xE50EB54E0F21BED0(iParam0, 0))
	{
		if (unk_0x4E8DA737B686529A(iParam0, 242628503) != 1 && unk_0x4E8DA737B686529A(iParam0, 242628503) != 0)
		{
			if (func_231(iParam0, Local_1440, 1) <= 50f)
			{
				...
				unk_0x3C3DD4D53CF82FCD(0, Local_1440, 2f, 0, 0, 786603, -1082130432);
	...
	if (func_165(&uLocal_1486) > 1f)
	{
		...
		if (unk_0x419E13582192CFEA(iParam0) && unk_0xBFCE58B2B3249999(iParam1, 0))
		{
			if (unk_0xF0BCF093FA825DD6(iParam1))
			{
				...
				if (fLocal_1436 != 0f)
				{
					unk_0xD5B3E5CB06248A58(iParam0, fLocal_1436);
				}
			}
		}
	}
...
void func_279()
{
	if (!iLocal_1396)
	{
		if (!unk_0xECEC7528A52B4EE8(iLocal_1498))
		{
			unk_0xCA089CD1A17D76DF(iLocal_1498);
			unk_0x4261814A9A26E86F(iLocal_1498, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0xF0CFD24C4C5A6185(iLocal_1498, 6, 0, 0);
			iLocal_1396 = 1;
		}
	}
	else if (unk_0x419E13582192CFEA(iLocal_1498))
	{
		if (func_235(iLocal_1498, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1))
		{
			if (unk_0x4E8DA737B686529A(iLocal_1498, 1805844857) != 1)
			{
				unk_0xCA089CD1A17D76DF(iLocal_1498);
				unk_0x1DC2BF231DE6A016(iLocal_1498, unk_0x7D2B9E6A64637269(), 1000f, -1, 0, 0);
			}
		}
		if (func_363(iLocal_1498, 1) > 100f)
		{
			if (!unk_0xB4E725A8915BDF60(iLocal_1498) || unk_0x98E18969B1D0C4AB(iLocal_1498))
			{
				unk_0xC606AE2A3209945E(&iLocal_1498);
			}
		}
	}
}
	...
	switch (iLocal_1412)
	{
		case 0:
			if (func_300(1, 3f))
			{
				...
				if (!unk_0xE50EB54E0F21BED0(iLocal_1498, 0))
				{
					unk_0xF2CEEA627AD5A24B(iLocal_1498, "Mugging_Victim", 0, joaat("a_f_o_genstreet_01"), 0);
				}
				if (!unk_0xE50EB54E0F21BED0(uParam1->f_1, 0))
				{
					if (bLocal_1399)
		...
		case 1:
			if (unk_0x2CA4B93E310C1860())
			{
				...
				if (unk_0x0E8572B08CEB6A11(uLocal_1464) && unk_0x2671671BBCC6AD9F(uLocal_1464))
				{
					unk_0x6FA8221C9D2ECB46(uLocal_1464, 0);
					unk_0xFE1DEC9C5734D0C0(uLocal_1464, 0);
					unk_0x09F9466B03D29D2D(0, 0, 3000, 1, 0, 0);
				}
				else if (unk_0x0E8572B08CEB6A11(uLocal_1464))
				{
					unk_0xFE1DEC9C5734D0C0(uLocal_1464, 0);
				}
				...
				{
					if (unk_0x419E13582192CFEA(iLocal_1498) && !unk_0xECEC7528A52B4EE8(iLocal_1498))
					{
						func_279();
					}
				}
...
void func_283(int iParam0, int iParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0xECEC7528A52B4EE8(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				if (iVar0 == 0)
				{
				...
				unk_0xCA089CD1A17D76DF(Local_1898[iParam1 /*30*/].f_14[iVar0]);
				...
				unk_0x8A1AC8EBC73850C8(Local_1898[iParam1 /*30*/].f_14[iVar0], uVar1);
...
void func_294(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_1499 != 0 && iLocal_1499 != joaat("object")) && iLocal_1499 != joaat("gadget_parachute"))
		{
			...
			{
				unk_0x2FF622571073AA69(unk_0x7D2B9E6A64637269(), iLocal_1499, 0);
			}
		}
	}
}
...
void func_295(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (unk_0xCAD1755E530A6012(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			...
			if (func_349(unk_0x7D2B9E6A64637269()))
			{
				iLocal_1499 = unk_0xE5113E3AD074FF61(unk_0x7D2B9E6A64637269());
...
void func_299()
{
	if (unk_0xE2BB9441C54169BF(uLocal_1497))
	{
		unk_0xDF27EE31B849DF76(uLocal_1497);
		iLocal_1406 = 0;
	}
}
	...
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), uParam0->f_1, 0))
		{
			...
			if (func_267(&uLocal_1899, 1, 0, 0))
			{
				...
				if (!unk_0x0E8572B08CEB6A11(uLocal_140))
				{
					uLocal_140 = unk_0x84F073038B557438(26379945, 0);
					unk_0xF82D990162AFC768(uLocal_140, 1);
					...
					if (bLocal_1398)
					{
						unk_0x612434A5544F5847(uLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
						unk_0x5C062C9AFC66C513(uLocal_140, uParam0->f_1, -0.0074f, -3.4691f, 1.1139f, 1);
					}
					else if (bLocal_1399)
					{
						unk_0x612434A5544F5847(uLocal_140, uParam0->f_1, -0.0387f, -5.3568f, 0.8942f, 1);
						unk_0x5C062C9AFC66C513(uLocal_140, uParam0->f_1, 0.0245f, -2.4095f, 0.3379f, 1);
					}
					else
					{
						unk_0x612434A5544F5847(uLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
					...
					unk_0xEF20E9A7B745D17A(uLocal_140, 35f);
				}
				if (!unk_0x2671671BBCC6AD9F(uLocal_140))
				{
					unk_0x6FA8221C9D2ECB46(uLocal_140, 1);
					unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
					unk_0x4200138CBB376D4D(0);
				}
			}
			else if (unk_0x0E8572B08CEB6A11(uLocal_140))
			{
				if (unk_0x2671671BBCC6AD9F(uLocal_140))
				{
					unk_0x6FA8221C9D2ECB46(uLocal_140, 0);
...
void func_307(var uParam0, var uParam1)
{
	...
	if (!unk_0x3D6C3476988DE6E1(Local_1898[iVar0 /*30*/].f_1, 15f))
	{
		unk_0xB7D390F8F682127B(Local_1898[iVar0 /*30*/].f_1, 15f, 0, 0, 0, 0, 0, 0);
	}
	if (iLocal_1391)
	{
	...
	if (iLocal_1391)
	{
		...
		{
			if (unk_0x591190E69BE43117(unk_0x7D2B9E6A64637269(), Local_1898[iVar0 /*30*/].f_21, 5f, 5f, 2f, 1, 1, 0))
			{
			}
		}
	}
	if (!unk_0xE50EB54E0F21BED0(uParam0->f_1, 0))
	{
		if (unk_0x2C10A11A684CFE96(unk_0x7D2B9E6A64637269(), uParam0->f_1))
		{
			if (Local_1898[iVar0 /*30*/])
			{
				...
				if ((((unk_0x0BABEFEA577FCFA4(Var3, Local_1898[iVar0 /*30*/].f_21, 1) <= fVar1 && unk_0x0711D6B5B61B3EBC(unk_0x1146A9AE09CE2B14())) && unk_0xA5827500BA13CF74(uLocal_1497)) && !func_334(iVar0)) && !bLocal_1387)
				{
					iLocal_1391 = 0;
				}
				if (iLocal_1429 > 0)
...
void func_308(var uParam0, var uParam1, int iParam2)
{
	...
	switch (iLocal_1411)
	{
		case 0:
			if (Local_1898[iParam2 /*30*/])
			{
				...
				uLocal_1464 = unk_0x1CA878DB277C6DF0(26379945, Local_1443, Local_1444, 65f, 0, 2);
				unk_0xEF20E9A7B745D17A(uLocal_1464, 38f);
				unk_0x6FA8221C9D2ECB46(uLocal_1464, 1);
				if (!bLocal_1384)
				{
					unk_0x612434A5544F5847(uLocal_1464, uParam0->f_1, -4.4984f, 8.6802f, -0.3745f, 1);
					unk_0x5C062C9AFC66C513(uLocal_1464, uParam0->f_1, -2.0642f, 7.0391f, 0.243f, 1);
				}
				unk_0xBA7E979B202649F9(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				unk_0x91F94D2287684BDB(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				unk_0xF22CC2CA28E44D4F(Local_1898[iParam2 /*30*/].f_1, 7f);
				unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
				if (iParam2 == 0)
				{
					func_328(uParam0);
				...
				else
				{
					...
					unk_0x78CDDD1E6367978D(uParam0->f_1, Local_1442, 1, 0, 0, 1);
					unk_0xCD37A28258D70638(uParam0->f_1, fLocal_1449);
					unk_0x037561EBFB8F7D13(uParam0->f_1);
					unk_0x47D0DDD8833C5E5F(uParam0->f_1, 1084227584);
					unk_0x49CB177958B472A8(uParam0->f_1, 2f);
					Var2 = { unk_0xD6E677FAD7521410(uParam0->f_1, 1) };
					fVar4 = unk_0xA8D713A937F31250(uParam0->f_1);
					Var3 = { unk_0x26C2ACB261895E70(Var2, fVar4, 2f, 5.6201f, 0.1098f) };
					unk_0xDDFB0D5F3D3B74AA(unk_0x7D2B9E6A64637269(), Var3, 5000, 0, 2);
				}
			...
			if (func_168(&uLocal_1468))
			{
				if (func_165(&uLocal_1468) > fLocal_1437)
				{
					...
					if (iParam2 == 0)
					{
						...
						{
							unk_0x95CA4545D0C61309(iVar1, uParam0->f_1, 20000, 0, 2f, 258, 0);
							if (unk_0x419E13582192CFEA(iVar1))
							{
								unk_0xE37EB80DFB0D31FB(iVar1, 1, 0);
							}
						}
					}
					else if (iParam2 == 1)
		...
		case 2:
			...
			if ((func_165(&uLocal_1468) > 1.5f && !bLocal_1388) || (bLocal_1388 && !func_221()))
			{
				...
				func_183(&uLocal_1468);
				unk_0x1AD5BCFEC31BB8D9(&(Local_1898[iParam2 /*30*/].f_9));
	...
	if (iLocal_1411 == 1)
	{
		if (func_310(iLocal_142))
		{
			...
			if (!unk_0xE50EB54E0F21BED0(uParam0->f_1, 0))
			{
				unk_0xCD37A28258D70638(uParam0->f_1, Local_1898[iParam2 /*30*/].f_20);
			}
			unk_0x1AD5BCFEC31BB8D9(&(Local_1898[iParam2 /*30*/].f_9));
			if (iParam2 == iLocal_1413)
			{
				...
				if (!unk_0xECEC7528A52B4EE8(*uParam0))
				{
					if (unk_0xBFCE58B2B3249999(uParam0->f_8, 0))
					{
						...
						unk_0x78CDDD1E6367978D(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_5, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_8);
				...
				unk_0x6AF7EE4DD9F8B944(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0, 0, 0, 0);
				unk_0xBA7E979B202649F9(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0);
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (unk_0x419E13582192CFEA(Local_1898[iParam2 /*30*/].f_14[2]))
	{
		unk_0xC606AE2A3209945E(&(Local_1898[iParam2 /*30*/].f_14[2]));
	}
	if (!unk_0x419E13582192CFEA(*uParam1))
	{
		uParam0->f_1 = { Var0 };
...
void func_315(var uParam0, var uParam1)
{
	if (!unk_0x419E13582192CFEA(*uParam1))
	{
		*uParam1 = unk_0x0FDCFECB2EF2BC1C(4, *uParam0, uParam0->f_1, uParam0->f_4, 1, 1);
		...
		if (!iLocal_969)
		{
			unk_0xF479CA7199C54C8F("Target", &iLocal_979);
			iLocal_969 = 1;
		}
		unk_0x78B2DF314748056B(5, iLocal_979, 1862763509);
		unk_0x78B2DF314748056B(5, 1862763509, iLocal_979);
		unk_0x2271ED1E65FB75EE(*uParam1, iLocal_979);
		if (uParam0->f_268)
		{
...
void func_316(var uParam0, int iParam1)
{
	...
	unk_0x6AF7EE4DD9F8B944(Local_1898[iParam1 /*30*/].f_1, 10f, 0, 0, 0, 0);
	unk_0x86DA8A407ED8A381((Local_1898[iParam1 /*30*/].f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 - 30f), (Local_1898[iParam1 /*30*/].f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 + 30f), 0, 1);
	if (!unk_0x419E13582192CFEA(Local_1898[iParam1 /*30*/].f_14[0]))
	{
		Local_1898[iParam1 /*30*/].f_14[0] = unk_0x0FDCFECB2EF2BC1C(4, uParam0->f_16, Var0[0 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 3, 2, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 8, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 2, 1, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 8, 1, 0, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 2, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		unk_0x8ADA462BC5F42FD8(Local_1898[iParam1 /*30*/].f_14[0], unk_0x7D2B9E6A64637269(), -1, 2048, 4);
		unk_0x4261814A9A26E86F(Local_1898[iParam1 /*30*/].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[iParam1 /*30*/].f_14[0], 1);
		unk_0x01BF36BDFE0F82AC(Local_1898[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0);
	}
	if (!unk_0x419E13582192CFEA(Local_1898[iParam1 /*30*/].f_14[1]))
	{
		Local_1898[iParam1 /*30*/].f_14[1] = unk_0x0FDCFECB2EF2BC1C(4, joaat("a_m_m_eastsa_01"), Var0[1 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 3, 1, 3, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 2, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 3, 2, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		unk_0x8ADA462BC5F42FD8(Local_1898[iParam1 /*30*/].f_14[1], unk_0x7D2B9E6A64637269(), -1, 2048, 4);
		unk_0x4261814A9A26E86F(Local_1898[iParam1 /*30*/].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[iParam1 /*30*/].f_14[1], 1);
		unk_0x01BF36BDFE0F82AC(Local_1898[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0);
	}
	if (!unk_0x419E13582192CFEA(Local_1898[iParam1 /*30*/].f_14[2]))
	{
		Local_1898[iParam1 /*30*/].f_14[2] = unk_0x0FDCFECB2EF2BC1C(4, uParam0->f_14, Var0[2 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, 1);
		if (iParam1 == 0)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 3, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 2, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 3, 1, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 2)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 3, 1, 2, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 3)
		{
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 3, 0, 1, 0);
			unk_0x4170FE884DF7426D(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		unk_0x8ADA462BC5F42FD8(Local_1898[iParam1 /*30*/].f_14[2], unk_0x7D2B9E6A64637269(), -1, 2048, 4);
		unk_0x4261814A9A26E86F(Local_1898[iParam1 /*30*/].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, unk_0x644B8DBA4F69BB73(0, 1065353216), 0, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[iParam1 /*30*/].f_14[2], 1);
		unk_0x01BF36BDFE0F82AC(Local_1898[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0);
	}
	if (iParam1 == 3)
	{
		if (!unk_0x419E13582192CFEA(Local_1898[iParam1 /*30*/].f_19))
		{
			Local_1898[iParam1 /*30*/].f_19 = unk_0x170478CC84C8AE2F(uParam0->f_15, Local_1898[iParam1 /*30*/].f_5, Local_1898[iParam1 /*30*/].f_8, 1, 1, 0);
			unk_0x47D0DDD8833C5E5F(Local_1898[iParam1 /*30*/].f_19, 1084227584);
		}
	}
}
	...
	while (iVar0 <= 2)
	{
		if (unk_0xBFCE58B2B3249999(uParam0->f_1, 0))
		{
			if (!unk_0xECEC7528A52B4EE8(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				{
					unk_0xB1D85A6C23F2F945(Local_1898[iParam1 /*30*/].f_14[iVar0], uParam0->f_1, iVar1);
				}
			}
		}
		iVar0++;
...
void func_320()
{
	iLocal_1498 = unk_0x0FDCFECB2EF2BC1C(5, joaat("a_f_o_genstreet_01"), 110.6556f, -776.3679f, 30.439f, 346.1708f, 1, 1);
	unk_0x4170FE884DF7426D(iLocal_1498, 0, 0, 0, 0);
	unk_0x4170FE884DF7426D(iLocal_1498, 2, 1, 2, 0);
	unk_0x4170FE884DF7426D(iLocal_1498, 3, 0, 2, 0);
	unk_0x4170FE884DF7426D(iLocal_1498, 4, 0, 0, 0);
	unk_0x4170FE884DF7426D(iLocal_1498, 8, 1, 2, 0);
	unk_0xBE91B077ADADE97F(iLocal_1498, 1);
}
...
var func_322(struct<3> Param0, int iParam1)
{
	...
	while (iVar3 <= 2)
	{
		if (!unk_0xE50EB54E0F21BED0(Local_1898[iParam1 /*30*/].f_14[iVar3], 0))
		{
...
{
	if (!unk_0x0E8572B08CEB6A11(uLocal_1464))
	{
		uLocal_1464 = unk_0x1CA878DB277C6DF0(26379945, unk_0x684B55BC7BEF0475(), unk_0x2EBAAC7478326ECC(2), 35f, 0, 2);
	}
	if (!unk_0x0E8572B08CEB6A11(uLocal_1465))
	{
		uLocal_1465 = unk_0x1CA878DB277C6DF0(26379945, unk_0x684B55BC7BEF0475(), unk_0x2EBAAC7478326ECC(2), 34f, 0, 2);
	}
	if (unk_0xBFCE58B2B3249999(uParam0->f_1, 0) && !unk_0xE50EB54E0F21BED0(uParam0->f_1, 0))
	{
		if (bLocal_1398)
		{
			unk_0x612434A5544F5847(uLocal_1464, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
			unk_0x5C062C9AFC66C513(uLocal_1464, uParam0->f_1, 1.2599f, 5.969f, 0.7051f, 1);
		}
		else if (bLocal_1399)
		{
			unk_0x612434A5544F5847(uLocal_1464, uParam0->f_1, -1.6144f, 4.8097f, 0.4117f, 1);
			unk_0x5C062C9AFC66C513(uLocal_1464, uParam0->f_1, 1.328f, 4.756f, -0.1711f, 1);
		}
		else
		{
			unk_0x612434A5544F5847(uLocal_1464, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
		...
		unk_0xCD29B8E8A95DC63C(uLocal_1464, 0.55f);
		unk_0x6FA8221C9D2ECB46(uLocal_1464, 1);
	}
	unk_0x57C1B8A4131913BA(0);
...
void func_324(var uParam0, int iParam1)
{
	...
	if (bLocal_1398)
	{
		Var0 = { unk_0x26C2ACB261895E70(Var2, fVar3, 2.519f, 5.6f, 0.1098f) };
	...
	if (!unk_0xECEC7528A52B4EE8(iVar1))
	{
		unk_0x16D66F11FE644901(iVar1);
		unk_0x78CDDD1E6367978D(iVar1, Var0.x, Var0.f_1, fVar4, 1, 0, 0, 1);
		unk_0xCD37A28258D70638(iVar1, fVar5);
	}
}
		...
		case 1:
			if (func_168(&uLocal_1468))
			{
				if (func_165(&uLocal_1468) > 3f)
				{
					...
					unk_0x71FA2D5F4B42ADDC(uLocal_1464);
					unk_0xC236342F1874172C(uLocal_1464);
					unk_0x7508AE96782B0441(uLocal_1464, Local_1443);
					unk_0xBD833AA6EB59C81B(uLocal_1464, Local_1444, 2);
...
void func_327(var uParam0, int iParam1, bool bParam2)
{
	...
	if (iParam1 == 0)
	{
		...
		fLocal_1449 = 160.65f;
		Local_1445 = { unk_0x26C2ACB261895E70(Local_1442, fLocal_1449, Var1) };
	}
	else if (iParam1 == 1)
	{
	...
	unk_0x7956E831D8C0C17C(Local_1442, &uVar0, 0, 0);
	unk_0x2C2F1450FAC84185(unk_0x7D2B9E6A64637269(), Local_1445);
	unk_0xCD37A28258D70638(uParam0->f_1, fLocal_1449);
	unk_0x47D0DDD8833C5E5F(uParam0->f_1, 1084227584);
	...
	if (bLocal_1398)
	{
		Local_1441 = { unk_0x26C2ACB261895E70(Local_1442, fLocal_1449, 2f, 5.6201f, 0.1098f) };
	}
	else if (bLocal_1399)
	{
		Local_1441 = { unk_0x26C2ACB261895E70(Local_1442, fLocal_1449, 2f, 5.6201f, 0.1098f) };
	...
	if (bParam2)
	{
		unk_0xDDFB0D5F3D3B74AA(unk_0x7D2B9E6A64637269(), Local_1441, 5000, 0, 2);
	}
}
...
void func_328(var uParam0)
{
	...
	if (unk_0x419E13582192CFEA(uParam0->f_1) && !unk_0xE50EB54E0F21BED0(uParam0->f_1, 0))
	{
		...
		while (iVar1 < 8)
		{
			if (!unk_0x9B73EB6255D4AE81(uParam0->f_1, iVar1, 0))
			{
				iVar0[iVar1] = unk_0x27FC1B0077581B37(uParam0->f_1, iVar1, 0);
				unk_0x4985CD0720AFD468(iVar0[iVar1], 1, 0);
				if (unk_0x419E13582192CFEA(iVar0[iVar1]))
				{
					unk_0xC606AE2A3209945E(&(iVar0[iVar1]));
				}
			}
			iVar1++;
		}
...
void func_329(int iParam0)
{
	...
	Var5 = { unk_0x5675C422E6519C64(unk_0x7D2B9E6A64637269(), 0) };
...
void func_333()
{
	if (unk_0x419E13582192CFEA(uLocal_1458[0]))
	{
		unk_0x0F3BD19FF11738D3(&(uLocal_1458[0]));
	}
	if (unk_0x419E13582192CFEA(uLocal_1458[1]))
	{
		unk_0x0F3BD19FF11738D3(&(uLocal_1458[1]));
	}
	if (unk_0x419E13582192CFEA(uLocal_1458[2]))
	{
		unk_0x0F3BD19FF11738D3(&(uLocal_1458[2]));
	}
	if (unk_0x419E13582192CFEA(uLocal_1458[3]))
	{
		unk_0x0F3BD19FF11738D3(&(uLocal_1458[3]));
	}
}
...
int func_334(int iParam0)
{
	...
	fVar0 = unk_0xA8D713A937F31250(unk_0x7D2B9E6A64637269());
	fVar1 = (Local_1898[iParam0 /*30*/].f_4 - 180f);
	if (cos(unk_0x0BCA9ADE67DF9DD8((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1386 = false;
		iVar2 = 0;
	}
...
void func_335(int iParam0)
{
	if (!iLocal_1406)
	{
		if (func_368(Local_1898[iParam0 /*30*/].f_1, 1) <= 100f)
		{
			...
			{
				uLocal_1497 = unk_0x3063E66D1501117A(Local_1898[iParam0 /*30*/].f_24, Local_1898[iParam0 /*30*/].f_27, 25f, 12, 127);
				if (iLocal_1429 == 3)
				{
					unk_0xA566E488BA0A0A4C("ASS_MCS_1", 8);
					unk_0x55CC6D7C6CB3F611(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
...
void func_337()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!unk_0x575B7C28D81C0B4D(Local_1898[iVar0 /*30*/].f_9))
			{
				Var1 = { unk_0x26C2ACB261895E70(Local_1898[iVar0 /*30*/].f_1, Local_1898[iVar0 /*30*/].f_4, 0f, 3f, 0f) };
				Local_1898[iVar0 /*30*/].f_9 = func_338(Var1, 1);
				unk_0xDD944E3FD2028A48(Local_1898[iVar0 /*30*/].f_9, &(Local_1898[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
void func_339()
{
	if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_1459, 0))
	{
		unk_0x795957CD3A0042C8(&iLocal_1459);
	}
	if (!unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_1460, 0))
	{
		unk_0x795957CD3A0042C8(&iLocal_1460);
	}
}
				...
				if (!iLocal_1395)
				{
					...
					while (iVar0 < 9)
					{
						if (unk_0xBFCE58B2B3249999(uParam0->f_1, 0))
						{
							...
							{
								iLocal_1457 = unk_0x27FC1B0077581B37(uParam0->f_1, iVar0, 0);
...
void func_355(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_357(Global_112293.f_18531[iVar0], &Var2, &fVar3))
			{
	...
	if (iLocal_980 > 4)
	{
		if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
		{
			...
			if (unk_0x419E13582192CFEA(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1463 && unk_0x6471F4759775FCA4(iVar0) != joaat("bus")) && unk_0x6471F4759775FCA4(iVar0) != joaat("coach"))
					{
						iLocal_1463 = iVar0;
						unk_0x4985CD0720AFD468(iLocal_1463, 1, 1);
						unk_0xD5CF6F9E6FB73F7B(iLocal_1463, 0);
					}
				}
			}
		}
...
void func_365(var uParam0)
{
	...
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
		{
			iLocal_1461 = unk_0xDA8C680C9B8BFAAF(unk_0x7D2B9E6A64637269());
			iLocal_1467 = unk_0x6471F4759775FCA4(iLocal_1461);
			if (iLocal_1467 != 0)
			{
...
int func_367(var uParam0)
{
	if (!unk_0x419E13582192CFEA(uLocal_1458[3]))
	{
		...
		if ((unk_0xA9C0BBFB9CBB66F1(uParam0->f_16) && unk_0xA9C0BBFB9CBB66F1(uParam0->f_14)) && unk_0xA9C0BBFB9CBB66F1(joaat("a_m_m_eastsa_01")))
		{
			if (!unk_0x419E13582192CFEA(uLocal_1458[0]))
			{
				uLocal_1458[0] = unk_0x0FDCFECB2EF2BC1C(4, joaat("a_m_m_eastsa_01"), 435.0773f, -650.2194f, 27.74271f, 85.9928f, 1, 1);
				unk_0x4170FE884DF7426D(uLocal_1458[0], 0, 0, 0, 0);
				unk_0x4170FE884DF7426D(uLocal_1458[0], 2, 0, 0, 0);
				unk_0x4170FE884DF7426D(uLocal_1458[0], 3, 0, 2, 0);
				unk_0x4170FE884DF7426D(uLocal_1458[0], 4, 1, 2, 0);
				unk_0x4170FE884DF7426D(uLocal_1458[0], 10, 1, 1, 0);
				if (unk_0x7B44CC985AF750BD(435.0773f, -650.2194f, 27.74271f, 2f, 1))
				{
					unk_0x2D64BC4D301915C2(uLocal_1458[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					unk_0x4B770B4D8C1A469B(uLocal_1458[0], 1193033728, 0);
				}
			}
			if (!unk_0x419E13582192CFEA(uLocal_1458[1]))
			{
				uLocal_1458[1] = unk_0x0FDCFECB2EF2BC1C(4, uParam0->f_16, 436.3171f, -642.8832f, 27.73943f, 32.8396f, 1, 1);
				if (unk_0x7B44CC985AF750BD(436.3171f, -642.8832f, 27.73943f, 2f, 1))
				{
					unk_0x2D64BC4D301915C2(uLocal_1458[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					unk_0x4B770B4D8C1A469B(uLocal_1458[1], 1193033728, 0);
				}
			}
			if (!unk_0x419E13582192CFEA(uLocal_1458[2]))
			{
				uLocal_1458[2] = unk_0x0FDCFECB2EF2BC1C(4, uParam0->f_14, 435.6569f, -645.5588f, 27.73775f, 343.8998f, 1, 1);
				if (unk_0x7B44CC985AF750BD(435.6569f, -645.5588f, 27.73775f, 2f, 1))
				{
					unk_0x2D64BC4D301915C2(uLocal_1458[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					unk_0x4B770B4D8C1A469B(uLocal_1458[2], 1193033728, 0);
				}
			}
			uLocal_1458[3] = unk_0x0FDCFECB2EF2BC1C(4, joaat("a_m_m_eastsa_01"), 436.6802f, -629.7325f, 27.71444f, 179.4746f, 1, 1);
			unk_0x4170FE884DF7426D(uLocal_1458[1], 0, 0, 2, 0);
			unk_0x4170FE884DF7426D(uLocal_1458[1], 2, 0, 0, 0);
			unk_0x4170FE884DF7426D(uLocal_1458[1], 3, 0, 1, 0);
			unk_0x4170FE884DF7426D(uLocal_1458[1], 4, 0, 2, 0);
			unk_0x4170FE884DF7426D(uLocal_1458[1], 10, 1, 0, 0);
			if (unk_0x7B44CC985AF750BD(436.6802f, -629.7325f, 27.71444f, 2f, 1))
			{
				unk_0x2D64BC4D301915C2(uLocal_1458[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				unk_0x4B770B4D8C1A469B(uLocal_1458[3], 1193033728, 0);
			}
			return 1;
		}
	}
...
{
	return func_231(unk_0xD56332194D622ECE(unk_0x638BDC79E655C1C2()), Param0, iParam1);
}
...
void func_375()
{
	if (!unk_0x419E13582192CFEA(iLocal_1462))
	{
		if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
		{
			if (unk_0xC49311A2A500FF09(unk_0x7D2B9E6A64637269(), 0))
			{
				iLocal_1462 = unk_0x75B58B38E45C6F9A(unk_0x7D2B9E6A64637269(), 0);
				if (unk_0x419E13582192CFEA(iLocal_1462) && !unk_0xE50EB54E0F21BED0(iLocal_1462, 0))
				{
					func_377(iLocal_1462);
				}
			}
...
void func_376()
{
	...
	if (!unk_0x419E13582192CFEA(iLocal_1349))
	{
		return;
	}
	if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
	...
	if (vdist2(Var0, Local_1352) > 10000f)
	{
		if (unk_0x419E13582192CFEA(iLocal_1349))
		{
			...
			unk_0x04F4D55F2C0C756D(&iLocal_1349);
		}
		if (unk_0x419E13582192CFEA(iLocal_1348))
		{
			unk_0x4603196EEEA2355C(iLocal_1348, 1, 0);
...
void func_383(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_424(unk_0x471C98FD94C0A5FD(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_422(&(Global_99370.f_3));
				if (iVar6 > -1)
				{
...
void func_395(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0xF98B272A945FAE61(iVar5, &Var7) && !func_397(Var7.f_1)) && iVar9 < 51)
			{
...
void func_448(var uParam0, var uParam1)
{
	...
	unk_0xDF23DCD7A3E1B7A5(0);
	unk_0x3A13FD2813C8251F(0, 1065353216);
	if (!unk_0x419E13582192CFEA(Local_1898[3 /*30*/].f_19))
	{
		Local_1898[3 /*30*/].f_19 = unk_0x170478CC84C8AE2F(uParam0->f_15, Local_1898[3 /*30*/].f_5, Local_1898[3 /*30*/].f_8, 1, 1, 0);
		unk_0x47D0DDD8833C5E5F(Local_1898[3 /*30*/].f_19, 1084227584);
	}
	iLocal_1405 = 0;
	iLocal_1408 = 0;
	iLocal_1429 = 3;
	...
	fLocal_1435 = unk_0xACBF3CDEE04E0AEC(uParam1->f_8);
	unk_0x9982130A0A4E9E8E(uParam1->f_8, (fLocal_1434 * 100f));
...
void func_449(var uParam0, var uParam1)
{
	...
	{
		Local_1898[0 /*30*/].f_14[0] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_16, 3, 1, 1);
		unk_0xBE91B077ADADE97F(Local_1898[0 /*30*/].f_14[0], 1);
		Local_1898[0 /*30*/].f_14[1] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 4, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[1], 0, 0, 2, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[1], 2, 1, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[1], 3, 1, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[1], 4, 0, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[0 /*30*/].f_14[1], 1);
		Local_1898[0 /*30*/].f_14[2] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_14, 5, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[2], 0, 1, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[2], 2, 2, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[2], 3, 1, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[2], 4, 0, 2, 0);
		unk_0x4170FE884DF7426D(Local_1898[0 /*30*/].f_14[2], 8, 1, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[0 /*30*/].f_14[2], 1);
		Local_1898[1 /*30*/].f_14[0] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_16, 6, 1, 1);
		unk_0xBE91B077ADADE97F(Local_1898[1 /*30*/].f_14[0], 1);
		Local_1898[1 /*30*/].f_14[1] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 7, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[1], 0, 0, 1, 0);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[1], 3, 0, 1, 0);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[1], 4, 0, 0, 0);
		unk_0xBE91B077ADADE97F(Local_1898[1 /*30*/].f_14[1], 1);
		Local_1898[1 /*30*/].f_14[2] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_14, 8, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[2], 0, 0, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[2], 3, 0, 1, 0);
		unk_0x4170FE884DF7426D(Local_1898[1 /*30*/].f_14[2], 4, 0, 2, 0);
		unk_0xBE91B077ADADE97F(Local_1898[1 /*30*/].f_14[2], 1);
		Local_1898[2 /*30*/].f_14[0] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_16, 0, 1, 1);
		unk_0xBE91B077ADADE97F(Local_1898[2 /*30*/].f_14[0], 1);
		Local_1898[2 /*30*/].f_14[1] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 1, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[1], 0, 0, 2, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[1], 2, 0, 0, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[1], 3, 1, 1, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[1], 4, 0, 1, 0);
		unk_0xBE91B077ADADE97F(Local_1898[2 /*30*/].f_14[1], 1);
		Local_1898[2 /*30*/].f_14[2] = unk_0x42F3C85A00B4FC7B(uParam1->f_1, 4, uParam0->f_14, 2, 1, 1);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[2], 0, 0, 2, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[2], 2, 0, 1, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[2], 3, 1, 2, 0);
		unk_0x4170FE884DF7426D(Local_1898[2 /*30*/].f_14[2], 4, 0, 1, 0);
		unk_0xBE91B077ADADE97F(Local_1898[2 /*30*/].f_14[2], 1);
	}
}
...
void func_451()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 < 3)
		{
			if (unk_0x419E13582192CFEA(Local_1898[iVar0 /*30*/].f_14[iVar1]))
			{
				unk_0xC606AE2A3209945E(&(Local_1898[iVar0 /*30*/].f_14[iVar1]));
			}
			iVar1++;
		}
		iVar0++;
...
{
	unk_0x6AF7EE4DD9F8B944(Local_1446, 50f, 1, 0, 0, 0);
	unk_0x86DA8A407ED8A381((Local_1446.x - 40f), (Local_1446.f_1 - 40f), (Local_1446.f_2 - 40f), (Local_1446.x + 40f), (Local_1446.f_1 + 40f), (Local_1446.f_2 + 40f), 0, 1);
	if (unk_0x419E13582192CFEA(uParam1->f_1))
	{
		if (!bLocal_1389)
		{
...
{
	iLocal_1459 = unk_0x170478CC84C8AE2F(uParam0->f_5, 439.7705f, -571.9359f, 27.5068f, 325f, 1, 1, 0);
	unk_0x47D0DDD8833C5E5F(iLocal_1459, 1084227584);
	iLocal_1460 = unk_0x170478CC84C8AE2F(uParam0->f_5, 406.7046f, -625.4039f, 27.5068f, 91f, 1, 1, 0);
	unk_0x47D0DDD8833C5E5F(iLocal_1460, 1084227584);
}
...
void func_457(var uParam0, var uParam1)
{
	...
	if (uParam0->f_15 != 0)
	{
		...
		if (uParam0->f_274 == 1)
		{
			...
			iLocal_967 = unk_0x42F3C85A00B4FC7B(uParam1->f_8, 4, uParam0->f_16, -1, 1, 1);
			unk_0xBE91B077ADADE97F(iLocal_967, 1);
...
void func_460()
{
	...
	uLocal_1466[0] = unk_0x0823FA7465392E20(Var0[0 /*3*/] - Vector(8f, 8f, 8f), Var0[0 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	uLocal_1466[1] = unk_0x0823FA7465392E20(Var0[1 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[1 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	uLocal_1466[2] = unk_0x0823FA7465392E20(Var0[2 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[2 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	uLocal_1466[3] = unk_0x0823FA7465392E20(Var0[3 /*3*/] - Vector(9.5f, 9.5f, 9.5f), Var0[3 /*3*/] + Vector(9.5f, 9.5f, 9.5f), 0, 1, 1, 1);
	uLocal_1466[4] = unk_0x0823FA7465392E20(Var0[4 /*3*/] - Vector(8f, 8f, 8f), Var0[4 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	uLocal_1466[5] = unk_0x0823FA7465392E20(Var0[5 /*3*/] - Vector(15f, 15f, 15f), Var0[5 /*3*/] + Vector(15f, 15f, 15f), 0, 1, 1, 1);
}
	...
	switch (iLocal_1347)
	{
		case 0:
			...
			if (bLocal_1370)
			{
				if (unk_0x419E13582192CFEA(iLocal_1348))
				{
					...
					if (unk_0x419E13582192CFEA(iLocal_1348))
					{
						unk_0x4603196EEEA2355C(iLocal_1348, 0, 0);
						unk_0x3CBE9F07524C242D(iLocal_1348, 0, 0);
						unk_0xC22CF0F8AABFA658(iLocal_1348, 0);
						iLocal_1349 = unk_0x795434E153F90E41(joaat("p_phonebox_01b_s"), -26.48f, -110.66f, 56.0227f, 1, 1, 0);
						unk_0xBDDCDEC7B6205897(iLocal_1349, 0f, 0f, 157.62f, 2, 1);
						unk_0x3CBE9F07524C242D(iLocal_1349, 0, 0);
						unk_0xC22CF0F8AABFA658(iLocal_1349, 0);
						unk_0x4603196EEEA2355C(unk_0x7D2B9E6A64637269(), 1, 0);
					}
					uLocal_1376 = unk_0xD1F051AA4563F197(-26.48f, -110.66f, 56.0227f, 350f, 12, 127);
					func_286(1, 1, 1, 0, 0, 0, 0);
					unk_0x91F94D2287684BDB(Local_1353, 5f, 0);
					if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
					{
						unk_0xE37EB80DFB0D31FB(unk_0x7D2B9E6A64637269(), 0, 0);
						unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), Local_1353, 1, 0, 0, 1);
						unk_0xCD37A28258D70638(unk_0x7D2B9E6A64637269(), fLocal_1354);
						unk_0x603ABA046B239722(unk_0x7D2B9E6A64637269(), 1);
					}
					uLocal_1373 = unk_0xD955F1CC0BCABC78(Local_1371, Local_1372, 2);
					if (unk_0x419E13582192CFEA(iLocal_1349))
					{
						unk_0xADAE2D0345EF09F9(uLocal_1373, iLocal_1349, -1);
					}
					unk_0xAD844C8843FC405C(unk_0x7D2B9E6A64637269(), uLocal_1373, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					unk_0xED3365BAA5895E01(iLocal_1349, uLocal_1373, "ass_bus_call_phone", "oddjobs@assassinate@bus@call", 1000f, -2f, 0, 1148846080);
					if (!unk_0x0E8572B08CEB6A11(uLocal_1350))
					{
						uLocal_1351 = unk_0x1CA878DB277C6DF0(26379945, Local_1358, Local_1359, 36f, 1, 2);
						uLocal_1350 = unk_0x1CA878DB277C6DF0(26379945, Local_1360, Local_1361, 36f, 0, 2);
						unk_0x32279DAB93C9A9FA(uLocal_1350, uLocal_1351, 2500, 1, 1);
						unk_0x09F9466B03D29D2D(1, 0, 3000, 1, 0, 0);
						unk_0x9C9EC7CC88D050FA(uLocal_1350, "HAND_SHAKE", 0.2f);
					}
					func_201(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_201(&(uParam0->f_16), 1, unk_0x7D2B9E6A64637269(), "FRANKLIN", 0, 1);
					unk_0xDD7C2F9844E745B1(0);
					unk_0x4200138CBB376D4D(0);
					uLocal_1375 = unk_0xD5504E3827DE12F9(-26.48f, -110.66f, 56.0227f, 3f, 3f, 3f, 0f, 0, 7);
					unk_0x2FF622571073AA69(unk_0x7D2B9E6A64637269(), joaat("weapon_unarmed"), 1);
				...
				else
				{
					...
					if (!unk_0x419E13582192CFEA(iLocal_1348))
					{
						iLocal_1348 = unk_0xB219A5BFF547852F(Local_1352, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1369)
			{
				if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
				{
					if (unk_0xEEC203A73BC92E7E(uLocal_1373))
					{
						if (unk_0x0BC8768247440B3A(uLocal_1373) > 0.05f)
						{
			...
			if (func_168(&uLocal_1362))
			{
				if ((func_165(&uLocal_1362) > fLocal_1355 || (unk_0xEEC203A73BC92E7E(uLocal_1373) && unk_0x0BC8768247440B3A(uLocal_1373) >= 0.962f)) || bLocal_1368)
				{
					iLocal_1347 = 3;
				}
			}
		...
		case 2:
			...
			if (bLocal_1368)
			{
				if (unk_0x8B6A925F148E0E94())
				{
					...
					unk_0x90ED32458AC2D129(iLocal_1349, -1000f, 1);
					wait(0);
					unk_0x6E1E3A5B1F9AB95B(500);
		...
		case 3:
			...
			if (unk_0xE2BB9441C54169BF(uLocal_1376))
			{
				unk_0xDF27EE31B849DF76(uLocal_1376);
			}
			unk_0x3CBE9F07524C242D(iLocal_1349, 1, 0);
			unk_0xDD7C2F9844E745B1(1);
			unk_0x4200138CBB376D4D(1);
			unk_0xCA089CD1A17D76DF(unk_0x7D2B9E6A64637269());
			unk_0xF99B8860747709DD(unk_0x1146A9AE09CE2B14(), 1, 0);
			...
			unk_0x39E572BDDBA714A2(&iLocal_1348);
			iLocal_980 = 4;
			break;
	}
}
...
int func_474(var uParam0, float fParam1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5, float fParam6)
{
	if (unk_0x0E8572B08CEB6A11(*uParam0))
	{
		if (func_168(&uLocal_1365))
		{
			...
			{
				unk_0x7508AE96782B0441(uLocal_1350, Param2);
				unk_0xBD833AA6EB59C81B(uLocal_1350, Param3, 2);
				unk_0xEF20E9A7B745D17A(uLocal_1350, fParam4);
				if (bParam5)
				{
					unk_0x9C9EC7CC88D050FA(uLocal_1350, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_483()
{
	if (unk_0x419E13582192CFEA(iLocal_1461))
	{
		if (unk_0xF41EB7643E61A928(unk_0x7D2B9E6A64637269(), iLocal_1461, 0))
		{
			unk_0x16D66F11FE644901(unk_0x7D2B9E6A64637269());
			unk_0x78CDDD1E6367978D(unk_0x7D2B9E6A64637269(), 421.5518f, -640.2153f, 27.5072f, 1, 0, 0, 1);
		}
		unk_0x4985CD0720AFD468(iLocal_1461, 1, 0);
		unk_0x5420D0D520CF44D0(&iLocal_1461);
	}
}
...
void func_484(var uParam0, struct<3> Param1, struct<3> Param2)
{
	...
	unk_0xA48693249537873E(Param1, Param2, 0);
}
...
{
	return func_493(&(Global_105842.f_2890), Param0, fParam1, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_157(Param1, 0f, 0f, 0f, 0)) || unk_0x0BABEFEA577FCFA4(unk_0xD6E677FAD7521410(iParam0, 1), unk_0xD6E677FAD7521410(uVar1[iVar3], 1), 1) < 10f)
					{
...
{
	unk_0x494E8A58F41F5F54(Param0, Param1);
	unk_0xA48693249537873E(Param0, Param1, 1);
	return unk_0x0823FA7465392E20(Param0, Param1, 0, 1, 1, 1);
}
...
void func_532(var uParam0)
{
	...
	unk_0x43BA63ED2A7A4D2F(uLocal_966);
...
void func_539()
{
	if (unk_0xA66693527106D3DF(uLocal_1375))
	{
		unk_0xF5A3E4A97D6F6DD4(uLocal_1375);
	}
}
