	...
	switch (iVar0)
	{
		...
		case 5:
			...
			if (unk_0x02BFF15CAA701972() && func_53())
			{
				...
				uVar5 = unk_0x15173FB88ABC94F9(&sVar4);
				if (unk_0x92F2FDB7CAFB0FD0(uVar5))
				{
					uVar6 = unk_0xB4D939A0198820EF(uVar5, 426439576, 1);
					return uVar6;
				}
			}
			switch (iParam0)
...
int func_260()
{
	...
	if (func_25() < 7)
	{
		...
		switch (func_25())
		{
			case 0:
				...
				fVar5 = Global_262145.f_21451;
				break;
			
			case 1:
				fVar5 = Global_262145.f_21452;
				break;
			
			case 2:
				fVar5 = Global_262145.f_21453;
				break;
			
			case 3:
				fVar5 = Global_262145.f_21454;
				break;
			
			case 4:
				fVar5 = Global_262145.f_21455;
				break;
			
			case 5:
				fVar5 = Global_262145.f_21456;
				break;
			
			case 6:
				fVar5 = Global_262145.f_21457;
				break;
		}
		if (fVar5 > unk_0x644B8DBA4F69BB73(0f, 1f))
		{
			iVar4 = 1;
		}
	}
	...
	fVar3 = unk_0x644B8DBA4F69BB73(0f, fVar2);
	iVar6 = 0;
	while (iVar6 < 51)
	{
...
int func_333(int iParam0)
{
	...
	iVar3 = func_50(iParam0, iLocal_136);
	iVar4 = iParam0;
	iVar5 = func_335(5, iVar4 + 1);
	iVar6 = unk_0x15173FB88ABC94F9(&sVar2);
	if (func_53())
	{
		bVar0 = false;
		while (!func_334(-103880010, 235173372, iVar6, 1, iVar3, &iLocal_125, iVar5, 3, 0, 0, 0))
		{
			wait(0);
			func_473();
	...
	if (bVar0)
	{
		if (iVar3 > 0)
		{
			Var7.x = unk_0x15173FB88ABC94F9(func_298(iLocal_136));
			Var7.f_1 = 5;
			Var7.f_2 = iParam0;
			unk_0xDEABE64F621A761B(iVar3, &Var7, 0, 1);
		}
		if (func_53())
		{
			func_289(func_316());
...
void func_345()
{
	...
	iVar1 = func_13(unk_0x1146A9AE09CE2B14(), iLocal_136);
	iVar2 = func_35(unk_0x1146A9AE09CE2B14(), iLocal_136);
	iVar3 = Global_1371980[5];
	uVar4 = func_371(iLocal_136);
	uVar5 = func_298(iLocal_136);
	StringCopy(&cVar6, "UA_BUNKER_TXD_", 24);
	iVar7 = func_34(unk_0x1146A9AE09CE2B14(), iLocal_136);
	StringIntConCat(&cVar6, (iLocal_136 - 21), 24);
	iVar8 = func_19();
	...
	unk_0x9E3D03981E2E9AD9((iVar10 + iVar12));
...
void func_427()
{
	...
	fVar2 = (to_float(iVar1) * Global_262145.f_21215);
	fVar3 = (to_float(iVar1) * Global_262145.f_21216);
	iVar4 = round(fVar2);
	iVar5 = round(fVar3);
...
int func_434()
{
	...
	while (iVar2 < 15)
	{
		if (Global_4265506[iVar2 /*85*/].f_66.f_4 == 268924934)
		{
			iLocal_325 = iVar2;
		}
		else
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		...
		{
			if (unk_0x5F0847A02025CAB5(1, iVar3) == 226)
			{
				if (unk_0x53858F1E03A88AE1(1, iVar3, &Var0, 7))
				{
	...
	if (unk_0x234B68AC2E35ED5A(iLocal_124, 11))
	{
		...
		else if (unk_0xCCBB1074CAAE000A(uLocal_320))
		{
			...
			else
			{
				...
				MemCopy(&sVar2, {func_426(iLocal_142, 0)}, 4);
				func_460(1);
...
void func_469()
{
	...
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 206, 1);
	if (unk_0x86AF801D34E482FF(2, 206))
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0xE7F34EDB631EC2D3(2))
	{
		...
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0x86AF801D34E482FF(2, 187))
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x609EEF618F8CC869(2, 187))
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0x609EEF618F8CC869(2, 188))
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0x86AF801D34E482FF(2, 188))
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0x86AF801D34E482FF(2, 187))
		{
			unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_471(2, 189, 1);
	if (unk_0x86AF801D34E482FF(2, 189))
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 190, 1);
	if (unk_0x86AF801D34E482FF(2, 190))
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 201, 1);
	if (unk_0x86AF801D34E482FF(2, 201))
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 202, 1);
	...
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 204, 1);
	if (unk_0x86AF801D34E482FF(2, 204))
	{
		unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0xE7F34EDB631EC2D3(2))
	{
...
void func_470()
{
	...
	unk_0x587426517A26C00B(uLocal_317, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
