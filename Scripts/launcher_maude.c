...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_213(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_234(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xE5965CDF24F93A9F(*uParam0))
		{
			if (!unk_0x55B23FE400FCEA6B(*uParam0, 0))
...
int func_234(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_236(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_199(uParam0);
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_52 = unk_0x2915D98110F23A29(Var0, Var1, 0, 1, 1, 1);
