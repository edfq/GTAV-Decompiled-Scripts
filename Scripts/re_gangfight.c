	...
	while (true)
	{
		...
		if (unk_0xC92F9F18E020B461())
		{
			...
			if (!func_99())
			{
				...
				switch (iLocal_44)
				{
					...
					case 1:
						...
						{
							if ((!unk_0xF68107C40359970C(uLocal_58) && !unk_0xF68107C40359970C(iLocal_59[0])) && !unk_0xF68107C40359970C(iLocal_59[1]))
							{
						...
						else
						{
							...
							{
								if (!unk_0xF68107C40359970C(iLocal_59[iVar0]))
								{
									unk_0x7734082B0EDB0BE0(iLocal_59[iVar0], unk_0xE2D3D51028F0428A(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
							if (!unk_0xF68107C40359970C(uLocal_58))
							{
								unk_0x7734082B0EDB0BE0(uLocal_58, unk_0xE2D3D51028F0428A(), 150f, -1, 0, 0);
							}
							func_69();
						}
						break;
			...
			else
			{
				...
				if (!unk_0xF68107C40359970C(uLocal_58))
				{
					if (unk_0x0747E45CFF1F74AA(uLocal_58, unk_0xE2D3D51028F0428A(), 1))
					{
						unk_0x7734082B0EDB0BE0(uLocal_58, unk_0xE2D3D51028F0428A(), 150f, -1, 0, 0);
						func_69();
					}
					if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), uLocal_58, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_45)
						{
							...
							case 1:
								if (iLocal_46 < 7 && !unk_0xF68107C40359970C(uLocal_58))
								{
									if (unk_0x2E7F5417D4F4DD69(unk_0xE2D3D51028F0428A(), uLocal_58, 90f))
									{
										if (unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), uLocal_58) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), uLocal_58))
										{
											func_64();
										}
									}
				...
				else
				{
					...
					if (((!unk_0xF68107C40359970C(iLocal_59[0]) && !unk_0xF68107C40359970C(iLocal_59[1])) && !unk_0x55B23FE400FCEA6B(iLocal_61[0], 0)) && !unk_0x55B23FE400FCEA6B(iLocal_61[1], 0))
					{
						func_69();
					}
					iVar1 = 0;
					...
					{
						if (!unk_0xF68107C40359970C(iLocal_59[iVar2]))
						{
							unk_0xC1A74225341AA9FB(iLocal_59[iVar2], unk_0xE2D3D51028F0428A(), 0, 16);
							unk_0xABC2CA6F28903308(iLocal_59[iVar2], 1);
							if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_59[iVar2], 150f, 150f, 50f, 0, 1, 0))
							{
								func_69();
							}
							iVar1 = 1;
						}
						else if (unk_0x12DD4A0B247D9B4D(uLocal_57[iVar2]))
						{
							unk_0xFFD8EB5462B07B59(&(uLocal_57[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_49 && !iLocal_54)
	{
		...
		if (!unk_0xF68107C40359970C(uLocal_58))
		{
			unk_0x0407CF7EFEE35240(uLocal_58, 0);
			unk_0x50274A7EACA3133A(uLocal_58, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_59)
		{
			if (unk_0x12DD4A0B247D9B4D(uLocal_57[iVar0]))
			{
				unk_0xFFD8EB5462B07B59(&(uLocal_57[iVar0]));
			}
			if (!unk_0xF68107C40359970C(iLocal_59[iVar0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				if (iVar0 < 2)
				{
					if (!unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
					{
						unk_0xB69D13E19147910F(iLocal_59[iVar0], iLocal_61[iVar0], unk_0xE2D3D51028F0428A(), 8, 20f, 786469, 150f, 10f, 1);
						unk_0xABC2CA6F28903308(iLocal_59[iVar0], 1);
					}
					else
					{
						unk_0x7734082B0EDB0BE0(iLocal_59[iVar0], unk_0xE2D3D51028F0428A(), 200f, -1, 0, 0);
					}
				}
				else
				{
				...
				unk_0x50274A7EACA3133A(iLocal_59[iVar0], 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_61)
		{
			if (!unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
			{
				unk_0x3D81769BEC61BFF8(&(iLocal_61[iVar0]));
	...
	if (unk_0x987A5F1E1A67E3C0(func_2(unk_0x9E2D6C50374FCFA9()), Local_48, 1) > 50f)
	{
		func_146();
	}
}
	...
	switch (iLocal_46)
	{
		case 0:
			if (timerb() > 2000)
			{
				...
				while (iVar0 < iLocal_59)
				{
					if (!unk_0xF68107C40359970C(iLocal_59[iVar0]) && !unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
					{
						if (!unk_0x12DD4A0B247D9B4D(uLocal_57[iVar0]))
						{
							uLocal_57[iVar0] = func_80(iLocal_59[iVar0], 1, 145);
							if (unk_0xD5C6B5E3B93A5EDC(iLocal_59[iVar0], 0))
							{
								if (!bLocal_51)
								{
									unk_0x0E6C3A4EFA9D9D35(iLocal_59[iVar0], unk_0xE2D3D51028F0428A(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									...
									unk_0x8ACADA903FCAA42F(iLocal_59[iVar0], uLocal_62);
		...
		case 1:
			...
			{
				if (!unk_0xF68107C40359970C(iLocal_59[iVar1]))
				{
					if (unk_0x8F41785F110B0DA0(iLocal_59[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0))
					{
						if (!unk_0x55B23FE400FCEA6B(iLocal_61[iVar1], 0))
						{
							unk_0x5545B7D117BB40B4(iLocal_61[iVar1], 0);
						}
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_59[iVar1], 0))
						{
							unk_0xA888F8CC04F25CC8(&uLocal_62);
							unk_0xAB7639D658BBCCEE(0, 0, 0);
							unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
							unk_0xC963A45B50851768(uLocal_62);
							unk_0x8ACADA903FCAA42F(iLocal_59[iVar1], uLocal_62);
							unk_0x7461D7C5BA953BC7(&uLocal_62);
							unk_0xABC2CA6F28903308(iLocal_59[iVar1], 1);
						}
					}
					if (!unk_0xD5C6B5E3B93A5EDC(iLocal_59[iVar1], 0))
					{
						unk_0xC1A74225341AA9FB(iLocal_59[iVar1], unk_0xE2D3D51028F0428A(), 0, 16);
						unk_0xABC2CA6F28903308(iLocal_59[iVar1], 1);
					}
					if (!unk_0x55B23FE400FCEA6B(iLocal_61[iVar1], 0))
					{
						if (unk_0x8F33D7496432068D(iLocal_61[iVar1]))
						{
						}
					}
				}
				if (unk_0xF68107C40359970C(iLocal_59[iVar1]))
				{
					if (unk_0x12DD4A0B247D9B4D(uLocal_57[iVar1]))
					{
						unk_0xFFD8EB5462B07B59(&(uLocal_57[iVar1]));
					}
				}
				iVar1++;
			}
			if (((unk_0xF68107C40359970C(iLocal_59[2]) && unk_0xF68107C40359970C(iLocal_59[3])) && unk_0xF68107C40359970C(iLocal_59[4])) && unk_0xF68107C40359970C(iLocal_59[5]))
			{
				unk_0x0AF8D3A06BB92903("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
				iLocal_46++;
			}
		...
		case 2:
			...
			if (!unk_0xF68107C40359970C(uLocal_58))
			{
				unk_0x03A927199A2DFE46(uLocal_58);
				unk_0xA888F8CC04F25CC8(&uLocal_62);
				unk_0xF30F15F203736DE4(0, unk_0xE2D3D51028F0428A(), -1, 2056, 2);
				unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), -1);
				unk_0xC963A45B50851768(uLocal_62);
				unk_0x8ACADA903FCAA42F(uLocal_58, uLocal_62);
				unk_0x7461D7C5BA953BC7(&uLocal_62);
			}
			if (!unk_0x55B23FE400FCEA6B(uLocal_60, 0))
			{
				unk_0xE68645525D451A8B(uLocal_60);
				if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), uLocal_58, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0xF68107C40359970C(uLocal_58))
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), uLocal_58, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x2E7F5417D4F4DD69(uLocal_58, unk_0xE2D3D51028F0428A(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0xF68107C40359970C(uLocal_58))
			{
				if (!unk_0x77A43AFA9AAEC041(uLocal_58, unk_0xE2D3D51028F0428A(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0x55B23FE400FCEA6B(uLocal_60, 0))
			{
				if (unk_0x0747E45CFF1F74AA(uLocal_60, unk_0xE2D3D51028F0428A(), 0))
				{
					func_69();
				}
			}
		...
		case 5:
			if (!unk_0xF68107C40359970C(uLocal_58) && !unk_0x55B23FE400FCEA6B(uLocal_60, 0))
			{
				unk_0xA888F8CC04F25CC8(&uLocal_62);
				unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 1500);
				unk_0xB486640392EC50BB(0, uLocal_60, -1, -1, 2f, 8, 0);
				unk_0x19C58BA8A663B64B(0, 2000);
				unk_0x49D97B076E3590AC(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0xAD6CDBCDA713560A(0, uLocal_60, 10f, 786603);
				unk_0xC963A45B50851768(uLocal_62);
				unk_0x8ACADA903FCAA42F(uLocal_58, uLocal_62);
				unk_0x7461D7C5BA953BC7(&uLocal_62);
				unk_0xABC2CA6F28903308(uLocal_58, 1);
				unk_0x11647D34B93A72EB(uLocal_60, 1);
				iLocal_46++;
			}
			break;
		...
		case 6:
			if (!unk_0xF68107C40359970C(uLocal_58))
			{
				if (unk_0xFCF559C8631ABED7(uLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0xD01FAFCE275C94F3(uLocal_58, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && unk_0xD5C6B5E3B93A5EDC(uLocal_58, 0))
					{
						unk_0xAE315B17AC08C2A9(unk_0xCACAD935C0BEE14F(unk_0xB3FF0049C1FD38EC(uLocal_58, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_46++;
					}
				}
			}
...
void func_59()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!unk_0xF68107C40359970C(uLocal_58))
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), uLocal_58, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xF30F15F203736DE4(uLocal_58, unk_0xE2D3D51028F0428A(), -1, 2060, 2);
		...
		case 2:
			if (!unk_0xF68107C40359970C(iLocal_58) && !unk_0x55B23FE400FCEA6B(uLocal_60, 0))
			{
				unk_0xA888F8CC04F25CC8(&uLocal_62);
				unk_0x7D1424753688EE7A(0, 916.5764f, 3602.146f, 31.9262f, 1f, 40000, 1048576000, 0, 1193033728);
				unk_0xC963A45B50851768(uLocal_62);
				unk_0x8ACADA903FCAA42F(iLocal_58, uLocal_62);
				unk_0x7461D7C5BA953BC7(&uLocal_62);
				iLocal_46++;
			}
			break;
		...
		case 4:
			...
			{
				if (unk_0x8F41785F110B0DA0(iLocal_58, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
					if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
			...
			if (!unk_0xF68107C40359970C(iLocal_58))
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) || unk_0x45052A4871A67255(unk_0xE2D3D51028F0428A()))
					{
						...
						{
							func_41(1000);
							if ((!unk_0xF68107C40359970C(iLocal_58) && !unk_0xF68107C40359970C(iLocal_59[2])) && !unk_0x55B23FE400FCEA6B(uLocal_60, 0))
							{
								unk_0xA888F8CC04F25CC8(&uLocal_62);
								unk_0xF9D446AF83E7A624(0, uLocal_60, -1, -1, 1f);
								unk_0xF30F15F203736DE4(0, iLocal_59[2], 2000, 0, 2);
								unk_0x529D306014D3C29A(0, iLocal_59[2], 0);
								unk_0xC963A45B50851768(uLocal_62);
								unk_0x8ACADA903FCAA42F(iLocal_58, uLocal_62);
								unk_0x7461D7C5BA953BC7(&uLocal_62);
								func_41(2000);
								...
								if ((!unk_0xF68107C40359970C(iLocal_58) && !unk_0x55B23FE400FCEA6B(uLocal_60, 0)) && unk_0xD5C6B5E3B93A5EDC(iLocal_58, 0))
								{
									iLocal_46++;
								}
								else
								{
									if (!unk_0xF68107C40359970C(iLocal_58) && !unk_0xF68107C40359970C(iLocal_59[2]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_62);
		...
		case 7:
			if ((((!unk_0xF68107C40359970C(iLocal_58) && !unk_0x55B23FE400FCEA6B(uLocal_60, 0)) && !unk_0xF6F5D18EF8EAB859(iLocal_58, uLocal_60, 0)) && !unk_0x1CFDD57741085128(iLocal_58, 0)) && !unk_0xD2FB3E2F21B617DF(iLocal_58))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xF68107C40359970C(iLocal_59[iVar0]) && !unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
				{
					if (((((unk_0x955815B1A675A225(unk_0xE2D3D51028F0428A(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), 0, 1) || unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_59[iVar0], 5f, 5f, 5f, 0, 1, 0)) || unk_0x0747E45CFF1F74AA(iLocal_59[iVar0], unk_0xE2D3D51028F0428A(), 1)) || unk_0x0747E45CFF1F74AA(iLocal_61[iVar0], unk_0xE2D3D51028F0428A(), 1)) || unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_59[iVar0])) || unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_61[iVar0]))
					{
						bLocal_51 = true;
						settimerb(2000);
						iLocal_46 = 0;
			...
			if (unk_0x8F41785F110B0DA0(iLocal_59[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || timerb() > 13000)
			{
				func_41(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_59)
				{
					if (!unk_0xF68107C40359970C(iLocal_59[iVar0]))
					{
						if (!unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
						{
							if (unk_0xF6F5D18EF8EAB859(iLocal_59[iVar0], iLocal_61[iVar0], 0))
							{
								unk_0xB69D13E19147910F(iLocal_59[iVar0], iLocal_61[iVar0], unk_0xE2D3D51028F0428A(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
...
int func_62()
{
	...
	if (((((((!unk_0xE5965CDF24F93A9F(iLocal_61[2]) && !unk_0xE5965CDF24F93A9F(iLocal_61[3])) && !unk_0xE5965CDF24F93A9F(iLocal_61[4])) && !unk_0xE5965CDF24F93A9F(iLocal_61[5])) && !unk_0xE5965CDF24F93A9F(iLocal_59[2])) && !unk_0xE5965CDF24F93A9F(iLocal_59[3])) && !unk_0xE5965CDF24F93A9F(iLocal_59[4])) && !unk_0xE5965CDF24F93A9F(iLocal_59[5]))
	{
		...
		{
			iLocal_61[2] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1, 0);
			iLocal_61[3] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1, 0);
			iLocal_61[4] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1, 0);
			iLocal_61[5] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1, 0);
			unk_0xF1A23B343DFEDFD0(joaat("hexer"));
			unk_0xC5EAD0C81781889B(iLocal_61[2], 3);
			unk_0xC5EAD0C81781889B(iLocal_61[4], 3);
			iLocal_55 = unk_0x320D1840B6DAA1CC() + 1500;
		}
		...
		{
			iLocal_59[2] = unk_0x487C17B41938052C(iLocal_61[2], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_59[3] = unk_0x487C17B41938052C(iLocal_61[3], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			iLocal_59[4] = unk_0x487C17B41938052C(iLocal_61[4], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_59[5] = unk_0x487C17B41938052C(iLocal_61[5], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xF68107C40359970C(iLocal_59[iVar0]) && !unk_0x55B23FE400FCEA6B(iLocal_61[iVar0], 0))
				{
					unk_0x2A375326652F1B50(iLocal_61[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					unk_0xD6A76BAB45A4B460(iLocal_59[iVar0], 137, 1);
					unk_0x6E9C0F9EAC1F29FD(iLocal_59[iVar0], 0);
					unk_0x71B502FC2E129665(iLocal_59[iVar0], 2);
					unk_0xBC12D08EE7559CCD(iLocal_59[iVar0], 50, 1);
					unk_0x395228F7A14C6543(iLocal_59[iVar0], 2);
					unk_0x78D13FF59B219912(iLocal_59[iVar0], 50f, 20);
					unk_0x3DAB02AAC9E9EC02(iLocal_59[iVar0], 1);
					unk_0x348A212511C78DBF(iLocal_59[iVar0], 13);
					unk_0x5C9D9A4EA475F37E(iLocal_59[iVar0], 100f);
					unk_0xE014FF3C785EEFB5(iLocal_59[iVar0], 100f);
					unk_0xFF4BEB6CFF55A013(iLocal_59[iVar0], uLocal_228);
					unk_0x50274A7EACA3133A(iLocal_59[iVar0], 1);
					unk_0xB11C0CF5CCDFE10A(iLocal_59[iVar0], 3);
					unk_0xA84812D8D6EE8D32(iLocal_59[iVar0], 0);
					unk_0xA7266A50941DBAEA(iLocal_59[iVar0], 1);
					unk_0x06AF73D7E3DF7782(iLocal_59[iVar0], 1, 1000f);
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x9521FB98DB6DDF50(iLocal_59[iVar0], joaat("weapon_pistol"), -1, 1, 1);
					}
					else
					{
						unk_0x9521FB98DB6DDF50(iLocal_59[iVar0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					}
					unk_0xA888F8CC04F25CC8(&uLocal_62);
					unk_0x3B8F94419979A0B1(0, iLocal_61[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xE1E1AF00CA06A2B7(0, Local_48, 5000, 0, 2);
					unk_0xC963A45B50851768(uLocal_62);
					unk_0x8ACADA903FCAA42F(iLocal_59[2], uLocal_62);
					unk_0x7461D7C5BA953BC7(&uLocal_62);
					unk_0xA888F8CC04F25CC8(&uLocal_62);
					unk_0x3B8F94419979A0B1(0, iLocal_61[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xE1E1AF00CA06A2B7(0, Local_48, 5000, 0, 2);
					unk_0xC963A45B50851768(uLocal_62);
					unk_0x8ACADA903FCAA42F(iLocal_59[3], uLocal_62);
					unk_0x7461D7C5BA953BC7(&uLocal_62);
					unk_0xABC2CA6F28903308(iLocal_59[3], 1);
					unk_0xA888F8CC04F25CC8(&uLocal_62);
					unk_0x3B8F94419979A0B1(0, iLocal_61[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xE1E1AF00CA06A2B7(0, Local_48, 5000, 0, 2);
					unk_0xC963A45B50851768(uLocal_62);
					unk_0x8ACADA903FCAA42F(iLocal_59[4], uLocal_62);
					unk_0x7461D7C5BA953BC7(&uLocal_62);
					unk_0xA888F8CC04F25CC8(&uLocal_62);
					unk_0x3B8F94419979A0B1(0, iLocal_61[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0xE1E1AF00CA06A2B7(0, Local_48, 5000, 0, 2);
					unk_0xC963A45B50851768(uLocal_62);
					unk_0x8ACADA903FCAA42F(iLocal_59[5], uLocal_62);
					unk_0x7461D7C5BA953BC7(&uLocal_62);
				}
				iVar0++;
			}
...
void func_64()
{
	if (!unk_0xF68107C40359970C(iLocal_58))
	{
		unk_0x7734082B0EDB0BE0(iLocal_58, unk_0xE2D3D51028F0428A(), 200f, -1, 0, 0);
		unk_0xABC2CA6F28903308(iLocal_58, 1);
		if (!unk_0x55B23FE400FCEA6B(iLocal_59[0], 0) && !unk_0x55B23FE400FCEA6B(iLocal_59[1], 0))
		{
			unk_0xF160248D9083ED0C(iLocal_58, 101, 0);
			unk_0x0407CF7EFEE35240(iLocal_58, 0);
			unk_0x913E191F1F726271(iLocal_59[0], iLocal_58, 1000, 0);
			unk_0x913E191F1F726271(iLocal_59[1], iLocal_58, 1000, 0);
		}
		else
		{
			func_4();
...
void func_67()
{
	...
	{
		case 0:
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_54() == 0)
		...
		case 1:
			if (!unk_0xF68107C40359970C(iLocal_58))
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!unk_0xF68107C40359970C(iLocal_58) && !unk_0xF68107C40359970C(iLocal_59[0])) && !unk_0xF68107C40359970C(iLocal_59[1]))
			{
				...
				if (timera() < 28000)
				{
					if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
					{
						if (((unk_0x7E006F2E24F03BB4(iLocal_59[0], unk_0xE2D3D51028F0428A()) || unk_0x7E006F2E24F03BB4(iLocal_59[1], unk_0xE2D3D51028F0428A())) || unk_0xD32EE22119FFF87D(iLocal_59[0], unk_0xE2D3D51028F0428A())) || unk_0xD32EE22119FFF87D(iLocal_59[1], unk_0xE2D3D51028F0428A()))
						{
							unk_0xF30F15F203736DE4(iLocal_59[0], unk_0xE2D3D51028F0428A(), 4000, 2056, 4);
							unk_0xF30F15F203736DE4(iLocal_59[1], unk_0xE2D3D51028F0428A(), 4000, 2056, 4);
							if (!iLocal_53)
							{
								func_4();
								func_41(0);
					...
					else if (!unk_0xFCF559C8631ABED7(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						if (!unk_0x2E7F5417D4F4DD69(iLocal_59[0], iLocal_58, 10f))
						{
							unk_0x636B3584208A6D73(iLocal_59[0], iLocal_58, -1, 0);
						}
					}
				}
				else if (!unk_0x55B23FE400FCEA6B(iLocal_61[0], 0) && !unk_0x55B23FE400FCEA6B(iLocal_61[1], 0))
				{
					func_4();
					func_41(0);
		...
		case 4:
			...
			while (iVar0 < iLocal_59)
			{
				if (!unk_0xF68107C40359970C(iLocal_59[iVar0]))
				{
					unk_0x3E3D339BAD67F6F2(iLocal_59[iVar0], 156, 1);
					unk_0xC1A74225341AA9FB(iLocal_59[iVar0], unk_0xE2D3D51028F0428A(), 0, 16);
					unk_0xABC2CA6F28903308(iLocal_59[iVar0], 1);
				}
				iVar0++;
			}
			if (!unk_0xF68107C40359970C(iLocal_58))
			{
				unk_0x402A537158A551BD(iLocal_58, -1);
			}
			iLocal_46++;
			break;
		...
		case 5:
			...
			if (unk_0xF68107C40359970C(iLocal_59[0]) && unk_0xF68107C40359970C(iLocal_59[1]))
			{
				iLocal_46 = 0;
				iLocal_45 = 1;
			}
...
int func_83()
{
	...
	if (!bLocal_51)
	{
		unk_0x9972EFADA7A2A47D(255, uLocal_228, 1862763509);
		if (!unk_0x55B23FE400FCEA6B(iLocal_59[0], 0) && !unk_0x55B23FE400FCEA6B(iLocal_59[1], 0))
		{
			if (unk_0x0747E45CFF1F74AA(iLocal_59[0], unk_0xE2D3D51028F0428A(), 1) || unk_0x0747E45CFF1F74AA(iLocal_59[1], unk_0xE2D3D51028F0428A(), 1))
			{
				func_4();
				return 1;
			}
			if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
			{
				if (unk_0x0747E45CFF1F74AA(iLocal_59[0], unk_0x9993EF7FDBCDB632(), 1) || unk_0x0747E45CFF1F74AA(iLocal_59[1], unk_0x9993EF7FDBCDB632(), 1))
				{
					func_4();
					return 1;
				}
		...
		if (!unk_0x55B23FE400FCEA6B(iLocal_61[0], 0) && !unk_0x55B23FE400FCEA6B(iLocal_61[1], 0))
		{
			if (((unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_61[0], 0) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_61[1], 0)) || unk_0x0747E45CFF1F74AA(iLocal_61[0], unk_0xE2D3D51028F0428A(), 1)) || unk_0x0747E45CFF1F74AA(iLocal_61[1], unk_0xE2D3D51028F0428A(), 1))
			{
				if (!unk_0xF68107C40359970C(iLocal_59[0]) && !unk_0xF68107C40359970C(iLocal_59[1]))
				{
					if (func_99())
		...
		Var0 = { 15f, 15f, 15f };
		Var1 = { -15f, -15f, -15f };
		if (!unk_0xF68107C40359970C(iLocal_59[0]))
		{
			if (unk_0x9AC74C7EF847A074(unk_0x6EA486FF6D815B4B(iLocal_59[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			Var0 = { Var0 + unk_0x6EA486FF6D815B4B(iLocal_59[0], 31086, 0f, 0f, 0f) };
			Var1 = { Var1 + unk_0x6EA486FF6D815B4B(iLocal_59[0], 31086, 0f, 0f, 0f) };
			if (((unk_0xA1C6623FC1047DAD(Var1, Var0, joaat("weapon_smokegrenade"), 1) || unk_0xA1C6623FC1047DAD(Var1, Var0, joaat("weapon_grenade"), 1)) || unk_0xA1C6623FC1047DAD(Var1, Var0, joaat("weapon_grenadelauncher"), 1)) || unk_0xA1C6623FC1047DAD(Var1, Var0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
			if (unk_0x6A1EDF18639D033E(unk_0x6EA486FF6D815B4B(iLocal_59[0], 31086, 0f, 0f, 0f), 3f))
			{
				func_4();
				return 1;
			}
		...
		if ((!unk_0xF68107C40359970C(iLocal_58) && !unk_0xF68107C40359970C(iLocal_59[0])) && !unk_0xF68107C40359970C(iLocal_59[1]))
		{
			if (iLocal_47 != -1)
			{
				if (((unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_59[0]) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_59[1])) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_59[0])) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_59[1]))
				{
					func_4();
					return 1;
				}
			...
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_58, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((unk_0x7E006F2E24F03BB4(iLocal_59[0], unk_0xE2D3D51028F0428A()) || unk_0x7E006F2E24F03BB4(iLocal_59[1], unk_0xE2D3D51028F0428A())) || unk_0xD32EE22119FFF87D(iLocal_59[0], unk_0xE2D3D51028F0428A())) || unk_0xD32EE22119FFF87D(iLocal_59[1], unk_0xE2D3D51028F0428A()))
				{
					if (!iLocal_50)
					{
						unk_0x636B3584208A6D73(iLocal_59[0], unk_0xE2D3D51028F0428A(), -1, 0);
						iLocal_50 = 1;
					}
					if (unk_0x12DD4A0B247D9B4D(uLocal_56))
					{
					...
					if (unk_0x12DD4A0B247D9B4D(uLocal_57[0]))
					{
						unk_0x3430966AC4550BB9(uLocal_57[0], 1);
					}
					if (unk_0x12DD4A0B247D9B4D(uLocal_57[1]))
					{
						unk_0x3430966AC4550BB9(uLocal_57[1], 1);
					}
					if ((!func_8() || func_6("RECGF_SHUTUP")) || func_6("RECGF_PAYUP"))
					{
						if (iLocal_47 == -1)
						{
							iLocal_47 = unk_0x320D1840B6DAA1CC();
							if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
							{
								func_4();
								func_41(0);
			...
			if (iLocal_47 != -1 && unk_0x320D1840B6DAA1CC() > iLocal_47 + 10000)
			{
				func_4();
				func_41(0);
			...
			if (!unk_0x0747E45CFF1F74AA(iLocal_59[0], unk_0xE2D3D51028F0428A(), 1) && !unk_0x0747E45CFF1F74AA(iLocal_59[1], unk_0xE2D3D51028F0428A(), 1))
			{
				if (unk_0x0747E45CFF1F74AA(iLocal_58, unk_0xE2D3D51028F0428A(), 1))
				{
					if (func_99())
					{
						func_4();
...
void func_84()
{
	if (unk_0x55A0C756C4A8220C(uLocal_60, 0))
	{
		if ((!unk_0x8F41785F110B0DA0(uLocal_60, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !unk_0xF6F5D18EF8EAB859(iLocal_58, iLocal_60, 0)) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_60, 1))
		{
			func_64();
		}
	}
...
int func_85()
{
	...
	if (((((!unk_0xE5965CDF24F93A9F(iLocal_58) && !unk_0xE5965CDF24F93A9F(iLocal_59[0])) && !unk_0xE5965CDF24F93A9F(iLocal_59[1])) && !unk_0xE5965CDF24F93A9F(iLocal_60)) && !unk_0xE5965CDF24F93A9F(iLocal_61[0])) && !unk_0xE5965CDF24F93A9F(iLocal_61[1]))
	{
		...
		if (((((((unk_0x0152AA00FA3130F1(joaat("a_m_m_skidrow_01")) && unk_0x0152AA00FA3130F1(joaat("g_m_y_lost_01"))) && unk_0x0152AA00FA3130F1(joaat("g_m_y_lost_02"))) && unk_0x0152AA00FA3130F1(joaat("picador"))) && unk_0x0152AA00FA3130F1(joaat("hexer"))) && unk_0x6F940C2636C076AD("random@countryside_gang_fight")) && unk_0x6F940C2636C076AD("veh@drivebystd_ds_grenades")) && unk_0xBB103A5DEC572725("move_m@gangster@var_i"))
		{
			...
			unk_0x2915D98110F23A29(Local_48 - Vector(20f, 50f, 80f), Local_48 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
			unk_0x07CECF421D895F3D(3, 0);
			unk_0x07CECF421D895F3D(5, 0);
			unk_0xD642E010A287ADFD("rghLost", &uLocal_228);
			unk_0x9972EFADA7A2A47D(5, uLocal_228, 1862763509);
			iLocal_58 = unk_0xA8D58C3AADA2C41C(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
			unk_0xE3752B10DC995E95(iLocal_58, 0, 0, 1, 0);
			unk_0xE3752B10DC995E95(iLocal_58, 2, 1, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_58, 3, 1, 2, 0);
			unk_0xE3752B10DC995E95(iLocal_58, 4, 0, 0, 0);
			...
			unk_0x0407CF7EFEE35240(iLocal_58, 1);
			unk_0xD6A76BAB45A4B460(iLocal_58, 185, 1);
			unk_0xD07E491BDA082CED(iLocal_58, 16);
			unk_0xEEBC95A38CBDED42(iLocal_58, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_63(&uLocal_63, 1, iLocal_58, "RECGFDealer", 0, 1);
			unk_0x059473086913178C(iLocal_58, 1);
			unk_0x49D97B076E3590AC(iLocal_58, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0xABFC84F5C4943D7B(iLocal_58, "move_m@gangster@var_i", 1048576000);
			iLocal_60 = unk_0xBA715A7BEBA5A1F9(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
			unk_0x58DAFDEB2F46A5EA(iLocal_60, 37, 0);
			unk_0x952B5201CC721090(iLocal_60, 4, 0);
			unk_0xAA207A327A73D480(iLocal_60, 1);
			unk_0x2C2F2F6BEE7AC7E7(iLocal_60, "WDU 696");
			iLocal_59[0] = unk_0xA8D58C3AADA2C41C(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, 1);
			func_63(&uLocal_63, 3, iLocal_59[0], "RECGFLost2", 0, 1);
			iLocal_59[1] = unk_0xA8D58C3AADA2C41C(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, 1);
			func_63(&uLocal_63, 2, iLocal_59[1], "RECGFLost1", 0, 1);
			unk_0xF1A23B343DFEDFD0(joaat("g_m_y_lost_01"));
			unk_0xF1A23B343DFEDFD0(joaat("g_m_y_lost_02"));
			iLocal_61[0] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1, 0);
			iLocal_61[1] = unk_0xBA715A7BEBA5A1F9(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1, 0);
			unk_0xF1A23B343DFEDFD0(joaat("hexer"));
			unk_0x49D97B076E3590AC(iLocal_59[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x49D97B076E3590AC(iLocal_59[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_59)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x71B502FC2E129665(iLocal_59[iVar0], 2);
					unk_0xBC12D08EE7559CCD(iLocal_59[iVar0], 50, 1);
					unk_0x3DAB02AAC9E9EC02(iLocal_59[iVar0], 0);
					unk_0x9521FB98DB6DDF50(iLocal_59[0], joaat("weapon_pistol"), -1, 1, 1);
					unk_0x9521FB98DB6DDF50(iLocal_59[1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					unk_0xABC2CA6F28903308(iLocal_59[iVar0], 1);
					unk_0x50274A7EACA3133A(iLocal_59[iVar0], 1);
					unk_0x006574E87E6F1942(iLocal_59[iVar0], 1, 1);
				}
				iVar0++;
			}
			iLocal_55 = unk_0x320D1840B6DAA1CC() + 1500;
			if (func_54() == 0)
			{
				func_63(&uLocal_63, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
			}
			else if (func_54() == 1)
			{
				func_63(&uLocal_63, 0, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
			}
			else if (func_54() == 2)
			{
				func_63(&uLocal_63, 0, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
			}
			return 1;
		}
	}
...
int func_86()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_97())
		{
			return 0;
		}
	}
...
int func_104(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_140(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_118(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
