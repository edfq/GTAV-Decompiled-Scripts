...
void __EntryFunction__()
{
	...
	uLocal_54 = unk_0x2915D98110F23A29(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
...
int func_183(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0xE2D3D51028F0428A()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0x320D1840B6DAA1CC() - uParam0->f_60) > iParam6) && func_187(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_187(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_199(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_219(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_237(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_244(&iVar0) || !unk_0x6F940C2636C076AD(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			...
			{
				uVar5 = unk_0x7F0054A115D66F44(uParam0->f_35[0], "chassis_dummy");
				Var6 = { unk_0x96EDA732FD9DC0AF(uParam0->f_35[0], uVar5) };
				uVar2 = unk_0x8F5F4164BF5FB513(Var6, unk_0x63A8BF5E6C2BF85C(uParam0->f_35[0], 2), 2);
				unk_0xFE1CD80C2F7CBCFB(uVar2, 1);
				unk_0x0BA4916484503B63(uVar2, 0);
				unk_0x950B26F4C891073F(uParam0->f_28[0], uVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_238(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_198(uParam0);
...
int func_241(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_242(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xE5965CDF24F93A9F(*uParam0))
		{
			if (!unk_0x55B23FE400FCEA6B(*uParam0, 0))
...
int func_242(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
