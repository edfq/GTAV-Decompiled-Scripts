...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else if (unk_0x9315DBF7D972F07A())
		{
			...
			if (iLocal_79 == 2)
			{
				iLocal_80 = unk_0x3EADDB16D5BD2CBA();
				switch (iLocal_80)
				{
					case 3:
						break;
		...
		if (iLocal_77 == 0)
		{
			...
			{
				unk_0x61481F9FBB1C7EDD(joaat("sp_cellphone_sleep_time"), &iLocal_76, -1);
		...
		else if (!unk_0xE2D0C323A1AE5D85(Global_7824, 25))
		{
			...
			iLocal_77 = 0;
			unk_0x076A5661EF5ABEE4(joaat("sp_cellphone_sleep_time"), (iLocal_76 + (iLocal_75 - iLocal_74)), 1);
		}
		func_81();
		func_80();
		func_79();
...
void func_1()
{
	iLocal_54 = unk_0xA2702A84C74E8980(Global_22324);
	switch (iLocal_54)
	{
		case 0:
			Global_22320 = 4;
...
void func_3()
{
	if (unk_0x9315DBF7D972F07A())
	{
		iLocal_52 = unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), uLocal_50);
	}
	else
	{
...
void func_4()
{
	iLocal_54 = unk_0x8E8FE906D8BAC5F7();
	switch (iLocal_54)
	{
		case 0:
			if (unk_0x9315DBF7D972F07A())
			{
				uLocal_50 = unk_0x0A89FDFA763DCAED();
			}
			else
			{
...
void func_8()
{
	iLocal_54 = unk_0x78BB5808602D08AA(1);
	switch (iLocal_54)
	{
		case 0:
			Global_22320 = 9;
...
void func_9()
{
	iLocal_54 = unk_0xEFAC41D453B8FA2B(iLocal_55);
	switch (iLocal_54)
	{
		case 0:
...
void func_10()
{
	if (unk_0x91E8216F9CE58F7E(iLocal_55))
	{
		Global_22320 = 5;
	}
	else
...
void func_11()
{
	iLocal_54 = unk_0x6FB6030525709933();
	switch (iLocal_54)
	{
		case 0:
			Global_22320 = 4;
...
int func_16()
{
	...
	if ((func_22(2, Global_19921, 0) && !unk_0x1EC008858F146889(19)) && !unk_0xBF6119A4AD89EF09())
	{
		...
		if (unk_0x361847535F5EDC1B() == Global_22342 && unk_0x361847535F5EDC1B() != -1)
		{
			...
			iLocal_60 = 0;
			iLocal_61 = 0;
			while (((func_20(2, Global_19921) && iLocal_60 < 250) && Global_20152 == 0) && !unk_0x1EC008858F146889(19))
			{
				if (Global_8528 > 0)
				{
					func_17();
...
void func_17()
{
	...
	if (Global_22350)
	{
		fLocal_71 = -0.055f;
		fLocal_72 = 0.745f;
		fLocal_67 = unk_0x36E90400DA266164();
		...
		if (!func_19())
		{
			...
			unk_0x694170BB080C08FF(uLocal_37, fLocal_68, fLocal_69, 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
							...
							if (!unk_0x99C20D75AF0FB22E(unk_0x9E2D6C50374FCFA9(), 1))
							{
								...
								if (!func_19())
								{
									...
									if (Global_2678323.f_1593)
									{
										...
										{
											unk_0x694170BB080C08FF(uLocal_37, (fLocal_68 + fLocal_39), (fLocal_69 + fLocal_40), 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
										}
									}
									else
									{
		...
		case 4:
			...
			else
			{
				...
				else
				{
					...
					if (((Global_112915.f_14051[Global_19954 /*20*/].f_18 == 1 || Global_112915.f_14051[Global_19954 /*20*/].f_17 == 1) || bLocal_66 == 1) || Global_22344 != 0)
					{
						while (!unk_0x0347CCBD719C8ADC(Global_19935) && Global_19937 == 0)
						{
							wait(0);
...
void func_24()
{
	...
	switch (Global_19954.f_1)
	{
		case 6:
			...
			if (Global_8429 == 1)
			{
				func_35(Global_19935, "DISPLAY_VIEW", 1f, to_float(Global_19958), -1082130432, -1082130432, -1082130432);
				Global_19934 = Global_19958;
			}
			else
			{
				func_35(Global_19935, "DISPLAY_VIEW", 1f, to_float(Global_19959), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_29();
				func_35(Global_19935, "SET_THEME", to_float(Global_112915.f_14051[Global_19954 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_21298)
				{
				...
				{
					func_32(Global_19935, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_117[Global_7139 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_32(Global_19935, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_1918[Global_7139 /*29*/].f_3), &(Global_1918[Global_7139 /*29*/].f_7), "CELL_217", &(Global_1918[Global_7139 /*29*/].f_3), 0);
				}
				func_35(Global_19935, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_21285 == 4 || Global_21285 == 3)
			{
				...
				else
				{
					...
					if (func_27(Global_7139, Global_19954) == 0)
					{
						...
						func_32(Global_19935, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_7139 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
					}
					else
					{
						func_35(Global_19935, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_32(Global_19935, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_1918[Global_7139 /*29*/].f_3), &(Global_1918[Global_7139 /*29*/].f_7), &Var0, &(Global_1918[Global_7139 /*29*/].f_3), 0);
					}
				}
				func_35(Global_19935, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (Global_2725219)
							{
								if (iVar1 == 14)
								{
									func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(Global_22348), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8393[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(Global_22353), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_77852)
								{
									...
									func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19954)
									...
									func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7831[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_32(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8393[iVar0] = 1;
						}
					}
...
void func_51()
{
	...
	if (((((((Global_4534062[Global_4535311 /*104*/].f_32 == 4 || Global_4534062[Global_4535311 /*104*/].f_32 == 5) || Global_4534062[Global_4535311 /*104*/].f_32 == 6) || Global_4534062[Global_4535311 /*104*/].f_32 == 7) || Global_4534062[Global_4535311 /*104*/].f_32 == 8) || Global_4534062[Global_4535311 /*104*/].f_32 == 9) || Global_4534062[Global_4535311 /*104*/].f_32 == 10) || Global_4534062[Global_4535311 /*104*/].f_32 == 11)
	{
		...
		while (iVar1 < Global_4534062[Global_4535311 /*104*/].f_49)
		{
			switch (Global_4534062[Global_4535311 /*104*/].f_32)
			{
				case 4:
					unk_0x26C23BE14F66F202(&(Global_2810287.f_1725[iVar1 /*4*/]));
					break;
				
				case 5:
					unk_0x26C23BE14F66F202(&(Global_1932204[iVar1 /*4*/]));
					break;
				
				case 6:
					unk_0x26C23BE14F66F202(&(Global_1932245[iVar1 /*4*/]));
					break;
				
				case 7:
					unk_0x26C23BE14F66F202(&(Global_1932266[iVar1 /*4*/]));
					break;
				
				case 8:
					unk_0x26C23BE14F66F202(&(Global_1932283[iVar1 /*4*/]));
					break;
				
				case 9:
					unk_0x26C23BE14F66F202(&(Global_1932296[iVar1 /*4*/]));
					break;
				
				case 10:
					unk_0x26C23BE14F66F202(&(Global_1932309[iVar1 /*4*/]));
					break;
				
				case 11:
					unk_0x26C23BE14F66F202(&(Global_1932322[iVar1 /*4*/]));
					break;
			}
			iVar1++;
		}
		StringCopy(&cVar2, unk_0xAEF70623D03F7B02(&(Global_1918[Global_4534062[Global_4535311 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 2, &cVar2, 0);
		unk_0xCED9E32812D6C7C7(&Global_4535327, 1);
		Global_22343 = 1;
		Global_22342 = uLocal_48;
		Global_22346 = 0;
	}
	else
	{
		...
		if (Global_4534062[Global_4535311 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar3, &Global_8512, 64);
			StringConCat(&cVar3, "</C>", 64);
			uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 2, &cVar3, 0);
			unk_0xCED9E32812D6C7C7(&Global_4535327, 1);
			Global_22343 = 1;
			Global_22342 = uLocal_48;
		}
		...
		{
			StringCopy(&cVar4, unk_0xAEF70623D03F7B02(&(Global_1918[Global_4534062[Global_4535311 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_4534062[Global_4535311 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 2, &cVar5, 0);
			}
			else
			{
				uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 2, &cVar4, 0);
			}
			unk_0xCED9E32812D6C7C7(&Global_4535327, 1);
			Global_22343 = 1;
			Global_22342 = uLocal_48;
	...
	Global_4534062[Global_4535311 /*104*/].f_16 = uLocal_48;
}
...
void func_53()
{
	if (unk_0xE2D0C323A1AE5D85(Global_7824, 1))
	{
		...
		if (unk_0x9315DBF7D972F07A())
		{
			uLocal_45[Global_19954] = unk_0x0A89FDFA763DCAED();
			iLocal_43[Global_19954] = 1;
		}
		else if (!unk_0xE2D0C323A1AE5D85(Global_7824, 10))
		{
			iLocal_44[Global_19954] = unk_0x320D1840B6DAA1CC();
			iLocal_43[Global_19954] = 1;
		}
		else
		{
			iLocal_44[0] = unk_0x320D1840B6DAA1CC();
			iLocal_44[2] = unk_0x320D1840B6DAA1CC();
			iLocal_44[1] = unk_0x320D1840B6DAA1CC();
			iLocal_43[0] = 1;
			iLocal_43[2] = 1;
			iLocal_43[1] = 1;
		}
...
void func_56()
{
	...
	if (((((((Global_112915.f_14141[Global_22352 /*104*/].f_32 == 4 || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 5) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 6) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 7) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 8) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 9) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 10) || Global_112915.f_14141[Global_22352 /*104*/].f_32 == 11)
	{
		...
		while (iVar1 < Global_112915.f_14141[Global_22352 /*104*/].f_49)
		{
		...
		StringCopy(&cVar2, unk_0xAEF70623D03F7B02(&(Global_1918[Global_112915.f_14141[Global_22352 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 1, &cVar2, 0);
		Global_22343 = 3;
		Global_22342 = uLocal_48;
		Global_22346 = 0;
	}
	else
	{
		...
		if (Global_112915.f_14141[Global_22352 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar3, &Global_8512, 64);
			StringConCat(&cVar3, "</C>", 64);
			uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 1, &cVar3, 0);
			Global_22343 = 3;
			Global_22342 = uLocal_48;
		}
		else
		{
			StringCopy(&cVar4, unk_0xAEF70623D03F7B02(&(Global_1918[Global_112915.f_14141[Global_22352 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_112915.f_14141[Global_22352 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar5, &cVar4, 64);
				uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 1, &cVar5, 0);
			}
			else
			{
				uLocal_48 = unk_0x3B81B9627E7885CF(&cVar0, &cVar0, 0, 1, &cVar4, 0);
			}
			Global_22343 = 3;
			Global_22342 = uLocal_48;
			Global_22346 = 0;
	...
	Global_112915.f_14141[Global_22352 /*104*/].f_16 = uLocal_48;
}
...
void func_58()
{
	if (iLocal_43[Global_19954] == 1)
	{
		if (unk_0x9315DBF7D972F07A())
		{
			iLocal_47 = unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), uLocal_45[Global_19954]);
		}
		else
		{
			iLocal_46[Global_19954] = unk_0x320D1840B6DAA1CC();
			iLocal_47 = (iLocal_46[Global_19954] - iLocal_44[Global_19954]);
		}
		if (iLocal_47 > 300000)
		{
	...
	if (Global_77852 == 0)
	{
		if (!func_50())
		{
			...
			if (iLocal_64 == 0)
			{
				...
				{
					iLocal_64 = 1;
					iLocal_65 = Global_19954;
					if (unk_0x9315DBF7D972F07A())
					{
						uLocal_62 = unk_0x0A89FDFA763DCAED();
					}
					else
					{
			...
			else
			{
				if (unk_0x9315DBF7D972F07A())
				{
					iLocal_63 = unk_0x780A854E3A976A66(unk_0x0A89FDFA763DCAED(), uLocal_62);
				}
				else
				{
...
int func_64(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20145)
	{
		if (Global_19954.f_1 == 6)
		{
			func_35(Global_19935, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_33(1);
			func_35(Global_19935, "DISPLAY_VIEW", 1f, to_float(Global_19934), -1082130432, -1082130432, -1082130432);
		}
	}
...
int func_75(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_96(int iParam0)
{
	...
	if (vdist2(Var0, 1081.951f, -1976.762f, 30.47218f) < 6f && func_103(26))
	{
		return 9;
	}
	if (!iLocal_27)
	...
	else if ((iVar1 == Global_111886 || iVar1 == Global_111887) && func_104(67))
	{
		return 9;
	}
	iVar2 = 0;
