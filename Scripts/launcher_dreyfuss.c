...
float func_171(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam6) && func_171(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					...
					unk_0x7CD708DEB04F8474(iLocal_53, 1);
				}
			}
			if (bVar2)
			{
...
void func_269(int iParam0, bool bParam1)
{
	...
	func_270(sVar0);
	unk_0x7CD708DEB04F8474(iLocal_53, 0);
