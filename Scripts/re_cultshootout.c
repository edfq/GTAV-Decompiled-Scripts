...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0xC92F9F18E020B461() || iLocal_60) || (func_111() && unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_46, 500f, 500f, 500f, 0, 1, 0)))
		{
			if (!func_111())
			{
				if (func_110())
...
void func_1()
{
	if (iLocal_54 && !iLocal_53)
	{
		...
		while (iLocal_71 < 6)
		{
			if (!unk_0xF68107C40359970C(iLocal_63[iLocal_71]))
			{
				if (unk_0x12DD4A0B247D9B4D(uLocal_68[iLocal_71]))
				{
					unk_0xFFD8EB5462B07B59(&(uLocal_68[iLocal_71]));
				}
				unk_0xB3822DB3D538C8F3(&(iLocal_63[iLocal_71]));
			}
			iLocal_71++;
		}
	...
	if (vdist(func_2(unk_0x9E2D6C50374FCFA9()), Local_46) > 150f)
	{
		func_142();
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_6(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_24()
{
	...
	{
		case 0:
			if (unk_0x2791155FB0769FE5(uLocal_65))
			{
				if (unk_0x12DD4A0B247D9B4D(uLocal_66))
				{
					if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_49, Local_50, fLocal_51, 0, 1, 0))
					{
						func_67();
						if (!bLocal_61)
						{
			...
			if (bLocal_61)
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_76) > 6000)
				{
					if (!iLocal_62)
					{
		...
		case 1:
			if ((((unk_0xF68107C40359970C(iLocal_63[0]) && unk_0xF68107C40359970C(iLocal_63[1])) && unk_0xF68107C40359970C(iLocal_63[2])) && unk_0xF68107C40359970C(iLocal_63[3])) && unk_0xF68107C40359970C(iLocal_63[4]))
			{
				func_25();
			}
			else if (!unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_46, 100f, 100f, 100f, 0, 1, 0))
			{
				func_25();
			}
			break;
...
void func_70()
{
	if (unk_0x803592456AE579B3(uLocal_65))
	{
		if (unk_0x12DD4A0B247D9B4D(uLocal_66))
		{
			unk_0xFFD8EB5462B07B59(&uLocal_66);
...
void func_71()
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if ((func_95() && iLocal_73 != 2) || (iLocal_73 == 1 && unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A())))
			{
				func_93();
				wait(0);
				if (func_92())
			...
			switch (iLocal_73)
			{
				case 0:
					...
					{
						if ((unk_0x77A43AFA9AAEC041(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A(), 15f, 15f, 40f, 0, 1, 0) && unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), iLocal_63[iLocal_71])) || unk_0x7E006F2E24F03BB4(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A()))
						{
							if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_49, Local_50, fLocal_51, 0, 1, 0) || unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, 0, 1, 0))
							{
								if (!func_56())
								{
								...
								{
									unk_0x41FBE02637A70478(iLocal_63[iLocal_71]);
									...
									unk_0x8ACADA903FCAA42F(iLocal_63[iVar0], uLocal_70);
									unk_0x7461D7C5BA953BC7(&uLocal_70);
									unk_0xA091C233F9D0AB04(iLocal_63[iVar0], 1, -1, 0);
									iVar0++;
								}
				...
				case 1:
					...
					while (iVar1 < iLocal_63)
					{
						if (!iLocal_56[iVar1])
						{
							...
							unk_0x636B3584208A6D73(0, unk_0xE2D3D51028F0428A(), -1, 0);
							unk_0xC963A45B50851768(uLocal_70);
							unk_0x8ACADA903FCAA42F(iLocal_63[iVar1], uLocal_70);
							unk_0x7461D7C5BA953BC7(&uLocal_70);
							unk_0xA091C233F9D0AB04(iLocal_63[iVar1], 1, -1, 0);
							iLocal_56[iVar1] = 1;
						}
						iVar1++;
					}
					if (!unk_0xF68107C40359970C(iLocal_63[iLocal_71]))
					{
						if (!unk_0x2E7F5417D4F4DD69(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A(), 50f))
						{
							unk_0xF30F15F203736DE4(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A(), -1, 0, 2);
							unk_0xABC2CA6F28903308(iLocal_63[iLocal_71], 1);
						}
					}
					...
					{
						if ((unk_0x320D1840B6DAA1CC() - iLocal_76) > 12000)
						{
							if (!func_56())
							{
								func_91(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
					...
					if (iLocal_56[iLocal_71])
					{
						if (((unk_0x320D1840B6DAA1CC() - iLocal_76) > 18000 || (iLocal_75 - iLocal_74) > 5000) || unk_0xCED7266BAB0BDC20(iLocal_63[iLocal_71], 0))
						{
							if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_49, Local_50, fLocal_51, 0, 1, 0) || unk_0x77A43AFA9AAEC041(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_93();
								wait(0);
								if (func_92())
							...
							{
								if (!unk_0xCED7266BAB0BDC20(iLocal_63[iLocal_71], 0))
								{
									unk_0x03A927199A2DFE46(iLocal_63[iLocal_71]);
									if (!unk_0xF68107C40359970C(iLocal_63[0]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_70);
										...
										unk_0x3F2B528DF27C8A9F(uLocal_70, 1);
										unk_0xC963A45B50851768(uLocal_70);
										unk_0x8ACADA903FCAA42F(iLocal_63[0], uLocal_70);
										unk_0x7461D7C5BA953BC7(&uLocal_70);
										unk_0xA091C233F9D0AB04(iLocal_63[0], 0, -1, 0);
									}
									if (!unk_0xF68107C40359970C(iLocal_63[1]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_70);
										...
										unk_0x3F2B528DF27C8A9F(uLocal_70, 1);
										unk_0xC963A45B50851768(uLocal_70);
										unk_0x8ACADA903FCAA42F(iLocal_63[1], uLocal_70);
										unk_0x7461D7C5BA953BC7(&uLocal_70);
										unk_0xA091C233F9D0AB04(iLocal_63[1], 0, -1, 0);
									}
									if (!unk_0xF68107C40359970C(iLocal_63[2]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_70);
										...
										unk_0x3F2B528DF27C8A9F(uLocal_70, 1);
										unk_0xC963A45B50851768(uLocal_70);
										unk_0x8ACADA903FCAA42F(iLocal_63[2], uLocal_70);
										unk_0x7461D7C5BA953BC7(&uLocal_70);
										unk_0xA091C233F9D0AB04(iLocal_63[2], 0, -1, 0);
									}
									if (!unk_0xF68107C40359970C(iLocal_63[3]) && !unk_0xF68107C40359970C(iLocal_63[4]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_70);
										unk_0xC149E50FBB27DD70(0, iLocal_63[4], -1, 2f, 1f, 1073741824, 0);
										unk_0x529D306014D3C29A(0, iLocal_63[4], 0);
										unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0xC963A45B50851768(uLocal_70);
										unk_0x8ACADA903FCAA42F(iLocal_63[3], uLocal_70);
										unk_0x7461D7C5BA953BC7(&uLocal_70);
										unk_0xA091C233F9D0AB04(iLocal_63[3], 0, -1, 0);
									}
									if (!unk_0xF68107C40359970C(iLocal_63[4]))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_70);
										unk_0xC149E50FBB27DD70(0, iLocal_63[3], -1, 2f, 1f, 1073741824, 0);
										unk_0x529D306014D3C29A(0, iLocal_63[3], 0);
										unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0xC963A45B50851768(uLocal_70);
										unk_0x8ACADA903FCAA42F(iLocal_63[4], uLocal_70);
										unk_0x7461D7C5BA953BC7(&uLocal_70);
										unk_0xA091C233F9D0AB04(iLocal_63[4], 0, -1, 0);
									}
									if (!unk_0xF68107C40359970C(iLocal_63[5]))
									{
										unk_0x274A180D57A0D9A6(iLocal_63[5], 0f, 3f, 1);
										unk_0xA091C233F9D0AB04(iLocal_63[5], 0, -1, 0);
									}
								}
								iVar1 = 0;
				...
				case 2:
					...
					while (iLocal_71 < 6)
					{
						if (!unk_0xF68107C40359970C(iLocal_63[iLocal_71]))
						{
							...
							{
								unk_0x41FBE02637A70478(iLocal_63[iLocal_71]);
								unk_0xC1A74225341AA9FB(iLocal_63[iLocal_71], unk_0xE2D3D51028F0428A(), 0, 16);
								unk_0xABC2CA6F28903308(iLocal_63[iLocal_71], 1);
								if (!unk_0x12DD4A0B247D9B4D(uLocal_68[iLocal_71]))
								{
...
int func_95()
{
	...
	{
		if (unk_0x55A0C756C4A8220C(iLocal_64[iVar0], 0))
		{
			if (unk_0x0747E45CFF1F74AA(iLocal_64[iVar0], unk_0xE2D3D51028F0428A(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_63)
	{
		if (!unk_0xF68107C40359970C(iLocal_63[iVar0]))
		{
			if (unk_0x7E006F2E24F03BB4(iLocal_63[iVar0], unk_0xE2D3D51028F0428A()))
			{
				if (unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_63[iVar0]) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_63[iVar0]))
				{
					return 1;
				}
			}
			if ((((((unk_0x9AC74C7EF847A074(unk_0x6B62510F212526DC(iLocal_63[iVar0], 1), 5f, 1) || unk_0x0747E45CFF1F74AA(iLocal_63[iVar0], unk_0xE2D3D51028F0428A(), 1)) || unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_63[iVar0])) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) - Vector(15f, 15f, 15f), unk_0x6B62510F212526DC(iLocal_63[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0x44808D06C0FF7D30(-1, Local_49, Local_50, fLocal_51))
	{
		return 1;
	}
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_49, Local_50, fLocal_51, 0, 1, 0))
...
void func_96()
{
	...
	{
		unk_0x2915D98110F23A29(Local_46 - Vector(20f, 50f, 50f), Local_46 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		unk_0x7CD708DEB04F8474(joaat("bobcatxl"), 1);
		unk_0x8576657A629C4B0A(0f);
		unk_0x07CECF421D895F3D(3, 0);
		iLocal_64[0] = unk_0xBA715A7BEBA5A1F9(joaat("bobcatxl"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, 1, 1, 0);
		unk_0x2D58A6131679D82C(iLocal_64[0], 1, 0);
		unk_0x9F65B3BAFA302A65(iLocal_64[0], 1084227584);
		unk_0x45A6EA15139A0C54(iLocal_64[0], 1, 1);
		iLocal_64[1] = unk_0xBA715A7BEBA5A1F9(joaat("bobcatxl"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, 1, 1, 0);
		unk_0x2D58A6131679D82C(iLocal_64[1], 1, 0);
		unk_0x45A6EA15139A0C54(iLocal_64[1], 1, 0);
		iVar0 = 0;
		unk_0xCED9E32812D6C7C7(&iVar0, 1);
		uLocal_65 = unk_0x1EE09F99FEF19DAF(joaat("pickup_money_case"), Local_47, -1.368082f, 0.230633f, 176.8749f, iVar0, unk_0x5853B15F78E1A265(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		unk_0xD642E010A287ADFD("DrugCult", &iLocal_69);
		unk_0x9972EFADA7A2A47D(3, iLocal_69, joaat("COP"));
		unk_0x9972EFADA7A2A47D(3, joaat("COP"), iLocal_69);
		unk_0x9972EFADA7A2A47D(5, iLocal_69, 1862763509);
		iLocal_71 = 0;
		while (iLocal_71 < 6)
		{
			iLocal_63[iLocal_71] = unk_0xA8D58C3AADA2C41C(26, joaat("g_m_y_salvagoon_01"), Local_48[iLocal_71 /*3*/], fLocal_52[iLocal_71], 1, 1);
			unk_0x50274A7EACA3133A(iLocal_63[iLocal_71], 1);
			unk_0x71B502FC2E129665(iLocal_63[iLocal_71], 2);
			unk_0xBC12D08EE7559CCD(iLocal_63[iLocal_71], 50, 1);
			unk_0x3DAB02AAC9E9EC02(iLocal_63[iLocal_71], 0);
			unk_0x348A212511C78DBF(iLocal_63[iLocal_71], 13);
			unk_0xFF4BEB6CFF55A013(iLocal_63[iLocal_71], iLocal_69);
			iLocal_72 = unk_0x5853B15F78E1A265(0, 3);
			if (iLocal_72 == 0)
			{
				unk_0x9521FB98DB6DDF50(iLocal_63[iLocal_71], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
			}
			else if (iLocal_72 == 1)
			{
				unk_0x9521FB98DB6DDF50(iLocal_63[iLocal_71], joaat("weapon_microsmg"), -1, 1, 1);
			}
			else
			{
				unk_0x9521FB98DB6DDF50(iLocal_63[iLocal_71], joaat("weapon_assaultrifle"), -1, 1, 1);
			}
			unk_0xD6A76BAB45A4B460(iLocal_63[iLocal_71], 42, 1);
			func_91(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
			iLocal_71++;
		}
		if (!unk_0xF68107C40359970C(iLocal_63[0]))
		...
		unk_0xD8B630F464FE1D6D(iLocal_63[0], "piDrugCult[0]");
		if (!unk_0xF68107C40359970C(iLocal_63[1]))
		{
			unk_0xA888F8CC04F25CC8(&uLocal_70);
			unk_0x7D1424753688EE7A(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
		...
		unk_0xD8B630F464FE1D6D(iLocal_63[1], "piDrugCult[1]");
		if (!unk_0xF68107C40359970C(iLocal_63[2]))
		{
			unk_0xA888F8CC04F25CC8(&uLocal_70);
		...
		unk_0xD8B630F464FE1D6D(iLocal_63[2], "piDrugCult[2]");
		if (!unk_0xF68107C40359970C(iLocal_63[3]) && !unk_0xF68107C40359970C(iLocal_63[4]))
		{
			unk_0xA888F8CC04F25CC8(&uLocal_70);
			unk_0xC149E50FBB27DD70(0, iLocal_63[4], -1, 2f, 1f, 1073741824, 0);
		...
		unk_0xD8B630F464FE1D6D(iLocal_63[3], "piDrugCult[3]");
		if (!unk_0xF68107C40359970C(iLocal_63[4]))
		{
			unk_0xA888F8CC04F25CC8(&uLocal_70);
			unk_0xC149E50FBB27DD70(0, iLocal_63[3], -1, 2f, 1f, 1073741824, 0);
		...
		unk_0xD8B630F464FE1D6D(iLocal_63[4], "piDrugCult[4]");
		unk_0x274A180D57A0D9A6(iLocal_63[5], 0f, 3f, 1);
		unk_0xD8B630F464FE1D6D(iLocal_63[5], "piDrugCult[5]");
		uLocal_66 = func_97(Local_47, 0);
		unk_0x1A5B5BA56167D412(uLocal_66, 140);
...
int func_98()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_109())
		{
			return 0;
		}
	}
...
int func_115(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_136(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
