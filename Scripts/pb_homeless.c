	...
	if (timerb() > 10000)
	{
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_47, 10f, 10f, 10f, 0, 1, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			...
			if (!unk_0x55B23FE400FCEA6B(iLocal_50, 0))
			{
				...
				else if (!unk_0x55B23FE400FCEA6B(uLocal_51, 0))
				{
					unk_0x529D306014D3C29A(iLocal_50, iLocal_51, 0);
					if (iLocal_46 == 0)
					{
					}
					unk_0xD86A0BC9CC0A625A(iLocal_51, 1193033728, 0);
					iLocal_44 = 0;
				}
			}
		}
...
int func_3(var uParam0, struct<3> Param1, float fParam2, float fParam3, bool bParam4)
{
	...
	{
		if ((((unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(uParam0, Param1), Var1, 0, 1, 0) && unk_0xC9CD8C710046A3DD(unk_0xE2D3D51028F0428A(), unk_0x6B62510F212526DC(uParam0, 1), fParam2)) && func_5(bParam4)) && !unk_0x32DCDA1B2F8A0694(uParam0)) && !unk_0x03454821A9ECF4AA(uParam0))
		{
			func_4(uParam0, 1);
			return 1;
		}
...
void func_7()
{
	if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_47, 50f, 50f, 50f, 0, 1, 0))
	{
		...
		unk_0xD642E010A287ADFD("homeless", &uLocal_49);
		Local_48.f_2 = (Local_47.f_2 - 1f);
		iLocal_50 = unk_0xA8D58C3AADA2C41C(19, joaat("a_m_o_tramp_01"), Local_47.x, Local_47.f_1, Local_48.f_2, 0f, 1, 1);
		unk_0xFF4BEB6CFF55A013(iLocal_50, uLocal_49);
		if (iLocal_44 == 1)
		{
			Local_48 = { unk_0xCACAD935C0BEE14F(iLocal_50, 0.8f, 0.8f, -1f) };
			iLocal_51 = unk_0xA8D58C3AADA2C41C(5, joaat("g_m_y_strpunk_01"), Local_48, 0f, 1, 1);
			unk_0xD642E010A287ADFD("homeless", &uLocal_49);
			unk_0xFF4BEB6CFF55A013(iLocal_51, uLocal_49);
			if (!unk_0x55B23FE400FCEA6B(iLocal_50, 0))
			{
				unk_0xA888F8CC04F25CC8(&uLocal_53);
			...
			if (!unk_0x55B23FE400FCEA6B(iLocal_51, 0))
			{
				...
				unk_0xC963A45B50851768(uLocal_53);
				unk_0x8ACADA903FCAA42F(iLocal_51, uLocal_53);
				unk_0x7461D7C5BA953BC7(&uLocal_53);
			}
		}
		iLocal_45 = 1;
