...
int func_184(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(unk_0xE2D3D51028F0428A()) && func_127(uParam0->f_28[0])) && (unk_0x320D1840B6DAA1CC() - uParam0->f_60) > iParam6) && func_190(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
			{
				uVar0 = 16;
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(uParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_190(unk_0xE2D3D51028F0428A(), Param4, 1);
					fVar1 = func_190(unk_0xE2D3D51028F0428A(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0xA8D58C3AADA2C41C(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
