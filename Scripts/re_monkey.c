...
void func_39(int iParam0)
{
	...
	iVar1 = 0;
	while (iVar1 < Global_112915.f_7688.f_650)
	{
		if (Global_112915.f_7688.f_199[iVar1 /*15*/] == iParam0)
		{
			iVar2 = iVar1;
			while (iVar2 <= (Global_112915.f_7688.f_650 - 2))
			{
				Global_112915.f_7688.f_199[iVar2 /*15*/] = { Global_112915.f_7688.f_199[iVar2 + 1 /*15*/] };
				iVar2++;
			}
...
void func_40(int iParam0)
{
	...
	iVar1 = 0;
	while (iVar1 < Global_112915.f_7688.f_198)
	{
		if (Global_112915.f_7688.f_137[iVar1 /*15*/] == iParam0)
		{
			func_41(Global_112915.f_7688.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
			while (iVar2 <= (Global_112915.f_7688.f_198 - 2))
			{
				Global_112915.f_7688.f_137[iVar2 /*15*/] = { Global_112915.f_7688.f_137[iVar2 + 1 /*15*/] };
				iVar2++;
			}
...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_58[iVar1] = unk_0x0E536D72AB30F4C8(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
				unk_0xA539EDE8DA5BBC22(uLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0x8CE3D365F064F69E(uLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				uLocal_58[iVar1] = unk_0x0E536D72AB30F4C8(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
				unk_0xA539EDE8DA5BBC22(uLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0x8CE3D365F064F69E(uLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				uLocal_58[iVar1] = unk_0x0E536D72AB30F4C8(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
				unk_0xA539EDE8DA5BBC22(uLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0x8CE3D365F064F69E(uLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0xE63474311C6E3825(iLocal_48, 1))
			{
				func_150();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (unk_0x337B1E5A3D6DEDFA(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0x320D1840B6DAA1CC() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0x320D1840B6DAA1CC())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_48 = unk_0xA8D58C3AADA2C41C(26, joaat("u_m_m_streetart_01"), Local_49, fLocal_50, 1, 1);
			unk_0xF1A23B343DFEDFD0(joaat("u_m_m_streetart_01"));
			uLocal_58[0] = unk_0x0E536D72AB30F4C8(joaat("prop_cs_spray_can"), Local_59, 1, 1, 0);
			unk_0x9A97DC6DBC7B223D(uLocal_58[0], iLocal_48, unk_0xB897FCFCFA664B38(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1);
			unk_0xABC2CA6F28903308(iLocal_48, 1);
			unk_0xD6A76BAB45A4B460(iLocal_48, 42, 1);
			uLocal_53 = func_68(iLocal_48, 0, 145);
			func_58(1);
			unk_0xFF4BEB6CFF55A013(iLocal_48, 1862763509);
			unk_0x9D4D63EB83A103AD(iLocal_48, 2.5f);
		}
	}
	return 0;
}
...
{
	func_72();
	if (!unk_0xC92F9F18E020B461() && iLocal_51 < 3)
	{
		func_150();
	}
}
...
void func_72()
{
	...
	if (func_50(iLocal_48))
	{
		...
		Var2 = { unk_0x6B62510F212526DC(iLocal_48, 0) };
		fVar4 = 7.5f;
		Var5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			Var3 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0) };
			bVar6 = unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0);
			bVar7 = unk_0x0F92AFFDE5783870(unk_0xE2D3D51028F0428A());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x9AC74C7EF847A074(Var2, fVar4, 0) || unk_0x863026E0C5C2E52B(Var2 - Var5, Var2 + Var5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x8FB472886552D737(sLocal_62);
				if (unk_0x6F940C2636C076AD(sLocal_62))
				{
					unk_0x50274A7EACA3133A(iLocal_48, 1);
					unk_0x49D97B076E3590AC(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_82(unk_0xE2D3D51028F0428A(), iLocal_48, 35f))
				{
					unk_0xA888F8CC04F25CC8(&uLocal_68);
					unk_0x49D97B076E3590AC(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x49D97B076E3590AC(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0xC963A45B50851768(uLocal_68);
					unk_0x8ACADA903FCAA42F(iLocal_48, uLocal_68);
					unk_0x7461D7C5BA953BC7(&uLocal_68);
					unk_0xAFC1FBF3F6AE7B9A(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(unk_0xE2D3D51028F0428A(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0xDC6110E0F8FF9DA0(iLocal_48, 8, 1);
				unk_0xDC6110E0F8FF9DA0(iLocal_48, 32, 1);
				unk_0xA888F8CC04F25CC8(&uLocal_68);
			...
			case 5:
				...
				if (!unk_0xBC7D3EDF3455BC35(iLocal_48) && vdist2(Var2, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0)) > 2500f)
				{
					uLocal_67 = unk_0x1E4C19DC2AD86A18(Var3, Var2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0xB2D581BD7446BBE9(uLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0xE5965CDF24F93A9F(iLocal_48))
	{
...
int func_73()
{
	...
	{
		case 0:
			if (unk_0xFCF559C8631ABED7(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				Local_57 = { Var0 };
			...
			else if (unk_0xFCF559C8631ABED7(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0xD01FAFCE275C94F3(iLocal_48, sLocal_62, sLocal_64);
				fLocal_54 = func_77(fLocal_54, 0.2f, 0.349f);
				if (fLocal_54 != 0.2f)
				{
					fVar2 = ((1f / (0.349f - 0.161f)) * to_float(900));
					iLocal_55 = round(((fLocal_54 - 0.161f) * fVar2));
					Local_57 = { unk_0x6B62510F212526DC(iLocal_48, 0) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x49D97B076E3590AC(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0x320D1840B6DAA1CC();
			func_76(&uLocal_53);
			func_75();
			if (unk_0xE5965CDF24F93A9F(uLocal_58[0]))
			{
				unk_0xE6451C2F193342C7(uLocal_58[0], 1, 1);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0xFCF559C8631ABED7(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0x320D1840B6DAA1CC() - iLocal_69);
				fVar4 = (to_float(iVar3) / to_float(iLocal_55));
				fVar5 = (fLocal_54 - ((fLocal_54 - 0.161f) * fVar4));
				fVar5 = func_77(fVar5, 0.161f, fLocal_54);
				unk_0x12FFBBB6191DB79F(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_77(fVar6, 0f, 0.8f);
				Var7 = { func_74(Local_57, Var1, fVar6) };
				unk_0xC64B6E13A6A7F517(iLocal_48, Var7, 0, 1, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0x5C65DDDC219B3AA5(iLocal_48, 0);
					return 1;
...
void func_75()
{
	if (iLocal_60 != 0)
	{
		unk_0x0F53BC871BA89C94(iLocal_60, 0);
		iLocal_60 = 0;
	}
}
...
void func_78()
{
	...
	if (unk_0xFCF559C8631ABED7(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0xD01FAFCE275C94F3(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_75();
		}
	...
	else if (unk_0xFCF559C8631ABED7(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0xD01FAFCE275C94F3(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_75();
		}
...
void func_79()
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0x2D649DA6DC187D35(sLocal_61, uLocal_58[0], Local_66, Local_66, 1065353216, 0, 0, 0);
		unk_0x9CCA66A85447D77C(iLocal_60, 1f, 1f, 1f, 0);
		unk_0x8364B4D1FE5492BD(iLocal_60, 0.2f);
	}
}
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xE5965CDF24F93A9F(uParam0) && unk_0xE5965CDF24F93A9F(uParam1))
	{
		...
		return vdist2(unk_0x6B62510F212526DC(iParam0, 0), unk_0x6B62510F212526DC(iParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_83(int iParam0)
{
	...
	{
		func_76(&uLocal_53);
		unk_0x7734082B0EDB0BE0(iLocal_48, unk_0xE2D3D51028F0428A(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_133(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
