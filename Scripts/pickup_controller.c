...
void func_3(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_29[iParam0] = unk_0x1EE09F99FEF19DAF(iParam1, func_4(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_27[iParam0] = unk_0x1EE09F99FEF19DAF(iParam1, func_8(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4)
{
	...
	uLocal_24[iParam0] = unk_0x1EE09F99FEF19DAF(iParam1, func_12(iParam0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_24[iParam0], 600000);
}
	...
	switch (Global_31749)
	{
		...
		case 1:
			switch (Global_31750)
			{
				...
				case 1:
					if (unk_0x2791155FB0769FE5(uLocal_22[Global_31751]) && unk_0x5F0E7DE3BFA7690C(uLocal_22[Global_31751]))
					{
						Global_31752 = 0;
					}
					else
				...
				case 2:
					if (unk_0x2791155FB0769FE5(uLocal_23[Global_31751]) && unk_0x5F0E7DE3BFA7690C(uLocal_23[Global_31751]))
					{
						Global_31752 = 0;
					}
					else
...
void func_16()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0x2791155FB0769FE5(uLocal_29[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()
{
	...
	while (iVar0 < 1)
	{
		if (unk_0x2791155FB0769FE5(uLocal_27[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()
{
	...
	while (iVar0 < 9)
	{
		if (unk_0x2791155FB0769FE5(uLocal_24[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()
{
	...
	while (iVar0 < 102)
	{
		if (unk_0x2791155FB0769FE5(uLocal_23[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_23[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()
{
	...
	while (iVar0 < 76)
	{
		if (unk_0x2791155FB0769FE5(uLocal_22[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_22[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 19)
	{
		if (unk_0x2791155FB0769FE5(uLocal_21[iVar0]))
		{
			unk_0x451F33099166532A(uLocal_21[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, struct<3> Param2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	uLocal_23[iParam0] = unk_0x1EE09F99FEF19DAF(iParam1, func_28(iParam0, 0), Param2, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0x28692DF126DAC03E(uLocal_23[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, struct<3> Param1, bool bParam2, bool bParam3)
{
	...
	uLocal_22[iParam0] = unk_0x1EE09F99FEF19DAF(joaat("pickup_health_standard"), func_32(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0x28692DF126DAC03E(uLocal_22[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	uLocal_21[iParam0] = unk_0x1EE09F99FEF19DAF(joaat("pickup_weapon_petrolcan"), func_35(iParam0), Param1, iVar0, -1, 2, 1, 0);
	unk_0x69DF462E3146F76E(uLocal_21[iParam0], 600000);
}
