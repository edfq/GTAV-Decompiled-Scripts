...
void func_279(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	func_280(uParam0, sParam3, iParam4, iParam5, iParam6);
	uParam0->f_9 = { Param1 };
	uParam0->f_12 = { Param2 };
	uParam0->f_7 = iParam7;
}
