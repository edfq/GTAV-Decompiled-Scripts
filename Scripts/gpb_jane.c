...
void func_9()
{
	...
	{
		unk_0xABFC84F5C4943D7B(uLocal_208, sLocal_277, 1048576000);
	}
}
...
void func_104()
{
	...
	while (!unk_0x6F940C2636C076AD(sLocal_277))
	{
		wait(0);
	}
	iLocal_278 = 1;
...
void func_118()
{
	if (iLocal_278 == 1)
	{
		if (unk_0x6F940C2636C076AD(sLocal_277))
		{
			unk_0xAFC1FBF3F6AE7B9A(sLocal_277);
		}
	}
}
