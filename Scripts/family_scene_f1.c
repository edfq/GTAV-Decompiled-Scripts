...
void func_36(var uParam0, var uParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam5)
{
	...
	else if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		*uParam2 = unk_0x6D7EE245AD1E10B0(unk_0xE2D3D51028F0428A());
		if (!unk_0xACC32B78196FBC2A(sParam5))
		{
			...
			{
				*uParam3 = unk_0x63AC7EFB770FCB6F(Param4, sParam5);
			}
		}
		func_38(uParam1);
		*uParam0 = 0;
	...
	if (unk_0xBCC73B466E2B2350(*uParam2) && unk_0xEA02B859DE237081(*uParam2))
	{
		...
		else if (!unk_0xACC32B78196FBC2A(sParam5))
		{
...
int func_45(int iParam0, struct<3> Param1, float fParam2)
{
	...
	if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Param1, 1) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_100024)
...
void func_51()
{
	...
	func_52(&uLocal_121, 0, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
}
...
void func_65(int iParam0)
{
	...
	while (iVar1 < Global_112915.f_7688.f_198)
	{
		...
		{
			func_66(Global_112915.f_7688.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_78()
{
	...
	while (iVar6 < 11)
	{
		...
		{
			uVar7 = unk_0x87A467676BDF8C35(Var1, 10f, iVar0, 0, 0, 1);
			if (unk_0xE5965CDF24F93A9F(uVar7))
			{
				if (iVar3 == 825812850)
				{
					unk_0x8CE3D365F064F69E(iVar7, 0f, 0f, 21f, 2, 1);
				}
				unk_0x59E393B344098656(&iVar7);
			}
		}
		if (iVar2 != 226)
		{
		}
		else if (!unk_0xEC32121F2E3875C8(iVar3))
		{
		}
		else
		{
			unk_0x7E15597AA5F53F9A(iVar3, 3, 1, 1);
			unk_0x1B3E1454BD86FCE6(iVar3, 0f, 1, 1);
			if (((iVar6 != 6 && iVar6 != 7) && iVar6 != 8) && iVar6 != 9)
			{
				unk_0xA5BD780899E2D5F0(iVar3, 0);
			}
		}
		iVar6++;
	}
