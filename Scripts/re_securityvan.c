...
void __EntryFunction__()
{
	...
	else
	{
		if (unk_0x4B34601C5C56F3EE(11))
		{
			...
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
				{
					if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
					{
						if (!unk_0xF6F5D18EF8EAB859(iLocal_49[iVar0], iLocal_50, 0))
						{
							unk_0xB486640392EC50BB(iLocal_49[iVar0], iLocal_50, -1, func_248(iLocal_50), 1073741824, 1, 0);
						}
					}
					else
					{
						unk_0x83F5BCFFFBA26699(iLocal_49[iVar0], 10000);
					}
				}
				iVar0++;
			}
	...
	func_187();
	uLocal_59 = unk_0x2915D98110F23A29(Local_63 + Vector(30f, 30f, 30f), Local_63 - Vector(30f, 30f, 30f), 0, 1, 1, 1);
	while (true)
	{
		wait(0);
		func_184(&uLocal_123);
		if (!func_183())
		{
			...
			switch (iLocal_298)
			{
				case 0:
					if (unk_0xC92F9F18E020B461() && !func_170())
					{
						if (func_161())
						{
							if ((iLocal_44 == 3 && !(unk_0x0318E2EE6FB4563F(Local_63, 3f) && func_160(unk_0xE2D3D51028F0428A(), Local_63, 1) < 150f)) || iLocal_44 != 3)
							{
								if (iLocal_44 == 3)
								{
									if (!unk_0x0318E2EE6FB4563F(Local_63, 8f))
									{
										unk_0x7A997A0A971D305F(Local_63, 4f, 1, 0, 0, 0);
									}
									iLocal_46 = 4;
									bLocal_79 = true;
								}
								...
								func_159();
								if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && iLocal_44 == 3)
								{
									unk_0xB2D5451CC5606248(iLocal_50, 5f);
								}
								settimera(0);
								iLocal_298++;
							}
				...
				case 1:
					if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && unk_0x55A0C756C4A8220C(iLocal_50, 0))
					{
						if (((vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) < 10000f || !unk_0x4D21C9FB671ED18F(iLocal_50)) || (!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0x4D21C9FB671ED18F(iLocal_49[0]))) || (!unk_0xF68107C40359970C(iLocal_49[1]) && !unk_0x4D21C9FB671ED18F(iLocal_49[1])))
						{
							iLocal_298++;
						}
					}
				...
				case 2:
					...
					if (unk_0xE5965CDF24F93A9F(iLocal_50) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
					{
						if (iLocal_44 == 3)
						{
							func_148();
							if (!unk_0x4D21C9FB671ED18F(iLocal_50) && (vdist(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < 100f || func_158()))
							{
								func_139(1);
							}
						}
						else if (((!unk_0x4D21C9FB671ED18F(iLocal_50) && iLocal_46 == 4) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_70, Local_71, fLocal_72, 0, 1, 0)) || func_158())
						{
							func_139(1);
						}
						if ((iLocal_46 == 4 && unk_0x4D21C9FB671ED18F(iLocal_50)) && iLocal_44 != 3)
						{
							if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) > 100f)
							{
								func_231();
							}
							else
			...
			if (iLocal_298 > 0)
			{
				if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0x4D21C9FB671ED18F(iLocal_50))
				{
					if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) > 62500f)
					{
						func_231();
					}
					if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) > 10000f && !unk_0xC92F9F18E020B461())
					{
						func_231();
					}
				}
		...
		else
		{
			...
			if (!unk_0x12DD4A0B247D9B4D(uLocal_57))
			{
				...
				if (unk_0xE5965CDF24F93A9F(iLocal_52))
				{
					if (iLocal_299 != 0)
					{
						if (vdist2(unk_0x6B62510F212526DC(iLocal_52, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < pow(50f, 2f))
						{
							iLocal_299 = 0;
				...
				else if (((bLocal_79 && !unk_0x2791155FB0769FE5(uLocal_103)) && unk_0x55A0C756C4A8220C(iLocal_50, 0)) && !bLocal_89)
				{
					if (iLocal_299 != 1)
					{
						if (vdist2(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < pow(50f, 2f))
						{
							iLocal_299 = 1;
							func_135(&uLocal_111, 0, 0);
						}
				...
				else if (unk_0x2791155FB0769FE5(uLocal_103))
				{
					if (iLocal_299 != 2)
					{
						if (vdist2(unk_0x70453F7DF40780A5(uLocal_103), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < pow(50f, 2f))
						{
							iLocal_299 = 2;
							func_135(&uLocal_111, 0, 0);
						}
				...
				{
					if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_50, 1))
					{
				...
				{
					if (unk_0x2791155FB0769FE5(uLocal_103))
					{
						func_105(&uLocal_111, unk_0x70453F7DF40780A5(uLocal_103), 0, 0, 1, 1, 1);
						if (vdist2(unk_0x70453F7DF40780A5(uLocal_103), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > pow(50f, 2f))
						{
							iLocal_299 = -1;
							func_135(&uLocal_111, 0, 0);
				...
				if (((!unk_0x55B23FE400FCEA6B(iLocal_50, 0) && bLocal_79) && !bLocal_81) && (!func_138(0) || (unk_0x8FEA2E94638F9767(unk_0xE2D3D51028F0428A(), joaat("weapon_stickybomb"), 0) && !func_138(1))))
				{
					switch (iLocal_100)
					{
						case 0:
							if (!unk_0xF847447D4467709D() && vdist2(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < 225f)
							{
						...
						case 2:
							if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 2000 && unk_0x8FEA2E94638F9767(unk_0xE2D3D51028F0428A(), joaat("weapon_stickybomb"), 0))
							{
			...
			switch (iLocal_46)
			{
				...
				case 7:
					if (!unk_0xF68107C40359970C(iLocal_49[0]))
					{
						if (unk_0x44C2858965E93D87(iLocal_49[0]) != 3)
						{
							unk_0x0AEBDB297E8270B8(iLocal_49[0], 3);
						}
					}
					if (!unk_0xF68107C40359970C(iLocal_49[1]))
					{
						if (unk_0x44C2858965E93D87(iLocal_49[1]) != 3)
						{
							unk_0x0AEBDB297E8270B8(iLocal_49[1], 3);
						}
					}
					if (((!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0x55B23FE400FCEA6B(iLocal_49[0], 0)) && !unk_0xF68107C40359970C(iLocal_49[1])) && !unk_0x55B23FE400FCEA6B(iLocal_49[1], 0))
					{
						iLocal_95 = 1;
						func_79(iLocal_49[1]);
						func_77(0, 1);
					...
					{
						if (unk_0xF68107C40359970C(iLocal_49[1]) || unk_0x55B23FE400FCEA6B(iLocal_49[1], 0))
						{
							iLocal_48 = 0;
							iLocal_95 = 0;
						}
					...
					{
						if (unk_0xF68107C40359970C(iLocal_49[0]) || unk_0x55B23FE400FCEA6B(iLocal_49[0], 0))
						{
							iLocal_95 = -1;
						}
						else
			...
			if ((((unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0) == unk_0xE2D3D51028F0428A()) && !bLocal_83) && iLocal_46 != 8)
			{
				if (bLocal_79)
				{
					func_68(8);
			...
			if (bLocal_80)
			{
				if (unk_0x76932AF783B85B6A(iLocal_60, 1862763509) != 5)
				{
					unk_0x9972EFADA7A2A47D(5, iLocal_60, 1862763509);
					unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_60);
				}
			}
			if (bLocal_81)
			{
				if ((unk_0x2791155FB0769FE5(uLocal_103) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x70453F7DF40780A5(uLocal_103)) > 250f)
				{
					func_68(9);
				}
			}
			...
			else
			{
				iVar1 = 1;
				iVar2 = 0;
				if (unk_0xE5965CDF24F93A9F(iLocal_49[iVar2]))
				{
					if ((!unk_0x55B23FE400FCEA6B(iLocal_49[iVar2], 0) && !unk_0xF68107C40359970C(iLocal_49[iVar2])) && vdist2(unk_0x6B62510F212526DC(iLocal_49[0], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < 10000f)
					{
						iVar1 = 0;
					}
				}
				if (unk_0xE5965CDF24F93A9F(iLocal_50))
				{
					if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
					{
						if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_50, 0))
						{
							iVar3 = 1;
						}
					}
					if ((vdist2(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 10000f && unk_0x4D21C9FB671ED18F(iLocal_50)) || vdist2(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 62500f)
					{
						iVar3 = 1;
					}
				}
		...
		if (bLocal_77)
		{
			if (!bLocal_78)
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_93) > 5000)
				{
		...
		if (((unk_0x320D1840B6DAA1CC() - iLocal_93) > 10000 && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) > 0) && !iLocal_92)
		{
		...
		if (bLocal_78)
		{
			if ((!unk_0xF68107C40359970C(iLocal_49[0]) || !unk_0xF68107C40359970C(iLocal_49[1])) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(func_3(), 1)) < pow(50f, 2f))
				{
		...
		if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			if (unk_0x7DF569D9E616D55E(iLocal_50, 0) > 0f || unk_0x7DF569D9E616D55E(iLocal_50, 1) > 0f)
			{
				if (unk_0xA09765D2ADE13CAE(iLocal_50) == 3)
				{
					unk_0x3B2646B62E7BBE11(iLocal_50, 1);
				}
			}
			if (!bLocal_82)
			{
			...
			if (!bLocal_82)
			{
				if (unk_0x7DF569D9E616D55E(iLocal_50, 0) == 0f && unk_0x7DF569D9E616D55E(iLocal_50, 1) == 0f)
				{
					if (unk_0xA09765D2ADE13CAE(iLocal_50) == 1)
					{
						unk_0x3B2646B62E7BBE11(iLocal_50, 3);
					}
				}
			}
		}
		if (iLocal_97 != 0)
		{
			...
			{
				unk_0x527AAB28DB255A95(iLocal_97);
			}
		}
		if (unk_0xE5965CDF24F93A9F(iLocal_52))
		{
			...
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iVar5]) && !unk_0x55B23FE400FCEA6B(iLocal_49[iVar5], 0))
				{
					if (unk_0x099CAD293190F449(iLocal_52, iLocal_49[iVar5]))
					{
						if (iLocal_46 == 1)
						{
							if (!iLocal_300[iVar5])
							{
								unk_0x1506C7782F807090(iLocal_49[iVar5], 0, "random@security_van", "sec_idle", 1090519040, 1);
								unk_0x1506C7782F807090(iLocal_49[iVar5], 1, "random@security_van", "sec_walk_calm", 1090519040, 1);
								iLocal_300[iVar5] = 1;
							}
						}
						if (iLocal_46 == 7)
						{
							...
							{
								unk_0x1506C7782F807090(iLocal_49[iVar5], 0, "random@security_van", "sec_idle", 1090519040, 1);
								unk_0x1506C7782F807090(iLocal_49[iVar5], 1, "random@security_van", "sec_walk_panic", 1090519040, 1);
								iLocal_301[iVar5] = 1;
							}
						}
						if (unk_0x5007A91D57C39FFC(iLocal_49[iVar5], 4) && !iLocal_85)
						{
							unk_0x4F1E6A84BC157FA0(iLocal_49[iVar5], 1);
							iLocal_85 = 1;
						}
					}
					else
					{
						if (iLocal_300[iVar5])
						{
							unk_0xD14025FD10232A78(iLocal_49[iVar5], 0, -1056964608);
							unk_0xD14025FD10232A78(iLocal_49[iVar5], 1, -1056964608);
							iLocal_300[iVar5] = 0;
						}
						if (iLocal_301[iVar5])
						{
		...
		else
		{
			...
			while (iVar5 < iLocal_49)
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iVar5]))
				{
					if (iLocal_300[iVar5] || iLocal_301[iVar5])
					{
						iLocal_300[iVar5] = 0;
		...
		{
			if (((((unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0xE85F749F6D5C809E(iLocal_52)) && !unk_0xF68107C40359970C(iLocal_49[iLocal_96])) && !unk_0xFCF559C8631ABED7(iLocal_49[iLocal_96], "random@security_van", "sec_hand_override", 3)) && !unk_0xFCF559C8631ABED7(iLocal_49[iLocal_96], "random@security_van", "sec_case_into_van_panic", 3)) && !unk_0xFCF559C8631ABED7(iLocal_49[iLocal_96], "random@security_van", "sec_case_into_van_calm", 3))
			{
				unk_0x49D97B076E3590AC(iLocal_49[iLocal_96], "random@security_van", "sec_hand_override", 1000f, -4f, -1, 49, 0, 0, 0, 0);
			}
		}
		if (!iLocal_86)
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_50))
			{
				...
				unk_0xE68645525D451A8B(iLocal_50);
			}
		}
	}
}
...
int func_2()
{
	...
	fVar0 = 50f;
	if (((!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && (((unk_0x55A0C756C4A8220C(iLocal_50, 0) && bLocal_84) && unk_0x2791155FB0769FE5(uLocal_103)) || (!unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0x2791155FB0769FE5(uLocal_103)))) && vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) < 20f) && vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x70453F7DF40780A5(uLocal_103)) < 20f)
	{
...
var func_3()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (!unk_0xF68107C40359970C(iLocal_49[0]))
		{
			fVar0 = vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[0], 1));
			iVar1 = 0;
		}
		if (!unk_0xF68107C40359970C(iLocal_49[1]))
		{
			if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[1], 1)) < fVar0)
			{
				fVar0 = vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[1], 1));
				iVar1 = 1;
			}
		}
	}
...
float func_27()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (!unk_0xF68107C40359970C(iLocal_49[0]))
		{
			fVar0 = vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[0], 1));
		}
		if (!unk_0xF68107C40359970C(iLocal_49[1]))
		{
			if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[1], 1)) < fVar0)
			{
				fVar0 = vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[1], 1));
			}
		}
	}
	return sqrt(fVar0);
...
int func_28()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_49[iVar1]))
			{
				if (((!unk_0xF68107C40359970C(iLocal_49[iVar1]) && unk_0x0747E45CFF1F74AA(iLocal_49[iVar1], unk_0xE2D3D51028F0428A(), 1)) || unk_0xF68107C40359970C(iLocal_49[iVar1])) || unk_0x55B23FE400FCEA6B(iLocal_49[iVar1], 0))
				{
					iVar0 = 1;
				}
			}
		...
		if ((!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF68107C40359970C(iLocal_49[1])) && iLocal_86)
		{
			iVar0 = 1;
		}
	}
...
void func_29()
{
	if (!bLocal_89)
	{
		if (!bLocal_79)
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_52))
			{
				if (!unk_0xE85F749F6D5C809E(iLocal_52))
				{
					unk_0x4BDA5AFD88C085EB(&iLocal_52);
					if (!unk_0x2791155FB0769FE5(uLocal_103) && !bLocal_81)
					{
						func_30(0f, 0f, 0f, 0);
					}
				}
				else if ((unk_0x320D1840B6DAA1CC() - iLocal_102) > 3000)
				{
					if (unk_0xF68107C40359970C(iLocal_49[iLocal_96]) || unk_0x32DCDA1B2F8A0694(iLocal_49[iLocal_96]))
					{
						unk_0xE6451C2F193342C7(iLocal_52, 1, 1);
			...
			{
				if (unk_0xF68107C40359970C(iLocal_49[iLocal_96]) || ((!unk_0xF68107C40359970C(iLocal_49[iLocal_96]) && unk_0x32DCDA1B2F8A0694(iLocal_49[iLocal_96])) && !bLocal_81))
				{
					func_30(0f, 0f, 0f, 0);
				}
			}
	...
	else
	{
		...
		if (unk_0x2791155FB0769FE5(uLocal_103))
		{
			unk_0x451F33099166532A(uLocal_103);
		}
	}
}
...
void func_30(struct<3> Param0, bool bParam1)
{
	if (!bLocal_89 && !bLocal_81)
	{
		if (!bParam1)
		{
			if (bLocal_79)
			{
				Param0 = { unk_0x7F65C587E17DEF5D(unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -3.3f, 0f), 1067030938, 1069547520) };
			}
			else
			{
				Param0 = { unk_0x7F65C587E17DEF5D(unk_0x6B62510F212526DC(iLocal_49[iLocal_96], 0), 1067030938, 1069547520) };
			}
		}
		unk_0xCED9E32812D6C7C7(&uLocal_104, 3);
		unk_0xCED9E32812D6C7C7(&uLocal_104, 4);
		unk_0xCED9E32812D6C7C7(&uLocal_104, 1);
		if (bParam1)
		{
			uLocal_103 = unk_0x1EE09F99FEF19DAF(joaat("pickup_money_security_case"), Param0, unk_0x63A8BF5E6C2BF85C(iLocal_52, 2), 0, uLocal_94, 2, 1, 0);
		}
		else
		{
			uLocal_103 = unk_0x1CD347D2BD906560(joaat("pickup_money_security_case"), Param0, uLocal_104, uLocal_94, 1, 0);
		}
...
void func_34()
{
	if (func_36())
	{
		...
		{
			unk_0x2476BE9932670CAD(iLocal_50, 2, 0, 0);
			unk_0x2476BE9932670CAD(iLocal_50, 3, 0, 0);
			if (unk_0xE5965CDF24F93A9F(iLocal_53))
			{
				unk_0x4BDA5AFD88C085EB(&iLocal_53);
			}
		}
	}
	switch (iLocal_47)
	{
		...
		case 1:
			if (unk_0x7DF569D9E616D55E(iLocal_50, 2) == 0f && unk_0x7DF569D9E616D55E(iLocal_50, 3) == 0f)
			{
				if (unk_0xE5965CDF24F93A9F(iLocal_52))
				{
					if (unk_0xE85F749F6D5C809E(iLocal_52))
					...
					unk_0x9A97DC6DBC7B223D(iLocal_52, iLocal_50, 0, Local_65, Local_66, 0, 0, 0, 0, 2, 1);
					iLocal_47 = 2;
				}
			}
			break;
		...
		case 2:
			if (!bLocal_81 && !bLocal_89)
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_50, 0))
				{
					if (((unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0x7DF569D9E616D55E(iLocal_50, 2) > 0.25f) && unk_0x7DF569D9E616D55E(iLocal_50, 3) > 0.25f) || !unk_0x55A0C756C4A8220C(iLocal_50, 0))
					{
						if (unk_0xE5965CDF24F93A9F(iLocal_52))
						{
							if (unk_0xE85F749F6D5C809E(iLocal_52))
							{
								unk_0xD336F8D9637B963F(unk_0xA9ADCC8D104AA552(), "DOORS_BLOWN", unk_0x96EDA732FD9DC0AF(iLocal_50, 13), "RE_SECURITY_VAN_SOUNDSET", 0, 0, 0);
								unk_0xE6451C2F193342C7(iLocal_52, 1, 0);
								unk_0x959E1626CBC7D38A(iLocal_52, 1, 0);
								unk_0xAA8C46C452582702(iLocal_52);
								unk_0xE987EFB3B3FAB187(iLocal_52, 1);
								Local_279 = { unk_0x6B62510F212526DC(iLocal_52, 1) - unk_0x6B62510F212526DC(iLocal_50, 1) * Vector(1.5f, 1.5f, 1.5f) };
								...
								unk_0x3F6DE6DBA9A99FEA(iLocal_52, 1, 0f, 1f, 5f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
								iLocal_278 = unk_0x320D1840B6DAA1CC();
							}
							else if (unk_0xD7500BC8646DAB0D(unk_0x6B62510F212526DC(iLocal_52, 1), unk_0xCACAD935C0BEE14F(iLocal_50, Local_276), unk_0xCACAD935C0BEE14F(iLocal_50, Local_277), 0) >= 1f)
							{
								iLocal_47 = 3;
								iLocal_91[0] = 0;
								iLocal_91[1] = 0;
							}
							else if ((unk_0x320D1840B6DAA1CC() - iLocal_278) > 5000)
							{
								func_30(0f, 0f, 0f, 0);
							}
						}
				...
				else if (unk_0xE5965CDF24F93A9F(iLocal_50))
				{
					unk_0x2476BE9932670CAD(iLocal_50, 2, 0, 0);
					unk_0x2476BE9932670CAD(iLocal_50, 3, 0, 0);
					func_30(unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 2f, 0f), 0);
				}
			}
			break;
		...
		case 3:
			...
			if (unk_0xE5965CDF24F93A9F(iLocal_52) && !unk_0x2791155FB0769FE5(uLocal_103))
			{
				if (unk_0x207D53F9E0190691(iLocal_52) == 0f && (unk_0x320D1840B6DAA1CC() - iLocal_278) > 1000)
				{
					func_30(unk_0x6B62510F212526DC(iLocal_52, 1), 1);
					unk_0x4BDA5AFD88C085EB(&iLocal_52);
				}
				else if ((unk_0x320D1840B6DAA1CC() - iLocal_278) > 5000)
				{
...
int func_36()
{
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_53) && unk_0xE85F749F6D5C809E(iLocal_53))
	{
		if (!iLocal_272)
		{
			if (unk_0xEDF30C9168B336D8(unk_0x6B62510F212526DC(iLocal_53, 1), joaat("weapon_stickybomb"), 0.25f, 0) || unk_0x574E2A23F0F76E35(unk_0x6B62510F212526DC(iLocal_53, 1), 0.3f, unk_0xB8DEE91181C30E65(joaat("weapon_stickybomb")), 0))
			{
				iLocal_272 = 1;
			}
		}
		iVar0 = 0;
		unk_0xB00FC865B64B72B8(unk_0x6B62510F212526DC(iLocal_53, 1), 0.1f, 255, 0, 0, 255);
		if (func_37(0f, 0f, 0f, 0f, 0f, 0f, unk_0x6B62510F212526DC(iLocal_53, 1), 1f, 1) || (unk_0x89D0E0233F6E59A7(2, unk_0x6B62510F212526DC(iLocal_53, 1), 0.3f) && iLocal_272))
		{
			iLocal_87 = 1;
			iVar0 = 1;
		}
		if (unk_0x0CF63873D754B965(iLocal_53) < iLocal_98 && unk_0x0747E45CFF1F74AA(iLocal_53, unk_0xE2D3D51028F0428A(), 0))
		{
			iLocal_99 = (iLocal_99 + (iLocal_98 - unk_0x0CF63873D754B965(iLocal_53)));
			unk_0xE68645525D451A8B(iLocal_53);
		}
		if ((unk_0x320D1840B6DAA1CC() - iLocal_273) > 200 && unk_0xE5965CDF24F93A9F(iLocal_50))
		{
			if (unk_0x42D790A6634DC8DC(unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 0f, (1.2195f - 0.27f)), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, fLocal_275, (1.2195f + 0.09f)), 0.45f, 1))
			{
		...
		iLocal_98 = unk_0x0CF63873D754B965(iLocal_53);
	}
	return 0;
}
...
int func_37(struct<3> Param0, struct<3> Param1, struct<3> Param2, int iParam3, bool bParam4)
{
	...
	else if ((((((((((((((((((((((unk_0x89D0E0233F6E59A7(5, Param2, iParam3) || (unk_0x89D0E0233F6E59A7(2, Param2, iParam3) && !bParam4)) || (unk_0x89D0E0233F6E59A7(20, Param2, iParam3) && !bParam4)) || unk_0x89D0E0233F6E59A7(4, Param2, iParam3)) || (unk_0x89D0E0233F6E59A7(28, Param2, iParam3) && !bParam4)) || unk_0x89D0E0233F6E59A7(32, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(25, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(9, Param2, iParam3)) || (unk_0x89D0E0233F6E59A7(3, Param2, iParam3) && !bParam4)) || (unk_0x89D0E0233F6E59A7(6, Param2, iParam3) && !bParam4)) || unk_0x89D0E0233F6E59A7(0, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(1, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(23, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(34, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(14, Param2, iParam3)) || (unk_0x89D0E0233F6E59A7(30, Param2, iParam3) && !bParam4)) || (unk_0x89D0E0233F6E59A7(12, Param2, iParam3) && !bParam4)) || unk_0x89D0E0233F6E59A7(7, Param2, iParam3)) || (unk_0x89D0E0233F6E59A7(21, Param2, iParam3) && !bParam4)) || (unk_0x89D0E0233F6E59A7(18, Param2, iParam3) && !bParam4)) || unk_0x89D0E0233F6E59A7(15, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(10, Param2, iParam3)) || unk_0x89D0E0233F6E59A7(27, Param2, iParam3))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_39()
{
	...
	if (!unk_0x12DD4A0B247D9B4D(uLocal_57))
	{
		if (!bLocal_80)
		{
			if ((!unk_0xF68107C40359970C(iLocal_49[1]) && unk_0x55A0C756C4A8220C(iLocal_50, 0)) && !bLocal_89)
			{
				if (!bLocal_79)
				{
					if (!unk_0x12DD4A0B247D9B4D(uLocal_56[1]))
					{
				...
				else
				{
					if (unk_0x12DD4A0B247D9B4D(uLocal_56[1]))
					{
						unk_0xFFD8EB5462B07B59(&(uLocal_56[1]));
					}
					if (!unk_0x12DD4A0B247D9B4D(uLocal_55))
					{
			...
			else
			{
				...
				if (unk_0x12DD4A0B247D9B4D(uLocal_55))
				{
					unk_0xFFD8EB5462B07B59(&uLocal_55);
				}
			}
		}
		else
		{
			if (unk_0x12DD4A0B247D9B4D(uLocal_56[0]) && unk_0xE8FCD9A6754A5FB2(uLocal_56[0]) != 119)
			{
				unk_0xFFD8EB5462B07B59(&(uLocal_56[0]));
			}
			if (unk_0x12DD4A0B247D9B4D(uLocal_56[1]) && unk_0xE8FCD9A6754A5FB2(uLocal_56[1]) != 119)
			{
				unk_0xFFD8EB5462B07B59(&(uLocal_56[1]));
			}
			if (unk_0x12DD4A0B247D9B4D(uLocal_55) && unk_0xE8FCD9A6754A5FB2(uLocal_55) != 119)
			{
				unk_0xFFD8EB5462B07B59(&uLocal_55);
			}
			if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
			...
			else if (unk_0x12DD4A0B247D9B4D(uLocal_55))
			{
				unk_0xFFD8EB5462B07B59(&uLocal_55);
			}
			if ((unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0x12DD4A0B247D9B4D(uLocal_55)) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_50, 0))
				{
					if (unk_0x6BABDF7A460158CE(uLocal_55) != 0)
					{
						unk_0xFBBD8F124403B0F5(uLocal_55, 0);
					}
				}
				else if (unk_0x6BABDF7A460158CE(uLocal_55) != 255)
				{
					unk_0xFBBD8F124403B0F5(uLocal_55, 255);
				}
			}
			iVar0 = 0;
			while (iVar0 < iLocal_49)
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iVar0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
				{
					if (!unk_0x2791155FB0769FE5(uLocal_103) && !unk_0xD5C6B5E3B93A5EDC(iLocal_49[iVar0], 0))
					{
						if (!unk_0x51B334B227EC8042(iLocal_49[iVar0]) || vdist(unk_0x6B62510F212526DC(iLocal_49[iVar0], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < 30f)
						{
							iVar2[iVar0] = 1;
						}
					}
					if (iLocal_46 == 8 && !unk_0xD5C6B5E3B93A5EDC(iLocal_49[iVar0], 0))
					{
						iVar2[iVar0] = 1;
					}
					if (iLocal_46 == 5)
				...
				if (iVar2[iVar0])
				{
					if (!unk_0x12DD4A0B247D9B4D(uLocal_56[iVar0]))
					{
						uLocal_56[iVar0] = func_42(iLocal_49[iVar0], 1, 145);
					}
				}
				else if (unk_0x12DD4A0B247D9B4D(uLocal_56[iVar0]))
				{
					unk_0xFFD8EB5462B07B59(&(uLocal_56[iVar0]));
				}
				iVar0++;
			}
			if (unk_0x2791155FB0769FE5(uLocal_103) && !bLocal_89)
			{
				if (!unk_0x12DD4A0B247D9B4D(uLocal_58))
				{
	...
	else if ((unk_0xE5965CDF24F93A9F(iLocal_50) && unk_0xE5965CDF24F93A9F(iLocal_49[0])) && unk_0xE5965CDF24F93A9F(iLocal_49[1]))
	{
		if ((((((!unk_0x4D21C9FB671ED18F(iLocal_50) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_50, 100f, 100f, 30f, 0, 1, 0)) || (!unk_0x4D21C9FB671ED18F(iLocal_49[0]) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[0], 100f, 100f, 30f, 0, 1, 0))) || (!unk_0x4D21C9FB671ED18F(iLocal_49[1]) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[1], 100f, 100f, 30f, 0, 1, 0))) || unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_50, 50f, 50f, 20f, 0, 1, 0)) || unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[0], 50f, 50f, 20f, 0, 1, 0)) || unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[1], 50f, 50f, 20f, 0, 1, 0))
		{
			unk_0xFFD8EB5462B07B59(&uLocal_57);
		}
	}
	if (unk_0x12DD4A0B247D9B4D(uLocal_56[0]))
	{
		unk_0x3430966AC4550BB9(uLocal_56[0], iLocal_90);
	}
	if (unk_0x12DD4A0B247D9B4D(uLocal_56[1]))
	{
		unk_0x3430966AC4550BB9(uLocal_56[1], iLocal_90);
	}
	if (unk_0x12DD4A0B247D9B4D(uLocal_55))
	{
		unk_0x3430966AC4550BB9(uLocal_55, iLocal_90);
	}
	if (unk_0x12DD4A0B247D9B4D(uLocal_58))
	{
		unk_0x3430966AC4550BB9(uLocal_58, iLocal_90);
	}
	if (!iLocal_90)
	{
...
void func_48()
{
	...
	{
		func_52(13, floor(Global_112915.f_10194.f_3853));
	}
...
int func_67()
{
	if (bLocal_81)
	{
		if (unk_0x803592456AE579B3(uLocal_103))
		{
			return 1;
		}
	}
...
int func_69()
{
	if (!unk_0x2791155FB0769FE5(uLocal_103))
	{
		...
		if (!bLocal_79)
		{
			if (iLocal_96 != -1)
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iLocal_96]))
				{
					if (!func_70(iLocal_50))
					{
						if (iLocal_271 == -1)
		...
		if (iLocal_271 != -1)
		{
			if ((unk_0x320D1840B6DAA1CC() - iLocal_271) > 3000)
			{
				unk_0xB3822DB3D538C8F3(&(iLocal_49[0]));
				unk_0xB3822DB3D538C8F3(&(iLocal_49[1]));
				unk_0xA5D8BA53953077C8(iLocal_50, -1000f, 1);
				unk_0x959E1626CBC7D38A(iLocal_50, 1, 0);
				unk_0x3D81769BEC61BFF8(&iLocal_50);
				return 1;
			}
		}
	}
	else
	{
		...
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && vdist(unk_0x70453F7DF40780A5(uLocal_103), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 300f)
		{
			return 1;
		}
	}
...
int func_70(int iParam0)
{
	...
	{
		if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1)) < 150f)
		{
			return 1;
		}
		else if (!unk_0x4D21C9FB671ED18F(iParam0) && vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1)) < 300f)
		{
			return 1;
		}
	}
...
void func_71()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		switch (iLocal_48)
		{
			case 0:
				bLocal_80 = true;
				if (!unk_0xF68107C40359970C(iLocal_49[0]) || !unk_0xF68107C40359970C(iLocal_49[1]))
				{
					if (func_27() < 30f && !unk_0xF68107C40359970C(Local_106[3 /*10*/]))
					{
				...
				while (iVar0 < iLocal_49)
				{
					if (!unk_0xF68107C40359970C(iLocal_49[iVar0]) && unk_0xE5965CDF24F93A9F(iLocal_52))
					{
						if ((iVar0 != iLocal_96 || bLocal_79) || !unk_0x099CAD293190F449(iLocal_52, iLocal_49[iVar0]))
						{
							unk_0x03A927199A2DFE46(iLocal_49[iVar0]);
							unk_0xA888F8CC04F25CC8(&uLocal_54);
							if (unk_0xD5C6B5E3B93A5EDC(iLocal_49[iVar0], 0))
							{
								if (iLocal_87)
								{
									if (unk_0xA7A5D14F877C9047("move_injured_generic"))
									{
										unk_0xABFC84F5C4943D7B(iLocal_49[iVar0], "move_injured_generic", 1048576000);
										iLocal_88[iVar0] = 1;
									}
								}
							...
							unk_0x8ACADA903FCAA42F(iLocal_49[iVar0], uLocal_54);
							unk_0x7461D7C5BA953BC7(&uLocal_54);
						}
						unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 6, 0);
						unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 0, 1);
						unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 1, 0);
						unk_0x71B502FC2E129665(iLocal_49[iVar0], 1);
						unk_0x7DCB4594ACF18DA7(iLocal_49[iVar0], 1);
						unk_0x50274A7EACA3133A(iLocal_49[iVar0], 1);
					}
					iVar0++;
				}
				if ((unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0xE85F749F6D5C809E(iLocal_52)) && !unk_0xF68107C40359970C(iLocal_49[iLocal_96]))
				{
					unk_0x03A927199A2DFE46(iLocal_49[iLocal_96]);
				}
				settimera(0);
				iLocal_48++;
				break;
			...
			case 1:
				if (func_76(iLocal_96))
				{
					if (!unk_0xF68107C40359970C(iLocal_49[iLocal_96]))
					{
						unk_0x03A927199A2DFE46(iLocal_49[iLocal_96]);
						unk_0xA888F8CC04F25CC8(&uLocal_54);
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_49[iLocal_96], 0))
						{
							unk_0xAB7639D658BBCCEE(0, 0, 256);
						}
						unk_0xC89EA639A6F338A6(0);
						unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
						unk_0xC963A45B50851768(uLocal_54);
						unk_0x8ACADA903FCAA42F(iLocal_49[iLocal_96], uLocal_54);
						unk_0x7461D7C5BA953BC7(&uLocal_54);
					}
					iLocal_48++;
				}
			...
			case 2:
				if (!unk_0xF68107C40359970C(iLocal_49[0]) || !unk_0xF68107C40359970C(iLocal_49[1]))
				{
					...
					while (iVar0 < iLocal_49)
					{
						if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
						{
							if ((iLocal_47 == 2 && !iLocal_91[iVar0]) && !unk_0x55B23FE400FCEA6B(iLocal_50, 0))
							{
								unk_0x776D1ABB5A5CC181(iLocal_49[iVar0], iLocal_50, unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -4f, 0f), 5f, 0);
								iLocal_91[iVar0] = 1;
							}
							if (((unk_0x2791155FB0769FE5(uLocal_103) && !iLocal_91[iVar0]) && iLocal_47 == 3) && !bLocal_89)
							{
								unk_0x776D1ABB5A5CC181(iLocal_49[iVar0], iLocal_50, unk_0x70453F7DF40780A5(uLocal_103), 5f, 0);
								iLocal_91[iVar0] = 1;
							}
							if (bLocal_89)
							{
								if (iLocal_91[iVar0])
								{
									unk_0x5174A997F4970AE4(iLocal_49[iVar0], 0);
									iLocal_91[iVar0] = 0;
								}
							}
						}
					...
					if (IntToFloat((unk_0x320D1840B6DAA1CC() - iLocal_292)) > unk_0xC4EAB25A108C2429(10000f, 15000f))
					{
					...
					if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
					{
						if (!bLocal_79)
						{
							if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_50, 0) && (unk_0x320D1840B6DAA1CC() - iLocal_295) > 5000)
							{
		...
		while (iVar0 < iLocal_49)
		{
			if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
			{
				...
				{
					unk_0x03DD3DA99C7ED7D1(iLocal_49[iVar0], 1048576000);
					iLocal_88[iVar0] = 0;
				}
			}
			iVar0++;
...
bool func_72()
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_282) > 250)
	{
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			iVar0 = 0;
			while (iVar0 < iLocal_49)
			{
				if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
				{
					if (unk_0xD936DBC1D824A1BE(iLocal_49[iVar0], unk_0xE2D3D51028F0428A(), 19) && unk_0xD32EE22119FFF87D(iLocal_49[iVar0], unk_0xE2D3D51028F0428A()))
					{
						iLocal_281[iVar0] = 1;
					}
					else
...
bool func_76(int iParam0)
{
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_52))
	{
		if (!unk_0xF68107C40359970C(iLocal_49[iParam0]))
		{
			if (unk_0x099CAD293190F449(iLocal_52, iLocal_49[iParam0]))
			{
				if (unk_0xFCF559C8631ABED7(iLocal_49[iParam0], "weapons@holster_1h", "holster", 3))
				{
					if (unk_0xD01FAFCE275C94F3(iLocal_49[iParam0], "weapons@holster_1h", "holster") > 0.9f)
					{
						unk_0xE6451C2F193342C7(iLocal_52, 1, 1);
						unk_0x4BDA5AFD88C085EB(&iLocal_52);
					}
				...
				{
					unk_0x50274A7EACA3133A(iLocal_49[iParam0], 1);
					unk_0x49D97B076E3590AC(iLocal_49[iParam0], "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
			}
		}
	}
	bVar0 = (!unk_0xE5965CDF24F93A9F(iLocal_52) || (unk_0xE5965CDF24F93A9F(iLocal_52) && !unk_0x099CAD293190F449(iLocal_52, iLocal_49[iParam0])));
	if (bVar0)
	{
		if (!unk_0xF68107C40359970C(iLocal_49[iParam0]))
		{
			unk_0x50274A7EACA3133A(iLocal_49[iParam0], 0);
		}
	}
	return bVar0;
}
...
void func_77(int iParam0, bool bParam1)
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		Var0 = { func_35(unk_0x37B78BEF7C4625D4(iLocal_50, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1))) };
		fVar1 = ((unk_0x82FE2343F8BDFF0B(iLocal_50) + unk_0xD12EFCAB87804BED(Var0.x, Var0.f_1)) + 45f);
		fVar2 = ((unk_0x82FE2343F8BDFF0B(iLocal_50) + unk_0xD12EFCAB87804BED(Var0.x, Var0.f_1)) - 45f);
		Var3[0 /*3*/] = { unk_0x6DB7FBD602C51670(unk_0x6B62510F212526DC(iLocal_50, 1), fVar1, 0f, 4.5f, 0f) };
		Var3[1 /*3*/] = { unk_0x6DB7FBD602C51670(unk_0x6B62510F212526DC(iLocal_50, 1), fVar2, 0f, 4.5f, 0f) };
		func_78(&fVar1);
		func_78(&fVar2);
		if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_293) > 2f)
		{
			bVar5 = true;
		}
		iVar4 = 0;
		...
		{
			if (!unk_0xF68107C40359970C(iLocal_49[iVar4]))
			{
				if (vdist(unk_0x6B62510F212526DC(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f)
				{
					bVar5 = true;
				}
			}
		...
		if (bVar5)
		{
			...
			while (iVar4 < iLocal_49)
			{
				if ((((((!unk_0xF68107C40359970C(iLocal_49[iVar4]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && vdist(unk_0x6B62510F212526DC(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f) && (unk_0x320D1840B6DAA1CC() - iLocal_294[iVar4]) > 1000) && !unk_0xD5C6B5E3B93A5EDC(iLocal_49[iVar4], 0)) && !iLocal_281[iVar4]) && (iParam0 == -1 || iParam0 == iVar4))
				{
					if (bParam1)
					{
						if (func_72())
						{
							Local_293 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
						}
						unk_0xA888F8CC04F25CC8(&uVar6);
						if (func_72() || func_38(Local_293))
						{
							unk_0x98DB2ABD53B8D70B(0, Var3[iVar4 /*3*/], unk_0xE2D3D51028F0428A(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
							unk_0x636B3584208A6D73(0, unk_0xE2D3D51028F0428A(), -1, 1);
						}
						else
						{
							unk_0x642C58F4CA259448(0, Var3[iVar4 /*3*/], Local_293, 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
							unk_0x2EA72CDBFACD9E92(0, Local_293, -1, 1, 0);
						}
						unk_0xC963A45B50851768(uVar6);
						unk_0x8ACADA903FCAA42F(iLocal_49[iVar4], uVar6);
						unk_0x7461D7C5BA953BC7(&uVar6);
					}
					iLocal_294[iVar4] = unk_0x320D1840B6DAA1CC();
				}
				iVar4++;
			}
		}
...
void func_79(int iParam0)
{
		...
		switch (iLocal_48)
		{
			case 0:
				if (!bLocal_79)
				{
					...
					Local_283 = { unk_0x96EDA732FD9DC0AF(iLocal_50, 0) };
					Local_284 = { unk_0x63A8BF5E6C2BF85C(iLocal_50, 2) };
					Local_285 = { unk_0x3DBAB8E11699EAEE("random@security_van", "sec_case_into_van_panic", Local_283, Local_284, 0, 2) };
					if (((!unk_0xF68107C40359970C(iLocal_49[1]) && !unk_0x55B23FE400FCEA6B(iLocal_49[1], 0)) && !unk_0xF68107C40359970C(iLocal_49[0])) && !unk_0x55B23FE400FCEA6B(iLocal_49[0], 0))
					{
						if (func_27() < 20f)
						{
							if (bLocal_80)
						...
						if (unk_0x2791155FB0769FE5(uLocal_103))
						{
							if (bLocal_80)
							{
								unk_0x7D1424753688EE7A(iParam0, unk_0x70453F7DF40780A5(uLocal_103), 2f, -1, 0.25f, 0, 1193033728);
							}
							else
							{
								unk_0x7D1424753688EE7A(iParam0, unk_0x70453F7DF40780A5(uLocal_103), 1f, -1, 0.25f, 0, 1193033728);
							}
							iLocal_48++;
						}
						else
			...
			case 1:
				if (!unk_0xF68107C40359970C(iParam0) && unk_0x2791155FB0769FE5(uLocal_103))
				{
					if ((unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam0, 1), unk_0x70453F7DF40780A5(uLocal_103), 1) < 2f && !unk_0x32DCDA1B2F8A0694(iParam0)) && (unk_0x320D1840B6DAA1CC() - iLocal_102) > 3000)
					{
			...
			case 2:
				if (!unk_0xF68107C40359970C(iParam0) && unk_0x55A0C756C4A8220C(iLocal_50, 0))
				{
					if (unk_0x174CED88B97C78D9(iParam0, 713668775) != 1)
					{
						if (bLocal_80)
						{
							unk_0x7D1424753688EE7A(iParam0, Local_285, 2f, -1, 0.1f, 512, Local_284.f_2);
						}
						else
						{
							unk_0x7D1424753688EE7A(iParam0, Local_285, 1f, -1, 0.1f, 512, Local_284.f_2);
						}
						iLocal_48++;
					}
				}
			...
			case 3:
				if (!unk_0xF68107C40359970C(iParam0))
				{
					...
					else
					{
						...
						if (vdist(Local_285, unk_0x6B62510F212526DC(iParam0, 1)) < 0.3f)
						{
							if (unk_0x48053974ED6F63CE((fVar0 - Local_284.f_2)) < 15f)
							{
								unk_0xBA002E17C13F9DD5(iParam0, -1056964608);
								unk_0x03A927199A2DFE46(iParam0);
								bLocal_288 = true;
								iLocal_286 = unk_0x8F5F4164BF5FB513(Local_283, Local_284, 2);
								if (bLocal_80)
								{
									unk_0x950B26F4C891073F(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									unk_0xAA8557AFE4A4A184(iLocal_50, iLocal_286, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									unk_0x950B26F4C891073F(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
									unk_0xAA8557AFE4A4A184(iLocal_50, iLocal_286, "van_case_into_van_calm", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								unk_0xEB087B19F63AB053(iParam0, 0, 0);
								iLocal_48++;
							}
						}
						else if (unk_0x4D21C9FB671ED18F(iParam0) && !unk_0x0318E2EE6FB4563F(Local_283, 2f))
						{
							unk_0xC64B6E13A6A7F517(iParam0, Local_283, 1, 0, 0, 1);
						}
					}
				}
				break;
			...
			case 4:
				if (unk_0xCE2C78E9FC0B01E3(iLocal_286))
				{
					if (bLocal_80)
					{
						fLocal_296 = 0.42f;
					...
					if (!bLocal_79)
					{
						if ((unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0x099CAD293190F449(iLocal_52, iParam0)) && unk_0x54DE1614490C2A83(iLocal_286) > fLocal_296)
						{
							if (!unk_0x099CAD293190F449(iLocal_52, iLocal_50))
							{
								unk_0xE6451C2F193342C7(iLocal_52, 1, 1);
								unk_0x959E1626CBC7D38A(iLocal_52, 0, 0);
								unk_0x9A97DC6DBC7B223D(iLocal_52, iLocal_50, 0, unk_0x37B78BEF7C4625D4(iLocal_50, unk_0x6B62510F212526DC(iLocal_52, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							}
							bLocal_79 = true;
						}
					}
					else if (unk_0x54DE1614490C2A83(iLocal_286) > fLocal_297)
					{
						unk_0xA5D8BA53953077C8(iLocal_50, -4f, 1);
						unk_0x03A927199A2DFE46(iParam0);
						if (unk_0xE5965CDF24F93A9F(iLocal_52))
						{
							iLocal_76 = 0;
							unk_0xCAA02C32EC0C2462(iLocal_50, 2, 1);
							unk_0xCAA02C32EC0C2462(iLocal_50, 3, 1);
			...
			case 5:
				if ((unk_0xCE2C78E9FC0B01E3(iLocal_286) && unk_0x54DE1614490C2A83(iLocal_286) > fLocal_297) || !unk_0xCE2C78E9FC0B01E3(iLocal_286))
				{
					if (!bLocal_80)
					{
						if (!unk_0xF68107C40359970C(iLocal_49[0]))
						{
							unk_0xB486640392EC50BB(iLocal_49[0], iLocal_50, -1, -1, 1f, 1, 0);
						}
					}
					iLocal_48++;
				}
	...
	if (iLocal_46 != 7)
	{
		if (bLocal_79)
		{
			if (unk_0xCE2C78E9FC0B01E3(iLocal_286))
			{
				unk_0xA5D8BA53953077C8(iLocal_50, -8f, 1);
			}
		}
		if (!unk_0xF68107C40359970C(iParam0))
		{
	...
	if ((unk_0x55A0C756C4A8220C(iLocal_50, 0) && iLocal_46 != 7) && unk_0xCE2C78E9FC0B01E3(iLocal_286))
	{
		unk_0xA5D8BA53953077C8(iLocal_50, -8f, 1);
	}
}
...
int func_80(int iParam0)
{
	...
	iVar0 = 0;
	if (unk_0xE5965CDF24F93A9F(iParam0) && unk_0xE5965CDF24F93A9F(iLocal_50))
	{
		uVar7 = 4;
		unk_0xB38EF75835FAF667(unk_0x15CAA6D7B11F1A7C(iParam0), &Var1, &Var2);
		Var3[0 /*3*/] = { unk_0xCACAD935C0BEE14F(iParam0, Var1, Var2.f_1, 0f) };
		Var3[1 /*3*/] = { unk_0xCACAD935C0BEE14F(iParam0, Var2, Var2.f_1, 0f) };
		Var3[2 /*3*/] = { unk_0xCACAD935C0BEE14F(iParam0, Var2, Var1.f_1, 0f) };
		Var3[3 /*3*/] = { unk_0xCACAD935C0BEE14F(iParam0, Var1, Var1.f_1, 0f) };
		fVar8 = -3.7f;
		fVar9 = 1.35f;
		Var4[0 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (-fVar9 - 0.25f), fVar8, 0f) };
		Var4[1 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (fVar9 + 0.25f), fVar8, 0f) };
		Var4[2 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (fVar9 - 0.25f), (fVar8 - 1.55f), 0f) };
		Var4[3 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (-fVar9 + 0.25f), (fVar8 - 1.55f), 0f) };
		Var5[0 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, -fVar9, 0.5f, 0f) };
		Var5[1 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (-fVar9 - 0.75f), 0.5f, 0f) };
		Var5[2 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (-fVar9 - 0.75f), 1.5f, 0f) };
		Var5[3 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, -fVar9, 1.5f, 0f) };
		Var6[0 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, fVar9, 0.5f, 0f) };
		Var6[1 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (fVar9 + 0.75f), 0.5f, 0f) };
		Var6[2 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, (fVar9 + 0.75f), 1.5f, 0f) };
		Var6[3 /*3*/] = { unk_0xCACAD935C0BEE14F(iLocal_50, fVar9, 1.5f, 0f) };
		if (!bLocal_79)
		{
		...
		if (!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF6F5D18EF8EAB859(iLocal_49[0], iLocal_50, 1))
		{
		...
		if (!unk_0xF68107C40359970C(iLocal_49[1]) && !unk_0xF6F5D18EF8EAB859(iLocal_49[1], iLocal_50, 1))
		{
...
void func_85(int iParam0)
{
	if (!unk_0xF68107C40359970C(iParam0))
	{
		if (!unk_0xE5965CDF24F93A9F(iLocal_52))
		{
			iLocal_52 = unk_0x0E536D72AB30F4C8(iLocal_75, Local_63, 1, 1, 0);
			unk_0xFEF687AF74EEDCC2(iLocal_52, 0);
		}
		if (unk_0xE5965CDF24F93A9F(iLocal_52))
		{
			unk_0x9A97DC6DBC7B223D(iLocal_52, iParam0, unk_0xB897FCFCFA664B38(iParam0, 28422), Local_68, Local_69, 1, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_86()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
			{
				if (unk_0xE5965CDF24F93A9F(func_89()))
				{
					...
					{
						if (unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0) != func_89() && unk_0x7158135695FAE89D(iLocal_50, -1, 0))
						{
							unk_0xB486640392EC50BB(func_89(), iLocal_50, 20000, -1, 2f, 1, 0);
						}
					}
				}
				if (!unk_0xF68107C40359970C(iLocal_49[1]) && func_89() != iLocal_49[1])
				{
					if (unk_0xAB793EA186AB8DAA(iLocal_50, 0, 0) != iLocal_49[1] && unk_0x7158135695FAE89D(iLocal_50, 0, 0))
					{
						unk_0xB486640392EC50BB(iLocal_49[1], iLocal_50, -1, 0, 1073741824, 1, 0);
					}
				}
				iLocal_48++;
			}
		...
		case 1:
			if (func_88())
			{
				...
				{
					unk_0xB69D13E19147910F(func_89(), iLocal_50, unk_0xE2D3D51028F0428A(), 8, 50f, 786484, 100f, 5f, 1);
					iLocal_48++;
				}
			}
			break;
		...
		case 2:
			if (func_87())
			{
				if (unk_0xE5965CDF24F93A9F(func_89()))
				{
					unk_0xFE5A02CF2178B6A8(func_89(), iLocal_50, 0, 5, 0f, 786484, 100f, 100f, 1);
					iLocal_48++;
				}
			}
			break;
		...
		case 3:
			if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
			{
				if (unk_0x207D53F9E0190691(iLocal_50) < 2f)
				{
					func_68(8);
				}
			}
	...
	if ((unk_0xE5965CDF24F93A9F(iLocal_50) && unk_0xE5965CDF24F93A9F(unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0))) && (unk_0x55B23FE400FCEA6B(unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0), 0) || unk_0xF68107C40359970C(unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0))))
	{
		iVar1 = 0;
		if (unk_0xAB793EA186AB8DAA(iLocal_50, -1, 0) == iLocal_49[0])
		{
			iVar1 = 1;
		}
		if (vdist2(unk_0x6B62510F212526DC(iLocal_50, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 100f)
		{
			if (!unk_0xF68107C40359970C(iLocal_49[iVar1]) && unk_0x174CED88B97C78D9(iLocal_49[iVar1], 242628503) != 1)
			{
				unk_0xDC6110E0F8FF9DA0(iLocal_49[iVar1], 2, 1);
				unk_0xA888F8CC04F25CC8(&uVar2);
				unk_0x8625186D3A8DDD7A(0, iLocal_50, 0);
				unk_0xB69D13E19147910F(0, iLocal_50, unk_0xE2D3D51028F0428A(), 8, 50f, 786484, 100f, 5f, 1);
				unk_0xC963A45B50851768(uVar2);
				unk_0x8ACADA903FCAA42F(iLocal_49[iVar1], uVar2);
	...
	if (((((((!unk_0x55A0C756C4A8220C(iLocal_50, 0) || unk_0x2791155FB0769FE5(uLocal_103)) || iLocal_47 == 3) || unk_0xF798DCF92C74B531(iLocal_50, 0, 7000)) || unk_0xF798DCF92C74B531(iLocal_50, 3, 30000)) || unk_0xF798DCF92C74B531(iLocal_50, 2, 30000)) || unk_0xF798DCF92C74B531(iLocal_50, 1, 40000)) || (iLocal_48 > 1 && !func_88()))
	{
		if (!func_88())
		{
		}
...
int func_87()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_50))
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_50, 0))
		{
			if (((((unk_0x0CF63873D754B965(iLocal_50) < 300 || unk_0x20E1198E4672F72D(iLocal_50) < 200f) || (unk_0xB4C63F21D1DC6C23(iLocal_50, 0, 0) && unk_0xB4C63F21D1DC6C23(iLocal_50, 1, 0))) || (unk_0xB4C63F21D1DC6C23(iLocal_50, 4, 0) && unk_0xB4C63F21D1DC6C23(iLocal_50, 5, 0))) || (unk_0xB4C63F21D1DC6C23(iLocal_50, 0, 0) && unk_0xB4C63F21D1DC6C23(iLocal_50, 4, 0))) || (unk_0xB4C63F21D1DC6C23(iLocal_50, 1, 0) && unk_0xB4C63F21D1DC6C23(iLocal_50, 5, 0)))
			{
				return 1;
			}
		}
...
int func_88()
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
	{
		if (!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0x55B23FE400FCEA6B(iLocal_49[0], 0))
		{
			if (!unk_0xF6F5D18EF8EAB859(iLocal_49[0], iLocal_50, 0))
			{
				iVar0 = 0;
			}
		}
		if (!unk_0xF68107C40359970C(iLocal_49[1]) && !unk_0x55B23FE400FCEA6B(iLocal_49[1], 0))
		{
			if (!unk_0xF6F5D18EF8EAB859(iLocal_49[1], iLocal_50, 0))
			{
				iVar0 = 0;
			}
		}
...
void func_90()
{
	...
	switch (iLocal_48)
	{
		case 0:
			if (!bLocal_79)
			{
				if (unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0xE85F749F6D5C809E(iLocal_52))
				{
					unk_0xE6451C2F193342C7(iLocal_52, 1, 1);
				}
			}
			if ((!unk_0xF68107C40359970C(iLocal_49[0]) || !unk_0xF68107C40359970C(iLocal_49[1])) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				while (iVar0 < iLocal_49)
				{
					if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
					{
						unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 17, 1);
						unk_0xDC6110E0F8FF9DA0(iLocal_49[iVar0], 128, 1);
						unk_0xDC6110E0F8FF9DA0(iLocal_49[iVar0], 16, 1);
						unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 1, 0);
						unk_0xA888F8CC04F25CC8(&uVar1);
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_49[iVar0], 1))
						{
							unk_0xAB7639D658BBCCEE(iLocal_49[iVar0], 0, 256);
						}
						unk_0x7734082B0EDB0BE0(0, unk_0xE2D3D51028F0428A(), 300f, -1, 0, 0);
						unk_0xC963A45B50851768(uVar1);
						unk_0x8ACADA903FCAA42F(iLocal_49[iVar0], uVar1);
...
void func_94()
{
		...
		switch (iLocal_48)
		{
			case 0:
				if (func_4(&Local_106, cLocal_105, "RESEC_CAR1", 8, 0, 0, 0))
				{
					if (unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0xE85F749F6D5C809E(iLocal_52))
					{
						if (!unk_0x099CAD293190F449(iLocal_52, iLocal_49[0]))
						{
							func_95(0);
						}
						else
						{
							unk_0x03A927199A2DFE46(iLocal_49[0]);
						}
						if (!unk_0x099CAD293190F449(iLocal_52, iLocal_49[1]))
						{
							func_95(1);
						}
						else
						{
							unk_0x03A927199A2DFE46(iLocal_49[1]);
						}
						iLocal_48++;
					}
					else
	...
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_51, 0) && unk_0x55A0C756C4A8220C(iLocal_50, 0))
		{
			if (vdist(unk_0x6B62510F212526DC(iLocal_51, 1), unk_0x6B62510F212526DC(iLocal_50, 1)) > 10f)
			{
				func_68(7);
			}
		}
		if ((unk_0x55B23FE400FCEA6B(iLocal_51, 0) || !unk_0x55A0C756C4A8220C(iLocal_51, 0)) || (!unk_0xEFD1745E9D77E91C(iLocal_51, 1119092736) && !unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_51, 1)))
		{
	...
	if (!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_49[0], unk_0xE2D3D51028F0428A(), 1))
		{
			func_68(8);
		}
	}
	if (!unk_0xF68107C40359970C(iLocal_49[1]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_49[1], unk_0xE2D3D51028F0428A(), 1))
		{
			func_68(8);
		}
	}
...
{
	if (!unk_0xF68107C40359970C(iLocal_49[iParam0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		unk_0x03A927199A2DFE46(iLocal_49[iParam0]);
		unk_0xA888F8CC04F25CC8(&uLocal_54);
		if (unk_0xD5C6B5E3B93A5EDC(iLocal_49[iParam0], 0))
		{
			unk_0xAB7639D658BBCCEE(0, 0, 256);
		}
		unk_0xC89EA639A6F338A6(0);
		...
		unk_0xC963A45B50851768(uLocal_54);
		unk_0x8ACADA903FCAA42F(iLocal_49[iParam0], uLocal_54);
		unk_0x7461D7C5BA953BC7(&uLocal_54);
		if (iLocal_97 == 0)
		{
			iLocal_97 = unk_0xAA8EA67D77D37C61(118, unk_0x6B62510F212526DC(iLocal_49[iParam0], 1), -1082130432);
		}
	}
}
...
void func_96()
{
	...
	switch (iLocal_48)
	{
		case 0:
			if (!unk_0xF68107C40359970C(iLocal_49[0]))
			{
				unk_0x50274A7EACA3133A(iLocal_49[0], 1);
			}
			if (!unk_0xF68107C40359970C(iLocal_49[1]))
			{
				unk_0x50274A7EACA3133A(iLocal_49[1], 1);
			}
			if (func_103())
			{
			...
			else if ((!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF68107C40359970C(iLocal_49[1])) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
		...
		case 2:
			if (!func_100())
			{
				...
				while (iVar1 < iLocal_49)
				{
					if (!func_99(iLocal_49[iVar1], 1000) && (func_27() < 2f && unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6)))
					{
						bVar0 = true;
					}
					if (!unk_0x55B23FE400FCEA6B(iLocal_49[iVar1], 0))
					{
						if (unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_49[iVar1]) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_49[iVar1]))
						{
							bVar0 = true;
						}
					}
				...
				func_77(-1, 1);
				if (IntToFloat((unk_0x320D1840B6DAA1CC() - iLocal_292)) > unk_0xC4EAB25A108C2429(5000f, 7500f))
				{
					if (!func_73())
					{
	...
	{
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()) && unk_0xE5965CDF24F93A9F(iLocal_49[iVar2]))
		{
			if ((unk_0xF68107C40359970C(iLocal_49[iVar2]) || unk_0x55B23FE400FCEA6B(iLocal_49[iVar2], 0)) && unk_0x0747E45CFF1F74AA(iLocal_49[iVar2], unk_0xE2D3D51028F0428A(), 0))
			{
				func_68(8);
			}
		}
	...
	if ((unk_0xF68107C40359970C(iLocal_49[0]) || unk_0xF68107C40359970C(iLocal_49[1])) || bLocal_89)
	{
		func_68(8);
	}
	if ((unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && func_72())
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_50, unk_0xE2D3D51028F0428A(), 1))
		{
			func_68(8);
...
int func_99(int iParam0, int iParam1)
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0xE5965CDF24F93A9F(iParam0))
		{
			...
			{
				if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1)) > fLocal_290)
				{
					iVar0 = 1;
				}
				if ((unk_0x320D1840B6DAA1CC() - iLocal_291) > iParam1)
				{
					fLocal_290 = vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1));
...
int func_100()
{
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_50, 20f, 20f, 5f, 0, 1, 0) && !unk_0x37BBF9ACD752871A(unk_0x9E2D6C50374FCFA9(), 0))
		{
			return 1;
		}
	}
...
int func_101()
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 1.7532f, 0.5984f), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 3.3477f, 3.5984f), 2.8f, 0, 1, 0))
		{
			return 1;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_49)
		{
			if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
			{
				if ((!unk_0xF6F5D18EF8EAB859(iLocal_49[iVar0], iLocal_50, 0) && unk_0x8465E2AB4423B436(unk_0xE2D3D51028F0428A(), iLocal_50)) && vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[iVar0], 1)) < 400f)
				{
					return 1;
				}
			}
...
int func_102()
{
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0xD9BD5965B9552645(unk_0xE2D3D51028F0428A()) == iLocal_50)
		{
...
int func_103()
{
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if ((!unk_0xF68107C40359970C(iLocal_49[0]) && unk_0x77A43AFA9AAEC041(iLocal_49[0], unk_0xE2D3D51028F0428A(), 20f, 20f, 5f, 0, 1, 0)) || (!unk_0xF68107C40359970C(iLocal_49[1]) && unk_0x77A43AFA9AAEC041(iLocal_49[1], unk_0xE2D3D51028F0428A(), 20f, 20f, 5f, 0, 1, 0)))
		{
	...
	switch (iLocal_48)
	{
		case 0:
			if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
			{
				if (!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF68107C40359970C(iLocal_49[1]))
				{
					unk_0xBC12D08EE7559CCD(iLocal_49[0], 6, 1);
					unk_0xBC12D08EE7559CCD(iLocal_49[1], 6, 1);
					unk_0x50274A7EACA3133A(iLocal_49[0], 1);
					unk_0x50274A7EACA3133A(iLocal_49[1], 1);
					if (unk_0xF6F5D18EF8EAB859(iLocal_49[0], iLocal_50, 0) && unk_0xF6F5D18EF8EAB859(iLocal_49[1], iLocal_50, 0))
					{
						if (iLocal_45 == 2)
						{
							unk_0xA888F8CC04F25CC8(&uVar0);
							unk_0x3B8F94419979A0B1(0, iLocal_50, -574.6195f, -847.232f, 25.2925f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							unk_0xAD6CDBCDA713560A(0, iLocal_50, 10f, 786603);
							unk_0xC963A45B50851768(uVar0);
							unk_0x8ACADA903FCAA42F(iLocal_49[0], uVar0);
						...
						{
							unk_0xA888F8CC04F25CC8(&uVar1);
							unk_0x3B8F94419979A0B1(0, iLocal_50, -551.2968f, -1119.418f, 20.4011f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							unk_0xAD6CDBCDA713560A(0, iLocal_50, 10f, 786603);
							unk_0xC963A45B50851768(uVar1);
							unk_0x8ACADA903FCAA42F(iLocal_49[0], uVar1);
							unk_0x7461D7C5BA953BC7(&uVar1);
							iLocal_48++;
						}
						else if (iLocal_45 == 7)
						{
							unk_0xA888F8CC04F25CC8(&uVar2);
							unk_0x3B8F94419979A0B1(0, iLocal_50, 2786.752f, 4358.032f, 48.6794f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							unk_0xAD6CDBCDA713560A(0, iLocal_50, 10f, 786603);
							unk_0xC963A45B50851768(uVar2);
							unk_0x8ACADA903FCAA42F(iLocal_49[0], uVar2);
							unk_0x7461D7C5BA953BC7(&uVar2);
							iLocal_48++;
						}
						else
						{
							unk_0xAD6CDBCDA713560A(iLocal_49[0], iLocal_50, 10f, 786603);
							iLocal_48++;
						}
					}
					else
					{
						if (!unk_0xF6F5D18EF8EAB859(iLocal_49[0], iLocal_50, 0) && unk_0x174CED88B97C78D9(iLocal_49[0], -1794415470) != 1)
						{
							unk_0xB486640392EC50BB(iLocal_49[0], iLocal_50, -1, -1, 1f, 8388608, 0);
						}
						if (!unk_0xF6F5D18EF8EAB859(iLocal_49[1], iLocal_50, 0) && unk_0x174CED88B97C78D9(iLocal_49[1], -1794415470) != 1)
						{
							unk_0xB486640392EC50BB(iLocal_49[1], iLocal_50, -1, 0, 1f, 8388608, 0);
						}
					}
				}
			}
		...
		case 1:
			...
			if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				{
					if (!unk_0xF68107C40359970C(iLocal_49[iVar3]) && !unk_0x55B23FE400FCEA6B(iLocal_49[iVar3], 0))
					{
						if (unk_0x706E4529F37489DB(unk_0xE2D3D51028F0428A()) && unk_0x177106D5E97D1958(iLocal_49[iVar3]))
						{
							func_68(8);
						}
					}
				...
				if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_50, 1))
				{
					func_68(8);
				}
			}
	...
	if (iLocal_46 == 4)
	{
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			...
			if ((iVar4 == joaat("weapon_stickybomb") || iVar4 == joaat("weapon_molotov")) || iVar4 == joaat("weapon_grenade"))
			{
				...
				if ((unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()) && !unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -3.44f, -3f), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0)) && vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) < 225f)
				{
					func_68(6);
				}
				if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -3.44f, -3f), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0))
				{
					unk_0x963A57DF8530029D("PLAYER IS BEHIND VAN", 0.1f, 0.8f, 0f, 0, 0, 255, 255);
				}
				if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_50, 1)) < 225f)
				{
		...
		if (((unk_0x55A0C756C4A8220C(iLocal_50, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, unk_0x6B62510F212526DC(iLocal_50, 1), 25f, 0)) || (!unk_0xF68107C40359970C(iLocal_49[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, unk_0x6B62510F212526DC(iLocal_49[0], 1), 20f, 0))) || (!unk_0xF68107C40359970C(iLocal_49[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, unk_0x6B62510F212526DC(iLocal_49[1], 1), 20f, 0)))
		{
			func_68(6);
		}
		if (iLocal_46 != 4)
		{
			if (!unk_0xF68107C40359970C(iLocal_49[0]))
			{
				unk_0xBC12D08EE7559CCD(iLocal_49[0], 6, 0);
				unk_0x50274A7EACA3133A(iLocal_49[0], 0);
			}
			if (!unk_0xF68107C40359970C(iLocal_49[1]))
			{
				unk_0xBC12D08EE7559CCD(iLocal_49[1], 6, 0);
				unk_0x50274A7EACA3133A(iLocal_49[1], 0);
			}
		}
	}
}
...
int func_149()
{
	...
	if ((unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9())) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		Var0 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) - unk_0x6B62510F212526DC(iLocal_50, 1) };
		Var1 = { unk_0x63BEA94AB58D4E6D(iLocal_50) };
		Var2 = { unk_0x37B78BEF7C4625D4(iLocal_50, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) };
		if (((Var2.f_1 > 1f && (((unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_50) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_50)) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_49[0])) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_49[1]))) && unk_0x48053974ED6F63CE(unk_0x952F3FA2E7880565(Var1.x, Var1.f_1, Var0.x, Var0.f_1)) < 60f) && unk_0x952F3FA2E7880565(Var1.f_2, Var1.f_1, Var0.f_2, Var0.f_1) < 30f)
		{
			return 1;
		}
	}
...
int func_150()
{
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if ((unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, 2.7f, 7f, -2f), unk_0xCACAD935C0BEE14F(iLocal_50, 2.7f, -3.25f, 3f), 3f, 0, 1, 0) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, -2.7f, 7f, -2f), unk_0xCACAD935C0BEE14F(iLocal_50, -2.7f, -3.25f, 3f), 3f, 0, 1, 0)) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 7f, -2f), unk_0xCACAD935C0BEE14F(iLocal_50, 0f, 0f, 3f), 2.4f, 0, 1, 0))
		{
			if (unk_0x3DA4842FA4407BE2(unk_0xE2D3D51028F0428A()))
			{
				return 1;
...
int func_151()
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (unk_0xE5965CDF24F93A9F(iVar0) && unk_0xE5965CDF24F93A9F(iLocal_50))
		{
			return ((unk_0x55A0C756C4A8220C(iVar0, 0) && unk_0x72F6AE51B7E34865(iVar0, iLocal_50)) && unk_0x207D53F9E0190691(iVar0) > 10f);
		}
	}
	return 0;
}
...
void func_153()
{
	...
	if ((!unk_0xF68107C40359970C(iLocal_49[0]) && !unk_0xF68107C40359970C(iLocal_49[1])) && unk_0x55A0C756C4A8220C(iLocal_50, 0))
	{
		switch (iLocal_48)
		{
			case 0:
				Local_283 = { unk_0x96EDA732FD9DC0AF(iLocal_50, 0) };
				Local_284 = { unk_0x63A8BF5E6C2BF85C(iLocal_50, 2) };
				Local_285 = { unk_0x3DBAB8E11699EAEE("random@security_van", "sec_case_into_van_calm", Local_283, Local_284, 0, 2) };
				bLocal_288 = false;
				iLocal_289 = 0;
				unk_0x9F65B3BAFA302A65(iLocal_50, 1084227584);
				unk_0xA888F8CC04F25CC8(&uLocal_54);
				unk_0x83F5BCFFFBA26699(0, 5000);
				unk_0x7D1424753688EE7A(0, Local_285, 1f, -1, 0.1f, 512, Local_284.f_2);
				unk_0x30E00B59448AB97E(0, Local_284.f_2, 0);
				unk_0xC963A45B50851768(uLocal_54);
				unk_0x8ACADA903FCAA42F(iLocal_49[1], uLocal_54);
				unk_0x7461D7C5BA953BC7(&uLocal_54);
				iLocal_48++;
				break;
			...
			case 1:
				...
				Local_284 = { unk_0x63A8BF5E6C2BF85C(iLocal_50, 2) };
				Local_285 = { unk_0x3DBAB8E11699EAEE("random@security_van", "sec_case_into_van_calm", Local_283, Local_284, 0, 2) };
				if (!unk_0xCE2C78E9FC0B01E3(iLocal_287))
				{
					if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_63) < 22500f && unk_0xF1E076F6CC1695AA(iLocal_50))
					{
						iLocal_287 = unk_0x8F5F4164BF5FB513(Local_283, Local_284, 2);
						unk_0x950B26F4C891073F(iLocal_49[0], iLocal_287, "random@security_van", "driver_idle", 2f, -8f, 13, 0, 1148846080, 0);
						unk_0xFE1CD80C2F7CBCFB(iLocal_287, 1);
					}
				}
				if (unk_0x174CED88B97C78D9(iLocal_49[1], 242628503) != 1)
				{
					unk_0xA888F8CC04F25CC8(&uLocal_54);
					unk_0x7D1424753688EE7A(0, Local_285, 1f, -1, 0.1f, 512, Local_284.f_2);
					unk_0x30E00B59448AB97E(0, Local_284.f_2, 0);
				...
				fVar0 = unk_0x82FE2343F8BDFF0B(iLocal_49[1]);
				if (fVar0 > 180f)
				{
					fVar0 = (fVar0 - 360f);
				}
				...
				if (unk_0x48053974ED6F63CE((fVar0 - Local_284.f_2)) < 15f && vdist(Local_285, unk_0x6B62510F212526DC(iLocal_49[1], 1)) < 0.2f)
				{
					unk_0xBA002E17C13F9DD5(iLocal_49[1], -1056964608);
					unk_0x03A927199A2DFE46(iLocal_49[1]);
					bLocal_288 = true;
					iLocal_286 = unk_0x8F5F4164BF5FB513(Local_283, Local_284, 2);
					unk_0x950B26F4C891073F(iLocal_49[1], iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
					unk_0xAA8557AFE4A4A184(iLocal_50, iLocal_286, "van_case_into_van_calm", "random@security_van", 4f, -1000f, 0, -1000f);
					iLocal_48++;
				}
				break;
			...
			case 2:
				if (!iLocal_76)
				{
					if (((unk_0xCE2C78E9FC0B01E3(iLocal_286) && unk_0x54DE1614490C2A83(iLocal_286) > 0.09f) && unk_0x54DE1614490C2A83(iLocal_286) < 0.11f) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
					{
						if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[1], 20f, 20f, 5f, 0, 1, 0))
						{
				...
				if (unk_0xCE2C78E9FC0B01E3(iLocal_286))
				{
					if (!bLocal_79)
					{
						if ((unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0x099CAD293190F449(iLocal_52, iLocal_49[1])) && unk_0x54DE1614490C2A83(iLocal_286) > 0.3793f)
						{
							if (!unk_0x099CAD293190F449(iLocal_52, iLocal_50))
							{
								unk_0xE6451C2F193342C7(iLocal_52, 1, 1);
					...
					else if (unk_0x54DE1614490C2A83(iLocal_286) > 0.546243f)
					{
						unk_0xA5D8BA53953077C8(iLocal_50, -4f, 1);
						if (unk_0xE5965CDF24F93A9F(iLocal_52))
						{
			...
			case 3:
				if (!iLocal_76)
				{
					if (((unk_0xCE2C78E9FC0B01E3(iLocal_286) && unk_0x54DE1614490C2A83(iLocal_286) > 0.56f) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_49[1], 20f, 20f, 5f, 0, 1, 0))
					{
				...
				if (!iLocal_289)
				{
					if ((unk_0xCE2C78E9FC0B01E3(iLocal_286) && unk_0x54DE1614490C2A83(iLocal_286) > 0.6f) || !unk_0xCE2C78E9FC0B01E3(iLocal_286))
					{
						if (unk_0xCE2C78E9FC0B01E3(iLocal_287))
						{
							unk_0x03A927199A2DFE46(iLocal_49[0]);
							iLocal_287 = unk_0x8F5F4164BF5FB513(Local_283, Local_284, 2);
							unk_0x950B26F4C891073F(iLocal_49[0], iLocal_287, "random@security_van", "driver_exit_calm", 4f, -4f, 9, 0, 1148846080, 0);
						}
						iLocal_289 = 1;
					}
				}
				else if ((unk_0xCE2C78E9FC0B01E3(iLocal_287) && unk_0x54DE1614490C2A83(iLocal_287) >= 0.92f) || !unk_0xCE2C78E9FC0B01E3(iLocal_287))
				{
					if (!unk_0xF6F5D18EF8EAB859(iLocal_49[0], iLocal_50, 0) && unk_0x174CED88B97C78D9(iLocal_49[0], -1794415470) != 1)
					{
						unk_0x03A927199A2DFE46(iLocal_49[0]);
				...
				if (unk_0xCE2C78E9FC0B01E3(iLocal_286) && unk_0xD9E56EC8ED04E45E(iLocal_49[1], unk_0x2E87280918B16506("ENDS_IN_WALK")))
				{
					unk_0x03A927199A2DFE46(iLocal_49[1]);
					unk_0xB486640392EC50BB(iLocal_49[1], iLocal_50, -1, 0, 1f, 1, 0);
					settimera(0);
				}
				if ((func_88() && unk_0x7DF569D9E616D55E(iLocal_50, 0) == 0f) && unk_0x7DF569D9E616D55E(iLocal_50, 1) == 0f)
				{
					func_68(4);
				}
				break;
			...
			case 4:
				if (timera() > 15000)
				{
					unk_0xCAA02C32EC0C2462(iLocal_50, 0, 1);
					unk_0xCAA02C32EC0C2462(iLocal_50, 1, 1);
				}
				break;
		}
		if (((!unk_0xF68107C40359970C(func_3()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(func_3(), 1)) < 30f) && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) != 0)
		{
			func_68(8);
		}
	}
	...
	if (iLocal_46 != 1)
	{
		if (iLocal_46 != 4)
		{
			...
			if (!unk_0xF68107C40359970C(iLocal_49[0]))
			{
				if (unk_0xFCF559C8631ABED7(iLocal_49[0], "random@security_van", "driver_idle", 3))
				{
					if (iLocal_45 != 2)
					{
						unk_0x246C656F8E525DC7(iLocal_49[0], "random@security_van", "driver_exit_panic", Local_283, Local_284, 1000f, -8f, -1, 4096, 0f, 2, 0);
					}
					else
					{
						unk_0x03A927199A2DFE46(iLocal_49[0]);
						unk_0x49D97B076E3590AC(iLocal_49[0], "random@security_van", "driver_exit_panic", 1000f, -8f, -1, 0, 0, 0, 0, 0);
					}
				}
			}
			if ((unk_0x55A0C756C4A8220C(iLocal_50, 0) && unk_0xCE2C78E9FC0B01E3(iLocal_286)) && !unk_0xF68107C40359970C(iLocal_49[1]))
			{
				unk_0xA5D8BA53953077C8(iLocal_50, -1000f, 1);
				unk_0x03A927199A2DFE46(iLocal_49[1]);
			}
		}
		if (bLocal_79 && !unk_0x2791155FB0769FE5(uLocal_103))
		{
			unk_0xCAA02C32EC0C2462(iLocal_50, 2, 1);
			unk_0xCAA02C32EC0C2462(iLocal_50, 3, 1);
		}
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
			{
				...
				{
					iLocal_51 = unk_0x9993EF7FDBCDB632();
					return 1;
				}
			}
		}
		else if (!unk_0x55B23FE400FCEA6B(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0))
		{
			...
			{
				fLocal_280 = (fLocal_280 + unk_0x51109C28352EC9A3());
			}
			else if (fLocal_280 > 0f)
			{
				fLocal_280 = (fLocal_280 - (unk_0x51109C28352EC9A3() * 10f));
			}
			else if (fLocal_280 < 0f)
			{
				fLocal_280 = 0f;
			...
			if (fLocal_280 > 3f)
			{
				iLocal_51 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
				return 1;
			}
		}
	}
...
int func_155()
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!unk_0xF68107C40359970C(iLocal_49[iVar0]) && unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9())) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A())) && (unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_49[iVar0]) || unk_0x7A6B8C262362C722(unk_0xE2D3D51028F0428A()))) && vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iLocal_49[iVar0], 1)) < 9f) && !unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 7)) && func_72())
		{
			return 1;
		}
		if (unk_0x32DCDA1B2F8A0694(iLocal_49[iVar0]))
		{
			return 1;
		}
		iVar0++;
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 7) || (iVar0 == joaat("weapon_petrolcan") && unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A())))
		{
			if (unk_0x3C7ED37A9FE7C585(unk_0xE2D3D51028F0428A()))
			{
				if (!unk_0xF68107C40359970C(iLocal_49[0]))
				{
					if (unk_0x77A43AFA9AAEC041(iLocal_49[0], unk_0xE2D3D51028F0428A(), 12f, 12f, 5f, 0, 1, 0))
					{
						return 1;
					}
				}
				if (!unk_0xF68107C40359970C(iLocal_49[1]))
				{
					if (unk_0x77A43AFA9AAEC041(iLocal_49[1], unk_0xE2D3D51028F0428A(), 12f, 12f, 5f, 0, 1, 0))
					{
						return 1;
					}
				}
...
int func_157()
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!unk_0xF68107C40359970C(iLocal_49[iVar0]) && unk_0x0747E45CFF1F74AA(iLocal_49[iVar0], unk_0xE2D3D51028F0428A(), 1)) || (!unk_0xF68107C40359970C(iLocal_49[iVar0]) && unk_0xCED7266BAB0BDC20(iLocal_49[iVar0], unk_0xE2D3D51028F0428A()))) || unk_0x0747E45CFF1F74AA(iLocal_49[iVar0], unk_0xE2D3D51028F0428A(), 1)) || (unk_0x0747E45CFF1F74AA(iLocal_50, unk_0xE2D3D51028F0428A(), 1) && func_72())) || unk_0xF68107C40359970C(iLocal_49[iVar0])) || unk_0x55B23FE400FCEA6B(iLocal_49[iVar0], 0))
		{
			return 1;
		}
		iVar0++;
	...
	if (unk_0x55A0C756C4A8220C(iLocal_50, 0))
	{
		...
		while (iVar0 < iLocal_49)
		{
			if (!unk_0xF68107C40359970C(iLocal_49[iVar0]))
			{
				if (unk_0x706E4529F37489DB(unk_0xE2D3D51028F0428A()) && unk_0x177106D5E97D1958(iLocal_49[iVar0]))
				{
					return 1;
				}
			}
	...
	{
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_63, 25f, 25f, 20f, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_158()
{
	...
	while (iVar0 < iLocal_49)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_49[iVar0]))
		{
			if ((!unk_0xF68107C40359970C(iLocal_49[iVar0]) && !unk_0x55B23FE400FCEA6B(iLocal_49[iVar0], 0)) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				if ((unk_0x9AC74C7EF847A074(unk_0x6B62510F212526DC(iLocal_49[iVar0], 1), 5f, 1) || func_37(unk_0x6B62510F212526DC(iLocal_49[iVar0], 1) + Vector(5f, 10f, 10f), unk_0x6B62510F212526DC(iLocal_49[iVar0], 1) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || unk_0x0747E45CFF1F74AA(iLocal_49[iVar0], unk_0xE2D3D51028F0428A(), 1))
				{
					bLocal_80 = true;
					return 1;
				}
...
void func_159()
{
	...
	iLocal_50 = unk_0xBA715A7BEBA5A1F9(iLocal_74, Local_63, fLocal_64, 1, 1, 0);
	iLocal_53 = unk_0x0E536D72AB30F4C8(joaat("prop_security_case_01"), Local_63, 1, 1, 0);
	unk_0x9A97DC6DBC7B223D(iLocal_53, iLocal_50, 0, 0f, -2.4589f, 1.2195f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	unk_0x1C2ED929474DC6FE(iLocal_53, 0, 0);
	unk_0x14AD86219FE1AC08(iLocal_53, iLocal_50, 0);
	unk_0x9F65B3BAFA302A65(iLocal_50, 1084227584);
	unk_0x3B2646B62E7BBE11(iLocal_50, 3);
	unk_0xBED097BB6359F09C(iLocal_53, 0, 1, 1, 1, 1, 1, 0, 0);
	unk_0x06AF73D7E3DF7782(iLocal_50, 1, 0);
	unk_0xF160248D9083ED0C(iLocal_50, 700, 0);
	unk_0x2EABFF5EFCB7E6CF(iLocal_50, 0, 0);
	unk_0x006574E87E6F1942(iLocal_50, 1, 1);
	unk_0xA2B9AE794C45034B(iLocal_50, 0);
	unk_0xAA207A327A73D480(iLocal_50, 1);
	unk_0x2EE5FFF3E1E3400D((Local_63.x - 200f), (Local_63.f_1 - 200f), (Local_63.x + 200f), (Local_63.f_1 + 200f));
	if (iLocal_44 == 3)
	{
		iLocal_49[0] = unk_0x487C17B41938052C(iLocal_50, 26, iLocal_73, -1, 1, 1);
		iLocal_49[1] = unk_0x487C17B41938052C(iLocal_50, 26, iLocal_73, 0, 1, 1);
		unk_0x371D594409A68A18(iLocal_50, 1, 1, 0);
		unk_0x006574E87E6F1942(iLocal_50, 1, 1);
	}
	else
	{
		iLocal_49[1] = unk_0xA8D58C3AADA2C41C(26, iLocal_73, Local_61[1 /*3*/], fLocal_62[1], 1, 1);
		iLocal_49[0] = unk_0xA8D58C3AADA2C41C(26, iLocal_73, Local_61[0 /*3*/], fLocal_62[0], 1, 1);
		unk_0xF30F15F203736DE4(iLocal_49[1], iLocal_49[0], -1, 0, 2);
	}
	func_85(iLocal_49[1]);
	unk_0xD642E010A287ADFD("Security_guards", &iLocal_60);
	iVar0 = 0;
	while (iVar0 < iLocal_49)
	{
		unk_0x62BDDA84CCCF90A9(iLocal_49[iVar0], 0);
		unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 1, 0);
		unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 13, 0);
		unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 6, 1);
		unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 8, 0);
		unk_0xBC12D08EE7559CCD(iLocal_49[iVar0], 10, 1);
		unk_0xDC6110E0F8FF9DA0(iLocal_49[iVar0], 512, 1);
		unk_0xD6A76BAB45A4B460(iLocal_49[iVar0], 118, 0);
		unk_0xDC6110E0F8FF9DA0(iLocal_49[iVar0], 128, 1);
		unk_0x3F990964E4A5669A(iLocal_49[iVar0], 0);
		unk_0x06AF73D7E3DF7782(iLocal_49[iVar0], 1, 0);
		unk_0x5D1D64E01B76705C(iLocal_49[iVar0], 1);
		unk_0xC8882E8058542F83(iLocal_49[iVar0], 1);
		unk_0x9521FB98DB6DDF50(iLocal_49[iVar0], joaat("weapon_pistol"), -1, 0, 1);
		unk_0xFF4BEB6CFF55A013(iLocal_49[iVar0], iLocal_60);
		unk_0xABC2CA6F28903308(iLocal_49[iVar0], 1);
		unk_0x7A93DEA53EFC3CF2(iLocal_49[iVar0], 250);
		iVar0++;
	}
	unk_0x006574E87E6F1942(iLocal_49[1], 1, 1);
	unk_0x9972EFADA7A2A47D(1, joaat("COP"), iLocal_60);
	unk_0x9972EFADA7A2A47D(1, iLocal_60, joaat("COP"));
	unk_0x9972EFADA7A2A47D(2, iLocal_60, 1862763509);
	unk_0x9972EFADA7A2A47D(2, 1862763509, iLocal_60);
	if (iLocal_44 == 1)
	{
		unk_0xD9D122A54FFE62B8(iLocal_49[0], 0, 1, 0, 0);
		unk_0x40A4FA5C4B5DA318(iLocal_49[0], 0);
		unk_0xD9D122A54FFE62B8(iLocal_49[1], 0, 1, 0, 0);
		unk_0x40A4FA5C4B5DA318(iLocal_49[1], 0);
	}
	if (func_16() == 0 && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		func_74(&Local_106, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
	}
	if (func_16() == 1 && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		func_74(&Local_106, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	}
	if (func_16() == 2 && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		func_74(&Local_106, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
	}
	func_74(&Local_106, 3, iLocal_49[0], "SECVANGUY1", 0, 1);
	func_74(&Local_106, 4, iLocal_49[1], "SECVANGUY2", 0, 1);
	unk_0x7CD708DEB04F8474(iLocal_74, 1);
	unk_0x269268AD5D4CA266(iLocal_73, 1);
	if (iLocal_44 != 3)
	{
	}
}
...
int func_170()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_181())
		{
			return 0;
		}
	}
...
void func_187()
{
	...
	uLocal_94 = unk_0x5853B15F78E1A265(3000, 8000);
	switch (iLocal_45)
	{
		case 1:
...
int func_191(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_225(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_204(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_231()
{
	if (func_183())
	{
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_52))
		{
			if (unk_0x4D21C9FB671ED18F(iLocal_52))
			{
				unk_0x4BDA5AFD88C085EB(&iLocal_52);
			}
			else
			{
				unk_0x59E393B344098656(&iLocal_52);
			}
		}
		unk_0xF1A23B343DFEDFD0(iLocal_74);
		unk_0xF1A23B343DFEDFD0(iLocal_73);
		unk_0xF1A23B343DFEDFD0(iLocal_75);
		unk_0x7A8DF8C7511BE48A(unk_0x9E2D6C50374FCFA9(), 0);
		unk_0x269268AD5D4CA266(iLocal_73, 0);
		unk_0x7CD708DEB04F8474(iLocal_74, 0);
	}
	if (iLocal_97 != 0)
	{
		unk_0x527AAB28DB255A95(iLocal_97);
	}
	unk_0x7BACBB4C6A7B18B7(uLocal_59, 0);
	func_135(&uLocal_111, 0, 0);
	func_237(-1);
