	...
	switch (iLocal_59)
	{
		...
		case 1:
			if (!unk_0xA08A61313445DB46())
			{
				...
				unk_0xCF0E3BB302EAC0EA(uLocal_53);
				unk_0x694170BB080C08FF(uLocal_51, 0.2f, 0.34f, 0.410001f, 0.69f, 100, 100, 100, 255, 0);
				unk_0xCF0E3BB302EAC0EA(uLocal_54);
				if (bLocal_55)
				{
					unk_0xEA5DEA46C3EE64D3(uLocal_52, "SET_TEXT");
					func_3("KEYNOTE_NAME");
					func_3("KEYNOTE_TITLE");
					unk_0x6F06CF0E9AB02847();
					unk_0x694170BB080C08FF(uLocal_52, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
				}
			}
			else
			{
...
void func_4()
{
	...
	while (iVar1 <= (16 - 1))
	{
		if (Local_22[iVar1] != -1)
		{
			if ((!unk_0xE2D0C323A1AE5D85(uLocal_39, iVar1) && iVar0 >= Local_22[iVar1]) && iVar0 < Local_22.f_17[iVar1])
			{
				func_5();
				unk_0xCED9E32812D6C7C7(&uLocal_39, iVar1);
			}
		}
		iVar1++;
	}
...
void func_18(bool bParam0)
{
	...
	uLocal_53 = unk_0x014679E62446327A("Big_Disp");
	uLocal_54 = unk_0x56555A9ED8B80DFD();
...
{
	uParam0->f_22 = 0;
	unk_0xB0550BC91B0159D6(&uLocal_47, iParam1);
...
{
	uParam0->f_22 = 0;
	unk_0xB0550BC91B0159D6(&uLocal_45, iParam1);
	if (iParam1 == 0 && uParam0->f_22 == 0)
	{
	}
}
...
void func_23(var uParam0, int iParam1)
{
	...
	func_28(uParam0);
	unk_0xB0550BC91B0159D6(&uLocal_43, iParam1);
	switch (iParam1)
	{
		case 0:
...
void func_43()
{
	...
	unk_0x705B098546DEB18A(&uLocal_51);
	unk_0x705B098546DEB18A(&uLocal_52);
