...
void func_26(struct<4> Param0, var uParam1, var uParam2, struct<6> Param3, struct<4> Param4, var uParam5, var uParam6, var uParam7)
{
	...
	*uParam7 = { unk_0x6DB7FBD602C51670(Param4, 0f, Var0) };
...
int func_34(int iParam0)
{
	...
	if (unk_0x9315DBF7D972F07A() && func_43())
	{
		...
		uVar3 = unk_0x2E87280918B16506(&sVar2);
		if (unk_0x30057DE4703C0DA0(uVar3))
		{
			uVar4 = unk_0xBC8C74780A771297(uVar3, 426439576, 1);
