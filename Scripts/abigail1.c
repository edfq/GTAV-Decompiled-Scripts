...
void func_1()
{
	switch (iLocal_87)
	{
		case 0:
			...
			{
				if (unk_0xFCF559C8631ABED7(iLocal_83, "rcmabigail", "loop_talk", 3) || unk_0xFCF559C8631ABED7(iLocal_83, "rcmabigail", "loop_look", 3))
				{
					unk_0x49D97B076E3590AC(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 1:
			func_299();
			if ((func_303(iLocal_83) && unk_0xFCF559C8631ABED7(iLocal_83, "rcmabigail", "loop_2_cs", 3)) && unk_0xD01FAFCE275C94F3(iLocal_83, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_87++;
			}
			break;
		...
		case 2:
			...
			if (func_290(1, 1093140480, 0))
			{
				if (func_303(iLocal_83))
				{
					unk_0x48F297980C708DB7(iLocal_83, "ABIGAIL", 0, 0, 0);
				}
				func_289();
		...
		case 4:
			if (unk_0xF34D8FCAE3FD4EE4())
			{
				...
				{
					uLocal_84 = unk_0xB93A4265CB0F5B1F("DEFAULT_SCRIPTED_CAMERA", 1);
					unk_0x15F5DB94F871E803(uLocal_84, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					unk_0x15F5DB94F871E803(uLocal_84, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
					unk_0x850D4EF3D40FB068(1, 0, 3000, 1, 0, 0);
					unk_0x9BAE3263D9B1FCB9(uLocal_84, "HAND_SHAKE", 0.3f);
				}
				...
				if (func_303(iLocal_83) && unk_0x6F2E1326DB60D575("Abigail", 0))
				{
					unk_0x03A927199A2DFE46(iLocal_83);
					unk_0x7D1424753688EE7A(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
				iLocal_86 = unk_0x320D1840B6DAA1CC() + 10000;
				iLocal_87++;
			}
			break;
		
		case 5:
			if ((iLocal_89 == 0 && unk_0x2B1D7439C26D5642() == 4) && unk_0x320D1840B6DAA1CC() > (iLocal_86 - 300))
			{
			...
			if (func_224(1000) || unk_0x320D1840B6DAA1CC() > iLocal_86)
			{
	...
	if (unk_0xE5965CDF24F93A9F(Global_103480.f_4))
	{
		if (unk_0x55A0C756C4A8220C(Global_103480.f_4, 0))
		{
			if (func_281(24) != Global_103480.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_278(unk_0x6B62510F212526DC(Global_103480.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_234(Global_103480.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_260(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_299()
{
	if (func_303(unk_0xE2D3D51028F0428A()))
	{
		...
		if (iLocal_88 == 0)
		{
			if (func_303(iLocal_83))
			{
				if (func_300(unk_0xE2D3D51028F0428A(), iLocal_83, 1) < 4f || (unk_0x207D53F9E0190691(unk_0xE2D3D51028F0428A()) > 2f && func_300(unk_0xE2D3D51028F0428A(), iLocal_83, 1) < 6f))
				{
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xA829C9A2767AC8EF())
			{
				...
				Var4 = { func_314(Global_78107, Global_78109, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_345(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_351())
	{
		...
		{
			iVar2 = func_346(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
