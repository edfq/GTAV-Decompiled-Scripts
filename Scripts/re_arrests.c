...
void func_1()
{
	...
	{
		unk_0x3E3D339BAD67F6F2(iLocal_53, 129, 1);
	}
	if (func_94(iLocal_53))
	{
		if (unk_0x7114C4D8AC9360FE(iLocal_53, 0))
		{
			bLocal_284 = true;
		}
	}
	if (!unk_0xF68107C40359970C(iLocal_52) && (iLocal_47 != 2 && iLocal_47 != 1))
	{
		if (!unk_0xF68107C40359970C(iLocal_53))
		{
			switch (iLocal_50)
			{
				case 0:
					...
					if (timera() > 10)
					{
						if (!bLocal_68)
						{
							if (unk_0x174CED88B97C78D9(iLocal_52, 1227113341) == 7)
							{
								unk_0xC149E50FBB27DD70(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
							}
						}
					}
					if (timera() > 4000)
					{
						if (!bLocal_68)
						{
							if (unk_0x174CED88B97C78D9(iLocal_53, 1805844857) == 7)
							{
								if (unk_0x174CED88B97C78D9(iLocal_53, -2017877118) == 1)
								{
									unk_0xE3258B995B832E6A(iLocal_53, 2, 1);
								}
								unk_0x7734082B0EDB0BE0(iLocal_53, iLocal_52, 150f, -1, 0, 0);
							}
						}
					}
					fVar2 = unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iLocal_52, 1), unk_0x6B62510F212526DC(iLocal_53, 1), 1);
					if (timera() > 8000 || fVar2 < 1.5f)
					{
						iVar3 = func_90();
						if (iVar3 == 1)
						{
							unk_0xC149E50FBB27DD70(iLocal_52, iLocal_53, -1, 1f, 0.01f, 1073741824, 0);
						}
					}
					...
					if (timera() > 2000)
					{
						if (iVar3 || iLocal_270 == 1)
						{
							if (!func_89())
							{
								...
								bLocal_282 = (unk_0x32DCDA1B2F8A0694(iLocal_53) || unk_0x03454821A9ECF4AA(iLocal_53));
								if (!unk_0x8FEA2E94638F9767(iLocal_52, joaat("weapon_pistol"), 0))
								{
									unk_0x9521FB98DB6DDF50(iLocal_52, joaat("weapon_pistol"), -1, 0, 1);
								}
								unk_0x202B28FEABEC4034(iLocal_52, joaat("weapon_pistol"), 1);
								Local_64 = { unk_0x6B62510F212526DC(iLocal_53, 1) };
								unk_0x03A927199A2DFE46(iLocal_52);
								unk_0xA888F8CC04F25CC8(&uLocal_67);
								if (!bLocal_282 && fVar2 > 2f)
								{
									unk_0xA99AD9DEE4794C48(0, Local_64.x, Local_64.f_1, (Local_64.f_2 + 4f), 1000, 1566631136);
								}
								unk_0xF30F15F203736DE4(0, iLocal_53, -1, 2048, 2);
								unk_0x0B47872E9D74882C(0, iLocal_53, iLocal_53, 1f, 0, 3f, 1082130432, 1, 0, -957453492);
								unk_0x636B3584208A6D73(0, iLocal_53, 5000, 0);
								unk_0xC963A45B50851768(uLocal_67);
								unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
								unk_0x7461D7C5BA953BC7(&uLocal_67);
								unk_0xE68645525D451A8B(iLocal_52);
								...
								if (bLocal_282)
								{
									...
									unk_0xA6D4FBB3B47CF11E(iLocal_53);
									iLocal_50 = 4;
								}
								else
								{
					...
					{
						if (!unk_0xF68107C40359970C(iLocal_52) && !unk_0x55B23FE400FCEA6B(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0))
						{
							if (unk_0x72F6AE51B7E34865(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), iLocal_52))
							{
								unk_0x03A927199A2DFE46(iLocal_52);
								iLocal_50 = 1;
								unk_0x83F5BCFFFBA26699(iLocal_52, 500);
							}
						}
					}
					break;
				...
				case 1:
					if (unk_0x174CED88B97C78D9(iLocal_52, -982327190) == 7)
					{
						unk_0xC149E50FBB27DD70(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
						iLocal_50 = 0;
					}
				...
				case 2:
					if ((unk_0x320D1840B6DAA1CC() - iLocal_240) > 1000)
					{
						Var1 = { 0f, 0f, (unk_0x82FE2343F8BDFF0B(iLocal_53) * 3f) };
						unk_0x7D1424753688EE7A(iLocal_53, Var1, 2f, -1, 1f, 1024, 1193033728);
						iLocal_50 = 3;
					}
					break;
				
				case 3:
					if ((unk_0x320D1840B6DAA1CC() - iLocal_240) > 4500)
					{
						iLocal_50 = 4;
					}
					break;
				...
				case 4:
					bLocal_68 = true;
					unk_0xA888F8CC04F25CC8(&uLocal_67);
					unk_0x49D97B076E3590AC(0, sLocal_250, "idle_2_hands_up", 2f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xC963A45B50851768(uLocal_67);
					unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
					unk_0x7461D7C5BA953BC7(&uLocal_67);
					unk_0xE68645525D451A8B(iLocal_53);
					unk_0xABC2CA6F28903308(iLocal_53, 1);
					unk_0x70D9EC5AF67D79C4(iLocal_53, 1);
					iLocal_50 = 5;
					break;
				...
				case 5:
					if (iLocal_48 == 3)
					{
						if (unk_0x174CED88B97C78D9(iLocal_52, 242628503) == 7)
						{
							unk_0x03A927199A2DFE46(iLocal_52);
							if (!unk_0x8FEA2E94638F9767(iLocal_52, joaat("weapon_pistol"), 0))
							{
							...
							unk_0x202B28FEABEC4034(iLocal_52, joaat("weapon_pistol"), 1);
							unk_0xA888F8CC04F25CC8(&uLocal_67);
							unk_0x636B3584208A6D73(0, iLocal_53, -1, 0);
							unk_0xC963A45B50851768(uLocal_67);
							unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
							unk_0x7461D7C5BA953BC7(&uLocal_67);
							unk_0xABC2CA6F28903308(iLocal_52, 1);
				...
				case 6:
					if (unk_0x55A0C756C4A8220C(iLocal_55, 0) && !unk_0xF68107C40359970C(iLocal_54))
					{
						unk_0x7928629159F456D1(iLocal_55, 1);
						if (unk_0x174CED88B97C78D9(iLocal_52, -2017877118) == 7)
						{
							if (unk_0x174CED88B97C78D9(iLocal_54, -1273030092) == 7)
							{
								if (unk_0x33168C7A83D47CC0(iLocal_53, iLocal_55, 2, 0, 0))
								{
									if (!unk_0xF68107C40359970C(iLocal_53))
									{
										if (!unk_0x87B449F4C26E764A(iLocal_53, iLocal_55))
										{
											if (!unk_0xCED7266BAB0BDC20(iLocal_53, 0))
											{
												if (unk_0x174CED88B97C78D9(iLocal_53, -1794415470) == 7)
												{
													unk_0xA888F8CC04F25CC8(&uLocal_67);
													unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_get_up", 8f, -2f, -1, 0, 0, 0, 0, 0);
													unk_0xC963A45B50851768(uLocal_67);
													unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
													unk_0x7461D7C5BA953BC7(&uLocal_67);
													unk_0x9972EFADA7A2A47D(0, iLocal_66, iLocal_65);
													unk_0x9972EFADA7A2A47D(0, iLocal_65, iLocal_66);
												}
											}
										}
									}
									...
									{
										unk_0x963E9AB0C31726BD(iLocal_52);
										if (!unk_0xCED7266BAB0BDC20(iLocal_52, 0))
										{
											if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
											{
												if (!func_89())
												{
													if (func_74(&uLocal_72, "REARRAU", "REARR_INCAR", 4, iLocal_246, 0, 0))
													{
														...
														{
															if (unk_0x2E7F5417D4F4DD69(iLocal_54, iLocal_53, 180f))
															{
														...
														else if (unk_0x2E7F5417D4F4DD69(iLocal_54, iLocal_53, 180f))
														{
															Local_283 = { -2.978f, -0.75f, 1f };
														}
														else
														...
														unk_0xA888F8CC04F25CC8(&uLocal_67);
														unk_0x98DB2ABD53B8D70B(0, unk_0xCACAD935C0BEE14F(iLocal_55, Local_283), iLocal_53, 0.75f, 0, 0.5f, 4f, 1, 0, 0, -957453492, 60000);
														unk_0x636B3584208A6D73(0, iLocal_53, -1, 0);
														unk_0xC963A45B50851768(uLocal_67);
														unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
														unk_0x7461D7C5BA953BC7(&uLocal_67);
														unk_0xABC2CA6F28903308(iLocal_52, 1);
														unk_0xBF0DDDDACD98C554(iLocal_55, 0);
														iLocal_238 = 8000;
														settimerb(0);
				...
				case 7:
					if (!unk_0xF68107C40359970C(iLocal_52))
					{
						if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 35f, 35f, 35f, 0, 1, 0))
						{
							if ((unk_0x320D1840B6DAA1CC() - iLocal_269) > 8000)
							{
								if (!func_89())
								{
									unk_0xF30F15F203736DE4(iLocal_52, unk_0xE2D3D51028F0428A(), 6000, 2048, 2);
						...
						if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
						{
							if (iLocal_62)
							{
								if (func_72(iLocal_52, iLocal_55) == 2)
								{
									unk_0xB486640392EC50BB(iLocal_53, iLocal_55, -1, 2, 1f, 1, 0);
								}
								else
								{
									unk_0xB486640392EC50BB(iLocal_53, iLocal_55, -1, 1, 1f, 1, 0);
								}
								iLocal_50 = 8;
							}
							else if (iLocal_61)
							{
								fVar4 = unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iLocal_53, 1), unk_0x6B62510F212526DC(iLocal_55, 1), 1);
								if (fVar4 < 4f && iLocal_273 == 0)
								{
									unk_0xB17A6034B9F1BCC2(iLocal_53, iLocal_55, 60000, 0.5f, Local_283.x, Local_283.f_1, 1f, 1);
									iLocal_273 = 1;
								}
								else if (fVar4 < 3f)
								{
							...
							else if (!unk_0xFCF559C8631ABED7(iLocal_53, sLocal_250, "kneeling_arrest_get_up", 3))
							{
								if (func_72(iLocal_52, iLocal_55) == 2)
								{
								...
								if (bLocal_284)
								{
									unk_0xABFC84F5C4943D7B(iLocal_53, "MOVE_M@BAIL_BOND_TAZERED", 1048576000);
								}
								else
								{
									unk_0xABFC84F5C4943D7B(iLocal_53, "MOVE_M@BAIL_BOND_NOT_TAZERED", 1048576000);
								}
								iLocal_61 = 1;
							}
						}
				...
				case 8:
					if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
					{
						if (!unk_0xF68107C40359970C(iLocal_54))
						{
							if (unk_0x87B449F4C26E764A(iLocal_53, iLocal_55))
							{
								if (unk_0x12DD4A0B247D9B4D(uLocal_56))
								{
									unk_0xFFD8EB5462B07B59(&uLocal_56);
								}
								if (unk_0x12DD4A0B247D9B4D(uLocal_57))
								{
									unk_0xFFD8EB5462B07B59(&uLocal_57);
								}
								if (unk_0x87B449F4C26E764A(iLocal_52, iLocal_55))
								{
									unk_0xAD6CDBCDA713560A(iLocal_54, iLocal_55, 10f, 786603);
									unk_0xABC2CA6F28903308(iLocal_54, 1);
									unk_0x50274A7EACA3133A(iLocal_52, 0);
									func_177();
								}
								else if (unk_0x174CED88B97C78D9(iLocal_52, -1794415470) == 7)
								{
									unk_0x03A927199A2DFE46(iLocal_52);
									unk_0xB486640392EC50BB(iLocal_52, iLocal_55, 20000, 0, 1f, 1, 0);
									unk_0xABC2CA6F28903308(iLocal_52, 1);
								}
							}
						}
		...
		if (!unk_0xF68107C40359970C(iLocal_53))
		{
			...
			else
			{
				if (iLocal_47 == 1 || iLocal_47 == 3)
				{
					if (!func_89())
					{
						if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iLocal_53, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 1) < 20f)
						{
							func_74(&uLocal_72, "REARRAU", sLocal_266, 4, iLocal_246, 0, 0);
						}
					}
				}
				if (unk_0xFCF559C8631ABED7(iLocal_53, sLocal_250, "kneeling_arrest_idle", 3))
				{
					unk_0xA888F8CC04F25CC8(&uLocal_67);
					unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_get_up", 2f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_2()
{
	...
	Var1 = { 40f, 40f, 20f };
	if (unk_0x320D1840B6DAA1CC() > iLocal_247 + 1000)
	{
		if (!unk_0xF68107C40359970C(iLocal_52))
		{
			if (!unk_0x77A43AFA9AAEC041(iLocal_52, unk_0xE2D3D51028F0428A(), Var1, 0, 1, 0))
			{
				iVar0++;
			}
		}
		...
		if (!unk_0xF68107C40359970C(iLocal_53))
		{
			if (!unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), Var1, 0, 1, 0))
			{
				iVar0++;
			}
		}
...
void func_3(bool bParam0)
{
	...
	if (!unk_0xF68107C40359970C(iLocal_52))
	{
		switch (iLocal_48)
		{
			case 0:
				if ((iLocal_237 == 3 || iLocal_50 == 5) || iLocal_50 == 6)
				{
					if (!func_89())
					{
						unk_0x03A927199A2DFE46(iLocal_52);
						unk_0xA888F8CC04F25CC8(&uLocal_67);
						unk_0xE1E1AF00CA06A2B7(0, unk_0x6B62510F212526DC(iLocal_53, 0), 10000, 0, 2);
						unk_0x49D97B076E3590AC(0, sLocal_250, sVar0, 8f, -4f, -1, 0, 0, 0, 0, 0);
						unk_0x49D97B076E3590AC(0, sLocal_250, sVar1, 16f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0xC963A45B50851768(uLocal_67);
						unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
						unk_0x7461D7C5BA953BC7(&uLocal_67);
						iLocal_48 = 1;
			...
			case 1:
				if (unk_0xFCF559C8631ABED7(iLocal_52, sLocal_250, sVar1, 3))
				{
					if (!unk_0xF68107C40359970C(iLocal_53))
					{
						if (!func_89())
			...
			case 2:
				if (!func_89())
				{
					if (func_10())
					{
						if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
						{
							unk_0xAF026BFB427D2C6F(iLocal_55, 0);
							unk_0xBF0DDDDACD98C554(iLocal_55, 1);
						}
						unk_0x03A927199A2DFE46(iLocal_52);
						unk_0xA888F8CC04F25CC8(&uLocal_67);
						unk_0x49D97B076E3590AC(0, sLocal_250, sVar2, 8f, -1.5f, -1, 0, 0, 0, 0, 0);
						unk_0xC963A45B50851768(uLocal_67);
						unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
						unk_0x7461D7C5BA953BC7(&uLocal_67);
						unk_0xEB087B19F63AB053(iLocal_52, 0, 0);
						func_8();
						iLocal_48 = 3;
					}
				}
			...
			case 3:
				...
				{
					if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_53))
					{
						if (!func_89())
						{
				...
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 35f, 35f, 35f, 0, 1, 0))
				{
					unk_0x6C600C7A5953076D(iLocal_52, 1, unk_0xE2D3D51028F0428A(), 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x6C600C7A5953076D(unk_0xE2D3D51028F0428A(), 1, iLocal_52, 31086, 0f, 0f, 0f, 0, -1, -1);
					if (timerb() > iLocal_238 || iLocal_254)
					{
						if (iLocal_47 == 3 || iLocal_47 == 0)
						{
							if (!unk_0xF68107C40359970C(iLocal_53))
							{
								...
								{
									unk_0xF30F15F203736DE4(iLocal_52, unk_0xE2D3D51028F0428A(), 500, 2048, 2);
									func_74(&uLocal_72, "REARRAU", "REARR_PLEAVE", 4, iLocal_246, 0, 0);
									iLocal_238 = 8000;
								}
							}
						...
						else
						{
							...
							else if (!func_89())
							{
								unk_0xF30F15F203736DE4(iLocal_52, unk_0xE2D3D51028F0428A(), 6000, 2048, 2);
								func_74(&uLocal_72, "REARRAU", "REARR_PLEAVE", 4, iLocal_246, 0, 0);
								iLocal_238 = unk_0x5853B15F78E1A265(8, 22);
								iLocal_238 *= 30000;
							}
							settimerb(0);
						}
				...
				if (iLocal_50 != 8)
				{
					if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
					{
						if (!unk_0xF68107C40359970C(iLocal_53))
						{
							if (!unk_0xF6F5D18EF8EAB859(iLocal_53, iLocal_55, 0))
							{
								func_71();
							}
						}
...
void func_4()
{
	if (!iLocal_254)
	{
		...
		unk_0xA888F8CC04F25CC8(&uLocal_67);
		unk_0x49D97B076E3590AC(0, sLocal_251, "enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(0, sLocal_251, sLocal_252, 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(0, sLocal_251, "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 9, 0, 0, 0, 0);
		unk_0xC963A45B50851768(uLocal_67);
		unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
		unk_0x7461D7C5BA953BC7(&uLocal_67);
		iLocal_254 = 1;
	}
	else if (unk_0xFCF559C8631ABED7(iLocal_53, sLocal_251, "enter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0xFCF559C8631ABED7(iLocal_53, sLocal_251, "exit", 3))
	{
	}
	else if (unk_0xFCF559C8631ABED7(iLocal_53, sLocal_251, sLocal_252, 3))
	{
...
int func_5()
{
	if (unk_0x320D1840B6DAA1CC() > iLocal_256 + 6000)
	{
		iLocal_256 = unk_0x320D1840B6DAA1CC();
		return 1;
	}
	return 0;
}
...
void func_6()
{
	...
	{
		unk_0xA888F8CC04F25CC8(&uLocal_67);
		unk_0x49D97B076E3590AC(0, sLocal_250, "radio_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(0, sLocal_250, "radio_chatter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(0, sLocal_250, "radio_exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0x636B3584208A6D73(0, iLocal_53, -1, 0);
		unk_0xC963A45B50851768(uLocal_67);
		unk_0x8ACADA903FCAA42F(iLocal_52, uLocal_67);
		unk_0x7461D7C5BA953BC7(&uLocal_67);
	...
	else if (unk_0xFCF559C8631ABED7(iLocal_52, sLocal_250, "radio_chatter", 3))
	{
		if (func_5())
		{
	...
	else if (unk_0xFCF559C8631ABED7(iLocal_52, sLocal_250, "radio_exit", 3))
	{
		iLocal_255 = 0;
		func_8();
	}
	...
	switch (iLocal_49)
	{
		case 0:
			if (!bLocal_68)
			{
				...
				unk_0x55B23FE400FCEA6B(iLocal_52, 0);
				unk_0x55B23FE400FCEA6B(iLocal_53, 0);
				if (unk_0xE5965CDF24F93A9F(iLocal_52) && unk_0xE5965CDF24F93A9F(iLocal_53))
				{
					unk_0xB17A6034B9F1BCC2(iLocal_52, iLocal_53, -1, 3f, 0f, 0f, 1f, 0);
				}
				settimerb(0);
			}
			break;
		...
		case 2:
			if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_279) > 20000)
				{
					if (!unk_0xF68107C40359970C(iLocal_54))
					{
						if (unk_0x174CED88B97C78D9(iLocal_54, -1273030092) == 7)
						{
							unk_0xB486640392EC50BB(iLocal_52, iLocal_55, -1, 0, 1f, 1, 0);
							iLocal_49 = 3;
						}
					}
				}
...
int func_10()
{
	...
	{
		if (unk_0x29579BC5971CA4B6(unk_0x6B62510F212526DC(iLocal_52, 0), 1, &Var0, 1, 1077936128, 0))
		{
			if (unk_0xAE32AE15890AA504(&Var0, &Var2, &uVar3, 0f, 180f, 50f, 1, 1, 1))
			{
				iLocal_55 = unk_0xBA715A7BEBA5A1F9(iVar4, Var2, 0, 1, 1, 0);
				iLocal_54 = unk_0x487C17B41938052C(iLocal_55, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				...
				unk_0xFF4BEB6CFF55A013(iLocal_54, iLocal_65);
				unk_0x3B2646B62E7BBE11(iLocal_55, 3);
				unk_0x50274A7EACA3133A(iLocal_54, 1);
				unk_0x9F65B3BAFA302A65(iLocal_55, 1084227584);
				unk_0x1B3814E11B085F5E(iLocal_55, 1);
				unk_0x11647D34B93A72EB(iLocal_55, 1);
				Var0 = { unk_0x6B62510F212526DC(iLocal_55, 1) };
				Var1 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) - Var0 };
				unk_0xBBF86885619695CE(iLocal_55, unk_0xD12EFCAB87804BED(Var1.x, Var1.f_1));
				unk_0x29579BC5971CA4B6(unk_0x6B62510F212526DC(iLocal_52, 0), 1, &Var0, 1, 1077936128, 0);
				...
				unk_0xFDB121077308E944(iLocal_54, iLocal_55, Var0, 4, 7f, 786471, 5f, -1f, 1);
				unk_0xB2D5451CC5606248(iLocal_55, 4f);
				unk_0xBF0DDDDACD98C554(iLocal_55, 1);
				iLocal_71 = 1;
...
int func_11()
{
	...
	{
		case 0:
			if (unk_0x174CED88B97C78D9(iLocal_52, 242628503) == 7 || unk_0x320D1840B6DAA1CC() > iLocal_240 + 15000)
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 25f, 25f, 25f, 0, 1, 0))
				{
					if (!unk_0xF68107C40359970C(iLocal_52))
					{
						unk_0x03A927199A2DFE46(iLocal_52);
						...
						{
							unk_0xC149E50FBB27DD70(0, iLocal_53, -1, 3.5f, 2f, 1073741824, 0);
						}
		...
		case 1:
			if (unk_0x174CED88B97C78D9(iLocal_52, 242628503) == 1)
			{
				if (unk_0x0829092F169950AB(iLocal_52) > 0)
				{
					if (!func_89())
					{
						if (iLocal_239 < 2)
						{
							...
							if (unk_0x12DD4A0B247D9B4D(uLocal_56))
							{
								unk_0xD809204F14EF9B68(uLocal_56, 1);
							}
						}
						else
						{
		...
		case 2:
			...
			unk_0x529D306014D3C29A(iLocal_52, unk_0xE2D3D51028F0428A(), 100);
			break;
...
void func_12()
{
	...
	bVar0 = unk_0x0747E45CFF1F74AA(iLocal_53, unk_0xE2D3D51028F0428A(), 1);
	bVar1 = func_56();
	if (bVar1)
	{
	}
				...
				if (iLocal_47 == 2 || bLocal_68 == 1)
				{
					switch (iLocal_241)
					{
						case 8:
							...
							unk_0xD809204F14EF9B68(uLocal_57, 1);
							if (!unk_0x55B23FE400FCEA6B(iLocal_53, 0) && unk_0xFCF559C8631ABED7(iLocal_53, sLocal_250, "kneeling_arrest_idle", 3))
							{
								unk_0xA888F8CC04F25CC8(&uLocal_67);
								unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
								unk_0xC963A45B50851768(uLocal_67);
								unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
								unk_0x7461D7C5BA953BC7(&uLocal_67);
								iLocal_241 = 9;
						...
						case 9:
							...
							if (unk_0x174CED88B97C78D9(iLocal_53, 242628503) == 7)
							{
								iLocal_241 = 0;
							}
							break;
						...
						case 0:
							...
							if (unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), 75f, 75f, 75f, 0, 1, 0))
							{
								unk_0x059473086913178C(iLocal_53, 1);
								iLocal_241 = 3;
							}
							break;
						...
						case 1:
							...
							if (unk_0x8F41785F110B0DA0(iLocal_53, unk_0x6B62510F212526DC(iLocal_52, 0), 4f, 4f, 3f, 0, 1, 0))
							{
								iLocal_241 = 2;
							}
							else
							{
								unk_0x03A927199A2DFE46(iLocal_53);
								unk_0xA888F8CC04F25CC8(&uLocal_67);
								unk_0xE1E1AF00CA06A2B7(0, unk_0x6B62510F212526DC(iLocal_52, 0), 1000, 0, 2);
								unk_0x7D1424753688EE7A(0, unk_0x6B62510F212526DC(iLocal_52, 0), 2f, -1, 3f, 0, 1193033728);
								unk_0xC963A45B50851768(uLocal_67);
								unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
								unk_0x7461D7C5BA953BC7(&uLocal_67);
								iLocal_241 = 2;
						...
						case 2:
							...
							if (unk_0x8F41785F110B0DA0(iLocal_53, unk_0x6B62510F212526DC(iLocal_52, 0), 4f, 4f, 3f, 0, 1, 0))
							{
								if (unk_0x174CED88B97C78D9(iLocal_53, 242628503) == 7 || func_74(&uLocal_72, "REARRAU", sLocal_263, 4, iLocal_246, 0, 0))
								{
									iLocal_241 = 6;
								}
							}
							else if (unk_0x174CED88B97C78D9(iLocal_53, 242628503) == 7)
							{
								unk_0xA888F8CC04F25CC8(&uLocal_67);
								unk_0xE1E1AF00CA06A2B7(0, unk_0x6B62510F212526DC(iLocal_52, 0), 1000, 0, 2);
								unk_0x7D1424753688EE7A(0, unk_0x6B62510F212526DC(iLocal_52, 0), 2f, -1, 3f, 0, 1193033728);
						...
						case 3:
							...
							if (unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), 5f, 5f, 3f, 0, 1, 0))
							{
								iLocal_241 = 4;
							}
							else if (unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), 75f, 75f, 75f, 0, 1, 0))
							{
								if (!func_89())
								{
									unk_0x03A927199A2DFE46(iLocal_53);
						...
						case 4:
							...
							if (unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), 9f, 9f, 9f, 0, 1, 0))
							{
								iLocal_280 = unk_0x320D1840B6DAA1CC();
								iLocal_241 = 7;
							}
							break;
						...
						case 7:
							...
							if (!unk_0xB15EF36AD557325B(iLocal_53, unk_0xE2D3D51028F0428A()))
							{
								unk_0xF30F15F203736DE4(iLocal_53, unk_0xE2D3D51028F0428A(), -1, 2064, 2);
							}
							if (!unk_0x2E7F5417D4F4DD69(iLocal_53, unk_0xE2D3D51028F0428A(), 30f))
							{
								unk_0x529D306014D3C29A(iLocal_53, unk_0xE2D3D51028F0428A(), -1);
							}
							if ((unk_0x320D1840B6DAA1CC() - iLocal_280) > 2000)
							{
								iLocal_241 = 5;
							}
							break;
						...
						case 5:
							...
							if (unk_0xFCF559C8631ABED7(iLocal_53, sLocal_250, "Thanks_Male_05", 3) || unk_0x174CED88B97C78D9(iLocal_53, 242628503) == 7)
							{
								if (!func_89())
								{
									if (iLocal_239 < 2)
									{
										...
										unk_0x49D97B076E3590AC(iLocal_53, sLocal_250, "Thanks_Male_05", 16f, -16f, -1, 16, 0, 0, 0, 0);
									}
									else
									{
...
int func_56()
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
	{
		if (unk_0x77A43AFA9AAEC041(iLocal_55, iLocal_53, fVar0, fVar0, fVar0, 0, 1, 0))
		{
			return 1;
		}
	}
	iVar1 = unk_0xE66E6FDCD35AFAFE(unk_0x6B62510F212526DC(iLocal_53, 0), fVar0, fVar0, fVar0, -1);
	...
	iVar2 = unk_0x8AA54390E994CE1B(unk_0x6B62510F212526DC(iLocal_53, 0), fVar0, 0, 1024);
...
void func_57()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_53))
	{
		bVar0 = unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_53);
		uVar1 = unk_0x0747E45CFF1F74AA(iLocal_53, unk_0xE2D3D51028F0428A(), 1);
		if (((uVar1 || func_70()) || func_68()) || bVar0)
		{
			func_67();
			if (bLocal_68)
			{
				if (((bVar0 || uVar1) && !unk_0x32DCDA1B2F8A0694(iLocal_53)) && !unk_0xD5C6B5E3B93A5EDC(iLocal_53, 0))
				{
					unk_0x03A927199A2DFE46(iLocal_53);
					unk_0x33021F68EDB8F06E(iLocal_53, 500, 2000, 0, 0, 0, 0);
					unk_0x402A537158A551BD(iLocal_53, -1);
					unk_0xABC2CA6F28903308(iLocal_53, 1);
				}
				else if (!unk_0xD5C6B5E3B93A5EDC(iLocal_53, 0) && !unk_0x32DCDA1B2F8A0694(iLocal_53))
				{
					unk_0x03A927199A2DFE46(iLocal_53);
					unk_0x402A537158A551BD(iLocal_53, -1);
					unk_0xABC2CA6F28903308(iLocal_53, 1);
				...
				if (!func_89())
				{
					if (!unk_0xF68107C40359970C(iLocal_52) && iLocal_274 == 0)
					{
	...
	if (!unk_0xF68107C40359970C(iLocal_52))
	{
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_54))
		{
			if (!unk_0xF68107C40359970C(iLocal_54))
			{
				if ((unk_0x0747E45CFF1F74AA(iLocal_54, unk_0xE2D3D51028F0428A(), 1) && unk_0x0CF63873D754B965(iLocal_54) < 190) || (unk_0x0747E45CFF1F74AA(iLocal_54, unk_0xE2D3D51028F0428A(), 1) && unk_0x32DCDA1B2F8A0694(iLocal_54)))
				{
					iVar2 = 1;
				}
				if (unk_0xE5965CDF24F93A9F(iLocal_55) && unk_0x0747E45CFF1F74AA(iLocal_55, unk_0xE2D3D51028F0428A(), 1))
				{
					iVar2 = 1;
				}
			}
		...
		if ((((((unk_0x0747E45CFF1F74AA(iLocal_52, unk_0xE2D3D51028F0428A(), 1) && unk_0x0CF63873D754B965(iLocal_52) < 190) || func_61()) || unk_0x37BBF9ACD752871A(unk_0x9E2D6C50374FCFA9(), 0)) || func_60()) || (unk_0x0747E45CFF1F74AA(iLocal_52, unk_0xE2D3D51028F0428A(), 1) && unk_0x32DCDA1B2F8A0694(iLocal_52))) || iVar2 == 1)
		{
			func_63(1);
	...
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_52, unk_0xE2D3D51028F0428A(), 1))
		{
			if (iLocal_275 == 0)
			{
				iLocal_275 = 1;
	...
	if (iLocal_275)
	{
		if ((unk_0x320D1840B6DAA1CC() - iLocal_278) > 5000)
		{
	...
	if (!unk_0xF68107C40359970C(iLocal_52) && !unk_0xF68107C40359970C(iLocal_53))
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_52, unk_0xE2D3D51028F0428A(), 1) && unk_0x0747E45CFF1F74AA(iLocal_53, unk_0xE2D3D51028F0428A(), 1))
		{
			if (unk_0x0CF63873D754B965(iLocal_52) < 190 && unk_0x0CF63873D754B965(iLocal_53) < 190)
			{
				func_67();
				func_63(1);
				iLocal_47 = 1;
		...
		if (!unk_0x77A43AFA9AAEC041(iLocal_53, iLocal_52, 110f, 110f, 40f, 0, 1, 0))
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 20f, 20f, 20f, 0, 1, 0))
			{
				func_58();
				wait(0);
				func_74(&uLocal_72, "REARRAU", "REARR_PORUN", 4, iLocal_246, 0, 0);
			}
			else if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_53, 40f, 40f, 40f, 0, 1, 0))
			{
				func_58();
				wait(0);
	...
	if (unk_0xF68107C40359970C(iLocal_53))
	{
		if (!unk_0xF68107C40359970C(iLocal_52))
		{
			if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 100f, 100f, 40f, 0, 1, 0))
			{
				func_177();
			}
		}
...
int func_61()
{
	...
	Var0 = { 3f, 3f, 3f };
	Var1 = { -3f, -3f, -3f };
	if (unk_0x9AC74C7EF847A074(unk_0x6EA486FF6D815B4B(iLocal_52, 31086, 0f, 0f, 0f), 0.5f, 1))
	{
		if (unk_0xF68107C40359970C(iLocal_53))
		{
			return 1;
		}
		else if (!unk_0x9AC74C7EF847A074(unk_0x6EA486FF6D815B4B(iLocal_53, 31086, 0f, 0f, 0f), 2f, 1))
		{
			return 1;
		}
	}
	if (unk_0x6A1EDF18639D033E(unk_0x6EA486FF6D815B4B(iLocal_52, 31086, 0f, 0f, 0f), 3f))
	{
		return 1;
	}
	if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 5f, 5f, 5f, 0, 1, 0))
	{
		if (!unk_0xF68107C40359970C(iLocal_52))
		{
			if (unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_52) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_52))
			{
		...
		if (!unk_0xF68107C40359970C(iLocal_53))
		{
			if (unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_53) || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_53))
			{
				if (unk_0xA7E29842FA438ED6(unk_0xE2D3D51028F0428A(), &iVar2, 1))
				{
					if (iVar2 != joaat("weapon_unarmed"))
	...
	Var0 = { Var0 + unk_0x6EA486FF6D815B4B(iLocal_52, 31086, 0f, 0f, 0f) };
	Var1 = { Var1 + unk_0x6EA486FF6D815B4B(iLocal_52, 31086, 0f, 0f, 0f) };
...
void func_63(int iParam0)
{
	if (!unk_0xF68107C40359970C(iLocal_52))
	{
		...
		if (!bLocal_59)
		{
			...
			unk_0xB78CBE6C9550E5EF(unk_0x9E2D6C50374FCFA9(), 0);
			unk_0xA7266A50941DBAEA(iLocal_52, 1);
			if (unk_0x12DD4A0B247D9B4D(uLocal_56))
			{
				unk_0xD809204F14EF9B68(uLocal_56, 0);
			}
			if (iParam0 == 1)
			{
				if (!unk_0xF68107C40359970C(iLocal_53))
				{
					if (unk_0x174CED88B97C78D9(iLocal_53, 1805844857) == 7)
					{
						...
						{
							unk_0xA888F8CC04F25CC8(&uLocal_67);
							unk_0x49D97B076E3590AC(0, sLocal_250, "kneeling_arrest_escape", 8f, -8f, -1, 4096, 0, 0, 0, 0);
							unk_0x7734082B0EDB0BE0(0, iLocal_52, 150f, -1, 0, 0);
							unk_0xC963A45B50851768(uLocal_67);
							unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
							unk_0x7461D7C5BA953BC7(&uLocal_67);
							unk_0xA8685678DDA27FC3(iLocal_53, -530524, 0, 0, 0);
							unk_0xABC2CA6F28903308(iLocal_53, 1);
						}
						else
						{
				...
				if ((!unk_0x55B23FE400FCEA6B(iLocal_53, 0) && !unk_0xF68107C40359970C(iLocal_53)) && !unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
				{
					if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iLocal_53, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 1) < 20f)
					{
						if (!func_89())
			...
			unk_0x7461D7C5BA953BC7(&uLocal_67);
			unk_0xABC2CA6F28903308(iLocal_52, 1);
			unk_0x06AF73D7E3DF7782(iLocal_52, 1, 0);
			if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
			{
...
void func_64()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_54))
	{
		if (!unk_0xF68107C40359970C(iLocal_54))
		{
			...
			unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
			unk_0xC963A45B50851768(uLocal_67);
			unk_0x8ACADA903FCAA42F(iLocal_54, uLocal_67);
			unk_0x7461D7C5BA953BC7(&uLocal_67);
			unk_0xABC2CA6F28903308(iLocal_54, 1);
...
void func_67()
{
	if (!unk_0xF68107C40359970C(iLocal_53))
	{
		if (unk_0x12DD4A0B247D9B4D(uLocal_57))
		{
			unk_0xD809204F14EF9B68(uLocal_57, 0);
		}
		unk_0xE68645525D451A8B(iLocal_53);
	}
}
...
int func_68()
{
	if (!unk_0x55B23FE400FCEA6B(iLocal_52, 0))
	{
		if (bLocal_68)
		{
			if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_52))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_268) > 1000)
				{
					func_69();
				}
			}
	...
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		if (unk_0x72F6AE51B7E34865(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), iLocal_53))
		{
			if (bLocal_68)
			{
				if (iLocal_50 != 7)
				{
					if (vdist(unk_0x6B62510F212526DC(iLocal_53, 1), Local_64) > 2.5f)
					{
						return 1;
					}
				}
		...
		switch (iLocal_239)
		{
			...
			case 1:
				if (!func_89())
				{
					if (!unk_0xF68107C40359970C(iLocal_53))
					{
						...
						unk_0xABC2CA6F28903308(iLocal_53, 1);
						unk_0xF160248D9083ED0C(iLocal_53, 101, 0);
			...
			case 2:
				if (!unk_0xF68107C40359970C(iLocal_52))
				{
					if (!unk_0xF68107C40359970C(iLocal_53))
					{
						unk_0x9972EFADA7A2A47D(2, iLocal_66, iLocal_65);
						unk_0x9972EFADA7A2A47D(2, iLocal_65, iLocal_66);
						unk_0xC1A74225341AA9FB(iLocal_52, iLocal_53, 0, 16);
					}
					else
					{
						unk_0xD86A0BC9CC0A625A(iLocal_52, 1193033728, 0);
						func_177();
					}
					unk_0xABC2CA6F28903308(iLocal_52, 1);
				}
...
int func_72(int iParam0, int iParam1)
{
	...
	if (unk_0x55A0C756C4A8220C(iParam1, 0))
	{
		...
		Var1 = { unk_0xCACAD935C0BEE14F(iParam1, 1f, -0.5f, 0f) };
		Var3 = { Var1 - Var0 };
		Var2 = { unk_0xCACAD935C0BEE14F(iParam1, -1f, -0.5f, 0f) };
		Var4 = { Var2 - Var0 };
...
void func_73()
{
	if (!func_89())
	{
		if (!iLocal_281)
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 30f, 30f, 30f, 0, 1, 0))
			{
		...
		else if (timerb() > 8000)
		{
			...
			else if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_53, 10f, 10f, 10f, 0, 1, 0))
			{
				func_74(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
			}
			else if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, 10f, 10f, 10f, 0, 1, 0))
			{
				func_74(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
			}
			else
...
int func_90()
{
	if (unk_0x77A43AFA9AAEC041(iLocal_53, iLocal_52, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_93())
	{
...
int func_91(float fParam0)
{
	...
	if (unk_0x45D982DAE0BE3255(unk_0x6B62510F212526DC(iLocal_53, 1), &uVar0, &Var1))
	{
...
void func_95()
{
	if ((unk_0x320D1840B6DAA1CC() - iLocal_245) > 500)
	{
		if ((iLocal_47 != 1 && iLocal_47 != 3) && iLocal_47 != 2)
		{
			if (unk_0x12DD4A0B247D9B4D(uLocal_57))
			{
				unk_0xD809204F14EF9B68(uLocal_57, iLocal_242);
				if (iLocal_242 == 1)
				{
					iLocal_242 = 0;
				}
		...
		if (!bLocal_59)
		{
			if (unk_0x12DD4A0B247D9B4D(uLocal_56))
			{
				unk_0xD809204F14EF9B68(uLocal_56, iLocal_243);
				if (iLocal_243 == 1)
				{
					iLocal_243 = 0;
				}
	...
	if (!bLocal_277 == bLocal_276)
	{
		if (bLocal_276)
		{
			...
			if (unk_0x12DD4A0B247D9B4D(uLocal_56))
			{
				unk_0x3430966AC4550BB9(uLocal_56, 1);
			}
		}
		else
		{
			...
			if (unk_0x12DD4A0B247D9B4D(uLocal_56))
			{
				unk_0x3430966AC4550BB9(uLocal_56, 0);
			}
		}
...
int func_96(float fParam0)
{
	...
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_271, Local_272, 194.75f, 0, 1, 0))
	{
		return 1;
	}
	if (!unk_0xF68107C40359970C(iLocal_52))
	{
		if (unk_0x77A43AFA9AAEC041(iLocal_52, unk_0xE2D3D51028F0428A(), Var2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
	...
	if (!unk_0xF68107C40359970C(iLocal_53))
	{
		if (unk_0x77A43AFA9AAEC041(iLocal_53, unk_0xE2D3D51028F0428A(), Var2, 0, 1, 0))
		{
			iVar0 = 1;
		}
		else
...
int func_108()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_52))
	{
		if (!unk_0xF68107C40359970C(iLocal_53))
		{
			if ((unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52, fVar0, fVar0, fVar0, 0, 1, 0) || unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_53, fVar0, fVar0, fVar0, 0, 1, 0)) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_271, Local_272, 194.75f, 0, 1, 0))
			{
				if (!unk_0x12DD4A0B247D9B4D(uLocal_57))
				{
...
int func_112()
{
	...
	unk_0x8FB472886552D737(sLocal_250);
	unk_0x8FB472886552D737(sLocal_251);
	unk_0x511A0AF0E8B0BF9A("MOVE_M@BAIL_BOND_NOT_TAZERED");
	unk_0x511A0AF0E8B0BF9A("MOVE_M@BAIL_BOND_TAZERED");
	if ((((((unk_0x0152AA00FA3130F1(iVar0) && unk_0x0152AA00FA3130F1(iVar1)) && unk_0x0152AA00FA3130F1(joaat("prop_ld_binbag_01"))) && unk_0x6F940C2636C076AD(sLocal_250)) && unk_0x6F940C2636C076AD(sLocal_251)) && unk_0xA7A5D14F877C9047("MOVE_M@BAIL_BOND_NOT_TAZERED")) && unk_0xA7A5D14F877C9047("MOVE_M@BAIL_BOND_TAZERED"))
	{
		iLocal_52 = unk_0xA8D58C3AADA2C41C(6, iVar0, Var2, fVar4, 1, 1);
		unk_0xD6A76BAB45A4B460(iLocal_52, 294, 1);
		unk_0x06AF73D7E3DF7782(iLocal_52, 1, 0);
		unk_0x70D9EC5AF67D79C4(iLocal_52, 1);
		unk_0x50274A7EACA3133A(iLocal_52, 1);
		func_114(&uLocal_72, 1, iLocal_52, "ArrestCop", 0, 1);
		unk_0x006574E87E6F1942(iLocal_52, 1, 1);
		unk_0x7DCB4594ACF18DA7(iLocal_52, 1);
		iLocal_53 = unk_0xA8D58C3AADA2C41C(26, iVar1, Var3, fVar5, 1, 1);
		unk_0x06AF73D7E3DF7782(iLocal_53, 1, 0);
		unk_0xD6A76BAB45A4B460(iLocal_53, 42, 1);
		unk_0xD6A76BAB45A4B460(iLocal_53, 281, 1);
		unk_0x50274A7EACA3133A(iLocal_53, 1);
		func_114(&uLocal_72, 2, iLocal_53, sLocal_257, 0, 1);
		unk_0x006574E87E6F1942(iLocal_53, 1, 1);
		if (iLocal_51 == 1)
		{
			unk_0xE3752B10DC995E95(iLocal_53, 0, 0, 2, 0);
			unk_0xE3752B10DC995E95(iLocal_53, 2, 0, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_53, 3, 2, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_53, 4, 0, 0, 0);
		}
		func_113();
		if (func_50() == 0)
		{
			func_114(&uLocal_72, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
		}
		else if (func_50() == 1)
		{
			func_114(&uLocal_72, 0, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
		}
		else if (func_50() == 2)
		{
			func_114(&uLocal_72, 0, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
		}
		if (!unk_0x8FEA2E94638F9767(iLocal_52, joaat("weapon_pistol"), 0))
		{
			unk_0x9521FB98DB6DDF50(iLocal_52, joaat("weapon_pistol"), -1, 0, 1);
		...
		unk_0x202B28FEABEC4034(iLocal_52, joaat("weapon_pistol"), 1);
		uLocal_58 = unk_0x0E536D72AB30F4C8(joaat("prop_ld_binbag_01"), Local_63.x, Local_63.f_1, (Local_63.f_2 + 100f), 1, 1, 0);
		unk_0x1C2ED929474DC6FE(uLocal_58, 0, 0);
		if (vdist(2411.32f, 4958.76f, 45.19f, Local_63) < 10f)
		{
			iLocal_51 = 1;
			unk_0xA888F8CC04F25CC8(&uLocal_67);
			unk_0x72F317BC03266125(0, 2473.254f, 4901.651f, 43.1488f, 3f, -1, 2f, 1, Local_244, 1193033728);
			unk_0x7734082B0EDB0BE0(0, iLocal_52, 150f, -1, 0, 0);
			unk_0xC963A45B50851768(uLocal_67);
			unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
			unk_0xABC2CA6F28903308(iLocal_53, 1);
		...
		else
		{
			iLocal_51 = 2;
			unk_0xA888F8CC04F25CC8(&uLocal_67);
			unk_0x72F317BC03266125(0, 2531.445f, 2521.749f, 38.2072f, 3f, -1, 2f, 1, Local_244, 1193033728);
			unk_0x7734082B0EDB0BE0(0, iLocal_52, 150f, -1, 0, 0);
			unk_0xC963A45B50851768(uLocal_67);
			unk_0x8ACADA903FCAA42F(iLocal_53, uLocal_67);
			unk_0xABC2CA6F28903308(iLocal_53, 1);
...
void func_113()
{
	Local_244.x = 0f;
	Local_244.f_1 = 10f;
	unk_0x71B502FC2E129665(iLocal_52, 2);
	unk_0xBC12D08EE7559CCD(iLocal_52, 13, 1);
	unk_0xBC12D08EE7559CCD(iLocal_52, 2, 1);
	unk_0xBC12D08EE7559CCD(iLocal_52, 1, 1);
	unk_0xBC12D08EE7559CCD(iLocal_52, 11, 0);
	unk_0x3DAB02AAC9E9EC02(iLocal_52, 0);
	unk_0x71B502FC2E129665(iLocal_53, 3);
	unk_0xBC12D08EE7559CCD(iLocal_53, 17, 1);
	unk_0xBC12D08EE7559CCD(iLocal_53, 6, 1);
	unk_0xBC12D08EE7559CCD(iLocal_53, 1, 1);
	unk_0xBC12D08EE7559CCD(iLocal_53, 11, 0);
	unk_0xDC6110E0F8FF9DA0(iLocal_53, 128, 1);
	unk_0xDC6110E0F8FF9DA0(iLocal_53, 1, 0);
	unk_0xD642E010A287ADFD("RE_ARREST_COP", &iLocal_65);
	unk_0xD642E010A287ADFD("RE_ARREST_CRIM", &iLocal_66);
	unk_0xFF4BEB6CFF55A013(iLocal_52, iLocal_65);
	unk_0xFF4BEB6CFF55A013(iLocal_53, iLocal_66);
	unk_0x9972EFADA7A2A47D(4, iLocal_66, iLocal_65);
	unk_0x9972EFADA7A2A47D(3, iLocal_65, 1862763509);
	unk_0x9972EFADA7A2A47D(3, iLocal_66, 1862763509);
	unk_0x9972EFADA7A2A47D(4, iLocal_66, joaat("COP"));
	unk_0xEEBC95A38CBDED42(iLocal_52, sLocal_249);
	unk_0xEEBC95A38CBDED42(iLocal_53, sLocal_248);
}
...
int func_115()
{
	...
	{
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_123())
		{
			return 0;
		}
	}
...
int func_134(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_170(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_148(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_177()
{
	if (unk_0xE3BBDB1C36703410())
	{
		...
		{
			if (!unk_0xF68107C40359970C(iLocal_53) && !unk_0x55B23FE400FCEA6B(iLocal_53, 0))
			{
				unk_0x55B23FE400FCEA6B(iLocal_52, 0);
				if (unk_0xE5965CDF24F93A9F(iLocal_52))
				{
					unk_0x84918839A90C954C(iLocal_53, unk_0x6B62510F212526DC(iLocal_52, 1), 9000f, -1, 0, 0);
				}
				else
				{
					unk_0x84918839A90C954C(iLocal_53, unk_0x6B62510F212526DC(iLocal_53, 1), 9000f, -1, 0, 0);
				}
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_52))
		{
			if (!unk_0xF68107C40359970C(iLocal_52))
			{
				unk_0xABC2CA6F28903308(iLocal_52, 1);
				unk_0x50274A7EACA3133A(iLocal_52, 0);
				unk_0x8601AD4E55C81412(iLocal_52, 1);
				unk_0xA7266A50941DBAEA(iLocal_52, 1);
			}
		}
		if (unk_0xE5965CDF24F93A9F(iLocal_54))
...
void func_196()
{
	...
	{
		func_45(13, floor(Global_112915.f_10194.f_3853));
	}
...
void func_207()
{
	if (!bLocal_68 && iLocal_49 == 0)
	{
		if (!unk_0xF68107C40359970C(iLocal_52) && !unk_0xF68107C40359970C(iLocal_53))
		{
			unk_0x13C3030981EA7C3B(iLocal_52, unk_0x6B62510F212526DC(iLocal_53, 1), 3f, 20000, 1193033728, 1056964608);
			unk_0xABC2CA6F28903308(iLocal_52, 1);
			wait(0);
		}
	}
