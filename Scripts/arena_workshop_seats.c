	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 5:
			...
			if ((iVar6 != 1 && iVar6 != 0) || func_34(unk_0x82FE2343F8BDFF0B(unk_0xE2D3D51028F0428A()), fVar8, 5f))
			{
				...
				unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_43.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar9 = unk_0x57736A7B8965A88A(uParam0->f_43.f_1);
			if (unk_0xCE2C78E9FC0B01E3(uVar9))
			{
				if (unk_0x54DE1614490C2A83(uVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_43.f_1 = unk_0x497E09037A63D346(func_48(uParam0), func_47(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_43.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					unk_0x60E9DD146055C13E(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			uVar10 = unk_0x57736A7B8965A88A(uParam0->f_43.f_1);
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((unk_0xE5965CDF24F93A9F(uVar0[iVar1]) && !unk_0xF68107C40359970C(uVar0[iVar1])) && unk_0x2B5F4FBAF644BEC8(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || vdist2(unk_0x6B62510F212526DC(uVar0[iVar1], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
