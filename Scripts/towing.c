...
void __EntryFunction__()
{
	...
	if (unk_0xE5965CDF24F93A9F(ScriptParam_929) && unk_0xE5965CDF24F93A9F(ScriptParam_929.f_1))
	{
		if (!unk_0x55B23FE400FCEA6B(ScriptParam_929, 0) && !unk_0x55B23FE400FCEA6B(ScriptParam_929.f_1, 0))
		{
			unk_0x2D58A6131679D82C(ScriptParam_929, 1, 1);
			unk_0x2D58A6131679D82C(ScriptParam_929.f_1, 1, 1);
		}
	}
	...
	switch (ScriptParam_929.f_2)
	{
		case 1:
			if (ScriptParam_929.f_4)
			{
				...
				{
					iLocal_450 = func_260(100000f, iLocal_170, Global_112915.f_19973.f_9);
				}
			}
			else
			{
				...
				{
					iLocal_450 = Global_112915.f_19973.f_9;
					iLocal_170 = Global_112915.f_19973.f_2;
				}
	...
	if (!bLocal_793)
	{
		func_255(&Local_396, 3, 0, "TOWDISPATCH", 0, 1);
	}
	if (iLocal_170 == 0)
	{
		iLocal_796 = 1;
	...
	{
		iLocal_796 = 1;
		iLocal_853 = Local_394[func_254() /*28*/].f_27;
	}
	func_253();
	func_229(&ScriptParam_929);
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_900))
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
		{
			unk_0x2D58A6131679D82C(iLocal_900, 1, 1);
			unk_0x66E36C5E6E28930C(iLocal_900);
			unk_0xF80F852786CB8BB0(iLocal_900, 0);
			unk_0x05EAB38F5AC8DA1D(iLocal_900, 1);
		}
	}
	uLocal_903 = unk_0x2915D98110F23A29(Vector(27.5001f, -640.002f, 414.1398f) - Vector(50f, 50f, 50f), Vector(27.5001f, -640.002f, 414.1398f) + Vector(50f, 50f, 50f), 0, 1, 1, 1);
	uLocal_904 = unk_0x2915D98110F23A29(Vector(21.8557f, -1172f, -229.8159f) - Vector(50f, 50f, 50f), Vector(21.8557f, -1172f, -229.8159f) + Vector(50f, 50f, 50f), 0, 1, 1, 1);
	unk_0x84A65E2E9CFB6A77(Local_862 - Vector(15f, 15f, 15f), Local_862 + Vector(15f, 15f, 15f), 0, 1);
	unk_0x06B8FBA220C6488C(Local_862 - Vector(15f, 15f, 15f), Local_862 + Vector(15f, 15f, 15f), 0);
	func_228();
	while (true)
	{
		wait(0);
		...
		if (bLocal_779 && !unk_0x4DA360FC7C3CFEFA(unk_0xE2D3D51028F0428A()))
		{
		...
		if (iLocal_906 < 15)
		{
			func_221(&iLocal_900, &uLocal_817, &Local_824, &Local_468, &cLocal_866, &iLocal_854, iLocal_849, bLocal_792, &iLocal_801, iLocal_783, bLocal_773, bLocal_209, iLocal_906, 1);
		}
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			switch (iLocal_821)
			{
				case 0:
					...
					{
						if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_900, 0))
						{
						}
						if (iLocal_170 != 2 && iLocal_170 != 4)
						{
							if (!func_218(&uLocal_913, Local_824[0 /*20*/].f_6, iLocal_900, &uLocal_844, &uLocal_845, bLocal_779))
							{
								iLocal_875 = 15;
								func_265();
							}
						...
						{
							func_217(&uLocal_914, iLocal_900, &uLocal_847, &uLocal_848, bLocal_779);
						}
					}
					if (bLocal_793)
					{
						if (iLocal_906 >= 7)
						{
							func_212(iLocal_900, Local_824[0 /*20*/].f_6, Local_825, &(Local_824[0 /*20*/].f_8), &Local_468, &cLocal_866, &Local_187, bLocal_793, &(Local_824[0 /*20*/]));
						}
					}
					bLocal_782 = false;
					if (((iLocal_170 == 0 || iLocal_170 == 2) && iLocal_906 > 4) && iLocal_906 < 17)
					{
						...
						{
							func_210();
							func_209(Local_824[0 /*20*/].f_6, Local_824[0 /*20*/]);
						}
						if (!bLocal_793)
						{
							func_198();
					...
					else if (iLocal_170 == 3)
					{
						...
						{
							if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
							{
								if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), Local_824[0 /*20*/].f_6))
								{
									iLocal_764 = 1;
									unk_0x03A927199A2DFE46(Local_824[0 /*20*/]);
									unk_0x529D306014D3C29A(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 0);
								}
							}
						}
					}
					...
					{
						func_183(&(Local_394[func_254() /*28*/]), &(Local_394[func_254() /*28*/].f_10), Local_393[iLocal_450 /*23*/].f_1, &(Local_824[0 /*20*/]), &(Local_824[0 /*20*/].f_2), &uLocal_820, fLocal_864, sLocal_465, &sLocal_466, iLocal_853);
					}
					if (iLocal_170 == 4)
					{
						func_181(&uLocal_907, iLocal_901, iLocal_902, iLocal_900, &(Local_824[0 /*20*/].f_2), iLocal_853, sLocal_465, &sLocal_466, &iLocal_816, bLocal_779, &(Local_824[0 /*20*/].f_6));
					}
					if (!bLocal_779)
					{
						if (unk_0xE5965CDF24F93A9F(iLocal_816) && !unk_0x55B23FE400FCEA6B(iLocal_816, 0))
						{
							if (func_173(iLocal_816, 0, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 0))
							{
								bLocal_776 = true;
								unk_0x7734082B0EDB0BE0(iLocal_816, unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
							}
							if (func_171())
							{
								bLocal_777 = true;
					...
					{
						if (func_173(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 1, 1, 0))
						{
							func_170();
							if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
							{
								unk_0x03A927199A2DFE46(Local_824[0 /*20*/]);
								unk_0xABC2CA6F28903308(Local_824[0 /*20*/], 1);
								unk_0x7734082B0EDB0BE0(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
							if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_1, 0))
							{
								unk_0x03A927199A2DFE46(Local_824[0 /*20*/].f_1);
								unk_0xABC2CA6F28903308(Local_824[0 /*20*/].f_1, 1);
								...
								if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_1, 0))
								{
									unk_0x8ACADA903FCAA42F(Local_824[0 /*20*/].f_1, uLocal_171);
								}
								unk_0x7461D7C5BA953BC7(&uLocal_171);
								iLocal_875 = 18;
							}
							if (!bLocal_793)
							{
								switch (iLocal_169)
								{
									...
									case 2:
										func_169(&Local_396, "TOWAUD", "TOW_DISP_LAW", 9, 1, 0, 0);
										iLocal_875 = 3;
										func_265();
										break;
								}
						...
						if (func_173(Local_824[0 /*20*/].f_1, Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 0))
						{
							func_170();
							if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_1, 0))
							{
								unk_0x03A927199A2DFE46(Local_824[0 /*20*/].f_1);
								unk_0xABC2CA6F28903308(Local_824[0 /*20*/].f_1, 1);
								unk_0x7734082B0EDB0BE0(Local_824[0 /*20*/].f_1, unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
						}
					}
					...
					if (!bLocal_782 && func_168(0))
					{
						if ((!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0) && !unk_0x55B23FE400FCEA6B(iLocal_900, 0)) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_900, 0))
						{
							if (!iLocal_216)
							{
								if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_6))
								{
									if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
									{
										func_145(&uLocal_149, unk_0x6B62510F212526DC(Local_824[0 /*20*/].f_6, 1), 0, 0, 1, 1, 1);
									}
								}
							}
							else
							{
								func_145(&uLocal_149, Local_469, 0, 0, 1, 1, 1);
							}
						}
					}
					if (!func_168(0))
					{
						func_144(&uLocal_149, 0, 0);
					}
					func_142(&uLocal_885, 7f, 1);
					func_141();
					func_140();
...
int func_1(struct<3> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_6))
	{
		if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
		{
			if (unk_0xF798DCF92C74B531(Local_824[0 /*20*/].f_6, 0, 7000))
			{
				iLocal_875 = 15;
				return 1;
			}
	...
	if (bLocal_215)
	{
		if ((unk_0x320D1840B6DAA1CC() - iLocal_854) > 50000)
		{
			if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
			{
				Var0 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
			}
			if (unk_0xE5965CDF24F93A9F(iLocal_900) && !unk_0x55B23FE400FCEA6B(iLocal_900, 0))
			{
				Var1 = { unk_0x6B62510F212526DC(iLocal_900, 1) };
			}
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_900))
	{
		if (!unk_0x55A0C756C4A8220C(iLocal_900, 0))
		{
			iLocal_875 = 2;
			return 1;
		}
			...
			switch (iLocal_170)
			{
				...
				case 0:
					if (bLocal_190)
					{
						if (!bLocal_798)
						{
							if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/]))
							{
								if (unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
								{
									iLocal_875 = 8;
						...
						if (bLocal_799)
						{
							if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_1))
							{
								if (unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_1, 0))
								{
									iLocal_875 = 9;
	...
	if (!unk_0x79A822779CC6508A(iLocal_900))
	{
		unk_0x66E36C5E6E28930C(iLocal_900);
	}
	else if (unk_0x66AA8BC9CA1BE26C(iLocal_900))
	{
		iLocal_875 = 4;
		return 1;
	}
...
int func_2()
{
	if (!iLocal_785)
	{
		...
		{
			iLocal_785 = 1;
			func_169(&Local_396, "TOWAUD", "TOW_DISP3", 9, 0, 0, 0);
		}
	}
...
int func_8()
{
	...
	if (!func_11(Local_468[0 /*3*/]))
	{
		if (!iLocal_786)
		{
			...
			{
				func_169(&Local_396, "TOWAUD", sVar2, 9, 0, 0, 0);
				iLocal_786 = 1;
			}
		}
...
{
	return func_10(unk_0x407E03586628E458(unk_0xB6BA8B8E3D0B41C6()), Param0, iParam1);
}
			...
			if ((timera() > 3000 && iLocal_216) && !func_43("TOWT_OBJ_04", 0, 0))
			{
				if (!func_47())
				{
					...
					else if (iLocal_170 == 1)
					{
						...
						{
							func_255(&Param0, 5, (*iParam1)[0 /*20*/], "TOWTRAINF", 0, 1);
							func_169(&Param0, "TOWAUD", "TOW_MECH", 7, 0, 0, 0);
							sLocal_226 = "TOW_MECH";
						}
						else if (Global_112915.f_19973.f_5 == 2)
						{
							func_255(&Param0, 6, (*iParam1)[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
	...
	switch (iLocal_452)
	{
		case 1:
			...
			else if (iLocal_170 == 1)
			{
				if (Global_112915.f_19973.f_5 == 0 || Global_112915.f_19973.f_5 == 1)
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 5, (*uParam165)[0 /*20*/], "TOWTRAINF", 0, 1);
					if (!iLocal_213)
					{
				...
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 6, (*uParam165)[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
					if (!iLocal_213)
					{
			...
			else if (iLocal_170 == 3)
			{
				...
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 5, (*uParam165)[0 /*20*/], "TOWBREAKM", 0, 1);
					if (!iLocal_213)
					{
				...
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 6, (*uParam165)[0 /*20*/], "TOWBREAKHIPM", 0, 1);
					if (!iLocal_213)
					{
	...
	switch (iLocal_906)
	{
		...
		case 2:
			if (!unk_0x559C03F53E6937FC())
			{
				...
				{
					case 3:
						func_255(&Local_396, 4, 0, "TOWDISPATCH", 0, 1);
						if (func_169(&Local_396, "TOWAUD", "TOW_ACC_EXP2", 9, 0, 0, 0))
						{
							iLocal_906 = 4;
						}
						break;
					...
					case 2:
						func_255(&Local_396, 4, 0, "TOWDISPATCH", 0, 1);
						if (func_169(&Local_396, "TOWAUD", "TOW_ABN_EXP2", 9, 0, 0, 0))
						{
							iLocal_906 = 4;
						}
						break;
					...
					case 0:
						...
						if (bLocal_799)
						{
							if (func_169(&Local_396, "TOWAUD", "TOW_HAN_EXP2", 9, 0, 0, 0))
							{
								iLocal_906 = 4;
							}
						}
						else if (func_169(&Local_396, "TOWAUD", "TOW_HAN_EXP2", 9, 0, 0, 0))
						{
							iLocal_906 = 4;
						}
						break;
					...
					case 1:
						func_255(&Local_396, 4, 0, "TOWDISPATCH", 0, 1);
						if (func_169(&Local_396, "TOWAUD", "TOW_TRN_EXP2", 9, 0, 0, 0))
						{
							iLocal_906 = 4;
						}
						break;
					...
					case 4:
						func_255(&Local_396, 4, 0, "TOWDISPATCH", 0, 1);
						if (func_169(&Local_396, "TOWAUD", "TOW_ACD_EXP2", 9, 0, 0, 0))
						{
							iLocal_906 = 4;
						}
						break;
		...
		case 4:
			switch (iLocal_170)
			{
				case 3:
					if (func_130("TOWT_OBJ_01", "TOWT_HELP_01", &uVar0, 1, 0))
					{
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
						{
							unk_0x3B2646B62E7BBE11(Local_824[0 /*20*/].f_6, 10);
						}
						func_128();
						func_261(&uLocal_891);
						iLocal_906 = 6;
				...
				case 2:
					if (func_130("TOWT_OBJ_AB", "TOWT_HELP_AB", &uVar0, 0, 0))
					{
						...
						unk_0x84A65E2E9CFB6A77(Local_470, Local_471, 0, 1);
						iLocal_797 = 1;
						unk_0x7570FB331DFE5904(Local_824[0 /*20*/].f_6, 1);
						func_261(&uLocal_891);
						iLocal_906 = 6;
					}
					break;
			...
			if (!unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_8))
			{
				if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_6))
				{
					Local_824[0 /*20*/].f_8 = unk_0xEFD6451BF0F3352F(Local_824[0 /*20*/].f_6);
					unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_8, 3);
					unk_0xAAD76B24A5282FDD(Local_824[0 /*20*/].f_8, 1);
				}
			}
			break;
		...
		case 7:
			...
			if (iLocal_170 == 1 && !unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], iLocal_900, 0))
			{
				bLocal_791 = true;
			}
			func_111();
			if (func_104(sVar2, Local_469))
			{
				if (iLocal_170 == 1 && !unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], iLocal_900, 0))
				{
					...
					if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/]))
					{
						Local_824[0 /*20*/].f_9 = unk_0xEFD6451BF0F3352F(Local_824[0 /*20*/]);
						unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_9, 3);
						unk_0x293A9399E902A33B(Local_824[0 /*20*/].f_9, 0.7f);
					}
					iLocal_906 = 5;
				}
				else
		...
		case 9:
			...
			{
				func_144(&uLocal_149, 0, 0);
				unk_0x2EABFF5EFCB7E6CF(Local_824[0 /*20*/].f_6, 0, 0);
				if (iLocal_840 == 0)
				{
					iLocal_775 = 0;
					iLocal_906 = 15;
		...
		case 15:
			...
			if (bLocal_773)
			{
				if (unk_0x12DD4A0B247D9B4D(uLocal_817))
				{
					unk_0xFFD8EB5462B07B59(&uLocal_817);
				}
			}
			...
			if (iLocal_218 != 0 && !bLocal_769)
			{
				if (bLocal_779)
				{
					if ((unk_0x320D1840B6DAA1CC() - iLocal_218) < 12000)
					{
...
void func_100()
{
	...
	Global_112915.f_19973.f_2 = iLocal_170;
	switch (iLocal_170)
	{
		case 2:
...
int func_101(char* sParam0)
{
	...
	if (Local_824[iLocal_839 /*20*/].f_15)
	{
		...
		{
			unk_0x207617CE1796D28E(Local_824[iLocal_839 /*20*/].f_6, 1, 0);
		}
	}
	if (func_102(&uVar0, &uVar1, &uVar2))
	{
		if (!unk_0x55B23FE400FCEA6B(Local_824[iLocal_839 /*20*/], 0) && unk_0xF6F5D18EF8EAB859(Local_824[iLocal_839 /*20*/], iLocal_900, 0))
		{
			unk_0xD28E3800883DED83(iLocal_900, 6f, 2, 0);
			iLocal_214 = 1;
			if (unk_0xE5965CDF24F93A9F(Local_824[iLocal_839 /*20*/]) && !unk_0x55B23FE400FCEA6B(Local_824[iLocal_839 /*20*/], 0))
			{
				unk_0xA888F8CC04F25CC8(&uLocal_171);
				unk_0xC89EA639A6F338A6(0);
				unk_0xAB7639D658BBCCEE(0, 0, 0);
				unk_0x6624B56C8F9A7BBF(0, Local_824[0 /*20*/].f_6, 20000, 2f, 0f, 1f, 0);
				...
				unk_0xC963A45B50851768(uLocal_171);
				unk_0x8ACADA903FCAA42F(Local_824[iLocal_839 /*20*/], uLocal_171);
				unk_0x7461D7C5BA953BC7(&uLocal_171);
				unk_0xABC2CA6F28903308(Local_824[iLocal_839 /*20*/], 1);
			}
			if ((Global_112915.f_19973.f_3 == 0 || Global_112915.f_19973.f_3 == 1) || Global_112915.f_19973.f_3 == 4)
			{
				if (unk_0xE5965CDF24F93A9F(iLocal_816) && !unk_0x55B23FE400FCEA6B(iLocal_816, 0))
				{
					...
					unk_0xC963A45B50851768(uLocal_171);
					if (!unk_0x55B23FE400FCEA6B(iLocal_816, 0))
					{
						unk_0x8ACADA903FCAA42F(iLocal_816, uLocal_171);
						unk_0xABC2CA6F28903308(iLocal_816, 1);
					}
					unk_0x7461D7C5BA953BC7(&uLocal_171);
				}
			}
			...
			if ((Global_112915.f_19973.f_3 == 0 || Global_112915.f_19973.f_3 == 1) || Global_112915.f_19973.f_3 == 4)
			{
				if (Global_112915.f_19973.f_3 == 0)
				{
					func_169(&Local_396, "TOWAUD", "TOW_TUT_ENDA", 9, 0, 0, 0);
				}
				else if (Global_112915.f_19973.f_3 == 1)
				{
					func_169(&Local_396, "TOWAUD", "TOW_TUT_ENDB", 9, 0, 0, 0);
				}
				else if (Global_112915.f_19973.f_3 == 4)
				{
					func_169(&Local_396, "TOWAUD", "TOW_TUT_ENDC", 9, 0, 0, 0);
				}
			}
			else if (iLocal_170 == 3)
			{
				if (Global_112915.f_19973.f_7 == 0 || Global_112915.f_19973.f_7 == 1)
				{
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWBREAKM", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_BRK_THNK", 9, 0, 0, 0);
				}
				else if (Global_112915.f_19973.f_7 == 2)
				{
					func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWBREAKHIPM", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_BRK_THAN", 9, 0, 0, 0);
				}
			}
			else if (iLocal_170 == 1)
			{
				if (Global_112915.f_19973.f_5 == 0 || Global_112915.f_19973.f_5 == 1)
				{
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWTRAINF", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_THANK", 9, 0, 0, 0);
				}
				else if (Global_112915.f_19973.f_5 == 2)
				{
					func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_THANK2", 9, 0, 0, 0);
				}
			}
		}
		if (!bLocal_793)
		...
		iLocal_216 = 0;
		unk_0xFFD8EB5462B07B59(&(Local_824[iLocal_839 /*20*/].f_8));
		func_59(&uLocal_879);
		iLocal_840 = (iLocal_840 - 1);
		return 1;
	}
	if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[iLocal_839 /*20*/].f_6, 0))
	{
		if (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[iLocal_839 /*20*/].f_6))
		{
			iLocal_216 = 0;
			func_144(&uLocal_149, 0, 0);
			unk_0xAAD76B24A5282FDD(Local_824[iLocal_839 /*20*/].f_8, 0);
			unk_0xFFD8EB5462B07B59(&(Local_824[iLocal_839 /*20*/].f_8));
			if (unk_0xE5965CDF24F93A9F(Local_824[iLocal_839 /*20*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_824[iLocal_839 /*20*/].f_6, 0))
			{
				if (!unk_0x12DD4A0B247D9B4D(Local_824[iLocal_839 /*20*/].f_8))
				{
					Local_824[iLocal_839 /*20*/].f_8 = unk_0xEFD6451BF0F3352F(Local_824[iLocal_839 /*20*/].f_6);
					unk_0xA582EE8380437B1B(Local_824[iLocal_839 /*20*/].f_8, 3);
				}
			}
			if (iLocal_170 == 1)
			{
				if (Global_112915.f_19973.f_5 == 0 || Global_112915.f_19973.f_5 == 1)
				{
					...
					if (!iLocal_812)
					{
						if (func_169(&Local_396, "TOWAUD", "TOW_UNHOOK", 9, 1, 0, 0))
						{
							iLocal_812 = 1;
						}
					}
				...
				else if (Global_112915.f_19973.f_5 == 2)
				{
					...
					if (!iLocal_812)
					{
						if (func_169(&Local_396, "TOWAUD", "TOW_UNHOOK2", 9, 1, 0, 0))
						{
							iLocal_812 = 1;
						}
					}
			...
			else if (iLocal_170 == 3)
			{
				if (Global_112915.f_19973.f_7 == 0 || Global_112915.f_19973.f_7 == 1)
				{
					...
					if (!iLocal_812)
					{
						if (func_169(&Local_396, "TOWAUD", "TOW_BRK_UNHK", 9, 1, 0, 0))
						{
							iLocal_812 = 1;
						}
					}
				...
				else if (Global_112915.f_19973.f_7 == 2)
				{
					...
					if (!iLocal_812)
					{
						if (func_169(&Local_396, "TOWAUD", "TOW_BRK_HOOK", 9, 1, 0, 0))
						{
							iLocal_812 = 1;
						}
					}
...
int func_102(var uParam0, var uParam1, var uParam2)
{
	if (iLocal_839 != -1)
	{
		...
		if (!bLocal_793)
		{
			if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
			{
				if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_469, 30f, 30f, 2f, 1, 1, 0))
				{
					if (iLocal_170 == 0 || iLocal_170 == 4)
					{
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
						{
							unk_0x3B2646B62E7BBE11(Local_824[0 /*20*/].f_6, 1);
							bLocal_773 = true;
						}
					}
				}
		...
		if (unk_0xE5965CDF24F93A9F(Local_824[iLocal_839 /*20*/].f_6))
		{
			if (unk_0xD132EDDA78FF4A51(Local_824[iLocal_839 /*20*/].f_6, *uParam0, *uParam1, *uParam2, 0, 0, 0))
			{
				if (iLocal_775)
				{
				...
				if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[iLocal_839 /*20*/].f_6, 0))
				{
					if (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[iLocal_839 /*20*/].f_6) || (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), Local_824[iLocal_839 /*20*/].f_6, 0) && !unk_0x671CB92F637FDB33(iLocal_900, Local_824[iLocal_839 /*20*/].f_6)))
					{
						if (func_47())
						{
							func_170();
...
int func_104(char* sParam0, struct<3> Param1)
{
	...
	if (!bLocal_779 && !bLocal_790)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_900) && !unk_0x55B23FE400FCEA6B(iLocal_900, 0))
		{
			iVar2 = unk_0x5DFF6B0D4F63C800(iLocal_900);
			if (unk_0xE5965CDF24F93A9F(iVar2) && !unk_0x55B23FE400FCEA6B(iVar2, 0))
			{
				if (unk_0x04D9F44466CBF3CA(iVar2))
				{
					if (unk_0x31EB55FAEEE9C0F5(iVar2) != Local_824[0 /*20*/].f_6)
					{
						if (!iLocal_806)
						{
							func_255(&uLocal_227, 3, iLocal_816, "TONYA", 0, 1);
							if (func_169(&uLocal_227, "TOWAUD", "TONYA_WRONG", 9, 0, 0, 0))
							{
								iLocal_806 = 1;
							}
						}
	...
	while (iVar1 < 1)
	{
		if (unk_0xE5965CDF24F93A9F(Local_824[iVar1 /*20*/].f_6))
		{
			if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[iVar1 /*20*/].f_6, 0))
			{
				if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[iVar1 /*20*/].f_6) && func_110())
				{
					unk_0xBF0DDDDACD98C554(iLocal_900, 1);
					func_107();
					func_144(&uLocal_149, 0, 0);
					iLocal_216 = 1;
					if (iLocal_795 && !unk_0xF6F5D18EF8EAB859(Local_824[iVar1 /*20*/], iLocal_900, 0))
					{
						bVar0 = false;
						if (iLocal_911 < 4)
						{
					...
					{
						func_106(&uLocal_885);
						unk_0xAAD76B24A5282FDD(Local_824[iVar1 /*20*/].f_8, 0);
						iLocal_801 = 0;
						func_105(Local_824[iVar1 /*20*/].f_8);
						Local_824[iVar1 /*20*/].f_14 = func_4(&(Local_824[iVar1 /*20*/].f_11));
						if (iLocal_821 == 0)
						{
							Local_824[iVar1 /*20*/].f_8 = unk_0xC5B823372B67998A(Param1);
							fLocal_180 = func_9(Param1, 0);
							Local_468[0 /*3*/] = { Param1 };
						}
						if (iLocal_170 == 4)
						{
							unk_0xCAA02C32EC0C2462(Local_824[0 /*20*/].f_6, 0, 0);
						}
						func_59(&uLocal_891);
						unk_0xA582EE8380437B1B(Local_824[iVar1 /*20*/].f_8, 5);
						unk_0xAAD76B24A5282FDD(Local_824[iVar1 /*20*/].f_8, 1);
						...
						StringCopy(&cLocal_866, sParam0, 64);
						unk_0x02B222EADC9DC566(Local_468[0 /*3*/], 6f, 0, 0, 0, 0, 0, 0, 0);
						iLocal_839 = iVar1;
						return 1;
					}
				}
...
void func_111()
{
	...
	if (((!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0)) && unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6)) || (Global_112915.f_19973.f_3 == 0 || Global_112915.f_19973.f_3 > 2))
	{
		return;
	}
	switch (iLocal_852)
...
int func_114(int iParam0, int iParam1, char* sParam2)
{
	...
	switch (*iParam0)
	{
			...
			if (!bLocal_792)
			{
				if ((func_121(Local_824[iParam1 /*20*/].f_6, iLocal_900, &iLocal_449, 10, 150f, 4f, 1) || iLocal_787) || iLocal_216)
				{
					if (!bLocal_770)
					{
						iLocal_449 = 0;
						func_120(&iLocal_444);
						if (unk_0x174CED88B97C78D9(Local_824[iParam1 /*20*/], -875674219) != 1)
						{
							unk_0x529D306014D3C29A(Local_824[iParam1 /*20*/], unk_0xE2D3D51028F0428A(), -1);
						}
						bLocal_770 = true;
					}
					if (bLocal_770)
					{
						if (unk_0x8F41785F110B0DA0(iLocal_900, unk_0x6B62510F212526DC(Local_824[iParam1 /*20*/], 1), 25f, 25f, 25f, 0, 1, 0))
						{
							if (unk_0xFCF559C8631ABED7(Local_824[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", 3))
							{
								unk_0x227B2DD85A708E68(Local_824[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", -4f);
							}
							if (!func_119())
							{
								if (iLocal_170 == 1)
								{
									...
									{
										func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
										func_255(&Local_396, 5, Local_824[iParam1 /*20*/], "TOWTRAINF", 0, 1);
										func_169(&Local_396, "TOWAUD", "TOW_GREET", 9, 1, 0, 0);
									}
									else if (Global_112915.f_19973.f_5 == 2)
									{
										func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
										func_255(&Local_396, 6, Local_824[iParam1 /*20*/], "TOWILLEGALMAN2", 0, 1);
										func_169(&Local_396, "TOWAUD", "TOW_GREET2", 9, 1, 0, 0);
									}
									unk_0xB486640392EC50BB(Local_824[iParam1 /*20*/], iLocal_900, 20000, 0, 2f, 1048577, 0);
								}
								else if (iLocal_170 == 3)
								{
									if (Global_112915.f_19973.f_7 == 0 || Global_112915.f_19973.f_7 == 1)
									{
										func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
										func_255(&Local_396, 5, Local_824[iParam1 /*20*/], "TOWBREAKM", 0, 1);
										func_169(&Local_396, "TOWAUD", "TOW_BRK_GRT", 9, 1, 0, 0);
									}
									else if (Global_112915.f_19973.f_7 == 2)
									{
										func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
										func_255(&Local_396, 6, Local_824[iParam1 /*20*/], "TOWBREAKHIPM", 0, 1);
										func_169(&Local_396, "TOWAUD", "TOW_BRK_GRT2", 9, 1, 0, 0);
									}
									unk_0xB486640392EC50BB(Local_824[iParam1 /*20*/], iLocal_900, 20000, 0, 2f, 1048577, 0);
								}
								if (iLocal_787)
								{
									unk_0xFFD8EB5462B07B59(&(Local_824[iParam1 /*20*/].f_8));
									if (unk_0xE5965CDF24F93A9F(Local_824[iParam1 /*20*/]))
									{
										Local_824[iParam1 /*20*/].f_8 = unk_0xEFD6451BF0F3352F(Local_824[iParam1 /*20*/]);
										unk_0xA582EE8380437B1B(Local_824[iParam1 /*20*/].f_8, 3);
										unk_0x293A9399E902A33B(Local_824[iParam1 /*20*/].f_8, 0.7f);
									}
								}
								settimera(0);
								*iParam0 = 1;
						...
						else if (unk_0x8F41785F110B0DA0(iLocal_900, unk_0x6B62510F212526DC(Local_824[iParam1 /*20*/], 1), 50f, 50f, 50f, 0, 1, 0))
						{
							if (!iLocal_811)
							{
								if (Global_112915.f_19973.f_7 == 0 || Global_112915.f_19973.f_7 == 1)
								{
									func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
									func_255(&Local_396, 5, Local_824[iParam1 /*20*/], "TOWBREAKM", 0, 1);
									if (func_169(&Local_396, "TOWAUD", "TOW_CALLING", 9, 1, 0, 0))
									{
										iLocal_811 = 1;
									}
								}
								else if (Global_112915.f_19973.f_7 == 2)
								{
									func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
									func_255(&Local_396, 6, Local_824[iParam1 /*20*/], "TOWBREAKHIPM", 0, 1);
									if (func_169(&Local_396, "TOWAUD", "TOW_BRK_CALL", 9, 1, 0, 0))
									{
										iLocal_811 = 1;
									}
								}
		...
		case 1:
			...
			if (!unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_9))
			{
				if (unk_0xE5965CDF24F93A9F(Local_824[iParam1 /*20*/]))
				{
					Local_824[0 /*20*/].f_9 = unk_0xEFD6451BF0F3352F(Local_824[iParam1 /*20*/]);
					unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_9, 3);
					unk_0x293A9399E902A33B(Local_824[0 /*20*/].f_9, 0.7f);
				}
			}
		...
		case 2:
			unk_0xD642E010A287ADFD("TOWBUDDIES", &uLocal_823);
			unk_0x9972EFADA7A2A47D(1, uLocal_823, 1862763509);
			unk_0xFF4BEB6CFF55A013(Local_824[iParam1 /*20*/], uLocal_823);
			func_118(iParam1);
			*iParam0 = 3;
			break;
		
		case 3:
			if (!unk_0xF6F5D18EF8EAB859(Local_824[iParam1 /*20*/], iLocal_900, 0))
			{
			...
			if (unk_0xF6F5D18EF8EAB859(Local_824[iParam1 /*20*/], iLocal_900, 0))
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
				{
					unk_0x3B2646B62E7BBE11(iLocal_900, 9);
					func_105(Local_824[0 /*20*/].f_9);
				}
			}
			if (unk_0xF6F5D18EF8EAB859(Local_824[iParam1 /*20*/], iLocal_900, 0) && !unk_0x2E5F8A288A954523())
			{
				if (iLocal_170 == 1)
				{
					if (Global_112915.f_19973.f_5 == 0 || Global_112915.f_19973.f_5 == 1)
					{
						...
						{
							func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWTRAINF", 0, 1);
							func_169(&Local_396, "TOWAUD", "TOW_INTRUCK", 9, 1, 0, 0);
						}
						else
						{
							func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWTRAINF", 0, 1);
					...
					else if (Global_112915.f_19973.f_5 == 2)
					{
						...
						{
							func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
							func_169(&Local_396, "TOWAUD", "TOW_GETIN", 9, 1, 0, 0);
						}
						else
						{
							func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
				...
				else if (iLocal_170 == 3)
				{
					if (Global_112915.f_19973.f_7 == 0 || Global_112915.f_19973.f_7 == 1)
					{
						...
						{
							func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWBREAKM", 0, 1);
							func_169(&Local_396, "TOWAUD", "TOW_BRK_STRT", 9, 1, 0, 0);
						}
						else
						{
							func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWBREAKM", 0, 1);
					...
					else if (Global_112915.f_19973.f_7 == 2)
					{
						...
						{
							func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWBREAKHIPM", 0, 1);
							func_169(&Local_396, "TOWAUD", "TOW_BRK_STR2", 9, 1, 0, 0);
						}
						else
						{
							func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWBREAKHIPM", 0, 1);
		...
		case 4:
			...
			{
				func_118(iParam1);
				if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					if (iLocal_787 && unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						return 1;
					}
				}
				if (!unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_8))
				{
					if (unk_0xE5965CDF24F93A9F(Local_824[iParam1 /*20*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_824[iParam1 /*20*/].f_6, 0))
					{
						Local_824[0 /*20*/].f_8 = unk_0xEFD6451BF0F3352F(Local_824[iParam1 /*20*/].f_6);
						unk_0xA582EE8380437B1B(Local_824[iParam1 /*20*/].f_8, 3);
					}
				}
				if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					if (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
					{
...
void func_118(int iParam0)
{
	...
	while (iVar0 < 1)
	{
		if (iVar0 != iParam0)
		{
			if (unk_0x12DD4A0B247D9B4D(Local_824[iVar0 /*20*/].f_8))
			{
				unk_0xFFD8EB5462B07B59(&(Local_824[iVar0 /*20*/].f_8));
			}
		}
		iVar0++;
	}
...
int func_119()
{
	...
	if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
	{
		if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
		{
			fVar0 = unk_0x207D53F9E0190691(iLocal_900);
			if (fVar0 > 1f)
			{
				return 1;
			}
...
int func_130(char* sParam0, char* sParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		if (func_136(Local_863, fLocal_864, uParam2, 0))
		{
			...
			unk_0x44B7E38F69D1E462(Local_824[0 /*20*/].f_6, 1);
			unk_0xAFE1B52F0DE91595(Local_824[0 /*20*/].f_6, 0);
			unk_0x006574E87E6F1942(Local_824[0 /*20*/].f_6, 1, 1);
			unk_0x05EAB38F5AC8DA1D(Local_824[0 /*20*/].f_6, 1);
			return 1;
		}
	}
...
int func_131(bool bParam0, int iParam1)
{
	...
	{
		unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 0f, 1.2f, 0f, 1600f, 1600f, 1);
		unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 0f, 0.75f, 0.05f, 1600f, 1600f, 1);
		unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, -0.7f, 0f, 0f, 1600f, 1600f, 1);
		unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 0.7f, 0f, 0f, 1600f, 1600f, 1);
	}
	else if (Local_393[iLocal_450 /*23*/] == 4)
	{
		fLocal_864 = -1f;
		iLocal_784 = 1;
		iLocal_901 = unk_0xBA715A7BEBA5A1F9(joaat("ambulance"), Local_394[func_254() /*28*/].f_23, Local_394[func_254() /*28*/].f_26, 1, 1, 0);
		if (!unk_0x55B23FE400FCEA6B(iLocal_901, 0))
		{
			unk_0xBF0DDDDACD98C554(iLocal_901, 1);
			unk_0x371D594409A68A18(iLocal_901, 1, 1, 0);
			iLocal_902 = unk_0x487C17B41938052C(iLocal_901, 4, joaat("s_m_m_paramedic_01"), -1, 1, 1);
		}
		if (!func_11(Local_394[func_254() /*28*/].f_17))
		{
			uLocal_395 = func_132(Local_394[func_254() /*28*/].f_17, Local_394[func_254() /*28*/].f_20);
		}
		switch (Local_393[iLocal_450 /*23*/].f_21)
		{
			case 1:
				unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, -0.5223f, 2.455f, 0.0784f, 200f, 250f, 1);
				unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, -1f, 1.5f, -0.5f, 200f, 250f, 1);
				break;
			
			case 0:
				unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 0.6012f, 2.4222f, 0.0245f, 200f, 250f, 1);
				unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 1f, 1.5f, -0.5f, 200f, 250f, 1);
				break;
			
			case 2:
				unk_0xBDB27A4F81702F96(Local_824[0 /*20*/].f_6, 0.1414f, 1.8401f, 0.0342f, 200f, 350f, 1);
				break;
		}
		unk_0x2476BE9932670CAD(Local_824[0 /*20*/].f_6, 0, 0, 0);
	}
	if (bParam0)
	{
		bLocal_190 = true;
		if (Global_112915.f_19973.f_5 == 0 || Global_112915.f_19973.f_5 == 1)
		{
			Local_824[0 /*20*/] = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, joaat("a_f_m_bevhills_01"), -1, 1, 1);
		}
		else if (Global_112915.f_19973.f_5 == 2)
		{
			Local_824[0 /*20*/] = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, joaat("a_m_y_genstreet_02"), -1, 1, 1);
		}
		else
		{
			Local_824[0 /*20*/] = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, uLocal_820[0], -1, 1, 1);
		}
	}
	return 1;
}
...
{
	unk_0xA8AEDE296853BB64(Param0, Param1);
	unk_0xB2C3D985489123F0(Param0, Param1, 1);
	return unk_0x2915D98110F23A29(Param0, Param1, 0, 1, 1, 1);
}
...
int func_133(struct<3> Param0, var uParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	*iParam2 = func_134(&Local_824);
	...
	Local_824[*iParam2 /*20*/].f_6 = unk_0xBA715A7BEBA5A1F9(iLocal_819[iLocal_841], Param0, uParam1, 1, 1, 0);
	unk_0x006574E87E6F1942(Local_824[*iParam2 /*20*/].f_6, 1, 1);
	iLocal_841++;
	...
	{
		Local_824[*iParam2 /*20*/].f_17 = unk_0xBF1778FE3AC12E6E(Local_393[iLocal_450 /*23*/].f_10, fVar0, 0f, 0);
	}
	else
	{
		Local_824[*iParam2 /*20*/].f_17 = unk_0xBF1778FE3AC12E6E(Param0, fVar0, 0f, 0);
	}
	Local_824[*iParam2 /*20*/].f_18 = unk_0xBF1778FE3AC12E6E(Param0, fVar1, 2.5f, 0);
	Local_824[*iParam2 /*20*/].f_19 = unk_0xBF1778FE3AC12E6E(Param0, fVar2, 4f, 0);
	if (bParam3)
	{
		if (Local_824[*iParam2 /*20*/].f_15)
		{
			unk_0xDC41F053565F1481(Local_824[*iParam2 /*20*/].f_6, 1);
			unk_0x2EE80CD0EAEB9B5B(Local_824[*iParam2 /*20*/].f_6, 1f);
			unk_0x86A3D2835B8F8645(Local_824[*iParam2 /*20*/].f_6, 1);
		}
		else
		{
			unk_0xDC41F053565F1481(Local_824[*iParam2 /*20*/].f_6, 1);
	...
	{
		if (unk_0xE5965CDF24F93A9F(Local_824[*iParam2 /*20*/].f_6))
		{
			Local_824[*iParam2 /*20*/].f_8 = unk_0xEFD6451BF0F3352F(Local_824[*iParam2 /*20*/].f_6);
			unk_0xA582EE8380437B1B(Local_824[*iParam2 /*20*/].f_8, 3);
		}
	}
	iLocal_840++;
	func_261(&(Local_824[*iParam2 /*20*/].f_11));
	return 1;
}
...
int func_136(struct<3> Param0, float fParam1, var uParam2, int iParam3)
{
	...
	unk_0x2476BE9932670CAD(Local_824[*uParam2 /*20*/].f_6, 4, 0, 0);
	unk_0xB38EF75835FAF667(unk_0x15CAA6D7B11F1A7C(Local_824[*uParam2 /*20*/].f_6), &Var1, &Var2);
	Var3 = { Var2 - Var1 };
	Var3 = { Var3 / Vector(2f, 2f, 2f) };
	iLocal_784 = 1;
	Var0 = { unk_0xCACAD935C0BEE14F(Local_824[*uParam2 /*20*/].f_6, 1.5f, 0f, 0f) };
	Var4 = { unk_0x6B62510F212526DC(Local_824[*uParam2 /*20*/].f_6, 1) };
	uVar5 = unk_0x82FE2343F8BDFF0B(Local_824[*uParam2 /*20*/].f_6);
	uLocal_850 = unk_0xBF1778FE3AC12E6E(unk_0x6DB7FBD602C51670(Var4, uVar5, -1.5f, -30f, 0f), 10f, 0f, 0);
	uLocal_851 = unk_0xBF1778FE3AC12E6E(unk_0x6DB7FBD602C51670(Var4, uVar5, -1.5f, 30f, 0f), 10f, 0f, 0);
	unk_0x02B222EADC9DC566(Var0, 30f, 0, 0, 0, 0, 0, 0, 0);
	Local_394[func_254() /*28*/][0 /*3*/] = { Var0.x, Var0.f_1, (Var0.f_2 + 1f) };
	return 1;
}
...
int func_137(var uParam0, float fParam1, var uParam2, var uParam3)
{
	...
	fVar4 = 0f;
	fVar5 = 0f;
	iVar6 = (unk_0x5853B15F78E1A265(0, 3999) / 1000);
	if (iVar6 == 0)
	{
		fVar4 = -unk_0xC4EAB25A108C2429(450f, 700f);
		fVar5 = unk_0xC4EAB25A108C2429(-100f, 100f);
	}
	else if (iVar6 == 1)
	{
		fVar4 = unk_0xC4EAB25A108C2429(450f, 700f);
	...
	{
		fVar5 = unk_0xC4EAB25A108C2429(450f, 700f);
		fVar4 = unk_0xC4EAB25A108C2429(-100f, 100f);
	}
	else
	{
		fVar5 = -unk_0xC4EAB25A108C2429(450f, 700f);
	...
	Var0 = { unk_0xCACAD935C0BEE14F(unk_0xE2D3D51028F0428A(), fVar4, fVar5, 0f) };
	if (!unk_0x5B0E3F68E96BEB2F(Var0, 10f, 1, 1, 1, &Var3, &uVar2))
	{
		return 0;
	}
	unk_0x15CEDAB46D800682(Var3, 2, uParam2, fParam1, &uVar1, 1, 1077936128, 0);
	*uParam0 = { Var3 };
...
void func_140()
{
	...
	while (iVar0 < 12)
	{
		if (unk_0x12DD4A0B247D9B4D(Local_69[iVar0 /*3*/].f_1))
		{
			if (unk_0x55B23FE400FCEA6B(Local_69[iVar0 /*3*/], 0))
			{
				unk_0xFFD8EB5462B07B59(&(Local_69[iVar0 /*3*/].f_1));
			}
...
void func_141()
{
	if (!unk_0x3C57C2F07FEE34D2(&cLocal_63, ""))
	{
		if (!func_47())
		{
			func_169(&Local_51, &cLocal_63, &cLocal_66, 9, 0, 0, 0);
...
void func_145(var uParam0, struct<3> Param1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	int iVar0;
	...
	if (!unk_0x4131052989DE1278())
	{
		if (func_162(uParam0, bParam4, bParam6, 0))
		{
			func_161(uParam0, Param1, iParam3);
		}
		if (*uParam0)
		{
			*uParam0 = 0;
		...
		else if (uParam0->f_6 == 2)
		{
			if (func_150(iVar0))
			{
				...
				{
					if ((unk_0x0318E2EE6FB4563F(Param1, 1f) && !unk_0xF847447D4467709D()) && iParam5)
					{
						if (!func_109(iVar0))
						{
							func_103(iVar0, -1);
...
void func_161(var uParam0, struct<3> Param1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_171()
{
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_816) && !unk_0x55B23FE400FCEA6B(iLocal_816, 0))
	{
		Var1 = { unk_0x6B62510F212526DC(iLocal_816, 1) };
	}
	if (vdist2(Var0, Var1) > 2500f)
	{
		if (!bLocal_802)
		{
			...
			if (!unk_0x12DD4A0B247D9B4D(uLocal_175))
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_816, 0))
				{
					uLocal_175 = unk_0xEFD6451BF0F3352F(iLocal_816);
					unk_0xA582EE8380437B1B(uLocal_175, 3);
					unk_0x293A9399E902A33B(uLocal_175, 0.5f);
				}
			}
			if (unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_8))
			{
				unk_0xFFD8EB5462B07B59(&(Local_824[0 /*20*/].f_8));
			}
		}
	}
	else if (bLocal_802)
	{
		...
		if (!unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_8))
		{
			Local_824[0 /*20*/].f_8 = unk_0xC5B823372B67998A(Local_468[0 /*3*/]);
			if (iLocal_216)
			{
				unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_8, 5);
				unk_0xAAD76B24A5282FDD(Local_824[0 /*20*/].f_8, 1);
				unk_0xDA6437EA059F152A(Local_824[0 /*20*/].f_8, 5);
			}
			else
			{
				unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_8, 3);
				unk_0xAAD76B24A5282FDD(Local_824[0 /*20*/].f_8, 1);
				unk_0xDA6437EA059F152A(Local_824[0 /*20*/].f_8, 3);
			}
		}
	}
	if (vdist2(Var0, Var1) > 22500f)
...
int func_174(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_145)
		{
			iLocal_146 = unk_0x0CF63873D754B965(iParam0);
			bLocal_145 = true;
		}
		iLocal_147 = unk_0x0CF63873D754B965(iParam0);
...
int func_177(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x5007A91D57C39FFC(iParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x3DA4842FA4407BE2(iParam0) || func_178(iVar1))
			{
				if (unk_0x8F41785F110B0DA0(iParam1, unk_0x6B62510F212526DC(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x2E7F5417D4F4DD69(unk_0x28AA31872A651BC7(iParam1), iParam0, 120f) && unk_0xD936DBC1D824A1BE(iParam1, iParam0, 17))
...
void func_181(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, char* sParam6, char* sParam7, var uParam8, bool bParam9, var uParam10)
{
	...
	while (iVar0 < iParam5)
	{
		if (unk_0xE5965CDF24F93A9F((*uParam4)[iVar0]))
		{
			...
			{
				if (func_173((*uParam4)[iVar0], 0, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 1))
				{
	...
	switch (*uParam0)
	{
		...
		case 3:
			if (!func_11(Local_394[func_254() /*28*/].f_17))
			{
				func_182(uLocal_395, Local_394[func_254() /*28*/].f_17, Local_394[func_254() /*28*/].f_20);
			}
			if (unk_0xB4C854DD86E40FDA(joaat("tonya5")) == 1)
			{
				if (!iLocal_205)
				{
					func_255(&uLocal_227, 3, *uParam8, "TONYA", 0, 1);
					if (func_169(&uLocal_227, "TOWAUD", "TOW_ACC_TNYA", 9, 0, 0, 0))
					{
						iLocal_205 = 1;
					}
				}
			...
			while (iVar0 < iParam5)
			{
				if (!unk_0x55B23FE400FCEA6B((*uParam4)[iVar0], 0))
				{
					...
					unk_0xC963A45B50851768(uLocal_171);
					unk_0x8ACADA903FCAA42F((*uParam4)[iVar0], uLocal_171);
					unk_0x7461D7C5BA953BC7(&uLocal_171);
				}
				iVar0++;
			}
				...
				if (!iLocal_217)
				{
					if (!unk_0x55B23FE400FCEA6B(iParam3, 0) && !unk_0x55B23FE400FCEA6B(*uParam10, 0))
					{
						if (!unk_0x671CB92F637FDB33(iParam3, *uParam10))
						{
							...
							{
								if (func_169(&uLocal_227, "TOWAUD", "TOW_WAITING2", 9, 0, 0, 0))
								{
									iLocal_217 = 1;
								}
							}
...
void func_182(var uParam0, struct<3> Param1, struct<3> Param2)
{
	unk_0x7BACBB4C6A7B18B7(uParam0, 0);
	unk_0x2AA70F35B0B111E6();
	unk_0xB2C3D985489123F0(Param1, Param2, 0);
}

int func_183(var uParam0, var uParam1, struct<3> Param2, var uParam3, var uParam4, var uParam5, float fParam6, char[4] cParam7, char* sParam8, int iParam9)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0x9CD4CBF2BBE10F00(Var3, &uVar0, 0, 0) || func_9(*(uParam0[0 /*3*/]), 0) < 60f)
	{
		...
		while (iVar2 < iParam9)
		{
			if (fParam6 == -1f)
			{
				fParam6 = func_184(*(uParam0[iVar2 /*3*/]), Param2);
			}
			else
			{
			...
			if (unk_0xB4C854DD86E40FDA(joaat("tonya4")) == 1)
			{
				iVar1 = unk_0xA8D58C3AADA2C41C(4, joaat("a_m_m_tourist_01"), *(uParam0[iVar2 /*3*/]), fParam6, 1, 1);
			...
			else if (unk_0xB4C854DD86E40FDA(joaat("tonya5")) == 1)
			{
				if (iVar2 == 0)
				{
					iVar1 = unk_0xA8D58C3AADA2C41C(4, joaat("a_m_y_genstreet_02"), *(uParam0[iVar2 /*3*/]), fParam6, 1, 1);
					unk_0xF1A23B343DFEDFD0(joaat("a_m_y_genstreet_02"));
				}
				else
				{
					iVar1 = unk_0xA8D58C3AADA2C41C(4, joaat("a_m_m_bevhills_02"), *(uParam0[iVar2 /*3*/]), fParam6, 1, 1);
					unk_0xF1A23B343DFEDFD0(joaat("a_m_m_bevhills_02"));
				}
			}
			else
			{
				iVar1 = unk_0xA8D58C3AADA2C41C(4, (*uParam5)[(iVar2 % 2)], *(uParam0[iVar2 /*3*/]), fParam6, 1, 1);
			}
			...
			if (iLocal_170 == 3)
			{
				...
				if (!unk_0x55B23FE400FCEA6B(iVar1, 0))
				{
					unk_0x8ACADA903FCAA42F(iVar1, uVar4);
				}
				unk_0x7461D7C5BA953BC7(&uVar4);
			}
			iVar2++;
...
void func_185(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar0 == 0)
		{
			Local_438[iVar0 /*18*/].f_8 = { func_186(unk_0xC4EAB25A108C2429(0f, 1f), unk_0xC4EAB25A108C2429(0f, 1f), 0f) };
		}
		else
		{
			Local_438[iVar0 /*18*/].f_8 = { func_186(0.5f, 1f, 0f) };
		}
		...
		Local_438[iVar0 /*18*/] = unk_0x20F895E512EC5DB6(Local_438[iVar0 /*18*/].f_1, Local_438[iVar0 /*18*/].f_2, Local_438[iVar0 /*18*/].f_5, Local_438[iVar0 /*18*/].f_8, Local_438[iVar0 /*18*/].f_11, Local_438[iVar0 /*18*/].f_12, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar0++;
	}
}
...
int func_187()
{
	...
	{
		case 0:
			func_255(&Local_396, 0, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
			func_255(&Local_396, 3, Local_824[0 /*20*/], sLocal_467, 0, 1);
			unk_0x50274A7EACA3133A(Local_824[0 /*20*/], 1);
			iLocal_843 = unk_0x5853B15F78E1A265(35, 80);
			iLocal_911 = 1;
			break;
		...
		case 1:
			...
			unk_0xC963A45B50851768(uLocal_171);
			unk_0x8ACADA903FCAA42F(Local_824[0 /*20*/], uLocal_171);
			unk_0x7461D7C5BA953BC7(&uLocal_171);
			if (func_9(Local_393[iLocal_450 /*23*/].f_1, 1) < 40f || Local_822.f_1 > 0)
			{
				if (iLocal_170 == 1)
				{
					...
					{
						func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWTRAINF", 0, 1);
						func_169(&Local_396, "TOWAUD", "TOW_GETOUT", 8, 0, 0, 0);
						iLocal_911 = 2;
					}
					else if (Global_112915.f_19973.f_5 == 2)
					{
						func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
						func_169(&Local_396, "TOWAUD", "TOW_GETOUT2", 8, 0, 0, 0);
						iLocal_911 = 2;
					}
				}
			}
		...
		case 2:
			if (!func_11(Local_393[iLocal_450 /*23*/].f_13))
			{
				...
				if (!unk_0xD132EDDA78FF4A51(Local_824[0 /*20*/].f_6, Local_393[iLocal_450 /*23*/].f_13, Local_393[iLocal_450 /*23*/].f_16, Local_393[iLocal_450 /*23*/].f_19, 0, 1, 0))
				{
					func_120(&iLocal_444);
					iLocal_781 = 1;
					iLocal_788 = 1;
					bLocal_177 = true;
					if (unk_0xD5C6B5E3B93A5EDC(Local_824[0 /*20*/], 0))
					{
						unk_0xA888F8CC04F25CC8(&uLocal_171);
						unk_0xAB7639D658BBCCEE(0, 0, 0);
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843 + 15))
			{
				...
				{
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWTRAINF", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_GETOUT", 9, 0, 0, 0);
				}
				else if (Global_112915.f_19973.f_5 == 2)
				{
					func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_GETOUT2", 9, 0, 0, 0);
				}
				func_120(&iLocal_444);
				unk_0xF30F15F203736DE4(Local_824[0 /*20*/], Local_824[0 /*20*/].f_7, -1, 2, 2);
				settimerb(0);
				iLocal_911 = 3;
			}
			break;
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843))
			{
				if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
				{
					...
					if (unk_0xD5C6B5E3B93A5EDC(Local_824[0 /*20*/], 0))
					{
						unk_0xA888F8CC04F25CC8(&uLocal_171);
						unk_0xAB7639D658BBCCEE(0, 0, 0);
						unk_0x9603C0EC536C6425(0, unk_0x6DB7FBD602C51670(Local_393[iLocal_450 /*23*/].f_1, Local_393[iLocal_450 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
						unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), -1);
						unk_0xC963A45B50851768(uLocal_171);
						unk_0xDC6110E0F8FF9DA0(Local_824[0 /*20*/], 64, 0);
						unk_0x8ACADA903FCAA42F(Local_824[0 /*20*/], uLocal_171);
						unk_0x7461D7C5BA953BC7(&uLocal_171);
						iLocal_911 = 4;
					}
		...
		case 4:
			if ((iLocal_910 == 8 && iLocal_216) || func_188())
			{
				settimerb(3000);
				iLocal_911 = 5;
			}
...
int func_188()
{
	if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
	{
		if (bLocal_177)
		{
			...
			{
				case 0:
					if (unk_0x0829092F169950AB(Local_824[0 /*20*/]) == 1)
					{
						iLocal_855 = 1;
					}
					break;
				...
				case 1:
					if (!unk_0xFCF559C8631ABED7(Local_824[0 /*20*/], "oddjobs@towingpleadingidle_b", "idle_d", 3))
					{
						iLocal_855 = 2;
					}
					break;
...
void func_190()
{
	...
	if (iLocal_781 || ((!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0)) && !unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0)))
	{
		if (iLocal_444 != -1)
		{
			unk_0xF889BDFCC181BA9F(iLocal_444);
			unk_0xCDBCC1BC1184B002(iLocal_444);
			iLocal_444 = -1;
			return;
		}
	}
	if (!iLocal_772)
	{
		iLocal_444 = unk_0xA9ADCC8D104AA552();
		iLocal_772 = 1;
	}
	if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
	{
		if (unk_0xFCF559C8631ABED7(Local_824[0 /*20*/], "oddjobs@towing", "Start_Engine_Loop", 3))
		{
			fVar0 = unk_0xD01FAFCE275C94F3(Local_824[0 /*20*/], "oddjobs@towing", "Start_Engine_Loop");
			if (((fVar0 >= 0.19f && fVar0 <= 0.262f) || (fVar0 >= 0.4f && fVar0 <= 0.6f)) || (fVar0 >= 0.9f && fVar0 <= 1f))
			{
				...
				if (!iLocal_771)
				{
					unk_0x979FC7400A5D0CD2(iLocal_444, "TOWING_ENGINE_TURNING_MASTER", Local_824[0 /*20*/].f_6, 0, 0, 0);
					iLocal_771 = 1;
				}
			}
			else
...
void func_191()
{
	...
	if (unk_0x0347CCBD719C8ADC(uLocal_454))
	{
		unk_0x705B098546DEB18A(&uLocal_454);
	}
	if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
	{
		unk_0x3B2646B62E7BBE11(iLocal_900, 1);
		unk_0xBF0DDDDACD98C554(iLocal_900, 0);
	}
	unk_0x11240D265DE9105F(uLocal_850);
	unk_0x11240D265DE9105F(uLocal_851);
	unk_0x7BACBB4C6A7B18B7(uLocal_903, 0);
	unk_0x7BACBB4C6A7B18B7(uLocal_904, 0);
	unk_0x84A65E2E9CFB6A77(Local_862 - Vector(15f, 15f, 15f), Local_862 + Vector(15f, 15f, 15f), 1, 1);
	iVar0 = 0;
	while (iVar0 < 1)
	{
		unk_0x11240D265DE9105F(Local_824[iVar0 /*20*/].f_17);
		unk_0x11240D265DE9105F(Local_824[iVar0 /*20*/].f_18);
		unk_0x11240D265DE9105F(Local_824[iVar0 /*20*/].f_19);
		iVar0++;
	}
	if (!func_11(Local_394[func_254() /*28*/].f_17))
	{
	...
	unk_0x3D81769BEC61BFF8(&(Local_824[0 /*20*/].f_6));
	if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
	{
		unk_0xB3822DB3D538C8F3(&(Local_824[0 /*20*/]));
		if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/]))
		{
			if (unk_0x611AD675982BEBCC(Local_824[0 /*20*/]))
			{
				unk_0x6221A52631154EF7(Local_824[0 /*20*/]);
			}
		}
	}
	if (unk_0xE5965CDF24F93A9F(uLocal_815))
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_815, 0))
		{
			unk_0xB3822DB3D538C8F3(&iLocal_815);
		}
	}
	if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
	{
		unk_0x2D58A6131679D82C(iLocal_900, 1, 1);
		unk_0x3D81769BEC61BFF8(&iLocal_900);
	}
	if (iLocal_797)
	{
		unk_0x84A65E2E9CFB6A77(Local_470, Local_471, 1, 1);
	}
	if (iLocal_794 && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_7, 0))
	{
		unk_0xD3BDAED335D2DB3E(Local_824[0 /*20*/].f_7, 1);
		unk_0x419230303ABC3B0B(&(Local_824[0 /*20*/].f_7), 0);
	...
	func_120(&iLocal_444);
	func_144(&uLocal_149, 0, 0);
	if (unk_0x876B1078E90C91CB(Local_822))
	{
		func_189(&Local_822);
	}
...
int func_194()
{
	...
	if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0) && !unk_0x55B23FE400FCEA6B(iLocal_900, 0))
	{
		if (unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], iLocal_900, 0))
		{
			if (unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_10))
			{
				unk_0xFFD8EB5462B07B59(&(Local_824[0 /*20*/].f_10));
				func_120(&iLocal_444);
			}
		}
		else if (!unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
		{
			func_120(&iLocal_444);
		}
	}
	switch (iLocal_910)
	{
		case 0:
			...
			{
				Local_824[0 /*20*/].f_7 = unk_0x27A58935528FC12F(6, Local_393[iLocal_450 /*23*/].f_6, Local_393[iLocal_450 /*23*/].f_5, 0, 0);
				if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_7))
				{
					Local_824[0 /*20*/].f_10 = unk_0xEFD6451BF0F3352F(Local_824[0 /*20*/].f_7);
				}
				iLocal_815 = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_7, 4, joaat("s_m_m_lsmetro_01"), -1, 1, 1);
				unk_0x50274A7EACA3133A(iLocal_815, 1);
				if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_7, 0))
				{
					unk_0x2FB817738FFFDC38(Local_824[0 /*20*/].f_7, 0f);
				}
				func_113("TOW_OBJ_05", 7500, 1);
				settimera(0);
				func_197("CROSSING_BELL", &iLocal_445, 1, 0, 226.8878f, -2538.421f, 4.8665f, "TONYA_03_SOUNDSET");
				iLocal_910 = 1;
			}
			break;
		...
		case 2:
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_7, 0))
			{
				unk_0x2FB817738FFFDC38(Local_824[0 /*20*/].f_7, 26f);
				unk_0x95F65274C3AB868E(Local_824[0 /*20*/].f_7, 22f);
			}
			iLocal_910 = 3;
			break;
		
		case 3:
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_7, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
			{
				if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < 175f)
				{
					func_196(Local_824[0 /*20*/].f_7);
					func_197("TOWING_TRAIN_BRAKES_MASTER", &iLocal_443, 1, Local_824[0 /*20*/].f_7, 0, 0, 0, 0);
					func_195(&uLocal_918, Local_824[0 /*20*/].f_7);
					func_197("TOWING_TRAIN_HORN_MASTER", &iLocal_442, 1, Local_824[0 /*20*/].f_7, 0, 0, 0, 0);
					iLocal_910 = 4;
				}
			}
			else
		...
		case 4:
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_7, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
			{
				...
				Var0 = { unk_0x6B62510F212526DC(Local_824[0 /*20*/].f_7, 1) };
				if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < 3f)
				{
					iLocal_768 = 1;
				}
				if (unk_0x72F6AE51B7E34865(Local_824[0 /*20*/].f_7, Local_824[0 /*20*/].f_6))
				{
					if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
					{
						if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
						{
							unk_0x25780288AB87BA6F(iLocal_900, Local_824[0 /*20*/].f_6);
						}
					}
					unk_0x207617CE1796D28E(Local_824[0 /*20*/].f_6, 1, 0);
					iLocal_910 = 6;
				}
				else if (func_10(Local_824[0 /*20*/].f_6, Var0, 1) < 10f && unk_0xD132EDDA78FF4A51(Local_824[0 /*20*/].f_6, Local_393[iLocal_450 /*23*/].f_13, Local_393[iLocal_450 /*23*/].f_16, Local_393[iLocal_450 /*23*/].f_19, 0, 1, 0))
				{
					iLocal_768 = 1;
					if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
					{
...
int func_196(int iParam0)
{
	...
	if (func_3(&uLocal_439, 0.15f))
	{
		...
		func_59(&uLocal_439);
		unk_0x2FB817738FFFDC38(iParam0, fLocal_446);
		unk_0x95F65274C3AB868E(iParam0, fLocal_446);
	}
	return 1;
}
	...
	switch (iLocal_909)
	{
		case 0:
			if (bLocal_799)
			{
				if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					Local_824[0 /*20*/] = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, uLocal_820[0], 1, 1, 1);
					unk_0x50274A7EACA3133A(Local_824[0 /*20*/], 1);
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWSEXMANLYGUY", 0, 1);
					Local_824[0 /*20*/].f_1 = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, iLocal_47, 2, 1, 1);
					unk_0x50274A7EACA3133A(Local_824[0 /*20*/].f_1, 1);
					unk_0xD6A76BAB45A4B460(Local_824[0 /*20*/].f_1, 42, 1);
					func_255(&Local_396, 6, Local_824[0 /*20*/].f_1, "TOWSEXPRISSYGUY", 0, 1);
					unk_0x49D97B076E3590AC(Local_824[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x49D97B076E3590AC(Local_824[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
					{
						unk_0x3B2646B62E7BBE11(Local_824[0 /*20*/].f_6, 10);
					}
			...
			else if (bLocal_800)
			{
				if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					Local_824[0 /*20*/] = unk_0x487C17B41938052C(Local_824[0 /*20*/].f_6, 26, uLocal_820[0], 0, 1, 1);
					unk_0x50274A7EACA3133A(Local_824[0 /*20*/], 1);
					unk_0xD6A76BAB45A4B460(Local_824[0 /*20*/], 42, 1);
					func_255(&Local_396, 2, Local_824[0 /*20*/], sLocal_467, 0, 1);
					unk_0x49D97B076E3590AC(Local_824[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					bLocal_190 = true;
				}
			}
			else if (func_207())
		...
		case 1:
			if (bLocal_799)
			{
				if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), unk_0x6B62510F212526DC(Local_824[0 /*20*/].f_6, 1), 15f, 15f, 15f, 0, 1, 0))
					{
						if (!iLocal_927)
						{
							if (func_169(&Local_396, "TOWAUD", "TOW_SEX_SNDS", 9, 0, 0, 0))
							{
								iLocal_927 = 1;
							}
						}
			...
			if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
			{
				if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6) || func_206(iLocal_900, Local_824[0 /*20*/].f_6, !(bLocal_799 || bLocal_800)))
				{
					if (func_206(iLocal_900, Local_824[0 /*20*/].f_6, !(bLocal_799 || bLocal_800)))
					{
						bLocal_813 = true;
					}
					if (!bLocal_800)
					{
						func_205(&uLocal_894, 1f);
					}
					else
					{
						func_261(&uLocal_894);
			...
			if (func_7(&uLocal_894) && func_4(&uLocal_894) > 1f)
			{
				if (bLocal_799 && func_7(&uLocal_894))
				{
					...
					if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
					{
						...
						unk_0xA888F8CC04F25CC8(&uLocal_171);
						unk_0xAB7639D658BBCCEE(0, 0, 0);
						unk_0x529D306014D3C29A(0, Local_824[0 /*20*/], 0);
						unk_0x49D97B076E3590AC(0, "oddjobs@towingpleadingidle_a", "idle_c", 0.25f, 0.25f, 30000, 1, 0, 0, 0, 0);
						unk_0x7734082B0EDB0BE0(0, Local_824[0 /*20*/], 1000f, -1, 0, 0);
						unk_0xD86A0BC9CC0A625A(0, 1193033728, 0);
						unk_0xC963A45B50851768(uLocal_171);
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_1, 0))
						{
				...
				else if (bLocal_800)
				{
					if ((Global_112915.f_19973.f_4 % 2) == 0)
					{
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
						{
							unk_0xA888F8CC04F25CC8(&uLocal_171);
							unk_0xAB7639D658BBCCEE(0, 0, 0);
							unk_0xC149E50FBB27DD70(0, iLocal_900, 20000, 9f, 1f, 1073741824, 0);
							unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 0);
						...
						func_255(&Local_396, 2, Local_824[0 /*20*/], "TOWABDBITCHM", 0, 1);
						func_169(&Local_396, "TOWAUD", "TOW_HOM_ANGR", 9, 0, 0, 0);
					}
					else
					{
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
						{
							func_204(Local_824[0 /*20*/]);
							unk_0xBC12D08EE7559CCD(Local_824[0 /*20*/], 0, 0);
							unk_0xBC12D08EE7559CCD(Local_824[0 /*20*/], 1, 0);
							unk_0xA888F8CC04F25CC8(&uLocal_171);
							unk_0xAB7639D658BBCCEE(0, 0, 0);
							unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 0);
							...
							if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/]))
							{
								uLocal_818 = unk_0xEFD6451BF0F3352F(Local_824[0 /*20*/]);
								unk_0xA582EE8380437B1B(uLocal_818, 1);
								unk_0x293A9399E902A33B(uLocal_818, 0.7f);
								func_203(Local_824[0 /*20*/], uLocal_818, 1);
							}
							bLocal_798 = true;
						}
						func_169(&Local_396, "TOWAUD", "TOW_HOM_DRG", 9, 0, 0, 0);
					}
					iLocal_909 = 2;
				}
				else if (bLocal_798)
				{
					Local_824[0 /*20*/] = unk_0xA8D58C3AADA2C41C(4, uLocal_820[0], Local_393[iLocal_450 /*23*/].f_6, Local_393[iLocal_450 /*23*/].f_9, 1, 1);
					unk_0x50274A7EACA3133A(Local_824[0 /*20*/], 1);
					unk_0xD6A76BAB45A4B460(Local_824[0 /*20*/], 42, 1);
					bLocal_190 = true;
					...
					{
						unk_0xA888F8CC04F25CC8(&uLocal_171);
						unk_0xC149E50FBB27DD70(0, iLocal_900, 20000, 15f, 3f, 1073741824, 0);
						unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
						unk_0xC963A45B50851768(uLocal_171);
						unk_0x8ACADA903FCAA42F(Local_824[0 /*20*/], uLocal_171);
						unk_0x7461D7C5BA953BC7(&uLocal_171);
				...
				else
				{
					...
					unk_0x50274A7EACA3133A(Local_824[0 /*20*/], 1);
					unk_0xD6A76BAB45A4B460(Local_824[0 /*20*/], 42, 1);
					unk_0x006574E87E6F1942(Local_824[0 /*20*/], 1, 1);
					bLocal_190 = true;
		...
		case 2:
			if (bLocal_799)
			{
				if (!bLocal_807)
				{
					if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6) || bLocal_813)
					{
						if (!unk_0x559C03F53E6937FC())
						{
							if (!func_47())
							{
								if (func_169(&Local_396, "TOWAUD", "TOW_SEX_INIT", 9, 0, 0, 0))
								{
									bLocal_807 = true;
								}
							}
			...
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
			{
				if (!unk_0xD5C6B5E3B93A5EDC(Local_824[0 /*20*/], 0))
				{
					if (bLocal_800)
					{
						if (!func_47())
						{
							if (unk_0x174CED88B97C78D9(Local_824[0 /*20*/], 242628503) == 1)
							{
								if (unk_0x0829092F169950AB(Local_824[0 /*20*/]) == 2)
								{
									if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
									{
										Var1 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
									}
									if (vdist2(Var1, unk_0x6B62510F212526DC(Local_824[0 /*20*/], 1)) < 400f)
									{
										if ((Global_112915.f_19973.f_4 % 2) == 0)
										{
											func_169(&Local_396, "TOWAUD", "TOW_HOM_ANG1", 9, 0, 0, 0);
										}
										else
										{
											func_169(&Local_396, "TOWAUD", "TOW_HOM_ANG2", 9, 0, 0, 0);
										}
									}
									iLocal_909 = 8;
								}
					...
					else if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
					{
						if (func_202() || (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6) && !bLocal_813))
						{
							func_170();
							iLocal_909 = 5;
						}
						else if (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6) && bLocal_813)
						{
							if (bLocal_807)
							{
								if (!func_47())
		...
		case 3:
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
			{
				if (func_117(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 1) < 12f)
				{
					unk_0x03A927199A2DFE46(Local_824[0 /*20*/]);
					if (bLocal_798)
					{
						unk_0xC1A74225341AA9FB(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 0, 16);
					}
					else if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
					{
						unk_0xA888F8CC04F25CC8(&uLocal_171);
						unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 0);
		...
		case 4:
			if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/]))
			{
				...
				if (bLocal_798)
				{
					unk_0xA582EE8380437B1B(Local_824[0 /*20*/].f_9, 1);
					unk_0x293A9399E902A33B(Local_824[0 /*20*/].f_9, 0.7f);
				}
				else
				{
			...
			if (bLocal_798)
			{
				...
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWABDHANDMAN2", 0, 1);
					func_201(Local_396, "TOWAUD", "TOW_PED_ANGR", 0);
				}
				else
				{
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_255(&Local_396, 2, Local_824[0 /*20*/], "TOWABDATTACKM", 0, 1);
					func_201(Local_396, "TOWAUD", "TOW_HOM_DRG", 0);
				}
			}
			else
			{
				func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
				func_255(&Local_396, 3, Local_824[0 /*20*/], sLocal_467, 0, 1);
				func_201(Local_396, "TOWAUD", sLocal_464, 0);
			}
			bLocal_791 = true;
			settimera(0);
			if (bLocal_798)
		...
		case 5:
			if (!func_47())
			{
				...
				func_59(&uLocal_888);
				if ((!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0)) && !unk_0x55B23FE400FCEA6B(iLocal_900, 0))
				{
					if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						unk_0x6FCE069E4940878C(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
					}
					else
					{
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
						...
						unk_0xB486640392EC50BB(0, Local_824[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
						unk_0xAD6CDBCDA713560A(0, Local_824[0 /*20*/].f_6, 5f, 786597);
						unk_0xC963A45B50851768(uVar0);
						if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
						{
							unk_0x8ACADA903FCAA42F(Local_824[0 /*20*/], uVar0);
						}
						unk_0x7461D7C5BA953BC7(&uVar0);
						bLocal_928 = true;
					}
		...
		case 6:
			...
			if (!bLocal_805)
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
				{
					if (!unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						if (bLocal_799)
						{
							if (timerb() > 8000)
							{
								...
								{
									unk_0x3B2646B62E7BBE11(Local_824[0 /*20*/].f_6, 1);
									unk_0xB486640392EC50BB(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
								}
								iLocal_909 = 7;
							}
						}
					...
					else if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
					{
						if (timerb() > 7000)
						{
							if (!bLocal_798)
							{
								if (unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
								{
									if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
									{
										if (unk_0x207D53F9E0190691(iLocal_900) < 2f)
										{
											if (unk_0x174CED88B97C78D9(Local_824[0 /*20*/], -258271821) != 1)
											{
												unk_0xAD6CDBCDA713560A(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 2f, 786597);
											}
										}
										else
										{
								...
								else if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0))
								{
									if (unk_0x207D53F9E0190691(iLocal_900) < 5f)
									{
										if (unk_0x174CED88B97C78D9(Local_824[0 /*20*/], -1794415470) != 1)
										{
											if (unk_0x7158135695FAE89D(Local_824[0 /*20*/].f_6, -1, 0))
											{
												unk_0xB486640392EC50BB(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, -1, -1, 1073741824, 1, 0);
											}
										}
									}
									else if (unk_0x174CED88B97C78D9(Local_824[0 /*20*/], 1056466932) != 1)
									{
										unk_0x6FCE069E4940878C(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
									}
								}
		...
		case 7:
			func_199(1);
			if (unk_0xD5C6B5E3B93A5EDC(Local_824[0 /*20*/], 0) && !unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6))
			{
				if (bLocal_798)
				{
				...
				bLocal_804 = true;
				func_169(&Local_396, "TOWAUD", sLocal_464, 9, 0, 0, 0);
				bLocal_791 = false;
				unk_0xAD6CDBCDA713560A(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 5f, 786597);
				iLocal_909 = 8;
				return 1;
			}
			break;
		...
		case 8:
			...
			if (unk_0x12DD4A0B247D9B4D(Local_824[0 /*20*/].f_9))
			{
				unk_0xFFD8EB5462B07B59(&(Local_824[0 /*20*/].f_9));
			}
			break;
	}
	return 0;
...
void func_199(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_900, 0) && !unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
		{
			if (unk_0x671CB92F637FDB33(iLocal_900, Local_824[0 /*20*/].f_6) && !unk_0xF6F5D18EF8EAB859(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
			{
				iVar0 = 1;
			}
		}
	...
	if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
	{
		if (unk_0x0747E45CFF1F74AA(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 1) || unk_0x0747E45CFF1F74AA(unk_0xE2D3D51028F0428A(), Local_824[0 /*20*/], 1))
		{
			func_59(&uLocal_888);
			unk_0xE68645525D451A8B(Local_824[0 /*20*/]);
	...
	else if (((fVar1 > 35f || (func_4(&uLocal_888) > 30f && fVar1 > 5f)) || iVar0) || (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0) && unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6)))
	{
		if (bLocal_798)
		{
			func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWABDHANDMAN2", 0, 1);
		...
		{
			func_255(&Local_396, 6, Local_824[0 /*20*/], "TOWABDHANDMAN1", 0, 1);
			sVar2 = "TOW_PED_ANC2";
		}
		uLocal_814[0] = Local_824[0 /*20*/];
		uLocal_814[1] = Local_824[0 /*20*/].f_1;
		bLocal_805 = true;
		func_200(Local_396, "TOWAUD", sVar2, &uLocal_814, 0);
		unk_0xFFD8EB5462B07B59(&(Local_824[0 /*20*/].f_9));
		if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/], 0))
		{
			unk_0x03A927199A2DFE46(Local_824[0 /*20*/]);
...
void func_201(struct<165> Param0, char* sParam1, char* sParam2, bool bParam3)
{
	if (bParam3)
	{
		unk_0xD681CC2BC1084DB6(0);
...
int func_202()
{
	...
	{
		case 0:
			if (unk_0x0829092F169950AB(Local_824[0 /*20*/]) >= 1 && !unk_0x559C03F53E6937FC())
			{
				iLocal_912 = 1;
			}
			break;
		...
		case 1:
			if (bLocal_807 && !iLocal_808)
			{
				if (!func_47())
				{
					...
					if (iLocal_809 && !unk_0x559C03F53E6937FC())
					{
						if (unk_0x174CED88B97C78D9(Local_824[0 /*20*/], -875674219) != 1)
						{
							unk_0x529D306014D3C29A(Local_824[0 /*20*/], Local_824[0 /*20*/].f_1, 0);
						}
						iLocal_808 = 1;
						iLocal_912 = 2;
					}
...
int func_203(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		if (Local_69[iVar0 /*3*/] == iParam0 && !unk_0x12DD4A0B247D9B4D(Local_69[iVar0 /*3*/].f_1))
		{
		}
		iVar0++;
	}
...
void func_208()
{
	...
	if (!iLocal_780)
	{
		if (unk_0xE5965CDF24F93A9F(Local_824[0 /*20*/].f_6))
		{
			if (!unk_0x55B23FE400FCEA6B(Local_824[0 /*20*/].f_6, 0))
			{
				Var1 = { unk_0x6B62510F212526DC(Local_824[0 /*20*/].f_6, 1) };
			}
		}
		if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
		{
		...
		if (bLocal_799)
		{
			if (vdist2(Var0, Var1) < 25f)
			{
				...
				if (!func_47())
				{
					unk_0xF30F15F203736DE4(Local_824[0 /*20*/], unk_0xE2D3D51028F0428A(), 5000, 0, 2);
					func_255(&Local_396, 5, Local_824[0 /*20*/], "TOWSEXMANLYGUY", 0, 1);
					if (func_169(&Local_396, "TOWAUD", "TOW_HANDI_CL", 9, 0, 0, 0))
					{
						iLocal_780 = 1;
					}
				}
...
int func_209(var uParam0, int iParam1)
{
	...
	if (func_3(&uLocal_184, unk_0xC4EAB25A108C2429(fLocal_181, fLocal_182)))
	{
		func_59(&uLocal_184);
		unk_0x3F6DE6DBA9A99FEA(uParam0, 1, 0f, 0f, fLocal_183, -0.0067f, -0.8283f, -0.2766f, 0, 1, 1, 1, 1, 1);
	}
	return 1;
}
...
int func_212(int iParam0, int iParam1, struct<7> Param2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, char* sParam18, var uParam19, bool bParam20, var uParam21)
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
	...
	if (!bLocal_215)
	{
		...
		switch (iLocal_447)
		{
			case 0:
				if (func_121(uParam1, uParam0, &iLocal_449, 10, 90f, 100f, 0))
				{
					...
					func_255(&Local_396, 3, *uParam21, "TONYA", 0, 1);
					func_255(&Local_396, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_169(&Local_396, "TOWAUD", "TOW_TUT_INS1", 9, 0, 0, 0);
					iLocal_447 = 1;
				}
				break;
			...
			case 2:
				...
				if (timera() > 5000)
				{
					...
					{
						func_169(&Local_396, "TOWAUD", "TOW_TUT_INS2", 9, 0, 0, 0);
						iLocal_447 = 3;
					}
				}
				break;
			...
			case 6:
				if ((!func_47() && !unk_0x559C03F53E6937FC()) && timera() > 12000)
				{
					if (!iLocal_208)
					{
				...
				{
					func_169(&Local_396, "TOWAUD", "TOW_TUT_INS4", 9, 0, 0, 0);
					if (unk_0x12DD4A0B247D9B4D(*uParam16))
					{
						unk_0xAAD76B24A5282FDD(*uParam16, 0);
						unk_0xFFD8EB5462B07B59(uParam16);
					}
					StringCopy(sParam18, "TOW_TUT_04A", 64);
					*(uParam17[0 /*3*/]) = { Param2.f_14 };
					fLocal_180 = func_9(Param2.f_14, 0);
					*uParam16 = unk_0xC5B823372B67998A(Param2.f_14);
					settimerb(0);
					iLocal_447 = 7;
				}
				break;
			...
			case 9:
				...
				if (!func_47())
				{
					...
					{
						iLocal_218 = unk_0x320D1840B6DAA1CC();
						if (bLocal_192)
						{
							unk_0xAAD76B24A5282FDD(*uParam16, 0);
							unk_0xFFD8EB5462B07B59(uParam16);
						...
						if (unk_0x12DD4A0B247D9B4D(*uParam16))
						{
							unk_0xA582EE8380437B1B(*uParam16, 5);
						}
						iLocal_447 = 10;
					}
				}
			...
			case 10:
				...
				if (unk_0xD132EDDA78FF4A51(uParam1, Var0, Var1, uVar2, 0, 1, 0))
				{
					func_103("TOWT_HELP_UH", -1);
					func_214();
			...
			case 11:
				...
				if (unk_0xD132EDDA78FF4A51(iParam1, Var0, Var1, uVar2, 0, 1, 0))
				{
					func_103("TOWT_HELP_UH", -1);
					func_214();
				}
		...
		if (bParam20)
		{
			if (((unk_0xE5965CDF24F93A9F(iParam0) && unk_0xE5965CDF24F93A9F(iParam1)) && !unk_0x55B23FE400FCEA6B(iParam0, 0)) && !unk_0x55B23FE400FCEA6B(iParam1, 0))
			{
				if (unk_0x671CB92F637FDB33(iParam0, iParam1) && !bLocal_448)
				{
					if (func_47())
					{
					...
					else
					{
						...
						settimera(0);
						iLocal_447 = 6;
						func_169(&Local_396, "TOWAUD", "TOW_TUT_INS3", 9, 0, 0, 0);
						bLocal_448 = true;
					}
				}
			}
...
void func_213()
{
	switch (iLocal_224)
	{
		case 0:
			...
			{
				if (func_169(&uLocal_227, "TOWAUD", "TOW_SUGG2", 9, 0, 0, 0))
				{
					iLocal_224 = 1;
				}
			}
		...
		case 1:
			if (!func_47())
			{
				if (func_169(&uLocal_227, "TOWAUD", "TOW_RESP", 9, 0, 0, 0))
				{
					func_59(&uLocal_409);
					iLocal_224 = 2;
				}
		...
		case 2:
			if (func_7(&uLocal_409))
			{
				if (func_4(&uLocal_409) > 15f)
				{
					if (!func_47())
					{
						if (func_169(&uLocal_227, "TOWAUD", "TOW_WAIT", 9, 0, 0, 0))
						{
							iLocal_224 = 3;
						}
					}
...
void func_214()
{
	if (!iLocal_207)
	{
		if (!unk_0x559C03F53E6937FC())
		{
			if (!func_47())
			{
				if (func_169(&uLocal_227, "TOWAUD", "TONYA_UNHOOK", 9, 0, 0, 0))
				{
					iLocal_207 = 1;
				}
			}
...
void func_216(struct<7> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15)
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
	
	if (!unk_0xE5965CDF24F93A9F(uParam14) || !unk_0xE5965CDF24F93A9F(uParam15))
	{
		return;
	}
	if (unk_0x55B23FE400FCEA6B(iParam14, 0) || unk_0x55B23FE400FCEA6B(iParam15, 0))
	{
		return;
	}
	...
	if (!iLocal_193)
	{
		if (unk_0xD132EDDA78FF4A51(iParam15, Var0, Var1, uVar2, 0, 1, 0))
		{
			if (!unk_0x55B23FE400FCEA6B(iParam14, 0) && !unk_0x55B23FE400FCEA6B(iParam15, 0))
			{
				if (!unk_0x671CB92F637FDB33(iParam14, iParam15))
				{
					unk_0x3410421C60BF7143(1);
					unk_0xBA6C3C5E9E5A9442();
					iLocal_447 = 12;
	...
	switch (*uParam0)
	{
		case 0:
			if (*uParam3 > 250)
			{
				if (bParam4)
				{
					if (func_169(&Local_396, "TOWAUD", "TOW_DISP_DMA", 8, 0, 0, 0))
					{
						*uParam0 = 1;
					}
				}
				else if (func_169(&Local_396, "TOWAUD", "TOW_DISP_DMT", 8, 0, 0, 0))
				{
					*uParam0 = 1;
				}
				if (bParam4)
		...
		case 1:
			if (*uParam3 > 500)
			{
				...
				else if (func_169(&Local_396, "TOWAUD", "TOW_DISP_DT2", 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
				if (bParam4)
		...
		case 2:
			if (*uParam3 > 900)
			{
				if (bParam4)
				{
					func_169(&Local_396, "TOWAUD", "TOW_DISP_DMB", 8, 0, 0, 0);
					*uParam0 = 3;
				}
				else
				{
					func_169(&Local_396, "TOWAUD", "TOW_DISP_DT2", 8, 0, 0, 0);
					*uParam0 = 3;
				}
				if (bParam4)
				{
...
void func_221(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)
{
	...
	if (bParam11)
	{
		...
		*uParam5 = unk_0x320D1840B6DAA1CC();
		bLocal_215 = !func_222(uParam0);
		return;
	}
	else if (!unk_0x12DD4A0B247D9B4D(*uParam1) && bLocal_215)
	{
		...
		else if (func_222(uParam0))
		{
			...
			else if (bParam7)
			{
				...
				else
				{
					...
					if (!unk_0x12DD4A0B247D9B4D((uParam2[0 /*20*/])->f_8))
					{
						(uParam2[0 /*20*/])->f_8 = unk_0xC5B823372B67998A(Local_393[iLocal_450 /*23*/].f_1);
...
void func_229(var uParam0)
{
	...
	{
		sLocal_466[0] = "base";
		func_249(&uLocal_482, "amb@world_human_smoking@male@male_a@base");
		func_249(&uLocal_482, "oddjobs@towingcome_here");
		func_249(&uLocal_482, "move_m@JOG@");
	}
	else if ((uParam0->f_3 == 0 || uParam0->f_3 == 2) && !bLocal_793)
	{
		func_249(&uLocal_482, "Ped");
		func_249(&uLocal_482, "oddjobs@towing");
		func_249(&uLocal_482, "oddjobs@towingangryidle_a");
		func_249(&uLocal_482, "oddjobs@towingpleadingidle_b");
		func_249(&uLocal_482, "oddjobs@towingpleadingidle_a");
		func_249(&uLocal_482, "move_m@JOG@");
	}
	else if (bLocal_793)
	{
	...
	if (uParam0->f_3 == 2)
	{
		func_249(&uLocal_482, "RANDOM@CAR_SLEEPING");
	}
	else if (uParam0->f_3 == 4)
	{
		sLocal_465 = "REACTION@MALE_STAND@BIG_VARIATIONS@A";
		func_249(&uLocal_482, sLocal_465);
		func_247(&uLocal_472, joaat("ambulance"));
		func_247(&uLocal_472, joaat("s_m_m_paramedic_01"));
	...
	if (uParam0->f_3 == 1)
	{
		...
		func_249(&uLocal_482, "amb@world_human_smoking@male@male_a@base");
		func_249(&uLocal_482, "oddjobs@towingpleadingidle_b");
		func_247(&uLocal_472, joaat("freightcont1"));
		func_247(&uLocal_472, joaat("tankercar"));
		func_247(&uLocal_472, joaat("freight"));
		func_247(&uLocal_472, joaat("freightcar"));
		func_247(&uLocal_472, joaat("s_m_m_lsmetro_01"));
		func_247(&uLocal_472, joaat("a_f_m_bevhills_01"));
		func_247(&uLocal_472, joaat("a_m_y_genstreet_02"));
	}
	if (uParam0->f_3 == 2)
	{
		func_246();
	...
	while (iVar0 < 1)
	{
		...
		{
			iLocal_819[iVar0] = func_243(&iLocal_819, &iLocal_49, 10);
			unk_0x6B9A9289F29F4166(iLocal_819[iVar0], 3);
		}
		if (bLocal_799)
		{
			iLocal_819[iVar0] = joaat("landstalker");
			func_247(&uLocal_472, iLocal_819[iVar0]);
			unk_0x6B9A9289F29F4166(iLocal_819[iVar0], 3);
		}
	...
	if (!bLocal_793 && iLocal_796)
	{
		...
		while (iVar0 < 2)
		{
			uLocal_820[iVar0] = func_243(&uLocal_820, &iLocal_48, iVar1);
			if (uLocal_820[iVar0] != 0)
			{
				func_247(&uLocal_472, uLocal_820[iVar0]);
			}
			iVar0++;
		}
	}
	func_247(&uLocal_472, iLocal_392);
	func_239(&uLocal_490, "TOW", 2, 0);
	func_239(&uLocal_490, "DTRSHRD", 3, 0);
	func_238(&uLocal_472);
	func_235(&uLocal_482, &uLocal_490);
	while (!unk_0x0347CCBD719C8ADC(uLocal_454))
	{
		func_224(&uLocal_490);
		wait(0);
	}
	while (!func_234(&uLocal_472) || !unk_0x08A9BDFE90D7CFE2(iLocal_819[0]))
	{
		func_224(&uLocal_490);
		wait(0);
	}
	while (!func_230(&uLocal_490))
	{
		func_224(&uLocal_490);
		wait(0);
	}
...
void func_256()
{
	iLocal_170 = func_258(Global_112915.f_19973.f_2);
	if (!func_257(iLocal_170))
	{
		iLocal_170 = 3;
	}
	if (iLocal_170 == 3)
	...
	{
		iLocal_450 = func_260(1300f, iLocal_170, Global_112915.f_19973.f_9);
		Global_112915.f_19973.f_9 = iLocal_450;
	}
	if (iLocal_450 == 0)
	{
		iLocal_170 = 3;
...
{
	iLocal_450 = func_260(1300f, iParam0, Global_112915.f_19973.f_9);
	if (iLocal_450 == -1)
	{
		return 0;
	}
...
int func_260(float fParam0, int iParam1, int iParam2)
{
	...
	if (iVar4 > 1)
	{
		iVar1 = iVar3[unk_0x5853B15F78E1A265(0, (iVar4 - 1))];
	}
	else if (iVar4 == 1)
	{
		iVar1 = iVar3[0];
...
int func_270(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_281())
	{
		...
		{
			iVar2 = func_271(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
...
void func_273(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
