...
void __EntryFunction__()
{
	...
	{
		uLocal_181 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
		unk_0x15F5DB94F871E803(uLocal_181, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
		unk_0xDD786B89B15AA63F(uLocal_181, 1);
	...
	if (unk_0x876B1078E90C91CB(uLocal_181))
	{
		unk_0x15F5DB94F871E803(uLocal_181, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
	...
	wait(0);
	func_15();
	if (func_56(unk_0xE2D3D51028F0428A()) && func_56(Local_164.f_9))
	{
		unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), -1648.4f, -1127.6f, 18.3f, 1, 0, 0, 1);
		unk_0x9A97DC6DBC7B223D(unk_0xE2D3D51028F0428A(), Local_164.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		unk_0x1C2ED929474DC6FE(unk_0xE2D3D51028F0428A(), 0, 0);
	}
	while (unk_0x320D1840B6DAA1CC() < iVar6)
	{
		wait(0);
	}
	if (unk_0x876B1078E90C91CB(uLocal_181))
	{
		unk_0xDD786B89B15AA63F(uLocal_181, 0);
	...
	if (func_56(unk_0xE2D3D51028F0428A()))
	{
		...
		func_14(&Local_169, Var1, unk_0x63A8BF5E6C2BF85C(Local_164.f_9, 2), 50f, Local_169.f_20, Local_169.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		unk_0x3FB84450A94CB528(Local_169, unk_0xE2D3D51028F0428A(), 0f, 0f, 0.5f, 1);
	}
	wait(0);
	if (func_56(unk_0xE2D3D51028F0428A()) && func_56(Local_165.f_9))
	{
		func_12(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(Local_165.f_9, 1), &fVar4, &fVar5, 1);
		func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
		unk_0x93150D31CE38FE75(Local_169, Vector(fVar5, 0f, fVar4) + Local_169.f_14, 2);
	}
	unk_0x66B27A59829491D3("FAIRGROUND_RIDES_LEVIATHAN");
	iLocal_187 = unk_0x320D1840B6DAA1CC() + 5000;
	...
	while (true)
	{
		...
		if (func_56(unk_0xE2D3D51028F0428A()) && func_56(Local_165.f_9))
		{
			func_12(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(Local_165.f_9, 1), &fVar4, &fVar5, 1);
			func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			unk_0x93150D31CE38FE75(Local_169, Vector((fVar5 + (fVar7 * (fVar8 * 2f))), 0f, (fVar4 + fVar7)) + Local_169.f_14, 2);
		}
		func_53();
		func_2();
		...
		if (unk_0x320D1840B6DAA1CC() > iLocal_187)
		{
			if (fLocal_190 > 0.01f)
			{
				if (fLocal_190 > 0.5f)
				...
				iLocal_187 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(8000, 13000));
			}
		}
		if (iLocal_179 == 0)
		{
...
void func_6()
{
	...
	fVar0 = to_float(unk_0x07141611FD632B59((Local_192[iLocal_191 + 1 /*3*/] - Local_192[iLocal_191 /*3*/])));
...
void func_9(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	{
		uParam0->f_14 = (uParam0->f_14 + func_7(((((Var6.x - uParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
...
void func_17(var uParam0)
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			unk_0xF7A14A1A76B6DD17(0, iLocal_184, iLocal_185);
		}
	}
...
void func_19()
{
	...
	{
		case 0:
			fLocal_163 = (fLocal_163 + (unk_0x51109C28352EC9A3() / 2f));
			if (fLocal_163 >= 5f)
			{
				fLocal_163 = 5f;
				iLocal_168 = 1;
		...
		case 2:
			fLocal_163 = (fLocal_163 - unk_0x51109C28352EC9A3());
			if (fLocal_163 <= 0f)
			{
				fLocal_163 = 0f;
				iLocal_168 = 3;
...
void func_29()
{
	...
	iLocal_180[0] = unk_0x87A467676BDF8C35(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
	iLocal_180[1] = unk_0x87A467676BDF8C35(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_180[2] = unk_0x87A467676BDF8C35(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_180[3] = unk_0x87A467676BDF8C35(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_180[iVar0]))
		{
			unk_0x2D58A6131679D82C(iLocal_180[iVar0], 1, 0);
			unk_0x1C2ED929474DC6FE(iLocal_180[iVar0], 0, 0);
			unk_0x959E1626CBC7D38A(iLocal_180[iVar0], 0, 0);
			unk_0x9210F85E9CD785F1(iLocal_180[iVar0], 1);
		}
		iVar0++;
	}
}
...
int func_49(int iParam0, int iParam1)
{
	...
	unk_0xB38EF75835FAF667(iParam1, &Var2, &Var3);
	if (unk_0x48053974ED6F63CE((Var1 - Var0)) > unk_0x48053974ED6F63CE((Var3 - Var2)))
	{
		return 0;
	}
	if (unk_0x48053974ED6F63CE((Var1.f_1 - Var0.f_1)) > unk_0x48053974ED6F63CE((Var3.f_1 - Var2.f_1)))
	{
		return 0;
	}
	return 1;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xE2D0C323A1AE5D85(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_112(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_112(iVar10, 14, uVar15[iVar1], -1) };
			func_81(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_103(14);
			if (Global_77661 == 1)
			{
...
void func_114(int iParam0)
{
	...
	func_115(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_115(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_115(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
void func_222()
{
	...
	{
		iLocal_180[0] = unk_0x0E536D72AB30F4C8(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_180[1]))
	{
		iLocal_180[1] = unk_0x0E536D72AB30F4C8(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_180[2]))
	{
		iLocal_180[2] = unk_0x0E536D72AB30F4C8(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, 1, 1, 0);
	}
	if (!func_56(iLocal_180[3]))
	{
		iLocal_180[3] = unk_0x0E536D72AB30F4C8(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, 1, 1, 0);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		...
		{
			unk_0xBBF86885619695CE(iLocal_180[iVar0], 140f);
			unk_0x1C2ED929474DC6FE(iLocal_180[iVar0], 1, 0);
			unk_0x959E1626CBC7D38A(iLocal_180[iVar0], 1, 0);
			unk_0x5C65DDDC219B3AA5(iLocal_180[iVar0], 1);
			unk_0x9210F85E9CD785F1(iLocal_180[iVar0], 1);
			func_223(&(iLocal_180[iVar0]), 0);
		}
		iVar0++;
	}
}
...
void func_227()
{
	...
	{
		func_214(13, floor(Global_112915.f_10194.f_3853));
	}
