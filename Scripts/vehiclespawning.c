...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_38)
		{
			if (!iLocal_37 && unk_0xA829C9A2767AC8EF())
			{
				unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Local_45, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(unk_0xE2D3D51028F0428A(), fLocal_43);
				unk_0xCA60DF1D01DBD440(Local_45, 2500f, 0);
...
int func_1()
{
	if (!unk_0x9B28DEEC684DA500(uLocal_44, "garage_decor_01"))
	{
		unk_0x9F9FADBC78E66B6A(uLocal_44, "garage_decor_01");
	}
	else
	{
		unk_0xD665FC4F45F67B23(uLocal_44);
		return 1;
	}
	return 0;
}
...
int func_2()
{
	uLocal_44 = unk_0x6D7EE245AD1E10B0(unk_0xE2D3D51028F0428A());
	if (unk_0xBCC73B466E2B2350(uLocal_44))
	{
		if (!iLocal_40)
		{
			unk_0x62EB051F5ED6DD41(uLocal_44);
			iLocal_40 = 1;
		}
		else if (unk_0xEA02B859DE237081(uLocal_44))
		{
			unk_0xAED5221F05DAE55E(uLocal_44);
			return 1;
		}
	}
	return 0;
