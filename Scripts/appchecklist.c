...
void func_4()
{
	...
	if (Global_19950 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_19950 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_32[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	if (iLocal_21 == 0)
	{
		func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_3092", 0, 0, 0, 0);
	}
	else
	{
		bLocal_31 = true;
...
void func_10()
{
	...
	if (Global_19932 == 0)
	{
		if (func_9(2, Global_19923, 0))
		{
			...
			uLocal_30 = unk_0xD452B47F164A4D79();
			while (!unk_0x17E14239FB53CCE3(uLocal_30))
			{
				wait(0);
			}
			iVar0 = unk_0xC2F770299DFFA794(uLocal_30);
			...
			unk_0x2AE954BA77A66307(iLocal_27);
			unk_0xD1D4F8D5470AFA4C();
			unk_0x6F06CF0E9AB02847();
			unk_0xEA5DEA46C3EE64D3(Global_19935, "SET_DATA_SLOT");
			unk_0x4F47E317C74C543B(18);
			...
			unk_0x2AE954BA77A66307(iLocal_28);
			unk_0xD1D4F8D5470AFA4C();
			unk_0x6F06CF0E9AB02847();
			func_33(Global_19935, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_19935, "SET_HEADER", &(Local_32[iLocal_23 /*6*/]), 0, 0, 0, 0);
...
void func_11()
{
	...
	{
		case 0:
			iLocal_27 = Global_112634;
			iLocal_28 = Global_112651;
			break;
		
		case 1:
			iLocal_27 = (Global_112635 + Global_112636);
			iLocal_28 = (Global_112652 + Global_112653);
			break;
		
		case 2:
			iLocal_27 = Global_112637;
			iLocal_28 = Global_112654;
			break;
		
		case 3:
			iLocal_27 = Global_112638;
			iLocal_28 = Global_112655;
			break;
		
		case 4:
			iLocal_27 = (Global_112639 + Global_112640);
			iLocal_28 = (Global_112656 + Global_112657);
			break;
...
void func_15()
{
	if (Global_19932 == 0)
	{
		if (func_9(2, Global_19923, 0))
		{
			...
			iLocal_29 = unk_0xC2F770299DFFA794(uLocal_30);
			if (Global_19954.f_1 > 3)
			{
				Global_19954.f_1 = 8;
				if (iLocal_29 == 0)
...
void func_16()
{
	...
	if (func_17(0))
	{
		func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, "CELL_229", 0, 0, 0, 0);
	}
	else
	{
		while (iVar0 < Global_94975)
		{
			func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, &(Global_94766[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_21++;
...
void func_26()
{
	func_33(Global_19935, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_28()
{
	func_33(Global_19935, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x91DFC8F68F6D9B05(-1, "Menu_Navigate", &Global_19943, 1);
	func_29();
}
...
{
	func_33(Global_19935, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_3301", 0, 0, 0, 0);
	func_7(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(1), to_float(0), -1f, -1f, "CELL_3302", 0, 0, 0, 0);
	iLocal_21 = 2;
	func_33(Global_19935, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_19935, "SET_HEADER", "CELL_23", 0, 0, 0, 0);
	if (Global_19942)
