...
int func_2()
{
	...
	if (vdist(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0x174CED88B97C78D9(iParam0, -1146898486) != 1)
				{
					...
					unk_0xABC2CA6F28903308(iLocal_68[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xACC32B78196FBC2A(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (vdist2(unk_0x6B62510F212526DC(iParam0, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0xACC32B78196FBC2A(&(Local_71[iVar0 /*4*/])))
			{
				unk_0xAF76A37C80EFD1D8(&(Local_71[iVar0 /*4*/]));
				if (!unk_0xF79F112CE5999680(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xA8D58C3AADA2C41C(4, iLocal_69[iVar0], Local_72 + Local_74[iVar0 /*3*/], 0, 1, 1);
			unk_0xBBF86885619695CE(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0xC252F409BDE7A700(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			Local_74[3 /*3*/] = { Vector(45.5004f, unk_0xC4EAB25A108C2429(-205.8167f, -210.4254f), unk_0xC4EAB25A108C2429(-1416.54f, -1428.501f)) - Local_72 };
