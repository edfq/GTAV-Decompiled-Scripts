	...
	switch (iLocal_81)
	{
		case 0:
			...
			if (!unk_0xACC32B78196FBC2A(sLocal_187))
			{
				...
				{
					while ((unk_0x320D1840B6DAA1CC() - iLocal_199) < 3000)
					{
						wait(0);
					}
				}
...
void func_23()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_93(unk_0xE2D3D51028F0428A(), Local_196, 2f) && func_87(21))
			{
			...
			else
			{
				...
				if (bLocal_190)
				{
					iLocal_198 = unk_0x320D1840B6DAA1CC();
					iLocal_81 = 2;
				}
				else if (!func_93(unk_0xE2D3D51028F0428A(), Local_195, 75f))
				{
					if (!iLocal_201)
					{
						func_22(&uLocal_192);
				...
				else if (func_93(unk_0xE2D3D51028F0428A(), Local_196, 12f))
				{
					if (iLocal_201)
					{
						func_22(&uLocal_192);
		...
		case 2:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_198) > 2000)
			{
				func_22(&uLocal_192);
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (bParam1)
			{
				func_95(unk_0xE2D3D51028F0428A(), Local_196, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_97(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			unk_0x249A0D3C5714BCF4(sLocal_203, 6);
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_93(unk_0xE2D3D51028F0428A(), Local_195, 60f))
				{
		...
		case 3:
			func_95(unk_0xE2D3D51028F0428A(), Local_196, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_184(struct<3> Param0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_197(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_198(iParam0, uVar1[iVar3], 1) && func_98(unk_0x6B62510F212526DC(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_193(Param1, 0f, 0f, 0f, 0)) || unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam0, 1), unk_0x6B62510F212526DC(uVar1[iVar3], 1), 1) < 10f)
					{
	...
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			if (!bLocal_190)
			{
				...
				{
					iLocal_199 = unk_0x320D1840B6DAA1CC();
					func_227(4);
					return;
				}
			}
			...
			if (!bLocal_190)
			{
				if (!func_93(unk_0xE2D3D51028F0428A(), Local_195, 150f))
				{
					func_227(2);
				}
				else if (!func_93(unk_0xE2D3D51028F0428A(), Local_195, 75f))
...
void func_275(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_283(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_276(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_283(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(uVar1, 10, -1, 0, -1, func_284(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_342(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_343(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
