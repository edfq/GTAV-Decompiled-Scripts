...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			func_21();
			if (!unk_0xACC32B78196FBC2A(sLocal_189))
			{
				if (unk_0x3C57C2F07FEE34D2(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((unk_0x320D1840B6DAA1CC() - iLocal_373) < 2000)
					{
						wait(0);
					}
				}
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_8(Global_112915.f_18533[iVar0], &Var2, &fVar3))
			{
...
int func_39(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4)
{
	...
	if (func_27(uParam0))
	{
		...
		unk_0xBBF86885619695CE(uParam0, uParam2);
		if (bParam3)
		{
			return bVar0;
		}
...
int func_95(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_38(unk_0xE2D3D51028F0428A(), Local_200, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_96(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0x249A0D3C5714BCF4(sLocal_190, 0);
			unk_0x249A0D3C5714BCF4(sLocal_202, 6);
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_95(iLocal_81, bLocal_28))
			{
				...
				if (unk_0x12DD4A0B247D9B4D(uLocal_197))
				{
					unk_0xA582EE8380437B1B(uLocal_197, 2);
					unk_0xDA6437EA059F152A(uLocal_197, 2);
				}
		...
		case 1:
			func_106();
			if (func_105(unk_0xE2D3D51028F0428A(), Local_200, 2f) && func_104(28))
			{
				if (!iLocal_196)
				{
					unk_0xBA5D7196EACB9282(unk_0x9E2D6C50374FCFA9());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(unk_0xE2D3D51028F0428A(), Local_200, 75f))
					{
						if (!iLocal_195)
						{
							func_22(&uLocal_197);
					...
					else if (func_105(unk_0xE2D3D51028F0428A(), Local_200, 12f))
					{
						if (iLocal_195)
						{
							func_22(&uLocal_197);
...
void func_108(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4)
{
	if (!unk_0x12DD4A0B247D9B4D(*uParam0))
	{
		*uParam0 = func_109(Param1, 5, iParam2);
		if (bParam3)
		{
			unk_0xAF62582F3EA39095(*uParam0, sParam4);
		}
	}
}
...
{
	return func_197(&(Global_106464.f_2890), Param0, fParam1, 0);
}
...
int func_199(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_200(iParam0, uVar1[iVar3], 1) && func_97(unk_0x6B62510F212526DC(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_195(Param1, 0f, 0f, 0f, 0)) || unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam0, 1), unk_0x6B62510F212526DC(uVar1[iVar3], 1), 1) < 10f)
					{
...
{
	return func_222(Global_106464.f_2890.f_12.f_66, Param0, iParam1);
}
...
void func_224()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(unk_0xE2D3D51028F0428A(), Local_200, 150f))
				{
					func_231(2);
				}
				else if (!func_105(unk_0xE2D3D51028F0428A(), Local_200, 75f))
				{
					if (!bLocal_201)
					{
						unk_0xBA6C3C5E9E5A9442();
...
void func_278(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_279())
	{
...
void func_285(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_293(iVar7, iParam0, 155, -1);
			return;
			break;
	}
	func_286(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_293(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_286(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_286(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(uVar1, 10, -1, 0, -1, func_294(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_351(var uParam0, int iParam1)
{
	...
	{
		func_355(&uLocal_84, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_354(&uLocal_84);
	func_352(&uLocal_136, &uLocal_84, 50f);
}
...
void func_352(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_353(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
bool func_353(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_360(bool bParam0)
{
	...
	if (unk_0x876B1078E90C91CB(uLocal_198))
	{
		unk_0x850D4EF3D40FB068(0, 0, 3000, 1, 0, 0);
		unk_0x588DDCB644C6486A(uLocal_198, 0);
	}
}
