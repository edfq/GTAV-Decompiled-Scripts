...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_205(Var0.f_28[0]))
		{
			...
			{
				func_188(&uLocal_58, unk_0x6B62510F212526DC(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_187(Var0))
		{
			if ((unk_0x320D1840B6DAA1CC() - iLocal_54) > 5000)
			{
				iVar2 = 1;
...
void func_188(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3)
{
	...
	{
		case 0:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_224) > 5000)
			{
				*uParam0 = 1;
			}
			break;
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0xE2D3D51028F0428A()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam6) && func_201(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_252()
{
	...
	if (func_205(unk_0xE2D3D51028F0428A()))
	{
		if (func_253(unk_0xE2D3D51028F0428A(), Var0, fVar1))
		{
			func_150();
		}
	}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_41[0]))
			{
				...
				{
					unk_0x9A97DC6DBC7B223D(uParam0->f_41[0], uParam0->f_35[0], 0, Var3, Var4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_41[0]))
			{
				...
				if (unk_0xE5965CDF24F93A9F(uParam0->f_41[0]) && unk_0xE5965CDF24F93A9F(uParam0->f_35[0]))
				{
					unk_0x9A97DC6DBC7B223D(uParam0->f_41[0], uParam0->f_35[0], 0, Var2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
