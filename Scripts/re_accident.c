	...
	while (true)
	{
		...
		if (unk_0xC92F9F18E020B461())
		{
			...
			switch (iLocal_70)
			{
				...
				case 2:
					if (((unk_0xE5965CDF24F93A9F(iLocal_78) && unk_0xE63474311C6E3825(iLocal_78, 1)) && iLocal_98 < 5) && !bLocal_95)
					{
						func_12();
					}
					func_1();
...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		while (iLocal_97 < 11)
		{
			if (unk_0xE5965CDF24F93A9F(uLocal_88[iLocal_97]))
			{
				unk_0x5C65DDDC219B3AA5(uLocal_88[iLocal_97], 0);
			}
			iLocal_97++;
		}
		if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
		{
			unk_0x2EE80CD0EAEB9B5B(iLocal_80, 0f);
		...
		{
			unk_0x588DDCB644C6486A(uLocal_275, 0);
			unk_0x850D4EF3D40FB068(0, 0, 3000, 1, 0, 0);
	...
	if (unk_0xE5965CDF24F93A9F(uLocal_88[0]) || unk_0xE5965CDF24F93A9F(uLocal_88[1]))
	{
		if (!unk_0x0318E2EE6FB4563F(Local_75 + Vector(20f, 0f, 0f), 30f) && !unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_75, 80f, 80f, 80f, 0, 1, 0))
		{
			func_180();
		}
	}
...
void func_12()
{
	if (iLocal_102 == -1)
	{
		iLocal_102 = unk_0x320D1840B6DAA1CC() + 5000;
	}
	if (unk_0x320D1840B6DAA1CC() > iLocal_102)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_80))
		{
			unk_0x5C65DDDC219B3AA5(iLocal_80, 0);
			unk_0x3F6DE6DBA9A99FEA(iLocal_80, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
			if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
			{
				unk_0x207617CE1796D28E(iLocal_80, 1, 0);
			}
		}
	}
}
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (unk_0xD0773D0C37D0A612(&Var1, Local_68[0 /*5*/]))
		{
			fVar2 = 0f;
			fVar5 = 999999f;
			iVar0 = 0;
			while (iVar0 < Local_68)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + unk_0x987A5F1E1A67E3C0(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], 1));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (unk_0xD0773D0C37D0A612(&Var1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = unk_0x987A5F1E1A67E3C0(Local_68[iVar0 /*5*/], Var1, 1);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	if (iLocal_61 == 1)
	{
		...
		fVar7 = (to_float((unk_0x320D1840B6DAA1CC() - iLocal_63)) / fLocal_69);
		...
		{
			if ((unk_0x320D1840B6DAA1CC() - Local_60[iVar0 /*5*/].f_4) > 1000)
			{
				unk_0x152BC923D5118C6F(Local_60[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((unk_0x320D1840B6DAA1CC() - Local_60[iVar0 /*5*/].f_4) > 6000)
			{
				unk_0xD97DCB0ED4FF04F8(Local_60[iVar0 /*5*/]);
			}
			iVar0++;
		}
	}
...
void func_16(struct<3> Param0, int iParam1)
{
	...
	unk_0xD97DCB0ED4FF04F8(Local_60[iLocal_65 /*5*/]);
	if (Local_60[iLocal_65 /*5*/].f_4 != 0)
	{
		unk_0x152BC923D5118C6F(Local_60[iLocal_65 /*5*/].f_1, 0.4f, 1f);
	}
	Local_60[iLocal_65 /*5*/].f_4 = unk_0x320D1840B6DAA1CC();
	Local_60[iLocal_65 /*5*/].f_1 = { Param0 };
	Local_60[iLocal_65 /*5*/] = unk_0x8669FFC323BE936C(Param0, uLocal_53, iParam1);
	iLocal_65++;
	if (iLocal_65 >= 31)
	{
		iLocal_65 = 0;
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (unk_0x4C1B8C5717647539(0, 24) && unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()))
			{
				if (iLocal_54 == 0)
				{
					...
					iLocal_54 = unk_0x320D1840B6DAA1CC() + 250;
				}
				if (unk_0x320D1840B6DAA1CC() > iLocal_54)
				{
					if (!bLocal_44)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_68)
						{
							if (unk_0x12DD4A0B247D9B4D(Local_68[iVar0 /*5*/].f_3))
							{
								fVar2 = unk_0x987A5F1E1A67E3C0(Local_57, unk_0x1A3931A61B3223A2(Local_68[iVar0 /*5*/].f_3), 1);
								fVar3 = unk_0x987A5F1E1A67E3C0(Local_68[iVar0 /*5*/], unk_0x1A3931A61B3223A2(Local_68[iVar0 /*5*/].f_3), 1);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_50 != -1)
							{
								if (unk_0x07141611FD632B59((iLocal_51 - iVar5)) > 1)
								{
									iLocal_51 = -1;
								}
								if (iLocal_51 == -1)
								...
								if (unk_0x07141611FD632B59((iLocal_51 - iVar5)) < 3 && unk_0x07141611FD632B59((iLocal_51 - iVar5)) > 0)
								{
									if (iLocal_51 < iVar5)
									{
										iVar6 = iLocal_51;
										while (iVar6 <= (iVar5 - 1))
										{
											if (unk_0x12DD4A0B247D9B4D(Local_68[iVar6 /*5*/].f_3))
											{
												if (unk_0x6BABDF7A460158CE(Local_68[iVar6 /*5*/].f_3) > 0)
												{
													unk_0xFBBD8F124403B0F5(Local_68[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (unk_0x12DD4A0B247D9B4D(Local_68[iVar5 /*5*/].f_3))
									{
										if (unk_0x6BABDF7A460158CE(Local_68[iVar5 /*5*/].f_3) > 0)
										{
											unk_0xFBBD8F124403B0F5(Local_68[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	switch (iLocal_71)
	{
		case 0:
			...
			if (Local_283.f_32 <= 0)
			{
				Local_283.f_32 = unk_0x8142A6539DDC180F();
			}
			...
			func_108(&Local_283);
			if ((unk_0x70F555A7CCF10659("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0x6F940C2636C076AD("re@construction")) && func_104(&Local_283))
			{
				if (unk_0x55A0C756C4A8220C(iLocal_80, 0))
				{
					iLocal_78 = unk_0x487C17B41938052C(iLocal_80, 26, joaat("s_m_m_dockwork_01"), -1, 1, 1);
					unk_0xE3752B10DC995E95(iLocal_78, 0, 1, 0, 0);
					unk_0xE3752B10DC995E95(iLocal_78, 3, 1, 1, 0);
					unk_0xE3752B10DC995E95(iLocal_78, 4, 0, 1, 0);
					unk_0xE3752B10DC995E95(iLocal_78, 8, 0, 0, 0);
					unk_0x49D97B076E3590AC(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
					iLocal_90 = unk_0x0E536D72AB30F4C8(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, 1, 1, 0);
					unk_0xF1A23B343DFEDFD0(joaat("p_amb_phone_01"));
					unk_0x9A97DC6DBC7B223D(iLocal_90, iLocal_78, unk_0xB897FCFCFA664B38(iLocal_78, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0xBC12D08EE7559CCD(iLocal_78, 17, 1);
					unk_0x4D671450EBB62809(iLocal_78, 1);
					unk_0x50274A7EACA3133A(iLocal_78, 1);
					unk_0xA7266A50941DBAEA(iLocal_78, 0);
					func_103(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					unk_0xEEBC95A38CBDED42(iLocal_78, "S_M_Y_GENERICWORKER_01_WHITE_01");
					uLocal_79 = unk_0xA8D58C3AADA2C41C(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, 1, 1);
					unk_0x50274A7EACA3133A(uLocal_79, 1);
					unk_0x006574E87E6F1942(iLocal_79, 1, 1);
					unk_0x5C65DDDC219B3AA5(iLocal_79, 1);
					unk_0x0EC3A788F361170A(iLocal_78, -1143637011);
					...
					iLocal_89 = unk_0x0E536D72AB30F4C8(joaat("prop_generator_01a"), Local_274.x, (Local_274.f_1 + 0.5f), (Local_274.f_2 - 0.25f), 1, 1, 0);
					unk_0xBBF86885619695CE(iLocal_89, 75f);
					unk_0xBED097BB6359F09C(iLocal_89, 0, 1, 1, 0, 0, 0, 0, 0);
					uLocal_279 = unk_0x2D649DA6DC187D35("scr_sparking_generator", iLocal_89, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					unk_0x5C65DDDC219B3AA5(iLocal_89, 1);
			...
			if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				if (!iLocal_92)
				{
					if (!unk_0xF68107C40359970C(iLocal_78))
					{
						...
						if (unk_0x0747E45CFF1F74AA(iLocal_78, unk_0xE2D3D51028F0428A(), 1) || unk_0x0747E45CFF1F74AA(iLocal_80, unk_0xE2D3D51028F0428A(), 1))
						{
							unk_0x5C65DDDC219B3AA5(iLocal_80, 0);
							unk_0x03A927199A2DFE46(iLocal_78);
							...
							unk_0x8ACADA903FCAA42F(iLocal_78, uLocal_107);
						...
						if ((((unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, 0, 1, 0) && !unk_0x0F92AFFDE5783870(unk_0xE2D3D51028F0428A())) && !unk_0xB73D201873640749(unk_0xE2D3D51028F0428A())) && func_94(1, 0, 1)) && unk_0x0152AA00FA3130F1(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_134())
							{
								...
								{
									iLocal_83 = unk_0x9993EF7FDBCDB632();
								}
								func_84(1);
							}
							iLocal_91 = 1;
				...
				else
				{
					if (!unk_0xF68107C40359970C(iLocal_78))
					{
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_78, 0))
						{
							if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0) && !unk_0x12DD4A0B247D9B4D(uLocal_85))
							{
								uLocal_85 = func_96(iLocal_80, 0, 0);
							}
						}
						else if (!unk_0x12DD4A0B247D9B4D(uLocal_84))
						{
							if (unk_0x12DD4A0B247D9B4D(uLocal_85))
							{
								unk_0xFFD8EB5462B07B59(&uLocal_85);
					...
					if (!unk_0xF68107C40359970C(iLocal_78))
					{
						if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_78, Local_76, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_48();
					...
					else
					{
						...
						if (unk_0xF68107C40359970C(iLocal_78) || unk_0x55B23FE400FCEA6B(iLocal_80, 0))
						{
							func_95();
						}
					}
					if (!unk_0x55A0C756C4A8220C(iLocal_81, 0))
					{
						if (unk_0x12DD4A0B247D9B4D(uLocal_86))
						{
							unk_0xFFD8EB5462B07B59(&uLocal_86);
					...
					if (iLocal_103 >= 3)
					{
						if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && unk_0xF30A227F7990AE00(unk_0xE2D3D51028F0428A(), joaat("bulldozer")))
						{
							if (unk_0x12DD4A0B247D9B4D(uLocal_86))
							{
								...
								if (!unk_0xF68107C40359970C(iLocal_78) && !unk_0x55B23FE400FCEA6B(iLocal_80, 0))
								{
									if (unk_0xD5C6B5E3B93A5EDC(iLocal_78, 0) && !unk_0x12DD4A0B247D9B4D(uLocal_85))
									{
										uLocal_85 = func_96(iLocal_80, 0, 0);
									}
								}
						...
						else if (!unk_0xF68107C40359970C(iLocal_78) && !unk_0x55B23FE400FCEA6B(iLocal_80, 0))
						{
							if (unk_0xD5C6B5E3B93A5EDC(iLocal_78, 0) && unk_0x12DD4A0B247D9B4D(uLocal_85))
							{
								unk_0xFFD8EB5462B07B59(&uLocal_85);
				...
				if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
				{
					if (unk_0xEF9410C312F2B117(iLocal_80))
					{
						iLocal_97 = 0;
						while (iLocal_97 < 11)
						{
						...
						if (!unk_0xF68107C40359970C(iLocal_78))
						{
							...
							{
								unk_0x50274A7EACA3133A(iLocal_78, 1);
								unk_0xD6A76BAB45A4B460(iLocal_78, 116, 0);
								unk_0xD6A76BAB45A4B460(iLocal_78, 29, 0);
								if (!bLocal_95)
								{
									func_46();
									wait(0);
								...
								if (!unk_0xF68107C40359970C(iLocal_78))
								{
									unk_0xF160248D9083ED0C(iLocal_78, 99, 0);
								}
								if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
								{
									unk_0x5C65DDDC219B3AA5(iLocal_80, 0);
...
void func_48()
{
	switch (iLocal_103)
	{
		case 0:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 3000)
				{
		...
		case 2:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 5000 && !func_23())
				{
					if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
					{
						iLocal_106 = unk_0x15CAA6D7B11F1A7C(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0));
					}
					if (unk_0xD5C6B5E3B93A5EDC(iLocal_78, 0))
					{
						if (unk_0x55A0C756C4A8220C(iLocal_81, 0))
						{
							...
							else if (!unk_0x12DD4A0B247D9B4D(uLocal_86))
							{
								uLocal_86 = func_96(iLocal_81, 0, 0);
								if (unk_0x12DD4A0B247D9B4D(uLocal_85))
								{
		...
		case 3:
			if (unk_0x320D1840B6DAA1CC() - iLocal_101) > unk_0x5853B15F78E1A265(5000, 8000)
			{
				if (!func_23())
				{
...
void func_49()
{
	...
	{
		case 0:
			unk_0x44949EC4364CC53B(Local_274 + Vector(0f, 1f, 0f), 1f, 1f, 1f);
			wait(0);
			unk_0x9F0371728DF05832(1f);
			unk_0xA22D087A4F4D9310(Local_273, 1f);
			wait(0);
			unk_0xA22D087A4F4D9310(Local_273 - Vector(0f, 4f, 0f), 1f);
			wait(0);
			unk_0xA22D087A4F4D9310(Local_273 - Vector(0f, 8f, 0f), 1f);
			wait(0);
			unk_0xA22D087A4F4D9310(Local_274, 1f);
		...
		case 2:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_105) > iLocal_73 || func_51())
			{
				...
				if (!bLocal_95)
				{
					if (!unk_0xF68107C40359970C(iLocal_78) && !unk_0x55B23FE400FCEA6B(iLocal_80, 0))
					{
						if (!unk_0x33168C7A83D47CC0(iLocal_78, iLocal_80, -1, 0, 0) && !unk_0x33168C7A83D47CC0(iLocal_78, iLocal_80, 0, 0, 0))
						{
							func_46();
							wait(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
				...
				unk_0x302D843E3C8F40E2(3, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_278, 0, 0);
				settimera(0);
				iLocal_99 = 3;
			}
			break;
...
void func_52()
{
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!unk_0xF68107C40359970C(iLocal_78) && !unk_0x55B23FE400FCEA6B(iLocal_80, 0))
				{
					...
					unk_0x4BDA5AFD88C085EB(&iLocal_90);
					if (unk_0x33168C7A83D47CC0(iLocal_78, iLocal_80, -1, 0, 0) || unk_0x33168C7A83D47CC0(iLocal_78, iLocal_80, 0, 0, 0))
					{
						if (unk_0x33168C7A83D47CC0(iLocal_78, iLocal_80, -1, 0, 0))
						{
							bLocal_94 = true;
							Local_77 = { unk_0x6B62510F212526DC(iLocal_80, 0) + Vector(0f, -1f, -3f) };
						}
						else
						{
							Local_77 = { unk_0x6B62510F212526DC(iLocal_80, 0) + Vector(0f, 1.5f, -3f) };
						}
						if (unk_0x8F41785F110B0DA0(unk_0x9993EF7FDBCDB632(), Local_77, 4.2f, 4f, 5f, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_46();
		...
		case 1:
			if (!unk_0xF68107C40359970C(iLocal_78) && !unk_0x55B23FE400FCEA6B(iLocal_80, 0))
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_81, 0))
				{
					unk_0xBED097BB6359F09C(iLocal_81, 0, 1, 1, 0, 0, 0, 0, 0);
				}
				unk_0xBED097BB6359F09C(iLocal_78, 0, 1, 0, 0, 0, 0, 0, 0);
				unk_0x5C65DDDC219B3AA5(iLocal_80, 0);
				unk_0xA888F8CC04F25CC8(&uLocal_107);
				if (bLocal_94)
				{
				...
				unk_0x8ACADA903FCAA42F(iLocal_78, uLocal_107);
				unk_0x7461D7C5BA953BC7(&uLocal_107);
				unk_0xABC2CA6F28903308(iLocal_78, 1);
				iLocal_101 = unk_0x320D1840B6DAA1CC();
				iLocal_98++;
			}
			break;
		...
		case 2:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 500 && !unk_0xD5C6B5E3B93A5EDC(iLocal_78, 0))
				{
					iLocal_73 = 0;
					if (unk_0x55A0C756C4A8220C(iLocal_80, 0))
					{
		...
		case 3:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if (unk_0x8F41785F110B0DA0(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, 0, 1, 0) || (unk_0x320D1840B6DAA1CC() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if (unk_0x8F41785F110B0DA0(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, 0, 1, 0) || (unk_0x320D1840B6DAA1CC() - iLocal_101) > 10000)
				{
					if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
					{
						unk_0x5C65DDDC219B3AA5(iLocal_80, 0);
		...
		case 5:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 3000)
			{
				...
				if (!unk_0xF68107C40359970C(iLocal_78))
				{
					...
					if (!unk_0x55B23FE400FCEA6B(iLocal_81, 0))
					{
						unk_0xBED097BB6359F09C(iLocal_81, 0, 0, 0, 0, 0, 0, 0, 0);
					}
					unk_0xBED097BB6359F09C(iLocal_78, 0, 0, 0, 0, 0, 0, 0, 0);
					unk_0xC252F409BDE7A700(iLocal_78, 1);
					unk_0xA7266A50941DBAEA(iLocal_78, 1);
					unk_0x4D671450EBB62809(iLocal_78, 0);
					unk_0x50274A7EACA3133A(iLocal_78, 0);
					unk_0x0EC3A788F361170A(iLocal_78, joaat("DEFAULT"));
					unk_0x03A927199A2DFE46(unk_0xE2D3D51028F0428A());
					unk_0xA888F8CC04F25CC8(&uLocal_107);
					unk_0x49D97B076E3590AC(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0f, 0, 0, 0);
					unk_0x3F2B528DF27C8A9F(uLocal_107, 1);
					unk_0xC963A45B50851768(uLocal_107);
					unk_0x8ACADA903FCAA42F(iLocal_78, uLocal_107);
					unk_0x7461D7C5BA953BC7(&uLocal_107);
				}
		...
		case 6:
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				if ((unk_0x320D1840B6DAA1CC() - iLocal_101) > 6400)
				{
					...
					{
						if (unk_0x8F41785F110B0DA0(iLocal_83, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					{
						if (unk_0x8F41785F110B0DA0(iLocal_81, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
...
void func_60()
{
	...
	{
		func_62(13, floor(Global_112915.f_10194.f_3853));
	}
...
void func_97()
{
	if (func_100(1000))
	{
		...
		if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
		{
			unk_0xBDB27A4F81702F96(iLocal_80, 0f, 1f, 1f, 200f, 800f, 1);
		}
		bLocal_282 = true;
		iLocal_72 = 8;
	}
	switch (iLocal_72)
	{
		case 0:
			...
			unk_0xF96094A43D443C41(Local_75, 50f, 0);
			unk_0x02B222EADC9DC566(Local_75, 30f, 0, 0, 0, 0, 0, 0, 0);
			unk_0x917F631782A9CB32(Local_75, 100f, 0);
			if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
			{
				if (unk_0x8F41785F110B0DA0(unk_0x9993EF7FDBCDB632(), Local_75, 8f, 8f, 8f, 0, 1, 0))
				{
					uLocal_82 = unk_0x9993EF7FDBCDB632();
					unk_0x2D58A6131679D82C(uLocal_82, 1, 0);
					unk_0xD59CC8123FD1A789(&iLocal_82);
				}
			}
			...
			uLocal_276 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, 1, 2);
			uLocal_277 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, 1, 2);
			unk_0x9BAE3263D9B1FCB9(uLocal_276, "HAND_SHAKE", 0.3f);
			unk_0x9BAE3263D9B1FCB9(uLocal_277, "HAND_SHAKE", 0.3f);
			func_99();
			unk_0xDD786B89B15AA63F(uLocal_276, 1);
			unk_0x850D4EF3D40FB068(1, 0, 3000, 1, 0, 0);
			wait(500);
			unk_0x889B4F9D52E23DEE(uLocal_277, uLocal_276, 3500, 1, 1);
		...
		case 1:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 3500)
			{
				unk_0x91DFC8F68F6D9B05(-1, "WEAKEN", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				unk_0x91DFC8F68F6D9B05(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				unk_0xE987EFB3B3FAB187(uLocal_88[0], 1);
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, 1, 2);
				uLocal_277 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, 1, 2);
				unk_0x9BAE3263D9B1FCB9(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x9BAE3263D9B1FCB9(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0x889B4F9D52E23DEE(uLocal_277, uLocal_276, 4000, 1, 0);
				if (!unk_0xF68107C40359970C(iLocal_78))
				{
					unk_0x03A927199A2DFE46(iLocal_78);
					unk_0xE1E1AF00CA06A2B7(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
				if (unk_0xE5965CDF24F93A9F(iLocal_90))
				{
					unk_0xE6451C2F193342C7(iLocal_90, 1, 1);
					unk_0x4BDA5AFD88C085EB(&iLocal_90);
				}
				iLocal_104 = unk_0x320D1840B6DAA1CC();
				iLocal_72 = 2;
		...
		case 2:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 1500)
			{
		...
		case 3:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 500)
			{
				if (unk_0xE5965CDF24F93A9F(uLocal_88[0]))
				{
					unk_0x5C65DDDC219B3AA5(uLocal_88[0], 0);
					unk_0x3F6DE6DBA9A99FEA(uLocal_88[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, 1, 1, 1, 0, 1);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 11, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 18, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 19, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 23, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 9, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 12, 0);
					unk_0xB35D04A52BD51F16(uLocal_88[0], 17, 0);
					unk_0x74A35BFF0670ECD4("scr_reconstruct_pipefall_debris", uLocal_88[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
				}
				iLocal_104 = unk_0x320D1840B6DAA1CC();
				iLocal_72 = 4;
			}
		...
		case 4:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 2000)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, 1, 2);
				uLocal_277 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, 1, 2);
				unk_0x9BAE3263D9B1FCB9(uLocal_276, "HAND_SHAKE", 0.3f);
				unk_0x9BAE3263D9B1FCB9(uLocal_277, "HAND_SHAKE", 0.3f);
				unk_0x889B4F9D52E23DEE(uLocal_277, uLocal_276, 1000, 3, 3);
				unk_0xF889BDFCC181BA9F(iLocal_100);
				iLocal_104 = unk_0x320D1840B6DAA1CC();
				iLocal_72 = 5;
			}
			break;
		...
		case 5:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 500)
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_80, 0))
				{
					...
					if (!unk_0xF68107C40359970C(iLocal_78))
					{
						unk_0xC89EA639A6F338A6(iLocal_78);
					}
					unk_0x49D97B076E3590AC(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0f, 0, 0, 0);
					unk_0x74A35BFF0670ECD4("scr_reconstruct_pipe_impact", iLocal_80, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					func_24(&uLocal_108, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
					if (unk_0x876B1078E90C91CB(uLocal_276) && unk_0x876B1078E90C91CB(uLocal_277))
					{
						unk_0x9BAE3263D9B1FCB9(uLocal_276, "HAND_SHAKE", 1.5f);
						unk_0x9BAE3263D9B1FCB9(uLocal_277, "HAND_SHAKE", 1.5f);
					}
					iLocal_104 = unk_0x320D1840B6DAA1CC();
					iLocal_72 = 6;
				}
		...
		case 6:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 500)
			{
				func_98(uLocal_276);
				func_98(uLocal_277);
				uLocal_276 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, 1, 2);
				uLocal_277 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, 1, 2);
				unk_0x9BAE3263D9B1FCB9(uLocal_276, "HAND_SHAKE", 0.5f);
				unk_0x9BAE3263D9B1FCB9(uLocal_277, "HAND_SHAKE", 0.5f);
				unk_0x889B4F9D52E23DEE(uLocal_277, uLocal_276, 2500, 3, 3);
				if (!unk_0xF68107C40359970C(iLocal_78))
				{
					unk_0xE1E1AF00CA06A2B7(iLocal_78, unk_0x6B62510F212526DC(iLocal_78, 1) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = unk_0x320D1840B6DAA1CC();
				iLocal_72 = 7;
			}
		...
		case 7:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 2200 && !iLocal_96)
			{
			...
			if ((unk_0x320D1840B6DAA1CC() - iLocal_104) > 2500)
			{
				if (unk_0x55A0C756C4A8220C(iLocal_80, 0))
				{
		...
		case 8:
			...
			if (unk_0xE5965CDF24F93A9F(uLocal_88[0]))
			{
				unk_0x4BDA5AFD88C085EB(&(uLocal_88[0]));
			}
			if (unk_0x55A0C756C4A8220C(iLocal_80, 0))
			{
				unk_0x2EE80CD0EAEB9B5B(iLocal_80, 250f);
				unk_0xC64B6E13A6A7F517(iLocal_80, Local_75, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(iLocal_80, 80f);
				unk_0xDC226C748C3C868D(Local_75, 50f, 0);
			}
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				unk_0x03A927199A2DFE46(iLocal_78);
				unk_0xC89EA639A6F338A6(iLocal_78);
				unk_0x49D97B076E3590AC(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0f, 0, 0, 0);
			}
			unk_0xDD786B89B15AA63F(uLocal_276, 0);
			unk_0x850D4EF3D40FB068(0, 0, 3000, 1, 0, 0);
			unk_0x588DDCB644C6486A(uLocal_276, 0);
			unk_0x588DDCB644C6486A(uLocal_277, 0);
			unk_0x64E21045781AFBC9(unk_0x9E2D6C50374FCFA9(), 1, 0);
			unk_0x94953C3FF0664F66(0f);
			unk_0xB60709BD0E075903(1);
			unk_0x72DB022C36FCEA24(1);
			...
			uLocal_88[1] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[1], -0.1939f, 105.0058f, 77.3964f, 2, 1);
			uLocal_88[2] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[2], 24.3941f, 32.5423f, 80.6862f, 2, 1);
			uLocal_88[3] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[3], 24.1841f, 110.287f, 78.4357f, 2, 1);
			uLocal_88[4] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[4], -0.0264f, 29.5754f, 79.1811f, 2, 1);
			uLocal_88[5] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[5], -0.6337f, 108.4339f, 77.9539f, 2, 1);
			uLocal_88[6] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[6], 0.0929f, 74.2657f, 79.3839f, 2, 1);
			uLocal_88[7] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[7], -0.0264f, 29.5754f, 80.9061f, 2, 1);
			uLocal_88[8] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[8], -0.1087f, 109.7339f, 80.9789f, 2, 1);
			uLocal_88[9] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[9], -0.3321f, 74.1907f, 81.6089f, 2, 1);
			uLocal_88[10] = unk_0x0A7322C6D0E1A985(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, 1, 1, 0);
			unk_0x8CE3D365F064F69E(uLocal_88[10], 5.7811f, 104.6058f, 104.6964f, 2, 1);
			iLocal_97 = 0;
			while (iLocal_97 < 11)
			{
				if (unk_0xE5965CDF24F93A9F(uLocal_88[iLocal_97]))
				{
					unk_0x4536AE3DABDE0C44(uLocal_88[iLocal_97], 1);
					unk_0x5C65DDDC219B3AA5(uLocal_88[iLocal_97], 1);
				}
				iLocal_97++;
			}
			if (bLocal_282)
...
void func_115()
{
	...
	if (func_104(&Local_283))
	{
		...
		unk_0x2915D98110F23A29(Local_74 + Vector(50f, 50f, 50f), Local_74 - Vector(50f, 50f, 50f), 0, 1, 1, 1);
		Local_75 = { -455.6561f, -985.8071f, 22.4868f };
		iLocal_80 = unk_0xBA715A7BEBA5A1F9(joaat("utillitruck2"), Local_75, 80f, 1, 1, 0);
		unk_0x371D594409A68A18(iLocal_80, 0, 1, 0);
		unk_0x3B2646B62E7BBE11(iLocal_80, 3);
		unk_0x45A6EA15139A0C54(iLocal_80, 1, 1);
		unk_0x45A6EA15139A0C54(iLocal_80, 2, 1);
		unk_0x45A6EA15139A0C54(iLocal_80, 3, 0);
		unk_0x45A6EA15139A0C54(iLocal_80, 4, 1);
		unk_0x45A6EA15139A0C54(iLocal_80, 5, 1);
		unk_0x45A6EA15139A0C54(iLocal_80, 6, 0);
		unk_0x45A6EA15139A0C54(iLocal_80, 7, 1);
		unk_0x5C65DDDC219B3AA5(iLocal_80, 1);
		unk_0xBED097BB6359F09C(iLocal_80, 0, 0, 0, 1, 0, 0, 0, 0);
		unk_0x7A93DEA53EFC3CF2(iLocal_80, 10000);
		unk_0x09042D5723106B97(iLocal_80, 5f);
		iLocal_81 = unk_0xBA715A7BEBA5A1F9(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, 1, 1, 0);
		unk_0x7A997A0A971D305F(Local_75, 10f, 1, 0, 0, 0);
		uLocal_88[0] = unk_0x0A7322C6D0E1A985(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, 1, 1, 0);
		unk_0xBBF86885619695CE(uLocal_88[0], 90f);
		unk_0x5C65DDDC219B3AA5(uLocal_88[0], 1);
		unk_0xBED097BB6359F09C(uLocal_88[0], 1, 1, 1, 1, 0, 0, 0, 0);
		unk_0x7A93DEA53EFC3CF2(uLocal_88[0], 10000000);
...
int func_121()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_132())
		{
			return 0;
		}
	}
...
int func_138(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_174(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_152(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_180()
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!unk_0xF68107C40359970C(iLocal_78))
			{
				unk_0xD6A76BAB45A4B460(iLocal_78, 317, 1);
			}
			if (!unk_0x55B23FE400FCEA6B(iLocal_83, 0))
			{
				if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_83, 0) && !unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_83, 50f, 50f, 50f, 0, 1, 0))
				{
