	...
	while (iLocal_257 && func_137(2, 0))
	{
		...
		switch (iLocal_66)
		{
			...
			case 2:
				if (func_133())
				{
					func_132(&uLocal_68, 0, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
					func_132(&uLocal_68, 2, Global_99695, "LAMAR", 0, 1);
					iLocal_66 = 3;
				}
				break;
...
int func_2()
{
	...
	func_125(&Global_99695, iLocal_258);
	func_3(Global_99695);
	return 0;
}
...
void func_3(var uParam0)
{
	...
	{
		if (!iLocal_337 && unk_0x0747E45CFF1F74AA(uParam0, unk_0xE2D3D51028F0428A(), 1))
		{
	...
	fVar4 = vdist2(unk_0x6B62510F212526DC(uParam0, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1));
	if (fVar4 > (8f * 8f))
	{
		iLocal_335 = -1;
	}
	...
	else
	{
		if (iLocal_335 <= 0)
		{
			iLocal_335 = unk_0x320D1840B6DAA1CC();
		}
		if (iLocal_335 > 0)
		{
			if (iLocal_336 == 0)
			{
				if (iLocal_335 + 15000 < unk_0x320D1840B6DAA1CC())
				{
			...
			else if (iLocal_335 + 10000 < unk_0x320D1840B6DAA1CC())
			{
...
int func_6(var uParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6)
{
	...
	if (!bVar5)
	{
		iVar6 = unk_0x782B98242B6BBB25(uParam0);
...
int func_84(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20145)
	{
		if (Global_19954.f_1 == 6)
		{
			...
			func_87(1);
			func_90(Global_19935, "DISPLAY_VIEW", 1f, to_float(Global_19934), -1082130432, -1082130432, -1082130432);
		}
	}
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (Global_2725219)
							{
								if (iVar1 == 14)
								{
									func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(Global_22348), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8393[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(Global_22353), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_77852)
								{
									...
									func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19954)
									...
									func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7831[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_88(Global_19935, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7831[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8393[iVar0] = 1;
						}
					}
...
int func_125(var uParam0, int iParam1)
{
	...
	if (unk_0xE5965CDF24F93A9F(*uParam0))
	{
		...
		{
			case 0:
				if (unk_0xFCF559C8631ABED7(*uParam0, &cLocal_317, &(Local_327[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_334;
					fVar2 = -1f;
					fVar3 = -1f;
					if (unk_0x0AF1DAD2F59B2C3C(&cLocal_317, &(Local_327[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (unk_0x54DE1614490C2A83(Global_97304) > fVar1)
					{
						...
						if (unk_0xF68107C40359970C(*uParam0))
						{
							...
							unk_0x13C3030981EA7C3B(*uParam0, Local_263 + Local_266[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
			...
			case 1:
				...
				{
					unk_0x7D1424753688EE7A(*uParam0, Local_263 + Local_266[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_260[iParam1] = 2;
					return 1;
				}
				fVar5 = vmag(Local_266[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (vdist2(unk_0x6B62510F212526DC(*uParam0, 1), Local_263) >= fVar5)
				{
			...
			case 2:
				...
				if (unk_0x174CED88B97C78D9(*uParam0, 713668775) != 1)
				{
					...
					unk_0x5315F7AC22DC95F1(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (unk_0xAEC3FB024079CF27(sLocal_333))
				{
					unk_0x247F21B1803F0EC4(sLocal_333, 0);
				}
				if (vdist2(unk_0x6B62510F212526DC(*uParam0, 1), Local_263 + Local_266[iParam1 /*3*/]) < (fLocal_268[iParam1] * fLocal_268[iParam1]))
				{
					if (unk_0x5B138084858689AC(Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1))
					{
						unk_0x1D698ECDFF42AC58(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					else if (unk_0x1555F0FA7BA4FE0F(Var6, 0, &Var7, 14))
					{
						if (vdist2(unk_0x6B62510F212526DC(*uParam0, 1), Var7) > 100f)
						{
							unk_0x7D1424753688EE7A(*uParam0, Var7, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_260[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				unk_0x9972EFADA7A2A47D(5, iLocal_261, 1862763509);
				unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_261);
				unk_0x9972EFADA7A2A47D(5, iLocal_261, Global_94978);
				unk_0x9972EFADA7A2A47D(5, Global_94978, iLocal_261);
...
Vector3 func_126(struct<3> Param0, float fParam1, float fParam2)
{
	...
	while (iVar3 < 10)
	{
		Var0 = { unk_0xC4EAB25A108C2429(-fParam1, fParam1), unk_0xC4EAB25A108C2429(-fParam1, fParam1), 0f };
		if (((Var0.x * Var0.x) + (Var0.f_1 * Var0.f_1)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			Var0.f_2 = unk_0xC4EAB25A108C2429(-fVar2, fVar2);
			return Param0 + Var0;
		}
		iVar3++;
	}
...
Vector3 func_127(struct<3> Param0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_128(Var0, unk_0xC4EAB25A108C2429(0f, fParam1)) };
...
int func_135()
{
	...
	if (!func_134())
	{
		if (unk_0xCE2C78E9FC0B01E3(Global_97304))
		{
			...
			while (iVar0 < iLocal_258)
			{
				if (!unk_0xF68107C40359970C(iLocal_258[iVar0]))
				{
					unk_0x950B26F4C891073F(iLocal_258[iVar0], Global_97304, &cLocal_317, &(Local_327[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_260[iVar0] = 0;
				}
				else
				{
...
int func_136()
{
	...
	if (unk_0xCE2C78E9FC0B01E3(Global_97303))
	{
		...
		while (iVar0 < iLocal_258)
		{
			if (!unk_0xF68107C40359970C(iLocal_258[iVar0]))
			{
				unk_0x950B26F4C891073F(iLocal_258[iVar0], Global_97303, &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			func_132(&uLocal_68, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
		}
		if (!unk_0xF68107C40359970C(Global_99695))
		{
			func_132(&uLocal_68, 4, Global_99695, "LAMAR", 0, 1);
		}
		if (!unk_0xF68107C40359970C(iLocal_258[0]))
		{
			func_132(&uLocal_68, 5, iLocal_258[0], "GangMember1", 0, 1);
		}
		if (!unk_0xF68107C40359970C(iLocal_258[1]))
		{
...
void func_145()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_258)
		{
			...
			{
				unk_0xD69A0C3662175E68(iLocal_259[iVar0]);
				if (!unk_0x0152AA00FA3130F1(iLocal_259[iVar0]))
				{
					bVar2 = false;
					unk_0xD69A0C3662175E68(iLocal_259[iVar0]);
				}
		...
		if (!unk_0xACC32B78196FBC2A(&cLocal_317))
		{
			unk_0x8FB472886552D737(&cLocal_317);
			if (!unk_0x6F940C2636C076AD(&cLocal_317))
			{
				bVar2 = false;
				unk_0x8FB472886552D737(&cLocal_317);
			}
	...
	unk_0xD642E010A287ADFD("TAUNTERS", &iLocal_261);
	iVar0 = 0;
	while (iVar0 < iLocal_258)
	{
		if (iLocal_259[iVar0] != 0)
		{
			iLocal_258[iVar0] = unk_0xA8D58C3AADA2C41C(iLocal_262, iLocal_259[iVar0], Local_263 + Local_265[iVar0 /*3*/], 0, 1, 1);
			unk_0xBBF86885619695CE(iLocal_258[iVar0], (fLocal_264 + fLocal_267[iVar0]));
			unk_0x6E9C0F9EAC1F29FD(iLocal_258[iVar0], 0);
			unk_0xFF4BEB6CFF55A013(iLocal_258[iVar0], iLocal_261);
			unk_0x49D97B076E3590AC(iLocal_258[iVar0], &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			unk_0xD6A76BAB45A4B460(iLocal_258[iVar0], 317, 1);
			if (iLocal_262 == 6)
			{
				unk_0x9521FB98DB6DDF50(iLocal_258[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_147()
{
	...
	iLocal_67 = Global_99377;
	func_151(iLocal_67, &Local_263, &fLocal_264, &cVar0);
	func_149(iLocal_67, &sLocal_269, &cLocal_285, &cLocal_301, &uVar1, &uVar2);
	switch (iLocal_67)
	{
		case 218:
			Local_265[0 /*3*/] = { unk_0xC4EAB25A108C2429(-10f, 10f), unk_0xC4EAB25A108C2429(-10f, 10f), 0f };
			Local_265[1 /*3*/] = { unk_0xC4EAB25A108C2429(-10f, 10f), unk_0xC4EAB25A108C2429(-10f, 10f), 0f };
			Local_266[0 /*3*/] = { -77.3f, -4.1f, 1f };
			Local_266[1 /*3*/] = { Local_266[0 /*3*/] };
			Local_266[iLocal_258 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_267[0] = unk_0xC4EAB25A108C2429(-180f, 180f);
			fLocal_267[1] = unk_0xC4EAB25A108C2429(-180f, 180f);
			fLocal_268[0] = 30f;
...
void func_158()
{
	...
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			unk_0xB3822DB3D538C8F3(&(iLocal_258[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			unk_0xF1A23B343DFEDFD0(iLocal_259[iVar0]);
		}
		iVar0++;
	}
	unk_0x8813F60F6F44C9E3(iLocal_261);
	if (!unk_0xAEC3FB024079CF27(sLocal_333))
	{
		unk_0x247F21B1803F0EC4(sLocal_333, 1);
	}
