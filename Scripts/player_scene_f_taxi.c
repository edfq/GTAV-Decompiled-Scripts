...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { unk_0x6B62510F212526DC(uLocal_68, 0) };
		fVar2 = vdist2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0xAD6CDBCDA713560A(uLocal_68, uLocal_70, uLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (unk_0x55A0C756C4A8220C(uLocal_70, 0))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0xCE2C78E9FC0B01E3(Global_97304))
		{
			...
			if (!func_5(Global_99695, uLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0xA9F390242F9EB2E1(Global_99695, uLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0x5C65DDDC219B3AA5(uLocal_68, 0);
				iLocal_172 = 1;
			}
			unk_0xCD41D6F721CB9C3A(uLocal_68, uLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_99695, uLocal_70, 2))
			...
			unk_0xA5D8BA53953077C8(uLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0xA888F8CC04F25CC8(&uVar2);
				unk_0xCD41D6F721CB9C3A(0, uLocal_70, 24, 50);
				unk_0x19C58BA8A663B64B(0, 2000);
				unk_0x3B8F94419979A0B1(0, uLocal_70, Local_170 + Local_173, uLocal_171, 0, uLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0xC963A45B50851768(uVar2);
				unk_0x8ACADA903FCAA42F(iLocal_68, uVar2);
...
void func_22()
{
	...
	unk_0x7CD708DEB04F8474(iLocal_69, 1);
	uLocal_70 = unk_0x8AA54390E994CE1B(Local_173 + Local_169, 15f, uLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0xE5965CDF24F93A9F(Global_99695) || !unk_0xE5965CDF24F93A9F(uLocal_70)) || (!unk_0x0152AA00FA3130F1(iLocal_69) && iVar0 < 400))
	{
		if (!unk_0xE5965CDF24F93A9F(iLocal_70))
		{
			iLocal_70 = unk_0x8AA54390E994CE1B(Local_173 + Local_169, 15f, uLocal_71, 2);
		}
		iVar0++;
		wait(0);
	}
	...
	{
		unk_0x371D594409A68A18(iLocal_70, 1, 1, 0);
		unk_0x3B2646B62E7BBE11(iLocal_70, 2);
		unk_0x9F65B3BAFA302A65(iLocal_70, 1084227584);
		iLocal_68 = unk_0x487C17B41938052C(iLocal_70, 4, iLocal_69, -1, 1, 1);
		unk_0x6E9C0F9EAC1F29FD(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_50()
{
	if (!unk_0x55B23FE400FCEA6B(iLocal_68, 0) && unk_0x930E64CB0285CAEC(iLocal_68, 1))
	{
		unk_0xB3822DB3D538C8F3(&iLocal_68);
	}
	if (!unk_0x55B23FE400FCEA6B(iLocal_70, 0) && unk_0x930E64CB0285CAEC(iLocal_70, 1))
	{
		unk_0x3D81769BEC61BFF8(&iLocal_70);
	}
	unk_0x7CD708DEB04F8474(iLocal_69, 0);
	unk_0xF1A23B343DFEDFD0(iLocal_69);
