...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (unk_0xE5965CDF24F93A9F(uLocal_91))
		{
			if (unk_0x55B23FE400FCEA6B(uLocal_91, 0) && !iLocal_95 == 7)
			{
		...
		switch (iLocal_95)
		{
			case 0:
				if ((unk_0xC92F9F18E020B461() && !func_34()) && !func_12())
				{
					if (func_11())
					{
						uLocal_91 = unk_0xA8D58C3AADA2C41C(26, iLocal_88, Local_89, uLocal_90, 1, 1);
						unk_0x50274A7EACA3133A(uLocal_91, 1);
						uLocal_92 = unk_0x0E536D72AB30F4C8(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, 1, 1, 0);
						unk_0xBBF86885619695CE(uLocal_92, (233.8288f + 180f));
						unk_0xD9D122A54FFE62B8(uLocal_91, 0, 0, 0, 0);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = unk_0x8F5F4164BF5FB513(Local_89 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_90, 2);
				unk_0x950B26F4C891073F(uLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0x0472288E3E06730D("MNT_DNC", uLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0x662A04C7BF4CEB42(iLocal_97, "MNT_DNC") == 1)
				{
					unk_0x0726C6430F767980(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				Var0 = { unk_0x6B62510F212526DC(uLocal_91, 1) };
				unk_0x9D4D63EB83A103AD(uLocal_91, 3f);
				if (func_10(unk_0xE2D3D51028F0428A(), uLocal_91) < 10f)
				{
					unk_0x6C600C7A5953076D(unk_0xE2D3D51028F0428A(), 1, uLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x6C600C7A5953076D(uLocal_91, 1, unk_0xE2D3D51028F0428A(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(uLocal_91, unk_0xE2D3D51028F0428A(), 1) < 25f)
				{
					if (!unk_0x12DD4A0B247D9B4D(uLocal_96))
					{
						func_5(&uLocal_96, &uLocal_91, 0);
						unk_0xA582EE8380437B1B(uLocal_96, 3);
					}
				}
				else if (unk_0x12DD4A0B247D9B4D(uLocal_96))
				{
					func_4(&uLocal_96);
				}
				if (unk_0x54DE1614490C2A83(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x32DCDA1B2F8A0694(uLocal_91))
				{
					unk_0xA6ADA1DC68C9EAED(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0xF68107C40359970C(uLocal_91) || unk_0x9AC74C7EF847A074(Var0, 50f, 1)) || unk_0x9AC74C7EF847A074(Var0, 50f, 0)) || unk_0x863026E0C5C2E52B(Var0, 20f, 20f, 20f, 0)) || unk_0x89D0E0233F6E59A7(-1, Var0, 50f)) || (((unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), uLocal_91) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), uLocal_91)) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Var0, 1) < 25f) && func_1(uLocal_91, unk_0xE2D3D51028F0428A(), 1126825984, 0)))
				{
					unk_0xA6ADA1DC68C9EAED(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x32DCDA1B2F8A0694(uLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x7D1424753688EE7A(uLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x7D1424753688EE7A(uLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0xABC2CA6F28903308(uLocal_91, 1);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0x174CED88B97C78D9(uLocal_91, 713668775) != 1 && unk_0x174CED88B97C78D9(uLocal_91, 713668775) != 0)
				{
					unk_0x50274A7EACA3133A(uLocal_91, 0);
					if (iLocal_93 == 1)
					{
						unk_0x7734082B0EDB0BE0(uLocal_91, unk_0xE2D3D51028F0428A(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0xD86A0BC9CC0A625A(uLocal_91, 1193033728, 0);
					}
					unk_0xABC2CA6F28903308(uLocal_91, 1);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0x4D21C9FB671ED18F(uLocal_91) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(uLocal_91, 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 1) > 50f) && !unk_0xC92F9F18E020B461())
				{
					func_37(1);
				}
				break;
...
int func_1(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_3(unk_0x6EA486FF6D815B4B(uParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_11()
{
	...
	unk_0x8FB472886552D737(sLocal_94);
	if (unk_0x0152AA00FA3130F1(iLocal_88) && unk_0x6F940C2636C076AD(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_27())
		{
			return 0;
		}
	}
...
{
	if (unk_0xE5965CDF24F93A9F(uLocal_92))
	{
		unk_0x4BDA5AFD88C085EB(&uLocal_92);
	}
	if (unk_0x12DD4A0B247D9B4D(uLocal_96))
	{
		func_4(&uLocal_96);
	...
	if (unk_0xE5965CDF24F93A9F(uLocal_91))
	{
		if (bParam0)
		{
			unk_0x05CB75C0837196F9(&uLocal_91);
		}
		else
		{
			unk_0xB3822DB3D538C8F3(&uLocal_91);
		}
	}
