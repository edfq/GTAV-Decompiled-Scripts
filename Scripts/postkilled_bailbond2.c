...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((unk_0x320D1840B6DAA1CC() - iVar4) > 100)
		{
			if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				{
					if (vdist2(Var0, unk_0x6B62510F212526DC(iLocal_79[iVar1], 0)) >= IntToFloat((iVar3 * iVar3)) && unk_0x4D21C9FB671ED18F(iLocal_79[iVar1]))
					{
				...
				else if (unk_0xE5965CDF24F93A9F(iLocal_79[iVar1]))
				{
					func_6(&(iLocal_79[iVar1]), 1, 0, 1);
				}
				if (func_3(iLocal_79.f_5[iVar2]))
				{
					...
					{
						if (unk_0x4D21C9FB671ED18F(iLocal_79.f_5[iVar2]) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_79.f_5[iVar2], 0))
						{
							func_2(&(iLocal_79.f_5[iVar2]));
						}
					}
				}
				else if (unk_0xE5965CDF24F93A9F(iLocal_79.f_5[iVar2]))
				{
					func_2(&(iLocal_79.f_5[iVar2]));
				}
				iVar1++;
...
void func_19()
{
	...
	unk_0xD642E010A287ADFD("ENEMIES", &iLocal_90);
	unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_90);
	unk_0x9972EFADA7A2A47D(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
	...
	while (iVar0 <= (iLocal_79 - 1))
	{
		if (func_8(iLocal_79[iVar0]))
		{
			...
			unk_0xFF4BEB6CFF55A013(iLocal_79[iVar0], iLocal_90);
...
void func_20()
{
	...
	unk_0x33B3A4723D5DBD35(5, 1862763509, iLocal_90);
	unk_0x33B3A4723D5DBD35(5, iLocal_90, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
