...
void func_1()
{
	...
	iLocal_245 = 0;
	if (unk_0xE5965CDF24F93A9F(iLocal_237))
	{
		if (!unk_0x55A0C756C4A8220C(iLocal_237, 0))
		{
			func_141();
		}
		else if (iLocal_43 == 2)
		{
			if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_237, 0))
			{
				if (!unk_0x12DD4A0B247D9B4D(uLocal_46))
				{
					func_140("BK_PLANE", 7500, 1);
					uLocal_46 = func_139(iLocal_237, 0, 0);
				}
				if (func_138(unk_0xE2D3D51028F0428A(), iLocal_237, 1) > 300f)
				{
					func_141();
				}
			}
			else if (unk_0x12DD4A0B247D9B4D(uLocal_46))
			{
				unk_0xBA6C3C5E9E5A9442();
				unk_0xFFD8EB5462B07B59(&uLocal_46);
			}
		}
	}
	if ((((unk_0xE5965CDF24F93A9F(iLocal_237) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_237, 0)) && unk_0xCE282187B0A6217E(iLocal_237)) && iLocal_241) && unk_0x70F555A7CCF10659("PLANES", 0, -1))
	{
		if (!bLocal_242)
		{
			if (unk_0xF09A4F413B0D30EB(0, 114))
			{
				if (iLocal_240 == -1 || (unk_0x320D1840B6DAA1CC() - iLocal_240) > 2000)
				{
					if (!unk_0x6B8F21F773404988(uLocal_248))
					{
						uLocal_248 = unk_0x2D649DA6DC187D35("scr_property_leaflet_drop", iLocal_237, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_246 = 0f;
					}
					if (func_137("LEAFLET"))
					{
					...
					unk_0x979FC7400A5D0CD2(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_237, 0, 0, 0);
					iLocal_240 = unk_0x320D1840B6DAA1CC();
					bLocal_242 = true;
				}
			}
		}
		else if ((unk_0x320D1840B6DAA1CC() - iLocal_240) > 3000)
		{
			bLocal_242 = false;
		}
	}
	else if (unk_0x6B8F21F773404988(uLocal_248))
	{
		unk_0x0F53BC871BA89C94(uLocal_248, 0);
		fLocal_246 = 0f;
	}
	if (unk_0x6B8F21F773404988(uLocal_248))
	{
		...
		unk_0x39B111DDFA0712B3(uLocal_248, "spawn", fLocal_246, 0);
	}
	switch (iLocal_43)
	{
		case 0:
			...
			{
				iLocal_237 = Global_111625.f_222[0];
				if (!unk_0xE5965CDF24F93A9F(iLocal_237))
				{
					iLocal_237 = unk_0xBA715A7BEBA5A1F9(joaat("stunt"), Var0, 121.2244f, 1, 1, 0);
					unk_0x9F65B3BAFA302A65(iLocal_237, 1084227584);
				}
				else
				{
					unk_0x2D58A6131679D82C(iLocal_237, 1, 1);
				}
				...
				func_133(&uLocal_47, 1, 0);
				iLocal_43++;
			}
			break;
		
		case 1:
			if (unk_0xE5965CDF24F93A9F(iLocal_237) && unk_0x55A0C756C4A8220C(iLocal_237, 0))
			{
				if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_237, 0))
				{
					unk_0xBA6C3C5E9E5A9442();
		...
		case 3:
			if (func_30(&uLocal_47, Local_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_237, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !unk_0xCE282187B0A6217E(iLocal_237))
			{
				func_133(&uLocal_47, 1, 0);
				iLocal_43++;
			}
		...
		case 5:
			...
			unk_0xF838539C61C30896(iLocal_237, 0);
			func_27();
			break;
	}
	switch (iLocal_44)
	{
		case 0:
			...
			else if ((func_26() && (unk_0x320D1840B6DAA1CC() - iLocal_45) > 5000) && iLocal_245)
			{
		...
		case 1:
			if (func_26() && (unk_0x320D1840B6DAA1CC() - iLocal_45) > 1000)
			{
			...
			if (bVar1)
			{
				...
				else
				{
					...
					if (bParam20)
					{
						...
						if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Param3, Param4, uParam28, 0, iVar4, iVar5))
						{
							bVar1 = true;
						}
					}
...
var func_43(struct<3> Param0, int iParam1)
{
	var uVar0;
...
var func_77(struct<3> Param0, var uParam1, bool bParam2)
{
	var uVar0;
	
	uVar0 = unk_0x434CC3C60683B171(Param0, uParam1);
	unk_0xA582EE8380437B1B(uVar0, 5);
	unk_0xFBBD8F124403B0F5(uVar0, 64);
	unk_0xA241A7085A493F20(uVar0, bParam2);
	if (!bParam2)
	{
...
var func_79(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
	...
	if (unk_0xE5965CDF24F93A9F(Global_103480.f_4))
	{
		if (unk_0x55A0C756C4A8220C(Global_103480.f_4, 0))
		{
			if (func_132(24) != Global_103480.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_129(unk_0x6B62510F212526DC(Global_103480.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_81(Global_103480.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_81(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (unk_0xE5965CDF24F93A9F(iParam0) && unk_0x55A0C756C4A8220C(iParam0, 0))
	{
		...
		func_115(iParam3, &Var0, Param1, uParam2, func_121(iParam0));
...
{
	return (shift_right(iParam0, 26) & 31 * func_107(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_115(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4)
{
	if (func_112(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
...
int func_129(struct<3> Param0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_130(Param0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
void func_143()
{
	...
	func_147(2, 1);
	func_146(&uLocal_72, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
	...
	while (iVar0 <= 9)
	{
		...
		{
			fVar1 = 0f;
			unk_0x9CD4CBF2BBE10F00(Local_238[iVar0 /*8*/], &fVar1, 0, 0);
...
void func_148()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_237))
	{
		unk_0x3D81769BEC61BFF8(&iLocal_237);
	}
	if (unk_0x12DD4A0B247D9B4D(Local_238[0 /*8*/].f_4))
	{
		unk_0xFFD8EB5462B07B59(&(Local_238[0 /*8*/].f_4));
	}
	if (unk_0x12DD4A0B247D9B4D(Local_238[0 /*8*/].f_5))
	{
		unk_0xFFD8EB5462B07B59(&(Local_238[0 /*8*/].f_5));
	}
	if (unk_0x12DD4A0B247D9B4D(Local_238[1 /*8*/].f_4))
	{
		unk_0xFFD8EB5462B07B59(&(Local_238[1 /*8*/].f_4));
	}
	if (unk_0x12DD4A0B247D9B4D(Local_238[1 /*8*/].f_5))
	{
		unk_0xFFD8EB5462B07B59(&(Local_238[1 /*8*/].f_5));
	}
