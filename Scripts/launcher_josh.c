...
void func_192()
{
	...
	{
		case 0:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(unk_0xE2D3D51028F0428A()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam6) && func_217(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_237(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_258(var uParam0, bool bParam1)
{
	...
	func_259(uParam0, iLocal_53, Var0, fVar1);
...
void func_259(var uParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_260(uParam0);
...
void func_261(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_262(uParam0);
...
int func_263(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_264(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xE5965CDF24F93A9F(*uParam0))
		{
			if (!unk_0x55B23FE400FCEA6B(*uParam0, 0))
...
int func_264(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	func_259(uParam0, iLocal_53, 558.09f, -1765.39f, 28.86f, 335.3252f);
	unk_0xD584204572DF0440(*uParam0, 4);
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				uLocal_54 = unk_0x8F5F4164BF5FB513(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xFE1CD80C2F7CBCFB(uLocal_54, 1);
				unk_0x950B26F4C891073F(uParam0->f_28[0], uLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_289(int iParam0, bool bParam1)
{
	...
	{
		unk_0xFFD8EB5462B07B59(&uLocal_224);
	}
