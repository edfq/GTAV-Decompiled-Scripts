...
{
	return func_93(Global_103480.f_2890.f_12.f_66, Param0, iParam1);
}
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_115(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_201(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_203(Global_112915.f_18533[iVar0], &Var2, &fVar3))
			{
