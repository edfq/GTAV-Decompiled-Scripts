...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0x3E3D339BAD67F6F2(iLocal_296, 124, 1);
		}
		func_532();
		switch (iLocal_292)
		{
...
void func_1()
{
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_296) && unk_0xF68107C40359970C(iLocal_296))
	{
		func_2(2);
	}
	else if (func_533(iLocal_296) && func_533(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x0747E45CFF1F74AA(iLocal_296, unk_0xE2D3D51028F0428A(), 1))
		{
			if (unk_0x6799F7DD0261990E(iLocal_296, 0, 2) || unk_0x344BB7BDBAB3823C(iLocal_296))
			{
				func_2(1);
			}
		}
...
void func_3()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			{
				if (unk_0xF68107C40359970C(iLocal_296))
				{
					iLocal_294 = 2;
				}
				else if (unk_0x0747E45CFF1F74AA(iLocal_296, unk_0xE2D3D51028F0428A(), 1))
				{
					iLocal_294 = 1;
				}
			}
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_533(iLocal_296) && unk_0x611AD675982BEBCC(iLocal_296))
		{
			unk_0x6221A52631154EF7(iLocal_296);
		}
		if (bParam1)
		{
			func_17(&iLocal_296, 1, 0, 1);
		}
		else if (func_533(iLocal_296) && unk_0x8F41785F110B0DA0(iLocal_296, Local_282, 50f, 50f, 50f, 0, 1, 0))
		{
			func_11(iLocal_296);
		}
		else
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_302))
	{
		func_6(&uLocal_55, 6);
		iVar0 = 1;
		if (!unk_0xF68107C40359970C(iLocal_302))
		{
			if (unk_0xCED7266BAB0BDC20(iLocal_302, 0) && !func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0x03A927199A2DFE46(iLocal_302);
				unk_0xD86A0BC9CC0A625A(iLocal_302, 1193033728, 0);
			}
		}
		if (bParam0)
		{
	...
	unk_0xB2C3D985489123F0(Local_279, Local_280, 0);
	unk_0x780D33653803D9B0(Local_279, Local_280, 1, 0);
...
void func_24(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_26(Global_112915.f_18533[iVar0], &Var2, &fVar3))
			{
...
void func_36()
{
	...
	if (func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296))
	{
		unk_0x3E3D339BAD67F6F2(iLocal_296, 60, 1);
		...
		switch (iLocal_293)
		{
			case 0:
				...
				uLocal_247 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -1392.254f, 367.9411f, 75.0046f, -44.2648f, 0f, -119.873f, 48.4f, 0, 2);
				unk_0xDD786B89B15AA63F(uLocal_247, 1);
				...
				{
					unk_0x529D306014D3C29A(unk_0xE2D3D51028F0428A(), iLocal_296, 0);
					...
					unk_0x7D1424753688EE7A(0, Local_239, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0xC963A45B50851768(uVar2);
					unk_0x8ACADA903FCAA42F(iLocal_296, uVar2);
			...
			case 3:
				...
				if (unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_296, -828834893))
					{
						if (unk_0xA7A8E89EA6C5E222(iVar0))
						{
							...
							unk_0x8ACADA903FCAA42F(iLocal_296, uVar3);
				...
				else if (func_51(iLocal_296, Local_239, 1.5f) || func_53(&iLocal_334, 10000))
				{
					...
					unk_0x588DDCB644C6486A(uLocal_247, 0);
					func_37();
				}
				break;
			}
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xE2D0C323A1AE5D85(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_126(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_126(iVar10, 14, uVar15[iVar1], -1) };
			func_96(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_118(14);
			if (Global_77661 == 1)
			{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_86(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_128(int iParam0)
{
	...
	func_129(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_129(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_129(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_86(iParam0));
			if (iVar11 > iVar10)
			{
	...
	if (func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296))
	{
		...
		switch (iLocal_293)
		{
			case 0:
				...
				iLocal_334 = -1;
				func_73(0f, 0f, 0f, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0);
				uLocal_247 = unk_0x6729FA3AF971BE2A("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				unk_0xDD786B89B15AA63F(uLocal_247, 1);
				unk_0x850D4EF3D40FB068(1, 0, 3000, 1, 0, 0);
				if (func_8(iVar0))
				{
					...
					{
						unk_0xD6A76BAB45A4B460(iLocal_296, 179, 1);
					}
					func_71(iVar0, 1093140480, 1, 1056964608, 0, 1, 0);
				...
				else
				{
					...
					unk_0x51BB443B279E4104(iLocal_296);
					func_198(iLocal_296, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) + Vector(0f, 2f, 2f));
					unk_0xBBF86885619695CE(iLocal_296, -155.84f);
					unk_0xBBF86885619695CE(unk_0xE2D3D51028F0428A(), -43.04f);
					unk_0x529D306014D3C29A(unk_0xE2D3D51028F0428A(), iLocal_296, 0);
					unk_0xA888F8CC04F25CC8(&uVar3);
					unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 3000);
					unk_0x7D1424753688EE7A(0, Local_238, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0xC963A45B50851768(uVar3);
					unk_0x8ACADA903FCAA42F(iLocal_296, uVar3);
					unk_0x7461D7C5BA953BC7(&uVar3);
					unk_0x85050CAC8798CDD0(Local_341, 2.5f);
					unk_0x3E100889F69B5149(Local_341, 2.5f);
					iLocal_293 = 2;
				}
				break;
				...
				if (unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_52(iLocal_296, 242628503))
					{
						if (unk_0xA7A8E89EA6C5E222(iVar0))
						{
							...
							unk_0x8ACADA903FCAA42F(iLocal_296, uVar4);
...
void func_210()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_533(iLocal_296))
			{
				if (unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
				{
			...
			iLocal_258 = unk_0x320D1840B6DAA1CC() + 1000;
			iLocal_293 = 1;
			break;
		...
		case 1:
			if (func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296))
			{
				...
				if (unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
				{
					if (func_218(unk_0xE2D3D51028F0428A(), iLocal_296) < 5f)
					{
						func_217();
					}
				}
				else if (((func_8(iLocal_298) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0)) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0)) || (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0) && !unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0)))
				{
					func_217();
				}
				func_215();
				if (func_218(unk_0xE2D3D51028F0428A(), iLocal_296) > 200f)
				{
					func_2(4);
				}
			}
...
void func_211()
{
	...
	if (unk_0x320D1840B6DAA1CC() > iLocal_273)
	{
		if ((((func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296)) && unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0)) && !func_214()) && func_218(unk_0xE2D3D51028F0428A(), iLocal_296) < 10f)
		{
			iVar0 = unk_0xB3FF0049C1FD38EC(iLocal_296, 0);
			if (func_8(iVar0) && !unk_0x87B449F4C26E764A(unk_0xE2D3D51028F0428A(), iVar0))
			{
				if (unk_0x0747E45CFF1F74AA(iVar0, unk_0xE2D3D51028F0428A(), 1))
				{
					...
					iLocal_273 = unk_0x320D1840B6DAA1CC() + 5000;
					unk_0xE68645525D451A8B(iLocal_298);
				}
			}
...
void func_215()
{
	if (((func_9(iLocal_298) && func_533(iLocal_296)) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0)) && func_218(unk_0xE2D3D51028F0428A(), iLocal_296) < 10f)
	{
		if (unk_0x320D1840B6DAA1CC() > iLocal_258)
		{
			if (!func_214())
			{
				func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if ((func_216("MEA1_03", 0, 0) || func_216("MEA1_05", 0, 0)) || func_216("MEA1_06", 0, 0))
				{
					...
					{
						iLocal_258 = unk_0x320D1840B6DAA1CC() + 9000;
					}
				}
...
void func_221()
{
	unk_0xF23E6F5690771F71(iLocal_296, func_226());
	unk_0x950D2D7EA1BFF54C(iLocal_296, 0);
	unk_0x508EA490C0230199(iLocal_296, 1);
	unk_0xA7266A50941DBAEA(iLocal_296, 0);
	unk_0x96C405257A1BD81B(iLocal_296, 0);
	unk_0x8888993DFEAE0D08(iLocal_296, 0);
...
void func_233()
{
	...
	if (func_533(iLocal_296))
	{
		unk_0xE54845B0A6C7BCD4(iLocal_296, 1);
	}
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_257())
			{
				if (unk_0x6F940C2636C076AD(sLocal_278))
				{
					unk_0xABFC84F5C4943D7B(iLocal_296, sLocal_278, 1048576000);
				}
				iLocal_270 = unk_0x320D1840B6DAA1CC() + 20000;
		...
		case 1:
			if (iLocal_317)
			{
				if (unk_0x320D1840B6DAA1CC() > iLocal_246)
				{
					if (!func_214())
					{
						if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0))
						{
			...
			{
				iLocal_311 = unk_0x320D1840B6DAA1CC() + 1000;
				unk_0x3C2A46BB06553CEE(unk_0x9E2D6C50374FCFA9());
				iLocal_293 = 2;
			}
			break;
		...
		case 2:
			if (func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296))
			{
				...
				if (!unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
				{
					if (func_8(iLocal_298))
					{
						if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0))
						{
							func_257();
						}
					}
				...
				if (func_218(unk_0xE2D3D51028F0428A(), iLocal_296) > 15f)
				{
					func_237();
					iLocal_293 = 0;
					iLocal_292 = 5;
...
void func_234()
{
	if (func_533(iLocal_306) && func_218(unk_0xE2D3D51028F0428A(), iLocal_306) > 100f)
	{
		func_17(&iLocal_306, 0, 0, 1);
	}
	if (func_533(iLocal_302) && func_218(unk_0xE2D3D51028F0428A(), iLocal_302) > 100f)
	{
...
void func_235()
{
	...
	if (((iLocal_337 && !unk_0x559C03F53E6937FC()) && func_533(unk_0xE2D3D51028F0428A())) && func_533(iLocal_296))
	{
		if (unk_0x174B84F6B78D6CA7(unk_0xE2D3D51028F0428A()))
		{
			iVar0 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
			if ((func_8(iVar0) && !unk_0xF6F5D18EF8EAB859(iLocal_296, iVar0, 1)) && !func_236(iVar0))
			{
...
void func_239()
{
	...
	if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Var0, 1f, 1f, 2f, 1, 1, 0) || unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Var0, 1) < 2.75f)
	{
		...
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			...
			if (func_8(iVar2))
			{
				if (unk_0x78006D212FD7243E(iVar2))
				{
					bVar1 = true;
				}
			}
...
void func_240()
{
	...
	{
		if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_310, 0) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_310, 0))
		{
			if (((unk_0xF798DCF92C74B531(iLocal_310, 2, 5000) || unk_0xF798DCF92C74B531(iLocal_310, 3, 5000)) || unk_0xF798DCF92C74B531(iLocal_310, 0, 5000)) || unk_0xF798DCF92C74B531(iLocal_310, 1, 5000))
			{
				if (iLocal_313 == iLocal_312)
				{
					iLocal_312++;
					iLocal_315 = unk_0x320D1840B6DAA1CC() + 5000;
				}
				else if (unk_0x320D1840B6DAA1CC() > iLocal_315 && !func_214())
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_243()
{
	...
	if (func_533(unk_0xE2D3D51028F0428A()) && unk_0x320D1840B6DAA1CC() > iLocal_311)
	{
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			iVar0 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
			if (iVar0 != iLocal_310)
			{
				...
				else
				{
					if (func_8(iLocal_310))
					{
						unk_0x3D81769BEC61BFF8(&iLocal_310);
					}
					iLocal_310 = iVar0;
				}
			}
...
void func_244()
{
	if ((((iLocal_272 < 3 && !func_214()) && func_242()) && func_245()) && unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
	{
		if (unk_0x320D1840B6DAA1CC() > iLocal_270)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_245()
{
	...
	{
		iVar0 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
		if (func_8(iVar0) && unk_0xF6F5D18EF8EAB859(iLocal_296, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_246()
{
	...
	if ((((iLocal_261 < 3 && unk_0x320D1840B6DAA1CC() > iLocal_259) && func_242()) && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0)) && func_245())
	{
		iVar0 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
		if (func_8(iVar0) && func_70(unk_0x15CAA6D7B11F1A7C(iVar0)))
		{
			bLocal_262 = unk_0xE3F9ED416083BAE0(iVar0);
			if (bLocal_262)
			{
				if (!func_214() && bLocal_263 == 0)
				{
					...
					if (func_241(&uLocal_55, "MEA1AUD", "MEA1_SIREN", sLocal_260[iLocal_261], 7, 0, 0))
					{
						...
						iLocal_259 = unk_0x320D1840B6DAA1CC() + 9000;
					}
				}
			}
			else
	...
	else if (bLocal_263 && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		iVar1 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
		if (func_8(iVar1) && func_70(unk_0x15CAA6D7B11F1A7C(iVar1)))
		{
			bLocal_263 = unk_0xE3F9ED416083BAE0(iVar1);
		}
	}
}
...
void func_247()
{
	if (((iLocal_257 < 3 && unk_0x320D1840B6DAA1CC() > iLocal_254) && func_242()) && func_245())
	{
			...
			if (iLocal_255 > 180)
			{
				if (!func_214() && !func_216("MEA1_04", 0, 0))
				{
					...
					else if (func_241(&uLocal_55, "MEA1AUD", "MEA1_STILL", sLocal_256[iLocal_257], 7, 0, 0))
					{
						iLocal_257++;
						iLocal_255 = 0;
						iLocal_254 = unk_0x320D1840B6DAA1CC() + 9000;
					}
				}
			}
		}
...
void func_248()
{
	...
	if (((iLocal_253 < 4 && unk_0x320D1840B6DAA1CC() > iLocal_251) && func_242()) && func_245())
	{
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && !unk_0xEEEC05469860B219(unk_0xE2D3D51028F0428A()))
		{
			...
			if (func_8(iVar0))
			{
				if (unk_0x5C5B446AD691DEA2(iVar0))
				{
					if (!func_214())
					{
						if (((((iLocal_253 == 0 && func_8(iLocal_298)) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0)) && func_249(iLocal_296, 0) == 2) || (((iLocal_253 == 1 || iLocal_253 == 2) && unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0)) && (func_249(iLocal_296, 0) == 2 || func_249(iLocal_296, 0) == 1))) || (iLocal_253 == 3 && unk_0x79135882170E3D22(unk_0xE2D3D51028F0428A())))
						{
							func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
							if (func_241(&uLocal_55, "MEA1AUD", "MEA1_CRASH", sLocal_252[iLocal_253], 7, 0, 0))
							{
								iLocal_253++;
								iLocal_251 = unk_0x320D1840B6DAA1CC() + 9000;
							}
						}
						else
						{
...
void func_250()
{
	if ((((iLocal_241 < 4 && !func_214()) && func_242()) && (func_245() || func_251())) && unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
	{
		if (iLocal_242 == iLocal_241)
		{
			iLocal_241++;
			iLocal_246 = unk_0x320D1840B6DAA1CC() + 2000;
		}
		else if (unk_0x320D1840B6DAA1CC() > iLocal_246)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
int func_251()
{
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) || unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0))
	{
		return 0;
	}
	return 1;
...
void func_252()
{
	if (iLocal_324)
	{
		if (func_214())
		{
			if (unk_0x320D1840B6DAA1CC() > iLocal_327)
			{
				unk_0x979FC7400A5D0CD2(uLocal_326, "MICHAEL_EVENT_AMANDA_REMOVE_HANDCUFFS_MASTER", iLocal_296, 0, 0, 0);
				iLocal_324 = 0;
			}
		}
	}
		...
		else if (!func_214())
		{
			...
			if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0) && unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0))
			{
				if (func_258(&uLocal_55, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_53(&iLocal_332, 5000))
				{
					...
					unk_0xE1E1AF00CA06A2B7(0, unk_0xCACAD935C0BEE14F(iLocal_298, 2f, 2f, 0f), 2000, 2050, 4);
					...
					unk_0x8ACADA903FCAA42F(iLocal_296, uVar0);
					unk_0x7461D7C5BA953BC7(&uVar0);
					iLocal_327 = unk_0x320D1840B6DAA1CC() + 9000;
					iLocal_324 = 1;
					return 1;
				}
			}
...
void func_262()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_223(&uLocal_343);
			iLocal_293 = 1;
			iLocal_291 = unk_0x320D1840B6DAA1CC() + 10000;
			iLocal_332 = -1;
			break;
		...
		case 1:
			...
			if (iLocal_325)
			{
				...
				{
					uLocal_326 = unk_0xA9ADCC8D104AA552();
					iLocal_325 = 0;
				}
			}
			func_268();
			if (func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296))
			{
				...
				if (unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
				{
					if (func_218(unk_0xE2D3D51028F0428A(), iLocal_296) > (15f * 2f))
					{
						func_237();
						iLocal_293 = 0;
						iLocal_292 = 5;
				...
				else if (((func_8(iLocal_298) && unk_0x87B449F4C26E764A(iLocal_296, iLocal_298)) && !unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0)) && !func_261(iLocal_298))
				{
					func_237();
					iLocal_293 = 0;
					iLocal_292 = 5;
	...
	func_235();
	func_211();
	if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0) || unk_0x8F41785F110B0DA0(iLocal_296, -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0))
	{
...
void func_263()
{
	if (func_533(iLocal_296) && !unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
	{
		if (func_8(iLocal_298))
		{
			if (((unk_0xF798DCF92C74B531(iLocal_298, 2, 30000) || unk_0xF798DCF92C74B531(iLocal_298, 3, 30000)) || unk_0xF798DCF92C74B531(iLocal_298, 0, 7000)) || unk_0xF798DCF92C74B531(iLocal_298, 1, 40000))
			{
				func_2(5);
			}
		}
...
void func_264()
{
	if (((((func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_302)) && !unk_0xEF9410C312F2B117(iLocal_302)) && !unk_0x03454821A9ECF4AA(iLocal_302)) && !unk_0xA6BB28CAD9FB957E(iLocal_302)) && !unk_0x32DCDA1B2F8A0694(iLocal_302))
	{
		if (unk_0x320D1840B6DAA1CC() > iLocal_291)
		{
			if (!func_5(iLocal_302) == joaat("weapon_pistol"))
			{
				unk_0xDEA78B2C8DACFE9D(iLocal_302, 1);
				unk_0x9521FB98DB6DDF50(iLocal_302, joaat("weapon_pistol"), -1, 0, 1);
			}
			if (!unk_0xCED7266BAB0BDC20(iLocal_302, 0))
			{
				unk_0x03A927199A2DFE46(iLocal_302);
				unk_0x463D4F9C4826A59B(iLocal_302, unk_0xE2D3D51028F0428A());
...
void func_265()
{
	if (((((iLocal_266 < 9 && !func_214()) && func_242()) && func_245()) && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) > 0) && !func_267(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x320D1840B6DAA1CC() > iLocal_264)
		{
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			iLocal_268 = unk_0x5853B15F78E1A265(0, 4);
			...
			{
				iLocal_264 = unk_0x320D1840B6DAA1CC() + 9000;
				iLocal_266++;
...
void func_268()
{
	...
	{
		if ((func_270(iLocal_306, 1090519040, 1097859072) || unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A())) || (func_533(iLocal_302) && unk_0xE323E6755636A70E(iLocal_302)))
		{
			if (unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_233, 2))
			{
				unk_0xA5D8BA53953077C8(iLocal_306, -8f, 1);
			}
			unk_0x7734082B0EDB0BE0(iLocal_306, unk_0xE2D3D51028F0428A(), 500f, -1, 0, 0);
			func_269(1);
		}
	}
}
...
{
	if (((((func_533(iLocal_302) && func_533(unk_0xE2D3D51028F0428A())) && !unk_0xEF9410C312F2B117(iLocal_302)) && !unk_0x03454821A9ECF4AA(iLocal_302)) && !unk_0xA6BB28CAD9FB957E(iLocal_302)) && !unk_0x32DCDA1B2F8A0694(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			unk_0xDEA78B2C8DACFE9D(iLocal_302, 1);
	...
	if ((func_533(iLocal_306) && !unk_0x51B334B227EC8042(iLocal_306)) && !unk_0xCED7266BAB0BDC20(iLocal_306, 0))
	{
		if (unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_233, 2))
		{
			unk_0xA5D8BA53953077C8(iLocal_306, -8f, 1);
...
int func_273(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_207(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_275()
{
	if ((iLocal_320 && unk_0x320D1840B6DAA1CC() > iLocal_316) && func_245())
	{
		func_6(&uLocal_55, 4);
...
void func_276()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			func_365();
			iLocal_248 = unk_0x320D1840B6DAA1CC() + 7000;
			iVar0 = unk_0x9993EF7FDBCDB632();
			if (func_8(iVar0) && unk_0x15CAA6D7B11F1A7C(iVar0) != iLocal_299)
			{
		...
		case 1:
			...
			func_302();
			func_298();
			if (((func_533(unk_0xE2D3D51028F0428A()) && func_8(iLocal_298)) && unk_0x0747E45CFF1F74AA(iLocal_298, unk_0xE2D3D51028F0428A(), 1)) && !unk_0x32DCDA1B2F8A0694(unk_0xE2D3D51028F0428A()))
			{
				unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
				func_269(1);
			}
			func_306();
			break;
		...
		case 2:
			if (func_8(iLocal_298))
			{
				if (func_533(iLocal_302))
				{
					...
					{
						func_297();
						iLocal_316 = unk_0x320D1840B6DAA1CC() + 1000;
						iLocal_221 = 4;
						iLocal_234 = 5;
					}
				}
...
void func_277()
{
	...
	if (func_280(unk_0xE2D3D51028F0428A(), Local_222, 100f))
	{
		if (iLocal_323)
		{
			func_279(0);
	...
	else if (func_214())
	{
		if (!iLocal_323)
		{
			Var0 = { func_231() };
			sVar1 = func_278(&Var0);
			if (unk_0x3C57C2F07FEE34D2(sVar1, "MEA1_SCENE"))
			{
				func_279(1);
				iLocal_323 = 1;
			}
...
void func_281()
{
	...
	iVar0 = unk_0x9993EF7FDBCDB632();
	if (((((unk_0xF68107C40359970C(iLocal_302) || unk_0xF68107C40359970C(iLocal_306)) || func_283(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_283(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(iVar0) && func_8(iLocal_298)) && unk_0x72F6AE51B7E34865(iVar0, iLocal_298))) || (unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) > 0 && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_281, 1) < 30f))
	{
		if (!unk_0xF6F5D18EF8EAB859(iLocal_296, iLocal_298, 0))
		{
			if (!unk_0x2F52E009BBC0AFCE(iLocal_296, func_226()))
			{
				func_237();
				iLocal_221 = 5;
				iLocal_234 = 5;
				if (unk_0xCE2C78E9FC0B01E3(uLocal_220))
				{
					fVar1 = unk_0x54DE1614490C2A83(uLocal_220);
					unk_0xA5D8BA53953077C8(iLocal_296, -1000f, 1);
					unk_0xA5D8BA53953077C8(iLocal_298, -1000f, 1);
					if (fVar1 > 0.75f)
					{
						unk_0xA5D8BA53953077C8(iLocal_296, -1000f, 0);
						func_282(iLocal_296, iLocal_298, 2, 0);
					}
					else
					{
						unk_0xA5D8BA53953077C8(iLocal_296, -1000f, 1);
						unk_0x959E1626CBC7D38A(iLocal_296, 1, 0);
					}
					if (func_533(iLocal_302))
					{
						unk_0xA5D8BA53953077C8(iLocal_302, -1000f, 1);
					}
					if (func_533(iLocal_306))
					{
						unk_0xA5D8BA53953077C8(iLocal_306, -1000f, 1);
					}
				}
				unk_0x5C65DDDC219B3AA5(iLocal_296, 0);
				unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
				if ((func_8(iVar0) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iVar0, 0)) && unk_0x7158135695FAE89D(iVar0, 0, 0))
				{
					...
					{
						unk_0xB486640392EC50BB(iLocal_296, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_218(iLocal_296, unk_0xE2D3D51028F0428A()) > 10f)
				{
					if (!func_52(iLocal_296, 1227113341))
					{
						unk_0xC149E50FBB27DD70(iLocal_296, unk_0xE2D3D51028F0428A(), 20000, 7f, 1073741824, 1073741824, 0);
					}
				}
				else
				{
					unk_0x03A927199A2DFE46(iLocal_296);
				}
				func_221();
				func_35(&iLocal_295);
				iLocal_322 = 1;
...
bool func_286(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (unk_0x320D1840B6DAA1CC() - Local_52[iVar2 /*4*/].f_3) < iParam4);
}
...
void func_297()
{
	...
	if (func_533(unk_0xE2D3D51028F0428A()))
	{
		...
		else
		{
			...
			if (func_533(iLocal_296))
			{
				unk_0xC89EA639A6F338A6(iLocal_296);
			}
			unk_0x13A2865660B9B033(Local_329, Local_330, fLocal_331, 1);
			iLocal_325 = 1;
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_533(iLocal_302) && !unk_0xEF9410C312F2B117(iLocal_302)) && !unk_0x03454821A9ECF4AA(iLocal_302)) && !unk_0xA6BB28CAD9FB957E(iLocal_302)) && !unk_0x32DCDA1B2F8A0694(iLocal_302))
			{
				if (!func_52(iLocal_302, 1392476864))
				{
					if (unk_0xFCF559C8631ABED7(iLocal_302, sLocal_277, sLocal_228, 2) || unk_0xFCF559C8631ABED7(iLocal_302, sLocal_277, sLocal_232, 2))
					{
						unk_0xA5D8BA53953077C8(iLocal_302, -8f, 1);
					}
					unk_0xA888F8CC04F25CC8(&uVar0);
					unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 1500);
					unk_0x463D4F9C4826A59B(0, unk_0xE2D3D51028F0428A());
					unk_0xC963A45B50851768(uVar0);
					unk_0x8ACADA903FCAA42F(iLocal_302, uVar0);
					unk_0x7461D7C5BA953BC7(&uVar0);
				}
			}
			if (func_533(iLocal_306) && !unk_0x51B334B227EC8042(iLocal_306))
			{
				if (unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_229, 2) || unk_0xFCF559C8631ABED7(iLocal_306, sLocal_277, sLocal_233, 2))
				{
					unk_0xA5D8BA53953077C8(iLocal_306, -8f, 1);
...
void func_298()
{
	...
	if (((func_8(iLocal_298) && func_533(unk_0xE2D3D51028F0428A())) && func_533(iLocal_302)) && func_533(iLocal_306))
	{
		switch (iLocal_250)
		{
			case 0:
				if (func_214())
				{
					...
					{
						Local_249 = { func_301() };
						if ((((((((func_300(unk_0xE2D3D51028F0428A(), iLocal_298, 5f, 1) || func_300(unk_0xE2D3D51028F0428A(), iLocal_302, 5f, 1)) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_1")) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_2")) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_3")) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_4")) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_5")) && !unk_0x3C57C2F07FEE34D2(&Local_249, "MEA1_SCENE_6")) && func_285(iLocal_302, 1126825984))
						{
			...
			case 1:
				fVar2 = func_219(unk_0xE2D3D51028F0428A(), iLocal_302, 1);
				fVar3 = func_219(unk_0xE2D3D51028F0428A(), iLocal_298, 1);
				bVar4 = false;
				func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				if (fVar2 < fVar3)
				{
				...
				if (bVar4)
				{
					unk_0xF30F15F203736DE4(iLocal_302, unk_0xE2D3D51028F0428A(), 2000, 2048, 4);
					iLocal_250 = 2;
				}
				break;
			...
			case 2:
				if (!func_214())
				{
					if (!unk_0x3C57C2F07FEE34D2(&Local_249, "") && !unk_0x3C57C2F07FEE34D2(&Local_249, "NULL"))
					{
						func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
...
void func_302()
{
	...
	if (func_533(unk_0xE2D3D51028F0428A()) && iLocal_221 != 5)
	{
		bVar0 = false;
		if ((func_533(iLocal_302) && unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_302)) || (((func_533(iLocal_306) && unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_306)) && !((func_283(iLocal_302, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_283(iLocal_306, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()))) && unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) == 0))
		{
			if (unk_0x32DCDA1B2F8A0694(iLocal_302) || unk_0x32DCDA1B2F8A0694(iLocal_306))
			{
				bVar0 = true;
			}
			else if (iLocal_335)
		...
		if (((((((((((unk_0xE5965CDF24F93A9F(iLocal_302) && unk_0x0747E45CFF1F74AA(iLocal_302, unk_0xE2D3D51028F0428A(), 1)) || (unk_0xE5965CDF24F93A9F(iLocal_302) && unk_0xF68107C40359970C(iLocal_302))) || func_295(iLocal_302, 1, 0, 0, 0)) || func_284(iLocal_302, 1126825984)) || func_284(iLocal_306, 1126825984)) || (unk_0xE5965CDF24F93A9F(iLocal_306) && unk_0x0747E45CFF1F74AA(iLocal_306, unk_0xE2D3D51028F0428A(), 1))) || (unk_0xE5965CDF24F93A9F(iLocal_306) && unk_0xF68107C40359970C(iLocal_306))) || unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A())) || bVar0) || func_270(iLocal_306, 1090519040, 1097859072)) || unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A()))
		{
			unk_0xB2C3D985489123F0(Local_279, Local_280, 0);
			unk_0x780D33653803D9B0(Local_279, Local_280, 1, 0);
			if (bVar0)
			...
			if ((((func_533(iLocal_302) && !unk_0xEF9410C312F2B117(iLocal_302)) && !unk_0x03454821A9ECF4AA(iLocal_302)) && !unk_0xA6BB28CAD9FB957E(iLocal_302)) && !unk_0x32DCDA1B2F8A0694(iLocal_302))
			{
				...
				if (!unk_0xCED7266BAB0BDC20(iLocal_302, 0) && !func_52(iLocal_302, 1392476864))
				{
					func_237();
					unk_0xDEA78B2C8DACFE9D(iLocal_302, 1);
					unk_0x9521FB98DB6DDF50(iLocal_302, joaat("weapon_pistol"), -1, 0, 1);
...
void func_303()
{
	if ((func_533(unk_0xE2D3D51028F0428A()) && func_8(iLocal_298)) && func_533(iLocal_296))
	{
		if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 0) || func_261(iLocal_298))
		{
			func_237();
			func_35(&iLocal_295);
			unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
		...
		else if (func_300(unk_0xE2D3D51028F0428A(), iLocal_298, 6.5f, 1))
		{
			if (iLocal_321)
			{
				unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
		...
		{
			unk_0x5C65DDDC219B3AA5(iLocal_298, 1);
			iLocal_321 = 1;
		}
	}
}
...
void func_304()
{
	if ((((func_533(iLocal_302) && func_533(iLocal_306)) && func_533(iLocal_296)) && func_8(iLocal_298)) && unk_0x6F940C2636C076AD(sLocal_277))
	{
		switch (iLocal_221)
		{
			case 0:
				func_305();
				uLocal_220 = unk_0x8F5F4164BF5FB513(Local_222, Local_223, 2);
				unk_0xFE1CD80C2F7CBCFB(uLocal_220, 1);
				unk_0x0BA4916484503B63(uLocal_220, 0);
				iLocal_328 = 1;
				unk_0x950B26F4C891073F(iLocal_302, uLocal_220, sLocal_277, sLocal_224, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x950B26F4C891073F(iLocal_306, uLocal_220, sLocal_277, sLocal_225, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x950B26F4C891073F(iLocal_296, uLocal_220, sLocal_277, sLocal_226, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0xAA8557AFE4A4A184(iLocal_298, uLocal_220, sLocal_227, sLocal_277, 1000f, -8f, 1, 1148846080);
				iLocal_333 = -1;
				iLocal_234 = 1;
				iLocal_221 = 2;
				break;
			...
			case 1:
				func_305();
				uLocal_220 = unk_0x8F5F4164BF5FB513(Local_222, Local_223, 2);
				unk_0xFE1CD80C2F7CBCFB(uLocal_220, 0);
				unk_0x0BA4916484503B63(uLocal_220, 0);
				unk_0x950B26F4C891073F(iLocal_302, uLocal_220, sLocal_277, sLocal_228, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0x950B26F4C891073F(iLocal_306, uLocal_220, sLocal_277, sLocal_229, 1000f, -4f, 1, 16, 1148846080, 0);
				unk_0x950B26F4C891073F(iLocal_296, uLocal_220, sLocal_277, sLocal_230, 1000f, -4f, 4, 16, 1148846080, 0);
				unk_0xAA8557AFE4A4A184(iLocal_298, uLocal_220, sLocal_231, sLocal_277, 1000f, -8f, 1, 1148846080);
				unk_0xE0F81EAEB49D39EF(uLocal_220, 0.622f);
				iLocal_221 = 3;
				break;
			...
			case 3:
				...
				if (!unk_0xCE2C78E9FC0B01E3(uLocal_220))
				{
					uLocal_220 = unk_0x8F5F4164BF5FB513(Local_222, Local_223, 2);
					unk_0xFE1CD80C2F7CBCFB(uLocal_220, 1);
					unk_0x950B26F4C891073F(iLocal_302, uLocal_220, sLocal_277, sLocal_232, 1000f, -4f, 1, 16, 1148846080, 0);
					unk_0x950B26F4C891073F(iLocal_306, uLocal_220, sLocal_277, sLocal_233, 1000f, -4f, 1, 16, 1148846080, 0);
					if (unk_0x7158135695FAE89D(iLocal_298, 2, 0))
					{
						unk_0xA9F390242F9EB2E1(iLocal_296, iLocal_298, 2);
						unk_0xCAA02C32EC0C2462(iLocal_298, 3, 1);
						unk_0xF838539C61C30896(iLocal_298, 1);
						unk_0xF30F15F203736DE4(iLocal_296, unk_0xE2D3D51028F0428A(), -1, 2050, 4);
					}
					if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_298, 1))
					{
				...
				else if (unk_0x54DE1614490C2A83(uLocal_220) >= 0.9f)
				{
					if (unk_0xFCF559C8631ABED7(iLocal_296, sLocal_277, sLocal_230, 2))
					{
						unk_0xA5D8BA53953077C8(iLocal_296, -1000f, 0);
						if (unk_0x7158135695FAE89D(iLocal_298, 2, 0))
						{
				...
				else if (unk_0x54DE1614490C2A83(uLocal_220) >= 0.85f)
				{
					if (unk_0xFCF559C8631ABED7(iLocal_298, sLocal_277, sLocal_231, 2))
					{
						unk_0x959E1626CBC7D38A(iLocal_296, 0, 0);
						unk_0xA5D8BA53953077C8(iLocal_298, -4f, 1);
						unk_0xCAA02C32EC0C2462(iLocal_298, 3, 1);
					}
				}
				break;
			...
			case 4:
				...
				if (func_533(iLocal_302))
				{
					unk_0x529D306014D3C29A(iLocal_302, unk_0xE2D3D51028F0428A(), -1);
				}
				iLocal_221 = 5;
				break;
			}
	...
	switch (iLocal_234)
	{
		...
		case 1:
			if (!func_214())
			{
				...
				{
					if (func_280(unk_0xE2D3D51028F0428A(), Local_222, 90f))
					{
						func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
				...
				else if (func_280(unk_0xE2D3D51028F0428A(), Local_222, (90f * 2f)))
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 2:
			if (!func_214())
			{
				if ((func_280(unk_0xE2D3D51028F0428A(), Local_222, 90f) && !func_216("MEA1_02", 0, 0)) && !func_216("MEA1_03", 0, 0))
				{
					func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
		...
		case 3:
			if (func_214())
			{
				...
				{
					Local_235 = { func_230() };
					if (unk_0x3C57C2F07FEE34D2(&Local_235, "") || unk_0x3C57C2F07FEE34D2(&Local_235, "NULL"))
					{
						iLocal_234 = 5;
					}
					else
		...
		case 4:
			if (func_214())
			{
				if (!func_280(unk_0xE2D3D51028F0428A(), Local_222, 91f))
				{
					Local_235 = { func_230() };
					if (unk_0x3C57C2F07FEE34D2(&Local_235, "") || unk_0x3C57C2F07FEE34D2(&Local_235, "NULL"))
					{
...
void func_310()
{
	...
	{
		if (unk_0xF6F5D18EF8EAB859(iLocal_302, iLocal_298, 0))
		{
			unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
			if (func_52(iLocal_302, -258271821))
			{
				if (unk_0x320D1840B6DAA1CC() > iLocal_286)
				{
					func_2(3);
				}
			}
			...
			{
				unk_0xAD6CDBCDA713560A(iLocal_302, iLocal_298, 30f, 786469);
				iLocal_286 = unk_0x320D1840B6DAA1CC() + 2000;
			}
		}
	}
}
...
void func_311()
{
	...
	if (iLocal_319)
	{
		unk_0xB2C3D985489123F0(Local_279, Local_280, 0);
		unk_0x780D33653803D9B0(Local_279, Local_280, 1, 0);
		if ((func_533(iLocal_302) && func_8(iLocal_298)) && unk_0x7158135695FAE89D(iLocal_298, -1, 0))
		{
			func_237();
			func_69(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			...
			{
				unk_0xA888F8CC04F25CC8(&uVar0);
				unk_0xB486640392EC50BB(0, iLocal_298, 20000, -1, 1f, 1, 0);
				unk_0xAD6CDBCDA713560A(0, iLocal_298, 50f, 786597);
				unk_0xC963A45B50851768(uVar0);
				unk_0x8ACADA903FCAA42F(iLocal_302, uVar0);
				unk_0x7461D7C5BA953BC7(&uVar0);
				unk_0x5C65DDDC219B3AA5(iLocal_298, 0);
	...
	if (unk_0xE5965CDF24F93A9F(unk_0x9993EF7FDBCDB632()))
	{
		if (unk_0x55A0C756C4A8220C(unk_0x9993EF7FDBCDB632(), 0))
		{
			if (func_364(24) != unk_0x9993EF7FDBCDB632())
			{
				if (iParam2 == 1)
				{
					if (func_361(unk_0x6B62510F212526DC(unk_0x9993EF7FDBCDB632(), 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_315(unk_0x9993EF7FDBCDB632(), Param0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_339(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_366(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_418(unk_0x05CBA41180F5D521(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_416(&(Global_99974.f_3));
				if (iVar6 > -1)
				{
...
void func_383(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x75BACF95335672B8(iVar5, &Var7) && !func_385(Var7.f_1)) && iVar9 < 51)
			{
...
void func_428()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			unk_0xAF62582F3EA39095(iLocal_295, "MEA1_AMA");
			unk_0xA582EE8380437B1B(iLocal_295, 3);
			unk_0xAAD76B24A5282FDD(iLocal_295, 1);
			func_435(&iLocal_295, -838.47f, -177.11f, 36.92f, 31.44f);
			func_433();
			iLocal_246 = unk_0x320D1840B6DAA1CC() + 10000;
			iLocal_244 = -1;
			iLocal_245 = -1;
			iLocal_322 = 0;
			iLocal_323 = 0;
		...
		case 1:
			if (func_533(unk_0xE2D3D51028F0428A()))
			{
				if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_281, 1) < 200f)
				{
					iLocal_293 = 2;
				}
			}
		...
		case 2:
			func_430();
			if ((((func_533(unk_0xE2D3D51028F0428A()) && func_533(iLocal_296)) && unk_0xE5965CDF24F93A9F(iLocal_306)) && unk_0xE5965CDF24F93A9F(iLocal_302)) && func_8(iLocal_298))
			{
				if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_281, 1) < 30f)
				{
					iLocal_332 = -1;
					iLocal_293 = 0;
					iLocal_292 = 2;
...
void func_429()
{
	if ((((iLocal_244 < 1 && func_533(unk_0xE2D3D51028F0428A())) && !func_214()) && !func_216("MEA1_01", 0, 0)) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_281, 1) > (30f * 3f))
	{
...
void func_430()
{
	if (!unk_0xE5965CDF24F93A9F(iLocal_298))
	{
		if (unk_0x0152AA00FA3130F1(iLocal_299))
		{
			iLocal_298 = unk_0xBA715A7BEBA5A1F9(iLocal_299, Local_300, fLocal_301, 1, 1, 0);
			unk_0x371D594409A68A18(iLocal_298, 1, 1, 0);
			unk_0x5C65DDDC219B3AA5(iLocal_298, 1);
			unk_0x0FCB0A306FF51ECA(iLocal_298, 0);
			unk_0xF838539C61C30896(iLocal_298, 0);
			unk_0x45A6EA15139A0C54(iLocal_298, 2, true);
			iLocal_321 = 1;
			unk_0xF1A23B343DFEDFD0(iLocal_299);
			unk_0x208B14CA225DC5A0(Local_329, Local_330, fLocal_331, 0, 0, 1);
		}
	}
	if (!unk_0xE5965CDF24F93A9F(iLocal_296))
	{
		if (func_8(iLocal_298) && unk_0x0152AA00FA3130F1(func_16(17)))
		{
			func_431(&iLocal_296, 17, iLocal_298, 2, 1);
			unk_0xF7438EF713CBDAAC(iLocal_296, 2, 4, 0);
			unk_0xF7438EF713CBDAAC(iLocal_296, 3, 5, 0);
			unk_0xF7438EF713CBDAAC(iLocal_296, 4, 5, 0);
			unk_0xF7438EF713CBDAAC(iLocal_296, 8, 1, 0);
			unk_0xF7438EF713CBDAAC(iLocal_296, 1, 0, 0);
			unk_0xF7438EF713CBDAAC(iLocal_296, 10, 1, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 2, 4, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 3, 5, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 4, 5, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 8, 1, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 1, 0, 0, 0);
			unk_0xE3752B10DC995E95(iLocal_296, 10, 1, 0, 0);
			unk_0xD9D122A54FFE62B8(iLocal_296, 1, 0, 0, false);
			unk_0xA7266A50941DBAEA(iLocal_296, 0);
			unk_0xD6A76BAB45A4B460(iLocal_296, 29, 0);
			unk_0xD6A76BAB45A4B460(iLocal_296, 116, 0);
			unk_0xD6A76BAB45A4B460(iLocal_296, 104, 1);
			unk_0x50274A7EACA3133A(iLocal_296, 1);
			unk_0xFF4BEB6CFF55A013(unk_0xE2D3D51028F0428A(), uLocal_297);
			unk_0xFF4BEB6CFF55A013(iLocal_296, uLocal_297);
			unk_0x96C405257A1BD81B(iLocal_296, 1);
			unk_0x8888993DFEAE0D08(iLocal_296, 1);
			unk_0xE54845B0A6C7BCD4(iLocal_296, 1);
			iLocal_221 = 0;
		}
	}
	if (!unk_0xE5965CDF24F93A9F(iLocal_302))
	{
		if (unk_0x0152AA00FA3130F1(iLocal_303))
		{
			iLocal_302 = unk_0xA8D58C3AADA2C41C(6, iLocal_303, Local_304, fLocal_305, 1, 1);
			func_69(&uLocal_55, 6, iLocal_302, "MEAmandaCop", 1, 1);
			unk_0xDEA78B2C8DACFE9D(iLocal_302, 0);
			unk_0xD9D122A54FFE62B8(iLocal_302, 1, 0, 0, false);
			unk_0x348A212511C78DBF(iLocal_302, 25);
			unk_0xA539EDE8DA5BBC22(iLocal_302, Local_304, 0, 0, 1);
			unk_0xF160248D9083ED0C(iLocal_302, 110, 0);
			unk_0xF1A23B343DFEDFD0(iLocal_303);
		}
	}
	if (!unk_0xE5965CDF24F93A9F(iLocal_306))
	{
		...
		{
			iLocal_306 = unk_0xA8D58C3AADA2C41C(4, iLocal_307, Local_308, fLocal_309, 1, 1);
			unk_0x50274A7EACA3133A(iLocal_306, 1);
			unk_0xA539EDE8DA5BBC22(iLocal_306, Local_308, 0, 0, 1);
			func_69(&uLocal_55, 5, iLocal_306, "MEAmandaShop", 1, 1);
			unk_0xF1A23B343DFEDFD0(iLocal_307);
			unk_0xF96094A43D443C41(Local_304, 50f, 0);
			unk_0xB2C3D985489123F0(Local_279, Local_280, 1);
			unk_0x780D33653803D9B0(Local_279, Local_280, 0, 0);
			unk_0xA8AEDE296853BB64(Local_279, Local_280);
			unk_0x2915D98110F23A29(Local_279, Local_280, 0, 1, 1, 1);
		}
	}
}
...
void func_433()
{
	...
	unk_0xD69A0C3662175E68(iLocal_303);
	func_434(func_16(17));
	unk_0xD69A0C3662175E68(iLocal_307);
	unk_0x8FB472886552D737(sLocal_277);
	unk_0x8FB472886552D737(sLocal_278);
}
...
void func_436()
{
	...
	if (unk_0x01896B71C5AC966E(0))
	{
		if (func_533(unk_0xE2D3D51028F0428A()))
		{
			func_69(&uLocal_55, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 1, 1);
			unk_0xE54845B0A6C7BCD4(unk_0xE2D3D51028F0428A(), 1);
		}
		func_69(&uLocal_55, 4, 0, "AMANDA", 0, 1);
		if (func_533(unk_0xE2D3D51028F0428A()))
		{
			uLocal_297 = unk_0x6F8FB52F5D1D0B84(unk_0xE2D3D51028F0428A());
		}
		...
		if (func_34(0) && func_533(unk_0xE2D3D51028F0428A()))
		{
			...
			fVar2 = unk_0x82FE2343F8BDFF0B(unk_0xE2D3D51028F0428A());
		...
		if (func_461())
		{
			...
			switch (iVar3)
			{
				case 0:
					...
					{
						unk_0xC64B6E13A6A7F517(iVar4, -822.4044f, 182.6078f, 71.37809f, 1, 0, 0, 1);
						unk_0xBBF86885619695CE(iVar4, 135.6541f);
					}
					func_7(&iVar4);
					func_452();
					iLocal_293 = 0;
...
{
	return func_511(&(Global_106464.f_2890), Param0, fParam1, 0);
}
...
int func_513(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_514(iParam0, uVar1[iVar3], 1) && func_458(unk_0x6B62510F212526DC(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_354(Param1, 0f, 0f, 0f, 0)) || unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam0, 1), unk_0x6B62510F212526DC(uVar1[iVar3], 1), 1) < 10f)
					{
						unk_0xD59CC8123FD1A789(&iParam0);
						return 1;
					}
...
void func_530()
{
	...
	fVar0 = func_531(unk_0xE2D3D51028F0428A(), Local_281, 1);
...
void func_532()
{
	if (func_533(iLocal_296))
	{
		if (iLocal_328)
		{
			if (unk_0xD5C6B5E3B93A5EDC(iLocal_296, 0))
			{
				unk_0xE3752B10DC995E95(iLocal_296, 8, 0, 0, 0);
				iLocal_328 = 0;
			}
		}
		else if (!unk_0xD5C6B5E3B93A5EDC(iLocal_296, 1))
		{
			unk_0xE3752B10DC995E95(iLocal_296, 8, 1, 0, 0);
			iLocal_328 = 1;
		}
