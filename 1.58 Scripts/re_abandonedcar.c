...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0xC92F9F18E020B461() && !unk_0x37BBF9ACD752871A(unk_0x9E2D6C50374FCFA9(), 0)) || iLocal_243)
		{
			if (!func_236())
			{
				if (func_235())
			...
			switch (iLocal_49)
			{
				...
				case 1:
					...
					if (!unk_0x55B23FE400FCEA6B(iLocal_234, 0))
					{
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_234, 0))
						{
							func_219();
						}
					}
					if (!unk_0x55B23FE400FCEA6B(iLocal_235, 0))
					{
						if (unk_0xD5C6B5E3B93A5EDC(iLocal_235, 0))
						{
							func_219();
						}
					}
					...
					if (!iLocal_243)
					{
						...
						{
							if (func_204(unk_0xE2D3D51028F0428A(), unk_0x6B62510F212526DC(iLocal_236, 1), 1) < IntToFloat(iLocal_256) && !unk_0x4D21C9FB671ED18F(iLocal_236))
							{
								if (!iLocal_250)
								{
									func_202();
									...
									{
										unk_0x3430966AC4550BB9(uLocal_233, 1);
									}
									iLocal_250 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_245)
						{
							if (!unk_0x55B23FE400FCEA6B(iLocal_236, 0))
							{
								...
								{
									if (!unk_0xF68107C40359970C(iLocal_234))
									{
										unk_0xA888F8CC04F25CC8(&uLocal_253);
										unk_0xB486640392EC50BB(0, iLocal_236, -1, -1, 2f, 524296, 0);
										unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
										unk_0xC963A45B50851768(uLocal_253);
										unk_0x8ACADA903FCAA42F(iLocal_234, uLocal_253);
										unk_0x7461D7C5BA953BC7(&uLocal_253);
										unk_0xABC2CA6F28903308(iLocal_234, 1);
									}
									iLocal_245 = 1;
								}
							}
...
void func_2()
{
	if (!unk_0x55B23FE400FCEA6B(iLocal_234, 0))
	{
		if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 10f, 10f, 10f, 0, 1, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if ((timerb() > 3000 && iLocal_254 == 0) && !func_3())
			{
				func_186(&uLocal_66, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				unk_0xF30F15F203736DE4(iLocal_234, unk_0xE2D3D51028F0428A(), 4000, 0, 2);
				unk_0x9972EFADA7A2A47D(5, iLocal_63, 1862763509);
				settimerb(0);
				iLocal_254++;
			}
	...
	if (!iLocal_249)
	{
		if (!unk_0xF68107C40359970C(iLocal_234))
		{
			...
			else if (timera() > 4000)
			{
				if (!unk_0xF68107C40359970C(iLocal_234))
				{
					unk_0xC1A74225341AA9FB(iLocal_234, unk_0xE2D3D51028F0428A(), 0, 16);
					unk_0xABC2CA6F28903308(iLocal_234, 1);
				}
			...
			if (!unk_0xF68107C40359970C(iLocal_234))
			{
				if ((iLocal_257 >= 1 && unk_0x7114C4D8AC9360FE(unk_0xE2D3D51028F0428A(), 0)) && iLocal_246)
				{
					unk_0x49D97B076E3590AC(iLocal_234, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0x1CF3F44FC2EB9F99(sLocal_259);
	...
	else
	{
		...
		switch (iLocal_260)
		{
			...
			case 1:
				...
				{
					func_167();
					uLocal_64 = unk_0xD6D670D39E5EB332(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_159(1);
					unk_0x859006DB870314C5(500);
					wait(2000);
					if (unk_0xE5965CDF24F93A9F(iLocal_234))
					{
						unk_0xB3822DB3D538C8F3(&iLocal_234);
					}
					iLocal_260++;
				}
				else
			...
			case 2:
				...
				iLocal_237 = unk_0x27A58935528FC12F(0, 1063.595f, 3227.571f, 39.3899f, 1, 0, 0);
				uVar0 = unk_0x487C17B41938052C(iLocal_237, 26, iLocal_240, -1, 1, 1);
				uVar0 = uVar0;
				if (!iLocal_248)
				{
					if (unk_0x70F555A7CCF10659("Train_Horn", 0, -1))
					{
						unk_0x979FC7400A5D0CD2(-1, "Warning_Once", iLocal_237, "TRAIN_HORN", 0, 0);
					}
				}
			...
			case 3:
				unk_0x7DE67EEEFEC38205(uLocal_64);
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xE2D0C323A1AE5D85(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_95(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_95(iVar10, 14, uVar15[iVar1], -1) };
			func_65(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_87(14);
			if (Global_77661 == 1)
			{
...
void func_97(int iParam0)
{
	...
	func_98(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_98(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_98(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
...
void func_169()
{
	if ((unk_0xF68107C40359970C(iLocal_234) && unk_0xF68107C40359970C(iLocal_235)) && !iLocal_249)
	{
		func_15();
	}
	if (iLocal_50 == 1)
	{
		if (!iLocal_249)
		{
			if (!unk_0xF68107C40359970C(iLocal_234))
			{
				if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 50f, 50f, 50f, 0, 1, 0))
				{
					func_15();
				}
			}
	...
	{
		if (!unk_0xF68107C40359970C(iLocal_234) && !unk_0xF68107C40359970C(iLocal_235))
		{
			if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 200f, 200f, 200f, 0, 1, 0) && !unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 200f, 200f, 200f, 0, 1, 0))
			{
				func_15();
			}
		}
...
void func_170()
{
	if (!unk_0xF68107C40359970C(iLocal_234))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x7114C4D8AC9360FE(unk_0xE2D3D51028F0428A(), 0))
			{
				if (!unk_0x77A43AFA9AAEC041(iLocal_234, unk_0xE2D3D51028F0428A(), 8f, 8f, 8f, 0, 1, 0) || !unk_0x8F41785F110B0DA0(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
				{
					if ((unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_234) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iLocal_234)) || !unk_0x8F41785F110B0DA0(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
					{
						if (unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6) || !unk_0x8F41785F110B0DA0(iLocal_234, Local_59, 215f, 215f, 215f, 0, 1, 0))
						{
							unk_0x7734082B0EDB0BE0(iLocal_234, unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
							unk_0xABC2CA6F28903308(iLocal_234, 1);
							func_202();
							wait(0);
...
void func_171()
{
	if (iLocal_50 == 1)
	{
		if (!unk_0xF68107C40359970C(iLocal_234))
		{
			if (!unk_0x645F244ECDDEF6CF(iLocal_234))
			{
				if (iLocal_260 < 3)
				{
					if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 20f, 20f, 10f, 0, 1, 0))
					{
						if (func_176())
						{
							func_175(0);
	...
	else if (iLocal_50 == 2)
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_234, 0))
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_176())
				{
					func_175(0);
		...
		else if (!unk_0x55B23FE400FCEA6B(iLocal_235, 0))
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_235, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_176())
				{
					func_175(0);
		...
		if (!func_3())
		{
			if (!iLocal_252)
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 30f, 30f, 10f, 0, 1, 0))
				{
					if (func_201() == 0)
					{
			...
			if (iLocal_258 < unk_0x320D1840B6DAA1CC())
			{
				if (func_174())
				{
					if (!unk_0xF68107C40359970C(iLocal_234))
					{
						if (!unk_0x645F244ECDDEF6CF(iLocal_234))
						{
							...
							iLocal_258 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(4500, 5000));
						}
					}
				}
				else if (!unk_0xF68107C40359970C(iLocal_235))
				{
					if (!unk_0x645F244ECDDEF6CF(iLocal_235))
					{
	...
	if (!unk_0xF68107C40359970C(iLocal_234))
	{
		if (!unk_0x645F244ECDDEF6CF(iLocal_234))
		{
			if ((unk_0x32DCDA1B2F8A0694(iLocal_234) || unk_0x7114C4D8AC9360FE(iLocal_234, joaat("weapon_stungun"))) || unk_0x0747E45CFF1F74AA(iLocal_234, unk_0xE2D3D51028F0428A(), 1))
			{
				func_202();
				unk_0xE68645525D451A8B(iLocal_234);
			}
			if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, Local_62, 0, 1, 0) || !unk_0x8F41785F110B0DA0(iLocal_234, Local_59, 290f, 290f, 290f, 0, 1, 0))
			{
...
void func_177()
{
	...
	if (unk_0x12DD4A0B247D9B4D(uLocal_232))
	{
		if (unk_0xF68107C40359970C(iLocal_235))
		{
			unk_0xFFD8EB5462B07B59(&uLocal_232);
		}
	}
}
...
void func_178()
{
	if (!unk_0xF68107C40359970C(iLocal_234))
	{
		if (unk_0xD5C6B5E3B93A5EDC(iLocal_234, 0))
		{
			if (unk_0x55A0C756C4A8220C(unk_0xB3FF0049C1FD38EC(iLocal_234, 0), 0))
			{
				if (unk_0xFCF559C8631ABED7(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && unk_0xD01FAFCE275C94F3(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						unk_0x3F6DE6DBA9A99FEA(unk_0xB3FF0049C1FD38EC(iLocal_234, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						unk_0x979FC7400A5D0CD2(-1, "SUSPENSION_SCRIPT_FORCE", unk_0xB3FF0049C1FD38EC(iLocal_234, 0), 0, 0, 0);
					}
				}
		...
		if (!unk_0xF68107C40359970C(iLocal_235))
		{
			if (unk_0x0747E45CFF1F74AA(iLocal_235, unk_0xE2D3D51028F0428A(), 1))
			{
				unk_0x49D97B076E3590AC(iLocal_235, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
			}
		}
	}
}
...
void func_179()
{
	if (!unk_0x55B23FE400FCEA6B(iLocal_236, 0))
	{
		if ((!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_236, 0)) || iLocal_50 == 2)
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_236, Local_61, 0, 1, 0) || iLocal_242)
			{
				if (iLocal_50 == 1)
				{
					Local_55 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) - Vector(-1f, 8.8f, 0f) };
					unk_0x1555F0FA7BA4FE0F(Local_55, 0, &Local_55, 0);
					Local_56 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) + Vector(-1f, 0f, 8.8f) };
					unk_0x1555F0FA7BA4FE0F(Local_56, 0, &Local_56, 0);
					Local_57 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) + Vector(-1f, 8.8f, 0f) };
					unk_0x1555F0FA7BA4FE0F(Local_57, 0, &Local_57, 0);
					Local_58 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) - Vector(-1f, 0f, 8.8f) };
					unk_0x1555F0FA7BA4FE0F(Local_58, 0, &Local_58, 0);
					if (!unk_0x0318E2EE6FB4563F(Local_55, 2f))
					{
						iLocal_234 = unk_0xA8D58C3AADA2C41C(19, iLocal_240, Local_55 - Vector(1f, 0f, 0f), func_184(Local_55, func_185(unk_0x9E2D6C50374FCFA9())), 1, 1);
					}
					else if (!unk_0x0318E2EE6FB4563F(Local_56, 2f))
					{
						iLocal_234 = unk_0xA8D58C3AADA2C41C(19, iLocal_240, Local_56 - Vector(1f, 0f, 0f), func_184(Local_56, func_185(unk_0x9E2D6C50374FCFA9())), 1, 1);
					}
					else if (!unk_0x0318E2EE6FB4563F(Local_57, 2f))
					{
						iLocal_234 = unk_0xA8D58C3AADA2C41C(19, iLocal_240, Local_57 - Vector(1f, 0f, 0f), func_184(Local_57, func_185(unk_0x9E2D6C50374FCFA9())), 1, 1);
					}
					else if (!unk_0x0318E2EE6FB4563F(Local_58, 2f))
					{
						iLocal_234 = unk_0xA8D58C3AADA2C41C(19, iLocal_240, Local_58 - Vector(1f, 0f, 0f), func_184(Local_58, func_185(unk_0x9E2D6C50374FCFA9())), 1, 1);
					}
					if (!unk_0xF68107C40359970C(iLocal_234))
					{
						unk_0xEEBC95A38CBDED42(iLocal_234, "A_M_M_HillBilly_01_WHITE_MINI_02");
						unk_0x9521FB98DB6DDF50(iLocal_234, joaat("weapon_stungun"), -1, 1, 1);
						unk_0xC97BA48BC273A1F3(iLocal_234, 100);
						unk_0xD6A76BAB45A4B460(iLocal_234, 137, 1);
						unk_0xD6A76BAB45A4B460(iLocal_234, 188, 1);
						unk_0xD6A76BAB45A4B460(iLocal_234, 286, 1);
						unk_0xB4D956C3C9624B6B(unk_0xE2D3D51028F0428A(), 10000);
						unk_0xBC12D08EE7559CCD(iLocal_234, 0, 0);
						unk_0xBC12D08EE7559CCD(iLocal_234, 27, 1);
						unk_0xBC12D08EE7559CCD(iLocal_234, 13, 1);
						unk_0xBC12D08EE7559CCD(iLocal_234, 50, 1);
						unk_0x71B502FC2E129665(iLocal_234, 2);
						unk_0x395228F7A14C6543(iLocal_234, 2);
						unk_0x3DAB02AAC9E9EC02(iLocal_234, 0);
						unk_0x9DC5CCC4C16546CB(iLocal_234, 2, 11f);
						unk_0x9DC5CCC4C16546CB(iLocal_234, 13, 1f);
						unk_0x059473086913178C(iLocal_234, 1);
						unk_0xFF4BEB6CFF55A013(iLocal_234, iLocal_63);
						func_183(&uLocal_66, 4, iLocal_234, "RAPIST", 0, 1);
						unk_0xBA002E17C13F9DD5(unk_0xE2D3D51028F0428A(), -8f);
						unk_0x50274A7EACA3133A(iLocal_234, 1);
						if (!unk_0x12DD4A0B247D9B4D(uLocal_231))
						{
						...
						unk_0x7461D7C5BA953BC7(&uLocal_253);
						unk_0xABC2CA6F28903308(iLocal_234, 1);
						unk_0xEB087B19F63AB053(iLocal_234, 0, 0);
						iLocal_243 = 1;
					}
				}
				else if (iLocal_50 == 2)
				{
					...
					if (!unk_0xF68107C40359970C(iLocal_235))
					{
						...
						unk_0xF160248D9083ED0C(iLocal_235, 200, 0);
						unk_0xA888F8CC04F25CC8(&uLocal_253);
						...
						unk_0xC1A74225341AA9FB(0, unk_0xE2D3D51028F0428A(), 0, 16);
						unk_0xC963A45B50851768(uLocal_253);
						unk_0x8ACADA903FCAA42F(iLocal_235, uLocal_253);
						unk_0x7461D7C5BA953BC7(&uLocal_253);
						unk_0xABC2CA6F28903308(iLocal_235, 1);
					}
					func_202();
					wait(0);
					if (!unk_0xF68107C40359970C(iLocal_234) && !unk_0xF68107C40359970C(iLocal_235))
...
void func_205()
{
	if (unk_0x55A0C756C4A8220C(iLocal_236, 0))
	{
		if (!func_236())
		{
			if (func_204(unk_0xE2D3D51028F0428A(), unk_0x6B62510F212526DC(iLocal_236, 1), 1) < IntToFloat(iLocal_255))
			{
				if (unk_0x12DD4A0B247D9B4D(uLocal_233))
				{
					unk_0xFFD8EB5462B07B59(&uLocal_233);
				...
				{
					iLocal_238 = unk_0x9993EF7FDBCDB632();
				}
				func_207(1);
				func_206(1);
			}
	...
	if (iLocal_50 == 1)
	{
		if (!unk_0x55B23FE400FCEA6B(iLocal_234, 0))
		{
			if ((((unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_234, 13f, 13f, 13f, 0, 1, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0)) || unk_0x0747E45CFF1F74AA(unk_0xE2D3D51028F0428A(), iLocal_234, 1)) || unk_0x0747E45CFF1F74AA(iLocal_234, unk_0xE2D3D51028F0428A(), 1)) || unk_0x0318E2EE6FB4563F(unk_0x6B62510F212526DC(iLocal_234, 1), 2f))
			{
				iLocal_242 = 1;
				settimerb(0);
				if (!unk_0x55B23FE400FCEA6B(iLocal_234, 0))
				{
					...
					if (!unk_0xF68107C40359970C(iLocal_234))
					{
						unk_0xF30F15F203736DE4(iLocal_234, unk_0xE2D3D51028F0428A(), 30000, 0, 2);
					}
				}
			}
		}
...
void func_218()
{
	if (!unk_0x55B23FE400FCEA6B(iLocal_236, 0))
	{
		if (iLocal_50 == 1)
		{
			if (!unk_0x8F41785F110B0DA0(iLocal_236, Local_59, 15f, 15f, 15f, 0, 1, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((unk_0x0747E45CFF1F74AA(iLocal_236, unk_0xE2D3D51028F0428A(), 1) || unk_0x955815B1A675A225(unk_0xE2D3D51028F0428A(), Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f), 0, 1)) || unk_0x8FE34BF4165F5104(2, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x8FE34BF4165F5104(4, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x8FE34BF4165F5104(0, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x8FE34BF4165F5104(1, Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x97D65C0968CFE3AF(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || unk_0x0C9B32757AE0B2BF(Local_59 - Vector(50f, 50f, 50f), Local_59 + Vector(50f, 50f, 50f))) || (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_236, 50f, 50f, 50f, 0, 1, 2) && unk_0x98D590FB7BA7DF44(unk_0x9E2D6C50374FCFA9())))
			{
				if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
				{
					iLocal_238 = unk_0x9993EF7FDBCDB632();
...
void func_221()
{
	...
	if (iLocal_50 == 1)
	{
		unk_0x2915D98110F23A29(Local_59 - Vector(20f, 50f, 50f), Local_59 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x2915D98110F23A29(Local_59 - Vector(50f, 100f, 100f), Local_59 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
	}
	unk_0x02B222EADC9DC566(Local_54, 50f, 0, 0, 0, 0, 0, 0, 0);
	...
	unk_0x63B063064DC08617(sLocal_259);
	unk_0xF30CF8286FBA13D7(0);
	unk_0x66B27A59829491D3("RE_ABANDONED_VEHICLE_SCENE");
	while (((((!unk_0x0152AA00FA3130F1(iLocal_240) || !unk_0x0152AA00FA3130F1(iLocal_241)) || !unk_0x6F940C2636C076AD("random@train_tracks")) || !unk_0x6F940C2636C076AD("amb@world_human_guard_patrol@male@idle_b")) || !unk_0x63B063064DC08617(sLocal_259)) || !unk_0xA37204C64473B324("RE_ABANDONED_VEHICLE_SCENE"))
	{
		wait(0);
	}
	if (func_201() == 0)
	{
		func_183(&uLocal_66, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
	}
	else if (func_201() == 1)
	{
		func_183(&uLocal_66, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	}
	else if (func_201() == 2)
	{
		func_183(&uLocal_66, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
	}
	unk_0x07CECF421D895F3D(3, 0);
	unk_0x07CECF421D895F3D(5, 0);
	iLocal_236 = unk_0xBA715A7BEBA5A1F9(iLocal_241, Local_59, fLocal_60, 1, 1, 0);
	unk_0x7A93DEA53EFC3CF2(iLocal_236, 10000);
	unk_0x7A75DC202144ACCF(iLocal_236);
	unk_0x09042D5723106B97(iLocal_236, 5f);
	unk_0xF1A23B343DFEDFD0(iLocal_241);
	unk_0x2A375326652F1B50(iLocal_236, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
	unk_0xC5EAD0C81781889B(iLocal_236, 3);
	unk_0xD642E010A287ADFD("Redneck", &iLocal_63);
	unk_0x9972EFADA7A2A47D(5, iLocal_63, 1862763509);
	unk_0x9972EFADA7A2A47D(5, joaat("COP"), iLocal_63);
	unk_0x9972EFADA7A2A47D(5, iLocal_63, joaat("COP"));
	if (iLocal_50 == 1)
	{
		unk_0x2476BE9932670CAD(iLocal_236, 0, 1, 0);
		unk_0x2476BE9932670CAD(iLocal_236, 1, 1, 0);
		unk_0xBDB27A4F81702F96(iLocal_236, Local_59, 0f, 1700f, 1);
		unk_0x371D594409A68A18(iLocal_236, 0, 1, 0);
		unk_0xE5283B3A324D3FB0(iLocal_236, 2);
	}
	else if (iLocal_50 == 2)
	{
		unk_0x371D594409A68A18(iLocal_236, 0, 1, 0);
		unk_0xE5283B3A324D3FB0(iLocal_236, 1);
		iLocal_234 = unk_0x487C17B41938052C(iLocal_236, 26, iLocal_240, -1, 1, 1);
		unk_0xE3752B10DC995E95(iLocal_234, 0, 0, 2, 0);
		unk_0xE3752B10DC995E95(iLocal_234, 2, 1, 2, 0);
		unk_0xE3752B10DC995E95(iLocal_234, 3, 1, 0, 0);
		unk_0xE3752B10DC995E95(iLocal_234, 4, 0, 0, 0);
		unk_0xE3752B10DC995E95(iLocal_234, 8, 0, 0, 0);
		unk_0x50274A7EACA3133A(iLocal_234, 1);
		unk_0xFF4BEB6CFF55A013(iLocal_234, iLocal_63);
		unk_0x9521FB98DB6DDF50(iLocal_234, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
		unk_0xBC12D08EE7559CCD(iLocal_234, 1, 0);
		unk_0x348A212511C78DBF(iLocal_234, 25);
		unk_0x059473086913178C(iLocal_234, 1);
		unk_0xEEBC95A38CBDED42(iLocal_234, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_183(&uLocal_66, 4, iLocal_234, "INCESTBRO1", 0, 1);
		iLocal_235 = unk_0x487C17B41938052C(iLocal_236, 26, iLocal_240, 0, 1, 1);
		unk_0xE3752B10DC995E95(iLocal_235, 0, 0, 0, 0);
		unk_0xE3752B10DC995E95(iLocal_235, 2, 0, 0, 0);
		unk_0xE3752B10DC995E95(iLocal_235, 3, 0, 2, 0);
		unk_0xE3752B10DC995E95(iLocal_235, 4, 1, 0, 0);
		unk_0xE3752B10DC995E95(iLocal_235, 8, 0, 0, 0);
		unk_0xF160248D9083ED0C(iLocal_235, 100000000, 0);
		unk_0x50274A7EACA3133A(iLocal_235, 1);
		unk_0xFF4BEB6CFF55A013(iLocal_235, iLocal_63);
		unk_0x9521FB98DB6DDF50(iLocal_235, joaat("weapon_pistol"), -1, 0, 1);
		unk_0xBC12D08EE7559CCD(iLocal_235, 1, 0);
		unk_0x348A212511C78DBF(iLocal_235, 25);
		unk_0x059473086913178C(iLocal_235, 1);
		unk_0xEEBC95A38CBDED42(iLocal_235, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_183(&uLocal_66, 5, iLocal_235, "INCESTBRO2", 0, 1);
		unk_0x49D97B076E3590AC(iLocal_234, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0x49D97B076E3590AC(iLocal_235, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		unk_0xF1A23B343DFEDFD0(iLocal_240);
	}
	iLocal_51 = 1;
}
...
int func_223()
{
	...
	{
		if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_48) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_234())
		{
			return 0;
		}
	}
...
void func_237()
{
	if (iLocal_52)
	{
		...
		unk_0x0709E99F1DDFFF26(sLocal_259);
		...
		if (!unk_0x55B23FE400FCEA6B(iLocal_238, 0))
		{
			if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_238, 0) && !unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_238, 50f, 50f, 50f, 0, 1, 0))
			{
				func_265(iLocal_238, 0, 145);
			}
		}
		if (!unk_0xF68107C40359970C(iLocal_234) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			unk_0xA6D4FBB3B47CF11E(iLocal_234);
			unk_0x7734082B0EDB0BE0(iLocal_234, unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
			unk_0xABC2CA6F28903308(iLocal_234, 1);
		}
		if (!unk_0xF68107C40359970C(iLocal_235) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			unk_0xA6D4FBB3B47CF11E(iLocal_235);
			unk_0x7734082B0EDB0BE0(iLocal_235, unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
			unk_0xABC2CA6F28903308(iLocal_235, 1);
		}
	}
	func_238(-1);
...
int func_292(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_313(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
Vector3 func_318()
{
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		fVar0 = unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_261, 1);
		iLocal_263 = 1;
		if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_262, 1) < fVar0)
		{
			fVar0 = unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_262, 1);
			iLocal_263 = 2;
		}
		if (iLocal_263 == 1)
		{
