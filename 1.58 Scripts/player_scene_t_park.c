...
int func_2()
{
	...
	if (!unk_0xACC32B78196FBC2A(&cLocal_80))
	{
		if (!unk_0x6B8F21F773404988(uLocal_77))
		{
			Var0 = { Vector(32.856f, 3819.65f, 1971.62f) - Local_75 };
			uLocal_77 = unk_0xE1DF0021F629F1D2(&cLocal_80, Local_75 + Var0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0xFCF559C8631ABED7(unk_0xE2D3D51028F0428A(), &sLocal_110, &cLocal_126, 2))
		{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						if (!unk_0xE5965CDF24F93A9F(iLocal_68) || iLocal_79 != -1)
						{
							if (unk_0xE4084DC6AF8BE020(&cLocal_89, unk_0xE2D3D51028F0428A(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
								if (unk_0x3C57C2F07FEE34D2(&cLocal_89, "scr_meth_pipe_smoke"))
								{
									func_17(unk_0xE2D3D51028F0428A(), 0, 1, 0);
								}
								uLocal_169 = unk_0xA9ADCC8D104AA552();
								unk_0x979FC7400A5D0CD2(uLocal_169, &cLocal_160, unk_0xE2D3D51028F0428A(), &cLocal_151, 0, 0);
								iLocal_170++;
							}
						}
						else if (unk_0x74A35BFF0670ECD4(&cLocal_89, iLocal_68, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (unk_0x3C57C2F07FEE34D2(&cLocal_89, "scr_meth_pipe_smoke"))
							{
								func_17(unk_0xE2D3D51028F0428A(), 0, 1, 0);
				...
				case 2:
					if (!unk_0xACC32B78196FBC2A(&cLocal_98))
					{
						if (unk_0xBC6A97BAEBCD5CD9(&cLocal_98, Local_75 + Local_107, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_170++;
						}
					}
			...
			{
				if (unk_0xE85F749F6D5C809E(iLocal_68))
				{
					if (iLocal_74 != -1)
					{
						if (fVar1 > fLocal_73)
		...
		else
		{
			if (iLocal_78 != 0)
			{
				unk_0x0F53BC871BA89C94(iLocal_78, 0);
				iLocal_78 = 0;
				unk_0xF889BDFCC181BA9F(uLocal_169);
				unk_0xCDBCC1BC1184B002(uLocal_169);
			}
			if (unk_0xE5965CDF24F93A9F(iLocal_68))
			{
				if (unk_0xE85F749F6D5C809E(iLocal_68))
	...
	switch (iParam1)
	{
		case 0:
			...
			if (unk_0x15CAA6D7B11F1A7C(*iParam0) == joaat("prop_iron_01"))
			{
				...
				Var2 = { unk_0x63A8BF5E6C2BF85C(*iParam0, 2) };
				unk_0xC64B6E13A6A7F517(*iParam0, Var1 + Vector(0.1f, 0f, 0f), 1, 0, 0, 1);
				unk_0x8CE3D365F064F69E(*iParam0, Var2.x, Var2.f_1, Var2.f_2, 2, 1);
			}
		...
		case 4:
			...
			switch (unk_0x15CAA6D7B11F1A7C(*iParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					Var7 = { 0f, 0f, 53.6f };
					unk_0xC64B6E13A6A7F517(*iParam0, Var6, 1, 0, 0, 1);
					unk_0x8CE3D365F064F69E(*iParam0, Var7, 2, 1);
			...
			while (!unk_0x0152AA00FA3130F1(iVar5))
			{
			...
			unk_0x4BDA5AFD88C085EB(iParam0);
			*iParam0 = unk_0x0E536D72AB30F4C8(iVar5, Var3, 1, 1, 0);
			unk_0x8CE3D365F064F69E(*iParam0, Var4, 2, 1);
		...
		case 8:
			Var8 = { unk_0x6B62510F212526DC(*iParam0, 1) };
			Var9 = { unk_0x63A8BF5E6C2BF85C(*iParam0, 2) };
			sVar10 = "";
			switch (unk_0x15CAA6D7B11F1A7C(*iParam0))
			{
			...
			unk_0xBC6A97BAEBCD5CD9(sVar10, Var8, Var9, 1065353216, 0, 0, 0);
			unk_0x4BDA5AFD88C085EB(iParam0);
			return 1;
			break;
		
		case 9:
			Var11 = { unk_0x6B62510F212526DC(*iParam0, 1) };
			Var12 = { unk_0x63A8BF5E6C2BF85C(*iParam0, 2) };
			sVar13 = "";
			switch (unk_0x15CAA6D7B11F1A7C(*iParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			unk_0xD69A0C3662175E68(iVar14);
			while (!unk_0x0152AA00FA3130F1(iVar14))
			{
				unk_0xC43E67C9BA871ECB();
				unk_0xAC765EF46E85A446(18);
				unk_0xC166F812177B2F12();
			...
			unk_0xBC6A97BAEBCD5CD9(sVar13, Var11, Var12, 1065353216, 0, 0, 0);
			unk_0x4BDA5AFD88C085EB(iParam0);
			*iParam0 = unk_0x0E536D72AB30F4C8(iVar14, Var11, 1, 1, 0);
			unk_0x8CE3D365F064F69E(*iParam0, Var12, 2, 1);
			if (func_6(iVar0, &sVar15, &cVar16, &uVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					if (!unk_0xFCF559C8631ABED7(*iParam0, &sVar18, &sVar15, 2))
					{
						unk_0xAA8557AFE4A4A184(*iParam0, Global_97304, &sVar15, &sVar18, 1000f, -8f, uVar17, 1148846080);
					}
				}
			}
			unk_0xF1A23B343DFEDFD0(iVar14);
			return 1;
			break;
	}
	return 0;
...
int func_37()
{
	if (!iLocal_69 == 0)
	{
		if (!unk_0xE5965CDF24F93A9F(iLocal_68))
		{
			...
			{
				iLocal_68 = unk_0x0E536D72AB30F4C8(iLocal_69, Local_75, 1, 1, 0);
				unk_0x9A97DC6DBC7B223D(iLocal_68, unk_0xE2D3D51028F0428A(), unk_0xB897FCFCFA664B38(unk_0xE2D3D51028F0428A(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				iLocal_68 = unk_0x0E536D72AB30F4C8(iLocal_69, Local_75 + Local_70, 1, 1, 0);
				unk_0xC64B6E13A6A7F517(iLocal_68, Local_75 + Local_70, 1, 0, 0, 1);
				unk_0x8CE3D365F064F69E(iLocal_68, Vector(uLocal_76, 0f, 0f) + Local_71, 2, 1);
				unk_0x5C65DDDC219B3AA5(iLocal_68, 1);
			}
		}
	}
	if (!func_38())
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_68))
		{
			if (iLocal_72 != -1)
			{
				if (!unk_0x099CAD293190F449(iLocal_68, unk_0xE2D3D51028F0428A()))
				{
					unk_0x9A97DC6DBC7B223D(iLocal_68, unk_0xE2D3D51028F0428A(), unk_0xB897FCFCFA664B38(unk_0xE2D3D51028F0428A(), iLocal_72), Local_70, Local_71, 0, 0, 0, 0, 2, 1);
				}
			}
...
void func_53()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (!unk_0xACC32B78196FBC2A(&cLocal_142))
		{
			if (!unk_0x8133A5F807883BC6(&cLocal_142, 0, -1))
			{
				bVar1 = false;
			}
		}
...
int func_55(struct<109> Param0, var uParam1)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam1 = { Global_98085[0 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_57(uParam1);
			uParam1->f_118 = Global_99673[0];
			return 1;
			break;
		
		case 3:
			*uParam1 = { Global_98085[1 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_57(uParam1);
			uParam1->f_118 = Global_99673[1];
			return 1;
			break;
		
		case 4:
			*uParam1 = { Global_98085[2 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_57(uParam1);
			uParam1->f_118 = Global_99673[2];
			return 1;
			break;
		...
		case 5:
			*uParam1 = { Param0 };
			...
			uParam1->f_110 = -982327190;
			func_57(uParam1);
			uParam1->f_118 = Global_99673[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 17, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 144, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 43, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
