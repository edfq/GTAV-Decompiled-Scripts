...
void __EntryFunction__()
{
	...
	if (unk_0xB4C854DD86E40FDA(unk_0x1307D54181723A6E()) > 1 && !func_84(uLocal_66, 4194304))
	{
		if (iLocal_77 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (unk_0x9CD4CBF2BBE10F00(ScriptParam_95.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
		...
		if (unk_0xE5965CDF24F93A9F(uLocal_61) && !unk_0x55B23FE400FCEA6B(iLocal_61, 0))
		{
			...
			switch (iLocal_67)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_70(3) && !Global_100008)
						{
							...
							{
								if ((!func_84(uLocal_66, 1) || !unk_0xE5965CDF24F93A9F(func_69())) && !Global_100008)
								{
									func_77(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (!unk_0x8F41785F110B0DA0(iLocal_61, ScriptParam_95.f_1[0 /*3*/], fLocal_85, fLocal_85, 2f, 0, 1, iLocal_75))
							{
								bVar3 = false;
							}
							...
							if (bVar3)
							{
								...
								if (func_42(uLocal_62))
								{
									...
									else if (!func_84(uLocal_66, 2048) || !unk_0xF847447D4467709D())
									{
										func_40(&iLocal_68);
				...
				case 6:
					...
					if (func_84(uLocal_66, 2097152))
					{
						if (!func_70(3) && !unk_0x87C0DA419F19FF57(iLocal_50))
						{
							func_77(10);
						}
					}
...
void func_23()
{
	unk_0xF1A23B343DFEDFD0(Local_88.f_1);
	if (unk_0xE5965CDF24F93A9F(Local_88))
	{
		unk_0x59E393B344098656(&Local_88);
	}
}
...
void func_73()
{
	if (!unk_0xE5965CDF24F93A9F(Local_88))
	{
		Local_88 = unk_0x0E536D72AB30F4C8(Local_88.f_1, Local_88.f_2, 1, 1, 0);
		unk_0xA539EDE8DA5BBC22(Local_88, Local_88.f_2, 0, 0, 1);
		unk_0x8CE3D365F064F69E(Local_88, Local_88.f_5, 2, 1);
		unk_0x5C65DDDC219B3AA5(Local_88, 1);
	}
}

int func_74()
{
	if (!unk_0x61ADF697DF551DA6(Local_88.f_1))
	{
		return 0;
	}
	return unk_0x0152AA00FA3130F1(Local_88.f_1);
}
...
void func_75()
{
	...
	unk_0xD69A0C3662175E68(Local_88.f_1);
}
