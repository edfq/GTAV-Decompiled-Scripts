...
void func_1()
{
	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (unk_0x01896B71C5AC966E(0))
			{
				...
				while (iVar1 <= 5)
				{
					if (unk_0xE5965CDF24F93A9F(Global_111625.f_225[iVar1]))
					{
						uLocal_221[iVar1] = Global_111625.f_225[iVar1];
						Global_111625.f_225[iVar1] = 0;
						unk_0x2D58A6131679D82C(uLocal_221[iVar1], 1, 1);
						if (iLocal_226 == 0)
						{
							iLocal_226 = unk_0x15CAA6D7B11F1A7C(uLocal_221[iVar1]);
						}
						if (!unk_0xF68107C40359970C(uLocal_221[iVar1]))
						{
							unk_0xFF4BEB6CFF55A013(uLocal_221[iVar1], iLocal_224);
							unk_0x71B502FC2E129665(uLocal_221[iVar1], 1);
							unk_0x3DAB02AAC9E9EC02(uLocal_221[iVar1], 0);
							unk_0x348A212511C78DBF(uLocal_221[iVar1], 5);
							unk_0x7DCB4594ACF18DA7(uLocal_221[iVar1], 1);
							func_52(uLocal_221[iVar1], 20f, 5f, 90f, -80f, 80f);
							if (iLocal_45 == 0)
							{
								unk_0x71B502FC2E129665(uLocal_221[iVar1], 2);
							}
				...
				while (iVar1 <= 1)
				{
					if (unk_0xE5965CDF24F93A9F(Global_111625.f_222[iVar1]))
					{
						uLocal_220[iVar1] = Global_111625.f_222[iVar1];
						Global_111625.f_222[iVar1] = 0;
						unk_0x2D58A6131679D82C(uLocal_220[iVar1], 1, 1);
						if (iLocal_225 == 0)
						{
							iLocal_225 = unk_0x15CAA6D7B11F1A7C(uLocal_220[iVar1]);
						}
					}
					iVar1++;
				}
		...
		case 1:
			...
			while (iVar1 <= 5)
			{
				...
				if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar1]) && !unk_0xF68107C40359970C(uLocal_221[iVar1]))
				{
					bVar3 = false;
				}
				iVar1++;
	...
	while (iVar1 <= 5)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar1]))
		{
			if (unk_0xF68107C40359970C(uLocal_221[iVar1]))
			{
				unk_0xB3822DB3D538C8F3(&(uLocal_221[iVar1]));
			}
			else if (func_6(uLocal_221[iVar1], func_7(func_8()), 1) > 100f && func_5(unk_0xE2D3D51028F0428A(), uLocal_221[iVar1], 1) > 300f)
			{
				func_4();
			}
		...
		if (unk_0x12DD4A0B247D9B4D(uLocal_223[iVar1]))
		{
			if (!unk_0xE5965CDF24F93A9F(uLocal_221[iVar1]) || unk_0xF68107C40359970C(uLocal_221[iVar1]))
			{
				unk_0xFFD8EB5462B07B59(&(uLocal_223[iVar1]));
			}
		}
		iVar1++;
	}
...
void func_9()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar0]) && !unk_0xF68107C40359970C(uLocal_221[iVar0]))
		{
			...
			{
				iVar3 = 0;
				unk_0xA7E29842FA438ED6(uLocal_221[iVar0], &iVar3, 1);
				if (iVar3 == joaat("weapon_molotov"))
				{
					if (unk_0x8FEA2E94638F9767(uLocal_221[iVar0], joaat("weapon_microsmg"), 0))
					{
						unk_0x202B28FEABEC4034(uLocal_221[iVar0], joaat("weapon_microsmg"), 1);
					}
					else
					{
						unk_0x9521FB98DB6DDF50(uLocal_221[iVar0], joaat("weapon_microsmg"), -1, 1, 1);
					}
				}
			}
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						unk_0xC1A74225341AA9FB(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						unk_0x7734082B0EDB0BE0(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 1000f, -1, 1, 0);
					}
					break;
				}
		}
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar4 = func_36();
				if (iVar4 != -1 && !unk_0xB6F46ABD140050F1(uLocal_221[iVar4]))
				{
		...
		case 3:
			if ((func_37() && (unk_0x320D1840B6DAA1CC() - iLocal_212) > 3000) && !unk_0xB6F46ABD140050F1(unk_0xE2D3D51028F0428A()))
			{
		...
		case 4:
			if (func_37() && (unk_0x320D1840B6DAA1CC() - iLocal_212) > 1000)
			{
				iVar4 = func_36();
				if (iVar4 != -1 && !unk_0xB6F46ABD140050F1(uLocal_221[iVar4]))
				{
...
int func_36()
{
	...
	while (iVar1 <= 5)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar1]) && !unk_0xF68107C40359970C(uLocal_221[iVar1]))
		{
			fVar3 = func_5(uLocal_221[iVar1], unk_0xE2D3D51028F0428A(), 1);
...
Vector3 func_40(struct<3> Param0, float fParam1)
{
	...
	return Param0 + func_41(Var0, unk_0xC4EAB25A108C2429(0f, fParam1));
}
...
int func_43(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		if ((unk_0xE5965CDF24F93A9F(uLocal_221[iVar0]) && !unk_0xF68107C40359970C(uLocal_221[iVar0])) && uLocal_222[iVar0] > 0)
		{
			iLocal_219 = 1;
		}
		iVar0++;
	}
	if (((((((((((func_44(Global_111625.f_35, 134217728) || unk_0x7E006F2E24F03BB4(uLocal_221[iParam0], unk_0xE2D3D51028F0428A())) || unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), uLocal_221[iParam0])) || unk_0xE10B76698E5CF067(uLocal_221[iParam0])) || unk_0x9AC74C7EF847A074(unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f, 1)) || unk_0x81C70E8A536AAC9E(unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f, 1, 1)) || unk_0x89D0E0233F6E59A7(21, unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f)) || unk_0x89D0E0233F6E59A7(10, unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f)) || unk_0x89D0E0233F6E59A7(7, unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f)) || unk_0x89D0E0233F6E59A7(0, unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f)) || unk_0x89D0E0233F6E59A7(1, unk_0x6B62510F212526DC(uLocal_221[iParam0], 1), 15f)) || iLocal_219)
	{
		return 1;
	}
	return 0;
...
void func_45()
{
	...
	while (iVar0 <= 1)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_220[iVar0]) && unk_0x55A0C756C4A8220C(uLocal_220[iVar0], 0))
		{
			iVar2 = 0;
			while (iVar2 <= 5)
			{
				if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar2]) && !unk_0xF68107C40359970C(uLocal_221[iVar2]))
				{
					if (Local_37[iVar2 /*10*/].f_8 != -1 && Local_37[iVar2 /*10*/].f_8 == iVar0)
					{
						if (!unk_0xF6F5D18EF8EAB859(uLocal_221[iVar2], uLocal_220[iVar0], 0))
						{
							uVar1[iVar0]++;
						}
					}
		...
		unk_0x963A57DF8530029D(&cVar3, 0.05f, (0.25f + (IntToFloat(iVar0) * 0.025f)), 0f, 255, 255, 255, 255);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
		...
		if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar0]) && !unk_0xF68107C40359970C(uLocal_221[iVar0]))
		{
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						if (!unk_0x98C2AE9A4C384CBF(uLocal_221[iVar0], 286, 1))
						{
							unk_0xD6A76BAB45A4B460(uLocal_221[iVar0], 286, 1);
						}
					}
					else
					{
						bVar5 = false;
						if (unk_0xD5C6B5E3B93A5EDC(uLocal_221[iVar0], 0))
						{
							iVar6 = unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0);
							iVar4 = 0;
							while (iVar4 <= 1)
							{
								if (!bVar5)
				...
				case 2:
					if (iLocal_215 != -1)
					{
						...
						if (unk_0xE5965CDF24F93A9F(uLocal_221[iLocal_215]))
						{
							if (unk_0xD5C6B5E3B93A5EDC(uLocal_221[iLocal_215], 0))
							{
								uVar7 = unk_0xB3FF0049C1FD38EC(uLocal_221[iLocal_215], 0);
							}
						}
					}
					if ((((((((iLocal_215 == -1 || !unk_0xE5965CDF24F93A9F(uLocal_221[iLocal_215])) || unk_0xF68107C40359970C(uLocal_221[iLocal_215])) || !unk_0xE5965CDF24F93A9F(uVar7)) || !unk_0x55A0C756C4A8220C(iVar7, 0)) || unk_0xB4C63F21D1DC6C23(iVar7, 0, 1)) || unk_0xB4C63F21D1DC6C23(iVar7, 1, 1)) || unk_0xB4C63F21D1DC6C23(iVar7, 4, 1)) || unk_0xB4C63F21D1DC6C23(iVar7, 5, 1))
					{
						iVar8 = -1;
						bVar9 = false;
						iVar4 = 0;
						while (iVar4 <= 5)
						{
							if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar4]) && !unk_0xF68107C40359970C(uLocal_221[iVar4]))
							{
			...
			{
				iVar10 = 0;
				unk_0xA7E29842FA438ED6(uLocal_221[iVar0], &iVar10, 1);
			...
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					else if (!unk_0xF6F5D18EF8EAB859(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
					{
						if (func_5(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 1) > 4f)
						{
							if (!func_38(uLocal_221[iVar0], 780511057, 1))
							{
								unk_0x776D1ABB5A5CC181(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0f, 0f, 0f, 4f, 0);
								unk_0xC1A74225341AA9FB(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 0, 16);
							}
						}
						else if (!func_38(uLocal_221[iVar0], -1794415470, 1))
						{
							unk_0xB486640392EC50BB(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
						}
						if (!unk_0x55A0C756C4A8220C(uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
						{
							if (!func_38(uLocal_221[iVar0], 780511057, 1))
							{
								unk_0xC1A74225341AA9FB(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 0, 16);
					...
					{
						unk_0xBBA695AD5315CDD8(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 1101004800);
					}
					break;
					...
					if (unk_0xD5C6B5E3B93A5EDC(uLocal_221[iVar0], 0))
					{
						if (iLocal_215 == iVar0)
						{
							if (func_46(uLocal_221[iVar0], 0) != -1)
							{
								...
								{
									unk_0x8625186D3A8DDD7A(uLocal_221[iVar0], unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0), 0);
								}
							}
							else if (!func_38(uLocal_221[iVar0], -1273030092, 1) || iLocal_215 != iLocal_216)
							{
								unk_0xB69D13E19147910F(uLocal_221[iVar0], unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0), unk_0xE2D3D51028F0428A(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (unk_0x174CED88B97C78D9(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!unk_0x99D3BE8C39BA34FF(uLocal_221[iVar0]))
								{
									unk_0x0E6C3A4EFA9D9D35(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
								}
							}
						}
						else if (func_46(uLocal_221[iVar0], 0) == -1)
						{
							...
							{
								unk_0xDBEE353C7CA6E88E(uLocal_221[iVar0], unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0), unk_0xB3FF0049C1FD38EC(uLocal_221[iLocal_215], 0), -1, 40f, 786468, -1082130432, 20, 1101004800);
							}
							else if (unk_0x174CED88B97C78D9(uLocal_221[iVar0], -1273030092) == 1)
							{
								if (!unk_0x99D3BE8C39BA34FF(uLocal_221[iVar0]))
						...
						{
							iVar11 = unk_0xAB793EA186AB8DAA(unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0), -1, 0);
							if (!unk_0xE5965CDF24F93A9F(iVar11) || unk_0xF68107C40359970C(iVar11))
							{
								if (!func_38(uLocal_221[iVar0], 355471868, 1))
								{
									unk_0x8625186D3A8DDD7A(uLocal_221[iVar0], unk_0xB3FF0049C1FD38EC(uLocal_221[iVar0], 0), 0);
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar12 = func_36();
				if (iVar12 != -1 && !unk_0xB6F46ABD140050F1(uLocal_221[iVar12]))
				{
		...
		case 4:
			if (func_37() && (unk_0x320D1840B6DAA1CC() - iLocal_212) > 1000)
			{
				...
				if (iVar12 != -1 && !unk_0xB6F46ABD140050F1(uLocal_221[iVar12]))
				{
					if (unk_0xD5C6B5E3B93A5EDC(uLocal_221[iVar12], 0))
					{
...
void func_54()
{
	...
	{
		case 0:
			func_60(&uLocal_46, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_60(&uLocal_46, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_60(&uLocal_46, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
			break;
	}
	...
	unk_0xD642E010A287ADFD("relGang", &iLocal_224);
	unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_224);
	unk_0x9972EFADA7A2A47D(5, iLocal_224, 1862763509);
	unk_0x9972EFADA7A2A47D(5, iLocal_224, joaat("COP"));
	switch (iVar0)
	{
		case 0:
			unk_0x9972EFADA7A2A47D(5, 1862763509, 296331235);
			unk_0x9972EFADA7A2A47D(1, iLocal_224, 296331235);
			unk_0x9972EFADA7A2A47D(1, 296331235, iLocal_224);
			break;
		
		case 1:
			unk_0x9972EFADA7A2A47D(5, 1862763509, -1033021910);
			unk_0x9972EFADA7A2A47D(1, iLocal_224, -1033021910);
			unk_0x9972EFADA7A2A47D(1, -1033021910, iLocal_224);
			break;
		
		case 2:
			unk_0x9972EFADA7A2A47D(5, 1862763509, 1782292358);
			unk_0x9972EFADA7A2A47D(1, iLocal_224, 1782292358);
			unk_0x9972EFADA7A2A47D(1, 1782292358, iLocal_224);
			break;
	}
}
...
void func_61()
{
	...
	while (iVar0 <= 5)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_221[iVar0]))
		{
			if (!unk_0xF68107C40359970C(uLocal_221[iVar0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				unk_0x7734082B0EDB0BE0(uLocal_221[iVar0], unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 1);
			}
			unk_0xB3822DB3D538C8F3(&(uLocal_221[iVar0]));
		}
		if (unk_0x12DD4A0B247D9B4D(uLocal_223[iVar0]))
		{
			unk_0xFFD8EB5462B07B59(&(uLocal_223[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		if (unk_0xE5965CDF24F93A9F(uLocal_220[iVar0]))
		{
			unk_0x3D81769BEC61BFF8(&(uLocal_220[iVar0]));
		}
		iVar0++;
	}
	unk_0x269268AD5D4CA266(iLocal_225, 0);
	unk_0x7CD708DEB04F8474(iLocal_226, 0);
