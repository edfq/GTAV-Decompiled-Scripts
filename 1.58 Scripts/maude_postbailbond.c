...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			...
			Var1 = { unk_0x6B62510F212526DC(uLocal_42, 1) };
			...
			switch (iLocal_47)
			{
				...
				case 2:
					if (!func_4(iLocal_42, 1805844857) && !unk_0x51B334B227EC8042(iLocal_42))
					{
						if (!unk_0xFCF559C8631ABED7(iLocal_42, func_11(), func_3(), 3))
						{
							func_1();
						}
					}
...
void func_1()
{
	...
	{
		func_2(&iLocal_42);
		unk_0x7734082B0EDB0BE0(iLocal_42, unk_0xE2D3D51028F0428A(), 10000f, -1, 0, 0);
		unk_0xABC2CA6F28903308(iLocal_42, 1);
	}
}
...
void func_12(struct<3> Param0, struct<3> Param1)
{
	if (func_51(iLocal_42))
	{
		if (!unk_0xB6F46ABD140050F1(iLocal_42))
		{
...
void func_16(bool bParam0)
{
	...
	if (func_23())
	{
		Var0 = { func_22() };
		uVar1 = func_21();
		if (unk_0x3C57C2F07FEE34D2(&Var0, uVar1))
		{
			if (bParam0)
			{
				func_19();
...
void func_24()
{
	if (unk_0xE5965CDF24F93A9F(uLocal_41))
	{
		unk_0x5C65DDDC219B3AA5(iLocal_41, 0);
	}
	if (unk_0xE5965CDF24F93A9F(uLocal_40))
	{
		unk_0x5C65DDDC219B3AA5(iLocal_40, 0);
	}
}
...
int func_25(var uParam0, bool bParam1)
{
	if (func_51(*uParam0))
	{
		...
		if (unk_0x174B84F6B78D6CA7(unk_0xE2D3D51028F0428A()))
		{
			...
			{
				if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_39))
				{
					return 1;
				}
			}
			...
			{
				if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_40))
				{
					return 1;
				}
			}
			...
			{
				if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_41))
				{
					return 1;
				}
			}
...
int func_29(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_31(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_43(struct<3> Param0, struct<3> Param1, int iParam2, float fParam3)
{
	...
	if (iLocal_44 < iLocal_45)
	{
		if (!func_23())
		{
			...
			{
				if (unk_0x320D1840B6DAA1CC() - iLocal_43) > (iParam2 + unk_0x5853B15F78E1A265(0, 2000))
				{
					uVar0 = 16;
...
void func_50()
{
	...
	if (func_51(iLocal_42))
	{
		if (!unk_0xA6A089369417736E(iLocal_42))
		{
			unk_0x2D58A6131679D82C(iLocal_42, 1, 0);
		}
		unk_0x50274A7EACA3133A(iLocal_42, 1);
		unk_0x62BDDA84CCCF90A9(iLocal_42, 0);
		unk_0xA7266A50941DBAEA(iLocal_42, 0);
		unk_0xFF4BEB6CFF55A013(iLocal_42, 1862763509);
		unk_0xCACF57AD414ACC75(iLocal_42, 0);
		unk_0x91D9C55E11392690(iLocal_42, 0);
		unk_0xD6A76BAB45A4B460(iLocal_42, 118, 0);
		Var0 = { 2728.33f, 4145.6f, 43.89f };
		if (unk_0x574E2A23F0F76E35(Var0, 10f, joaat("prop_table_03b"), 0))
		{
			iLocal_40 = unk_0x87A467676BDF8C35(Var0, 10f, joaat("prop_table_03b"), 1, 0, 1);
			if (func_8(iLocal_40))
			{
				unk_0xC64B6E13A6A7F517(iLocal_40, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(iLocal_40, -92.17f);
				unk_0x5C65DDDC219B3AA5(iLocal_40, 1);
			}
		}
		if (unk_0x574E2A23F0F76E35(Var0, 10f, joaat("prop_laptop_01a"), 0))
		{
			iLocal_41 = unk_0x87A467676BDF8C35(Var0, 10f, joaat("prop_laptop_01a"), 0, 0, 1);
			if (func_8(iLocal_41))
			{
				if (!unk_0xA6A089369417736E(iLocal_41))
				{
					unk_0x2D58A6131679D82C(iLocal_41, 1, 0);
				}
				unk_0xC64B6E13A6A7F517(iLocal_41, 2727.686f, 4145.715f, 44.08f, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(iLocal_41, 71f);
				unk_0x5C65DDDC219B3AA5(iLocal_41, 1);
			}
		}
		if (unk_0x574E2A23F0F76E35(Var0, 10f, joaat("prop_table_03_chr"), 0))
		{
			iLocal_39 = unk_0x87A467676BDF8C35(Var0, 10f, joaat("prop_table_03_chr"), 0, 0, 1);
			if (func_8(iLocal_39))
			{
				if (!unk_0xA6A089369417736E(iLocal_39))
				{
					unk_0x2D58A6131679D82C(iLocal_39, 1, 0);
				}
				unk_0xC64B6E13A6A7F517(iLocal_39, 2728.35f, 4145.59f, 43.3f, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(iLocal_39, -91.28f);
			}
		}
	}
}
...
void func_56()
{
	...
	if (func_8(iLocal_39))
	{
		unk_0x5C65DDDC219B3AA5(iLocal_39, 0);
		if (unk_0xFCF559C8631ABED7(iLocal_39, "special_ped@maude@base", "base_chair", 3))
		{
			unk_0xA02157241423F32E(iLocal_39, "base_chair", "special_ped@maude@base", -1000f);
			unk_0xA5D8BA53953077C8(iLocal_39, -1000f, 1);
		}
		else if (unk_0xFCF559C8631ABED7(iLocal_39, func_11(), "Female_Flee_Table_Left_Maude_Chair", 3))
		{
			unk_0xA02157241423F32E(iLocal_39, "Female_Flee_Table_Left_Maude_Chair", func_11(), -1000f);
			unk_0xA5D8BA53953077C8(iLocal_39, -1000f, 1);
		}
	}
	func_58(&iLocal_39, 0);
	...
	{
		unk_0xABC2CA6F28903308(iLocal_42, 1);
		unk_0xD6A76BAB45A4B460(iLocal_42, 118, 1);
	}
