	...
	if (unk_0x0152AA00FA3130F1(iParam0))
	{
		if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_68))
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_68, 0))
				{
					if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_68, 0))
					{
						...
						fVar1 = unk_0x82FE2343F8BDFF0B(iLocal_68);
			...
			if (!bVar2)
			{
				...
				fVar1 = (unk_0x82FE2343F8BDFF0B(unk_0xE2D3D51028F0428A()) + 90f);
			}
			if (func_18(iParam0, Var0, fVar1))
			{
				iLocal_68 = unk_0xBA715A7BEBA5A1F9(iParam0, Var0, fVar1, 0, 1, 0);
...
int func_18(int iParam0, struct<3> Param1, float fParam2)
{
	...
	unk_0xB38EF75835FAF667(iParam0, &Var1, &Var2);
	Var3.x = (unk_0x48053974ED6F63CE((Var2.x - Var1.x)) / 2f);
	Var3.f_1 = (unk_0x48053974ED6F63CE((Var2.f_1 - Var1.f_1)) / 2f);
	Var3.f_2 = (unk_0x48053974ED6F63CE((Var2.f_2 - Var1.f_2)) / 2f);
	Var0[0 /*3*/] = { Param1 };
	Var0[1 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, -Var3.x, -Var3.f_1, -Var3.f_2) };
	Var0[2 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, Var3.x, -Var3.f_1, -Var3.f_2) };
	Var0[3 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, Var3.x, Var3.f_1, -Var3.f_2) };
	Var0[4 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, -Var3.x, Var3.f_1, -Var3.f_2) };
	Var0[5 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, -Var3.x, -Var3.f_1, Var3.f_2) };
	Var0[6 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, Var3.x, -Var3.f_1, Var3.f_2) };
	Var0[7 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, Var3.x, Var3.f_1, Var3.f_2) };
	Var0[8 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam2, -Var3.x, Var3.f_1, Var3.f_2) };
	if (!unk_0x15616E8442D3D1E8(Param1))
	{
		return 0;
	}
	uVar13 = unk_0x53DFE85FC69724BD(func_19(unk_0x9E2D6C50374FCFA9()) + Vector(1f, 0f, 0f), Param1, 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar13, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar7 = unk_0x53DFE85FC69724BD(Var0[1 /*3*/], Var0[3 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar7, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar8 = unk_0x53DFE85FC69724BD(Var0[2 /*3*/], Var0[4 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar8, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar9 = unk_0x53DFE85FC69724BD(Var0[5 /*3*/], Var0[7 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar9, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar10 = unk_0x53DFE85FC69724BD(Var0[6 /*3*/], Var0[8 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar10, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar11 = unk_0x53DFE85FC69724BD(Var0[1 /*3*/], Var0[8 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar11, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
	uVar12 = unk_0x53DFE85FC69724BD(Var0[2 /*3*/], Var0[7 /*3*/], 87, unk_0xE2D3D51028F0428A(), 0);
	unk_0xB2D581BD7446BBE9(uVar12, &iVar6, &uVar4, &uVar5, &uVar14);
	if (iVar6 != 0)
	{
		return 0;
	}
...
void func_36()
{
	...
	switch (iLocal_64)
	{
		...
		case 2:
			...
			uVar1 = unk_0x82FE2343F8BDFF0B(unk_0xE2D3D51028F0428A());
			unk_0x9CD4CBF2BBE10F00(Var0, &fVar2, 0, 0);
			fVar2 = (fVar2 + 500f);
			unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Var0.x, Var0.f_1, fVar2, 1, 0, 0, 1);
...
void func_110()
{
	if (func_15(14) || (!unk_0xE9E8955A780DDA01() && iLocal_84 != 0))
	{
	...
	if (iLocal_84 != 0)
	{
		if (!func_15(14))
		{
			if ((unk_0x320D1840B6DAA1CC() - iLocal_84) > 1000)
			{
				iLocal_84 = 0;
			}
		}
