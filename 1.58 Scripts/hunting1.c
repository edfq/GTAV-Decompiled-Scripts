...
void __EntryFunction__()
{
	...
	uLocal_80 = unk_0xB8DEE91181C30E65(joaat("weapon_sniperrifle"));
	uLocal_81 = unk_0x2597F123290B0413(joaat("component_at_scope_large"));
	uLocal_82 = unk_0x2597F123290B0413(joaat("component_at_ar_supp_02"));
	...
	func_515(25);
	func_514();
	func_513(&uLocal_89, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
...
void func_1()
{
	switch (iLocal_257)
	{
		case 0:
			...
			func_7();
			if (unk_0xACC32B78196FBC2A(sLocal_352))
			{
				func_541(1);
			}
			else
...
void func_14()
{
	...
	{
		func_16(13, floor(Global_112915.f_10194.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77663[1 /*14*/] = { func_90(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xE2D0C323A1AE5D85(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_90(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_90(iVar10, 14, uVar15[iVar1], -1) };
			func_58(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_73(14);
			if (Global_77661 == 1)
			{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_82(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_77663[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				Global_2883589 = Var5;
				func_93(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, unk_0x036D1EA7243F2CCC(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			Global_2883589 = Var9;
			func_93(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, unk_0x036D1EA7243F2CCC(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_82(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&uVar1, Var0.f_3, Global_100011, iParam1, iParam2);
	}
}
...
void func_224()
{
	if (iLocal_274)
	{
		...
		unk_0xB003193C68661C8D(unk_0xE2D3D51028F0428A(), joaat("AMMO_SNIPER"), uLocal_337);
	}
	else
	{
		...
		case 1:
			if (unk_0xA829C9A2767AC8EF())
			{
				...
				if (func_308(unk_0xE2D3D51028F0428A()))
				{
					...
					if (!func_212())
					{
						func_229(unk_0xE2D3D51028F0428A(), Local_415, fLocal_416, 0, 1);
					}
					if (func_308(iLocal_348))
					{
						unk_0xF30F15F203736DE4(unk_0xE2D3D51028F0428A(), iLocal_348, -1, 0, 2);
					}
					func_228(1);
					func_226(0);
				}
...
void func_226(bool bParam0)
{
	if (func_308(iLocal_348))
	{
		if (bParam0)
		{
			...
			{
				if (!unk_0x2F52E009BBC0AFCE(iLocal_348, func_227()))
				{
					unk_0x03A927199A2DFE46(iLocal_348);
					unk_0xF23E6F5690771F71(iLocal_348, func_227());
					unk_0x508EA490C0230199(iLocal_348, 1);
					unk_0x5C65DDDC219B3AA5(iLocal_348, 0);
				}
			}
		}
		else if (unk_0x2F52E009BBC0AFCE(iLocal_348, func_227()))
		{
			unk_0x03A927199A2DFE46(iLocal_348);
			unk_0x6221A52631154EF7(iLocal_348);
		}
	}
}
...
void func_231(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_209(unk_0x05CBA41180F5D521(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_302(&(Global_99974.f_3));
				if (iVar6 > -1)
				{
...
void func_257(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x75BACF95335672B8(iVar5, &Var7) && !func_259(Var7.f_1)) && iVar9 < 51)
			{
...
{
	return (shift_right(iParam0, 26) & 31 * func_297(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_310()
{
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_365, Local_366, 20f, 0, 1, 0))
			{
				func_321();
				if (iLocal_301[17])
				{
...
void func_311()
{
	...
	while (iVar3 < 4)
	{
		if (unk_0x91194F9AB8BA4E66(iVar2[iVar3], Var0[iVar3 /*3*/], 1))
		{
			uLocal_425[iVar3] = unk_0xBA715A7BEBA5A1F9(iVar2[iVar3], Var0[iVar3 /*3*/], fVar1[iVar3], 1, 1, 0);
		}
		iVar3++;
	}
	if (((func_230(uLocal_425[0]) && func_230(uLocal_425[1])) && func_230(uLocal_425[2])) && func_230(uLocal_425[3]))
	{
		func_312();
	}
}
...
void func_312()
{
	...
	unk_0xF1A23B343DFEDFD0(iLocal_344);
}
...
void func_314(bool bParam0, int iParam1)
{
	...
	if (unk_0x12DD4A0B247D9B4D(iLocal_263))
	{
		if (!bParam0)
		{
			unk_0x293A9399E902A33B(iLocal_263, 0.75f);
		}
		unk_0x9705014C37E60003(iLocal_263, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_308(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						Local_421[iVar0 /*3*/] = { unk_0x6B62510F212526DC(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_303[iVar0] = 1;
						Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_260[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!unk_0x55B23FE400FCEA6B(Local_260[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_260[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_329 = 1;
							}
							else if (!unk_0x55B23FE400FCEA6B(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (unk_0x9AC74C7EF847A074(unk_0x6B62510F212526DC(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
					...
					while (iLocal_330 < 3)
					{
						...
						{
							Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14 = { unk_0x6B62510F212526DC(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 1) };
							Local_260[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_260[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_330 < 3)
					{
						if ((unk_0xE5965CDF24F93A9F(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0)) && !unk_0xF68107C40359970C(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						...
						{
							if (unk_0xE5965CDF24F93A9F(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0))
							{
								unk_0x9603C0EC536C6425(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, Local_421[iVar0 /*3*/], unk_0xC4EAB25A108C2429(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			unk_0x963E9AB0C31726BD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(3000, 8000));
		...
		case 4:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0x320D1840B6DAA1CC() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 = unk_0x5853B15F78E1A265(0, 8);
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						unk_0x7D1424753688EE7A(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, unk_0xC4EAB25A108C2429(0f, 359.9f));
					}
					else if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
					{
						unk_0x6FCE069E4940878C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && unk_0x8F41785F110B0DA0(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							unk_0x03A927199A2DFE46(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
							unk_0x5315F7AC22DC95F1(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					unk_0x84918839A90C954C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					unk_0x84918839A90C954C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				unk_0xABC2CA6F28903308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
		...
		case 12:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					...
					{
						unk_0x9603C0EC536C6425(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], unk_0xC4EAB25A108C2429(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
				{
					unk_0x6FCE069E4940878C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
				...
				unk_0xE68645525D451A8B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
float func_325(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
{
	if ((((unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_365, Local_366, 20f, 0, 1, 0) && unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3)
	{
		if (!unk_0x12DD4A0B247D9B4D(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/] = func_315(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (unk_0x12DD4A0B247D9B4D(Local_260[iParam0 /*54*/][iParam1 /*17*/]))
			{
				unk_0x293A9399E902A33B(Local_260[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!unk_0x55B23FE400FCEA6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				unk_0xFEF687AF74EEDCC2(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			}
		}
	}
	else
...
void func_346(int iParam0, int iParam1)
{
	...
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0xA8D58C3AADA2C41C(26, iLocal_341, Var0, unk_0xC4EAB25A108C2429(0f, 359.9f), 1, 1);
		if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			unk_0xF160248D9083ED0C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			unk_0x50274A7EACA3133A(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5 = unk_0xC4EAB25A108C2429(0f, 359.9f);
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0xA8D58C3AADA2C41C(26, iLocal_341, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (unk_0xE5965CDF24F93A9F(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				unk_0xF160248D9083ED0C(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				unk_0x50274A7EACA3133A(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
void func_348(int iParam0, int iParam1)
{
	if (func_349())
	{
		unk_0x979FC7400A5D0CD2(-1, "COYOTE_BARK_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		unk_0x979FC7400A5D0CD2(-1, "COYOTE_CRY_MASTER", Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0xA829C9A2767AC8EF())
			{
				...
				if (!func_212())
				{
					func_229(unk_0xE2D3D51028F0428A(), Local_377, fLocal_378, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x12DD4A0B247D9B4D(Local_258[iVar0 /*10*/].f_9))
		{
			unk_0xFFD8EB5462B07B59(&(Local_258[iVar0 /*10*/].f_9));
		}
	...
	if (iLocal_271)
	{
		unk_0xF1A23B343DFEDFD0(iLocal_340);
	}
}
...
void func_359()
{
	...
	unk_0xD69A0C3662175E68(iLocal_344);
	while (!unk_0x0152AA00FA3130F1(iLocal_343) || !unk_0x0152AA00FA3130F1(iLocal_344))
	{
		wait(0);
	}
}
...
int func_361()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_348) && !unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
	{
		if (!unk_0x77A43AFA9AAEC041(iLocal_348, unk_0xE2D3D51028F0428A(), Local_367, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_363()
{
	...
	func_364();
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_413, Local_414, 3.5f, 0, 1, 0) || iLocal_301[16])
	{
		func_358();
		func_351();
		iLocal_254 = 15;
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_378(iVar0);
			if (unk_0xE5965CDF24F93A9F(Local_259[iVar0 /*29*/].f_28))
			{
				if (!unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_363, Local_364, 10f, 0, 1, 0))
				{
					if (!bLocal_289)
					{
						if (unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
						{
							bLocal_289 = true;
							func_318(6);
						}
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_259[iVar0 /*29*/].f_7 = unk_0x5853B15F78E1A265(0, 5);
				if ((!unk_0x34FAA537D539192C(Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_319 < 3) && unk_0x91194F9AB8BA4E66(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, 1))
				{
					Local_259[iVar0 /*29*/].f_28 = unk_0xBA715A7BEBA5A1F9(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, Local_259[iVar0 /*29*/].f_4, 1, 1, 0);
					if (unk_0xE5965CDF24F93A9F(Local_259[iVar0 /*29*/].f_28) && !unk_0x55B23FE400FCEA6B(Local_259[iVar0 /*29*/].f_28, 0))
					{
						unk_0x0407CF7EFEE35240(Local_259[iVar0 /*29*/].f_28, 1);
						unk_0xAFE1B52F0DE91595(Local_259[iVar0 /*29*/].f_28, 1);
						Local_259[iVar0 /*29*/].f_7 = unk_0x5853B15F78E1A265(0, 5);
						Local_259[iVar0 /*29*/].f_12 = unk_0x487C17B41938052C(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
						if (unk_0xE5965CDF24F93A9F(Local_259[iVar0 /*29*/].f_12))
						{
							Local_259[iVar0 /*29*/].f_11 = unk_0x0E536D72AB30F4C8(iLocal_345, Local_259[iVar0 /*29*/].f_16, 1, 1, 0);
							if (unk_0xE5965CDF24F93A9F(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x9A97DC6DBC7B223D(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, unk_0xB897FCFCFA664B38(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								unk_0x1C2ED929474DC6FE(Local_259[iVar0 /*29*/].f_11, 0, 0);
								unk_0x006574E87E6F1942(Local_259[iVar0 /*29*/].f_12, 1, 1);
								unk_0x0407CF7EFEE35240(Local_259[iVar0 /*29*/].f_12, 1);
								Local_259[iVar0 /*29*/].f_2 = 0;
								Local_259[iVar0 /*29*/].f_1 = 0;
								Local_259[iVar0 /*29*/].f_3 = 0;
								unk_0x50274A7EACA3133A(Local_259[iVar0 /*29*/].f_12, 1);
								unk_0x3B8F94419979A0B1(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_319++;
			...
			case 4:
				...
				{
					if (!unk_0x8F41785F110B0DA0(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
							...
							if (func_324(Local_259[iVar0 /*29*/].f_28))
							{
								if (func_375(iVar0))
								{
									if (!Local_259[iVar0 /*29*/].f_1)
									{
										...
										func_374(iVar0);
										unk_0xE68645525D451A8B(Local_259[iVar0 /*29*/].f_28);
						...
						{
							if (unk_0x9AC74C7EF847A074(unk_0x6B62510F212526DC(Local_259[iVar0 /*29*/].f_28, 1), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
					...
					{
						unk_0x03A927199A2DFE46(Local_259[iVar0 /*29*/].f_12);
						unk_0xAFE1B52F0DE91595(Local_259[iVar0 /*29*/].f_28, 0);
						unk_0xAD6CDBCDA713560A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
						unk_0xABC2CA6F28903308(Local_259[iVar0 /*29*/].f_12, 1);
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					...
					{
						unk_0x5B7AF57D366861F2(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Var1, unk_0x82FE2343F8BDFF0B(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						unk_0xCD41D6F721CB9C3A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						unk_0xCD41D6F721CB9C3A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_259[iVar0 /*29*/].f_28) && func_308(Local_259[iVar0 /*29*/].f_12)) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					if (unk_0xA7A8E89EA6C5E222(Local_259[iVar0 /*29*/].f_28))
					{
						unk_0x03A927199A2DFE46(Local_259[iVar0 /*29*/].f_12);
						unk_0x50274A7EACA3133A(Local_259[iVar0 /*29*/].f_12, 1);
						if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
							unk_0x02F1CAAC7CB77E47(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 7:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					if (!unk_0xD5C6B5E3B93A5EDC(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
					...
					else if (unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1)) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					Var2 = { unk_0x6B62510F212526DC(Local_259[iVar0 /*29*/].f_12, 1) };
					if (!unk_0xD5C6B5E3B93A5EDC(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) && !unk_0x9AC74C7EF847A074(Var2, 3f, 1))
						{
							Local_259[iVar0 /*29*/].f_25 = { unk_0xCACAD935C0BEE14F(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_22) };
							Local_259[iVar0 /*29*/].f_6 = (unk_0x82FE2343F8BDFF0B(Local_259[iVar0 /*29*/].f_28) + Local_259[iVar0 /*29*/].f_5);
							unk_0x03A927199A2DFE46(Local_259[iVar0 /*29*/].f_12);
							unk_0x50274A7EACA3133A(Local_259[iVar0 /*29*/].f_12, 1);
							unk_0x7D1424753688EE7A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_259[iVar0 /*29*/].f_6);
			...
			case 9:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					...
					if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) && !unk_0x9AC74C7EF847A074(Var2, 3f, 1))
					{
						if (unk_0x8F41785F110B0DA0(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							unk_0x03A927199A2DFE46(Local_259[iVar0 /*29*/].f_12);
							unk_0x50274A7EACA3133A(Local_259[iVar0 /*29*/].f_12, 1);
							unk_0x529D306014D3C29A(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					...
					if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) && !unk_0x9AC74C7EF847A074(Var2, 3f, 1))
					{
						Local_259[iVar0 /*29*/].f_15 = unk_0x174CED88B97C78D9(Local_259[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					...
					if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) && !unk_0x9AC74C7EF847A074(Var2, 3f, 1))
					{
						unk_0xA888F8CC04F25CC8(&(Local_259[iVar0 /*29*/].f_14));
						...
						unk_0xC963A45B50851768(Local_259[iVar0 /*29*/].f_14);
						unk_0x8ACADA903FCAA42F(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_14);
						unk_0x7461D7C5BA953BC7(&(Local_259[iVar0 /*29*/].f_14));
						Local_259[iVar0 /*29*/].f_8 = unk_0x320D1840B6DAA1CC() + 20000;
			...
			case 12:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					...
					if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1) && !unk_0x9AC74C7EF847A074(Var2, 3f, 1))
					{
						if (unk_0x320D1840B6DAA1CC() > Local_259[iVar0 /*29*/].f_8)
						{
							if (unk_0x2B5F4FBAF644BEC8(Local_259[iVar0 /*29*/].f_11))
							{
								unk_0x1C2ED929474DC6FE(Local_259[iVar0 /*29*/].f_11, 0, 0);
							}
							else
						...
						else if (unk_0xFCF559C8631ABED7(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !unk_0x2B5F4FBAF644BEC8(Local_259[iVar0 /*29*/].f_11))
						{
							unk_0x1C2ED929474DC6FE(Local_259[iVar0 /*29*/].f_11, 1, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!unk_0x0747E45CFF1F74AA(Local_259[iVar0 /*29*/].f_28, unk_0xE2D3D51028F0428A(), 1))
				{
					if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(Local_259[iVar0 /*29*/].f_28, 0), unk_0x6B62510F212526DC(Local_259[iVar0 /*29*/].f_12, 1), 0) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (unk_0xE5965CDF24F93A9F(Local_259[iVar0 /*29*/].f_12))
				{
					if (!unk_0x55B23FE400FCEA6B(Local_259[iVar0 /*29*/].f_12, 0))
					{
						unk_0xABC2CA6F28903308(Local_259[iVar0 /*29*/].f_12, 1);
					}
		...
		{
			if (unk_0x987A5F1E1A67E3C0(Local_376, unk_0x6B62510F212526DC(Local_259[iVar0 /*29*/].f_28, 1), 1) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			...
			unk_0xA888F8CC04F25CC8(&(Local_259[iParam0 /*29*/].f_14));
			unk_0xB486640392EC50BB(0, Local_259[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			unk_0xAD6CDBCDA713560A(0, Local_259[iParam0 /*29*/].f_28, 60f, 786468);
			unk_0xC963A45B50851768(Local_259[iParam0 /*29*/].f_14);
			unk_0x8ACADA903FCAA42F(iVar0, Local_259[iParam0 /*29*/].f_14);
			unk_0xABC2CA6F28903308(iVar0, 1);
			unk_0x7461D7C5BA953BC7(&(Local_259[iParam0 /*29*/].f_14));
		}
...
Vector3 func_368(int iParam0)
{
	...
	if (func_377(iParam0))
	{
		...
		if (unk_0xDFCBBD9528DC1828(Var0, &Var1, 1, 1077936128, 0))
		{
			if (unk_0xE245E7DA125485EC(Var1, 0, &Var1))
			{
				if (!unk_0x34FAA537D539192C(Var1, 2f) && !unk_0x2D3CDDF3FE35FCA6(Var1, 2f, 0))
				{
					return Var1;
				}
			}
...
void func_369(int iParam0)
{
	...
	{
		unk_0x03A927199A2DFE46(Local_259[iParam0 /*29*/].f_12);
		unk_0x50274A7EACA3133A(Local_259[iParam0 /*29*/].f_12, 1);
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			if (unk_0xF6F5D18EF8EAB859(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, 0))
			{
				unk_0x3B8F94419979A0B1(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, Local_259[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_259[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				unk_0x84918839A90C954C(Local_259[iParam0 /*29*/].f_12, Local_358, 10000f, -1, 0, 0);
				Local_259[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_259[iParam0 /*29*/].f_2 = 1;
		unk_0xABC2CA6F28903308(Local_259[iParam0 /*29*/].f_12, 1);
	}
	else
	{
...
void func_370()
{
	if (!iLocal_278)
	{
		if (func_349())
		{
			iLocal_318 = unk_0x320D1840B6DAA1CC() + 1000;
			iLocal_278 = 1;
		}
	}
	else if (unk_0x320D1840B6DAA1CC() > iLocal_318)
	{
...
int func_372()
{
	...
	if (func_308(unk_0xE2D3D51028F0428A()))
	{
		...
		if (func_308(iLocal_348))
		{
			Var1 = { unk_0x6B62510F212526DC(iLocal_348, 1) };
			if (func_373(unk_0xE2D3D51028F0428A(), iLocal_348, 0) <= 10f && unk_0x48053974ED6F63CE((Var0.f_2 - Var1.f_2)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!unk_0x55B23FE400FCEA6B(Local_259[iParam0 /*29*/].f_28, 0))
	{
		unk_0xFEF687AF74EEDCC2(Local_259[iParam0 /*29*/].f_28, 0);
	}
...
{
	if (unk_0xE5965CDF24F93A9F(Local_259[iParam0 /*29*/].f_28) && !unk_0x55B23FE400FCEA6B(Local_259[iParam0 /*29*/].f_28, 0))
	{
		if (unk_0xB4C63F21D1DC6C23(Local_259[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xB4C63F21D1DC6C23(Local_259[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0xB4C63F21D1DC6C23(Local_259[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (unk_0xB4C63F21D1DC6C23(Local_259[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (unk_0xE5965CDF24F93A9F(Local_259[iParam0 /*29*/].f_12))
	{
		if (unk_0x55B23FE400FCEA6B(Local_259[iParam0 /*29*/].f_12, 0) || !unk_0x55B23FE400FCEA6B(Local_259[iParam0 /*29*/].f_12, 0))
		{
			if (unk_0x0747E45CFF1F74AA(Local_259[iParam0 /*29*/].f_12, unk_0xE2D3D51028F0428A(), 1))
			{
				func_369(iParam0);
			}
		}
...
void func_381()
{
	if (bLocal_292)
	{
		unk_0xF1A23B343DFEDFD0(Local_259[0 /*29*/].f_9);
		unk_0xF1A23B343DFEDFD0(Local_259[1 /*29*/].f_9);
		unk_0xF1A23B343DFEDFD0(Local_259[2 /*29*/].f_9);
		unk_0xF1A23B343DFEDFD0(Local_259[3 /*29*/].f_9);
		unk_0xF1A23B343DFEDFD0(Local_259[4 /*29*/].f_9);
		unk_0xF1A23B343DFEDFD0(Local_259[0 /*29*/].f_10);
		unk_0xF1A23B343DFEDFD0(Local_259[1 /*29*/].f_10);
		unk_0xF1A23B343DFEDFD0(Local_259[2 /*29*/].f_10);
		unk_0xF1A23B343DFEDFD0(Local_259[3 /*29*/].f_10);
		unk_0xF1A23B343DFEDFD0(Local_259[4 /*29*/].f_10);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0xA829C9A2767AC8EF())
			{
				...
				iLocal_255 = 13;
				unk_0x02B222EADC9DC566(Local_376, 50f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x02B222EADC9DC566(Local_374, 50f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x02B222EADC9DC566(Local_375, 50f, 0, 0, 0, 0, 0, 0, 0);
				unk_0x51BB443B279E4104(unk_0xE2D3D51028F0428A());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(unk_0xE2D3D51028F0428A(), Local_358, fLocal_305, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
{
	func_387();
	unk_0xD69A0C3662175E68(Local_259[0 /*29*/].f_9);
	unk_0xD69A0C3662175E68(Local_259[1 /*29*/].f_9);
	unk_0xD69A0C3662175E68(Local_259[2 /*29*/].f_9);
	unk_0xD69A0C3662175E68(Local_259[3 /*29*/].f_9);
	unk_0xD69A0C3662175E68(Local_259[4 /*29*/].f_9);
	unk_0xD69A0C3662175E68(Local_259[0 /*29*/].f_10);
	unk_0xD69A0C3662175E68(Local_259[1 /*29*/].f_10);
	unk_0xD69A0C3662175E68(Local_259[2 /*29*/].f_10);
	unk_0xD69A0C3662175E68(Local_259[3 /*29*/].f_10);
	unk_0xD69A0C3662175E68(Local_259[4 /*29*/].f_10);
	unk_0xD69A0C3662175E68(iLocal_345);
	while ((((((((((!unk_0x0152AA00FA3130F1(Local_259[0 /*29*/].f_9) || !unk_0x0152AA00FA3130F1(Local_259[1 /*29*/].f_9)) || !unk_0x0152AA00FA3130F1(Local_259[2 /*29*/].f_9)) || !unk_0x0152AA00FA3130F1(Local_259[3 /*29*/].f_9)) || !unk_0x0152AA00FA3130F1(Local_259[4 /*29*/].f_9)) || !unk_0x0152AA00FA3130F1(Local_259[0 /*29*/].f_10)) || !unk_0x0152AA00FA3130F1(Local_259[1 /*29*/].f_10)) || !unk_0x0152AA00FA3130F1(Local_259[2 /*29*/].f_10)) || !unk_0x0152AA00FA3130F1(Local_259[3 /*29*/].f_10)) || !unk_0x0152AA00FA3130F1(Local_259[4 /*29*/].f_10)) || !unk_0x0152AA00FA3130F1(iLocal_345))
	{
		wait(0);
	}
	bLocal_292 = true;
...
void func_389()
{
	...
	unk_0x8E21C2B8D76BD2C7(Local_359, fLocal_315);
	unk_0x8E21C2B8D76BD2C7(Local_360, fLocal_315);
	unk_0x6B81DF75FA671549(0f);
	unk_0x17F3D11FEC5656C2(0f, 0f);
	if (unk_0x2B1D7439C26D5642() == 4)
	{
...
void func_390()
{
	if (!unk_0xF68107C40359970C(iLocal_348) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (!bLocal_283)
		{
			if (!unk_0x77A43AFA9AAEC041(iLocal_348, unk_0xE2D3D51028F0428A(), Local_384, 0, 1, 0) || unk_0x6D7EE245AD1E10B0(unk_0xE2D3D51028F0428A()) != 0)
			{
				if (!unk_0x0208598D19E7A49F(iLocal_348))
				{
					bLocal_283 = true;
				}
			}
		}
		else if (unk_0x77A43AFA9AAEC041(iLocal_348, unk_0xE2D3D51028F0428A(), Local_385, 0, 1, 0) && unk_0x6D7EE245AD1E10B0(unk_0xE2D3D51028F0428A()) == 0)
		{
...
void func_393()
{
	...
	if (!iLocal_293)
	{
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_357, 50f, 50f, 50f, 0, 1, 0))
		{
			func_395();
			iLocal_293 = 1;
		}
	...
	if (!bLocal_283)
	{
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_357, 5f, 5f, 5f, 0, 1, 0) && func_394(1077936128, 1))
		{
			unk_0x84A65E2E9CFB6A77(Local_374, Local_375, 0, 1);
			func_8(&iLocal_262);
			func_385();
			func_2();
			func_351();
...
void func_395()
{
	unk_0x2915D98110F23A29(Local_401, Local_402, 0, 1, 1, 1);
	unk_0xA8AEDE296853BB64(Local_401, Local_402);
	unk_0xF96094A43D443C41(Local_412, 5f, 0);
}
...
void func_396()
{
	...
	if (iLocal_301[3])
	{
		...
		{
			func_231(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
			if (unk_0xE5965CDF24F93A9F(iLocal_426))
			{
				unk_0x3B2646B62E7BBE11(iLocal_426, 1);
			}
			if (iLocal_336 <= 3)
			{
				func_382(769, 3, 1);
...
void func_397()
{
	...
	unk_0x8E21C2B8D76BD2C7(Local_359, fLocal_315);
	unk_0x8E21C2B8D76BD2C7(Local_360, fLocal_315);
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_361, Local_362, 7f, 1, 1, 0))
	{
		if (iLocal_301[1])
		{
			iLocal_290 = 0;
...
void func_399()
{
	...
	unk_0x8E21C2B8D76BD2C7(Local_359, fLocal_315);
	unk_0x8E21C2B8D76BD2C7(Local_360, fLocal_315);
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_361, Local_362, 7f, 0, 1, 0))
	{
		func_321();
		func_404();
		func_383();
		...
		if (!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && (unk_0x8F41785F110B0DA0(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0) || iLocal_338 >= 3))
		{
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					if (!unk_0x8F41785F110B0DA0(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0))
					{
						func_226(1);
					}
					iLocal_254 = 8;
		...
		if (!unk_0x12DD4A0B247D9B4D(Local_258[iVar0 /*10*/].f_9))
		{
			if (func_230(Local_258[iVar0 /*10*/]))
			{
				if (!Local_258[iVar0 /*10*/].f_7)
				{
					...
					unk_0xA582EE8380437B1B(Local_258[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (Local_258[iVar0 /*10*/].f_7 == 1)
		{
			if (!Local_258[iVar0 /*10*/].f_8)
			{
				...
				{
					unk_0xE68645525D451A8B(Local_258[iVar0 /*10*/]);
					iLocal_338++;
				}
				else
				{
...
{
	if (unk_0xE5965CDF24F93A9F(Local_258[iParam0 /*10*/]) && !Local_258[iParam0 /*10*/].f_7)
	{
		Local_258[iParam0 /*10*/].f_5 = unk_0x0CF63873D754B965(Local_258[iParam0 /*10*/]);
		if (Local_258[iParam0 /*10*/].f_5 < 100)
		{
			...
			unk_0xB35D04A52BD51F16(Local_258[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (unk_0xA829C9A2767AC8EF())
			{
				...
				if (!func_212())
				{
					func_229(unk_0xE2D3D51028F0428A(), Local_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_228(1);
...
void func_407()
{
	unk_0xF96094A43D443C41(Local_403, 3f, 0);
	unk_0xA8AEDE296853BB64(Local_404, Local_405);
	unk_0xF96094A43D443C41(Local_406, 3f, 0);
	unk_0xA8AEDE296853BB64(Local_407, Local_408);
	unk_0xF96094A43D443C41(Local_409, 3f, 0);
	unk_0xA8AEDE296853BB64(Local_410, Local_411);
}
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			unk_0xDC226C748C3C868D(Local_258[iVar0 /*10*/].f_1, 2f, 0);
			Local_258[iVar0 /*10*/] = unk_0x0E536D72AB30F4C8(iLocal_340, Local_258[iVar0 /*10*/].f_1, 1, 1, 0);
			if (unk_0xE5965CDF24F93A9F(Local_258[iVar0 /*10*/]))
			{
				unk_0xBBF86885619695CE(Local_258[iVar0 /*10*/], Local_258[iVar0 /*10*/].f_4);
				unk_0x6486D097E5C691F3(Local_258[iVar0 /*10*/], 0);
				unk_0xF160248D9083ED0C(Local_258[iVar0 /*10*/], 100, 0);
				unk_0x4536AE3DABDE0C44(Local_258[iVar0 /*10*/], 1);
				Local_258[iVar0 /*10*/].f_7 = 0;
				Local_258[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((unk_0xE5965CDF24F93A9F(Local_258[0 /*10*/]) && unk_0xE5965CDF24F93A9F(Local_258[1 /*10*/])) && unk_0xE5965CDF24F93A9F(Local_258[2 /*10*/])) && func_409())
		{
			unk_0xF1A23B343DFEDFD0(iLocal_340);
			iLocal_271 = 0;
			return 1;
...
int func_409()
{
	iLocal_335 = unk_0x5853B15F78E1A265(0, 3);
	if (unk_0xE5965CDF24F93A9F(Local_258[iLocal_335 /*10*/]))
	{
...
void func_410()
{
	unk_0xD69A0C3662175E68(iLocal_340);
	while (!unk_0x0152AA00FA3130F1(iLocal_340))
	{
		wait(0);
	}
	iLocal_271 = 1;
...
void func_411()
{
	...
	else
	{
		...
		if (unk_0x12DD4A0B247D9B4D(iLocal_263))
		{
			if (!unk_0x7962B3383C030376(iLocal_263))
			{
				if (!unk_0x77A43AFA9AAEC041(iLocal_348, unk_0xE2D3D51028F0428A(), Local_384, 0, 1, 0))
				{
					func_2();
					func_314(1, 0);
					func_319("HT_BKHTER");
			...
			else
			{
				...
				if (unk_0x77A43AFA9AAEC041(iLocal_348, unk_0xE2D3D51028F0428A(), Local_385, 0, 1, 0))
				{
					func_314(1, 0);
					if (func_398("HT_BKHTER", 0, 0))
					{
		...
		case 1:
			if (unk_0xA829C9A2767AC8EF())
			{
				if (unk_0xF34D8FCAE3FD4EE4())
				{
					...
					if (unk_0xE5965CDF24F93A9F(iLocal_347))
					{
						unk_0x4BDA5AFD88C085EB(&iLocal_347);
					}
				}
				...
				if (!func_212())
				{
					func_229(unk_0xE2D3D51028F0428A(), Local_380, fLocal_381, 0, 1);
					func_352();
				}
				func_228(1);
				unk_0x02B222EADC9DC566(Local_379, 2f, 0, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
			...
			switch (iLocal_320)
			{
				case 0:
					if (func_440(1, 1093140480, 0))
					{
						...
						{
							unk_0x48F297980C708DB7(unk_0xE2D3D51028F0428A(), sLocal_354, 0, 0, 0);
						}
						if (func_230(iLocal_348))
						{
							unk_0x48F297980C708DB7(iLocal_348, sLocal_355, 0, 0, 0);
							unk_0x3817498C7B1515DD(sLocal_355, unk_0xE2D3D51028F0428A(), 0);
							iLocal_347 = func_436(iLocal_348, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (unk_0xE5965CDF24F93A9F(iLocal_347))
						{
							unk_0x48F297980C708DB7(iLocal_347, "Daves_Rifle", 0, 0, 0);
						}
						func_435();
						...
						{
							unk_0xC64B6E13A6A7F517(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
							unk_0xBBF86885619695CE(iLocal_426, 76.1155f);
						}
				...
				case 1:
					if (unk_0x6F2E1326DB60D575(sLocal_355, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_276)
						{
					...
					{
						unk_0x3AEA6B9A9FE5BD26(iLocal_347, unk_0xE2D3D51028F0428A());
					}
					if (unk_0x6F2E1326DB60D575(sLocal_354, 0))
					{
			...
			if (unk_0xA829C9A2767AC8EF())
			{
				if (func_408())
				{
					if (func_308(iLocal_348))
					{
						...
						{
							func_229(iLocal_348, Local_373, fLocal_312, 0, 1);
							unk_0xE002DFD518BF86A7(iLocal_348, joaat("weapon_sniperrifle"));
							unk_0x03A927199A2DFE46(iLocal_348);
							iLocal_255 = 2;
						}
					}
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!unk_0x55B23FE400FCEA6B(iParam0, 0))
		{
			if (unk_0x54B42DEC4CAB3D41(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				if (func_439(func_260(iVar2, iVar6)))
				{
					uVar7 = unk_0x2597F123290B0413(func_260(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_260(iVar2, iVar8) != 0)
	{
		if (!unk_0x55B23FE400FCEA6B(iParam0, 0))
		{
			...
			{
				unk_0x0B46DBCE80AD9DE5(uVar1, func_260(iVar2, iVar8));
				func_437(uVar1, func_260(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_446()
{
	if (!unk_0x4131052989DE1278() && func_373(unk_0xE2D3D51028F0428A(), iLocal_348, 1) > 3f)
	{
		iLocal_325 = unk_0x320D1840B6DAA1CC() + 2000;
		if (func_308(iLocal_348))
		{
			if (func_308(unk_0xE2D3D51028F0428A()))
			{
			}
			unk_0x56593357686570F4(iLocal_348, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			unk_0xC9B7A3B3228EDC18(fLocal_306);
			unk_0xFFD7FEEC98321A66(fLocal_307);
			unk_0xC3940C122330F4AA(fLocal_308);
			unk_0xC5FB663C1CE53C57(fLocal_309);
			unk_0xF2938A28C15DB464(fLocal_310);
			unk_0xCB772E2A88F6A27F(1);
		}
	}
	else if (func_308(iLocal_348) && func_308(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0x320D1840B6DAA1CC() > iLocal_325 || func_373(unk_0xE2D3D51028F0428A(), iLocal_348, 1) <= 3f)
		{
			if (func_373(unk_0xE2D3D51028F0428A(), iLocal_348, 1) <= 3f)
			{
			}
			iLocal_320 = 0;
			iLocal_257 = 0;
...
void func_447()
{
	...
	if (func_308(iLocal_348))
	{
		unk_0x7A93DEA53EFC3CF2(iLocal_348, 200);
		unk_0x91D9C55E11392690(iLocal_348, 0);
		unk_0x950D2D7EA1BFF54C(iLocal_348, 0);
		unk_0xD6A76BAB45A4B460(iLocal_348, 169, 1);
		unk_0xD6A76BAB45A4B460(iLocal_348, 206, 1);
		unk_0xD6A76BAB45A4B460(iLocal_348, 32, 0);
		unk_0x96C405257A1BD81B(iLocal_348, 0);
		unk_0xDCB52C614B3660EC(iLocal_348);
		unk_0x4D671450EBB62809(iLocal_348, 1);
		unk_0x027BDA95C9BD0667(iLocal_348, 0);
		unk_0x0407CF7EFEE35240(iLocal_348, 1);
		unk_0x3F990964E4A5669A(iLocal_348, 0);
		unk_0x102D1A546FDB4B6D(iLocal_348, 1);
		unk_0x5D1D64E01B76705C(iLocal_348, 1);
	}
	iLocal_257 = 0;
	if (func_528())
	{
...
void func_450()
{
	...
	{
		iLocal_274 = 1;
		uLocal_337 = unk_0x4A88C4ACAC824897(unk_0xE2D3D51028F0428A(), joaat("AMMO_SNIPER"));
	}
}
...
void func_452()
{
	unk_0xD69A0C3662175E68(iLocal_341);
	unk_0x0FA01D16FCD94A52("SCRIPT\HUNTING_1_COYOTE_VOCALS", 0, -1);
	while (!unk_0x0152AA00FA3130F1(iLocal_341))
	{
		wait(0);
	}
}
...
void func_456()
{
	if (unk_0x2B1D7439C26D5642() != 4)
	{
		if ((unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_397, Local_398, 16f, 0, 1, 0) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_399, Local_400, 19f, 0, 1, 0)) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_401, Local_402, 19f, 0, 1, 0))
		{
...
void func_457()
{
	...
	if (func_308(unk_0xE2D3D51028F0428A()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 3:
				func_314(1, 0);
				iLocal_334 = unk_0x320D1840B6DAA1CC() + 2000;
				unk_0xC64B6E13A6A7F517(iLocal_348, Local_373, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(iLocal_348, fLocal_312);
				iLocal_255 = 2;
				break;
			...
			case 2:
				if (func_308(iLocal_348))
				{
					...
					{
						bLocal_276 = true;
						iLocal_334 = unk_0x320D1840B6DAA1CC() + 5000;
						unk_0xE002DFD518BF86A7(iLocal_348, joaat("weapon_sniperrifle"));
						unk_0x7D1424753688EE7A(iLocal_348, Local_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						unk_0x3F990964E4A5669A(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				if (unk_0x174CED88B97C78D9(iLocal_348, 713668775) == 7)
				{
					if (unk_0x8F41785F110B0DA0(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0))
					{
						unk_0x03A927199A2DFE46(iLocal_348);
						unk_0xF30F15F203736DE4(iLocal_348, unk_0xE2D3D51028F0428A(), -1, 1024, 2);
						unk_0x3F990964E4A5669A(iLocal_348, 1);
						unk_0x50274A7EACA3133A(iLocal_348, 1);
						iLocal_255 = 6;
					}
				}
				else if (!iLocal_301[0])
				{
					if (unk_0x320D1840B6DAA1CC() > iLocal_334)
					{
			...
			case 5:
				if (!unk_0xF68107C40359970C(iLocal_348))
				{
					if (unk_0x8FEA2E94638F9767(iLocal_348, joaat("weapon_sniperrifle"), 0))
					{
						unk_0xE002DFD518BF86A7(iLocal_348, joaat("weapon_sniperrifle"));
					}
					if (func_488())
					{
						if (unk_0x2B5F4FBAF644BEC8(iLocal_346))
						{
							unk_0x1C2ED929474DC6FE(iLocal_346, 0, 0);
						}
						func_354();
						func_353();
						func_8(&iLocal_263);
						unk_0x51BB443B279E4104(iLocal_348);
						unk_0xC64B6E13A6A7F517(iLocal_348, Local_368, 1, 0, 0, 1);
						unk_0xBBF86885619695CE(iLocal_348, fLocal_304);
						iLocal_288 = 0;
						iLocal_255 = 6;
					}
				}
			...
			case 6:
				...
				else if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_361, Local_362, 7f, 0, 1, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 12:
				if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_333 == -1)
					{
						iLocal_333 = unk_0x7AFC31F33CB9B8D5(Local_395, Local_396, 0f, 0, 7);
					}
					func_380();
					iLocal_301[9] = 1;
					func_226(0);
					...
					iLocal_328 = 0;
					unk_0xF30F15F203736DE4(iLocal_348, unk_0xE2D3D51028F0428A(), -1, 1024, 2);
					unk_0x7D1424753688EE7A(iLocal_348, Local_369, 1f, 60000, 0.25f, 512, fLocal_305);
					unk_0x3F990964E4A5669A(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
			...
			case 13:
				if (!unk_0xF68107C40359970C(iLocal_348))
				{
					if (func_488())
					{
						...
						unk_0x51BB443B279E4104(iLocal_348);
						unk_0xC64B6E13A6A7F517(iLocal_348, Local_369, 1, 0, 0, 1);
						unk_0xBBF86885619695CE(iLocal_348, fLocal_305);
						func_380();
						func_353();
						func_354();
						func_8(&iLocal_263);
			...
			case 14:
				if (unk_0x174CED88B97C78D9(iLocal_348, 713668775) == 7)
				{
					if (unk_0x8F41785F110B0DA0(iLocal_348, Local_369, 1.25f, 1.25f, 2.5f, 0, 1, 0) && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_363, Local_364, 10f, 0, 1, 0))
					{
						if (func_485())
						{
							if (func_371(&uLocal_89, cLocal_353, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_328 == 1)
							{
								...
								if (iLocal_333 != -1)
								{
									unk_0xB251DDFA99084C56(iLocal_333);
									iLocal_333 = -1;
								}
								func_353();
								iLocal_301[11] = 1;
			...
			case 16:
				if (func_477())
				{
					iLocal_331 = 0;
					func_458();
					unk_0x7D1424753688EE7A(iLocal_348, Local_420[0 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
					unk_0x3F990964E4A5669A(iLocal_348, 1);
					func_314(0, 0);
					iLocal_255 = 17;
				}
			...
			case 17:
				unk_0x3DBD501D46E6A2BE(iLocal_348, 1.4f);
				if (!iLocal_301[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), Local_358, 1) > 10f)
							{
				...
				switch (iLocal_331)
				{
					case 0:
						...
						{
							unk_0x7D1424753688EE7A(iLocal_348, Local_420[1 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 1:
						...
						{
							unk_0x7D1424753688EE7A(iLocal_348, Local_420[2 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 2:
						...
						{
							unk_0x7D1424753688EE7A(iLocal_348, Local_420[3 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_331++;
						}
						break;
					...
					case 3:
						...
						{
							unk_0x7D1424753688EE7A(iLocal_348, Local_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (unk_0x174CED88B97C78D9(iLocal_348, 713668775) == 7 || (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_413, Local_414, 3.5f, 0, 1, 0) && unk_0xD132EDDA78FF4A51(iLocal_348, Local_413, Local_414, 3.5f, 0, 1, 0)))
						{
							unk_0x3F990964E4A5669A(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 20:
				if (!unk_0xF68107C40359970C(iLocal_348))
				{
					if (func_488())
					{
						...
						unk_0x51BB443B279E4104(iLocal_348);
						unk_0xC64B6E13A6A7F517(iLocal_348, Local_370, 1, 0, 0, 1);
						unk_0xBBF86885619695CE(iLocal_348, fLocal_371);
						func_353();
						func_354();
						func_314(1, 0);
						iLocal_255 = 18;
			...
			case 18:
				...
				{
					Var0 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
					if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_413, Local_414, 3.5f, 0, 1, 0) || Var0.f_2 > 41f)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT_ROOF", 7, 0, 0, 0))
						{
							unk_0x03A927199A2DFE46(iLocal_348);
							unk_0x7D1424753688EE7A(iLocal_348, Local_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							unk_0x3F990964E4A5669A(iLocal_348, 0);
							iLocal_255 = 21;
						}
					}
					else if (unk_0x174CED88B97C78D9(iLocal_348, -875674219) != 1)
					{
						unk_0x529D306014D3C29A(iLocal_348, unk_0xE2D3D51028F0428A(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_365, Local_366, 20f, 0, 1, 0))
				{
					...
					{
						func_316();
						iLocal_322 = unk_0x320D1840B6DAA1CC() + 2000;
						bLocal_279 = true;
					}
					if (func_485())
					{
				...
				if (bLocal_279)
				{
					if (unk_0x320D1840B6DAA1CC() > iLocal_322)
					{
						func_316();
			...
			case 24:
				...
				{
					unk_0x51BB443B279E4104(iLocal_348);
					unk_0xC64B6E13A6A7F517(iLocal_348, Local_417, 1, 0, 0, 1);
					unk_0xBBF86885619695CE(iLocal_348, fLocal_418);
					unk_0xF30F15F203736DE4(iLocal_348, unk_0xE2D3D51028F0428A(), -1, 0, 2);
					if (unk_0xE5965CDF24F93A9F(iLocal_346))
					{
						unk_0x1C2ED929474DC6FE(iLocal_346, 0, 0);
					}
				}
				...
				if (!func_223())
				{
					...
					else if (!func_223())
					{
						if (func_308(iLocal_348))
						{
							unk_0x03A927199A2DFE46(iLocal_348);
							unk_0x91D9C55E11392690(iLocal_348, 0);
							unk_0xA888F8CC04F25CC8(&uLocal_351);
							unk_0x7D1424753688EE7A(0, Local_422, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x7D1424753688EE7A(0, Local_423, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x7D1424753688EE7A(0, Local_424, 1f, 60000, 0.25f, 0, 40000f);
							unk_0xD86A0BC9CC0A625A(0, 1193033728, 0);
							unk_0xC963A45B50851768(uLocal_351);
							unk_0x8ACADA903FCAA42F(iLocal_348, uLocal_351);
							unk_0x7461D7C5BA953BC7(&uLocal_351);
							unk_0xABC2CA6F28903308(iLocal_348, 1);
						}
						iLocal_255 = 0;
					}
				}
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				...
				{
					if (unk_0x32DCDA1B2F8A0694(iLocal_348))
					{
						func_2();
						iLocal_324 = unk_0x320D1840B6DAA1CC() + 2400;
						iLocal_280 = 1;
					}
				}
				if (((unk_0x55B23FE400FCEA6B(iLocal_348, 0) || unk_0x0747E45CFF1F74AA(iLocal_348, unk_0xE2D3D51028F0428A(), 1)) || unk_0x6799F7DD0261990E(iLocal_348, 0, 2)) || unk_0x89D0E0233F6E59A7(-1, unk_0x6B62510F212526DC(iLocal_348, 0), 10f))
				{
					func_2();
					iLocal_324 = unk_0x320D1840B6DAA1CC() + 2400;
					iLocal_280 = 1;
			...
			else if (unk_0x320D1840B6DAA1CC() > iLocal_324)
			{
				if (unk_0xE5965CDF24F93A9F(iLocal_348))
				{
					if (!unk_0x55B23FE400FCEA6B(iLocal_348, 0))
					{
						unk_0x03A927199A2DFE46(iLocal_348);
						unk_0x7734082B0EDB0BE0(iLocal_348, unk_0xE2D3D51028F0428A(), 100f, -1, 0, 0);
						unk_0xABC2CA6F28903308(iLocal_348, 1);
						func_318(2);
					}
					else
	...
	if (func_462())
	{
		...
		while (iVar1 < func_461())
		{
			if (unk_0xE5965CDF24F93A9F(func_460(iVar1)))
			{
				...
				{
					if (unk_0x59BBF1CA2F5CAC75(iVar0, iLocal_341))
					{
...
void func_463()
{
	if (!unk_0xD5C6B5E3B93A5EDC(iLocal_348, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		if (!iLocal_433)
		{
			iLocal_434 = unk_0x320D1840B6DAA1CC() + 3000;
			iLocal_433 = 1;
		}
		else if (unk_0x320D1840B6DAA1CC() > iLocal_434)
		{
			if (func_372())
			{
...
void func_464()
{
	if (!unk_0xE63474311C6E3825(iLocal_348, 1) && !unk_0xE63474311C6E3825(unk_0xE2D3D51028F0428A(), 1))
	{
		if (unk_0xD5C6B5E3B93A5EDC(iLocal_348, 0) && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if (!iLocal_291)
			{
				iLocal_317 = unk_0x320D1840B6DAA1CC() + 3000;
				iLocal_291 = 1;
			}
			else if (unk_0x320D1840B6DAA1CC() > iLocal_317)
			{
				if (!func_223())
				{
					if (!iLocal_301[8])
					{
						...
						{
							if (!unk_0xACC32B78196FBC2A(&Local_428))
							{
								Local_428 = { func_465() };
							}
							else
...
void func_467()
{
	...
	if (func_308(unk_0xE2D3D51028F0428A()) && func_308(iLocal_348))
	{
		if (unk_0xD5C6B5E3B93A5EDC(iLocal_348, 0) && unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if (func_230(iLocal_426))
			{
				if (unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0) == iLocal_426 && unk_0xB3FF0049C1FD38EC(iLocal_348, 0) == iLocal_426)
				{
					if (!iLocal_431)
					{
						iLocal_432 = unk_0x0CF63873D754B965(iLocal_426);
						iLocal_431 = 1;
					}
					else
					{
						iVar0 = unk_0x0CF63873D754B965(iLocal_426);
						if (iVar0 < iLocal_432)
						{
							func_468();
	...
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		if (!iLocal_301[7])
		{
			if (!func_223())
			{
				if (func_372())
				{
					if (unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0) == iLocal_426)
					{
...
void func_471()
{
	if (!unk_0xE63474311C6E3825(iLocal_348, 1) && !unk_0xE63474311C6E3825(unk_0xE2D3D51028F0428A(), 1))
	{
		if (!unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_361, Local_362, 7f, 0, 1, 0))
		{
			if (!unk_0xD5C6B5E3B93A5EDC(iLocal_348, 0) && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 1))
			{
				if (!iLocal_297)
				{
					if (!func_398("HT_NXTLOC", 0, 0) && iLocal_301[4])
					{
						iLocal_332 = unk_0x320D1840B6DAA1CC() + 20000;
						iLocal_297 = 1;
					}
				}
				else if (unk_0x320D1840B6DAA1CC() > iLocal_332)
				{
...
void func_474()
{
	if (!unk_0xE63474311C6E3825(iLocal_348, 1) && !unk_0xE63474311C6E3825(unk_0xE2D3D51028F0428A(), 1))
	{
		if (!iLocal_429)
		{
			...
			{
				iLocal_430 = unk_0x320D1840B6DAA1CC() + 3000;
				iLocal_429 = 1;
			}
		}
		else if (unk_0x320D1840B6DAA1CC() > iLocal_430)
		{
			if (!func_223() && func_372())
			{
				if (!iLocal_301[4])
...
void func_475()
{
	if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_361, Local_362, 16f, 0, 1, 0))
	{
		if ((iLocal_302[1] && !func_398("HT_NXTLOC", 0, 0)) && !func_223())
		{
			if (!iLocal_296)
			{
				iLocal_316 = unk_0x320D1840B6DAA1CC() + 15000;
				iLocal_296 = 1;
			}
			else if (unk_0x320D1840B6DAA1CC() > iLocal_316)
			{
...
void func_476()
{
	if (unk_0x174B84F6B78D6CA7(unk_0xE2D3D51028F0428A()))
	{
		if (!iLocal_273)
		{
			uLocal_435 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
			if (!unk_0xD5C6B5E3B93A5EDC(iLocal_348, 1))
			{
				if (!unk_0x10A4F356F2DCEA52(uLocal_435))
				{
					if (func_372())
					{
						if (!func_223())
...
int func_477()
{
	if (!unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!unk_0xE5965CDF24F93A9F(iLocal_346))
		{
			unk_0x03A927199A2DFE46(iLocal_348);
		...
		{
			unk_0x4BDA5AFD88C085EB(&iLocal_346);
		}
	}
	else if (!unk_0xE5965CDF24F93A9F(iLocal_346))
	{
		unk_0x03A927199A2DFE46(iLocal_348);
		return 1;
	}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x9AC74C7EF847A074(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_223())
			{
...
void func_480(int iParam0)
{
	...
	if (((iLocal_338 < 3 && !func_398("HT_SHDISH", 0, 0)) && !func_398("HT_SHTYRE", 0, 0)) && !func_398("HT_SHCOY", 0, 0))
	{
		if (iLocal_277)
		{
			if (unk_0x320D1840B6DAA1CC() > iLocal_326)
			{
		...
		{
			iLocal_327 = unk_0x5853B15F78E1A265(10000, 15000);
			iLocal_326 = (unk_0x320D1840B6DAA1CC() + iLocal_327);
			iLocal_277 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							if (!unk_0x8F41785F110B0DA0(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !unk_0xC9CD8C710046A3DD(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f))
							{
								if (unk_0x174CED88B97C78D9(iLocal_348, 713668775) != 1 || unk_0x174CED88B97C78D9(iLocal_348, 713668775) != 7)
								{
									iLocal_328 = 1;
								}
							}
					...
					case 1:
						if (!unk_0x8F41785F110B0DA0(iLocal_348, Local_369, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!unk_0x8F41785F110B0DA0(iLocal_348, Local_372, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_269)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_348))
			{
				...
				if (bParam1)
				{
					unk_0x1A96B8B416BC07D0(0, Local_258[iLocal_335 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				unk_0x8ACADA903FCAA42F(iLocal_348, uVar0);
...
int func_488()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_346) && unk_0x099CAD293190F449(iLocal_346, iLocal_348))
	{
		return 1;
	}
	if (!iLocal_265)
...
void func_489()
{
	unk_0xD69A0C3662175E68(iLocal_342);
	while (!unk_0x0152AA00FA3130F1(iLocal_342))
	{
		wait(0);
	}
	iLocal_265 = 1;
...
void func_490(bool bParam0)
{
	...
	if (func_308(iLocal_348))
	{
		if (unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			unk_0x50274A7EACA3133A(iLocal_348, 1);
			unk_0xC89EA639A6F338A6(iLocal_348);
			unk_0xA888F8CC04F25CC8(&uVar0);
...
void func_491(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_308(iLocal_348) && func_308(unk_0xE2D3D51028F0428A()))
	{
		if (func_462())
		{
			iVar1 = 0;
			while (iVar1 < func_461())
			{
				...
				{
					iVar0 = unk_0x28AA31872A651BC7(func_460(iVar1));
					if (iVar0 != unk_0xE2D3D51028F0428A() && iVar0 != iLocal_348)
					{
			...
			while (iVar1 < 5)
			{
				if (unk_0xE5965CDF24F93A9F(Local_259[iVar1 /*29*/].f_12))
				{
					if (unk_0x0747E45CFF1F74AA(Local_259[iVar1 /*29*/].f_12, unk_0xE2D3D51028F0428A(), 1))
					{
						unk_0xE68645525D451A8B(Local_259[iVar1 /*29*/].f_12);
						iLocal_321++;
					}
				}
				iVar1++;
...
void func_492()
{
	if (!unk_0xF68107C40359970C(iLocal_348))
	{
		if (((unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0x6B62510F212526DC(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0x6B62510F212526DC(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || unk_0xA1C6623FC1047DAD(unk_0x6B62510F212526DC(iLocal_348, 0) + Vector(2f, 2f, 2f), unk_0x6B62510F212526DC(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || unk_0x89D0E0233F6E59A7(-1, unk_0x6B62510F212526DC(iLocal_348, 0), 10f))
		{
			unk_0x33B3A4723D5DBD35(1, iLocal_261, 1862763509);
		}
		if (!iLocal_272)
		{
			if (func_494() || unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iLocal_348))
			{
				if (func_223())
				{
					func_316();
		...
		if (!bLocal_298)
		{
			if (unk_0x0208598D19E7A49F(iLocal_348))
			{
				unk_0x0407CF7EFEE35240(iLocal_348, 0);
				bLocal_298 = true;
			}
		}
		else if (unk_0x03454821A9ECF4AA(iLocal_348))
		{
			unk_0x0407CF7EFEE35240(iLocal_348, 1);
			bLocal_298 = false;
		}
...
int func_494()
{
	if (func_308(iLocal_348))
	{
		if (iLocal_255 != 25)
		{
			if ((!unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6) && unk_0x7A6B8C262362C722(unk_0xE2D3D51028F0428A())) && func_373(iLocal_348, unk_0xE2D3D51028F0428A(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6) && unk_0x7A6B8C262362C722(unk_0xE2D3D51028F0428A())) && unk_0x2E7F5417D4F4DD69(unk_0xE2D3D51028F0428A(), iLocal_348, 30f)) && func_373(iLocal_348, unk_0xE2D3D51028F0428A(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_495()
{
	if (!unk_0xF68107C40359970C(iLocal_348))
	{
		if ((unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && unk_0xD01FAFCE275C94F3(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_328 == 1)
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_346))
			{
				unk_0x4BDA5AFD88C085EB(&iLocal_346);
		...
		if (!unk_0xE5965CDF24F93A9F(iLocal_346))
		{
			if (unk_0xFCF559C8631ABED7(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro", 3) && unk_0xD01FAFCE275C94F3(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_346 = unk_0x0E536D72AB30F4C8(iLocal_342, unk_0x6B62510F212526DC(iLocal_348, 1), 0, 0, 0);
			}
		}
		else if (!unk_0x099CAD293190F449(iLocal_346, iLocal_348))
		{
			unk_0x9A97DC6DBC7B223D(iLocal_346, iLocal_348, unk_0xB897FCFCFA664B38(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xA829C9A2767AC8EF())
			{
				...
				Var4 = { func_498(Global_78107, Global_78109, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_514()
{
	if (!iLocal_284)
	{
		unk_0xD642E010A287ADFD("FRIENDLIES", &iLocal_261);
		unk_0xFF4BEB6CFF55A013(iLocal_348, iLocal_261);
		unk_0x9972EFADA7A2A47D(1, iLocal_261, 1862763509);
		unk_0x9972EFADA7A2A47D(1, 1862763509, iLocal_261);
		unk_0x9972EFADA7A2A47D(2, iLocal_261, -2065892691);
...
void func_518(var uParam0, struct<3> Param1, float fParam2, int iParam3)
{
	func_519(uParam0, iLocal_79, Param1, fParam2);
	if (unk_0xE5965CDF24F93A9F(*uParam0))
	{
...
void func_519(var uParam0, int iParam1, struct<3> Param2, var uParam3)
{
	func_520(uParam0);
	*uParam0 = unk_0xBA715A7BEBA5A1F9(iParam1, Param2, uParam3, 1, 1, 0);
	if (unk_0xE5965CDF24F93A9F(*uParam0))
	{
		unk_0x9F65B3BAFA302A65(*uParam0, 1084227584);
...
int func_521(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_522(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xE5965CDF24F93A9F(*uParam0))
		{
...
int func_522(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_529()
{
	...
	if (iLocal_265)
	{
		unk_0xF1A23B343DFEDFD0(iLocal_342);
	}
	if (bLocal_264)
	{
	...
	if (iLocal_293)
	{
		unk_0x7BACBB4C6A7B18B7(uLocal_350, 0);
	}
...
void func_540()
{
	unk_0xF1A23B343DFEDFD0(iLocal_341);
}
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_546())
	{
		...
		{
			iVar2 = func_302(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
