...
void __EntryFunction__()
{
	...
	iLocal_54 = unk_0xB8DEE91181C30E65(joaat("weapon_sniperrifle"));
	iLocal_55 = unk_0x2597F123290B0413(joaat("component_at_scope_large"));
	iLocal_56 = unk_0x2597F123290B0413(joaat("component_at_ar_supp_02"));
	...
	unk_0x7A997A0A971D305F(Var1, 3f, 1, 0, 0, 0);
	while (true)
	{
		wait(0);
		if (!func_197(&Var0, 1))
		...
		if (func_169(&Var0, 0) && unk_0x48053974ED6F63CE((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam6) && func_188(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_217(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uLocal_58))
			{
				iLocal_58 = unk_0xBF59603E8A18FEB0(joaat("weapon_sniperrifle"), 0, Local_57, 0, 1065353216, 0, 0, 1);
				unk_0x0B46DBCE80AD9DE5(iLocal_58, joaat("component_at_scope_large"));
				unk_0x0B46DBCE80AD9DE5(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (unk_0x574E2A23F0F76E35(Local_57, 1f, iLocal_54, 0))
			{
				unk_0x8CE3D365F064F69E(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_237(var uParam0, struct<3> Param1, float fParam2, int iParam3)
{
	func_238(uParam0, iLocal_53, Param1, fParam2);
	if (unk_0xE5965CDF24F93A9F(*uParam0))
	{
...
void func_238(var uParam0, int iParam1, struct<3> Param2, var uParam3)
{
	func_239(uParam0);
...
int func_240(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_241(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xE5965CDF24F93A9F(*uParam0))
		{
...
int func_241(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
