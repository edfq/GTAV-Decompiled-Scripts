	...
	switch (iLocal_43)
	{
				...
				if (unk_0xE9E8955A780DDA01())
				{
					if (!func_20())
					{
						if (((!unk_0xA3329B7A7520670E() && !func_14()) && !func_13()) && !func_12())
						{
							...
							uLocal_55 = unk_0x528279F3F1EEF869("LETTER_SCRAPS");
							while (!unk_0x0347CCBD719C8ADC(uLocal_55))
							{
								wait(0);
							}
							unk_0xEA5DEA46C3EE64D3(uLocal_55, "SET_LETTER_TEXT");
							func_11(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0xC4353D240DCE9533(uLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						unk_0x28692DF126DAC03E((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
...
int func_38(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((vdist2(Param2, unk_0x70453F7DF40780A5((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_58(13)) || func_58(14))
		{
...
void func_73()
{
	...
	unk_0x705B098546DEB18A(&uLocal_55);
