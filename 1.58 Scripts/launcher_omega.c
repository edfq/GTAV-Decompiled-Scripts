...
void func_184(int iParam0)
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_58) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !unk_0xBC7D3EDF3455BC35(iParam0->f_28[0]))
		{
			if (func_127(unk_0xE2D3D51028F0428A()) && !func_185(unk_0xE2D3D51028F0428A(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar4 != 0f)
				{
					fVar2 = unk_0xC529D13129C03CF4(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0xBBF86885619695CE(iParam0->f_28[0], fVar2);
			}
		}
...
void func_186()
{
	...
	unk_0xEA5DEA46C3EE64D3(uLocal_56, "SET_COLOUR");
	...
	unk_0xEA5DEA46C3EE64D3(uLocal_56, "SET_DISTANCE");
	unk_0xCA5D23E5F0F0306F(10f);
	unk_0x6F06CF0E9AB02847();
	unk_0xCF0E3BB302EAC0EA(uLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	unk_0x694170BB080C08FF(uLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x320D1840B6DAA1CC() - iLocal_58) > 1250)
	{
		unk_0xD336F8D9637B963F(uLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0x320D1840B6DAA1CC();
	}
}
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_175(2))
		{
			...
			if (func_194(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		Var1 = { func_223(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_242()
{
	uLocal_56 = unk_0x528279F3F1EEF869("digiscanner");
	while (!unk_0x0347CCBD719C8ADC(uLocal_56))
	{
		wait(0);
	}
	...
	if (unk_0xBB75DCB31B62483C("digiscanner"))
	{
		uLocal_57 = unk_0x014679E62446327A("digiscanner");
	}
	uLocal_59 = unk_0xA9ADCC8D104AA552();
	iLocal_58 = unk_0x320D1840B6DAA1CC();
}
...
void func_245(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_246(uParam0);
...
int func_248(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
