...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_309(uParam1))
	{
		...
		case 4:
			if (func_269(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_267(uParam0[iParam3 /*94*/], unk_0xA8D58C3AADA2C41C(1, uParam0->f_1669, Var13, unk_0xD12EFCAB87804BED(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
					...
					func_267(uParam0[iParam4 /*94*/], unk_0xA8D58C3AADA2C41C(1, uParam0->f_1668, Var1, unk_0xD12EFCAB87804BED(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
		...
		case 8:
			...
			bVar14 = (unk_0x320D1840B6DAA1CC() > func_255(uParam0[iParam3 /*94*/]) && unk_0x320D1840B6DAA1CC() > func_255(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (unk_0xFCF559C8631ABED7(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && unk_0xE5965CDF24F93A9F(uParam0->f_247))
					{
						fVar19 = unk_0xD01FAFCE275C94F3(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve");
	...
	if (!func_105(uParam0, 1024))
	{
		...
		if (func_76(uParam0) == 72 || func_76(uParam0) == 73)
		{
			if (func_11(uParam0) != 0)
			{
				...
				unk_0x08C0F779422456F1(iParam1, iVar8, func_10(uParam0), func_9(uParam0), 1065353216, 0);
				func_8(uParam0, unk_0x320D1840B6DAA1CC() + 2871);
			}
		}
		else
		{
			unk_0xA427179DC0581389(iParam1, sVar1, &Var2, fVar5, func_7(uParam0), 0);
		}
...
Vector3 func_122(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	else if (uParam0->f_4.f_20 == 2)
	{
		...
		fVar17 = unk_0xC4EAB25A108C2429(0f, 1f);
...
Vector3 func_124(var uParam0, var uParam1, struct<3> Param2, int iParam3)
{
	...
	{
		fVar6 = func_125(0.4f, 1f, unk_0xC4EAB25A108C2429(0f, 1f));
...
int func_134(var uParam0, var uParam1, struct<3> Param2, bool bParam3)
{
	...
	Var8 = { unk_0x6EA486FF6D815B4B(func_266(uParam0), 60309, 0f, 0f, 0f) };
	Var9 = { Var0 - Var8 };
...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar11 = func_144(uParam0, &Var12, &Var13, &Local_254, &Local_256, &Local_257, 0, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
	...
	{
		iVar11 = func_144(uParam0, &Var12, &Var13, &Local_250, &Local_252, &Local_253, 1, &fVar15, &fVar16, &uVar14);
		if (iVar11 == 0)
		{
			func_143(uParam0, 0.5f);
			func_142(uParam0, 1f);
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = unk_0xD7500BC8646DAB0D(Var5, func_117(bParam6, *uParam5, *uParam4), func_117(bParam6, *uParam4, *uParam5), 0);
				...
				if ((uParam3[iVar18 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar14 == 0 && (iVar18 == 72 || iVar18 == 73))
						{
							...
							if (iVar18 == 72)
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_254, &Local_256, &Local_257, 0, &fVar24, &fVar25, &Var16);
							}
							else
							{
								iVar23 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_250, &Local_252, &Local_253, 1, &fVar24, &fVar25, &Var16);
							}
							if (iVar23 != 0)
							{
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_166(uParam0);
				func_174(uParam0, (to_float(iVar0) * unk_0x51109C28352EC9A3()));
			}
		}
		if (!func_173(*uParam2))
		{
...
int func_183(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (func_105(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_51(unk_0xC4EAB25A108C2429(0f, 1f) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = unk_0x5853B15F78E1A265(1, 4);
			iVar0 = func_51(unk_0xC4EAB25A108C2429(0f, 1f) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = unk_0x5853B15F78E1A265(0, 2);
		}
		Var5 = { func_123(Var6, Var5, unk_0xC4EAB25A108C2429(0f, 1f)) };
...
void func_219(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!unk_0xF68107C40359970C(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar2 = (unk_0xD12EFCAB87804BED(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				unk_0x49D97B076E3590AC(0, func_196(func_197(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
...
void func_228(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!unk_0xF68107C40359970C(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			unk_0xBBF86885619695CE(uParam0->f_32, unk_0x82FE2343F8BDFF0B(uParam0->f_32));
			func_59(uParam0, 16384);
			fVar2 = (unk_0xD12EFCAB87804BED(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam8, 180f, 0f));
			Var3 = { uParam1->f_189.f_29 - unk_0x6B62510F212526DC((uParam1[iParam3 /*94*/])->f_32, 1) };
			bVar4 = func_70(Var3, uParam0->f_40) < 0f;
			bVar5 = func_70(Var3, uParam0->f_43) < 0f;
			func_223(uParam0, 0);
...
void func_237(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		if (!unk_0xF68107C40359970C(func_266(uParam0)) && unk_0xFCD53F51D587F4C6(func_266(uParam0)))
		{
			...
			{
				fVar14 = unk_0xC4EAB25A108C2429(0f, 1f);
	...
	if (((func_76(uParam0) == 75 && unk_0xE5965CDF24F93A9F(uParam1->f_247)) && unk_0x5C5B446AD691DEA2(uParam1->f_247)) && vdist2(uParam0->f_37, func_284(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_59(uParam0, 256);
	...
	switch (func_148(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_76(uParam0) == 75)
			{
				...
				{
					unk_0x13C3030981EA7C3B(func_266(uParam0), Var1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((unk_0x8F41785F110B0DA0(uParam0->f_32, func_71(&(uParam0->f_4)), Var2, 0, 1, 0) || unk_0x174CED88B97C78D9(func_266(uParam0), 2106541073) == 7) && !func_229(&(uParam0->f_4), 256))
				{
					func_236(&(uParam0->f_4), 0);
					func_218(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_76(uParam0) == 75)
			{
				unk_0xDFAF13813077792A(func_284(uParam4), func_284(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				if (((!unk_0xF68107C40359970C(func_266(uParam0)) && !vdist2(uParam0->f_37, Var1) <= (0f * 0f)) && !func_229(&(uParam0->f_4), 4)) && !func_105(uParam0, 1024))
				{
				...
				else if (vdist2(uParam0->f_37, Var1) <= (0f * 0f) || unk_0x174CED88B97C78D9(func_266(uParam0), 2106541073) == 7)
				{
...
void func_263(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!unk_0xF68107C40359970C(func_266(uParam0[iParam1 /*94*/])) && !unk_0xF68107C40359970C(func_266(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				unk_0x9A97DC6DBC7B223D((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), unk_0xB897FCFCFA664B38(func_266(uParam0[iParam1 /*94*/]), 28422), Local_248, Local_249, 0, 0, 0, 0, 2, 1);
			}
			unk_0x9A97DC6DBC7B223D((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), unk_0xB897FCFCFA664B38(func_266(uParam0[iParam2 /*94*/]), 28422), Local_248, Local_249, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	Var0 = { 0f, 0f, 1f };
	fVar1 = func_145(fParam9 == -1f, unk_0x51109C28352EC9A3(), fParam9);
	iVar2 = 0;
...
void func_335(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_337(Global_112915.f_18533[iVar0], &Var2, &fVar3))
			{
