...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (unk_0xC92F9F18E020B461() || iLocal_105)
		{
			if (!func_166())
			{
				if (func_165())
				...
				case 1:
					if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if ((!func_133(iLocal_52[0], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0) && !func_133(iLocal_52[1], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0)) && !func_132())
								{
									switch (iLocal_48)
									{
										case 0:
											func_131();
											if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_72, 50f, 35f, 50f, 0, 1, 0))
											{
												func_130();
											}
											if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_72, 80f, 65f, 50f, 0, 1, 0))
											{
												func_129();
											}
											if (!unk_0x55B23FE400FCEA6B(iLocal_54, 0))
											{
												if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 281.9148f, 6816.345f, 4.3197f, 48.3924f, 6885.921f, 43.0037f, 226.5f, 0, 1, 0) || unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_74 - Vector(0f, 0f, 7f), 20f, 15f, 50f, 0, 1, 0))
												{
													func_128();
													if (unk_0x12DD4A0B247D9B4D(uLocal_88))
													{
														unk_0x3430966AC4550BB9(uLocal_88, 0);
													}
													iLocal_58 = 0;
													while (iLocal_58 <= 1)
													{
														if (unk_0x12DD4A0B247D9B4D(uLocal_87[iLocal_58]))
														{
															unk_0x3430966AC4550BB9(uLocal_87[iLocal_58], 0);
														}
														iLocal_58++;
													}
													if (!func_166())
							...
							case 2:
								if ((func_133(iLocal_52[0], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0) || func_133(iLocal_52[1], &iLocal_102, &uLocal_101, iLocal_100, iLocal_103, 7f, 0)) || iLocal_103)
								{
									...
									if (unk_0x12DD4A0B247D9B4D(uLocal_88))
									{
										unk_0x3430966AC4550BB9(uLocal_88, 1);
									}
									iLocal_58 = 0;
									while (iLocal_58 <= 1)
									{
										if (unk_0x12DD4A0B247D9B4D(uLocal_87[iLocal_58]))
										{
											unk_0x3430966AC4550BB9(uLocal_87[iLocal_58], 1);
										}
										iLocal_58++;
									}
									switch (iLocal_102)
								...
								if (func_132())
								{
									...
									else
									{
										...
										while (iVar0 < iLocal_52)
										{
											...
											{
												unk_0x35083F820751423C(iLocal_52[iVar0], 5, 0, 0);
												unk_0x7734082B0EDB0BE0(iLocal_52[iVar0], unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
							...
							case 4:
								func_91();
								if (!unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_85, 100f, 100f, 100f, 1, 1, 0))
								{
								...
								{
									if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_113, 200f, 200f, 200f, 1, 1, 0))
									{
										...
										{
											iLocal_55 = unk_0xBA715A7BEBA5A1F9(joaat("granger"), -1155.043f, 942.9685f, 197.4921f, 161.1247f, 1, 1, 0);
											unk_0x7A93DEA53EFC3CF2(iLocal_55, 200);
											unk_0x09042D5723106B97(iLocal_55, 1.5f);
											iLocal_53 = unk_0x487C17B41938052C(iLocal_55, 26, joaat("s_m_m_highsec_01"), -1, 1, 1);
											unk_0xE3752B10DC995E95(iLocal_53, 0, 0, 2, 0);
											unk_0xE3752B10DC995E95(iLocal_53, 3, 0, 0, 0);
											unk_0xE3752B10DC995E95(iLocal_53, 4, 0, 0, 0);
											unk_0x9521FB98DB6DDF50(iLocal_53, joaat("weapon_pistol"), -1, 1, 1);
											unk_0xFF4BEB6CFF55A013(iLocal_53, iLocal_137);
										}
									}
								}
								if (!unk_0xF68107C40359970C(iLocal_51))
								{
									...
									if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_113, Global_22, 1, 1, 0) && unk_0x77A43AFA9AAEC041(iLocal_51, unk_0xE2D3D51028F0428A(), 10f, 10f, 10f, 0, 1, 0))
									{
										if (unk_0x611AD675982BEBCC(iLocal_51))
										{
											if (unk_0x12DD4A0B247D9B4D(uLocal_111))
											{
												unk_0xFFD8EB5462B07B59(&uLocal_111);
											}
							...
							case 7:
								...
								if (unk_0xE5965CDF24F93A9F(iLocal_56))
								{
									if (unk_0xE85F749F6D5C809E(iLocal_56))
									{
										if (!unk_0xF68107C40359970C(iLocal_52[0]))
										{
											if (unk_0xFCF559C8631ABED7(iLocal_52[0], "random@burial", "a_burial_stop", 3))
											{
												if (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial_stop") > 0.355f)
												{
													unk_0xE6451C2F193342C7(iLocal_56, 1, 1);
												}
											}
								...
								if (bLocal_117)
								{
									if (unk_0x55A0C756C4A8220C(iLocal_54, 0))
									{
										if (!unk_0xF68107C40359970C(iLocal_52[0]))
										{
											unk_0x41FBE02637A70478(iLocal_52[0]);
											if (unk_0x33168C7A83D47CC0(iLocal_52[0], iLocal_54, -1, 0, 0) || unk_0x33168C7A83D47CC0(iLocal_52[0], iLocal_54, 0, 0, 0))
											{
												if (!iLocal_124)
												{
													...
													unk_0xA888F8CC04F25CC8(&uLocal_59);
													unk_0xC89EA639A6F338A6(0);
													unk_0x98DB2ABD53B8D70B(0, unk_0xCACAD935C0BEE14F(iLocal_54, -0.5f, 0.5f, 0f), unk_0xE2D3D51028F0428A(), 3f, 1, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
													unk_0xB486640392EC50BB(0, iLocal_54, -1, -1, 3f, 9, 0);
													unk_0xB69D13E19147910F(0, iLocal_54, unk_0xE2D3D51028F0428A(), 8, 30f, 262144, -1f, 10f, 1);
													unk_0xC963A45B50851768(uLocal_59);
													unk_0x8ACADA903FCAA42F(iLocal_52[0], uLocal_59);
													unk_0x7461D7C5BA953BC7(&uLocal_59);
													unk_0xABC2CA6F28903308(iLocal_52[0], 1);
													unk_0x11647D34B93A72EB(iLocal_54, 1);
													iLocal_124 = 1;
												}
												else if (unk_0x174CED88B97C78D9(iLocal_52[0], 242628503) == 1)
												{
													if (unk_0x0829092F169950AB(iLocal_52[0]) == 3)
													{
														if (!unk_0x77A43AFA9AAEC041(iLocal_52[0], unk_0xE2D3D51028F0428A(), 10f, 10f, 10f, 0, 1, 0) && !unk_0x8F41785F110B0DA0(iLocal_52[0], Local_74, 10f, 10f, 10f, 0, 1, 0))
														{
															unk_0xB3822DB3D538C8F3(&(iLocal_52[0]));
														}
													}
											...
											{
												unk_0xC1A74225341AA9FB(iLocal_52[0], unk_0xE2D3D51028F0428A(), 0, 16);
												unk_0xABC2CA6F28903308(iLocal_52[0], 1);
											}
										}
										if (!unk_0xF68107C40359970C(iLocal_52[1]))
										{
											unk_0x41FBE02637A70478(iLocal_52[1]);
											if (unk_0x33168C7A83D47CC0(iLocal_52[1], iLocal_54, -1, 0, 0) || unk_0x33168C7A83D47CC0(iLocal_52[1], iLocal_54, 0, 0, 0))
											{
												if (!iLocal_124)
												{
													unk_0x03A927199A2DFE46(iLocal_52[1]);
													unk_0xA888F8CC04F25CC8(&uLocal_59);
													unk_0xC89EA639A6F338A6(0);
													unk_0x98DB2ABD53B8D70B(0, unk_0xCACAD935C0BEE14F(iLocal_54, -0.5f, 0.5f, 0f), unk_0xE2D3D51028F0428A(), 3f, 1, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
													unk_0xB486640392EC50BB(0, iLocal_54, -1, -1, 3f, 9, 0);
													unk_0xB69D13E19147910F(0, iLocal_54, unk_0xE2D3D51028F0428A(), 8, 30f, 262144, -1f, 10f, 1);
													unk_0xC963A45B50851768(uLocal_59);
													unk_0x8ACADA903FCAA42F(iLocal_52[1], uLocal_59);
													unk_0x7461D7C5BA953BC7(&uLocal_59);
													unk_0xABC2CA6F28903308(iLocal_52[1], 1);
													unk_0x11647D34B93A72EB(iLocal_54, 1);
													iLocal_124 = 1;
												}
												else if (unk_0x174CED88B97C78D9(iLocal_52[1], 242628503) == 1)
												{
													if (unk_0x0829092F169950AB(iLocal_52[1]) == 3)
													{
														if (!unk_0x77A43AFA9AAEC041(iLocal_52[1], unk_0xE2D3D51028F0428A(), 10f, 10f, 10f, 0, 1, 0) && !unk_0x8F41785F110B0DA0(iLocal_52[1], Local_74, 10f, 10f, 10f, 0, 1, 0))
														{
															unk_0xB3822DB3D538C8F3(&(iLocal_52[1]));
														}
													}
						...
						if ((func_10() && !func_9()) && iLocal_47 != 9)
						{
							if (!unk_0xF68107C40359970C(iLocal_51))
							{
								if (unk_0x8F41785F110B0DA0(iLocal_51, Local_114, 5f, 5f, 5f, 0, 1, 0))
								{
									func_8(0);
									wait(0);
									func_110();
						...
						if (iLocal_47 != 3)
						{
							if (func_1())
							{
								...
								{
									settimera(0);
									iLocal_84 = unk_0x320D1840B6DAA1CC() + 8500;
									iLocal_68 = 1;
								}
								if (!unk_0xF68107C40359970C(iLocal_51))
								{
									if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_51, 20f, 20f, 20f, 0, 1, 1))
									{
						...
						if (((iLocal_47 == 1 || iLocal_47 == 2) || iLocal_47 == 3) || iLocal_47 == 7)
						{
							if (!unk_0xF68107C40359970C(iLocal_51))
							{
								if (!bLocal_104)
								{
									if (unk_0x174CED88B97C78D9(iLocal_51, 1785177548) != 1 && unk_0x174CED88B97C78D9(iLocal_51, 1785177548) != 0)
									{
										unk_0x51BB443B279E4104(iLocal_51);
										uLocal_303 = unk_0x8F5F4164BF5FB513(Local_72, -2f, -4f, 18f, 2);
										unk_0x950B26F4C891073F(iLocal_51, uLocal_303, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1148846080, 0);
										unk_0xAA8557AFE4A4A184(uLocal_57[0], uLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
										unk_0xAA8557AFE4A4A184(uLocal_57[1], uLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
										unk_0xFE1CD80C2F7CBCFB(uLocal_303, 1);
										unk_0xABC2CA6F28903308(iLocal_51, 1);
									}
									if (unk_0xEF9410C312F2B117(iLocal_51))
									{
										unk_0xA1B68DBB639CAFD5(iLocal_51, 1);
										unk_0xA8921DC376420B57(iLocal_51, 1);
										unk_0xF160248D9083ED0C(iLocal_51, 0, 0);
									}
								}
								if ((unk_0x5D5890DBA617ACC7(iLocal_51) || unk_0x344BB7BDBAB3823C(iLocal_51)) || (iLocal_99 - unk_0x0CF63873D754B965(iLocal_51)) >= 50)
								{
									unk_0xA1B68DBB639CAFD5(iLocal_51, 1);
									unk_0xA8921DC376420B57(iLocal_51, 1);
									unk_0xF160248D9083ED0C(iLocal_51, 0, 0);
								...
								if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && !unk_0x55B23FE400FCEA6B(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0))
								{
									...
									else if (unk_0x72F6AE51B7E34865(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), iLocal_51))
									{
										unk_0xA1B68DBB639CAFD5(iLocal_51, 1);
										unk_0xA8921DC376420B57(iLocal_51, 1);
										unk_0xF160248D9083ED0C(iLocal_51, 0, 0);
								...
								if (!unk_0x55B23FE400FCEA6B(iLocal_54, 0))
								{
									if (unk_0x72F6AE51B7E34865(iLocal_54, iLocal_51))
									{
										unk_0xA1B68DBB639CAFD5(iLocal_51, 1);
										unk_0xA8921DC376420B57(iLocal_51, 1);
										unk_0xF160248D9083ED0C(iLocal_51, 0, 0);
...
int func_1()
{
	if (!bLocal_104)
	{
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_52[0]) && unk_0xE5965CDF24F93A9F(iLocal_52[1]))
		{
			...
			if (unk_0xC96A660F9CAB40FC(iLocal_52[0]) && unk_0xC96A660F9CAB40FC(iLocal_52[1]))
			{
				return 1;
			}
		}
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_52[1]) && !unk_0xE5965CDF24F93A9F(iLocal_52[0]))
		{
			if (unk_0xF68107C40359970C(iLocal_52[1]))
			{
				return 1;
...
void func_2()
{
	if (unk_0xF68107C40359970C(iLocal_52[0]))
	{
		if (unk_0x12DD4A0B247D9B4D(uLocal_87[0]))
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_56))
			{
				if (unk_0xE85F749F6D5C809E(iLocal_56))
			...
			func_3(&uLocal_138, 4);
			unk_0xFFD8EB5462B07B59(&(uLocal_87[0]));
		}
	}
	if (unk_0xF68107C40359970C(iLocal_52[1]))
	{
		if (unk_0x12DD4A0B247D9B4D(uLocal_87[1]))
		{
			func_3(&uLocal_138, 3);
			unk_0xFFD8EB5462B07B59(&(uLocal_87[1]));
		}
	}
	if (unk_0xF68107C40359970C(iLocal_51))
	{
		...
		{
			func_3(&uLocal_138, 5);
			unk_0xFFD8EB5462B07B59(&uLocal_88);
		}
	}
}
	...
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if (!unk_0xF68107C40359970C(iLocal_52[0]) || !unk_0xF68107C40359970C(iLocal_52[1]))
		{
			if (!func_12())
			{
				...
				{
					case 0:
						if (iLocal_84 < unk_0x320D1840B6DAA1CC())
						{
							if (func_71(&uLocal_138, "REBU2AU", "REBU2_ATT", 4, 0, 0, 0))
							{
								iLocal_84 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(3500, 5000));
								iLocal_128++;
							}
						}
						break;
...
void func_19()
{
	...
	{
		func_21(13, floor(Global_112915.f_10194.f_3853));
	}
...
void func_47()
{
	...
	{
		case 0:
			if (!unk_0xF68107C40359970C(iLocal_51) && unk_0x55A0C756C4A8220C(iLocal_55, 0))
			{
				if (unk_0x611AD675982BEBCC(iLocal_51))
				{
					unk_0x6221A52631154EF7(iLocal_51);
				...
				unk_0xA7266A50941DBAEA(iLocal_51, 1);
				unk_0xA888F8CC04F25CC8(&uLocal_59);
				unk_0xF30F15F203736DE4(0, unk_0xE2D3D51028F0428A(), 5000, 2048, 2);
				unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 0);
				unk_0xB486640392EC50BB(0, iLocal_55, -1, 0, 1f, 1, 0);
				unk_0xC963A45B50851768(uLocal_59);
				unk_0x8ACADA903FCAA42F(iLocal_51, uLocal_59);
				unk_0x7461D7C5BA953BC7(&uLocal_59);
				unk_0xABC2CA6F28903308(iLocal_51, 1);
				func_110();
				wait(0);
		...
		case 1:
			if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
			{
				if (unk_0xF6F5D18EF8EAB859(iLocal_51, iLocal_55, 0))
				{
					if (!unk_0xF68107C40359970C(iLocal_53))
					{
						unk_0xAD6CDBCDA713560A(iLocal_53, iLocal_54, 10f, 786599);
						unk_0xABC2CA6F28903308(iLocal_53, 1);
					}
					unk_0x11647D34B93A72EB(iLocal_55, 1);
					iLocal_110++;
				}
			}
			break;
...
void func_48()
{
	...
	{
		case 0:
			unk_0x9972EFADA7A2A47D(255, iLocal_137, 1862763509);
			unk_0x9972EFADA7A2A47D(255, 1862763509, iLocal_137);
		...
		case 2:
			if (unk_0x55A0C756C4A8220C(iLocal_55, 0))
			{
				if (unk_0xF6F5D18EF8EAB859(iLocal_51, iLocal_55, 0))
				{
					if (!unk_0xF68107C40359970C(iLocal_53))
					{
						unk_0xAD6CDBCDA713560A(iLocal_53, iLocal_55, 10f, 786599);
						unk_0xABC2CA6F28903308(iLocal_53, 1);
					}
					unk_0x11647D34B93A72EB(iLocal_55, 1);
					iLocal_110++;
...
void func_52()
{
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if ((((((func_56("REBU2_LV2_2") || func_56("REBU2_LV2_3")) || func_56("REBU2_LV2_4")) || func_56("REBU2_LV2_5")) || func_56("REBU2_LV2_6")) || func_56("REBU2_LV2_7")) || func_56("REBU2_LV2_8"))
		{
			...
			unk_0xC89EA639A6F338A6(iLocal_51);
		}
		if (func_56("REBU2_LV2_9") || iLocal_66 > 1)
		{
			unk_0x57CAA5FBF134D4AE(iLocal_51, 0, 1);
		}
	}
	if (func_70() && !func_12())
	{
		...
		switch (iLocal_66)
		{
			...
			case 1:
				iLocal_67 = unk_0x320D1840B6DAA1CC() + 1500;
				iLocal_66++;
				break;
			
			case 2:
				if (iLocal_67 < unk_0x320D1840B6DAA1CC())
				{
			...
			case 4:
				iLocal_67 = unk_0x320D1840B6DAA1CC() + 500;
				iLocal_66++;
				break;
			...
			case 17:
				iLocal_67 = unk_0x320D1840B6DAA1CC() + 1000;
				iLocal_66++;
				break;
			...
			case 19:
				iLocal_67 = unk_0x320D1840B6DAA1CC() + 2500;
				iLocal_66++;
				break;
...
void func_58()
{
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if (!iLocal_107)
		{
			if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
			{
				if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), unk_0x9993EF7FDBCDB632(), 1) && unk_0xF6F5D18EF8EAB859(iLocal_51, unk_0x9993EF7FDBCDB632(), 0))
				{
		...
		{
			if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), unk_0x9993EF7FDBCDB632(), 0) && unk_0xF6F5D18EF8EAB859(iLocal_51, unk_0x9993EF7FDBCDB632(), 0))
			{
				iLocal_107 = 0;
			}
		}
	...
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 1))
		{
			if (!func_62())
			{
				...
				{
					unk_0xC149E50FBB27DD70(iLocal_51, unk_0xE2D3D51028F0428A(), -1, 6f, 2f, 1073741824, 0);
				}
				if (unk_0xD5C6B5E3B93A5EDC(iLocal_51, 0))
				{
					unk_0xAB7639D658BBCCEE(iLocal_51, 0, 4194304);
				}
				if (!iLocal_106)
				{
					func_87(0);
		...
		{
			unk_0xF23E6F5690771F71(iLocal_51, func_60());
...
void func_63()
{
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if (unk_0x3C7ED37A9FE7C585(iLocal_51))
		{
			if (!iLocal_130)
			{
	...
	if ((iLocal_132 - iLocal_131) > 180000)
	{
		if (!unk_0xF68107C40359970C(iLocal_51))
		{
			...
			{
				unk_0x6221A52631154EF7(iLocal_51);
				if (unk_0x8F41785F110B0DA0(iLocal_51, Local_113, 100f, 100f, 100f, 0, 1, 0))
				{
					unk_0x7D1424753688EE7A(iLocal_51, 1740.797f, 4648.756f, 42.6529f, 1f, -1, 1048576000, 0, 1193033728);
					unk_0xABC2CA6F28903308(iLocal_51, 1);
				}
				func_110();
				wait(0);
	...
	if ((iLocal_135 - iLocal_134) > 120000)
	{
		if (!unk_0xF68107C40359970C(iLocal_51))
		{
			if (unk_0x611AD675982BEBCC(iLocal_51))
			{
				...
				if (unk_0x8F41785F110B0DA0(iLocal_51, Local_113, 100f, 100f, 100f, 0, 1, 0))
				{
					unk_0x7D1424753688EE7A(iLocal_51, Local_113, 1f, -1, 1048576000, 0, 1193033728);
					unk_0xABC2CA6F28903308(iLocal_51, 1);
				}
				else
				{
...
void func_65()
{
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_51, 8f, 8f, 8f, 0, 1, 0) || unk_0x4DA360FC7C3CFEFA(unk_0xE2D3D51028F0428A()))
		{
			if ((unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && !unk_0xF6F5D18EF8EAB859(iLocal_51, unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0)) && !unk_0x4DA360FC7C3CFEFA(unk_0xE2D3D51028F0428A()))
			{
				if (!unk_0x12DD4A0B247D9B4D(uLocal_88))
				{
		...
		else if (!unk_0x12DD4A0B247D9B4D(uLocal_88))
		{
			uLocal_88 = func_68(iLocal_51, 0, 145);
		}
		if (!unk_0x611AD675982BEBCC(iLocal_51))
		{
			if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_51, 8f, 8f, 8f, 0, 1, 0))
			{
				unk_0x03A927199A2DFE46(iLocal_51);
				unk_0xF23E6F5690771F71(iLocal_51, func_60());
				unk_0x508EA490C0230199(iLocal_51, 1);
		...
		if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_51, 150f, 150f, 150f, 0, 1, 0))
		{
			func_4();
		}
	}
...
var func_66(struct<3> Param0, int iParam1)
{
	var uVar0;
...
int func_70()
{
	if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
	{
		iLocal_129 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
		if (unk_0x55A0C756C4A8220C(iLocal_129, 0))
		{
			if (!unk_0xF68107C40359970C(iLocal_51))
			{
				if (unk_0x87B449F4C26E764A(iLocal_51, iLocal_129))
				{
					return 1;
				}
			}
...
void func_87(bool bParam0)
{
	if (bParam0)
	{
		if (iLocal_119)
		{
			if (!unk_0xACC32B78196FBC2A(&Local_121))
			{
...
void func_91()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_51))
	{
		if (!unk_0xF68107C40359970C(iLocal_51))
		{
			unk_0x3E3D339BAD67F6F2(iLocal_51, 394, 1);
		}
		if (unk_0x0747E45CFF1F74AA(iLocal_51, unk_0xE2D3D51028F0428A(), 1))
		{
			if (!unk_0xF68107C40359970C(iLocal_51))
			{
				unk_0x7734082B0EDB0BE0(iLocal_51, unk_0xE2D3D51028F0428A(), 150f, -1, 0, 0);
				unk_0xABC2CA6F28903308(iLocal_51, 1);
			}
			if (!unk_0xF68107C40359970C(iLocal_53))
			{
				unk_0x9972EFADA7A2A47D(5, iLocal_137, 1862763509);
				unk_0xC1A74225341AA9FB(iLocal_53, unk_0xE2D3D51028F0428A(), 0, 16);
				unk_0xABC2CA6F28903308(iLocal_53, 1);
			}
			func_110();
			wait(0);
...
void func_92()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_51))
	{
		if ((unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_51, 1.2f, 1.2f, 5f, 0, 1, 0) && unk_0x3C7ED37A9FE7C585(unk_0xE2D3D51028F0428A())) && !unk_0x32DCDA1B2F8A0694(unk_0xE2D3D51028F0428A()))
		{
			if (func_49(1, 0, 1))
			{
				bLocal_104 = true;
				if (!iLocal_89)
				{
					...
					if (unk_0xE5965CDF24F93A9F(unk_0x9993EF7FDBCDB632()))
					{
						...
						if (unk_0x77A43AFA9AAEC041(unk_0x9993EF7FDBCDB632(), iLocal_51, 5f, 5f, 5f, 0, 1, 0) || unk_0x8F41785F110B0DA0(unk_0x9993EF7FDBCDB632(), Local_74, 5f, 5f, 5f, 0, 1, 0))
						{
							unk_0xC64B6E13A6A7F517(unk_0x9993EF7FDBCDB632(), unk_0x6B62510F212526DC(iLocal_51, 1) - Vector(0f, 3f, 5f), 0, 0, 0, 1);
							if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
							{
					...
					{
						if (unk_0xEF9410C312F2B117(iLocal_54))
						{
							func_98(iLocal_54);
							unk_0x2EE80CD0EAEB9B5B(iLocal_54, 200f);
						}
						if (unk_0x77A43AFA9AAEC041(iLocal_54, iLocal_51, 8f, 8f, 8f, 0, 1, 0))
						{
							unk_0xC64B6E13A6A7F517(iLocal_54, Local_74, 0, 0, 0, 1);
							if (!unk_0x55B23FE400FCEA6B(iLocal_54, 0))
							{
					...
					if (!unk_0xF68107C40359970C(iLocal_51))
					{
						iLocal_129 = unk_0xFE15FEB341652241(unk_0x6B62510F212526DC(iLocal_51, 1), 5f, 0, 2);
						if (!unk_0x55B23FE400FCEA6B(iLocal_129, 0))
						{
							if (unk_0xEF9410C312F2B117(iLocal_129))
							{
								func_98(iLocal_129);
								unk_0x2EE80CD0EAEB9B5B(iLocal_129, 200f);
							}
							unk_0xC64B6E13A6A7F517(iLocal_129, unk_0x6B62510F212526DC(iLocal_51, 1) + Vector(0f, 5f, 5f), 1, 0, 0, 1);
						}
					}
					unk_0x85050CAC8798CDD0(Local_72, 10f);
					unk_0x917F631782A9CB32(Local_72, 10f, 0);
					unk_0x02B222EADC9DC566(Local_72, 4.5f, 0, 0, 0, 0, 0, 0, 0);
					unk_0xC64B6E13A6A7F517(iLocal_51, Local_72, 1, 0, 0, 1);
					unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Local_72, 1, 0, 0, 1);
					if (!unk_0xF68107C40359970C(iLocal_51))
					{
					}
					iVar0 = 0;
					while (iVar0 < iLocal_52)
					{
						...
						{
							if (unk_0x8F41785F110B0DA0(iLocal_52[iVar0], unk_0x6B62510F212526DC(iLocal_51, 0), 1.5f, 1.5f, 1.5f, 0, 1, 0))
							{
								unk_0x05CB75C0837196F9(&(iLocal_52[iVar0]));
							}
						}
						iVar0++;
					}
					if (!unk_0xF68107C40359970C(iLocal_51))
					{
						uLocal_303 = unk_0x8F5F4164BF5FB513(163.449f, 6839.993f, 18.88f, 0f, 0f, 0f, 2);
						uLocal_71 = unk_0xB93A4265CB0F5B1F("DEFAULT_ANIMATED_CAMERA", 0);
						unk_0x7B8CE3A05613F41C(uLocal_71, uLocal_303, "untie_cam", "random@burial");
						...
						unk_0xF160248D9083ED0C(iLocal_51, 200, 0);
						unk_0xA1B68DBB639CAFD5(iLocal_51, 0);
						unk_0xA8921DC376420B57(iLocal_51, 0);
						unk_0x51BB443B279E4104(iLocal_51);
						unk_0x950B26F4C891073F(iLocal_51, uLocal_303, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
						unk_0xEB087B19F63AB053(iLocal_51, 0, 0);
						unk_0x950B26F4C891073F(unk_0xE2D3D51028F0428A(), uLocal_303, "random@burial", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xEB087B19F63AB053(unk_0xE2D3D51028F0428A(), 0, 0);
						unk_0xAA8557AFE4A4A184(uLocal_57[0], uLocal_303, "untie_legstie", "random@burial", 1000f, -1000f, 0, 1148846080);
						unk_0xAA8557AFE4A4A184(uLocal_57[1], uLocal_303, "untie_wristtie", "random@burial", 1000f, -1000f, 0, 1148846080);
						unk_0xDD786B89B15AA63F(uLocal_71, 1);
	...
	if (iLocal_89 && !iLocal_91)
	{
		...
		if (unk_0xCE2C78E9FC0B01E3(uLocal_303))
		{
			if ((unk_0x54DE1614490C2A83(uLocal_303) > 0.115f && unk_0x54DE1614490C2A83(uLocal_303) < 0.12f) || (unk_0x54DE1614490C2A83(uLocal_303) > 0.355f && unk_0x54DE1614490C2A83(uLocal_303) < 0.36f))
			{
				unk_0x91DFC8F68F6D9B05(-1, "ROPE_CUT", "ROPE_CUT_SOUNDSET", 1);
			}
			if (unk_0x54DE1614490C2A83(uLocal_303) > 0.6f)
			{
				if (!iLocal_90)
				{
					func_110();
		...
		if (((iLocal_93 - iLocal_94) > 9700 && !iLocal_97) && unk_0x2B1D7439C26D5642() == 4)
		{
	...
	if (iLocal_91 && !bLocal_96)
	{
		...
		unk_0xE0F81EAEB49D39EF(uLocal_303, 1f);
		unk_0x51BB443B279E4104(unk_0xE2D3D51028F0428A());
		unk_0xEB087B19F63AB053(unk_0xE2D3D51028F0428A(), 0, 0);
		...
		if (!unk_0xF68107C40359970C(iLocal_51))
		{
			...
			unk_0xC64B6E13A6A7F517(iLocal_51, 164.4963f, 6839.333f, 18.9657f, 1, 0, 0, 1);
			unk_0xBBF86885619695CE(iLocal_51, 73.449f);
		}
		unk_0x94953C3FF0664F66(26.1578f);
		unk_0x080C97B891E2F3AA(-8.1198f, 1065353216);
		unk_0xDD786B89B15AA63F(uLocal_71, 0);
		unk_0x850D4EF3D40FB068(0, 0, 3000, 1, 0, 0);
		unk_0x588DDCB644C6486A(uLocal_71, 0);
		...
		if (bLocal_96)
		{
			if (!iLocal_95)
			{
				if (!func_12())
				{
					...
					unk_0x9972EFADA7A2A47D(1, iLocal_137, 1862763509);
					unk_0x9972EFADA7A2A47D(1, 1862763509, iLocal_137);
					unk_0xA888F8CC04F25CC8(&uLocal_59);
					...
					{
						if (unk_0x77A43AFA9AAEC041(iLocal_51, unk_0x9993EF7FDBCDB632(), 20f, 20f, 20f, 0, 1, 0) && unk_0xADD893BD545BE5FC(unk_0x9993EF7FDBCDB632()) > 0)
						{
					...
					if (func_45() == 2 && !func_9())
					{
						if (!unk_0x12DD4A0B247D9B4D(uLocal_112))
						{
							...
							unk_0x1A5B5BA56167D412(uLocal_112, 269);
							func_94();
						}
					}
					func_93();
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < unk_0x320D1840B6DAA1CC())
				{
					if (func_71(&uLocal_138, "REBU2AU", "REBU2_HPF", 4, 0, 0, 0))
					{
						iLocal_84 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(4000, 5500));
						iLocal_128++;
					}
				}
				break;
...
void func_112()
{
	if (!iLocal_61 && unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_85, 30f, 30f, 30f, 0, 1, 0))
	{
		if (!unk_0xF68107C40359970C(iLocal_52[1]))
		{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_54, 0))
	{
		if (!unk_0xF68107C40359970C(iLocal_52[0]))
		{
			unk_0xB69D13E19147910F(iLocal_52[0], iLocal_54, unk_0xE2D3D51028F0428A(), 8, 30f, 262144, -1f, 10f, 1);
			unk_0xABC2CA6F28903308(iLocal_52[0], 1);
		}
		if (!unk_0xF68107C40359970C(iLocal_52[1]))
		{
			unk_0xB486640392EC50BB(iLocal_52[1], iLocal_54, -1, 0, 3f, 1, 0);
			unk_0xABC2CA6F28903308(iLocal_52[1], 1);
		}
	}
	else
	{
		...
		while (iLocal_58 <= 1)
		{
			if (!unk_0xF68107C40359970C(iLocal_52[iLocal_58]))
			{
				unk_0x7734082B0EDB0BE0(iLocal_52[iLocal_58], unk_0xE2D3D51028F0428A(), 250f, -1, 0, 0);
				unk_0xABC2CA6F28903308(iLocal_52[iLocal_58], 1);
			}
			iLocal_58++;
		}
	}
...
void func_113()
{
	if (!unk_0xF68107C40359970C(iLocal_52[0]) && !unk_0xF68107C40359970C(iLocal_52[1]))
	{
		if (!unk_0xE10B76698E5CF067(iLocal_52[0]) && !unk_0xE10B76698E5CF067(iLocal_52[1]))
		{
			if (func_71(&uLocal_138, "REBU2AU", "REBU2_VH", 4, 0, 0, 0))
			{
				if (!unk_0xE323E6755636A70E(iLocal_52[1]))
				{
					unk_0x03A927199A2DFE46(iLocal_52[1]);
					unk_0x913E191F1F726271(iLocal_52[1], unk_0xE2D3D51028F0428A(), -1, -957453492);
				}
			}
		}
	}
...
void func_114()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_52[0]) && !unk_0xF68107C40359970C(iLocal_52[1]))
	{
		if (!iLocal_63)
		{
			...
			if (unk_0x2E7F5417D4F4DD69(iLocal_52[1], unk_0xE2D3D51028F0428A(), 90f))
			{
				func_110();
				wait(0);
				...
				if (!unk_0xF68107C40359970C(iLocal_52[0]) && !unk_0xF68107C40359970C(iLocal_52[1]))
				{
					fVar0 = func_116(iLocal_52[0], unk_0xE2D3D51028F0428A(), 1);
					if (fVar0 > 5f)
					{
						fVar0 = (fVar0 - 2f);
					}
					...
					unk_0xE6451C2F193342C7(iLocal_56, 0, 1);
					unk_0x9A97DC6DBC7B223D(iLocal_56, iLocal_52[0], unk_0xB897FCFCFA664B38(iLocal_52[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x03A927199A2DFE46(iLocal_52[0]);
					unk_0xA888F8CC04F25CC8(&uLocal_59);
					unk_0xF30F15F203736DE4(0, unk_0xE2D3D51028F0428A(), -1, 2048, 2);
					...
					unk_0x8ACADA903FCAA42F(iLocal_52[0], uLocal_59);
					unk_0x7461D7C5BA953BC7(&uLocal_59);
					unk_0x202B28FEABEC4034(iLocal_52[1], joaat("weapon_sawnoffshotgun"), 1);
					unk_0x03A927199A2DFE46(iLocal_52[1]);
					unk_0xA888F8CC04F25CC8(&uLocal_59);
					unk_0xF30F15F203736DE4(0, unk_0xE2D3D51028F0428A(), -1, 2048, 2);
		...
		if (iLocal_125 && !iLocal_126)
		{
			...
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[1], 30f, 30f, 30f, 0, 1, 0))
				{
					unk_0x636B3584208A6D73(iLocal_52[0], unk_0xE2D3D51028F0428A(), -1, 0);
				}
				iLocal_126 = 1;
				settimerb(0);
			}
		...
		if (iLocal_126 && !bLocal_127)
		{
			if (timerb() > 15000 && !func_12())
			{
				if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[1], 30f, 30f, 30f, 0, 1, 0))
				{
					unk_0x529D306014D3C29A(iLocal_52[0], unk_0xE2D3D51028F0428A(), 0);
					unk_0x529D306014D3C29A(iLocal_52[1], unk_0xE2D3D51028F0428A(), 0);
					func_71(&uLocal_138, "REBU2AU", "REBU2_SHO", 4, 0, 0, 0);
					bLocal_127 = true;
				}
			}
		}
		if (((!iLocal_64 && iLocal_125) && !unk_0xF68107C40359970C(iLocal_52[0])) && !unk_0xF68107C40359970C(iLocal_52[1]))
		{
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[0], 30f, 30f, 30f, 0, 1, 0) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_52[1], 30f, 30f, 30f, 0, 1, 0))
			{
				if (!func_12())
			...
			{
				unk_0xA888F8CC04F25CC8(&uLocal_59);
				unk_0xC149E50FBB27DD70(0, iLocal_52[1], -1, 2f, 1f, 1073741824, 0);
				unk_0x529D306014D3C29A(0, iLocal_52[1], 0);
				unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				unk_0xC963A45B50851768(uLocal_59);
				unk_0x8ACADA903FCAA42F(iLocal_52[0], uLocal_59);
				unk_0x7461D7C5BA953BC7(&uLocal_59);
				unk_0xA888F8CC04F25CC8(&uLocal_59);
				unk_0xC149E50FBB27DD70(0, iLocal_52[0], -1, 2f, 1f, 1073741824, 0);
				unk_0x529D306014D3C29A(0, iLocal_52[0], 0);
				unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
				unk_0xC963A45B50851768(uLocal_59);
				unk_0x8ACADA903FCAA42F(iLocal_52[1], uLocal_59);
				unk_0x7461D7C5BA953BC7(&uLocal_59);
		...
		if (((unk_0x7E006F2E24F03BB4(iLocal_52[0], unk_0xE2D3D51028F0428A()) || unk_0x7E006F2E24F03BB4(iLocal_52[1], unk_0xE2D3D51028F0428A())) || unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), iLocal_52[0])) || unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), iLocal_52[1]))
		{
...
void func_118()
{
	...
	if (!iLocal_115)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_52[0]))
		{
			if (!unk_0xF68107C40359970C(iLocal_52[0]))
			{
				unk_0x3E3D339BAD67F6F2(iLocal_52[0], 156, 1);
				if (unk_0xE5965CDF24F93A9F(iLocal_56))
				{
					unk_0x41FBE02637A70478(iLocal_52[0]);
					if (unk_0xE85F749F6D5C809E(iLocal_56))
					{
						if (!iLocal_64)
						{
							...
							unk_0x7461D7C5BA953BC7(&uLocal_59);
							unk_0xABC2CA6F28903308(iLocal_52[0], 1);
							unk_0xEB087B19F63AB053(iLocal_52[0], 0, 0);
							iLocal_115 = 1;
						}
					}
					else
	...
	if (!iLocal_116)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_52[1]))
		{
			if (!unk_0xF68107C40359970C(iLocal_52[1]))
			{
				unk_0x3E3D339BAD67F6F2(iLocal_52[1], 156, 1);
				unk_0x41FBE02637A70478(iLocal_52[1]);
				unk_0xA888F8CC04F25CC8(&uLocal_59);
				unk_0xC89EA639A6F338A6(0);
...
void func_128()
{
	...
	while (iLocal_58 <= 1)
	{
		if (!unk_0x12DD4A0B247D9B4D(uLocal_87[iLocal_58]))
		{
			if (!unk_0x55B23FE400FCEA6B(iLocal_52[iLocal_58], 0))
			{
		...
		switch (iLocal_128)
		{
			case 0:
				if (iLocal_84 < unk_0x320D1840B6DAA1CC())
				{
					...
					{
						iLocal_84 = (unk_0x320D1840B6DAA1CC() + unk_0x5853B15F78E1A265(4500, 6500));
						iLocal_128++;
					}
				}
				break;
...
void func_130()
{
	switch (iLocal_86)
	{
		...
		case 4:
			iLocal_84 = unk_0x320D1840B6DAA1CC() + 3000;
			iLocal_86++;
			break;
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_56))
	{
		if (unk_0xE85F749F6D5C809E(iLocal_56))
		{
			if (!unk_0xF68107C40359970C(iLocal_52[0]))
			{
				if (unk_0xFCF559C8631ABED7(iLocal_52[0], "random@burial", "a_burial_stop", 3))
				{
					if (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial_stop") > 0.124f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.127f)
					{
						unk_0x74A35BFF0670ECD4("scr_burial_dirt", iLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1065353216, 0, 0, 0);
					}
				}
				if (unk_0xFCF559C8631ABED7(iLocal_52[0], "random@burial", "a_burial", 3))
				{
					if (((((unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") > 0.04f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.043f) || (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") > 0.24f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.243f)) || (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") > 0.44f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.443f)) || (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") > 0.64f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.643f)) || (unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") > 0.84f && unk_0xD01FAFCE275C94F3(iLocal_52[0], "random@burial", "a_burial") < 0.843f))
					{
						unk_0x74A35BFF0670ECD4("scr_burial_dirt", iLocal_56, 0f, 0f, -0.95f, 0f, 180f, 0f, 1065353216, 0, 0, 0);
					}
				}
...
int func_132()
{
	if (!iLocal_103)
	{
		if (unk_0x9AC74C7EF847A074(Local_74, 100f, 1) || unk_0x9AC74C7EF847A074(Local_74, 100f, 1))
		{
			if (unk_0xF68107C40359970C(iLocal_52[0]) || unk_0xF68107C40359970C(iLocal_52[1]))
			{
				iLocal_49 = 1;
		...
		if (unk_0xE5965CDF24F93A9F(iLocal_54))
		{
			if (!unk_0x55B23FE400FCEA6B(iLocal_54, 0))
			{
				if (unk_0x0747E45CFF1F74AA(iLocal_54, unk_0xE2D3D51028F0428A(), 1) || unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_54, 0))
				{
				...
				if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					...
					{
						if (unk_0x671CB92F637FDB33(unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), iLocal_54))
						{
							func_118();
							iLocal_49 = 3;
							return 1;
		...
		if (!iLocal_69)
		{
			if (!unk_0xF68107C40359970C(iLocal_52[0]) && !unk_0xF68107C40359970C(iLocal_52[1]))
			{
				if ((((unk_0x7E006F2E24F03BB4(iLocal_52[0], unk_0xE2D3D51028F0428A()) || unk_0x7E006F2E24F03BB4(iLocal_52[1], unk_0xE2D3D51028F0428A())) || unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), iLocal_52[0])) || unk_0x42A51C8E69566474(unk_0x9E2D6C50374FCFA9(), iLocal_52[1])) || unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_74 - Vector(0f, 0f, 7f), 20f, 15f, 35f, 0, 1, 0))
				{
					if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_74 - Vector(0f, 0f, 7f), 28f, 18f, 35f, 0, 1, 0))
					{
						iLocal_49 = 1;
						return 1;
					}
		...
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			if (!unk_0xF68107C40359970C(iLocal_52[0]) && !unk_0xF68107C40359970C(iLocal_52[1]))
			{
				if (!unk_0x55B23FE400FCEA6B(unk_0x9993EF7FDBCDB632(), 0))
				{
					if (unk_0x72F6AE51B7E34865(unk_0x9993EF7FDBCDB632(), iLocal_52[0]) || unk_0x72F6AE51B7E34865(unk_0x9993EF7FDBCDB632(), iLocal_52[1]))
					{
						iLocal_49 = 5;
						return 1;
					}
		...
		if (!unk_0xF68107C40359970C(iLocal_51))
		{
			if (unk_0x0747E45CFF1F74AA(iLocal_51, unk_0xE2D3D51028F0428A(), 0) || unk_0xEEF1A3C0E56FC8FF(iLocal_51, joaat("weapon_stungun"), 0))
			{
				iLocal_49 = 4;
				return 1;
			}
		...
		if (unk_0x55B23FE400FCEA6B(iLocal_52[0], 0) || unk_0x55B23FE400FCEA6B(iLocal_52[1], 0))
		{
			iLocal_49 = 6;
			return 1;
		}
...
void func_140()
{
	...
	func_142(43, 1);
	func_142(44, 1);
	unk_0x2915D98110F23A29(Local_113 - Vector(20f, 40f, 40f), Local_113 + Vector(20f, 40f, 40f), 0, 1, 1, 1);
	unk_0x2915D98110F23A29(Local_72 - Vector(20f, 50f, 60f), Local_72 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	unk_0x7CD708DEB04F8474(iLocal_83, 1);
	unk_0x07CECF421D895F3D(5, 0);
	unk_0x07CECF421D895F3D(3, 0);
	unk_0x8576657A629C4B0A(0f);
	iLocal_51 = unk_0xA8D58C3AADA2C41C(26, iLocal_80, Local_72, fLocal_77, 1, 1);
	unk_0x50274A7EACA3133A(iLocal_51, 1);
	unk_0xA7266A50941DBAEA(iLocal_51, 0);
	unk_0xDC6110E0F8FF9DA0(iLocal_51, 2, 0);
	unk_0xDC6110E0F8FF9DA0(iLocal_51, 128, 1);
	unk_0xBC12D08EE7559CCD(iLocal_51, 1, 0);
	unk_0xBC12D08EE7559CCD(iLocal_51, 6, 0);
	unk_0xD6A76BAB45A4B460(iLocal_51, 206, 1);
	unk_0xD6A76BAB45A4B460(iLocal_51, 318, 0);
	unk_0xD6A76BAB45A4B460(iLocal_51, 118, 0);
	unk_0xD6A76BAB45A4B460(iLocal_51, 208, 1);
	unk_0xF1A23B343DFEDFD0(iLocal_80);
	unk_0xF160248D9083ED0C(iLocal_51, iLocal_99, 0);
	unk_0x3F990964E4A5669A(unk_0xE2D3D51028F0428A(), 0);
	unk_0xD642E010A287ADFD("rghKidnappers", &iLocal_136);
	unk_0xD642E010A287ADFD("rghVictim", &iLocal_137);
	unk_0xFF4BEB6CFF55A013(iLocal_51, iLocal_137);
	iLocal_58 = 0;
	while (iLocal_58 <= 1)
	{
		iLocal_52[iLocal_58] = unk_0xA8D58C3AADA2C41C(26, iLocal_81, Local_73[iLocal_58 /*3*/], fLocal_78[iLocal_58], 1, 1);
		unk_0x50274A7EACA3133A(iLocal_52[iLocal_58], 1);
		unk_0x80476B7F23BCBB1B(iLocal_52[iLocal_58], 1);
		unk_0xBC12D08EE7559CCD(iLocal_52[iLocal_58], 0, 1);
		unk_0xDC6110E0F8FF9DA0(iLocal_52[iLocal_58], 2, 0);
		unk_0xDC6110E0F8FF9DA0(iLocal_52[iLocal_58], 128, 1);
		unk_0xD6A76BAB45A4B460(iLocal_52[iLocal_58], 42, 1);
		unk_0x71B502FC2E129665(iLocal_52[0], 2);
		unk_0xBC12D08EE7559CCD(iLocal_52[0], 50, 1);
		unk_0xC97BA48BC273A1F3(iLocal_52[iLocal_58], 50);
		unk_0x348A212511C78DBF(iLocal_52[iLocal_58], 13);
		unk_0x006574E87E6F1942(iLocal_52[iLocal_58], 1, 1);
		unk_0xFF4BEB6CFF55A013(iLocal_52[iLocal_58], iLocal_136);
		unk_0x62BDDA84CCCF90A9(iLocal_52[iLocal_58], unk_0x5853B15F78E1A265(800, 2000));
		iLocal_58++;
	}
	unk_0xF1A23B343DFEDFD0(iLocal_82);
	unk_0xF1A23B343DFEDFD0(iLocal_81);
	unk_0xC97BA48BC273A1F3(iLocal_52[1], 100);
	unk_0x8913620F26B565CE(iLocal_52[1], -687903391);
	unk_0x9972EFADA7A2A47D(5, iLocal_136, 1862763509);
	unk_0x9521FB98DB6DDF50(iLocal_52[0], joaat("weapon_pistol"), -1, 0, 1);
	unk_0x9521FB98DB6DDF50(iLocal_52[1], joaat("weapon_sawnoffshotgun"), -1, 0, 1);
	iLocal_54 = unk_0xBA715A7BEBA5A1F9(iLocal_83, Local_74, fLocal_79, 1, 1, 0);
	unk_0x9F65B3BAFA302A65(iLocal_54, 1084227584);
	unk_0xE5283B3A324D3FB0(iLocal_54, 3);
	unk_0x2476BE9932670CAD(iLocal_54, 5, 0, 0);
	unk_0xF1A23B343DFEDFD0(iLocal_83);
	iLocal_56 = unk_0x0E536D72AB30F4C8(joaat("prop_ld_shovel"), Local_85, 1, 1, 0);
	unk_0xF1A23B343DFEDFD0(joaat("prop_ld_shovel"));
	uLocal_57[0] = unk_0x0E536D72AB30F4C8(joaat("p_arm_bind_cut_s"), Local_85, 1, 1, 0);
	uLocal_57[1] = unk_0x0E536D72AB30F4C8(joaat("p_arm_bind_cut_s"), Local_85 + Vector(1f, 1f, 1f), 1, 1, 0);
	unk_0xD69A0C3662175E68(joaat("p_arm_bind_cut_s"));
	unk_0x9A97DC6DBC7B223D(iLocal_56, iLocal_52[0], unk_0xB897FCFCFA664B38(iLocal_52[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	unk_0xE3752B10DC995E95(iLocal_52[0], 0, 0, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_52[0], 3, 0, 1, 0);
	unk_0xE3752B10DC995E95(iLocal_52[0], 4, 1, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_52[1], 0, 0, 2, 0);
	unk_0xE3752B10DC995E95(iLocal_52[1], 3, 2, 1, 0);
	unk_0xE3752B10DC995E95(iLocal_52[1], 4, 1, 1, 0);
	Var0 = { Local_72 };
	Var1 = { -2f, -4f, 18f };
	uLocal_303 = unk_0x8F5F4164BF5FB513(Var0, Var1, 2);
	unk_0x950B26F4C891073F(iLocal_51, uLocal_303, "random@burial", "b_burial", 4f, -4f, 1, 0, 1148846080, 0);
	unk_0xAA8557AFE4A4A184(uLocal_57[0], uLocal_303, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
	unk_0xAA8557AFE4A4A184(uLocal_57[1], uLocal_303, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
	unk_0xFE1CD80C2F7CBCFB(uLocal_303, 1);
	unk_0xABC2CA6F28903308(iLocal_51, 1);
	unk_0x49D97B076E3590AC(iLocal_52[0], "random@burial", "a_burial", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x49D97B076E3590AC(iLocal_52[1], "random@burial", "c_burial", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0x0913ED93C4AB21CF(iLocal_52[0], Local_75, Local_76, 2.75f, 0, 0);
	unk_0x0913ED93C4AB21CF(iLocal_52[1], Local_75, Local_76, 2.75f, 0, 0);
	if (func_45() == 0)
	{
		func_141(&uLocal_138, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
	}
	else if (func_45() == 1)
	{
		func_141(&uLocal_138, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	}
	else if (func_45() == 2)
	{
		func_141(&uLocal_138, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
	}
	unk_0xEEBC95A38CBDED42(iLocal_52[0], "A_M_M_HillBilly_02_WHITE_MINI_03");
	unk_0xEEBC95A38CBDED42(iLocal_52[1], "A_M_M_HillBilly_02_WHITE_MINI_02");
	unk_0xEEBC95A38CBDED42(iLocal_51, "KIDNAPPEDFEMALE");
...
void func_151()
{
	unk_0xD69A0C3662175E68(iLocal_80);
	unk_0xD69A0C3662175E68(iLocal_82);
	unk_0xD69A0C3662175E68(iLocal_81);
	...
	if (((((((((unk_0x0152AA00FA3130F1(iLocal_80) && unk_0x0152AA00FA3130F1(iLocal_82)) && unk_0x0152AA00FA3130F1(iLocal_81)) && unk_0x0152AA00FA3130F1(iLocal_83)) && unk_0x0152AA00FA3130F1(joaat("prop_ld_shovel"))) && unk_0x0152AA00FA3130F1(joaat("p_arm_bind_cut_s"))) && unk_0x6F940C2636C076AD("random@burial")) && unk_0x51B6C2EF8DBE2E1A()) && unk_0x70F555A7CCF10659("ROPE_CUT", 0, -1)) && unk_0x63B063064DC08617("RE6_BOTH_DEAD_OS"))
	{
		bLocal_50 = true;
	}
	else
...
int func_153()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_164())
		{
			return 0;
		}
	}
...
int func_170(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_206(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_184(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (iLocal_122)
	{
		...
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			if (!unk_0xF68107C40359970C(iLocal_51))
			{
				...
				if (!unk_0xD5C6B5E3B93A5EDC(iLocal_51, 0))
				{
					unk_0x4731A59F8DC19173(iLocal_51);
				}
				if (unk_0x611AD675982BEBCC(iLocal_51))
				{
					unk_0x6221A52631154EF7(iLocal_51);
		...
		while (iVar0 < iLocal_52)
		{
			if (!unk_0xF68107C40359970C(iLocal_52[iVar0]) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				unk_0x41FBE02637A70478(iLocal_52[iVar0]);
				if (iLocal_63 || iLocal_70)
				{
					unk_0xC1A74225341AA9FB(iLocal_52[iVar0], unk_0xE2D3D51028F0428A(), 0, 16);
				}
				else
				{
					unk_0x7734082B0EDB0BE0(iLocal_52[iVar0], unk_0xE2D3D51028F0428A(), 1000f, -1, 0, 0);
		...
		unk_0x4BDA5AFD88C085EB(&(uLocal_57[0]));
		unk_0x4BDA5AFD88C085EB(&(uLocal_57[1]));
		if (unk_0xE5965CDF24F93A9F(iLocal_54))
		{
		...
		while (iLocal_58 <= 1)
		{
			if (unk_0x12DD4A0B247D9B4D(uLocal_87[iLocal_58]))
			{
				unk_0xFFD8EB5462B07B59(&(uLocal_87[iLocal_58]));
			}
			iLocal_58++;
		}
		if (unk_0x12DD4A0B247D9B4D(uLocal_88))
		...
		if (unk_0x876B1078E90C91CB(uLocal_71))
		{
			unk_0x588DDCB644C6486A(uLocal_71, 0);
		}
