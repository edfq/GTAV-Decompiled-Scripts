	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				...
				unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_85.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar7 = unk_0x57736A7B8965A88A(uParam0->f_85.f_1);
			if (unk_0xCE2C78E9FC0B01E3(uVar7))
			{
				if (unk_0x54DE1614490C2A83(uVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_85.f_1 = unk_0x497E09037A63D346(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_85.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x60E9DD146055C13E(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 8:
			uVar8 = unk_0x57736A7B8965A88A(uParam0->f_85.f_1);
