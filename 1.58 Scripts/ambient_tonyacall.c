...
int func_1()
{
	...
	if ((vdist2(Var0, Var1) > 10000f || unk_0x55B23FE400FCEA6B(uLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0xE5965CDF24F93A9F(uLocal_38) && !unk_0x55B23FE400FCEA6B(uLocal_38, 0))
			{
				if (unk_0x8F41785F110B0DA0(uLocal_38, Local_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x8ACADA903FCAA42F(uLocal_38, uVar2);
					unk_0x7461D7C5BA953BC7(&uVar2);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xE5965CDF24F93A9F(uLocal_38) && !unk_0x55B23FE400FCEA6B(uLocal_38, 0))
			{
				if (unk_0x0829092F169950AB(uLocal_38) == 1)
				{
					if (!unk_0xE5965CDF24F93A9F(uLocal_39))
					{
						...
						{
							fVar3 = unk_0xD01FAFCE275C94F3(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar3 >= 0.157f)
							{
				...
				{
					iVar4 = (unk_0x5853B15F78E1A265(0, 65535) % 2);
					if (iVar4 == 0)
					{
