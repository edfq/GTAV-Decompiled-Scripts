...
void func_1()
{
	switch (iLocal_269)
	{
		case 0:
			if (func_25(iLocal_67))
			{
				...
				if (!func_339())
				{
					...
					iLocal_270 = unk_0x320D1840B6DAA1CC() + 6000;
					if (bLocal_272)
					{
					...
					unk_0xD6A76BAB45A4B460(iLocal_67, 137, 1);
					iLocal_269++;
				}
			}
			else
		...
		case 1:
			if (func_25(iLocal_67))
			{
				if (func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0) || unk_0x320D1840B6DAA1CC() > iLocal_270)
				{
					iLocal_269++;
				}
			}
		...
		case 2:
			if (!func_339())
			{
				...
				iLocal_270 = unk_0x320D1840B6DAA1CC() + 500;
				iLocal_269++;
			}
			break;
		
		case 3:
			if (unk_0x320D1840B6DAA1CC() > iLocal_270 && unk_0xE9E8955A780DDA01())
			{
				if (!unk_0xF68107C40359970C(iLocal_67))
				{
					if (unk_0xD5C6B5E3B93A5EDC(iLocal_67, 0))
					{
						unk_0x279E52ABB546C567(iLocal_67, 1);
						unk_0xAD22EA15D9200B6E(iLocal_67, 200, 0, 0);
					}
					else
					{
						unk_0x33021F68EDB8F06E(iLocal_67, 500, 1000, 0, 0, 0, 0);
						unk_0xF160248D9083ED0C(iLocal_67, 0, 0);
					}
					iLocal_270 = unk_0x320D1840B6DAA1CC() + 2000;
					iLocal_269++;
				}
			}
			break;
		...
		case 4:
			if ((unk_0x320D1840B6DAA1CC() > iLocal_270 && func_9(&uLocal_76, "RECRAAU", sLocal_271, 3, 0, 0, 0)) || unk_0x320D1840B6DAA1CC() > iLocal_270 + 6000)
			{
				func_322();
			}
			break;
...
void func_26()
{
	...
	{
		case 0:
			if (!unk_0xF68107C40359970C(iLocal_67) && !unk_0xF68107C40359970C(iLocal_68))
			{
				if (unk_0x611AD675982BEBCC(iLocal_67) || unk_0x8F41785F110B0DA0(iLocal_67, Local_56, Global_22, 0, 1, 0))
				{
					func_208(1, 0, 1, 0);
			...
			if (iVar0 == 1)
			{
				...
				unk_0x7A997A0A971D305F(unk_0x6B62510F212526DC(iLocal_68, 1), 20f, 1, 0, 0, 0);
				unk_0x917F631782A9CB32(unk_0x6B62510F212526DC(iLocal_68, 1), 20f, 0);
				wait(0);
				iLocal_53 = 1;
			}
			break;
		...
		case 1:
			if (!unk_0xF68107C40359970C(iLocal_67) && !unk_0xF68107C40359970C(iLocal_68))
			{
				...
				{
					unk_0xF160248D9083ED0C(iLocal_67, 200, 0);
					...
					if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
					{
						...
						{
							unk_0xC64B6E13A6A7F517(iVar1, Local_56, 1, 0, 0, 1);
							unk_0xBBF86885619695CE(iVar1, 119f);
						}
					...
					unk_0xC64B6E13A6A7F517(iLocal_67, 1738.047f, 3842.438f, 33.7707f, 1, 0, 0, 1);
					unk_0xBBF86885619695CE(iLocal_67, 36.8203f);
					unk_0xEB087B19F63AB053(iLocal_67, 0, 0);
					unk_0x7A997A0A971D305F(Local_56, 4f, 1, 0, 0, 0);
					func_66(&iVar1);
					uLocal_259 = unk_0x8F5F4164BF5FB513(Local_72, Local_73, 2);
					unk_0x950B26F4C891073F(iLocal_67, uLocal_259, sLocal_257, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0x950B26F4C891073F(iLocal_68, uLocal_259, sLocal_257, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
					uLocal_75 = unk_0xB93A4265CB0F5B1F("DEFAULT_ANIMATED_CAMERA", 0);
					unk_0x7B8CE3A05613F41C(uLocal_75, uLocal_259, "HELPING_FRIEND_INSIDE_CAM", sLocal_257);
					unk_0xE0F81EAEB49D39EF(uLocal_259, fLocal_267);
		...
		case 4:
			if ((iLocal_274 && unk_0xCE2C78E9FC0B01E3(uLocal_259)) && unk_0x54DE1614490C2A83(uLocal_259) > 0.97f)
			{
			...
			if ((unk_0xCE2C78E9FC0B01E3(uLocal_259) && unk_0x54DE1614490C2A83(uLocal_259) >= fLocal_268) || func_63())
			{
...
void func_34()
{
	...
	{
		func_36(13, floor(Global_112915.f_10194.f_3853));
	}
...
int func_63()
{
	if (func_64(1000))
	{
		...
		if (unk_0x54DE1614490C2A83(uLocal_259) < 1f)
		{
			unk_0xE0F81EAEB49D39EF(uLocal_259, 1f);
		}
		return 1;
	}
	return 0;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_90(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_90(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_209()
{
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		if (unk_0xE10B76698E5CF067(iLocal_67))
		{
			bLocal_272 = true;
			iLocal_52 = 2;
			iLocal_269 = 5;
		}
		else if (unk_0x320D1840B6DAA1CC() < iLocal_270)
		{
			unk_0xA3400358EEE2B4A2(iLocal_67, 0);
			...
			if (func_221())
			{
				if (iLocal_70)
				{
					if (!func_220(unk_0xE2D3D51028F0428A(), 1935.53f, 6291.888f, 41.144f, 100f))
					{
						...
						func_66(&iLocal_71);
						if (unk_0x6B8F21F773404988(uLocal_265))
						{
							unk_0x0F53BC871BA89C94(uLocal_265, 0);
						}
						iLocal_70 = 0;
					}
					else
				...
				if (bLocal_244)
				{
					...
					else if (unk_0x0747E45CFF1F74AA(iLocal_68, unk_0xE2D3D51028F0428A(), 1) || func_214(iLocal_68, unk_0xE2D3D51028F0428A(), 1.25f, 1))
					{
						unk_0x03A927199A2DFE46(iLocal_68);
						unk_0x50274A7EACA3133A(iLocal_68, 0);
						unk_0x33021F68EDB8F06E(iLocal_68, 250, 500, 0, 0, 0, 0);
						unk_0x7734082B0EDB0BE0(iLocal_68, unk_0xE2D3D51028F0428A(), 500f, -1, 0, 0);
						unk_0xABC2CA6F28903308(iLocal_68, 1);
						bLocal_272 = true;
						iLocal_52 = 2;
						iLocal_269 = 0;
					}
					else if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_56, Global_19, 1, 1, 0) || unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, 1, 0))
					{
						iLocal_52 = 1;
						iLocal_53 = 0;
					}
				...
				if (unk_0x174B84F6B78D6CA7(iLocal_67) && unk_0x174B84F6B78D6CA7(unk_0xE2D3D51028F0428A()))
				{
					if (!unk_0x45052A4871A67255(iLocal_67))
					{
						...
						if (unk_0x174CED88B97C78D9(iLocal_67, -2017877118) == 7)
						{
							unk_0x49D97B076E3590AC(iLocal_67, sLocal_256, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
			else
			{
				...
				if (!func_214(unk_0xE2D3D51028F0428A(), iLocal_67, 200f, 1))
				{
					iLocal_52 = 2;
					iLocal_269 = 5;
				}
...
int func_210()
{
	...
	if (unk_0xD5C6B5E3B93A5EDC(iLocal_67, 0))
	{
		iVar0 = unk_0xB3FF0049C1FD38EC(iLocal_67, 0);
...
void func_212()
{
	if (!bLocal_244 && func_220(unk_0xE2D3D51028F0428A(), Local_56, 150f))
	{
		unk_0xD69A0C3662175E68(iLocal_246);
		unk_0x8FB472886552D737(sLocal_257);
		if ((unk_0x0152AA00FA3130F1(iLocal_246) && unk_0x6F940C2636C076AD(sLocal_257)) && unk_0x574E2A23F0F76E35(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			uLocal_245 = unk_0x87A467676BDF8C35(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 1, 0, 1);
			unk_0x5C65DDDC219B3AA5(uLocal_245, 1);
			Local_72 = { 1730.038f, 3853.562f, 34.661f };
			Local_73 = { 0f, 0f, 36f };
			iLocal_68 = unk_0xA8D58C3AADA2C41C(26, iLocal_246, 1728.778f, 3851.287f, 33.7826f, 211.7722f, 1, 1);
			unk_0x50274A7EACA3133A(iLocal_68, 1);
			func_213(&uLocal_76, 5, iLocal_68, "CrashSafehouse", 0, 1);
			uLocal_259 = unk_0x8F5F4164BF5FB513(Local_72, Local_73, 2);
			unk_0x950B26F4C891073F(iLocal_68, uLocal_259, sLocal_257, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_244 = true;
		}
	}
}
...
int func_216(struct<3> Param0, var uParam1)
{
	...
	unk_0xAAD76B24A5282FDD(iVar0, uParam1);
	return iVar0;
}
...
void func_218()
{
	if (unk_0xE5965CDF24F93A9F(iLocal_71))
	{
		if (unk_0x55A0C756C4A8220C(iLocal_71, 0))
		{
			iLocal_61 = unk_0x320D1840B6DAA1CC();
			if ((iLocal_61 - iLocal_62) < 1000)
			{
				unk_0xA3E3FC2853E2107B(iLocal_71, 1);
			}
			else if ((iLocal_61 - iLocal_62) > 2000)
			{
				unk_0xA3E3FC2853E2107B(iLocal_71, 0);
...
int func_221()
{
	...
	if (unk_0x2F52E009BBC0AFCE(iLocal_67, unk_0xFD8E434495EC2F26(unk_0x9E2D6C50374FCFA9())))
	{
		...
		else if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_67, 20f, 20f, 20f, 0, 1, 0) || !func_230())
		{
			unk_0x6221A52631154EF7(iLocal_67);
		}
		else if (unk_0x3C7ED37A9FE7C585(unk_0xE2D3D51028F0428A()))
		{
			if (!unk_0x3C7ED37A9FE7C585(iLocal_67))
			{
				if (unk_0x174CED88B97C78D9(iLocal_67, -828834893) == 7)
				{
					unk_0x03A927199A2DFE46(iLocal_67);
	...
	else if (unk_0x12DD4A0B247D9B4D(uLocal_65))
	{
		if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_67, Global_19, 0, 1, 0) && func_230())
		{
...
int func_230()
{
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
		{
			...
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				if (unk_0xF6F5D18EF8EAB859(iLocal_67, unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0), 0))
				{
					iLocal_264 = 0;
					return 1;
				}
...
void func_233()
{
	switch (iLocal_54)
	{
		case 0:
			iLocal_59 = 0;
			iLocal_54 = 1;
			iLocal_58 = unk_0x320D1840B6DAA1CC() + 1000;
			break;
		...
		case 2:
			...
			{
				iLocal_58 = unk_0x320D1840B6DAA1CC() + 1500;
				iLocal_59 = 0;
				iLocal_54 = 3;
			}
			break;
		...
		case 3:
			...
			{
				iLocal_58 = unk_0x320D1840B6DAA1CC() + 6000;
				iLocal_59 = 0;
				iLocal_54 = 4;
			}
			break;
		...
		case 4:
			if (iLocal_59 == 0)
			{
				if (unk_0x320D1840B6DAA1CC() > iLocal_58 && !func_339())
				{
					if (func_221())
					{
			...
			else if (iLocal_59 == 3)
			{
				if (!func_339())
				{
					...
					if (iLocal_64 < 3)
					{
						iLocal_58 = unk_0x320D1840B6DAA1CC() + 20000;
						iLocal_59 = 0;
					}
					else
					{
...
void func_234(int iParam0, bool bParam1)
{
	if (!func_339())
	{
		...
		else
		{
			...
			iLocal_58 = (unk_0x320D1840B6DAA1CC() + iParam0);
		}
	}
}
...
void func_236()
{
	...
	switch (iLocal_63)
	{
		case 0:
			...
			if (unk_0x6F940C2636C076AD(sLocal_251))
			{
				iLocal_63++;
			}
			break;
		...
		case 1:
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				...
				Local_72 = { unk_0xCACAD935C0BEE14F(iLocal_67, 0f, 0f, 5f) };
				unk_0x9CD4CBF2BBE10F00(Local_72, &(Local_72.f_2), 0, 0);
				Local_73 = { func_241() };
				Local_73.f_2 = func_240((fLocal_261 + 180f), 0f, 360f);
				uLocal_258 = unk_0x8F5F4164BF5FB513(Local_72, Local_73, 2);
				uLocal_74 = unk_0xB93A4265CB0F5B1F("DEFAULT_ANIMATED_CAMERA", 0);
				unk_0x7B8CE3A05613F41C(uLocal_74, uLocal_258, "HELPING_VICTIM_TO_FEET_CAM", sLocal_251);
				...
				unk_0x7A997A0A971D305F(unk_0x6B62510F212526DC(iLocal_67, 1), 5f, 1, 0, 0, 0);
				unk_0x917F631782A9CB32(unk_0x6B62510F212526DC(iLocal_67, 1), 20f, 0);
				unk_0x3E100889F69B5149(unk_0x6B62510F212526DC(iLocal_67, 1), 7f);
				uLocal_266 = unk_0x20F895E512EC5DB6(1110, Local_260, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				if (unk_0x6ABFD2A0B56D6940(unk_0xE2D3D51028F0428A()) == 1)
				{
					unk_0x42A972967C73AB48(unk_0xE2D3D51028F0428A(), 0, 0);
				}
				unk_0x51BB443B279E4104(unk_0xE2D3D51028F0428A());
				unk_0x950B26F4C891073F(unk_0xE2D3D51028F0428A(), uLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				unk_0x950B26F4C891073F(iLocal_67, uLocal_258, sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
				unk_0x0BA4916484503B63(uLocal_258, 0);
				unk_0xE0F81EAEB49D39EF(uLocal_258, 0.25f);
		...
		case 2:
			...
			else if (unk_0x54DE1614490C2A83(uLocal_258) > 0.5f)
			{
				iLocal_63++;
			}
			break;
		...
		case 3:
			...
			else if (unk_0x54DE1614490C2A83(uLocal_258) > 0.99f)
			{
				iLocal_63++;
			}
			break;
		...
		case 4:
			...
			unk_0xAFC1FBF3F6AE7B9A(sLocal_251);
			unk_0xAFC1FBF3F6AE7B9A(sLocal_249);
			if (func_25(iLocal_67))
			{
				unk_0x3F990964E4A5669A(iLocal_67, 1);
				unk_0x50274A7EACA3133A(iLocal_67, 0);
				unk_0xD6A76BAB45A4B460(iLocal_67, 172, 0);
			}
			unk_0x12B2B502C41EF25E(uLocal_266);
			...
			unk_0x4F1E6A84BC157FA0(unk_0xE2D3D51028F0428A(), 0);
			unk_0xFF4BEB6CFF55A013(iLocal_67, 1862763509);
			if (iLocal_242)
			{
				if (unk_0xA829C9A2767AC8EF())
				{
				...
				unk_0x94953C3FF0664F66(0f);
				unk_0x51BB443B279E4104(unk_0xE2D3D51028F0428A());
				unk_0x51BB443B279E4104(iLocal_67);
				unk_0xA8685678DDA27FC3(unk_0xE2D3D51028F0428A(), -1871534317, 0, 0, 0);
				unk_0xA8685678DDA27FC3(iLocal_67, -1871534317, 0, 0, 0);
				unk_0xEB087B19F63AB053(unk_0xE2D3D51028F0428A(), 0, 0);
				unk_0xEB087B19F63AB053(iLocal_67, 0, 0);
				Var0 = { unk_0x3DBAB8E11699EAEE(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", Local_72, Local_73, 1f, 2) };
				unk_0x9CD4CBF2BBE10F00(Var0, &(Var0.f_2), 0, 0);
				unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Var0, 1, 0, 0, 1);
				Var0 = { unk_0x34AEDCEA59226CCB(sLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", Local_72, Local_73, 1f, 2) };
				unk_0xBBF86885619695CE(unk_0xE2D3D51028F0428A(), Var0.f_2);
				Var0 = { unk_0x3DBAB8E11699EAEE(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", Local_72, Local_73, 1f, 2) };
				unk_0x9CD4CBF2BBE10F00(Var0, &(Var0.f_2), 0, 0);
				unk_0xC64B6E13A6A7F517(iLocal_67, Var0, 1, 0, 0, 1);
				Var0 = { unk_0x34AEDCEA59226CCB(sLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", Local_72, Local_73, 1f, 2) };
				unk_0xBBF86885619695CE(iLocal_67, Var0.f_2);
			}
			else
			{
				if (!bLocal_243)
				{
					...
					unk_0x49D97B076E3590AC(unk_0xE2D3D51028F0428A(), sVar1, "idle_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				unk_0xBAEA2321313356D0(0, 0, 3, 0);
			}
			iLocal_242 = 0;
			iLocal_270 = (unk_0x320D1840B6DAA1CC() + 180000);
			iLocal_58 = unk_0x320D1840B6DAA1CC() + 3000;
			unk_0x7BACBB4C6A7B18B7(uLocal_241, 0);
			uLocal_241 = unk_0x2915D98110F23A29(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
int func_239()
{
	...
	{
		unk_0xB38EF75835FAF667(unk_0x15CAA6D7B11F1A7C(iVar2), &(Var0[0 /*3*/]), &(Var0[1 /*3*/]));
		Var1 = { func_68() };
		if ((Var0[1 /*3*/] - Var0[0 /*3*/]) > Var1.x)
		{
			return 0;
...
void func_242()
{
	if (!unk_0xF68107C40359970C(iLocal_67) && !func_260())
	{
		if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_67, 80f, 80f, 15f, 0, 1, 0))
		{
			unk_0x8FB472886552D737(sLocal_251);
			if (!iLocal_273)
			{
			...
			if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_67, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_257(1, 0, 1))
			{
				unk_0xF23E6F5690771F71(iLocal_67, unk_0xFD8E434495EC2F26(unk_0x9E2D6C50374FCFA9()));
				unk_0x950D2D7EA1BFF54C(iLocal_67, 0);
				unk_0xD6A76BAB45A4B460(iLocal_67, 206, 1);
				iLocal_51 = 2;
			}
			else if (func_214(unk_0xE2D3D51028F0428A(), iLocal_67, 15f, 1) && unk_0x207D53F9E0190691(unk_0xE2D3D51028F0428A()) < 4f)
			{
				if (func_339())
				{
					func_255();
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_339())
						{
							...
							{
								uLocal_65 = func_254(iLocal_67, 1, 1, 5);
								unk_0x3430966AC4550BB9(uLocal_65, 0);
							}
							func_9(&uLocal_76, "RECRAAU", "RECRA_PLEAD", 3, 0, 0, 0);
							unk_0xF30F15F203736DE4(iLocal_67, unk_0xE2D3D51028F0428A(), -1, 0, 2);
							iLocal_58 = unk_0x320D1840B6DAA1CC() + 18000;
							iLocal_60 = 2;
						}
						break;
					...
					case 2:
						if (unk_0x320D1840B6DAA1CC() > iLocal_58 && !func_339())
						{
							...
							iLocal_58 = unk_0x320D1840B6DAA1CC() + 12000;
							iLocal_60 = 3;
						}
						break;
					...
					case 3:
						if (unk_0x320D1840B6DAA1CC() > iLocal_58 && !func_339())
						{
							...
							iLocal_58 = unk_0x320D1840B6DAA1CC() + 9500;
						}
						break;
					}
				}
...
int func_260()
{
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		if (unk_0x9AC74C7EF847A074(unk_0x6EA486FF6D815B4B(iLocal_67, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
			{
				if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), iLocal_67))
				{
					return 1;
				}
			}
		}
		if (unk_0x89D0E0233F6E59A7(-1, unk_0x6EA486FF6D815B4B(iLocal_67, 31086, 0f, 0f, 0f), 8f))
		{
			return 1;
		}
		if (unk_0x0747E45CFF1F74AA(iLocal_67, unk_0xE2D3D51028F0428A(), 1))
		{
			return 1;
		}
...
void func_261()
{
	...
	unk_0xD69A0C3662175E68(iLocal_246);
	unk_0xD69A0C3662175E68(iLocal_248);
	unk_0xD69A0C3662175E68(iLocal_247);
	unk_0x8FB472886552D737(sLocal_249);
	unk_0x511A0AF0E8B0BF9A(sLocal_250);
	unk_0x8FB472886552D737(sLocal_253);
	...
	if (((((((((unk_0x0152AA00FA3130F1(iLocal_246) && unk_0x0152AA00FA3130F1(iLocal_248)) && unk_0x0152AA00FA3130F1(iLocal_247)) && unk_0x6F940C2636C076AD(sLocal_249)) && unk_0xA7A5D14F877C9047(sLocal_250)) && unk_0x6F940C2636C076AD(sLocal_253)) && unk_0x6F940C2636C076AD(sLocal_254)) && unk_0x6F940C2636C076AD(sLocal_255)) && unk_0x6F940C2636C076AD(sLocal_252)) && unk_0x51B6C2EF8DBE2E1A())
	{
		bLocal_262 = false;
		iLocal_273 = 0;
		unk_0x07CECF421D895F3D(5, 0);
		iLocal_71 = unk_0xBA715A7BEBA5A1F9(iLocal_248, 1932.98f, 6291.91f, 41.08f, 350.85f, 1, 1, 0);
		unk_0xF1A23B343DFEDFD0(iLocal_248);
		unk_0x371D594409A68A18(iLocal_71, 0, 0, 0);
		unk_0xE5283B3A324D3FB0(iLocal_71, 1);
		unk_0x7517A117EA38D570(iLocal_71, 0, 0, 1148846080);
		unk_0xB38EF75835FAF667(iLocal_248, &uVar0, &Var1);
		unk_0xBDBA586F627A444A(iLocal_71, 0);
		unk_0xBDBA586F627A444A(iLocal_71, 2);
		unk_0xBDBA586F627A444A(iLocal_71, 3);
		unk_0xFC9192010268ED99(iLocal_71);
		unk_0xBDB27A4F81702F96(iLocal_71, 0f, Var1.f_1, 0f, 500f, 10000f, 1);
		unk_0xBDB27A4F81702F96(iLocal_71, Var1.x, (Var1.f_1 * 0.75f), 0f, 500f, 10000f, 1);
		unk_0xBDB27A4F81702F96(iLocal_71, Var1.x, 0f, 0f, 500f, 10000f, 1);
		unk_0xBDB27A4F81702F96(iLocal_71, 0f, 0f, Var1.f_2, 500f, 10000f, 1);
		unk_0x2476BE9932670CAD(iLocal_71, 5, 1, 1);
		unk_0x2EC6505629D78CCE(iLocal_71, 12f);
		unk_0x32C1B93FD1667DDB(iLocal_71);
		unk_0xBED097BB6359F09C(iLocal_71, 0, 1, 0, 0, 0, 0, 0, 0);
		unk_0x8CE3D365F064F69E(iLocal_71, 0f, 180f, 0f, 2, 1);
		unk_0xF80F852786CB8BB0(iLocal_71, 1);
		unk_0x7570FB331DFE5904(iLocal_71, 1);
		uLocal_265 = unk_0x2D649DA6DC187D35("scr_recrash_rescue_fire", iLocal_71, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_262)
		{
			iLocal_67 = unk_0xA8D58C3AADA2C41C(26, iLocal_247, Local_260, (fLocal_261 - 180f), 1, 1);
		}
		else
		{
			iLocal_67 = unk_0xA8D58C3AADA2C41C(26, iLocal_247, Local_260, fLocal_261, 1, 1);
		}
		unk_0x9777C2BD7F179F2D(iLocal_67, 0, 0.7f, 0.5f, 2);
		Local_57 = { unk_0x6B62510F212526DC(iLocal_67, 1) };
		unk_0xDB6AD61CE00E8A46(Local_57.x, (Local_57.f_1 + 0.1f), (Local_57.f_2 + 0.1f), Local_57.x, (Local_57.f_1 - 0.1f), (Local_57.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		unk_0x49D97B076E3590AC(iLocal_67, sLocal_249, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_25(iLocal_67))
		{
			unk_0x3F990964E4A5669A(iLocal_67, 0);
		}
		unk_0x50274A7EACA3133A(iLocal_67, 1);
		unk_0xF160248D9083ED0C(iLocal_67, 115, 0);
		unk_0xA5D600C274CC186F(iLocal_67, 1);
		unk_0xABC2CA6F28903308(iLocal_67, 1);
		unk_0x279E52ABB546C567(iLocal_67, 1);
		unk_0x2378080C93821600(iLocal_67, 0);
		unk_0xBC12D08EE7559CCD(iLocal_67, 13, 0);
		unk_0xBC12D08EE7559CCD(iLocal_67, 17, 1);
		unk_0xABFC84F5C4943D7B(iLocal_67, sLocal_250, 1048576000);
		unk_0xD6A76BAB45A4B460(iLocal_67, 229, 1);
		func_213(&uLocal_76, 3, iLocal_67, "TALINA", 0, 1);
		unk_0xE5BF90257C46EC94(iLocal_67, 3, 0f, 0f, 0f, "wound_sheet");
		unk_0xA7266A50941DBAEA(iLocal_67, 0);
		iLocal_69 = unk_0xA8D58C3AADA2C41C(26, iLocal_246, 1935.53f, 6291.888f, 41.144f, -28.44f, 1, 1);
		iLocal_70 = 1;
		Local_57 = { unk_0x6B62510F212526DC(iLocal_69, 1) };
		unk_0xE5BF90257C46EC94(iLocal_69, 3, 0f, 0f, 0f, "wound_sheet");
		unk_0xDB6AD61CE00E8A46(Local_57.x, (Local_57.f_1 + 0.1f), (Local_57.f_2 + 0.1f), Local_57.x, (Local_57.f_1 - 0.1f), (Local_57.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		unk_0xD6A76BAB45A4B460(iLocal_69, 227, 1);
		unk_0x246C656F8E525DC7(iLocal_69, sLocal_252, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		unk_0xF160248D9083ED0C(iLocal_69, 0, 0);
		unk_0xF1A23B343DFEDFD0(iLocal_246);
		if (func_2() == 0)
		{
			func_213(&uLocal_76, 0, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
		}
		else if (func_2() == 1)
		{
			func_213(&uLocal_76, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
		}
		else if (func_2() == 2)
		{
			func_213(&uLocal_76, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
		}
		uLocal_241 = unk_0x2915D98110F23A29(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
		iLocal_51 = 1;
	}
}
...
int func_262()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_269())
		{
			return 0;
		}
	}
...
int func_279(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_314(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_292(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_322()
{
	...
	{
		unk_0xBED097BB6359F09C(iLocal_71, 0, 0, 0, 0, 0, 0, 0, 0);
		unk_0x2EE80CD0EAEB9B5B(iLocal_71, -400f);
		unk_0x448AD51B3157C957(iLocal_71, -100f);
	}
	if (unk_0x6B8F21F773404988(uLocal_265))
	{
		unk_0x0F53BC871BA89C94(uLocal_265, 0);
	}
	if (unk_0xE5965CDF24F93A9F(uLocal_245))
	{
		unk_0x5C65DDDC219B3AA5(iLocal_245, 0);
	...
	unk_0x83E10DA4845841B7(Local_55 - Vector(3f, 3f, 3f), Local_55 + Vector(3f, 3f, 3f), 1);
	...
	if (Global_21285 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (unk_0xE73671E3D37CF79E(&(Global_20153[iVar0 /*6*/])))
			{
				...
				uVar2 = unk_0x6ABF9C6F18308B78(unk_0xAEF70623D03F7B02(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
