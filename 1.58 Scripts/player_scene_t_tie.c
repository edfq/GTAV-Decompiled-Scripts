...
int func_2()
{
	...
	fVar0 = vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			{
				unk_0xD69A0C3662175E68(iLocal_69[iVar0]);
				if (!unk_0x0152AA00FA3130F1(iLocal_69[iVar0]))
				{
					unk_0xD69A0C3662175E68(iLocal_69[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0xACC32B78196FBC2A(&cLocal_75))
		{
			unk_0x8FB472886552D737(&cLocal_75);
			if (!unk_0x6F940C2636C076AD(&cLocal_75))
			{
				unk_0x8FB472886552D737(&cLocal_75);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0xA8D58C3AADA2C41C(26, iLocal_69[iVar0], Local_70 + Local_72[iVar0 /*3*/], 0, 1, 1);
			unk_0x8CE3D365F064F69E(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + Local_73[iVar0 /*3*/], 2, 1);
			unk_0x6E9C0F9EAC1F29FD(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0xE3752B10DC995E95(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0xE3752B10DC995E95(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x6E9C0F9EAC1F29FD(iLocal_68[iVar0], 0);
			}
			unk_0xBC12D08EE7559CCD(iLocal_68[iVar0], 13, 0);
			...
			unk_0x246C656F8E525DC7(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), Local_70 + Local_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + Local_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0, 2, 0);
			unk_0xEB087B19F63AB053(iLocal_68[iVar0], 0, 0);
			unk_0xABC2CA6F28903308(iLocal_68[iVar0], 1);
			unk_0x3E3D339BAD67F6F2(iLocal_68[iVar0], 55, 1);
			if (iLocal_83[iVar0] > 0)
			{
				unk_0x8B65F723C8DD11A8(iLocal_68[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 2, 0f, 0.15f, 2);
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x9777C2BD7F179F2D(iLocal_68[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0x2D0C965C5964FC7A(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x2D0C965C5964FC7A(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x2D0C965C5964FC7A(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x2D0C965C5964FC7A(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x2D0C965C5964FC7A(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = unk_0x20F895E512EC5DB6(iLocal_83[iVar0], Local_70 + Local_84[iVar0 /*3*/], Var3, Var4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0, 0, 0);
			wait(0);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			Local_84[4 /*3*/] = { Local_84[0 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0xC4EAB25A108C2429(0.5f, 0.5f), unk_0xC4EAB25A108C2429(0.5f, 0.5f)) };
			Local_84[5 /*3*/] = { Local_84[1 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0xC4EAB25A108C2429(0.5f, 0.5f), unk_0xC4EAB25A108C2429(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 17, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 144, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 43, 1785177548, 1785177548, unk_0xC4EAB25A108C2429(-5f, 5f), unk_0xC4EAB25A108C2429(-5f, 5f), 0f, unk_0xC4EAB25A108C2429(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_34()
{
	...
	while (iVar0 < iLocal_69)
	{
		if (iLocal_69[iVar0] != 0)
		{
			unk_0xF1A23B343DFEDFD0(iLocal_69[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0xACC32B78196FBC2A(&cLocal_75))
	{
		unk_0xAFC1FBF3F6AE7B9A(&cLocal_75);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		if (unk_0xD39231CABDB82D64(iLocal_82[iVar0]))
		{
		}
		iVar0++;
	}
