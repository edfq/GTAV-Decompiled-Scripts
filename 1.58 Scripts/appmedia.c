	...
	while (true)
	{
		...
		if (iLocal_24 == 0)
		{
			if (Global_19954.f_1 != 9)
			{
				...
				{
					case 7:
						if ((iLocal_31 == 0 && iLocal_32 == 0) && Global_22320 == 0)
						{
							func_22();
							func_16();
						}
					...
					case 8:
						if ((func_15(2, Global_19922, 0) && iLocal_31 == 0) && iLocal_32 == 0)
						{
							func_14();
							Global_19932 = 1;
...
void func_3()
{
	...
	while (iLocal_22 < iLocal_21)
	{
		...
		{
			func_6(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, &(Local_27[iLocal_22 /*6*/]), 0, 0, 0, 0);
...
void func_8()
{
	if (iLocal_31 == 0 && iLocal_32 == 1)
	{
		...
		unk_0x6447DA2F47A963E9(Local_30, 0);
	}
}

void func_9()
{
	if ((iLocal_31 == 1 && iLocal_32 == 0) && Global_22320 == 6)
	{
		if (iLocal_33)
		{
			Local_30.x = (Local_30.x - 1f);
	...
	if (unk_0xE2D0C323A1AE5D85(Global_7825, 15))
	{
		...
		iLocal_32 = 0;
		func_7(Global_19935, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_6(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_MSMENU_3", 0, 0, 0, 0);
		if (Global_19942)
		{
		...
		unk_0xB0550BC91B0159D6(&Global_7824, 17);
		func_7(Global_19935, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_4(Global_19935, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
	}
}
...
void func_13()
{
	if (iLocal_31 == 0)
	{
		unk_0xDE866220FC1119FA(&Local_30, 0);
		Local_29 = { Global_19914 };
		iLocal_32 = 1;
		iLocal_36 = 1;
		iLocal_37 = 1;
		iLocal_38 = 1;
...
void func_17()
{
	func_7(Global_19935, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_20()
{
	func_7(Global_19935, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0x91DFC8F68F6D9B05(-1, "Menu_Navigate", &Global_19943, 1);
	func_21();
}
		...
		if (func_15(2, Global_19923, 0))
		{
			...
			if (iVar0 > -1)
			{
				...
				if (Global_19954.f_1 > 3)
				{
					...
					{
						func_7(Global_19935, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_6(Global_19935, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_MSMENU_2", 0, 0, 0, 0);
						func_7(Global_19935, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_4(Global_19935, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
						if (Global_19942)
						{
