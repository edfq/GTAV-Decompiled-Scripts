...
void func_1()
{
	switch (iLocal_261)
	{
		case 0:
			bLocal_262 = false;
			func_228(&uLocal_95, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
			iLocal_261 = 1;
			break;
			...
			switch (iLocal_264)
			{
				case 0:
					if (func_310(1, 1093140480, 0))
					{
						...
						{
							unk_0x48F297980C708DB7(Local_94.f_28[0], "Nigel", 0, 0, 0);
						}
						if (func_309(Local_94.f_28[1]))
						{
							unk_0x48F297980C708DB7(Local_94.f_28[1], "MRS_Thornhill", 0, 0, 0);
						}
						func_308();
				...
				case 2:
					if (!unk_0xF34D8FCAE3FD4EE4())
					{
						...
						if (func_309(Local_94.f_35[0]))
						{
							...
							unk_0x9F65B3BAFA302A65(Local_94.f_35[0], 1084227584);
							unk_0x11647D34B93A72EB(Local_94.f_35[0], 1);
							if (func_309(Local_94.f_28[0]))
							{
								unk_0xFF4BEB6CFF55A013(Local_94.f_28[0], 1862763509);
								unk_0x51BB443B279E4104(Local_94.f_28[0]);
								unk_0x50274A7EACA3133A(Local_94.f_28[0], 1);
								unk_0xA9F390242F9EB2E1(Local_94.f_28[0], Local_94.f_35[0], -1);
								unk_0xABC2CA6F28903308(Local_94.f_28[0], 1);
							}
							if (func_309(Local_94.f_28[1]))
							{
								unk_0xFF4BEB6CFF55A013(Local_94.f_28[1], 1862763509);
								unk_0x51BB443B279E4104(Local_94.f_28[1]);
								unk_0x50274A7EACA3133A(Local_94.f_28[1], 1);
								unk_0xA9F390242F9EB2E1(Local_94.f_28[1], Local_94.f_35[0], 0);
								unk_0xABC2CA6F28903308(Local_94.f_28[1], 1);
							}
							unk_0x371D594409A68A18(Local_94.f_35[0], 1, 1, 0);
							unk_0xAD6CDBCDA713560A(Local_94.f_28[0], Local_94.f_35[0], 20f, 786603);
						}
...
int func_233(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)
{
	...
	if (iParam4 == 1)
	{
		while (!unk_0x0152AA00FA3130F1(iLocal_81))
		{
			wait(0);
		}
	}
	else if (!unk_0x0152AA00FA3130F1(iLocal_81))
	{
		return 0;
	}
	...
	if (unk_0xE5965CDF24F93A9F(Global_103480.f_4))
	{
		if (unk_0x55A0C756C4A8220C(Global_103480.f_4, 0))
		{
			if (func_299(24) != Global_103480.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_296(unk_0x6B62510F212526DC(Global_103480.f_4, 1), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
				}
				func_252(Global_103480.f_4, Param0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_278(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xA829C9A2767AC8EF())
			{
				...
				Var4 = { func_320(Global_78107, Global_78109, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_339(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				uLocal_93 = unk_0x2915D98110F23A29(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				unk_0x247F21B1803F0EC4("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0x247F21B1803F0EC4("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0x247F21B1803F0EC4("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				uLocal_93 = unk_0x2915D98110F23A29(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				uLocal_93 = unk_0x2915D98110F23A29(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				uLocal_93 = unk_0x2915D98110F23A29(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_349()
{
	...
	unk_0x7BACBB4C6A7B18B7(uLocal_263, 0);
	unk_0x2AA70F35B0B111E6();
...
int func_364(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_370())
	{
		...
		{
			iVar2 = func_365(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
