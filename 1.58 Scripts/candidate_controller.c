		...
		if (Global_42557 > 0)
		{
			...
			if (Global_42557 == iVar0)
			{
				...
				if (Global_42557 > 1)
				{
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < Global_42557)
					{
						if (func_15(Global_42563[iVar4 /*4*/].f_2))
						{
							iVar2[iVar4] = 0;
						}
						else
					...
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < (Global_42557 - 1))
					{
						if (!iVar2[iVar4 + 1])
						{
							if (Global_42563[iVar4 + 1 /*4*/].f_1 < Global_42563[iVar5 /*4*/].f_1)
							{
								iVar5 = iVar4 + 1;
							}
						}
					...
					iVar3 = iVar5;
					if (Global_42563[iVar3 /*4*/].f_2 == 15)
					{
						iVar3 = -1;
					}
					if (iVar3 != -1)
					{
						if (!func_15(Global_42563[iVar3 /*4*/].f_2))
						{
							iVar3 = -1;
						}
					}
				...
				if (iVar3 > -1)
				{
					Global_42558 = Global_42563[iVar3 /*4*/];
					Global_42559 = Global_42563[iVar3 /*4*/].f_3;
					Global_42596 = Global_42563[iVar3 /*4*/].f_2;
					Global_42557 = 0;
					Global_42562 = 0;
				}
				else
...
{
	return (shift_right(iParam0, 26) & 31 * func_7(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
