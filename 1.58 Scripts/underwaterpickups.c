...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &uVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x1CD347D2BD906560(iVar1, Var2, iVar4, uVar5, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					...
					{
						uLocal_3[iVar0] = unk_0x1CD347D2BD906560(iVar1, Var2, iVar4, iVar5, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							uLocal_3[iVar0] = unk_0x1CD347D2BD906560(iVar1, Var2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x1EE09F99FEF19DAF(iVar1, Var2, Var3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						uLocal_3[iVar0] = unk_0x1EE09F99FEF19DAF(iVar1, Var2, Var3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
