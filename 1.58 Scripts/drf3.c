...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_112915.f_18533[iVar0], &Var2, &fVar3))
			{
...
void func_88(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	while (iVar4 < 47)
	{
		if (unk_0xACC32B78196FBC2A(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0xACC32B78196FBC2A(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (unk_0xACC32B78196FBC2A(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_93(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_94(&(Global_112915.f_19961), iVar1, 1);
	}
...
struct<4> func_104(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	else
	{
		...
		{
			unk_0xCED9E32812D6C7C7(&iVar2, 2);
			iVar3++;
		}
		...
		{
			unk_0xCED9E32812D6C7C7(&iVar2, 5);
			iVar3++;
		}
		...
		{
			unk_0xCED9E32812D6C7C7(&iVar2, 7);
			iVar3++;
		}
		...
		if (iVar3 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar1 = func_106(7, 9, 10, 11, 0);
			}
			else
			{
				iVar1 = func_106(7, 9, 10, 0, 0);
			}
		}
		else
		{
			...
			while (iVar4 > 0)
			{
				if (unk_0xE2D0C323A1AE5D85(iVar2, iVar5))
				{
					iVar4 = (iVar4 - 1);
					if (iVar4 == 0)
					{
	...
	if (bParam2)
	{
		func_105(&(Global_112915.f_19961), iVar1, 1);
	}
