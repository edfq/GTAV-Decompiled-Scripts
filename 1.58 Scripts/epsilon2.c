...
void func_1()
{
	...
	unk_0xD25FB7E1030E5E2D(iLocal_87, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_86)
	{
		case 0:
			iLocal_91 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_91 && (unk_0x320D1840B6DAA1CC() - iLocal_88) > 15000)
				{
				...
				if (!iLocal_93 && !unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
				{
					if (!unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
					{
						...
						if (unk_0x48053974ED6F63CE(fVar1) <= 0.05f && !iLocal_93)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_92 = 1;
...
{
	return (shift_right(iParam0, 26) & 31 * func_26(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_41(&iVar2);
		iVar3 = func_40(Var1, Global_112915.f_7688.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_38(Global_112915.f_7688.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_36(Global_112915.f_7688.f_765[iVar2 /*10*/]))
				{
					Global_112915.f_7688.f_765[iVar2 /*10*/] = { Var1 };
					func_37(&Var1);
					return 1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = unk_0xA188D1127A77C942(iParam3, 10, -1, 0, -1, func_72(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = unk_0xA188D1127A77C942(iVar1, 10, -1, 0, -1, func_72(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_179(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xA829C9A2767AC8EF())
			{
				...
				Var4 = { func_222(Global_78107, Global_78109, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_259()
{
	...
	{
		func_320(13, floor(Global_112915.f_10194.f_3853));
	}
...
int func_281(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_77663[1 /*14*/] = { func_112(iVar0, iParam1, uVar6[iParam1], -1) };
...
void func_286(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_287(&uVar1, Var0.f_3, Global_100011, iParam1, iParam2);
	}
}
...
int func_331(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_337())
	{
		...
		{
			iVar2 = func_332(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
