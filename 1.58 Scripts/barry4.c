...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_221(&uLocal_83, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0xA829C9A2767AC8EF())
			{
				...
				Var4 = { func_233(Global_78107, Global_78109, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	return func_325(&(Global_106464.f_2890), Param0, fParam1, 0);
}
...
int func_327(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_329(iParam0, uVar1[iVar3], 1) && func_328(unk_0x6B62510F212526DC(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_323(Param1, 0f, 0f, 0f, 0)) || unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam0, 1), unk_0x6B62510F212526DC(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_371(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_377())
	{
		...
		{
			iVar2 = func_372(unk_0x05CBA41180F5D521());
			if (iVar2 > -1)
			{
