...
void __EntryFunction__()
{
	...
	uLocal_126 = unk_0x2915D98110F23A29(Vector(93.3633f, 82.5239f, 276.3459f) + Vector(10f, 10f, 10f), Vector(93.3633f, 82.5239f, 276.3459f) - Vector(10f, 10f, 10f), 0, 1, 1, 1);
	uLocal_127 = unk_0x2915D98110F23A29(Vector(188.5935f, 675.8706f, 227.8598f) + Vector(4f, 4f, 4f), Vector(188.5935f, 675.8706f, 227.8598f) - Vector(4f, 4f, 4f), 0, 1, 1, 1);
	uLocal_128 = unk_0x2915D98110F23A29(Vector(93.8361f, 92.1704f, 246.1673f) + Vector(6f, 6f, 6f), Vector(93.8361f, 92.1704f, 246.1673f) - Vector(6f, 6f, 6f), 0, 1, 1, 1);
	if (Global_3)
	{
	...
	while (true)
	{
		...
		{
			if (unk_0xE5965CDF24F93A9F(Local_108[iVar0 /*18*/]) && !unk_0x55B23FE400FCEA6B(Local_108[iVar0 /*18*/], 0))
			{
				Local_108[iVar0 /*18*/].f_8 = { unk_0x6B62510F212526DC(Local_108[iVar0 /*18*/], 1) };
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		{
			if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]) && !unk_0x55B23FE400FCEA6B(Local_109[iVar0 /*18*/], 0))
			{
				Local_109[iVar0 /*18*/].f_6 = { unk_0x6B62510F212526DC(Local_109[iVar0 /*18*/], 1) };
			}
			iVar0++;
		}
		if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			Local_52 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1) };
		}
		if (!unk_0xF68107C40359970C(iLocal_67))
		{
			Local_53 = { unk_0x6B62510F212526DC(iLocal_67, 1) };
		}
		if (unk_0xE5965CDF24F93A9F(iLocal_70) && !unk_0x55B23FE400FCEA6B(iLocal_70, 0))
		{
			Local_54 = { unk_0x6B62510F212526DC(iLocal_70, 1) };
		}
		if (!func_230())
		{
			if (unk_0xC92F9F18E020B461())
			{
				switch (iLocal_130)
				{
					...
					case 1:
						if ((func_200() || unk_0xC378B7F0D175A5B0(unk_0x9E2D6C50374FCFA9()) > 0) || !unk_0x55A0C756C4A8220C(iLocal_70, 0))
						{
		...
		else
		{
			...
			switch (iLocal_45)
			{
				...
				case 8:
					if (func_106())
					{
						...
						{
							unk_0x05CB75C0837196F9(&iLocal_67);
						}
						func_82();
					}
					break;
			...
			if (!unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_53, 210f, 210f, 210f, 0, 1, 0))
			{
				func_199();
				func_280();
			}
		...
		if (iLocal_45 <= 0)
		{
			...
			{
				if ((!unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, 0, 1, 0) && (unk_0x320D1840B6DAA1CC() - iLocal_145) > 5000) && !unk_0xF68107C40359970C(Local_109[iVar1 /*18*/]))
				{
					if (vdist2(unk_0x6B62510F212526DC(Local_109[iVar1 /*18*/], 1), Local_52) < (30.5f * 30.5f) && vdist2(Local_53, Local_52) > (22.5f * 22.5f))
					{
						if (func_230())
						{
							...
							else if (!iLocal_193)
							{
								...
								{
									iLocal_145 = unk_0x320D1840B6DAA1CC();
									iLocal_193 = 1;
								}
							}
...
void func_2()
{
	...
	while (iVar0 < Local_109)
	{
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]))
		{
			if (unk_0x0CF63873D754B965(Local_109[iVar0 /*18*/]) < Local_109[iVar0 /*18*/].f_17)
			{
				if (unk_0x0747E45CFF1F74AA(Local_109[iVar0 /*18*/], unk_0xE2D3D51028F0428A(), 1))
				{
					iLocal_138[iVar0] = (iLocal_138[iVar0] + (Local_109[iVar0 /*18*/].f_17 - unk_0x0CF63873D754B965(Local_109[iVar0 /*18*/])));
					iLocal_63 = (iLocal_63 + (Local_109[iVar0 /*18*/].f_17 - unk_0x0CF63873D754B965(Local_109[iVar0 /*18*/])));
					unk_0xE68645525D451A8B(Local_109[iVar0 /*18*/]);
			...
			Local_109[iVar0 /*18*/].f_17 = unk_0x0CF63873D754B965(Local_109[iVar0 /*18*/]);
		}
		iVar0++;
	}
}
...
int func_30()
{
	...
	while (iVar0 < Local_109)
	{
		if ((unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iVar0 /*18*/])) && !unk_0xF68107C40359970C(iLocal_67))
		{
...
void func_31()
{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			unk_0x8FB472886552D737(sLocal_134);
			unk_0x8FB472886552D737("random@paparazzi@pap_anims");
			if (((((unk_0x0152AA00FA3130F1(joaat("a_m_y_genstreet_02")) && unk_0x0152AA00FA3130F1(joaat("prop_pap_camera_01"))) && unk_0x0152AA00FA3130F1(joaat("cavalcade2"))) && unk_0x0152AA00FA3130F1(joaat("vader"))) && unk_0x6F940C2636C076AD(sLocal_134)) && unk_0x6F940C2636C076AD("random@paparazzi@pap_anims"))
			{
		...
		case 2:
			if (unk_0xE5965CDF24F93A9F(Local_109[2 /*18*/].f_2))
			{
				if (!unk_0x2B5F4FBAF644BEC8(Local_109[2 /*18*/].f_2))
				{
					unk_0x1C2ED929474DC6FE(Local_109[2 /*18*/].f_2, 1, 0);
				}
			}
			switch (iLocal_165)
			{
				case 0:
					...
					if (!unk_0xE5965CDF24F93A9F(Local_108[2 /*18*/]))
					{
						func_64(2, Local_161[2 /*3*/], fLocal_162[2], 0);
						if (unk_0x55A0C756C4A8220C(Local_108[2 /*18*/], 0))
						{
							func_65(func_68(2), unk_0x6B62510F212526DC(Local_108[2 /*18*/], 1), 0f);
							unk_0xA9F390242F9EB2E1(func_63(2, 0), Local_108[2 /*18*/], -1);
						}
					}
					if (!unk_0xE5965CDF24F93A9F(Local_108[3 /*18*/]))
					{
						func_64(3, Local_161[3 /*3*/], fLocal_162[3], 0);
					}
					if (!unk_0xF68107C40359970C(func_63(2, 1)))
					{
						unk_0x7D1424753688EE7A(func_63(2, 1), Local_156, 2f, -1, 0.25f, 0, 1193033728);
					}
					if (!unk_0xF68107C40359970C(func_63(3, 1)))
					{
						unk_0x7D1424753688EE7A(func_63(3, 1), Local_157, 2f, -1, 0.25f, 0, 1193033728);
					}
					...
					if (Global_3 || bLocal_56)
					{
						if (!unk_0xF68107C40359970C(func_63(1, 0)))
						{
							unk_0x7D1424753688EE7A(func_63(1, 0), Local_158, 2f, 20000, 0.25f, 0, 1193033728);
						}
						if (!unk_0xF68107C40359970C(func_63(1, 1)))
						{
							unk_0x7D1424753688EE7A(func_63(1, 1), Local_159, 2f, 20000, 0.25f, 0, 1193033728);
						}
						if (!unk_0xF68107C40359970C(func_63(0, 1)))
						{
							unk_0x7D1424753688EE7A(func_63(0, 1), Local_160, 2f, 20000, 0.25f, 0, 1193033728);
						}
					}
					settimerb(0);
					iVar1 = 0;
					...
					{
						if (unk_0xE5965CDF24F93A9F(Local_109[iVar1 /*18*/]))
						{
							unk_0x2A375326652F1B50(Local_109[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iVar1 = 0;
					...
					{
						if (unk_0xE5965CDF24F93A9F(Local_108[iVar1 /*18*/]))
						{
							unk_0x2A375326652F1B50(Local_108[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iLocal_165++;
				...
				case 1:
					func_55();
					if ((unk_0x55A0C756C4A8220C(Local_108[0 /*18*/], 0) && !unk_0xF68107C40359970C(func_63(0, 0))) && !unk_0xF68107C40359970C(func_63(0, 1)))
					{
						if (!iLocal_152[1])
						{
							iLocal_152[1] = 1;
							unk_0x3B8F94419979A0B1(func_63(0, 0), Local_108[0 /*18*/], Local_154, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
						}
					}
					if ((unk_0x55A0C756C4A8220C(Local_108[2 /*18*/], 0) && !unk_0xF68107C40359970C(func_63(2, 0))) && !unk_0xF68107C40359970C(func_63(2, 1)))
					{
						if (!iLocal_152[0])
						{
							unk_0x3B8F94419979A0B1(func_63(2, 0), Local_108[2 /*18*/], Local_155, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
							iLocal_152[0] = 1;
						}
					}
					if (unk_0xE5965CDF24F93A9F(iLocal_67) && !unk_0xF68107C40359970C(iLocal_67))
					{
						func_52(iLocal_67, 6);
						if (Global_3 || bLocal_56)
						{
							if (!unk_0xF68107C40359970C(func_63(1, 0)))
							{
								if (unk_0x8F41785F110B0DA0(func_63(1, 0), Local_158, Global_22, 0, 1, 0))
								{
							...
							if (!unk_0xF68107C40359970C(func_63(1, 1)))
							{
								if (unk_0x8F41785F110B0DA0(func_63(1, 1), Local_159, Global_22, 0, 1, 0))
								{
							...
							if (!unk_0xF68107C40359970C(func_63(0, 1)))
							{
								if (unk_0x8F41785F110B0DA0(func_63(0, 1), Local_159, Global_22, 0, 1, 0))
								{
					...
					if (vdist2(unk_0x6B62510F212526DC(iLocal_70, 1), Local_68) < 9f)
					{
						if (unk_0x8F41785F110B0DA0(func_63(2, 1), Local_156, Global_22, 0, 1, 0))
						{
							func_51(iLocal_67, func_66(2));
						}
						if (unk_0x8F41785F110B0DA0(func_63(3, 1), Local_157, Global_22, 0, 1, 0))
						{
							func_51(iLocal_67, func_66(3));
						}
						if (unk_0x8F41785F110B0DA0(func_63(0, 1), Local_157, Global_22, 0, 1, 0))
						{
							func_51(iLocal_67, func_66(0));
						}
					}
					...
					{
						if (!unk_0xE2D0C323A1AE5D85(iLocal_168, 3))
						{
							unk_0x03A927199A2DFE46(Local_109[func_66(3) /*18*/]);
							unk_0xCED9E32812D6C7C7(&iLocal_168, 3);
						}
						if (!unk_0xE2D0C323A1AE5D85(iLocal_168, 2))
						{
							unk_0x03A927199A2DFE46(Local_109[func_66(2) /*18*/]);
							unk_0xCED9E32812D6C7C7(&iLocal_168, 2);
						}
						if (!unk_0xE2D0C323A1AE5D85(iLocal_168, 0))
						{
							unk_0x03A927199A2DFE46(Local_109[func_66(0) /*18*/]);
							unk_0xCED9E32812D6C7C7(&iLocal_168, 0);
						}
						if (Global_3 || bLocal_56)
						{
							func_51(iLocal_67, func_66(3));
		...
		case 3:
			func_55();
			if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
			{
				if (unk_0x207D53F9E0190691(iLocal_70) < 1f)
				{
					fLocal_153 = (fLocal_153 + unk_0x51109C28352EC9A3());
				}
			...
			while (iVar0 < Local_108)
			{
				if (unk_0xE5965CDF24F93A9F(Local_108[iVar0 /*18*/]) && iLocal_45 != 6)
				{
					if ((iVar0 < 2 && ((iVar0 != iLocal_163 || !unk_0xE5965CDF24F93A9F(Local_108[0 /*18*/])) || !unk_0xE5965CDF24F93A9F(Local_108[1 /*18*/]))) && (unk_0x320D1840B6DAA1CC() - iLocal_164) > 500)
					{
						if (vdist2(Local_52, Local_68) > 400f)
						{
							if (vdist2(Local_52, Local_68) < 62500f || (unk_0x320D1840B6DAA1CC() - iLocal_131) < 30000)
							{
					...
					iVar2 = func_68(iVar0);
					if (!unk_0xF68107C40359970C(Local_109[iVar2 /*18*/]))
					{
						iVar3 = func_66(iVar0);
					}
					else
					...
					{
						case 0:
							if (unk_0x55A0C756C4A8220C(Local_108[iVar0 /*18*/], 0))
							{
								if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), Local_108[iVar0 /*18*/], 0))
								{
									if (!unk_0xF68107C40359970C(Local_109[iVar2 /*18*/]))
									{
										if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0))
										{
											if (unk_0x174CED88B97C78D9(Local_109[iVar2 /*18*/], -1794415470) != 1 && unk_0x7158135695FAE89D(Local_108[iVar0 /*18*/], -1, 0))
											{
												unk_0xB486640392EC50BB(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], -1, -1, 2f, 1, 0);
											}
										}
									}
									if (iVar3 != -1)
									{
										if (!unk_0xF68107C40359970C(Local_109[iVar3 /*18*/]))
										{
											if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))
											{
												if (unk_0x174CED88B97C78D9(Local_109[iVar3 /*18*/], -1794415470) != 1 && unk_0x7158135695FAE89D(Local_108[iVar0 /*18*/], 0, 0))
												{
													unk_0xB486640392EC50BB(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], -1, 0, 2f, 1, 0);
												}
											}
										}
										if (!unk_0xF68107C40359970C(Local_109[iVar2 /*18*/]) && (iVar3 != -1 && !unk_0xF68107C40359970C(Local_109[iVar3 /*18*/])))
										{
											if ((unk_0xF6F5D18EF8EAB859(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0) && (iVar3 != -1 && unk_0xF6F5D18EF8EAB859(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))) && unk_0x55A0C756C4A8220C(iLocal_70, 0))
											{
												if (unk_0x174CED88B97C78D9(Local_109[iVar2 /*18*/], -1273030092) != 1 && unk_0x174CED88B97C78D9(Local_109[iVar2 /*18*/], -1817882002) != 1)
												{
													unk_0xBC12D08EE7559CCD(Local_109[iVar2 /*18*/], 3, 0);
													unk_0xBC12D08EE7559CCD(Local_109[iVar2 /*18*/], 1, 1);
													unk_0xBC12D08EE7559CCD(Local_109[iVar2 /*18*/], 2, 0);
													if (iVar0 == 0)
													{
														unk_0xFE5A02CF2178B6A8(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
													}
													else if (iVar0 == 1)
													{
														unk_0xFE5A02CF2178B6A8(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, 50f, 786470, 4f, 10f, 1);
													}
													else if (iVar0 == 2)
													{
														unk_0xFE5A02CF2178B6A8(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
												...
												unk_0xBB3480BB855CDB33(Local_109[iVar2 /*18*/], func_45((3f * unk_0x987A5F1E1A67E3C0(Local_54, Local_108[iVar0 /*18*/].f_8, 1)), 50f, 120f));
											}
										}
									}
							...
							else
							{
								if (!unk_0xF68107C40359970C(Local_109[iVar2 /*18*/]))
								{
									if (!unk_0x51B334B227EC8042(Local_109[iVar2 /*18*/]))
									{
										unk_0xDC6110E0F8FF9DA0(Local_109[iVar2 /*18*/], 2, 0);
										unk_0x7734082B0EDB0BE0(Local_109[iVar2 /*18*/], unk_0xE2D3D51028F0428A(), 300f, 100000, 0, 0);
									}
								}
								if (iVar3 != -1)
								{
									if (!unk_0xF68107C40359970C(Local_109[iVar3 /*18*/]))
									{
										if (!unk_0x51B334B227EC8042(Local_109[iVar3 /*18*/]))
										{
											unk_0xDC6110E0F8FF9DA0(Local_109[iVar3 /*18*/], 2, 0);
											unk_0x7734082B0EDB0BE0(Local_109[iVar3 /*18*/], unk_0xE2D3D51028F0428A(), 300f, 100000, 0, 0);
										}
									}
								}
							}
						...
						case 1:
							if (unk_0xD5C6B5E3B93A5EDC(Local_109[iVar2 /*18*/], 0))
							{
								unk_0xAB7639D658BBCCEE(Local_109[iVar2 /*18*/], 1, 256);
							}
							else
							{
							...
							if (iVar3 != -1)
							{
								if (!unk_0xF68107C40359970C(Local_109[iVar3 /*18*/]))
								{
									if (unk_0xD5C6B5E3B93A5EDC(Local_109[iVar3 /*18*/], 0))
									{
										unk_0xAB7639D658BBCCEE(Local_109[iVar3 /*18*/], 0, 256);
									}
									else
									{
					...
					if ((!unk_0xF68107C40359970C(Local_109[iVar2 /*18*/]) && (iVar3 == -1 || !unk_0xF68107C40359970C(Local_109[iVar3 /*18*/]))) && unk_0x55A0C756C4A8220C(Local_108[iVar0 /*18*/], 0))
					{
						iVar4 = 1;
						if (!unk_0x4D21C9FB671ED18F(Local_109[iVar2 /*18*/]))
						{
							iVar4 = 0;
						}
						if (iVar3 != -1)
						{
							if (!unk_0x4D21C9FB671ED18F(Local_109[iVar3 /*18*/]))
							{
								iVar4 = 0;
							}
						}
						if (!unk_0x4D21C9FB671ED18F(Local_108[iVar0 /*18*/]))
						{
							iVar4 = 0;
						}
						if ((iVar4 && vdist(Local_52, Local_108[iVar0 /*18*/].f_8) > 25f) && vdist(Local_52, Local_109[iVar0 /*18*/].f_6) > 25f)
						{
							if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0))
							{
								unk_0xA9F390242F9EB2E1(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], -1);
							}
							if (iVar3 != -1)
							{
								if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))
								{
									unk_0xA9F390242F9EB2E1(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0);
								}
							}
						}
					}
		...
		case 4:
			...
			if (!iLocal_167)
			{
				...
				{
					iVar5 = func_68(iVar0);
					if (!unk_0xF68107C40359970C(Local_109[iVar5 /*18*/]))
					{
						iVar6 = func_66(iVar0);
					}
					else
					...
					if (unk_0x55A0C756C4A8220C(Local_108[iVar0 /*18*/], 0))
					{
						if (!unk_0xF68107C40359970C(Local_109[iVar5 /*18*/]))
						{
							if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], 0))
							{
								if (unk_0x174CED88B97C78D9(Local_109[iVar5 /*18*/], -1794415470) != 1)
								{
									unk_0xB486640392EC50BB(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], -1, -1, 2f, 1, 0);
								}
							}
						}
						if (iVar6 != -1)
						{
							if (!unk_0xF68107C40359970C(Local_109[iVar6 /*18*/]))
							{
								if (!unk_0xF6F5D18EF8EAB859(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], 0))
								{
									if (unk_0x174CED88B97C78D9(Local_109[iVar6 /*18*/], -1794415470) != 1)
									{
										unk_0xB486640392EC50BB(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], -1, 0, 2f, 1, 0);
									}
								}
							}
							if (!unk_0xF68107C40359970C(Local_109[iVar5 /*18*/]) && (iVar6 != -1 && !unk_0xF68107C40359970C(Local_109[iVar6 /*18*/])))
							{
								if ((unk_0xF6F5D18EF8EAB859(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], 0) && (iVar6 != -1 && unk_0xF6F5D18EF8EAB859(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], 0))) && unk_0x55A0C756C4A8220C(iLocal_70, 0))
								{
									fVar7 = func_45((70f - (to_float((unk_0x320D1840B6DAA1CC() - iLocal_66)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (unk_0x320D1840B6DAA1CC() - iLocal_66) > 4000)
									{
										unk_0x3D2EBAC0A745E60C(Local_109[iVar5 /*18*/], fVar7);
										iVar8 = 0;
										while (iVar8 < Local_108)
										{
											if ((unk_0x55A0C756C4A8220C(Local_108[iVar8 /*18*/], 0) && !unk_0xF68107C40359970C(func_63(iVar8, 0))) && unk_0xF6F5D18EF8EAB859(func_63(iVar8, 0), Local_108[iVar8 /*18*/], 0))
											{
												unk_0x03A927199A2DFE46(func_63(iVar8, 0));
												unk_0xFE5A02CF2178B6A8(func_63(iVar8, 0), Local_108[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_167 = 1;
									}
									else if (unk_0x174CED88B97C78D9(Local_109[iVar5 /*18*/], -1273030092) != 1 && unk_0x174CED88B97C78D9(Local_109[iVar5 /*18*/], -1817882002) != 1)
									{
										unk_0xBC12D08EE7559CCD(Local_109[iVar5 /*18*/], 3, 0);
										unk_0xBC12D08EE7559CCD(Local_109[iVar5 /*18*/], 1, 1);
										unk_0xBC12D08EE7559CCD(Local_109[iVar5 /*18*/], 2, 0);
										if (iVar0 == 0)
										{
											unk_0xFE5A02CF2178B6A8(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
										}
										else if (iVar0 == 1)
										{
											unk_0xFE5A02CF2178B6A8(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, fVar7, 786470, 4f, 10f, 1);
										}
										else if (iVar0 == 2)
										{
											unk_0xFE5A02CF2178B6A8(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
					...
					else
					{
						if (!unk_0xF68107C40359970C(Local_109[iVar5 /*18*/]))
						{
							if (!unk_0x51B334B227EC8042(Local_109[iVar5 /*18*/]))
							{
								unk_0xDC6110E0F8FF9DA0(Local_109[iVar5 /*18*/], 2, 0);
								unk_0x7734082B0EDB0BE0(Local_109[iVar5 /*18*/], unk_0xE2D3D51028F0428A(), 300f, 100000, 0, 0);
							}
						}
						if (iVar6 != -1)
						{
							if (!unk_0xF68107C40359970C(Local_109[iVar6 /*18*/]))
							{
								if (!unk_0x51B334B227EC8042(Local_109[iVar6 /*18*/]))
								{
									unk_0xDC6110E0F8FF9DA0(Local_109[iVar6 /*18*/], 2, 0);
									unk_0x7734082B0EDB0BE0(Local_109[iVar6 /*18*/], unk_0xE2D3D51028F0428A(), 300f, 100000, 0, 0);
								}
							}
						}
					}
	...
	while (iVar0 < Local_109)
	{
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
		{
			if (iLocal_47 > 1)
			{
				if (!unk_0xACC32B78196FBC2A(sLocal_134))
				{
					func_34(iVar0);
					if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/].f_2) && unk_0xE85F749F6D5C809E(Local_109[iVar0 /*18*/].f_2))
					{
						if (!unk_0xD5C6B5E3B93A5EDC(Local_109[iVar0 /*18*/], 0))
						{
							if (unk_0x2B5F4FBAF644BEC8(Local_109[iVar0 /*18*/].f_2))
							{
								if (unk_0x03454821A9ECF4AA(Local_109[iVar0 /*18*/]))
								{
									unk_0x1C2ED929474DC6FE(Local_109[iVar0 /*18*/].f_2, 0, 0);
								}
							}
							else if (!unk_0x03454821A9ECF4AA(Local_109[iVar0 /*18*/]))
							{
								unk_0x1C2ED929474DC6FE(Local_109[iVar0 /*18*/].f_2, 1, 0);
							}
							if (!unk_0x4D21C9FB671ED18F(Local_109[iVar0 /*18*/]))
							{
								if (!unk_0xFCF559C8631ABED7(Local_109[iVar0 /*18*/], sLocal_134, func_33(iVar0), 3))
								{
									if (!Local_109[iVar0 /*18*/].f_11)
									{
										if (!unk_0xFCF559C8631ABED7(Local_109[iVar0 /*18*/], sLocal_134, "grip", 3))
										{
											unk_0x49D97B076E3590AC(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 57, 0, 0, 0, 0);
								...
								{
									unk_0x49D97B076E3590AC(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 48, 0.99f, 0, 0, 0);
									Local_109[iVar0 /*18*/].f_11 = 0;
								}
							}
							if (!Local_109[iVar0 /*18*/].f_10)
							{
								unk_0x3ACA4F727AC4606E(sLocal_134);
								if (unk_0xBB103A5DEC572725(sLocal_134))
								{
									unk_0xF31FD609B1E9F297(Local_109[iVar0 /*18*/], sLocal_134);
						...
						else
						{
							...
							if (Local_109[iVar0 /*18*/].f_10)
							{
								unk_0x2DCD5A713355AB1B(Local_109[iVar0 /*18*/]);
								Local_109[iVar0 /*18*/].f_10 = 0;
							}
						}
						if (unk_0x174B84F6B78D6CA7(Local_109[iVar0 /*18*/]) && func_32(Local_109[iVar0 /*18*/], unk_0xB3FF0049C1FD38EC(Local_109[iVar0 /*18*/], 0)) == -1)
						{
							if (unk_0x2B5F4FBAF644BEC8(Local_109[iVar0 /*18*/].f_2))
							{
								unk_0x1C2ED929474DC6FE(Local_109[iVar0 /*18*/].f_2, 0, 0);
						...
						else if (!unk_0x2B5F4FBAF644BEC8(Local_109[iVar0 /*18*/].f_2))
						{
							unk_0x1C2ED929474DC6FE(Local_109[iVar0 /*18*/].f_2, 1, 0);
						}
					}
			...
			if (iLocal_45 != 7)
			{
				if (unk_0x177106D5E97D1958(Local_109[iVar0 /*18*/]) && unk_0x706E4529F37489DB(unk_0xE2D3D51028F0428A()))
				{
					func_187(7);
				}
			}
	...
	if (iLocal_45 != 7)
	{
		...
		while (iVar0 < Local_108)
		{
			if (unk_0xE5965CDF24F93A9F(Local_108[iVar0 /*18*/]))
			{
				if (unk_0x55A0C756C4A8220C(Local_108[iVar0 /*18*/], 0))
				{
					if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), Local_108[iVar0 /*18*/], 0))
...
void func_34(int iParam0)
{
	...
	while (iVar0 < 15)
	{
		if (unk_0xE2D0C323A1AE5D85(Local_109[iParam0 /*18*/].f_15, iVar0))
		{
			iVar1 = 5;
			...
			if (iVar3 < iVar1)
			{
				if (unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0), 3))
				{
					if (unk_0xD01FAFCE275C94F3(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0)) > 0.9f)
					{
						unk_0xB0550BC91B0159D6(&(Local_109[iParam0 /*18*/].f_15), iVar0);
					}
				}
			}
			else if (iVar3 < iVar2)
			{
				if (unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[(iVar3 - iVar1)], 3))
				{
					if (unk_0xD01FAFCE275C94F3(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[(iVar3 - iVar1)]) > 0.9f)
					{
						unk_0xB0550BC91B0159D6(&(Local_109[iParam0 /*18*/].f_15), iVar0);
					}
				}
			}
			else if (!unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sLocal_134, "grip", 3))
			{
				unk_0xB0550BC91B0159D6(&(Local_109[iParam0 /*18*/].f_15), iVar0);
			}
		}
...
void func_35()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		...
		if (((unk_0xE5965CDF24F93A9F(Local_108[iLocal_149 /*18*/]) && unk_0x55A0C756C4A8220C(Local_108[iLocal_149 /*18*/], 0)) && unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/])) && !unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
		{
			if (unk_0x7010991FDA59D3F2(Local_108[iLocal_149 /*18*/], joaat("cavalcade2")))
			{
				if (vdist2(Local_109[iVar0 /*18*/].f_6, Local_53) < pow(30f, 2f) && unk_0xAB793EA186AB8DAA(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					...
					else if (!func_42(iVar0) && (unk_0x320D1840B6DAA1CC() - Local_109[iVar0 /*18*/].f_13) > 1000)
					{
						if (!unk_0xFCF559C8631ABED7(Local_109[iVar0 /*18*/], sLocal_135, "base", 3))
						{
							unk_0x49D97B076E3590AC(Local_109[iVar0 /*18*/], sLocal_135, "base", 8f, 1000f, -1, 16, 0, 0, 0, 0);
						}
					}
				}
			}
			else if (!Local_109[iVar0 /*18*/].f_9)
			{
				if (vdist2(Local_109[iVar0 /*18*/].f_6, Local_53) < pow(30f, 2f) && unk_0xAB793EA186AB8DAA(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					unk_0x26D2934CF2D5B32C(Local_109[iVar0 /*18*/], "random@paparazzi@pap_anims", "sweep_low", "sweep_med", "sweep_high", -1, iLocal_67, 1070134723, 1048576000);
					Local_109[iVar0 /*18*/].f_9 = 1;
					Local_109[iVar0 /*18*/].f_13 = unk_0x320D1840B6DAA1CC();
				}
			}
			else if (Local_109[iVar0 /*18*/].f_9)
			{
				if ((unk_0x320D1840B6DAA1CC() - Local_109[iVar0 /*18*/].f_13) > 2000)
				{
...
void func_36(int iParam0)
{
	...
	if (!unk_0xF68107C40359970C(Local_109[iParam0 /*18*/]) && !unk_0xF68107C40359970C(iLocal_67))
	{
		iVar0 = 15;
		Var1 = { Local_53 - Local_109[iParam0 /*18*/].f_6 };
		Var2 = { unk_0x63BEA94AB58D4E6D(Local_109[iParam0 /*18*/]) };
		fVar3 = func_40(Var2, Var1);
		if (unk_0x48053974ED6F63CE(fVar3) < 10f)
		{
			iVar0 = 5;
		}
...
void func_37(int iParam0, int iParam1)
{
	if (iParam1 < 15)
	{
		if (!unk_0xE2D0C323A1AE5D85(Local_109[iParam0 /*18*/].f_15, iParam1))
		{
			if (func_39(iParam1))
			{
				unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[func_38(iParam1)], 4f, -4f, -1, 16, 0, 0, 0, 0);
			}
			else if (iParam1 < 5)
			{
				unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sLocal_134, func_33(iParam0), 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else
			{
				unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sLocal_134, "grip", 1000f, -1000f, -1, 57, 0, 0, 0, 0);
			}
			Local_109[iParam0 /*18*/].f_15 = 0;
			unk_0xCED9E32812D6C7C7(&(Local_109[iParam0 /*18*/].f_15), iParam1);
		}
	}
}
...
float func_40(struct<3> Param0, struct<3> Param1)
{
	...
	fVar0 = (unk_0xC529D13129C03CF4(Param1.f_1, Param1.x) - unk_0xC529D13129C03CF4(Param0.f_1, Param0.x));
	if (fVar0 > 180f)
	{
		fVar0 = (fVar0 - 360f);
	}
...
bool func_42(int iParam0)
{
	...
	bVar0 = false;
	if (!unk_0xACC32B78196FBC2A(sLocal_135))
	{
		iVar1 = 5;
		while (iVar1 <= 13)
		{
			if (!bVar0)
			{
				if (unk_0xE2D0C323A1AE5D85(Local_109[iParam0 /*18*/].f_15, iVar1))
				{
					bVar0 = true;
				}
			}
...
void func_43(int iParam0)
{
	...
	if (unk_0xE5965CDF24F93A9F(Local_108[iParam0 /*18*/]) && unk_0x4D21C9FB671ED18F(Local_108[iParam0 /*18*/]))
	{
		unk_0xD59CC8123FD1A789(&(Local_108[iParam0 /*18*/]));
	}
	if (unk_0x12DD4A0B247D9B4D(Local_108[iParam0 /*18*/].f_1))
	{
		unk_0xFFD8EB5462B07B59(&(Local_108[iParam0 /*18*/].f_1));
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		...
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar1 /*18*/]) && unk_0x4D21C9FB671ED18F(Local_109[iVar1 /*18*/]))
		{
			if (unk_0xE5965CDF24F93A9F(Local_109[iVar1 /*18*/]))
			{
				unk_0x4BDA5AFD88C085EB(&(Local_109[iVar1 /*18*/].f_2));
			}
			if (unk_0x12DD4A0B247D9B4D(Local_109[iVar1 /*18*/].f_1))
			{
				unk_0xFFD8EB5462B07B59(&(Local_109[iVar1 /*18*/].f_1));
			}
			unk_0x05CB75C0837196F9(&(Local_109[iVar1 /*18*/]));
		}
		iVar0++;
	}
}
...
int func_44(int iParam0, float fParam1)
{
	...
	iVar0 = 1;
	if (unk_0xE5965CDF24F93A9F(Local_108[iParam0 /*18*/]))
	{
		if (unk_0x55A0C756C4A8220C(Local_108[iParam0 /*18*/], 0))
		{
			if (vdist2(Local_52, Local_108[iParam0 /*18*/].f_8) < (fParam1 * fParam1) || !unk_0x4D21C9FB671ED18F(Local_108[iParam0 /*18*/]))
			{
				iVar0 = 0;
			}
		}
	...
	if (unk_0xE5965CDF24F93A9F(func_63(iParam0, 0)))
	{
		...
		{
			if (vdist2(Local_52, Local_109[func_68(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !unk_0x4D21C9FB671ED18F(func_63(iParam0, 0)))
			{
				iVar0 = 0;
			}
		}
	...
	if (unk_0xE5965CDF24F93A9F(func_63(iParam0, 1)))
	{
		...
		{
			if (vdist2(Local_52, Local_109[func_66(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !unk_0x4D21C9FB671ED18F(func_63(iParam0, 1)))
			{
				iVar0 = 0;
			}
		}
...
void func_46(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9)
{
	if (unk_0xE5965CDF24F93A9F(iParam0) && unk_0x55A0C756C4A8220C(iParam0, 0))
	{
		if (((((unk_0xE5965CDF24F93A9F(iParam1) && iParam0 != iParam1) && !unk_0xD2B5B1C8FC84FE0F(unk_0x15CAA6D7B11F1A7C(iParam1))) && !unk_0xD6F7D32A98E07F93(unk_0x15CAA6D7B11F1A7C(iParam1))) && !unk_0x4262B4DCEADC2695(unk_0x15CAA6D7B11F1A7C(iParam1))) && !unk_0xF4AD75B2D964D8AB(unk_0x15CAA6D7B11F1A7C(iParam1)))
		{
			...
			{
				if (func_49(iParam0, iParam1, iLocal_119, unk_0x6B62510F212526DC(iParam1, 1), unk_0x63A8BF5E6C2BF85C(iParam1, 2)))
				{
					*uParam2 = { *uParam4 };
					*uParam3 = *uParam5;
			...
			else if ((unk_0x320D1840B6DAA1CC() - *uParam6) > iParam8)
			{
				if ((func_48(iParam0, iParam1, 1) > fParam9 && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(iParam1, 1), *uParam2, 1) > 20f) && vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), *uParam2) > 100f)
				{
					if (!func_47(*uParam2))
					{
...
void func_50()
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_148) > 100)
	{
		if ((unk_0x320D1840B6DAA1CC() - Local_109[iLocal_147 /*18*/].f_12) > 500)
		{
			if (unk_0xE5965CDF24F93A9F(Local_109[iLocal_147 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iLocal_147 /*18*/]))
			{
				bVar0 = true;
				if (!Local_109[iLocal_147 /*18*/].f_9 && unk_0xD5C6B5E3B93A5EDC(Local_109[iLocal_147 /*18*/], 0))
				{
					bVar0 = false;
				}
				if (bVar0)
				{
					if (((unk_0xFCF559C8631ABED7(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147), 3) && unk_0xD01FAFCE275C94F3(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147)) > 0.5f) && unk_0xD01FAFCE275C94F3(Local_109[iLocal_147 /*18*/], sLocal_134, func_33(iLocal_147)) < 0.75f) || Local_109[iLocal_147 /*18*/].f_9)
					{
						unk_0x74A35BFF0670ECD4("scr_rcpap1_camera", Local_109[iLocal_147 /*18*/].f_2, 0.019f, -0.01f, 0.046f, 0f, 0f, -180f, 1065353216, 0, 0, 0);
						if ((iLocal_147 % 3) == 0)
						{
							unk_0xD336F8D9637B963F(-1, "SHUTTER_FLASH", unk_0x6B62510F212526DC(Local_109[iLocal_147 /*18*/].f_2, 1), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						else if ((iLocal_147 % 3) == 1)
						{
							unk_0xD336F8D9637B963F(-1, "SHUTTER", unk_0x6B62510F212526DC(Local_109[iLocal_147 /*18*/].f_2, 1), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						else
						{
							unk_0xD336F8D9637B963F(-1, "FLASH", unk_0x6B62510F212526DC(Local_109[iLocal_147 /*18*/].f_2, 1), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						Local_109[iLocal_147 /*18*/].f_12 = unk_0x320D1840B6DAA1CC();
					}
...
{
	if (!unk_0xF68107C40359970C(Local_109[iParam1 /*18*/]) && !unk_0xF68107C40359970C(iParam0))
	{
		if (!unk_0x2E7F5417D4F4DD69(Local_109[iParam1 /*18*/], iParam0, 20f))
		{
			if (unk_0x174CED88B97C78D9(Local_109[iParam1 /*18*/], -875674219) != 1)
			{
				unk_0x529D306014D3C29A(Local_109[iParam1 /*18*/], iParam0, 0);
			}
		}
		else if ((unk_0x320D1840B6DAA1CC() - Local_109[iParam1 /*18*/].f_13) > 2000)
		{
			if (!unk_0xFCF559C8631ABED7(Local_109[iParam1 /*18*/], sLocal_134, func_33(iParam1), 3))
			{
				unk_0x49D97B076E3590AC(Local_109[iParam1 /*18*/], sLocal_134, func_33(iParam1), 4f, -4f, -1, 0, 0, 0, 0, 0);
				Local_109[iParam1 /*18*/].f_13 = unk_0x320D1840B6DAA1CC();
			}
		}
	}
}
...
void func_52(int iParam0, int iParam1)
{
	...
	if (!unk_0xF68107C40359970C(Local_109[iParam1 /*18*/]) && !unk_0xF68107C40359970C(iParam0))
	{
		...
		switch (Local_109[iParam1 /*18*/].f_16)
		{
			...
			case 1:
				if (unk_0x174CED88B97C78D9(Local_109[iParam1 /*18*/], 713668775) != 1 || vdist(Var0, Local_109[iParam1 /*18*/].f_6) > 5f)
				{
					Local_109[iParam1 /*18*/].f_16++;
				}
				break;
			...
			case 3:
				...
				if (unk_0x174CED88B97C78D9(Local_109[iParam1 /*18*/], 713668775) != 1)
				{
...
void func_53(struct<3> Param0, int iParam1, int iParam2)
{
	...
	Var0 = { func_41(unk_0x6B62510F212526DC(iParam2, 1) - Param0) };
	iVar1 = unk_0xD12EFCAB87804BED(Var0.x, Var0.f_1);
	Local_109[iParam1 /*18*/].f_3 = { Param0 };
	unk_0x03A927199A2DFE46(Local_109[iParam1 /*18*/]);
	if (vdist(Param0, Local_109[iParam1 /*18*/].f_6) < 2f)
	{
		unk_0x7D1424753688EE7A(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 1f, -1, 0.5f, 512, iVar1);
	}
	else
	{
		unk_0x7D1424753688EE7A(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 2f, -1, 0.5f, 512, iVar1);
	}
}
...
void func_55()
{
	...
	while (iVar0 < Local_109)
	{
		if (unk_0x12DD4A0B247D9B4D(Local_109[iVar0 /*18*/].f_1))
		{
			if (unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
			{
				unk_0xFFD8EB5462B07B59(&(Local_109[iVar0 /*18*/].f_1));
			}
			else if (unk_0xD5C6B5E3B93A5EDC(Local_109[iVar0 /*18*/], 0))
			{
				unk_0xFFD8EB5462B07B59(&(Local_109[iVar0 /*18*/].f_1));
			}
		}
		else if (!unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]) && !unk_0xD5C6B5E3B93A5EDC(Local_109[iVar0 /*18*/], 0))
		{
			Local_109[iVar0 /*18*/].f_1 = func_189(Local_109[iVar0 /*18*/], 1, 145);
			unk_0xAF62582F3EA39095(Local_109[iVar0 /*18*/].f_1, "EP_PAPBLIP");
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Local_108)
	{
		if (unk_0x55A0C756C4A8220C(Local_108[iVar0 /*18*/], 0))
		{
			if (unk_0x12DD4A0B247D9B4D(Local_108[iVar0 /*18*/].f_1))
			{
				Var1 = { unk_0x1A3931A61B3223A2(Local_108[iVar0 /*18*/].f_1) };
				...
				unk_0xFB7ACC9D9D6401A8(Local_108[iVar0 /*18*/].f_1, Var1);
				if (func_58(Local_108[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0, 1))
				{
					unk_0xFFD8EB5462B07B59(&(Local_108[iVar0 /*18*/].f_1));
				}
			}
			else if (!func_58(Local_108[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0, 1))
			{
				Local_108[iVar0 /*18*/].f_1 = func_56(Local_108[iVar0 /*18*/].f_8, 0);
				unk_0xA582EE8380437B1B(Local_108[iVar0 /*18*/].f_1, 1);
				unk_0xAF62582F3EA39095(Local_108[iVar0 /*18*/].f_1, "EP_PAPBLIP");
				unk_0x7A610B2EC5DA34E7(Local_108[iVar0 /*18*/].f_1, 9);
			}
		}
		else if (unk_0x12DD4A0B247D9B4D(Local_108[iVar0 /*18*/].f_1))
		{
			unk_0xFFD8EB5462B07B59(&(Local_108[iVar0 /*18*/].f_1));
		}
		iVar0++;
...
{
	if (!unk_0xF68107C40359970C(Local_109[iParam0 /*18*/]))
	{
		if (vdist(unk_0x6B62510F212526DC(Local_109[iParam0 /*18*/], 1), Param1) > 1.5f)
		{
			if (unk_0x174CED88B97C78D9(Local_109[iParam0 /*18*/], 713668775) != 1)
			{
				unk_0x7D1424753688EE7A(Local_109[iParam0 /*18*/], Param1, 2f, -1, 0.25f, 0, fParam2);
			}
		}
		else if (unk_0x48053974ED6F63CE((func_62(unk_0x82FE2343F8BDFF0B(Local_109[iParam0 /*18*/])) - func_62(fParam2))) > 10f)
		{
			if (unk_0x174CED88B97C78D9(Local_109[iParam0 /*18*/], 1920390111) != 1)
			{
				unk_0x30E00B59448AB97E(Local_109[iParam0 /*18*/], fParam2, 0);
			}
		}
		else
		{
			switch (Local_109[iParam0 /*18*/].f_16)
			{
				case 0:
					...
					{
						if (!unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sParam3, sParam4, 3))
						{
							unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, -1, 1, 0, 0, 0, 0);
						}
					}
					else if (!unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sParam3, sParam4, 3))
					{
						unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (unk_0xD01FAFCE275C94F3(Local_109[iParam0 /*18*/], sParam3, sParam4) > 0.99f)
					{
						unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sParam3, sParam5, 4f, -4f, -1, 0, 0, 0, 0, 0);
						Local_109[iParam0 /*18*/].f_16++;
					}
					break;
				
				case 1:
					if (!unk_0xFCF559C8631ABED7(Local_109[iParam0 /*18*/], sParam3, sParam5, 3))
					{
						unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sParam3, sParam5, 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (unk_0xD01FAFCE275C94F3(Local_109[iParam0 /*18*/], sParam3, sParam5) > 0.99f)
					{
						unk_0x49D97B076E3590AC(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, -1, 0, 0, 0, 0, 0);
...
void func_64(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	if ((iParam0 % 2) == 1)
	{
		Local_108[iParam0 /*18*/] = unk_0xBA715A7BEBA5A1F9(joaat("vader"), Param1, fParam2, 1, 1, 0);
	}
	else
	{
		Local_108[iParam0 /*18*/] = unk_0xBA715A7BEBA5A1F9(joaat("cavalcade2"), Param1, fParam2, 1, 1, 0);
		unk_0xD584204572DF0440(Local_108[iParam0 /*18*/], 0);
	}
	unk_0x9F65B3BAFA302A65(Local_108[iParam0 /*18*/], 1084227584);
	unk_0xFF74DEC3F62D3654(Local_108[iParam0 /*18*/], 1);
	if (bParam3)
	{
		if (!unk_0xE5965CDF24F93A9F(func_63(iParam0, 0)))
		{
		...
		if (!unk_0xF68107C40359970C(func_63(iParam0, 0)) && unk_0x55A0C756C4A8220C(Local_108[iParam0 /*18*/], 0))
		{
			unk_0xA9F390242F9EB2E1(func_63(iParam0, 0), Local_108[iParam0 /*18*/], -1);
		}
		if (!unk_0xF68107C40359970C(func_63(iParam0, 1)) && unk_0x55A0C756C4A8220C(Local_108[iParam0 /*18*/], 0))
		{
			unk_0xA9F390242F9EB2E1(func_63(iParam0, 1), Local_108[iParam0 /*18*/], 0);
		}
		unk_0x371D594409A68A18(Local_108[iParam0 /*18*/], 1, 1, 0);
	}
}

void func_65(int iParam0, struct<3> Param1, float fParam2)
{
	Local_109[iParam0 /*18*/] = unk_0xA8D58C3AADA2C41C(26, joaat("a_m_y_genstreet_02"), Param1, fParam2, 1, 1);
	unk_0xBC12D08EE7559CCD(Local_109[iParam0 /*18*/], 1, 0);
	unk_0x50274A7EACA3133A(Local_109[iParam0 /*18*/], 1);
	unk_0xBC12D08EE7559CCD(Local_109[iParam0 /*18*/], 0, 1);
	unk_0xB11C0CF5CCDFE10A(Local_109[iParam0 /*18*/], 3);
	unk_0x0407CF7EFEE35240(Local_109[iParam0 /*18*/], 1);
	unk_0xBC12D08EE7559CCD(Local_109[iParam0 /*18*/], 17, 1);
	unk_0xDC6110E0F8FF9DA0(Local_109[iParam0 /*18*/], 2, 0);
	unk_0x398C962F550CF3B4(Local_109[iParam0 /*18*/], 0);
	unk_0xABC2CA6F28903308(Local_109[iParam0 /*18*/], 1);
	unk_0xC97BA48BC273A1F3(Local_109[iParam0 /*18*/], 100);
	unk_0x8913620F26B565CE(Local_109[iParam0 /*18*/], -957453492);
	unk_0xD6A76BAB45A4B460(Local_109[iParam0 /*18*/], 101, 1);
	unk_0xD6A76BAB45A4B460(Local_109[iParam0 /*18*/], 185, 0);
	unk_0xF160248D9083ED0C(Local_109[iParam0 /*18*/], 300, 0);
	unk_0xE3752B10DC995E95(Local_109[iParam0 /*18*/], 3, (iParam0 % 2), floor((to_float(iParam0) / 2f)), 0);
	if (Global_3 || bLocal_56)
	{
		unk_0x9210F85E9CD785F1(Local_109[iParam0 /*18*/], 1);
		unk_0xF160248D9083ED0C(Local_109[iParam0 /*18*/], 500, 0);
	}
	unk_0x7DCB4594ACF18DA7(Local_109[iParam0 /*18*/], 1);
	unk_0xBC12D08EE7559CCD(Local_109[iParam0 /*18*/], 2, 1);
	unk_0xCAC4D1050F2E6899(Local_109[iParam0 /*18*/], 2f);
	unk_0x398C962F550CF3B4(Local_109[iParam0 /*18*/], 0);
	unk_0xA84812D8D6EE8D32(Local_109[iParam0 /*18*/], 0);
	Local_109[iParam0 /*18*/].f_2 = unk_0x0E536D72AB30F4C8(joaat("prop_pap_camera_01"), unk_0x6EA486FF6D815B4B(Local_109[iParam0 /*18*/], 28422, 0f, 0f, 0f), 1, 1, 0);
	unk_0x9A97DC6DBC7B223D(Local_109[iParam0 /*18*/].f_2, Local_109[iParam0 /*18*/], unk_0xB897FCFCFA664B38(Local_109[iParam0 /*18*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	if (unk_0xE5965CDF24F93A9F(Local_109[0 /*18*/].f_2))
	{
		unk_0x1C2ED929474DC6FE(Local_109[0 /*18*/].f_2, 0, 0);
	}
	Local_109[iParam0 /*18*/].f_17 = unk_0x0CF63873D754B965(Local_109[iParam0 /*18*/]);
}
...
int func_70()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		...
		if (func_73())
		{
			...
			{
				if (vdist(unk_0x6B62510F212526DC(func_72(), 1), Local_53) < 5f && unk_0x207D53F9E0190691(iLocal_70) < 1f)
				{
					bVar0 = true;
				}
			}
		}
		else if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
		{
			if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0) && unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
			{
				fLocal_151 = (fLocal_151 + unk_0x51109C28352EC9A3());
			}
		...
		if (iLocal_57)
		{
			if (!unk_0x87B449F4C26E764A(iLocal_67, iLocal_70))
			{
				if (unk_0x32DCDA1B2F8A0694(iLocal_67))
				{
					bVar1 = true;
				}
				iLocal_57 = 0;
		...
		if (!unk_0x55A0C756C4A8220C(iLocal_70, 0) && (!bLocal_129 || iLocal_45 == 1))
		{
			bVar1 = true;
		}
		...
		if (((unk_0x55A0C756C4A8220C(iLocal_70, 0) && func_71(iLocal_70)) && (!bLocal_129 || iLocal_45 == 1)) && vdist(unk_0x6B62510F212526DC(iLocal_67, 1), Local_50) > 15f)
		{
			bVar1 = true;
		}
		if (unk_0x55A0C756C4A8220C(iLocal_70, 0) && unk_0xD8F9DF94CD871327(iLocal_70))
		{
			bVar1 = true;
		}
		if (bVar1)
...
int func_73()
{
	if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
	{
		if (!unk_0xF68107C40359970C(iLocal_67))
		{
			if (unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0) && unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0))
			{
				return 1;
			}
		}
...
int func_74()
{
	...
	while (iVar0 < Local_109)
	{
		...
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]))
		{
			if (unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]) || unk_0x55B23FE400FCEA6B(Local_109[iVar0 /*18*/], 0))
			{
...
int func_75(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		if (vdist2(Var0, Local_52) < 400f)
		{
			...
			if ((iVar1 == joaat("weapon_petrolcan") && unk_0xE323E6755636A70E(unk_0xE2D3D51028F0428A())) && vdist2(Local_52, Var0) < 9f)
			{
				return 1;
			}
			if (((unk_0x24E6C39AAC2154D0(unk_0x9E2D6C50374FCFA9(), iParam0) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iParam0)) && (func_76(Local_52, iParam0) && vdist2(Local_52, unk_0x6B62510F212526DC(iParam0, 1)) < 100f)) && unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6))
			{
				return 1;
			}
			if (iLocal_137 > 150)
...
int func_76(struct<3> Param0, int iParam1)
{
	...
	Var1 = { unk_0xCACAD935C0BEE14F(iParam1, 0f, 1f, 0f) - Var0 };
	Var2 = { Param0 - Var0 };
...
{
	if ((unk_0x320D1840B6DAA1CC() - iLocal_197) > 5000)
	{
		if (!func_80())
		{
			if (func_5(&Local_139, cLocal_133, sParam0, 4, 0, 0, 0))
			{
				iLocal_197 = unk_0x320D1840B6DAA1CC();
			}
		}
	}
}
...
bool func_81()
{
	if (!unk_0xF68107C40359970C(iLocal_67) && vdist2(Local_52, Local_53) < 400f)
	{
		if (!iLocal_111 && (unk_0x320D1840B6DAA1CC() - iLocal_113) > 5000)
		{
			if (iLocal_63 > 10)
			{
				iLocal_111 = 1;
		...
		if ((!iLocal_116 && !iLocal_111) && (unk_0x320D1840B6DAA1CC() - iLocal_117) > 4000)
		{
		...
		if (((!iLocal_114 && !iLocal_111) && !iLocal_116) && (unk_0x320D1840B6DAA1CC() - iLocal_115) > 15000)
		{
		...
		if (iLocal_116)
		{
			...
			{
				iLocal_117 = unk_0x320D1840B6DAA1CC();
				iLocal_116 = 0;
			}
		}
		if (iLocal_114)
...
void func_82()
{
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		unk_0xABC2CA6F28903308(iLocal_67, 1);
		unk_0x9972EFADA7A2A47D(255, uLocal_55, 1862763509);
		if (!Global_3 && !bLocal_56)
		{
			unk_0xD6A76BAB45A4B460(iLocal_67, 317, 1);
			unk_0x50274A7EACA3133A(iLocal_67, 0);
		}
	}
	func_86(-1, 0);
	func_83();
...
void func_89()
{
	...
	{
		func_91(13, floor(Global_112915.f_10194.f_3853));
	}
...
void func_107()
{
	...
	switch (iLocal_130)
	{
		case 0:
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				unk_0x7734082B0EDB0BE0(iLocal_67, unk_0xE2D3D51028F0428A(), 300f, -1, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 < Local_109)
			{
				if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]))
				{
					if (unk_0x4D21C9FB671ED18F(Local_109[iVar0 /*18*/]) && vdist2(unk_0x6B62510F212526DC(Local_109[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 900f)
					{
						if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/].f_2))
						{
							unk_0x4BDA5AFD88C085EB(&(Local_109[iVar0 /*18*/].f_2));
						}
						unk_0x05CB75C0837196F9(&(Local_109[iVar0 /*18*/]));
					}
				}
				if (unk_0x12DD4A0B247D9B4D(Local_109[iVar0 /*18*/].f_1))
				{
			...
			while (iVar0 < Local_108)
			{
				if (unk_0xE5965CDF24F93A9F(Local_108[iVar0 /*18*/]))
				{
					if (unk_0x4D21C9FB671ED18F(Local_108[iVar0 /*18*/]) && vdist2(unk_0x6B62510F212526DC(Local_108[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 900f)
					{
						unk_0xD59CC8123FD1A789(&(Local_108[iVar0 /*18*/]));
					}
				}
				if (unk_0x12DD4A0B247D9B4D(Local_108[iVar0 /*18*/].f_1))
				{
		...
		case 1:
			...
			while (iVar0 < Local_109)
			{
				if ((unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iVar0 /*18*/])) && !unk_0x55B23FE400FCEA6B(Local_109[iVar0 /*18*/], 0))
				{
					iVar1++;
					func_52(unk_0xE2D3D51028F0428A(), iVar0);
					if (unk_0x4D21C9FB671ED18F(Local_109[iVar0 /*18*/]) && vdist2(unk_0x6B62510F212526DC(Local_109[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 2500f)
					{
						if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/].f_2))
						{
							unk_0x4BDA5AFD88C085EB(&(Local_109[iVar0 /*18*/].f_2));
			...
			if (!iLocal_203)
			{
				if (vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(func_72(), 1)) < 100f)
				{
					...
					if (func_24() == 1)
					{
						...
						switch (iVar2)
						{
							case 0:
								...
								if (unk_0xE5965CDF24F93A9F(Local_139[6 /*10*/]) && !unk_0xF68107C40359970C(Local_139[6 /*10*/]))
								{
							...
							case 1:
								...
								if (unk_0xE5965CDF24F93A9F(Local_139[7 /*10*/]) && !unk_0xF68107C40359970C(Local_139[7 /*10*/]))
								{
							...
							case 2:
								...
								if (unk_0xE5965CDF24F93A9F(Local_139[8 /*10*/]) && !unk_0xF68107C40359970C(Local_139[8 /*10*/]))
								{
					...
					else if (func_24() == 2)
					{
						...
						switch (iVar2)
						{
							case 0:
								func_22(&Local_139, 6, func_72(), "PAP1ESCAPE", 0, 1);
								if (unk_0xE5965CDF24F93A9F(Local_139[iVar2 /*10*/]) && !unk_0xF68107C40359970C(Local_139[iVar2 /*10*/]))
								{
...
void func_108(char* sParam0)
{
	...
	if (!iLocal_202)
	{
		...
		while (iVar0 < Local_109)
		{
			if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
			{
				unk_0x03A927199A2DFE46(Local_109[iVar0 /*18*/]);
		...
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/]))
		{
			if (!unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
			{
				...
				if (!unk_0xF68107C40359970C(iLocal_67))
				{
					if (unk_0xD5C6B5E3B93A5EDC(Local_109[iVar0 /*18*/], 0))
					{
						unk_0xAB7639D658BBCCEE(Local_109[iVar0 /*18*/], 0, 0);
					}
					else
					{
				...
				else if (unk_0x174CED88B97C78D9(Local_109[iVar0 /*18*/], -1146898486) != 1)
				{
					unk_0xD86A0BC9CC0A625A(Local_109[iVar0 /*18*/], 1193033728, 0);
				}
			}
			if ((unk_0x4D21C9FB671ED18F(Local_109[iVar0 /*18*/]) && vdist2(unk_0x6B62510F212526DC(Local_109[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 400f) && vdist2(unk_0x6B62510F212526DC(Local_109[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 400f)
			{
				unk_0x05CB75C0837196F9(&(Local_109[iVar0 /*18*/]));
				if (unk_0xE5965CDF24F93A9F(Local_109[iVar0 /*18*/].f_2))
				{
	...
	while (iVar0 < Local_108)
	{
		if (unk_0xE5965CDF24F93A9F(Local_108[iVar0 /*18*/]))
		{
			if ((unk_0x4D21C9FB671ED18F(Local_108[iVar0 /*18*/]) && vdist2(unk_0x6B62510F212526DC(Local_108[iVar0 /*18*/], 1), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 2500f) && func_58(Local_108[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0, 1))
			{
				unk_0x3D81769BEC61BFF8(&(Local_108[iVar0 /*18*/]));
			}
		}
		if (unk_0x12DD4A0B247D9B4D(Local_108[iVar0 /*18*/].f_1))
		{
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_67))
	{
		if (unk_0x4D21C9FB671ED18F(iLocal_67) && vdist2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_53) > 2500f)
		{
			unk_0xB3822DB3D538C8F3(&iLocal_67);
			func_280();
		}
	}
	...
	switch (iLocal_130)
	{
		case 0:
			...
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				unk_0x03A927199A2DFE46(iLocal_67);
				unk_0xCAC4D1050F2E6899(iLocal_67, 3f);
			}
			func_109();
		...
		case 1:
			if (((unk_0x55A0C756C4A8220C(iLocal_70, 0) && unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0)) && !bLocal_129) && unk_0x7158135695FAE89D(iLocal_70, -1, 0))
			{
				if (vdist(Local_53, Local_49) < 100f)
				{
					unk_0xA888F8CC04F25CC8(&uVar2);
					unk_0x8625186D3A8DDD7A(0, iLocal_70, 0);
					unk_0x3B8F94419979A0B1(0, iLocal_70, Local_49, 20f, 0, joaat("serrano"), 786599, 10f, 10f);
					unk_0x5B7AF57D366861F2(0, iLocal_70, Local_49, 288.7089f, 1, 50f, 0);
					unk_0xFDB121077308E944(0, iLocal_70, unk_0x6B62510F212526DC(iLocal_70, 1), 5, 10f, 262144, 2f, 2f, 1);
					unk_0x02F1CAAC7CB77E47(0, iLocal_70, 0);
					unk_0x7D1424753688EE7A(0, Local_50, 1f, -1, 0.25f, 512, fLocal_51);
					unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_SMOKING", 0, 1);
					unk_0xC963A45B50851768(uVar2);
					unk_0x8ACADA903FCAA42F(iLocal_67, uVar2);
				...
				else
				{
					...
					unk_0x8625186D3A8DDD7A(0, iLocal_70, 0);
					unk_0xAD6CDBCDA713560A(0, iLocal_70, 15f, 786468);
					unk_0xC963A45B50851768(uVar3);
					unk_0x8ACADA903FCAA42F(iLocal_67, uVar3);
			...
			{
				if (unk_0xD5C6B5E3B93A5EDC(iLocal_67, 0))
				{
					unk_0xAB7639D658BBCCEE(iLocal_67, 0, 0);
				}
				iLocal_130++;
			}
			break;
		...
		case 2:
			if (iVar1 > 0)
			{
				unk_0x7734082B0EDB0BE0(iLocal_67, unk_0xE2D3D51028F0428A(), 3000f, -1, 1, 0);
				iLocal_130 = 1000;
			}
			else
			{
				if (vdist(Local_53, Local_49) < 100f)
				{
					...
					unk_0x8ACADA903FCAA42F(iLocal_67, uVar4);
					unk_0x7461D7C5BA953BC7(&uVar4);
				}
				else
				{
					unk_0xD86A0BC9CC0A625A(iLocal_67, 1193033728, 0);
				}
				iLocal_130 = 1000;
			}
			break;
...
{
	func_109();
	if (!unk_0xF68107C40359970C(iLocal_67) && vdist2(Local_52, Local_53) < 900f)
	{
		unk_0x03A927199A2DFE46(iLocal_67);
		...
		unk_0xFF4BEB6CFF55A013(iLocal_67, -2065892691);
	}
	else
	{
		func_199();
	...
	switch (iLocal_130)
	{
		case 0:
			...
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				...
				unk_0x02F1CAAC7CB77E47(0, iLocal_70, 0);
				unk_0x7D1424753688EE7A(0, Local_50, 1f, 30000, 0.25f, 512, fLocal_51);
				unk_0xC9FEFB406C44F60B(0, "WORLD_HUMAN_SMOKING", 0, 1);
				unk_0xC963A45B50851768(uVar0);
				unk_0x8ACADA903FCAA42F(iLocal_67, uVar0);
				unk_0x7461D7C5BA953BC7(&uVar0);
				if (unk_0x611AD675982BEBCC(iLocal_67))
				{
					unk_0x6221A52631154EF7(iLocal_67);
				}
				func_109();
				iLocal_130++;
			}
		...
		case 1:
			if (!func_80() && !unk_0xF68107C40359970C(iLocal_67))
			{
				if (unk_0x8F41785F110B0DA0(iLocal_67, Local_50, 3f, 3f, 3f, 0, 1, 0) && unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_50, 5f, 5f, 5f, 0, 1, 0))
				{
					iLocal_130++;
				}
			}
...
void func_145(bool bParam0)
{
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		if (iLocal_170 > 1)
		{
			if (!unk_0x2E7F5417D4F4DD69(iLocal_67, unk_0xE2D3D51028F0428A(), 60f))
			{
				iLocal_170 = 0;
				iLocal_171 = 0;
			}
		...
		switch (iLocal_170)
		{
			case 0:
				unk_0x03A927199A2DFE46(iLocal_67);
				unk_0xF30F15F203736DE4(iLocal_67, unk_0xE2D3D51028F0428A(), -1, 16, 2);
				unk_0xA888F8CC04F25CC8(&uLocal_169);
				unk_0x529D306014D3C29A(0, unk_0xE2D3D51028F0428A(), 0);
				unk_0xF30F15F203736DE4(0, unk_0xE2D3D51028F0428A(), -1, 16, 2);
				unk_0xC963A45B50851768(uLocal_169);
				unk_0x8ACADA903FCAA42F(iLocal_67, uLocal_169);
				unk_0x7461D7C5BA953BC7(&uLocal_169);
				iLocal_170++;
				break;
			
			case 1:
				if (unk_0x174CED88B97C78D9(iLocal_67, 242628503) != 1)
				{
					iLocal_170++;
				}
				break;
			...
			case 2:
				if (bParam0)
				{
					...
					{
						case 0:
							if (!unk_0xFCF559C8631ABED7(iLocal_67, "random@paparazzi@wait", "wait_a", 3))
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (unk_0xD01FAFCE275C94F3(iLocal_67, "random@paparazzi@wait", "wait_a") > 0.95f)
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_171++;
							}
							break;
						
						case 1:
							if (!unk_0xFCF559C8631ABED7(iLocal_67, "random@paparazzi@wait", "wait_b", 3))
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (unk_0xD01FAFCE275C94F3(iLocal_67, "random@paparazzi@wait", "wait_b") > 0.95f)
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_171++;
							}
							break;
						
						case 2:
							if (!unk_0xFCF559C8631ABED7(iLocal_67, "random@paparazzi@wait", "wait_c", 3))
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (unk_0xD01FAFCE275C94F3(iLocal_67, "random@paparazzi@wait", "wait_c") > 0.95f)
							{
								unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_171 = 0;
							}
...
void func_147()
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
	{
		...
		{
			case 0:
				if (!unk_0xF68107C40359970C(iLocal_67) && unk_0x55A0C756C4A8220C(iLocal_70, 0))
				{
					func_146();
					...
					if (!unk_0xF68107C40359970C(iLocal_67))
					{
						unk_0xE1E1AF00CA06A2B7(iLocal_67, unk_0xCACAD935C0BEE14F(iLocal_70, -10f, 5f, 0f), -1, 16, 4);
					}
					unk_0xE1E1AF00CA06A2B7(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_70, 10f, 5f, 0f), 15000, 16, 4);
					...
					{
						unk_0xE1E1AF00CA06A2B7(iLocal_67, unk_0xCACAD935C0BEE14F(iLocal_70, -10f, 5f, 0f), -1, 16, 4);
						unk_0xEB087B19F63AB053(iLocal_67, 0, 0);
					}
					unk_0xE1E1AF00CA06A2B7(unk_0xE2D3D51028F0428A(), unk_0xCACAD935C0BEE14F(iLocal_70, 10f, 5f, 0f), 15000, 16, 4);
					iLocal_130++;
				}
			...
			case 2:
				if (!unk_0xF68107C40359970C(iLocal_67) && unk_0x55A0C756C4A8220C(iLocal_70, 0))
				{
					if (!unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
					{
						settimera(0);
						if (bLocal_129)
						{
			...
			case 3:
				if ((!unk_0xF68107C40359970C(iLocal_67) && unk_0x55A0C756C4A8220C(iLocal_70, 0)) && timera() > 1000)
				{
					unk_0x02F1CAAC7CB77E47(unk_0xE2D3D51028F0428A(), iLocal_70, 0);
					unk_0xF30F15F203736DE4(unk_0xE2D3D51028F0428A(), iLocal_70, 10000, 0, 3);
					iLocal_130++;
				}
				break;
			
			case 4:
				if (unk_0x55A0C756C4A8220C(iLocal_70, 0) && !unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0))
				{
					unk_0x64E21045781AFBC9(unk_0x9E2D6C50374FCFA9(), 1, 0);
					func_151(0, 1, 0, 0, 0, 0, 0);
					unk_0x3B2646B62E7BBE11(iLocal_70, 2);
					settimera(0);
					iLocal_130++;
				}
				break;
...
void func_159()
{
	...
	if (bLocal_129 && !unk_0xF68107C40359970C(iLocal_67))
	{
		...
		if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0))
		{
			...
			{
				iLocal_70 = 0;
				iLocal_70 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
				unk_0x2D58A6131679D82C(iLocal_70, 1, 1);
				unk_0x3B2646B62E7BBE11(iLocal_70, 1);
				unk_0x2EABFF5EFCB7E6CF(iLocal_70, 0, 0);
			}
		}
		if (unk_0x12DD4A0B247D9B4D(uLocal_124) && !unk_0xD5C6B5E3B93A5EDC(iLocal_67, 0))
		{
			if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), Local_50, 15f, 15f, 15f, 0, 1, 0) || unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), 231.7982f, 672.7683f, 189.2f, 1f, 1f, 2.5f, 1, 1, 0))
			{
				func_187(4);
			}
		}
		else if (iLocal_130 != 100)
		{
			...
			{
				if (unk_0xD132EDDA78FF4A51(iLocal_70, 225.5938f, 681.1489f, 188.4262f, 232.02f, 681.3113f, 191.9843f, 8.75f, 0, 1, 0) || unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), 226.6788f, 681.0637f, 189f, 1f, 1f, 2.5f, 1, 1, 0))
				{
					settimera(0);
					iLocal_130 = 100;
				}
			}
			else if (!unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
			{
				if (unk_0x174CED88B97C78D9(iLocal_67, -1794415470) != 1)
				{
					unk_0xB486640392EC50BB(iLocal_67, iLocal_70, -1, func_177(iLocal_70), 2f, 8388608, 0);
				}
			}
		}
	}
	...
	switch (iLocal_130)
	{
		case 0:
			if (func_73())
			{
				if (unk_0xFCF559C8631ABED7(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || unk_0xFCF559C8631ABED7(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3))
				{
					unk_0x03A927199A2DFE46(iLocal_67);
				}
	...
	if (func_24() == 2)
	{
		if ((func_160() && !func_173()) && iLocal_45 != 8)
		{
			if (!unk_0xF68107C40359970C(iLocal_67))
			{
				if (unk_0x8F41785F110B0DA0(iLocal_67, -1034.6f, 4918.6f, 205.9f, 5f, 5f, 5f, 0, 1, 0))
				{
					if (!unk_0x2F52E009BBC0AFCE(iLocal_67, unk_0xFD8E434495EC2F26(unk_0x9E2D6C50374FCFA9())))
					{
						unk_0xF23E6F5690771F71(iLocal_67, unk_0xFD8E434495EC2F26(unk_0x9E2D6C50374FCFA9()));
					}
					func_109();
					iLocal_45 = 8;
				}
...
int func_164(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		if ((iLocal_58 && !iLocal_59) && bParam1)
		{
			...
			else if ((unk_0x320D1840B6DAA1CC() - iLocal_62) > 500)
			{
				iLocal_62 = -1;
				iLocal_58 = 0;
				iLocal_59 = 0;
...
int func_167()
{
	if (bLocal_129)
	{
		...
		if (!unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && !unk_0xD5C6B5E3B93A5EDC(iLocal_67, 0))
		{
...
{
	if (unk_0x55A0C756C4A8220C(iLocal_70, 0) && !unk_0xF68107C40359970C(iLocal_67))
	{
		if (func_73())
		{
			if (bParam0)
...
void func_181()
{
	if (!unk_0xF68107C40359970C(iLocal_67) && unk_0x55A0C756C4A8220C(iLocal_70, 0))
	{
		if (!unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 1))
		{
			if (unk_0x174CED88B97C78D9(iLocal_67, -1794415470) != 1)
			{
				unk_0xB486640392EC50BB(iLocal_67, iLocal_70, -1, func_177(iLocal_70), 2f, 8388608, 0);
		...
		if ((unk_0xE5965CDF24F93A9F(func_72()) && vdist2(unk_0x6B62510F212526DC(iLocal_67, 1), unk_0x6B62510F212526DC(func_72(), 1)) < 100f) && (unk_0x207D53F9E0190691(iLocal_70) < 5f || !unk_0x6F0299ED3CEB4E5D(unk_0x15CAA6D7B11F1A7C(iLocal_70))))
		{
			if (bLocal_129)
			{
				if (!unk_0xFCF559C8631ABED7(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 3) && unk_0x87B449F4C26E764A(iLocal_67, iLocal_70))
				{
					unk_0x49D97B076E3590AC(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
				}
			}
			else if (!unk_0xFCF559C8631ABED7(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3) && unk_0x87B449F4C26E764A(iLocal_67, iLocal_70))
			{
				unk_0x49D97B076E3590AC(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
			}
		}
		else if ((unk_0xFCF559C8631ABED7(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || unk_0xFCF559C8631ABED7(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3)) && unk_0x87B449F4C26E764A(iLocal_67, iLocal_70))
		{
			unk_0x03A927199A2DFE46(iLocal_67);
		}
		switch (iLocal_130)
		{
			case 0:
				if (timera() > 2000)
				{
					...
					if (func_5(&Local_139, cLocal_133, "REPAP_GO", 4, 0, 0, 0))
					{
						...
						unk_0x50274A7EACA3133A(iLocal_67, 1);
						unk_0x9972EFADA7A2A47D(1, uLocal_55, 1862763509);
						iLocal_119 = unk_0x0E536D72AB30F4C8(joaat("prop_ld_test_01"), Local_68, 1, 1, 0);
						unk_0x959E1626CBC7D38A(iLocal_119, 0, 0);
						unk_0x1C2ED929474DC6FE(iLocal_119, 0, 0);
						unk_0x5C65DDDC219B3AA5(iLocal_119, 1);
						iLocal_130++;
					}
				}
				break;
			...
			case 1:
				func_183();
				if (!unk_0xD132EDDA78FF4A51(iLocal_67, 243.5571f, 77.51265f, 90.08002f, 268.2083f, 144.2189f, 109.853f, 23.25f, 0, 1, 0))
				{
					iLocal_130++;
			...
			case 2:
				if (!bLocal_198)
				{
					...
					{
						bLocal_199 = false;
						if (unk_0xE5965CDF24F93A9F(func_72()) && unk_0x77A43AFA9AAEC041(func_72(), iLocal_70, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_198 = true;
						}
					}
				...
				else
				{
					...
					if (unk_0xE5965CDF24F93A9F(func_72()))
					{
						if (!unk_0x77A43AFA9AAEC041(func_72(), iLocal_70, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_198 = false;
						}
					}
					...
					switch (iLocal_200)
					{
						...
						case 1:
							if (((!bLocal_198 && func_167()) && !func_81()) && !func_80())
							{
								...
								{
									iLocal_201 = unk_0x320D1840B6DAA1CC();
									iLocal_200++;
								}
							}
							break;
						...
						case 2:
							if ((unk_0x320D1840B6DAA1CC() - iLocal_201) > 8000)
							{
								if (((!bLocal_198 && func_167()) && !func_81()) && !func_80())
								{
						...
						case 4:
							if ((unk_0x320D1840B6DAA1CC() - iLocal_201) > 6000)
							{
								if (func_24() == 0)
								{
...
int func_182()
{
	...
	iVar0 = func_30();
	if ((unk_0x320D1840B6DAA1CC() - iLocal_196) > 5000)
	{
		if (unk_0xE5965CDF24F93A9F(iLocal_70) && unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
		{
			if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 1))
			{
				if (iVar0 != -1 && (unk_0x320D1840B6DAA1CC() - Local_109[iVar0 /*18*/].f_12) < 3000)
				{
					if (func_5(&Local_139, cLocal_133, "REPAP_WHINE", 4, 0, 0, 0))
					{
						iLocal_196 = unk_0x320D1840B6DAA1CC();
						return 1;
					}
				}
			}
...
void func_183()
{
	...
	if ((unk_0x320D1840B6DAA1CC() - iLocal_145) > iLocal_146)
	{
		if ((!unk_0xF68107C40359970C(iLocal_67) && unk_0xE5965CDF24F93A9F(func_72())) && !unk_0xF68107C40359970C(func_72()))
		{
			if (unk_0x987A5F1E1A67E3C0(Local_53, unk_0x6B62510F212526DC(func_72(), 1), 1) < 8f)
			{
				...
				switch (iVar0)
				{
					case 0:
						func_22(&Local_139, 4, func_72(), "PAPARAZZO", 0, 1);
						if (unk_0xE5965CDF24F93A9F(Local_139[4 /*10*/]) && !unk_0xF68107C40359970C(Local_139[4 /*10*/]))
						{
							if (func_5(&Local_139, cLocal_133, "REPAP_PP", 4, 0, 0, 0))
							{
								iLocal_145 = unk_0x320D1840B6DAA1CC();
								iLocal_146 = unk_0x5853B15F78E1A265(2000, 3000);
							}
						}
						break;
					...
					case 2:
						...
						if (unk_0xE5965CDF24F93A9F(Local_139[5 /*10*/]) && !unk_0xF68107C40359970C(Local_139[5 /*10*/]))
						{
...
void func_184()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		if (unk_0x12DD4A0B247D9B4D(uLocal_121))
		{
			unk_0x3430966AC4550BB9(uLocal_121, iLocal_194);
		}
		switch (iLocal_130)
		{
			case 0:
				...
				{
					uLocal_174 = unk_0x8F5F4164BF5FB513(Local_187, Local_188, 2);
					unk_0x950B26F4C891073F(iLocal_67, uLocal_174, "random@paparazzi@peek", "left_peek_a", 1000f, -8f, 1, 0, 1148846080, 0);
					unk_0xF30F15F203736DE4(iLocal_67, unk_0xE2D3D51028F0428A(), -1, 4, 4);
					sLocal_175[0] = "peek_a";
					sLocal_175[1] = "peek_b";
					sLocal_175[2] = "peek_c";
					unk_0x8576657A629C4B0A(0.2f);
			...
			case 1:
				if (unk_0xE2D0C323A1AE5D85(iLocal_190, 0))
				{
					if (!unk_0xE2D0C323A1AE5D85(iLocal_190, 1))
					{
						unk_0xCED9E32812D6C7C7(&iLocal_190, 1);
					}
					else
					{
						iLocal_190 = 0;
				...
				iVar2 = 0;
				bVar0 = unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_181, Local_182, fLocal_183, 0, 1, 0);
				bVar1 = unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_178, Local_179, fLocal_180, 0, 1, 0);
				if (unk_0x3C57C2F07FEE34D2(sLocal_177, "right_"))
				{
					if (bVar1)
					{
						sLocal_177 = "left_";
				...
				if ((unk_0xCE2C78E9FC0B01E3(uLocal_174) && unk_0x54DE1614490C2A83(uLocal_174) > 0.9f) || iVar2)
				{
					if (iLocal_190 == 0)
					{
						unk_0x03A927199A2DFE46(iLocal_67);
						...
						uLocal_174 = unk_0x8F5F4164BF5FB513(Local_187, Local_188, 2);
						unk_0x950B26F4C891073F(iLocal_67, uLocal_174, "random@paparazzi@peek", &cVar3, 4f, -4f, 1, 0, 1148846080, 0);
						unk_0xCED9E32812D6C7C7(&iLocal_190, 0);
					}
				}
				if (bVar0 || bVar1)
				{
					if (fLocal_191 <= 20f)
					{
						fLocal_191 = (fLocal_191 + unk_0x51109C28352EC9A3());
					}
					if ((unk_0x320D1840B6DAA1CC() - iLocal_173) > 5000 && iLocal_190 == 0)
					{
						if (vdist2(Local_52, Local_53) < (22.2f * 22.2f))
						{
							...
							if (func_24() == 1)
							{
								func_22(&Local_139, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
							}
							else if (func_24() == 0)
							{
								func_22(&Local_139, 1, unk_0xE2D3D51028F0428A(), "MICHAEL", 0, 1);
							}
							else
							{
								func_22(&Local_139, 1, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
							}
							if (func_5(&Local_139, cLocal_133, sVar4, 4, 0, 0, 0))
							{
								iLocal_192 = 1;
								if (!unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_67, 7f, 7f, 7f, 0, 1, 0))
								{
									unk_0x03A927199A2DFE46(iLocal_67);
									StringCopy(&cVar5, sLocal_177, 24);
									StringConCat(&cVar5, "come_here", 24);
									uLocal_174 = unk_0x8F5F4164BF5FB513(Local_187, Local_188, 2);
									unk_0x950B26F4C891073F(iLocal_67, uLocal_174, "random@paparazzi@peek", &cVar5, 4f, -4f, 1, 0, 1148846080, 0);
									unk_0xCED9E32812D6C7C7(&iLocal_190, 0);
								}
								iLocal_173 = unk_0x320D1840B6DAA1CC();
							}
						}
					}
				}
				if (unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), Local_184, Local_185, fLocal_186, 0, 1, 0) && iLocal_190 == 0)
				{
					...
					if (bVar1)
					{
						unk_0x950B26F4C891073F(iLocal_67, uLocal_174, "random@paparazzi@trans", "trans_left_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					else
					{
						unk_0x950B26F4C891073F(iLocal_67, uLocal_174, "random@paparazzi@trans", "trans_right_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					unk_0xCED9E32812D6C7C7(&iLocal_190, 0);
					iLocal_130++;
				}
			...
			case 2:
				if (unk_0xCE2C78E9FC0B01E3(uLocal_174) && unk_0x54DE1614490C2A83(uLocal_174) > 0.9f)
				{
					if (unk_0x174CED88B97C78D9(iLocal_67, 242628503) != 1)
					{
						unk_0x03A927199A2DFE46(iLocal_67);
						unk_0x49D97B076E3590AC(iLocal_67, "random@paparazzi@wait", "wait_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
						iLocal_170 = 2;
						settimera(0);
					}
					iLocal_130++;
			...
			case 3:
				if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					if (func_186())
					{
						unk_0x3D81769BEC61BFF8(&iLocal_70);
						iLocal_70 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
						unk_0x2D58A6131679D82C(iLocal_70, 1, 1);
						unk_0x2EABFF5EFCB7E6CF(iLocal_70, 0, 0);
						unk_0x3B2646B62E7BBE11(iLocal_70, 1);
			...
			case 4:
				...
				if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
				{
					if (unk_0x77A43AFA9AAEC041(iLocal_70, iLocal_67, Global_19 + Vector(2f, 12f, 12f), 0, 1, 0) && !bLocal_129)
					{
						if (unk_0x174CED88B97C78D9(iLocal_67, 242628503) != 1 && !iLocal_189)
						{
							...
							unk_0x8ACADA903FCAA42F(iLocal_67, uVar6);
							unk_0xEB087B19F63AB053(iLocal_67, 0, 0);
						...
						{
							unk_0xCAC4D1050F2E6899(iLocal_67, 1f);
					...
					if ((unk_0x77A43AFA9AAEC041(iLocal_70, iLocal_67, Global_19, 0, 1, 0) && func_179(iLocal_70)) && (timera() > 6000 || !bLocal_129))
					{
						if (!iLocal_172)
						{
							func_109();
						...
						else
						{
							...
							unk_0x03A927199A2DFE46(iLocal_67);
							unk_0xB486640392EC50BB(iLocal_67, iLocal_70, -1, func_177(iLocal_70), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case 5:
				if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
				{
					if (!unk_0xF68107C40359970C(iLocal_67) && unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
					{
						if (unk_0x12DD4A0B247D9B4D(uLocal_121))
						{
							unk_0xFFD8EB5462B07B59(&uLocal_121);
					...
					else
					{
						if (!Global_3 && !bLocal_56)
						{
							if ((unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0) && !unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 1)) && !unk_0xD132EDDA78FF4A51(iLocal_70, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, 0, 1, 0))
							{
								if (bLocal_129)
								{
									unk_0xDC6110E0F8FF9DA0(iLocal_67, 2, 1);
									sLocal_132 = "REPAP_GUP";
									func_187(6);
								}
								else
						...
						if (!unk_0xF6F5D18EF8EAB859(iLocal_67, iLocal_70, 0))
						{
							...
							else if (vdist(Local_53, unk_0xCACAD935C0BEE14F(iLocal_70, 1f, 0f, 0f)) < 1f)
							{
								unk_0xCAC4D1050F2E6899(iLocal_67, 1f);
							}
						}
			...
			case 101:
				if (vdist2(Local_52, Local_53) < 49f && !unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					if (unk_0x207D53F9E0190691(unk_0xE2D3D51028F0428A()) < 3f)
					{
						fLocal_195 = (fLocal_195 + unk_0x51109C28352EC9A3());
					}
					else
					{
						fLocal_195 = (fLocal_195 - (unk_0x51109C28352EC9A3() * 2f));
					}
					if (fLocal_195 > 10f)
					{
				...
				if (unk_0x55A0C756C4A8220C(iLocal_70, 0))
				{
					if (!unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_70, 0) && func_186())
					{
						bLocal_129 = true;
						iLocal_60 = 1;
						iLocal_70 = unk_0xB3FF0049C1FD38EC(unk_0xE2D3D51028F0428A(), 0);
					...
					if (unk_0x87B449F4C26E764A(unk_0xE2D3D51028F0428A(), iLocal_70))
					{
						if (unk_0x12DD4A0B247D9B4D(uLocal_122))
						{
							unk_0xFFD8EB5462B07B59(&uLocal_122);
		...
		if (!bLocal_129)
		{
			...
			else
			{
				if (!bLocal_129)
				{
					if (!Global_3 && !bLocal_56)
					{
						if (unk_0x0CF63873D754B965(iLocal_70) < iLocal_64)
						{
							if (unk_0x0747E45CFF1F74AA(iLocal_70, unk_0xE2D3D51028F0428A(), 1))
							{
								iLocal_65 = (iLocal_65 + (iLocal_64 - unk_0x0CF63873D754B965(iLocal_70)));
							}
							unk_0xE68645525D451A8B(iLocal_70);
						}
						if (iLocal_65 > 250)
						{
							if (unk_0xD32EE22119FFF87D(iLocal_67, iLocal_70) && vdist(Local_53, Local_54) < 25f)
							{
								func_187(5);
							}
						}
				...
				iLocal_64 = unk_0x0CF63873D754B965(iLocal_70);
			}
		}
		if (!unk_0xF68107C40359970C(iLocal_67))
		{
			if (unk_0x51B334B227EC8042(iLocal_67))
			{
				if (!Global_3 && !bLocal_56)
				{
					func_187(5);
...
void func_185(struct<3> Param0, bool bParam1)
{
	...
	{
		if (unk_0x174CED88B97C78D9(iLocal_67, 713668775) != 1)
		{
			unk_0x7D1424753688EE7A(iLocal_67, Param0, 1f, -1, 0.25f, 0, 1193033728);
		}
	}
	else if (unk_0x174CED88B97C78D9(iLocal_67, 713668775) != 1)
	{
		func_145(bParam1);
		unk_0xF30F15F203736DE4(iLocal_67, unk_0xE2D3D51028F0428A(), -1, 16, 2);
	}
...
void func_188(char* sParam0)
{
	...
	{
		if (!unk_0x3C57C2F07FEE34D2(iLocal_144[iVar0], sParam0))
		{
			if (unk_0xA37204C64473B324(iLocal_144[iVar0]))
			{
				unk_0x0AF8D3A06BB92903(iLocal_144[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_144)
	{
		if (unk_0x3C57C2F07FEE34D2(iLocal_144[iVar0], sParam0))
		{
			if (!unk_0xA37204C64473B324(iLocal_144[iVar0]))
			{
				unk_0x66B27A59829491D3(iLocal_144[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_199()
{
	...
	if (!unk_0xF68107C40359970C(iLocal_67))
	{
		unk_0xDC6110E0F8FF9DA0(iLocal_67, 2, 0);
		unk_0x7734082B0EDB0BE0(iLocal_67, unk_0xE2D3D51028F0428A(), 300f, -1, 0, 0);
	}
	iVar0 = 0;
	while (iVar0 < Local_109)
	{
		if (!unk_0xF68107C40359970C(Local_109[iVar0 /*18*/]))
		{
			unk_0x7734082B0EDB0BE0(Local_109[iVar0 /*18*/], unk_0xE2D3D51028F0428A(), 300f, -1, 0, 0);
			unk_0xFF4BEB6CFF55A013(Local_109[iVar0 /*18*/], -2065892691);
			unk_0x50274A7EACA3133A(Local_109[iVar0 /*18*/], 0);
		}
		iVar0++;
	}
}
...
int func_200()
{
	...
	while (iVar1 < Local_109)
	{
		if (unk_0xE5965CDF24F93A9F(Local_109[iVar1 /*18*/]) && !unk_0xF68107C40359970C(Local_109[iVar1 /*18*/]))
		{
			if (unk_0x2B5F4FBAF644BEC8(Local_109[iVar1 /*18*/]))
			{
				if (((unk_0x9AC74C7EF847A074(Local_109[iVar1 /*18*/].f_6, 5f, 1) || unk_0x89D0E0233F6E59A7(-1, Local_109[iVar1 /*18*/].f_6, 10f)) || unk_0x51B334B227EC8042(Local_109[iVar1 /*18*/])) || (iLocal_138[iVar1] > 10 && iLocal_45 == 0))
				{
					iVar0 = 1;
				}
			}
	...
	while (iVar1 < Local_108)
	{
		if (unk_0xE5965CDF24F93A9F(Local_108[iVar1 /*18*/]))
		{
			if (unk_0x55A0C756C4A8220C(Local_108[iVar1 /*18*/], 0) && unk_0x2B5F4FBAF644BEC8(Local_108[iVar1 /*18*/]))
			{
				if (unk_0xEF9410C312F2B117(Local_108[iVar1 /*18*/]))
				{
					iVar0 = 1;
				}
			}
...
int func_201()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (vmag2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_212())
		{
			return 0;
		}
	}
...
void func_213()
{
	...
	iLocal_67 = unk_0xA8D58C3AADA2C41C(26, joaat("a_f_y_bevhills_03"), Local_68, fLocal_69, 1, 1);
	unk_0xBC12D08EE7559CCD(iLocal_67, 1, 1);
	unk_0xBC12D08EE7559CCD(iLocal_67, 17, 1);
	unk_0xDC6110E0F8FF9DA0(iLocal_67, 128, 1);
	unk_0xABC2CA6F28903308(iLocal_67, 1);
	unk_0x027BDA95C9BD0667(iLocal_67, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 0, 0, 1, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 2, 0, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 3, 0, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 4, 0, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 7, 1, 0, 0);
	unk_0xE3752B10DC995E95(iLocal_67, 8, 0, 0, 0);
	unk_0x157A3B02D5DED24B(iLocal_67, 1);
	unk_0x50274A7EACA3133A(iLocal_67, 1);
	unk_0xA7266A50941DBAEA(iLocal_67, 0);
	unk_0xEEBC95A38CBDED42(iLocal_67, "LACEY");
	if (Global_3 || bLocal_56)
	{
		unk_0x9210F85E9CD785F1(iLocal_67, 1);
	}
	if (unk_0xD642E010A287ADFD("CELEBRITY", &uLocal_55))
	{
		unk_0xFF4BEB6CFF55A013(iLocal_67, uLocal_55);
	}
	iLocal_70 = unk_0xBA715A7BEBA5A1F9(joaat("surano"), Local_71, fLocal_72, 1, 1, 0);
	unk_0xA539EDE8DA5BBC22(iLocal_70, Local_71, 0, 0, 1);
	unk_0x03F4139102BA4AFC(iLocal_70, 0.1293f, -0.0323f, -0.1606f, 0.978f);
	unk_0x2EABFF5EFCB7E6CF(iLocal_70, 0, 0);
	unk_0xD584204572DF0440(iLocal_70, 10);
	unk_0x9F65B3BAFA302A65(iLocal_70, 1084227584);
	unk_0x3B2646B62E7BBE11(iLocal_70, 3);
	unk_0x1B3814E11B085F5E(iLocal_70, 1);
	unk_0x32CAC81EC8C5BA86(iLocal_70, 1);
	unk_0xD501428969A52C0F(iLocal_70, unk_0x8ECF4849E085E658(1));
	if (func_24() == 1)
	{
		func_22(&Local_139, 1, unk_0xE2D3D51028F0428A(), "FRANKLIN", 0, 1);
	}
...
int func_237(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_26(func_24()))
		{
			if (!func_274(iParam1, iParam2, 145))
			{
				return 0;
			}
		}
		if (!func_273(Global_112915.f_24995.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (func_262(iParam1, iParam2) && !bParam3)
		{
			return 0;
		}
		...
		if ((iParam1 == 9 && (iParam2 == 2 || iParam2 == 5)) && !func_262(0, 0))
		{
			return 0;
		}
		if (Global_31652)
...
{
	return (shift_right(iParam0, 26) & 31 * func_251(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_280()
{
	...
	unk_0xAFC1FBF3F6AE7B9A(sLocal_135);
	...
	if (unk_0xE5965CDF24F93A9F(iLocal_67) && !unk_0xF68107C40359970C(iLocal_67))
	{
		...
		if (unk_0xD5C6B5E3B93A5EDC(iLocal_67, 1))
		{
			if (!unk_0x51B334B227EC8042(iLocal_67))
			{
				unk_0xAB7639D658BBCCEE(iLocal_67, 0, 0);
	...
	unk_0x7BACBB4C6A7B18B7(uLocal_126, 0);
	unk_0x7BACBB4C6A7B18B7(uLocal_127, 0);
	unk_0x7BACBB4C6A7B18B7(uLocal_128, 0);
